...
void func_67(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_94(iParam0, 0), " ", func_95(iParam1, 0), " ", func_96(iParam2, 0), " state ", func_97(iParam4, 0));
	...
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_94(iParam0, 0), " or ", func_95(iParam1, 0), " or ", func_96(iParam2, 0));
...
{
	if (func_188(iParam0) && func_189())
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 183, "RELEASE_DOOR_ID - Releasing Door ID ", func_190(iParam0, 0));
