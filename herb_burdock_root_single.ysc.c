...
{
	return func_52(&(Global_3145858.f_6), iParam0);
}
...
int func_12(int iParam0, vector3 vParam1)
{
	...
	while (iVar3 < 500)
	{
		...
		else if (func_55(iVar3) != iParam0)
		{
			Jump @145; //curOff = 94
		}
		else
		{
			fVar0 = func_57(vParam1, func_56(iVar3));
...
int func_13(int iParam0, vector3 vParam1)
{
	...
	iVar0 = Global_20529;
	func_58(&(Global_20530[iVar0 /*9*/]), iParam0, vParam1, -15);
	Global_20529++;
...
void func_15(var uParam0)
{
	...
	func_59(uParam0->f_22, &uVar0, &uVar7);
	if (uParam0->f_24 > 4)
	{
		uParam0->f_24 = 4;
	}
	...
	while (iVar12 <= (iVar11 - 1))
	{
		...
		func_60(uParam0->f_26, iVar12, iVar15);
		iVar12++;
	}
}
...
void func_16(var uParam0)
{
	...
	func_60(uParam0->f_26, 0, iVar12);
}

bool func_17(var uParam0)
{
	if (func_61(Global_33) && func_62())
	{
		return true;
	}
	func_20(uParam0);
...
void func_20(var uParam0)
{
	...
	if (func_69(Global_17356[uParam0->f_27 /*2*/], *uParam0))
	{
...
void func_27(var uParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 191, "REQUEST_HERB_ASSETS: requesting ", func_78(uParam0->f_44, 0));
}
...
bool func_28(var uParam0)
{
	...
	{
		DEBUG::_0xF0783374333FD8CE(40, 191, "HAVE_HERB_ASSETS_LOADED: not loaded ", func_78(uParam0->f_44, 0));
		return false;
	}
	DEBUG::_0xF0783374333FD8CE(40, 191, "HAVE_HERB_ASSETS_LOADED: loaded ", func_78(uParam0->f_44, 0));
	return true;
}
...
int func_29(var uParam0)
{
	...
	if (!MISC::GET_GROUND_Z_FOR_3D_COORD(*uParam0, uParam0->f_1, (uParam0->f_2 + 2f), &uVar4, false))
	{
		...
		if (!MISC::GET_GROUND_Z_FOR_3D_COORD(*uParam0, uParam0->f_1, (uParam0->f_2 + 10f), &uVar4, false))
		{
			...
			if (uParam0->f_14 >= 50)
			{
				DEBUG::_0x83407B92D46F25C3(629160, 191, "SPAWN_HERB_PATCH: We have failed to find a valid ground location to root ", func_79(uParam0->f_20, 0), " patch at location <<", *uParam0, ",", uParam0->f_1, ",", uParam0->f_2, ">> - this could be a streaming issue, or a problem with the herb patch placement.");
				uParam0->f_14 = 0;
				return -1;
			}
			else
	...
	while (iVar0 <= 3)
	{
		if (!func_75(uParam0->f_26, iVar0))
		{
		}
		else
		{
			func_80(uParam0->f_26, iVar0, &iVar1, &iVar2, &uVar3);
			...
			{
				DEBUG::_0xD9911C7B5F8CD69C(10066088, 191, "SPAWN_HERB_PATCH: ", func_79(uParam0->f_20, 0), " patch member ", iVar0, " could not be placed at location <<", vLocal_24[iVar0 /*3*/], ",", vLocal_24[iVar0 /*3*/].f_1, ",", (uParam0->f_2 + 10f), ">> - this is problem with the herb patch placement.");
				uParam0->f_14 = 0;
				return -1;
			}
		}
...
bool func_30(var uParam0)
{
	...
	if (iLocal_16 < 4)
	{
		if (!func_53(vLocal_24[iLocal_16 /*3*/]))
		{
			if (!Global_1915813)
			{
				iVar1 = 0;
				...
				{
					iVar1 |= 2;
					vLocal_24[iLocal_16 /*3*/] = { vLocal_24[iLocal_16 /*3*/] + func_81(0f, 0.737008f, 1.81999f, uParam0->f_3) };
				}
				...
				{
					iVar1 |= 2;
					vLocal_24[iLocal_16 /*3*/] = { vLocal_24[iLocal_16 /*3*/] + func_81(0f, 0.5f, 1.81999f, uParam0->f_3) };
				}
				if (func_39(uParam0->f_26, iLocal_16))
				{
					iVar1 |= 1;
				}
				uParam0->f_15[iLocal_16] = TASK::_0x5B4BBE80AD5972DC(uParam0->f_44, vLocal_24[iLocal_16 /*3*/], func_82((uParam0->f_3 + (IntToFloat(iLocal_16) * MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 90f)))), iVar1, &uVar0, iLocal_37[iLocal_16]);
				if (func_83(uParam0->f_20))
				{
					uParam0->f_34[iLocal_16] = GRAPHICS::_0xFA50F79257745E74(vLocal_24[iLocal_16 /*3*/], 0.37f, 4, 27, 0);
				}
				if (uParam0->f_20 == 39)
				{
					func_84(&(uParam0->f_39[iLocal_16]), vLocal_24[iLocal_16 /*3*/], 0.15f);
				}
...
bool func_33(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	while (iVar0 <= 3)
	{
		if (func_75(*iParam4, iVar0))
		{
			...
			iVar0++;
			if (func_57(vParam1, vVar11) < IntToFloat(iParam8))
			{
			...
			{
				DEBUG::_0xA308F935BDECCEC0(24, 191, "@@@@@@@@@ GET_HERB_PATCH_PLANT_INDEXES: Failed distance check! Distance: ", func_57(vParam1, vVar11));
			}
...
void func_34(var uParam0, vector3 vParam1, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (!bVar1)
	{
		if (uParam0->f_8)
		{
			DEBUG::_0xF0783374333FD8CE(40, 215, "NET_COLLECTIBLE_HANDLE_RUMBLE: rumble disabled in state - ", func_89(uParam0->f_11, 0));
			uParam0->f_8 = 0;
		}
	}
	if (uParam0->f_11 < 8)
	...
	switch (*uParam0)
	{
		...
		case 2:
			...
			else if (func_94(&(uParam0->f_1)) >= 2f)
			{
				func_91(uParam0, 1);
			}
...
void func_35(int iParam0, bool bParam1)
{
	...
	if (!func_96(iParam0, iVar0, iVar1, bParam1))
	{
		return;
	}
	func_97(iVar0, iVar1);
	DEBUG::_0xA308F935BDECCEC0(10376, 105, "TUTORIAL_MARK_RUN() - Tutorial with Set: ", iVar0, " & Flag", iVar1, " marked to run. ", func_98(iParam0));
...
bool func_41(struct<32> Param0, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, var uParam61, var uParam62, var uParam63, var uParam64, var uParam65, vector3 vParam66, int iParam69)
{
	...
	if (func_57(Param0, vParam66) > 26f)
	{
		DEBUG::_0xF0783374333FD8CE(24, 191, "PROCESS_PICKED_HERB: Exceeded max distance = ", func_57(Param0, vParam66));
		return false;
	}
	if (!Param0.f_31)
	{
		iVar0 = func_99(Param0.f_20);
	...
	func_38(Param0.f_26);
	if (!func_100(Param0.f_20))
	{
		func_101(Param0.f_20, 0, 0);
	}
	if (iParam69 == 1)
	{
		func_102(Param0.f_20, 1);
		DEBUG::_0xF0783374333FD8CE(168, 191, "PROCESS_PICKED_HERB: Incrementing herb eaten stat! ", func_79(Param0.f_20, 0), " ", func_103(Param0.f_20));
	}
	else
	{
		func_104(Param0.f_20, 1);
		DEBUG::_0xF0783374333FD8CE(168, 191, "PROCESS_PICKED_HERB: Incrementing herb picked stat! ", func_79(Param0.f_20, 0), " ", func_105(Param0.f_20));
	}
...
{
	DEBUG::_0x1B08D1EB9D8C4931(152, 191, "HERB_HANDLE_VOMIT_ANIM - time ", func_94(uParam3), " can start ", bParam2);
	...
	switch (*uParam0)
	{
		case 0:
			...
			if (func_111(uParam3) && func_94(uParam3) > 2f)
			{
				func_112(uParam0, 1);
				func_113(uParam3);
			}
...
void func_45(var uParam0)
{
	...
	while (iVar1 <= 3)
	{
		if (func_75(uParam0->f_26, iVar1) && uParam0->f_15[iVar1] != iVar0)
		{
...
void func_50(var uParam0)
{
	...
	bVar0 = false;
	if (func_115(Global_1940410, 4194304))
	{
		bVar0 = true;
	}
	if (func_48(uParam0) == 2)
	...
	if (!uParam0->f_31)
	{
		...
		if (uParam0->f_32 || (func_111(&(Global_1959052.f_2)) && func_94(&(Global_1959052.f_2)) < 5f))
		{
...
Vector3 func_56(int iParam0)
{
	...
	return func_117(Global_20530[iParam0 /*9*/].f_1);
}

float func_57(vector3 vParam0, vector3 vParam3)
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
bool func_62()
{
	return (Global_1893599 & 1 != 0 && func_119() != -1);
}
...
bool func_63(bool bParam0, bool bParam1)
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		{
			DEBUG::_0xF0783374333FD8CE(168, 8, "KILL_EVENT_CAUGHT - NETWORK_IS_GAME_IN_PROGRESS() = FALSE - but bIgnoreTransition = TRUE and g_mpTransition.eMPState = ", func_120(Global_1572887, 0), ", so skipping");
		}
		else
		{
...
bool func_64()
{
	return func_121(Global_1572887.f_7, 1);
}
...
bool func_65(int iParam0, int iParam1, bool bParam2)
{
	...
	if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && iParam1 != -1)
	{
		...
		while (iVar1 <= 7)
		{
			if (Global_1196810.f_1[iVar1 /*26*/].f_1 == iParam1 && func_122(iVar1, 64, iVar0))
			{
				if (bParam2)
				{
...
bool func_69(int iParam0, vector3 vParam1)
{
...
void func_73(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	func_131(uParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}

bool func_74(int iParam0, bool bParam1)
{
	return func_132(func_8(), iParam0, bParam1);
}
...
void func_80(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)
{
	...
	func_133(&(Global_20530[iParam0 /*9*/]), iParam1, iParam2, iParam3, uParam4);
}
...
void func_84(var uParam0, vector3 vParam1, float fParam4)
{
	...
	bVar0 = -1;
	func_134(uParam0, vParam1, fParam4, 4, bVar0, 0);
...
int func_88(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		case 0:
			if (func_135(joaat("KIT_COLLECTORS_BAG"), 0, 0, 0) <= 0)
			{
				return 0;
			}
			break;
...
bool func_96(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_142(iParam1, iParam2))
	{
		if (!bParam3)
		{
			DEBUG::_0xA308F935BDECCEC0(168, 105, "TUTORIAL_CAN_GO_PENDING_CHECKS - Tutorial: ", func_98(iParam0), " has already run, and is not being forced.");
			return false;
		}
	}
	if (!func_143(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 105, "TUTORIAL_CAN_GO_PENDING_CHECKS - NOT CAN_TUTORIAL_PLAY_IN_MODE ", func_144(iParam0, 0));
		return false;
	}
	if (func_145(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 105, "TUTORIAL_CAN_GO_PENDING_CHECKS - Timed tutorial is delayed or finished ", func_144(iParam0, 0));
		return false;
	}
	if ((Global_1900777.f_67 && !func_146(iParam0, 1)) || func_147(32768))
	{
		if (!func_146(iParam0, 262144) || !Global_1904703.f_8785)
		{
...
void func_101(int iParam0, bool bParam1, bool bParam2)
{
	...
	DEBUG::_0xF0783374333FD8CE(168, 191, "HERB_TYPE_FLAG_AS_PICKED: herb type ", func_79(iParam0, 0), " has been picked for the first time!");
	func_150(iParam0, 1);
	func_151(iParam0, 1);
	DEBUG::_0xF0783374333FD8CE(680, 191, "HERB_TYPE_FLAG_AS_PICKED: herb type ", func_79(iParam0, 0), " will make save request: ", MISC::_0xF216F74101968DB0(bParam2));
	if (bParam2)
	{
		if (!func_152(0, 0, 1))
		{
		...
		{
			DEBUG::_0xF0783374333FD8CE(168, 191, "HERB_TYPE_FLAG_AS_PICKED: herb type ", func_79(iParam0, 0), " save cancelled due to IS_ANYTHING_RUNNING()");
		}
	}
}
...
void func_102(int iParam0, int iParam1)
{
	...
	Var0 = { func_154(joaat("EATEN"), func_99(iParam0)) };
...
var func_103(int iParam0)
{
	...
	Var0 = { func_154(joaat("EATEN"), func_99(iParam0)) };
	return func_157(Var0);
}

void func_104(int iParam0, int iParam1)
{
	func_156(func_154(joaat("PICK"), func_99(iParam0)), iParam1);
...
var func_105(int iParam0)
{
	...
	Var0 = { func_154(joaat("PICK"), func_99(iParam0)) };
	return func_157(Var0);
}
...
void func_106(int iParam0, bool bParam1, int iParam2)
{
	...
	DEBUG::_0xF0783374333FD8CE(168, 191, "HERB_TYPE_UNLOCK_PROPERTY_DISPLAY: herb type ", func_79(iParam0, 0), " has had display of its properties unlocked!");
	func_150(iParam0, 4);
...
bool func_107(int iParam0)
{
	switch (iParam0)
	{
		...
		default:
			DEBUG::_0x83407B92D46F25C3(168, 191, "GET_SATCHEL_ITEM_FROM_HERB - herb type ", func_79(iParam0, 0), " undefined in switch");
			break;
	}
	return false;
}
...
void func_108(bool bParam0)
{
	...
	Var0.f_1 = 20;
	if ((func_160(bParam0, 1573112293) || func_160(bParam0, 672467738)) || func_160(bParam0, -550842268))
	{
		bVar37 = true;
	}
	DEBUG::_0x4DC69742196F818A(40, 158, "PROCESS_GENERIC_ITEM_USE - Inventory Item Group - ", func_162(func_161(bParam0), 0));
	if (func_161(bParam0) == joaat("CONSUMABLE"))
	{
		ITEMDATABASE::_ITEM_DATABASE_FILLOUT_ITEM_EFFECTS_IDS(bParam0, &Var0);
		DEBUG::_0xF0783374333FD8CE(168, 158, "PROCESS_GENERIC_ITEM_USE - ", func_163(bParam0, 0), " Num Effects ", Var0);
		ATTRIBUTE::_0xD962F8579D702DB5();
		iVar29 = 0;
		while (iVar29 < Var0)
		{
			DEBUG::_0xF0783374333FD8CE(648, 158, "PROCESS_GENERIC_ITEM_USE - Effect ", iVar29, ":", func_164(Var0.f_1[iVar29], 0));
			if (!ITEMDATABASE::_ITEM_DATABASE_FILLOUT_ITEM_EFFECTS_ID_INFO(Var0.f_1[iVar29], &Var22))
			{
				DEBUG::_0x9A6C65DDDBEC9C52(2696, 158, "PROCESS_GENERIC_ITEM_USE - Effect ", iVar29, ":", func_164(Var0.f_1[iVar29], 0), " failed to Fillout via ITEMDATABASE_FILLOUT_EFFECT_ID_INFO.");
			}
			else
			{
				DEBUG::_0xF0783374333FD8CE(25725608, 158, "PROCESS_GENERIC_ITEM_USE - Key ", func_164(Var22, 0), " Enum ID ", func_165(Var22.f_1, 0), " Value ", Var22.f_2, " Time ", Var22.f_3, " unit ", Var22.f_4, " percent ", Var22.f_5);
				if (-943921969 == Var22.f_1)
				{
					fVar30 = func_166(0, Var22.f_2);
					func_167(Var22.f_2);
					bVar39 = true;
				}
				else if (-1104847406 == Var22.f_1)
				{
					fVar31 = func_166(2, Var22.f_2);
					func_168(Var22.f_2, 0);
					bVar38 = true;
				}
				else if (381158954 == Var22.f_1)
				{
					fVar32 = func_166(1, Var22.f_2);
					func_169(Var22.f_2);
				}
				else if (-416929031 == Var22.f_1)
				{
					fVar33 = func_170(BUILTIN::TO_FLOAT(Var22.f_2), Var22.f_5);
					func_171(0, fVar33, 1, 1, bVar37);
					bVar39 = true;
				}
				else if (1857353317 == Var22.f_1)
				{
					fVar34 = func_170(BUILTIN::TO_FLOAT(Var22.f_2), Var22.f_5);
					func_171(2, fVar34, 1, 1, bVar37);
					bVar38 = true;
				}
				else if (1681823811 == Var22.f_1)
				{
					fVar35 = func_170(BUILTIN::TO_FLOAT(Var22.f_2), Var22.f_5);
					func_171(1, fVar35, 1, 1, bVar37);
				}
				else if (2062242710 == Var22.f_1)
				{
					fVar36 = func_172(BUILTIN::TO_FLOAT(Var22.f_3), Var22.f_4);
					func_173(19, fVar36, 1, 1);
					bVar39 = true;
				}
				else if (-826379728 == Var22.f_1)
				{
					fVar36 = func_172(BUILTIN::TO_FLOAT(Var22.f_3), Var22.f_4);
					func_173(20, fVar36, 1, 1);
					bVar38 = true;
				}
				else if (-1191740624 == Var22.f_1)
				{
					fVar36 = func_172(BUILTIN::TO_FLOAT(Var22.f_3), Var22.f_4);
					func_173(18, fVar36, 1, 1);
				}
				else if (1869697234 == Var22.f_1)
				{
					fVar36 = func_172(BUILTIN::TO_FLOAT(Var22.f_3), Var22.f_4);
					func_173(0, fVar36, 1, 1);
					bVar39 = true;
				}
				else if (1342237631 == Var22.f_1)
				{
					fVar36 = func_172(BUILTIN::TO_FLOAT(Var22.f_3), Var22.f_4);
					func_173(2, fVar36, 1, 1);
					bVar38 = true;
				}
				else if (-1240225157 == Var22.f_1)
				{
					fVar36 = func_172(BUILTIN::TO_FLOAT(Var22.f_3), Var22.f_4);
					func_173(1, fVar36, 1, 1);
				}
				else if (-816334026 == Var22.f_1)
				{
					func_174(BUILTIN::TO_FLOAT(Var22.f_2), 1);
				}
			}
			iVar29++;
		}
		if (bVar39 || func_160(bParam0, -537818634))
		{
			func_156(func_175(joaat("MEDICINE_ITEMS_USED")), 1);
		}
		if (func_160(bParam0, -1457797660))
		{
			func_156(func_175(joaat("PROVISION_ITEMS_USED")), 1);
		}
		if (bVar38)
		{
			func_156(func_175(joaat("DEADEYE_ITEMS_USED")), 1);
		}
		switch (bParam0)
		{
...
void func_109(bool bParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	iVar6 = func_161(bParam0);
	iVar10 = 0;
	iVar11 = joaat("INVENTORY");
	if ((((((((iVar6 == joaat("AMMO") && bParam0 != joaat("AMMO_HATCHET")) && bParam0 != joaat("AMMO_HATCHET_CLEAVER")) && bParam0 != joaat("AMMO_HATCHET_HUNTER")) && bParam0 != joaat("AMMO_TOMAHAWK_ANCIENT")) && bParam0 != joaat("AMMO_POISONBOTTLE")) && bParam0 != joaat("AMMO_MOONSHINEJUG_MP")) && !func_160(bParam0, -1982291600)) && !func_160(bParam0, 137764179))
	{
	...
	else if (!func_182(bParam0, &Var7, iVar11, iVar10, 0, joaat("UI_ITEMVIEWER")))
	{
		Var7 = "_PLACEHOLDER";
		Var7.f_1 = "inventory_items";
		DEBUG::_0x9A6C65DDDBEC9C52(168, 158, "ADD_QUEUED_ITEM_DISPLAY: Failed to find UI Data for: ", func_163(bParam0, 0), " | Using _PLACEHOLDER texture");
	}
	...
	{
		DEBUG::_0xD9911C7B5F8CD69C(40, 158, "ADD_QUEUED_ITEM_DISPLAY: Failed to find a valid texture for item ", func_163(bParam0, 0));
		return;
	}
	...
	if (func_160(bParam0, 1816585950))
	{
	...
	bVar18 = func_185(bParam0, 0);
	if ((func_186(iVar12) && func_160(bParam0, -306684263)) && bVar18 != 0)
	{
		bVar18 = func_187(bParam0);
	}
	else if (func_161(bParam0) == joaat("CLOTHING"))
	{
		bVar19 = func_188(bParam0);
		if (func_176(bVar19, 0))
		{
			bVar18 = func_185(bVar19, 0);
		}
	...
	if (func_189(bParam0, 1443104131) && iParam3)
	{
		iVar20 = 1;
		func_190(bParam0, -915411861, &iVar20, 0);
	...
	sVar21 = func_191(MISC::_CREATE_VAR_STRING(10, &cVar2, MISC::_CREATE_VAR_STRING(0, bVar18), iVar1), iVar13);
	if (iParam1 == 1)
	{
	...
	{
		sVar21 = MISC::_CREATE_VAR_STRING(0, func_192(bParam0, -442898163));
	}
	if (iVar12 == -126813555 || iVar12 == 1946043663)
	{
		StringCopy(&cVar22, "", 128);
		if (func_193(bParam0, &cVar22))
		{
			sVar21 = func_195(func_194(cVar22), joaat("COLOR_PURE_WHITE"));
		}
	}
	DEBUG::_0xF0783374333FD8CE(174760, 158, "ADD_QUEUED_ITEM_DISPLAY: Adding - ", func_163(bParam0, 0), " with color ", func_196(iVar13, 0), " sound ", sVar14, " set ", sVar15);
...
{
	DEBUG::_0xF0783374333FD8CE(680, 191, "HERB_SET_VOMIT_ANIM_SCENE: moving from ", func_199(*uParam0, 0), " to ", func_199(iParam1, 0));
	*uParam0 = iParam1;
}
...
{
	DEBUG::_0xF0783374333FD8CE(680, 191, "[HERB_SET_BLIP_STATE] moving from: ", func_200(uParam0->f_7, 0), " to: ", func_200(iParam1, 0));
	uParam0->f_7 = iParam1;
}
...
{
	return func_201(Global_1197038[iParam2 /*10*/][iParam0], iParam1);
}
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_202(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_133(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4)
{
...
void func_134(var uParam0, vector3 vParam1, bool bParam4, int iParam5, bool bParam6, int iParam7)
{
	if (!func_114(uParam0))
	{
...
int func_135(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	if (!func_176(bParam0, 0))
	{
		DEBUG::_0xD9911C7B5F8CD69C(168, 157, "GET_PLAYER_SATCHEL_ITEM_COUNT - Attempting to check for an invalid item ", func_163(bParam0, 0), " in the player's inventory!");
		UNK_0x355E72323AEE83CC(157, 6);
		return 0;
	}
	iVar1 = func_161(bParam0);
	if (iVar1 == joaat("AMMO") || (bParam1 && iVar1 == joaat("WEAPON")))
	{
		bVar2 = func_210(bParam0, 1);
		if (bVar2 != 0)
		{
	...
	{
		return func_211(bParam0, 0);
	}
	if (func_212(bParam0, joaat("DEFAULT")) != 0)
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_213(bParam2), bParam0, bParam3);
	}
	else
	{
		Var3 = { func_214(bParam0, bParam2) };
		if (!INVENTORY::_0xB881CA836CC4B6D4(&Var3))
		{
			DEBUG::_0x1B08D1EB9D8C4931(168, 157, "GET_PLAYER_SATCHEL_ITEM_COUNT - No GUID found for item ", func_163(bParam0, 0), ", returning 0");
			return 0;
		}
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_213(bParam2), &Var3, bParam3);
	}
	DEBUG::_0x1B08D1EB9D8C4931(648, 157, "GET_PLAYER_SATCHEL_ITEM_COUNT - Found ", iVar0, " of item ", func_163(bParam0, 0));
	return iVar0;
}
...
char* func_144(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case -2:
...
bool func_145(int iParam0)
{
	...
	while (iVar0 < Global_38.f_3538)
	{
		if (Global_38.f_3538[iVar0 /*3*/].f_2 == iParam0)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(168, 105, "IS_TIMED_TUTORIAL_DELAYED_OR_FINISHED time since last played tutorial ", func_144(iParam0, 0), " Seconds ", iVar2);
...
void func_150(int iParam0, int iParam1)
{
	...
	DEBUG::_0x4DC69742196F818A(680, 157, "HERB_SET_TYPE_FLAG - Setting :  ", func_79(iParam0, 0), " ", func_219(iParam1, 0));
}
...
void func_151(int iParam0, bool bParam1)
{
	...
	DEBUG::_0xF0783374333FD8CE(168, 191, "HERB_TYPE_UNLOCK_BLIPPING: herb type ", func_79(iParam0, 0), " has had blipping unlocked!");
	func_150(iParam0, 2);
	if (bParam1)
	{
		if (!func_152(0, 0, 1))
		{
			func_221(1, 1017438712);
		}
	}
}
...
bool func_152(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_223(func_4(0)))
	{
		return true;
	}
...
var func_157(var uParam0, var uParam1)
{
	var uVar0;
...
bool func_160(bool bParam0, bool bParam1)
{
	if (!func_176(bParam0, 0))
	{
		return func_228(func_227(bParam0), bParam1);
	}
	if (bParam1 == 0)
	{
		return false;
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[ITEM_HAS_PROPERTY_TAG] Found tag ", func_229(bParam1, 0), " for item ", func_163(bParam0, 0), ", returning TRUE");
		return true;
	}
	return false;
}
...
var func_163(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
...
var func_164(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
var func_165(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
float func_170(float fParam0, float fParam1)
{
	if (fParam1 != 0f)
	{
...
void func_171(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (fParam1 == 0f)
	{
		return;
...
float func_172(float fParam0, int iParam1)
{
	switch (iParam1)
	{
		case 0:
...
int func_173(int iParam0, char* sParam1, bool bParam2, bool bParam3)
{
	...
	DEBUG::_0xF0783374333FD8CE(2472, 84, "RPG_GLOBAL_SET_OVERPOWER_FOR_PLAYER_ATTRIBUTE - Attribute: ", func_239(iParam0, 0), " will be Overpowered this frame for  ", sParam1, " seconds");
	return func_240(iParam0, sParam1, bParam2, bParam3);
}

void func_174(float fParam0, bool bParam1)
{
	if (fParam0 > 10f)
	{
		fParam0 = 10f;
...
void func_178(bool bParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	while (iVar0 < Global_1913655.f_3)
	{
		if ((((Global_1913655.f_4[iVar0 /*6*/] == bParam0 && Global_1913655.f_4[iVar0 /*6*/].f_2 == bParam2) && Global_1913655.f_4[iVar0 /*6*/].f_3 == iParam3) && Global_1913655.f_4[iVar0 /*6*/].f_4 == iParam4) && Global_1913655.f_4[iVar0 /*6*/].f_5 == bParam5)
		{
			...
			DEBUG::_0xF0783374333FD8CE(2696, 158, "ADD_ITEM_TO_DELAYED_QUEUE: Adding - ", iParam1, "x ", func_163(bParam0, 0), " to existing entry ", iVar0);
			return;
		}
		iVar0++;
	}
	...
	{
		DEBUG::_0xF0783374333FD8CE(2696, 158, "ADD_ITEM_TO_DELAYED_QUEUE: Adding - ", iParam1, "x ", func_163(bParam0, 0), " to new entry ", Global_1913655.f_3);
...
bool func_182(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	Var3.f_2 = 5;
	Var3.f_18 = 8;
	DEBUG::_0x1B08D1EB9D8C4931(40, 158, "FIND_INVENTORY_ITEM_TEXTURE_UI_DATA - eItem = ", func_163(bParam0, 0));
	DEBUG::_0x1B08D1EB9D8C4931(40, 158, "FIND_INVENTORY_ITEM_TEXTURE_UI_DATA - eTextureType = ", func_243(iParam2, 0));
	...
	if (ITEMDATABASE::_ITEM_DATABASE_FILLOUT_UI_DATA(bParam0, &Var3))
	{
		...
		while (iVar0 < 5)
		{
			...
			else
			{
				...
				{
					DEBUG::_0x1B08D1EB9D8C4931(40, 158, "FIND_INVENTORY_ITEM_TEXTURE_UI_DATA: Skipping entry with type: ", func_243(Var3.f_2[iVar0 /*3*/].f_2, 0));
					Jump @489; //curOff = 268
				}
				...
				else
				{
					...
					DEBUG::_0x1B08D1EB9D8C4931(40, 158, "FIND_INVENTORY_ITEM_TEXTURE_UI_DATA:    Type: ", func_243(Var3.f_2[iVar0 /*3*/].f_2, 0));
	...
	{
		DEBUG::_0xD9911C7B5F8CD69C(40, 158, "FIND_INVENTORY_ITEM_TEXTURE_UI_DATA: Unable to fillout UI data for item ", func_163(bParam0, 0));
	}
	DEBUG::_0x9A6C65DDDBEC9C52(680, 158, "FIND_INVENTORY_ITEM_TEXTURE_UI_DATA: Unable to find texture of type ", func_243(iParam2, 0), " for item ", func_163(bParam0, 0));
	return false;
}

char* func_183(bool bParam0)
{
	if (func_160(bParam0, -1995062316))
	{
		return "collectible_arrowheads";
	}
	if (func_160(bParam0, 1239889275))
	{
		return "collectible_liquor_bottles";
	}
	if (func_160(bParam0, 143267379))
	{
		return "collectible_coins";
	}
	if (func_160(bParam0, -944041124))
	{
		return "colectible_heirlooms";
	}
	if (func_160(bParam0, 1562621600))
	{
		return "collectible_jewelry";
	}
	if (func_160(bParam0, -149719013))
	{
		return "collectible_bird_eggs";
	}
	if (func_160(bParam0, 1940829793))
	{
		return "collectible_tarot_cards";
	}
	if (func_160(bParam0, 781094263))
	{
		return "collectible_flowers";
	}
	if (((func_160(bParam0, -352095726) || func_160(bParam0, -2014783736)) || func_160(bParam0, -545064757)) || func_160(bParam0, 679186220))
	{
...
{
	if (func_160(bParam0, -189374246))
	{
		if (((func_244(bParam0, -1305775593) || func_244(bParam0, 1384151091)) || func_244(bParam0, 2075388272)) || func_244(bParam0, -1738780413))
		{
			return true;
		}
	}
	if (func_160(bParam0, -753854379) || func_160(bParam0, 173360570))
	{
		return true;
	}
	return false;
...
bool func_185(bool bParam0, bool bParam1)
{
	...
	iVar0 = func_245(bParam0, bParam1);
	if (iVar0 != 0)
	{
		return iVar0;
	}
...
bool func_188(bool bParam0)
{
	...
	Var1 = { func_247(-1591664384, -1591664384, 0, 0, 0, 0, -1, iVar0, 0) };
	if (func_248(Var1, &iVar11, &iVar12, 0))
	{
		iVar13 = 0;
		while (iVar13 < iVar12)
		{
			if (ITEMDATABASE::_0x8750F69A720C2E41(iVar11, iVar13, &bVar14) && func_249(bVar14))
			{
				func_250(iVar11);
				return bVar14;
			}
...
int func_189(bool bParam0, bool bParam1)
{
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[ITEM_HAS_INTERACTION_TAG] Found tag ", func_229(bParam1, 0), " for item ", func_163(bParam0, 0), ", returning TRUE");
		return 1;
	}
	return 0;
}

int func_190(bool bParam0, int iParam1, int iParam2, bool bParam3)
{
	struct<37> Var0;

	if (!func_176(bParam0, 0) && !func_251(func_227(bParam0), 2))
	{
	...
	if (!ITEMDATABASE::_ITEM_DATABASE_FILLOUT_ACQUIRE_COST(bParam0, iParam1, &Var0))
	{
		if (!bParam3)
		{
			DEBUG::_0xA308F935BDECCEC0(680, 158, "GET_ITEM_ACQUIRE_COST_OUTPUT_QUANTITY - Unable to find cost ", func_252(iParam1, 0), " for item ", func_163(bParam0, 0));
		}
		return 0;
	}
	if (!bParam3)
	{
		DEBUG::_0x4DC69742196F818A(168, 158, "GET_ITEM_ACQUIRE_COST_OUTPUT_QUANTITY - Found requested identifier of ", func_252(iParam1, 0), " with output quantity ", Var0.f_1);
	}
	*iParam2 = Var0.f_1;
	return 1;
}
...
bool func_192(bool bParam0, int iParam1)
{
	...
	bVar0 = func_253(bParam0, iParam1);
	if (bVar0 == 0)
	{
...
bool func_193(bool bParam0, char* sParam1)
{
	int iVar0;
	char cVar1[128];
	...
	StringCopy(sParam1, func_254(bParam0), 128);
	iVar0 = HUD::GET_LENGTH_OF_LITERAL_STRING(sParam1);
	if (!func_255(bParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(680, 162, "[GET_COUPON_FULL_NAME] Item: ", func_163(bParam0, 0), " is not a coupon or voucher. Setting name to ", sParam1);
		return false;
	}
	StringCopy(&cVar1, func_256(bParam0), 128);
...
char* func_194(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)
{
...
void func_205(int iParam0, int iParam1)
{
	...
	if (iParam1 < 1 || iParam1 > func_130(iVar0, iVar1))
	{
		DEBUG::_0x83407B92D46F25C3(559240, 0, "SET_TIMEOFDAY_DAY: Passed an invalid day [", iParam1, "] for the TIMEOFDAY's current month [", iVar0, "] for year ", iVar1, ". GET_NUMBER_OF_DAYS_IN_MONTH(eMonth, iYear) = ", func_130(iVar0, iVar1), ". Failed to set TIMEOFDAY.");
		return;
	}
...
bool func_209(int iParam0)
{
	...
	if (iVar5 < 1 || iVar5 > func_130(iVar4, iVar3))
	{
		return false;
	}
	return true;
...
bool func_210(bool bParam0, int iParam1)
{
	...
	if (!func_176(bParam0, 0))
	{
		DEBUG::_0x4423BBAB7EB2B96B(40, 158, "GET_AMMO_TYPE_FROM_SATCHEL_ITEM - Invalid item: ", func_163(bParam0, 0));
		return false;
	}
	...
	{
		func_258(bParam0, &uVar1, &uVar2);
		return uVar2;
	}
	DEBUG::_0x9A6C65DDDBEC9C52(168, 158, "GET_AMMO_TYPE_FROM_SATCHEL_ITEM - ", func_163(bParam0, 0), " does not map to a valid ammo item");
	return false;
}

char[] func_211(bool bParam0, bool bParam1)
{
	struct<14> Var0;
	int iVar14;
	char[] cVar15[8];
	...
	Var0 = { func_259(bParam0, -1591664384, -1591664384, -1591664384, 0, 0, 0) };
	if (bParam1)
	{
		func_261(&Var0, func_260(0));
	}
	if (!func_262(&Var0, &iVar14, &cVar15, 0))
	{
		DEBUG::_0x1B08D1EB9D8C4931(648, 157, "GET_PLAYER_WEAPON_ITEM_COUNT bCarriedOnly = ", bParam1, " - Found 0 of item ", func_163(bParam0, 0));
		return 0;
	}
	func_263(iVar14);
	DEBUG::_0x1B08D1EB9D8C4931(10376, 157, "GET_PLAYER_WEAPON_ITEM_COUNT bCarriedOnly = ", bParam1, " - Found ", cVar15, " of item ", func_163(bParam0, 0));
	return cVar15;
}
...
int func_212(bool bParam0, int iParam1)
{
	...
	if (func_251(func_227(bParam0), 2))
	{
...
struct<4> func_214(bool bParam0, bool bParam1)
{
	struct<5> Var0;

	Var0 = { func_264(bParam0, bParam1, 0) };
	return func_265(bParam0, Var0, Var0.f_4, bParam1);
}
...
int func_221(bool bParam0, int iParam1)
{
	...
	Global_0 = iParam1;
	DEBUG::_0x9A6C65DDDBEC9C52(40, 144, "MAKE_MULTIPLAYER_AUTOSAVE_REQUEST - request type: ", func_267(Global_0, 0));
	if (bParam0)
	{
		func_224(&Global_0, 8);
	}
...
bool func_222()
{
	...
	if (!func_223(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
{
	DEBUG::_0xF0783374333FD8CE(40, 144, "SET_SAVE_FLAG: setting flag - ", func_270(iParam1, 0));
...
int func_228(bool bParam0, bool bParam1)
{
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[BUNDLE_HAS_PROPERTY_TAG] Found tag ", func_229(bParam1, 0), " for bundle ", func_271(bParam0, 0), ", returning TRUE");
		return 1;
	}
	return 0;
}
...
float func_236(int iParam0, float fParam1, bool bParam2)
{
	...
	iVar0 = func_8();
	func_274(&iVar0, 0, 0, 0, 1, 0, 0);
	iVar1 = func_275(iParam0, 2);
	DEBUG::_0x1B08D1EB9D8C4931(8, 84, "_RPG_GLOBAL_APPLY_CORE_FIX_DEGRADE - Degrade Count: ", iVar1);
	if (func_132(iVar0, func_276(iParam0, 2), 1))
	{
		func_277(iParam0, 0, 2);
		iVar1 = 0;
		DEBUG::_0x1B08D1EB9D8C4931(8, 84, "_RPG_GLOBAL_APPLY_CORE_FIX_DEGRADE - Reseting Degrade Count to 0, it's a whole new day!");
		DEBUG::_0x1B08D1EB9D8C4931(40, 84, "_RPG_GLOBAL_APPLY_CORE_FIX_DEGRADE - Degrade Time of Day: ", func_278(iVar0));
		DEBUG::_0x1B08D1EB9D8C4931(40, 84, "_RPG_GLOBAL_APPLY_CORE_FIX_DEGRADE - Current Time of Day: ", func_278(func_276(iParam0, 2)));
	}
	if (iVar1 >= 2)
	{
		func_35(103, bParam2);
	...
	func_279(iParam0, func_8(), 2);
	func_277(iParam0, iVar1 + 1, 2);
	return fParam1;
}
...
float func_237(int iParam0, int iParam1)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_ATTRIBUTE_CORE_DISPLAY_STATE - Failed to retrieve Core Value for ", func_280(iParam0, 0), " Returning -1.0. This is really bad. ");
	return -1f;
}
...
int func_238(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)
{
	...
	if (func_281(iVar0, iParam0, fParam1))
	{
		...
		DEBUG::_0xA308F935BDECCEC0(10664, 84, "__RPG_GLOBAL_SET_PLAYER_ATTRIBUTE_CORE - Caching Player Attribute Core ", func_280(iParam0, 0), " Value Data. Setting to: ", fParam1, " Override Enabled: ", MISC::_0xF216F74101968DB0(func_284()));
		func_285(iParam0, fParam1, bParam4, iParam5);
	}
	return 1;
}
...
int func_240(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	...
	iVar1 = PLAYER::PLAYER_PED_ID();
	DEBUG::_0xF0783374333FD8CE(2472, 84, "__RPG_GLOBAL_SET_OVERPOWER_FOR_PLAYER_ATTRIBUTE_INTERNAL - Attribute: ", func_239(iParam0, 0), " will be Overpowered this frame for  ", fParam1, " seconds on local player...");
	if (fParam1 == -1f)
	{
		if (func_286(iParam0))
		{
	...
	{
		DEBUG::_0x6D2A5155B260E879(2472, 84, "__RPG_GLOBAL_SET_OVERPOWER_FOR_PLAYER_ATTRIBUTE_INTERNAL - Attribute: ", func_239(iParam0, 0), " was set to a Duration of: ", fParam1, " this is really bad. Correct this. ");
		return 0;
	}
	switch (iParam0)
	{
		...
		case 1:
			...
			func_288(joaat("STATUS_EFFECT__TRACKING"));
			func_169(-1);
			ATTRIBUTE::ENABLE_ATTRIBUTE_OVERPOWER(iVar1, iParam0, fParam1, bParam3);
		...
		case 2:
			...
			break;
		case 19:
			func_288(joaat("STATUS_EFFECT__POISON"));
			func_289(0, 1, 1);
			ATTRIBUTE::ENABLE_ATTRIBUTE_OVERPOWER(iVar1, iParam0, fParam1, bParam3);
		...
		case 20:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(168, 84, "__RPG_GLOBAL_SET_OVERPOWER_FOR_PLAYER_ATTRIBUTE_INTERNAL - Attribute: ", func_239(iParam0, 0), " cannot be overpowered... Why are you doing this?");
			return 0;
	}
	return 1;
}
...
bool func_241()
{
	...
	return func_74(Global_1957252.f_1431.f_107, 0);
}
...
void func_242(float fParam0, bool bParam1)
{
	...
	fVar0 = func_290(13, 2);
	iVar1 = func_291(fVar0);
	fVar0 = (fVar0 + fParam0);
	fVar0 = func_292(fVar0, 0f, 100f);
	iVar2 = func_291(fVar0);
	...
	if (iVar1 != iVar2)
	{
		...
		func_73(&(Global_1957252.f_1431.f_107), 0, 0, 1, 0, 0, 0, 0);
	}
	func_293(13, fVar0, 2);
...
int func_244(bool bParam0, bool bParam1)
{
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[ITEM_HAS_FOLDER_TAG] Found tag ", func_229(bParam1, 0), " for item ", func_163(bParam0, 0), ", returning TRUE");
		return 1;
	}
	return 0;
}
...
struct<10> func_247(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	struct<10> Var0;
...
bool func_248(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, int iParam10, int iParam11, char* sParam12)
{
	...
	if (ITEMDATABASE::_ITEM_DATABASE_FILLOUT_TAG_DATA(bParam0, &Var0, &iVar42, 20))
	{
		...
		while (iVar43 < iVar42)
		{
			if (Var0[iVar43 /*2*/].f_1 == iParam1)
			{
				...
				DEBUG::_0x4DC69742196F818A(10920, 158, "[INVENTORY_ITEM__HAS_TAG_OF_TYPE] Found tag type ", func_294(iParam1, 0), " for item ", func_163(bParam0, 0), ", returning tag : ", func_229(bVar41, 0));
				return bVar41;
			}
			iVar43++;
		}
...
char* func_254(bool bParam0)
{
	...
	bVar0 = func_185(bParam0, 0);
	if (bVar0 == 0)
	{
		DEBUG::_0xD9911C7B5F8CD69C(40, 158, "GET_ITEM_NAME - No name specified for ", func_163(bParam0, 0));
		return "";
	}
...
char* func_256(bool bParam0)
{
	...
	if (iVar0 == 0)
	{
		DEBUG::_0xD9911C7B5F8CD69C(40, 158, "GET_ITEM_ALT_NAME - No AltName specified for ", func_163(bParam0, 0));
		return "";
	}
...
void func_258(bool bParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
struct<14> func_259(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6)
{
	struct<14> Var0;
	...
	{
		Var0 = bParam0;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - Item:      ", func_163(bParam0, 0));
	}
	if (bParam1 != 0 && bParam1 != -1591664384)
	{
		Var0.f_1 = bParam1;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eSlot:     ", func_295(bParam1, 0));
	}
	if (bParam2 != 0 && bParam2 != -1591664384)
	{
		Var0.f_2 = bParam2;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eFitsSlot: ", func_295(bParam2, 0));
	}
	if (bParam3 != 0 && bParam3 != -1591664384)
	{
		Var0.f_3 = bParam3;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eHasSlot:  ", func_295(bParam3, 0));
	}
	if (bParam4 != 0)
	{
		Var0.f_4 = bParam4;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eCategory: ", func_296(bParam4, 0));
	}
	if (bParam5 != 0)
	{
		Var0.f_5 = bParam5;
	...
	{
		Var0.f_8 = iParam6;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eItemGroup:  ", func_162(iParam6, 0));
	}
	return Var0;
}
...
struct<4> func_260(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		if (!INVENTORY::_0xB881CA836CC4B6D4(&(Global_1272425.f_4)))
		{
			...
			Global_1272425.f_4 = { func_265(923904168, func_297(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		if (!INVENTORY::_0xB881CA836CC4B6D4(&(Global_1272425.f_16)))
		{
			...
			Global_1272425.f_16 = { func_265(923904168, func_297(bParam0), -740156546, 0) };
		}
		return Global_1272425.f_16;
	}
	return func_265(923904168, func_297(bParam0), -740156546, 0);
}

void func_261(var uParam0, struct<4> Param1)
{
...
bool func_262(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_213(bParam3), uParam0, sParam2);
	if (*iParam1 >= 0)
	{
...
struct<5> func_264(bool bParam0, bool bParam1, bool bParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 157, "PLAYER_INVENTORY_GET_DEFAULT_ITEM_SLOT_INFO - eInventoryItem = ", func_163(bParam0, 0));
	DEBUG::_0x1B08D1EB9D8C4931(40, 157, "PLAYER_INVENTORY_GET_DEFAULT_ITEM_SLOT_INFO - eInvItemGroup = ", func_162(iVar5, 0));
	switch (iVar5)
	{
		case joaat("CLOTHING"):
			Var0 = { func_265(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			{
				Var6.f_9 = -1591664384;
				if (!func_299(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_299(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_300(bParam0, &Var6, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
		case joaat("DOG"):
			if (func_302(bParam0, -1823706425))
			{
				Var0 = { func_265(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, joaat("KIT_CAMP"));
			}
			else if (func_302(bParam0, -1483207246))
			{
				Var0 = { func_265(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, joaat("WARDROBE"));
			}
			...
			else if (func_302(bParam0, -1653629781))
			{
				Var0 = { func_265(1384535894, Var0, 1784584921, bParam1) };
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(bParam0, -833319691))
			{
				...
				if (!func_303(Var0, &Var28, bParam1, 0, -1))
				{
			...
			else
			{
				...
				if (Var0.f_4 == 0)
				{
					DEBUG::_0xD9911C7B5F8CD69C(40, 157, "PLAYER_INVENTORY_GET_DEFAULT_ITEM_SLOT_INFO - Unable to find an approprite default slot for item ", func_163(bParam0, 0));
				}
			}
			break;
	}
	DEBUG::_0xA308F935BDECCEC0(10920, 157, "PLAYER_INVENTORY_GET_DEFAULT_ITEM_SLOT_INFO - ", func_163(bParam0, 0), ": ", func_295(Var0.f_4, 0), " - ", UNK_0xD2E4270E5D98EEE4(&Var0));
	return Var0;
}

struct<4> func_265(bool bParam0, var uParam1, bool bParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	struct<4> Var0;

	if (!func_176(bParam0, 0))
	{
		DEBUG::_0xD9911C7B5F8CD69C(2216, 157, "GET_PLAYER_INVENTORY_ITEM_GUID - Attempting to check for an invalid item ", func_163(bParam0, 0), " (", bParam0, ") in the player's inventory!");
		return Var0;
	}
...
bool func_273(int iParam0)
{
	...
	fVar0 = (func_306(iParam0) - PLAYER::_0xDF66A37936D5F3D9(iParam0));
	return fVar0 <= 1f;
}

void func_274(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = (iVar0 - iParam6);
	func_131(iParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}
...
int func_275(int iParam0, int iParam1)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_ATTRIBUTE_CORE_DEGRADE_COUNT - Failed to retrieve Core Degrade Count for ", func_280(iParam0, 0), " Returning -1. This is really bad. ");
	return -1;
}
...
int func_276(int iParam0, int iParam1)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_ATTRIBUTE_CORE_DEGRADE_TIME_OF_DAY - Failed to retrieve Core Degrade Time of Day for ", func_280(iParam0, 0), " Returning -1. This is really bad. ");
	return -15;
}
...
void func_277(int iParam0, char* sParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DEGRADE_COUNT - Setting Core Degrade Count for ", func_280(iParam0, 0), " Pool: ", func_307(iParam2), " to ", sParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DEGRADE_COUNT - Failed to set Core Degrade Count for ", func_280(iParam0, 0), " Pool: ", func_307(iParam2), ". This is really bad. ");
			break;
	}
}
...
void func_279(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(10920, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DEGRADE_TIME_OF_DAY - Setting Core Degrade Time of Day for ", func_280(iParam0, 0), " Pool: ", func_307(iParam2), " to ", func_278(iParam1));
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DEGRADE_TIME_OF_DAY - Failed to set Core Degrade Time of Day for ", func_280(iParam0, 0), " Pool: ", func_307(iParam2), ". This is really bad. ");
			break;
	}
}
...
bool func_281(int iParam0, int iParam1, float fParam2)
{
	...
	ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(iParam0, func_309(iParam1), BUILTIN::CEIL(fParam2));
	return true;
}
...
void func_282(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DISPLAY_TIME - Setting Core Display Time for ", func_280(iParam0, 0), " Pool: ", func_307(iParam2), " to ", iParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DISPLAY_TIME - Failed to set Core Display Time for ", func_280(iParam0, 0), " Pool: ", func_307(iParam2), ". This is really bad. ");
			break;
	}
}
...
void func_283(int iParam0, int iParam1, float fParam2)
{
	...
	{
		PED::_SET_PED_BLACKBOARD_FLOAT(iParam0, func_311(iParam1), fParam2, -1);
	}
	else
	{
		DEBUG::_0x6D2A5155B260E879(40, 84, "__RPG_GLOBAL_HANDLE_BLACKBOARD_FOR_ATTRIBUTE - INVALID BLACK BOARD NAME for Attribute Core: ", func_280(iParam1, 0));
	}
}
...
void func_285(int iParam0, char* sParam1, bool bParam2, int iParam3)
{
	char* sVar0;
	...
	DEBUG::_0xA308F935BDECCEC0(43432, 84, "__RPG_GLOBAL_CACHE_ATTRIBUTE_CORE_DATA - Caching Attribute Core ", func_280(iParam0, 0), " Value Data. Setting to: ", sParam1, " Override Enabled: ", MISC::_0xF216F74101968DB0(func_284()), " Time Stamp: ", sVar0);
	func_312(iParam0, sParam1, iParam3);
	if (bParam2)
	{
		func_313(iParam0, sVar0, iParam3);
	}
}
...
char* func_287(int iParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(168, 84, "RPG_GLOBAL_GET_OVERPOWER_POSTFX_STRING_FOR_ATTRIBUTE - Attribute: ", func_239(iParam0, 0), " does not have an overpower post fx... Returning NULL ");
	return "";
}
...
void func_288(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 84, "RPG_GLOBAL__DISABLE_ALL_STATUS_EFFECT_SOURCES_OF_TYPE - Now disabling all Status Effects with Perk Group: ", func_314(iParam0, 0));
	iVar1 = Global_1146683.f_47689.f_1.f_42;
	iVar2 = 0;
	while (iVar2 < iVar1)
	{
		iVar0 = Global_1146683.f_47689.f_1[iVar2 /*2*/];
		iVar3 = func_315(iVar0, 1);
		if (Global_1146683.f_35859.f_919[iVar3 /*12*/] == iParam0)
		{
			DEBUG::_0xA308F935BDECCEC0(168, 84, "RPG_GLOBAL__DISABLE_ALL_STATUS_EFFECT_SOURCES_OF_TYPE - Disabling Source: ", func_316(Global_1146683.f_47689.f_1[iVar2 /*2*/], 0), " at index: ", iVar2);
			func_317(iVar0);
...
float func_290(int iParam0, int iParam1)
{
	...
	{
		case 0:
			DEBUG::_0x1B08D1EB9D8C4931(424, 84, "[RPG_GLOBAL_GET_CACHED_PLAYER_ATTRIBUTE_XP] Pool for Attributes: ", func_318(0, 0), " Value: ", Global_1957252.f_1431.f_26[iParam0]);
			return Global_1957252.f_1431.f_26[iParam0];
		case 1:
			DEBUG::_0x1B08D1EB9D8C4931(424, 84, "[RPG_GLOBAL_GET_CACHED_PLAYER_ATTRIBUTE_XP] Pool for Attributes: ", func_318(1, 0), " Value: ", Global_1957252.f_1565.f_2.f_26[iParam0]);
			return Global_1957252.f_1565.f_2.f_26[iParam0];
		default:
			break;
	}
	DEBUG::_0x6D2A5155B260E879(40, 84, "[RPG_GLOBAL_GET_CACHED_PLAYER_ATTRIBUTE_XP] Couldn't retrieve Cached Attribute XP data for Attribute: ", func_239(iParam0, 0));
	return -1f;
}
...
int func_293(int iParam0, char* sParam1, int iParam2)
{
	if (!func_319(iParam0))
	{
		return 0;
	...
	DEBUG::_0xA308F935BDECCEC0(10664, 84, "__RPG_GLOBAL_SET_PLAYER_ATTRIBUTE - Caching Attribute ", func_239(iParam0, 0), " XP Data. Setting to: ", sParam1, " Override Enabled: ", MISC::_0xF216F74101968DB0(func_284()));
	func_320(iParam0, sParam1, iParam2);
...
var func_295(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
struct<4> func_297(bool bParam0)
{
	...
	if (Global_1572887.f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				Global_1272425 = { func_265(joaat("CHARACTER"), func_321(), -1591664384, bParam0) };
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1272425.f_12 = { func_265(joaat("CHARACTER"), func_321(), -1591664384, 0) };
	...
	return func_265(joaat("CHARACTER"), func_321(), -1591664384, bParam0);
}
...
bool func_299(bool bParam0, var uParam1, int iParam2, int iParam3, bool bParam4)
{
	return func_323(bParam0, *uParam1, iParam2, iParam3, 1, bParam4) > 0;
}

bool func_300(bool bParam0, int iParam1, bool bParam2)
{
	var uVar0;

	if (func_324(bParam0, &uVar0, iParam1, bParam2))
	{
...
struct<4> func_301(bool bParam0)
{
	int iVar0;
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		if (!INVENTORY::_0xB881CA836CC4B6D4(&(Global_1272425.f_8)))
		{
			...
			Global_1272425.f_8 = { func_265(271701509, func_297(bParam0), 12999093, 0) };
		}
		return Global_1272425.f_8;
	}
	return func_265(271701509, func_297(bParam0), 12999093, 0);
}
...
bool func_303(var uParam0, var uParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, int iParam7)
{
...
{
	return func_327(&(Global_1957252.f_1565), iParam0, 1);
}
...
{
	return (PLAYER::_0x592F58BC4D2A2CF3(iParam0, 0) - IntToFloat(func_328(2)));
}
...
int func_309(int iParam0)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_PED_ATTRIBUTE_FROM_RPG_GLOBAL_CORE - Attribute Core: ", func_280(iParam0, 0), " does not have an associated PED Attribute. This is REALLY bad, correct immediately... ");
	return 0;
}
...
void func_312(int iParam0, char* sParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(6824, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_VALUE - Setting Core Value for ", func_280(iParam0, 0), " Pool: ", func_307(iParam2), " to ", sParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_VALUE - Failed to set Core Value for ", func_280(iParam0, 0), " Pool: ", func_307(iParam2), ". This is really bad. ");
			break;
	}
}
...
void func_313(int iParam0, char* sParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_LAST_UPDATED_TIMESTAMP - Setting Last Updated Timestamp for ", func_280(iParam0, 0), " Pool: ", func_307(iParam2), " to ", sParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_LAST_UPDATED_TIMESTAMP - Failed to set Last Updated Timestamp for ", func_280(iParam0, 0), " Pool: ", func_307(iParam2), ". This is really bad. ");
			break;
	}
}
...
int func_317(int iParam0)
{
	...
	if (!func_330(Global_1146683.f_35859.f_919[iVar0 /*12*/]))
	{
		return 1;
	}
	iVar3 = func_331(Global_1146683.f_35859.f_919[iVar0 /*12*/], 1);
	DEBUG::_0xA308F935BDECCEC0(2216, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Attempting to disable all Perks in Perk Group: ", func_314(Global_1146683.f_35859.f_919[iVar0 /*12*/], 0), " it has: ", Global_1146683.f_35859[iVar3 /*6*/].f_5, " perks...");
	iVar4 = 0;
	while (iVar4 < Global_1146683.f_35859[iVar3 /*6*/].f_5)
	{
		iVar1 = Global_1146683.f_35859[iVar3 /*6*/][iVar4];
		DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Disabling Perk: ", func_332(iVar1, 0), " from Source: ", func_316(iParam0, 0));
		switch (func_333(iParam0, iVar1))
		{
			case 0:
				DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - deactivating perk ", func_332(iVar1, 0), " directly");
				func_334(iVar1, iParam0, iVar4);
				break;
			case 1:
				iVar5 = 0;
				while (iVar5 < Global_1146683.f_35859.f_11700)
				{
					...
					{
						DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - removing perk ", func_332(iVar1, 0), " from the activation queue");
						func_334(iVar1, iParam0, iVar4);
						func_335(&(Global_1146683.f_35859.f_9503[iVar5 /*3*/]));
						...
						func_335(&(Global_1146683.f_35859.f_9503[Global_1146683.f_35859.f_11700 /*3*/]));
					}
					else
					{
						iVar5++;
				...
				break;
			case 2:
				DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - ignoring perk ", func_332(iVar1, 0), "...");
				Jump @1002; //curOff = 566
				iVar2 = func_336(iVar1, 1);
				DEBUG::_0xA308F935BDECCEC0(2216, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Perk: ", func_332(iVar1, 0), " currently has num sources: ", Global_1146683.f_35859.f_3116[iVar2 /*31*/].f_29, " remaining... ");
				func_337(iVar2, -1);
				DEBUG::_0xA308F935BDECCEC0(2216, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Perk: ", func_332(iVar1, 0), " has num sources: ", Global_1146683.f_35859.f_3116[iVar2 /*31*/].f_29, " remaining... ");
				if (Global_1146683.f_35859.f_3116[iVar2 /*31*/].f_29 <= 0)
				{
					func_338(iVar2, 0);
					DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - all sources for Perk: ", func_332(iVar1, 0), " have been removed, disabling it");
					iVar6 = 0;
					while (iVar6 < Global_1146683.f_35859.f_9502)
					{
						if (Global_1146683.f_35859.f_9302[iVar6] != iVar1)
						{
							DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Evaluated Perk: ", func_332(iVar1, 0), " does not equal perk in slot: ", func_332(Global_1146683.f_35859.f_9302[iVar6], 0));
						}
						else
						{
							DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Evaluated Perk: ", func_332(iVar1, 0), " matches perk in slot! ");
			...
			func_339(&(Global_1146683.f_35859.f_919[iVar0 /*12*/]));
			return 1;
		}
...
void func_320(int iParam0, float fParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(6824, 84, "__RPG_GLOBAL_SET_CACHED_ATTRIBUTE_XP - Setting Attribute XP for ", func_239(iParam0, 0), " Pool: ", func_307(iParam2), " to ", fParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_CACHED_ATTRIBUTE_XP - Failed to set Attribute XP for ", func_239(iParam0, 0), " Pool: ", func_307(iParam2), ". This is really bad. ");
			break;
	}
}
...
bool func_322()
{
	return (func_341(joaat("UPGRADE_OFFHAND_HOLSTER"), 0, 0, 0) > 0 && func_342(func_265(joaat("WARDROBE"), func_297(1), 1034665895, 1), -234132662, 1, -1) != 0);
}

int func_323(bool bParam0, struct<4> Param1, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	struct<4> Var1;
	...
	{
		DEBUG::_0x4DC69742196F818A(168, 157, "PLAYER_INVENTORY_GET_ITEM_COUNT - ", func_163(bParam0, 0), " doesn't have a default pathset, using supplied slot only");
		bParam7 = true;
	}
	iVar0 = 0;
	if (bParam7)
	{
		DEBUG::_0x1B08D1EB9D8C4931(43688, 157, "PLAYER_INVENTORY_GET_ITEM_COUNT - eInventoryItem: ", func_163(bParam0, 0), " sParentGUID: ", UNK_0xD2E4270E5D98EEE4(&Param1), " eSlot: ", func_295(bParam5, 0), " bPlayerOnly: ", bParam6);
		Var1 = { func_265(bParam0, Param1, bParam5, bParam6) };
		if (!INVENTORY::_0xB881CA836CC4B6D4(&Var1))
		{
			DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_GET_ITEM_COUNT - Unable to find GUID for item ", func_163(bParam0, 0));
			return 0;
		}
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_213(bParam6), &Var1, bParam8);
		DEBUG::_0xA308F935BDECCEC0(648, 157, "PLAYER_INVENTORY_GET_ITEM_COUNT - Found ", iVar0, " of item ", func_163(bParam0, 0));
	}
	else
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_213(bParam6), bParam0, bParam8);
		DEBUG::_0xA308F935BDECCEC0(648, 157, "PLAYER_INVENTORY_GET_ITEM_COUNT - Found total ", iVar0, " of item ", func_163(bParam0, 0));
	}
	return iVar0;
}

bool func_324(bool bParam0, int iParam1, int iParam2, bool bParam3)
{
	int iVar0;

	iVar0 = func_213(0);
	*iParam1 = { func_265(bParam0, func_260(0), bParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(iParam1))
	{
		DEBUG::_0xF0783374333FD8CE(2728, 139, "[SHOP_GET_INVENTORY_WEAPON_DATA] Invalid INVENTORY_ITEM_GUID for ", func_163(bParam0, 0), " eSlot: ", func_295(bParam3, 0), " iPlayerInventoryID: ", iVar0);
		return false;
	}
	if (!INVENTORY::_0x025A1B1FB03FBF61(iVar0, iParam1, iParam2, 22, 1))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[SHOP_GET_INVENTORY_WEAPON_DATA] We couldn't grab the data for ", func_163(bParam0, 0));
		return false;
	}
	return true;
}
...
bool func_326(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 157, "PLAYER_INVENTORY_GET_ITEM_DATA -  ItemId:      ", func_163(iParam1->f_4, 0));
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 157, "PLAYER_INVENTORY_GET_ITEM_DATA -  SlotId:      ", func_295(iParam1->f_9, 0));
...
int func_328(int iParam0)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_ATTRIBUTE_CORE_MAX_SIZE - Attribute Core: ", func_280(iParam0, 0), " is INVALID. Correct this immediately... ");
	return -1;
}
...
int func_333(int iParam0, int iParam1)
{
	...
	iVar2 = func_336(iParam1, 1);
	DEBUG::_0x1B08D1EB9D8C4931(10920, 84, "RPG_GLOBAL_STAT_GET_DEACTIVATION_TYPE - Source: ", func_316(iParam0, 0), " Perk: ", func_332(iParam1, 0), " Deactivation Trigger: ", func_344(Global_1146683.f_35859.f_3116[iVar2 /*31*/].f_1, 0));
...
int func_334(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_347(Global_1146683.f_35859.f_3116[iVar0 /*31*/]) && func_348(iParam0, Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK - Now checking Stack Group: ", func_349(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, 0), " for any perks that could be enabled now that this perk is diabled... ");
		vVar1 = { func_350(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4) };
		if (func_351(vVar1))
		{
			if (func_352(vVar1.x, vVar1.y, vVar1.z))
			{
				func_353(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, vVar1.x, vVar1.y, vVar1.z);
			}
			else
			{
				func_354(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4);
				DEBUG::_0x6D2A5155B260E879(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK - Failed to activate next availible perk in Stack Group: ", func_349(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, 0), " there was a critical failure... ");
			}
		}
		else
		{
			func_354(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4);
			DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK - No suitable replacement for active perk in Stack Group: ", func_349(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, 0), "...");
		}
	}
	return 1;
}
...
void func_337(int iParam0, int iParam1)
{
	...
	DEBUG::_0xF0783374333FD8CE(2216, 84, "__RPG_GLOBAL__ALTER_SOURCES_FOR_PERK_ID - Perk: ", func_332(func_355(iParam0, 1), 0), " is being altered by: ", iParam1, " to a total of: ", Global_1146683.f_35859.f_3116[iParam0 /*31*/].f_29);
}

void func_338(int iParam0, int iParam1)
{
	Global_1146683.f_35859.f_3116[iParam0 /*31*/].f_29 = iParam1;
	DEBUG::_0xF0783374333FD8CE(168, 84, "__RPG_GLOBAL__SET_SOURCES_FOR_PERK_ID - Perk: ", func_332(func_355(iParam0, 1), 0), " is being set to: ", Global_1146683.f_35859.f_3116[iParam0 /*31*/].f_29);
}
...
int func_341(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (func_356(bParam0) && !bParam2)
	{
		return WEAPON::GET_PED_AMMO_BY_TYPE(Global_33, bParam0);
	}
	return INVENTORY::_0xE787F05DFC977BDE(func_213(bParam1), bParam0, bParam3);
}

int func_342(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, int iParam6)
{
	return func_357(&uParam0, bParam4, bParam5, iParam6);
}
...
int func_346(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = func_315(iParam1, 1);
	iVar1 = func_336(iParam0, 1);
	iVar2 = func_331(Global_1146683.f_35859.f_919[iVar0 /*12*/], 1);
	if (Global_1146683.f_35859[iVar2 /*6*/][iParam2] != iParam0)
	{
		DEBUG::_0x9A6C65DDDBEC9C52(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK_INTERNAL - attempting to disable perk ", func_332(iParam0, 0), " from a source that hasn't previously enabled it ", func_316(iParam1, 0));
		return 0;
	}
	...
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK_INTERNAL - deactivating perk ", func_332(iParam0, 0), " and source ", func_316(iParam1, 0));
	...
	while (iVar4 < Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_16)
	{
		...
		else
		{
			...
			Global_1146683.f_2169[iVar5 /*205*/].f_201 = (Global_1146683.f_2169[iVar5 /*205*/].f_201 - func_362(&(Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			DEBUG::_0xA308F935BDECCEC0(6824, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK_INTERNAL - removing perk ", func_332(iParam0, 0), " to stat mod ", func_363(iVar3, 0), " with strength ", Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/].f_1);
			func_364(iVar3);
		}
		iVar4++;
	}
...
bool func_347(struct<5> Param0, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30)
{
	return Param0.f_4 != 0;
}
...
{
	if (!func_345(vParam0.x))
	{
		return false;
	}
	if (!func_329(vParam0.y))
	{
		return false;
	}
	if (!func_371(vParam0.z))
	{
		return false;
	}
	return true;
...
bool func_352(int iParam0, int iParam1, int iParam2)
{
	...
	if (Global_1146683.f_35859[iVar2 /*6*/][iParam2] != iParam0)
	{
		DEBUG::_0x9A6C65DDDBEC9C52(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - attempting to disable perk ", func_332(iParam0, 0), " from a source that hasn't previously enabled it ", func_316(iParam1, 0));
		return false;
	}
	...
	DEBUG::_0xA308F935BDECCEC0(2728, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK - activating perk ", func_332(iParam0, 0), " and source ", func_316(iParam1, 0), " at POSIX time: ", Global_1275959.f_21);
	...
	while (iVar4 < Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_16)
	{
		...
		else
		{
			...
			Global_1146683.f_2169[iVar5 /*205*/].f_201 = (Global_1146683.f_2169[iVar5 /*205*/].f_201 + func_362(&(Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			DEBUG::_0xA308F935BDECCEC0(6824, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - adding perk ", func_332(iParam0, 0), " to stat mod ", func_363(iVar3, 0), " with strength ", func_362(&(Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			DEBUG::_0xA308F935BDECCEC0(6824, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - adding perk ", func_332(iParam0, 0), " to stat mod ", func_363(iVar3, 0), " with total ", Global_1146683.f_2169[iVar5 /*205*/].f_201);
			func_372(iVar3);
		}
		iVar4++;
	}
	DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - perk: ", func_332(iParam0, 0), " Flag Count: ", Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_28);
	iVar7 = 0;
	while (iVar7 < Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_28)
	{
		iVar6 = Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_17[iVar7 /*2*/];
		if (!func_365(iVar6))
		{
			DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - Flag: ", func_373(iVar6, 0), " is not valid... skipping... ");
		}
		else if (!func_374(&(Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_17[iVar7 /*2*/])))
		{
			DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - Flag: ", func_373(iVar6, 0), " is not currently disabled by tunables... skipping... ");
		}
		else
		{
			iVar8 = func_366(iVar6, 1);
			...
			{
				DEBUG::_0xA308F935BDECCEC0(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - Turning on flag ", func_373(iVar6, 0));
	...
	func_376(Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_2);
	return true;
}
...
void func_353(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (!func_368(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA - Perk Group: ", func_349(iParam0, 0), " is not valid... Bailing out... ");
		return;
	}
	iVar0 = func_369(iParam0, 1);
	if (!func_345(iParam1))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA - Perk: ", func_332(iParam1, 0), " is not valid... Bailing out... ");
		return;
	}
	if (!func_329(iParam2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA - Source: ", func_316(iParam2, 0), " is not valid... Bailing out... ");
		return;
	}
	if (!func_371(iParam3))
	{
	...
	DEBUG::_0xF0783374333FD8CE(680, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA - Setting Perk: ", func_332(iParam1, 0), " active for Perk Group: ", func_349(iParam0, 0));
...
void func_354(int iParam0)
{
	...
	iVar0 = func_369(iParam0, 1);
	DEBUG::_0xF0783374333FD8CE(680, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA_AS_INVALID - Setting Perk: ", func_332(-1, 0), " active for Perk Group: ", func_349(iParam0, 0));
...
int func_357(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	struct<10> Var0;

	Var0.f_9 = -1591664384;
	if (func_377(iParam0, bParam1, &Var0, bParam2, iParam3))
	{
		DEBUG::_0x4DC69742196F818A(680, 157, "PLAYER_INVENTORY_GET_ITEM_EQUIPPED_IN_SLOT_BY_REF - Found ", func_163(Var0.f_4, 0), " equipped on item ", UNK_0xD2E4270E5D98EEE4(iParam0));
		return Var0.f_4;
	}
...
bool func_362(var uParam0)
{
	...
	if (uParam0->f_2 != 0)
	{
		DEBUG::_0xF0783374333FD8CE(168, 84, "RPG_GLOBAL_STATS_GET_STAT_MOD_IMPACT - Stat Mod: ", func_363(*uParam0, 0), " has a Tunable associated with impact, looking up... ");
		bVar0 = func_384(794259616, uParam0->f_2, uParam0->f_1, "");
		DEBUG::_0xF0783374333FD8CE(424, 84, "RPG_GLOBAL_STATS_GET_STAT_MOD_IMPACT - Stat Mod: ", func_363(*uParam0, 0), " has an associated Tunable with impact: ", bVar0);
		return bVar0;
	}
	DEBUG::_0xF0783374333FD8CE(424, 84, "RPG_GLOBAL_STATS_GET_STAT_MOD_IMPACT - Stat Mod: ", func_363(*uParam0, 0), " using default Impact: ", uParam0->f_1);
	return uParam0->f_1;
}
...
void func_364(int iParam0)
{
	...
	if (!func_361(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__UNSUBSCRIBE_STAT_MOD - Stat Mod: ", func_363(iParam0, 0), " is Invalid... ");
		return;
	}
	iVar0 = func_360(iParam0, 1);
	if (!func_385(Global_1146683.f_2169[iVar0 /*205*/]))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__UNSUBSCRIBE_STAT_MOD - no RPG stat associated with stat mod ", func_363(iParam0, 0));
		return;
	}
	...
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__UNSUBSCRIBE_STAT_MOD - stat mod ", func_363(iParam0, 0), " is no longer impacting stat ", func_386(Global_1146683.f_2169[iVar0 /*205*/], 0));
	Global_1146683.f_2169[iVar0 /*205*/].f_204 = 0;
	if (!func_387(Global_1146683.f_2169[iVar0 /*205*/].f_203))
	{
		return;
	}
	iVar1 = func_388(Global_1146683.f_2169[iVar0 /*205*/].f_203, 1);
	...
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__UNSUBSCRIBE_STAT_MOD - removing stat ", func_386(Global_1146683.f_2169[iVar0 /*205*/], 0), " from subscribed action ", func_389(Global_1146683.f_2169[iVar0 /*205*/].f_203, 0));
	iVar2 = 0;
...
void func_367(int iParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_STAT_FLAG - Now Disabling Stat Flag: ", func_373(iParam0, 0));
	iVar0 = PLAYER::PLAYER_PED_ID();
	...
	switch (iParam0)
	{
		...
		case joaat("TRAIL_EFFECT"):
			...
			GRAPHICS::_0xC5CB91D65852ED7E(func_392(iParam0));
			break;
		case joaat("DRAIN_EFFECT"):
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
		case joaat("SLOW_AND_STEADY_VFX"):
			DEBUG::_0xF0783374333FD8CE(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_STAT_FLAG - Remove VFX ", func_373(iParam0, 0));
			func_394(func_393(iParam0));
			break;
		case joaat("SLOW_AND_STEADY_AURA"):
		case joaat("MOMENT_TO_RECUPERATE_AURA"):
...
int func_370(int iParam0)
{
	...
	{
		iVar64 = func_336(Global_1146683.f_35859.f_9503[iVar65 /*3*/], 1);
		DEBUG::_0x1B08D1EB9D8C4931(168, 84, "RPG_GLOBAL_GET_ACTIVATION_QUEUE_PERK_INDEX_FROM_NEXT_AVAILIBLE_PERK_IN_STACK_GROUP - Now processing Perk: ", func_332(Global_1146683.f_35859.f_9503[iVar65 /*3*/], 0), "...");
		...
		else if (!func_397(Global_1146683.f_35859.f_9503[iVar65 /*3*/], Global_1146683.f_35859.f_9503[iVar65 /*3*/].f_1))
		{
		}
		else
		{
			Var1 = { func_398(Global_1146683.f_35859.f_9503[iVar65 /*3*/]) };
...
void func_372(int iParam0)
{
	...
	if (!func_361(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__SUBSCRIBE_STAT_MOD - Stat Mod: ", func_363(iParam0, 0), " is Invalid... ");
		return;
	}
	iVar0 = func_360(iParam0, 1);
	if (!func_385(Global_1146683.f_2169[iVar0 /*205*/]))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__SUBSCRIBE_STAT_MOD - no RPG stat associated with stat mod ", func_363(iParam0, 0));
		return;
	}
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__SUBSCRIBE_STAT_MOD - subcribing stat mod ", func_363(iParam0, 0), " to stat ", func_386(Global_1146683.f_2169[iVar0 /*205*/], 0));
	...
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__SUBSCRIBE_STAT_MOD - adding stat ", func_386(Global_1146683.f_2169[iVar0 /*205*/], 0), " to action ", func_389(Global_1146683.f_2169[iVar0 /*205*/].f_203, 0));
...
bool func_374(var uParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(680, 84, "RPG_GLOBAL_STATS_IS_STAT_FLAG_TUNABLE_ENABLED - Stat Flag: ", func_373(*uParam0, 0), " Associated Tunable: ", UNK_0x4379B6FA65D55295(uParam0->f_1));
	if (uParam0->f_1 != 0)
	{
		bVar0 = func_399(794259616, uParam0->f_1, 1, "");
		DEBUG::_0xF0783374333FD8CE(680, 84, "RPG_GLOBAL_STATS_IS_STAT_FLAG_TUNABLE_ENABLED - Stat Flag: ", func_373(*uParam0, 0), " is has Tunable Enabled State: ", MISC::_0xF216F74101968DB0(bVar0));
		return bVar0;
	}
	return true;
}
...
void func_375(int iParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_STAT_FLAG - Now Enabling Stat Flag: ", func_373(iParam0, 0));
	iVar0 = PLAYER::PLAYER_PED_ID();
	iVar1 = PLAYER::PLAYER_ID();
	switch (iParam0)
	{
		...
		case joaat("TRAIL_EFFECT"):
			...
			GRAPHICS::ANIMPOSTFX_PLAY(func_392(iParam0));
			break;
		case joaat("DRAIN_EFFECT"):
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			...
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_400(iParam0, 0));
			func_401(iVar2, 0, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_400(iParam0, 1));
			func_401(iVar2, 1, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_400(iParam0, 2));
			func_401(iVar2, 2, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_400(iParam0, 3));
			func_401(iVar2, 2, 1, iVar3, 0);
			break;
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
			DEBUG::_0xF0783374333FD8CE(8, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_STAT_FLAG - Moment to Recuperate VFX start. ");
			iVar2 = func_393(iParam0);
			func_401(iVar2, 3, 1, -1, 1);
			break;
		case joaat("SLOW_AND_STEADY_VFX"):
			DEBUG::_0xF0783374333FD8CE(8, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_STAT_FLAG - Slow and Steady VFX start. ");
			iVar2 = func_393(iParam0);
			func_401(iVar2, 4, 1, -1, 0);
			break;
		case joaat("MOMENT_TO_RECUPERATE_AURA"):
...
void func_376(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - Attempting to play Activation Sound: ", func_403(iParam0, 0));
	sVar0 = func_404(iParam0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - There is no sound name associated with Activation Sound: ", func_403(iParam0, 0), " not playing anything...");
		return;
	}
	DEBUG::_0x1B08D1EB9D8C4931(680, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - Found sound name: ", sVar0, " associated with Activation Sound: ", func_403(iParam0, 0));
	sVar1 = func_405(iParam0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - There is no sound set associated with Activation Sound: ", func_403(iParam0, 0), " not playing anything...");
		return;
	}
	DEBUG::_0x1B08D1EB9D8C4931(680, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - Found sound set: ", sVar1, " associated with Activation Sound: ", func_403(iParam0, 0));
	DEBUG::_0xF0783374333FD8CE(10920, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - Playing sound name: ", sVar0, " in sound set: ", sVar1, " for Activation Sound: ", func_403(iParam0, 0));
	AUDIO::_PLAY_SOUND_FROM_ENTITY(sVar0, Global_1275959.f_8, sVar1, false, 0, 0);
}

bool func_377(int iParam0, bool bParam1, int iParam2, bool bParam3, int iParam4)
{
	var uVar0;
	...
	{
		DEBUG::_0x9A6C65DDDBEC9C52(40, 157, "PLAYER_INVENTORY_GET_ITEM_DATA_EQUIPPED_IN_SLOT_BY_REF - nothing is equipped for slot ", func_295(bParam1, 0));
		return false;
	}
	if (!func_326(&uVar0, iParam2, bParam3, 0, iParam4))
	{
		DEBUG::_0xD9911C7B5F8CD69C(40, 157, "PLAYER_INVENTORY_GET_ITEM_DATA_EQUIPPED_IN_SLOT_BY_REF - failed to get equipment data for slot ", func_295(bParam1, 0));
		return false;
	}
	DEBUG::_0x1B08D1EB9D8C4931(10920, 157, "PLAYER_INVENTORY_GET_ITEM_DATA_EQUIPPED_IN_SLOT_BY_REF - ", func_163(iParam2->f_4, 0), " (", UNK_0xD2E4270E5D98EEE4(iParam2), ") is equipped in slot ", func_295(bParam1, 0));
	return true;
}
...
bool func_384(bool bParam0, bool bParam1, float fParam2, char* sParam3)
{
	struct<11> Var0;
	bool bVar22;

	if (func_406(bParam0, bParam1, &Var0))
	{
...
bool func_385(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(168, 84, "RPG_GLOBAL_STATS__ADD_STAT_ID_TO_UPDATE_QUEUE - adding stat ", func_386(iParam0, 0), " to update queue. Total stats in queue: ", Global_1146683.f_2165);
	return true;
}

char* func_386(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case -1:
...
void func_390()
{
	...
	{
		if (!func_201(Global_1277758[Global_1275959 /*87*/].f_86, 1))
		{
...
char* func_392(int iParam0)
{
	...
	DEBUG::_0x9A6C65DDDBEC9C52(168, 84, "RPG_GLOBAL_GET_STAT_FLAG_POSTFX_NAME - Stat Flag: ", func_373(iParam0, 0), " does not have a Post FX name. Should you set one up? ");
	return "";
}
...
int func_393(int iParam0)
{
	...
	DEBUG::_0x9A6C65DDDBEC9C52(168, 84, "RPG_GLOBAL_GET_STAT_FLAG_PTFX_SCRIPT_ID - Stat Flag: ", func_373(iParam0, 0), " does not have a Particle FX. Should you set one up? ");
	return 0;
}
...
bool func_397(int iParam0, int iParam1)
{
	...
	if (func_347(Global_1146683.f_35859.f_3116[iVar0 /*31*/]))
	{
		iVar3 = Global_1146683.f_35859.f_9286[func_369(iVar2, 1) /*3*/];
		Var4 = { func_398(iVar3) };
		if (iVar3 != iParam0 && Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_5 <= Var4.f_5)
		{
			DEBUG::_0x1B08D1EB9D8C4931(680, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - A stronger perk in the perk stack group: ", func_349(iVar2, 0), " is already active. Active Perk: ", func_332(iVar3, 0));
			return false;
		}
	}
	DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Evaluating Activation Trigger: ", func_407(Global_1146683.f_35859.f_3116[iVar0 /*31*/], 0), " for activation... ");
	switch (Global_1146683.f_35859.f_3116[iVar0 /*31*/])
	{
		...
		case 2116793692:
			DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_332(iParam0, 0), " can be activated! ");
			return true;
		case joaat("ENTER_FREEROAM_OR_COOP"):
			if (!func_408() && !func_409())
			{
				DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_332(iParam0, 0), " can only be activated when you are in Free Roam or running COOP. Returning FALSE. ");
				return false;
			}
			DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_332(iParam0, 0), " can be activated! ");
			return true;
		case -2010146101:
			if (!func_408())
			{
				DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_332(iParam0, 0), " can only be activated when you are in Free Roam. Returning FALSE. ");
				return false;
			}
			DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_332(iParam0, 0), " can be activated! ");
			return true;
		case joaat("ENTER_REVIVED_REMOTE"):
			...
			{
				DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_332(iParam0, 0), " can only be activated from REMOTE players. Returning FALSE. ");
				return false;
			}
			DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_332(iParam0, 0), " can be activated from Remote Player Index: ", iVar1);
			return true;
		case -2129621195:
			iVar1 = func_343(iParam1);
			if (iVar1 == Global_1275959)
		...
		case joaat("ALLY_ENTER_DEADEYE"):
			...
			if (iVar1 != Global_1275959 && !func_410(Global_1275959.f_154[iVar1]))
			{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_332(iParam0, 0), " has no activation logic defined, fix this... ");
	return false;
}

struct<31> func_398(int iParam0)
{
	int iVar0;
...
bool func_399(bool bParam0, bool bParam1, bool bParam2, char* sParam3)
{
	struct<11> Var0;
	bool bVar22;
...
char* func_400(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case joaat("SLIPPERY_BASTARD_VFX"):
	...
	DEBUG::_0x9A6C65DDDBEC9C52(168, 84, "RPG_GLOBAL_GET_STAT_FLAG_PTFX_BONE - Stat Flag: ", func_373(iParam0, 0), " does not have a Particle FX bone. Should you set one up? ");
	return "";
}
...
bool func_406(bool bParam0, bool bParam1, var uParam2)
{
	struct<5> Var0;
	int iVar7;
	...
	if (DATAFILE::_0x44B3A36933AC009C(&iVar7, &Var0, joaat("NAME")))
	{
		*uParam2 = bParam0;
		...
		uParam2->f_10.f_3 = func_412(iVar7);
...
bool func_409()
{
	...
	if (func_413(Global_524288.f_40400))
	{
