...
void __EntryFunction__()
{
	fLocal_14 = 1f;
	fLocal_15 = 1f;
	DEBUG::_0xF0783374333FD8CE(8, 0, "********************* RUNNING GHOSTTOWN *********************");
	...
	DEBUG::_0xF0783374333FD8CE(8, 0, "********************* SHUTTING DOWN GHOSTTOWN *********************");
...
void func_1(int iParam0)
{
	...
	{
		DEBUG::_0xF0783374333FD8CE(8, 0, "GET_GAME_MODE() = ", func_5());
		MISC::NETWORK_SET_SCRIPT_IS_SAFE_FOR_NETWORK_GAME();
		DEBUG::_0xF0783374333FD8CE(8, 0, "Thread initialized with NUM_NETWORK_PLAYERS");
		MISC::SET_THIS_SCRIPT_CAN_BE_PAUSED(false);
		AUDIO::REGISTER_SCRIPT_WITH_AUDIO(1);
	}
	else if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(523))
	{
		DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": Force cleanup occurred -- ", &(Global_1887351[iParam0 /*36*/].f_23));
		func_4(iParam0);
...
void func_4(int iParam0)
{
	if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
	{
		...
		{
			case 45:
				DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_8(iParam0));
				STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_9(iParam0, 0), 1);
				break;
		}
	}
	...
	func_10(iParam0, 4);
	func_10(iParam0, 8);
	DEBUG::_0xF0783374333FD8CE(8, 0, "********************* TERMINATING GHOSTTOWN *********************");
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_6();
	}
