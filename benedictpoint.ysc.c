...
void __EntryFunction__()
{
	...
	DEBUG::_0xF0783374333FD8CE(43688, 17, "**** INITIALIZING REGION: ", &(Global_1887351[vScriptParam_0.x /*36*/].f_23), ", ", &(Global_1887351[iLocal_28 /*36*/].f_24), ", ", &(Global_1887351[iLocal_28 /*36*/].f_27), " ****");
	func_2();
	func_3();
	...
	while (func_4())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_27)
		{
			...
			{
				case 0:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_28 /*36*/].f_23), " global init...");
					if (Global_1901988.f_1.f_26 > 0)
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_28 /*36*/].f_23), "-> RBS_WAIT_FOR_UGC_EARLY_QUIT");
						iLocal_29 = (MISC::GET_GAME_TIMER() + Global_1901988.f_1.f_26);
						iLocal_26 = 1;
					}
					else
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_28 /*36*/].f_23), "-> RBS_INIT_REGION");
						iLocal_26 = 2;
					}
					break;
				case 1:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_28 /*36*/].f_23), " ugc early quit...");
					...
					break;
				case 2:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_28 /*36*/].f_23), " region init...");
					func_6(iLocal_28);
					func_7();
					func_8();
					...
					Global_1896632 = -1;
					DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_28 /*36*/].f_23), "-> RBS_INIT_VOLUME");
					iLocal_29 = (iLocal_25 + MISC::GET_GAME_TIMER());
					iLocal_26 = 3;
					break;
				case 3:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_28 /*36*/].f_23), " volume init...");
					if (func_13() || iLocal_29 < MISC::GET_GAME_TIMER())
					{
						func_14(iLocal_28);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_28 /*36*/].f_23), "-> RBS_LOAD_APPEARANCE");
						iLocal_29 = (MISC::GET_GAME_TIMER() + iLocal_25);
						iLocal_26 = 4;
					}
					break;
				case 4:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_28 /*36*/].f_23), " load appearance...");
					if (func_15(iLocal_28) || iLocal_29 < MISC::GET_GAME_TIMER())
					{
						func_16(iLocal_28);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_28 /*36*/].f_23), "-> RBS_LOAD_SPECIAL");
						iLocal_29 = (MISC::GET_GAME_TIMER() + iLocal_25);
						iLocal_26 = 5;
					}
					break;
				case 5:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_28 /*36*/].f_23), " load special...");
					if (func_17(iLocal_28) || iLocal_29 < MISC::GET_GAME_TIMER())
					{
						func_18(iLocal_28);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_28 /*36*/].f_23), "-> RBS_LOAD_PERS_CHARS");
						iLocal_29 = (iLocal_25 + MISC::GET_GAME_TIMER());
						iLocal_26 = 7;
					}
					break;
				case 7:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_28 /*36*/].f_23), " init regional chars...");
					if (func_10(func_9(iLocal_28)))
					{
						...
						else
						{
							if (func_20(iLocal_28) || iLocal_29 < MISC::GET_GAME_TIMER())
							{
								func_21(iLocal_28, 4);
								iLocal_29 = (MISC::GET_GAME_TIMER() + iLocal_25);
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_28 /*36*/].f_23), "-> RBS_INIT_AMBIENT");
								iLocal_26 = 8;
							}
							...
							{
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_28 /*36*/].f_23), " AMBIENT MINIGAMES ARE NOT BEING ENABLED AS A STORY OR RCM OR MISSION RETRY IS HAPPENING");
							}
							func_26();
							func_27();
							func_28();
							...
							func_31();
							func_32();
							DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": INIT_CURRENT_REGION_TOWN_DATA FOR ", &(Global_1887351[iLocal_28 /*36*/].f_23));
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_28 /*36*/].f_23), " RBS_INIT_AMBIENT -> RBS_INIT_LAW");
							iLocal_26 = 9;
							Jump @1356; //curOff = 1032
							func_33(iLocal_28);
							func_34();
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_28 /*36*/].f_23), "-> RBS_INIT_NAMED_LOCATIONS");
							iLocal_26 = 10;
							Jump @1356; //curOff = 1070
							func_35(&Global_1896686);
							func_36(iLocal_28, &Global_1896686);
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_28 /*36*/].f_23), "-> RBS_DONE_INIT");
							iLocal_26 = 11;
							Jump @1356; //curOff = 1116
							DEBUG::_0xF0783374333FD8CE(168, 17, "**** FINISHED INITIALIZING: ", &(Global_1887351[iLocal_28 /*36*/].f_23), " ****");
							func_37(iLocal_28);
							func_21(iLocal_28, 8);
							if (func_38(32))
							{
							...
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_28 /*36*/].f_23), "-> RBS_RUNNING");
							iLocal_26 = 12;
							...
							func_41(&Global_1896686, iLocal_28);
							func_42(iLocal_28);
							func_21(iLocal_28, 8);
							if (func_43())
							{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887351[iLocal_28 /*36*/].f_11);
							if (Global_1887351[iLocal_28 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887351[iLocal_28 /*36*/].f_12);
							}
							Jump @1356; //curOff = 1312
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_28 /*36*/].f_23), " RBS_CLEANUP");
							func_8();
							func_44(iVar0);
							iVar0++;
						}
						if (Global_1887351[iLocal_28 /*36*/].f_13 == 0)
						{
						}
						else
						{
							PED::_0x95423627A9CA598E(Global_1887351[iLocal_28 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
...
bool func_1()
{
	if (!bLocal_30)
	{
		if (Global_1051140)
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_28 /*36*/].f_23), ", g_mpUGC_QuitSessionRequest.bRequestRunning is still true");
			bLocal_30 = true;
			return true;
		}
		if (func_47() && func_48())
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_28 /*36*/].f_23), ", a session request is running and a UGC script is running");
			bLocal_30 = true;
			return true;
		}
	...
	if (func_48())
	{
		DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_28 /*36*/].f_23), ", content script still running for some player");
		return true;
	}
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_34, 0f, 0f, 0f) <= 5f || func_69(Global_1940410, 32768)) || func_69(Global_1940410, 16777216))
	{
		return;
	}
...
bool func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": REGION_TOWN_MANANGER_EXIT_TOWN FOR ", &(Global_1887351[iLocal_28 /*36*/].f_23));
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_28)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_82(iLocal_28));
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_83(iLocal_28, 0), 1);
					break;
			}
		}
		if (func_10(func_75()))
	...
	else
	{
		...
		if (func_45() == -1)
		{
			func_87(iLocal_28);
			func_88(iLocal_28);
			if (!func_89(iLocal_28, 0))
			{
				return false;
			}
		}
		else if (!func_90(iLocal_28))
		{
			return false;
		}
	}
	DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": Terminating. -- ", &(Global_1887351[iLocal_28 /*36*/].f_23));
	SCRIPTS::TERMINATE_THIS_THREAD();
	return true;
}
...
bool func_49(bool bParam0, bool bParam1)
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		{
			DEBUG::_0xF0783374333FD8CE(168, 8, "KILL_EVENT_CAUGHT - NETWORK_IS_GAME_IN_PROGRESS() = FALSE - but bIgnoreTransition = TRUE and g_mpTransition.eMPState = ", func_91(Global_1572887, 0), ", so skipping");
		}
		else
		{
...
{
	if (iParam0 == 9 && !(!func_100() && func_101()))
	{
		if (func_102(255))
		{
	...
	func_104(iParam0, 1);
	DEBUG::_0xF0783374333FD8CE(40, 139, "NET_ENABLE_SHOP_LOCATION: Registering ", func_105(iParam0));
	Global_1051777.f_80[iParam0 /*75*/] = 0;
	Global_1051777.f_80[iParam0 /*75*/].f_18 = func_106(iParam2, iParam0);
	...
	Global_1051777.f_80[iParam0 /*75*/].f_63 = func_107(Global_1051777.f_80[iParam0 /*75*/].f_18);
...
void func_59(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	...
	if (iVar0 < 0 || iVar0 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(40, 139, "[NET_ADD_SHOP_DOOR] - Invalid door index for shop: ", func_112(iParam0, 0));
		return;
	}
	Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0] = func_113(bParam1, 0, 0);
	if (func_114(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0]))
	{
		if (!func_115(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0]))
		{
			func_116(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0], 0, fParam2, bParam3, 1, 0, bParam4, 0);
		}
	}
...
int func_60(int iParam0, bool bParam1)
{
	...
	if ((func_117(iParam0, 16384) || func_117(iParam0, 32768)) || func_118(Global_1051777.f_80[iParam0 /*75*/].f_3))
	{
	...
	iVar0 = func_106(func_119(), iParam0);
...
void func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	...
	iVar0 = func_106(iParam3, iParam0);
	vVar1 = { func_123(iVar0) };
	vVar4 = { func_124(iVar0) };
	if (func_118(vVar1))
	{
		DEBUG::_0xD9911C7B5F8CD69C(8, 139, "ENABLE_SHOP_LOCATION: Shop position is zero! Cannot init.");
		return;
	}
	if (!func_125(16, 16384))
	{
		if (!func_97(iParam1))
		{
	...
	{
		DEBUG::_0x83407B92D46F25C3(680, 139, "[ENABLE_SHOP_LOCATION] Shop volume does not exist for shop: ", func_126(iVar0, 0), " in the region: ", func_127(iParam3, 0));
		return;
	}
	...
	DEBUG::_0xA308F935BDECCEC0(424, 139, "[ENABLE_SHOP_LOCATION] Setting prestream distance for: ", func_126(iVar0, 0), " to ", fParam7);
	...
	func_134(Global_1915867.f_3[iParam0 /*447*/].f_9);
	func_135(iParam0, 16);
	func_136(iParam0, 4);
	VOLUME::_0x748C5F51A18CB8F0(1);
	DEBUG::_0xF0783374333FD8CE(40, 139, "ENABLE_SHOP_LOCATION: Enabling shop: ", func_126(Global_1915867.f_3[iParam0 /*447*/].f_9, 0));
}
...
{
	Global_1960427.f_129[iParam0 /*3*/] = { vParam1 };
	Global_1960427.f_250[iParam0] = fParam4;
}
...
int func_64(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == 0)
	{
		DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_140(iParam0), " IS INVALID.");
		return 0;
	}
	DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_140(iParam0), " IS VALID.");
...
void func_68(int iParam0, int iParam1, var uParam2)
{
	if (!*uParam2)
	{
		if (func_143(Global_33, iParam1, 0, 1, 0))
		{
			DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_SHOPS_HANDLE_VISITED_VOLUME] - Player visited volume for ", func_126(iParam0, 0));
			func_145(func_144(iParam0), 1);
			*uParam2 = 1;
		}
	}
	else if (!func_143(Global_33, iParam1, 0, 1, 0))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_SHOPS_HANDLE_VISITED_VOLUME] - Player left volume for ", func_126(iParam0, 0));
		*uParam2 = 0;
	}
}
...
bool func_71()
{
	return func_69(Global_1940410, 8192);
}
...
bool func_73(int iParam0)
{
	...
	return ((Global_1887351[iParam0 /*36*/].f_21 == 1 || Global_1887351[iParam0 /*36*/].f_21 == 2) && !func_146(iParam0));
}
...
void func_76(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	char* sVar1;
	char* sVar2;
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_127(iParam0, 0), " ", func_148(iParam1, 0), " ", func_149(bParam2, 0), " state ", func_150(iParam4, 0));
	UNK_0x355E72323AEE83CC(11, 6);
	sVar1 = func_151(iParam0, iParam1, bParam2, iParam4, bParam5, bParam3, &bVar0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_127(iParam0, 0), " or ", func_148(iParam1, 0), " or ", func_149(bParam2, 0));
	...
	if (!func_152(iParam4))
	{
		if (func_66(iParam0))
		{
			iParam4 = func_153(func_9(iParam0));
		}
		else
		{
			iParam4 = func_153(iParam1);
		}
	}
	if (func_152(iParam4))
	{
		iVar3 = func_154(iParam4);
	}
	if (bVar0 && bParam3)
	{
		sVar2 = func_156(func_155(bParam2));
	}
	else if ((func_157(iParam1, 2) || func_158(iParam4, 2)) && !Global_1893599.f_9)
	{
	...
	else if ((func_66(iParam0) && func_92(iParam0, 16777216)) && !Global_1893599.f_9)
	{
	...
	{
		iVar4 = func_160(func_159());
		iVar5 = func_161(func_159());
		if (iVar5 < 10)
		{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			{
				fVar7 = func_162(fVar7);
				sVar8 = "TIME_AND_TEMP_F";
			}
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_163(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_163(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_163(&cVar6, joaat("COLOR_PURE_WHITE")), func_163(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		Global_1893599.f_9 = 0;
	}
	DEBUG::_0xF0783374333FD8CE(680, 11, "DISPLAY_NAMED_LOCATION - Texture ", sVar1, " info ", sVar2);
	Global_1939313.f_145 = func_164(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_78(int iParam0, bool bParam1)
{
	...
	func_166(&Global_1940410, 16384);
	func_145(func_167(joaat("DISCOVERED"), joaat("AREAS")), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_145(func_167(joaat("DISCOVERED"), joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_145(func_167(joaat("DISCOVERED"), joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_145(func_167(joaat("DISCOVERED"), joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_145(func_167(joaat("DISCOVERED"), joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_145(func_167(joaat("DISCOVERED"), joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_145(func_167(joaat("DISCOVERED"), joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
bool func_89(int iParam0, bool bParam1)
{
	...
	if (func_96(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_169(Global_1896632.f_1, 16))
			{
				func_170(Global_1896632.f_1, 0);
			}
			Global_1896632.f_1++;
			iVar2++;
	...
	switch (iParam0)
	{
		...
		case 139:
			...
			*iParam2 = 851;
			...
			break;
		default:
			DEBUG::_0xA308F935BDECCEC0(40, 138, "Attempting to get regional character bounds for a region that doesn't have them yet ", func_82(iParam0));
			*iParam1 = -1;
			*iParam2 = -1;
			break;
	}
...
int func_99(int iParam0, bool bParam1)
{
	if (!func_97(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_140(iParam0), " is invalid");
		return 0;
	}
	if (!func_169(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_140(iParam0), " has not been initialized");
		return 0;
	}
	if (func_169(iParam0, 32) && !bParam1)
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_140(iParam0), " has been locked dead");
		...
		if (func_45() == -1)
		{
			if (func_169(iParam0, 2048))
			{
				...
				DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_140(iParam0), " has been revived!");
			}
	...
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_140(iParam0), " dead or not spawning, turn scenario groups off");
		return 0;
	}
	if (PERSCHAR::_0x800DF3FC913355F3(func_139(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Persistent character ", func_140(iParam0), " already exists");
		func_177(iParam0, 128);
		return 1;
	}
	func_176(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_175(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_139(iParam0));
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_140(iParam0), " perschar index created!");
	if (func_169(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_139(iParam0));
		func_177(iParam0, 2048);
	...
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_140(iParam0), " created.");
...
void func_103(bool bParam0, bool bParam1)
{
	...
	else
	{
		...
		func_184(0);
		func_185(&(Global_1102630.f_3849));
		...
		func_186(&(Global_1102630.f_3888));
	...
	func_187(Global_1102630.f_3849, 36);
	func_188(Global_1102630.f_3888, 36);
...
void func_104(int iParam0, bool bParam1)
{
	...
	DEBUG::_0x4DC69742196F818A(40, 139, "NET_CLEAR_SHOP ", func_112(iParam0, 0));
	bVar0 = (func_189(iParam0) && !bParam1);
	if (!bVar0 && !func_117(iParam0, 65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] - Shop keeper deleted for shop: ", func_105(iParam0));
		}
	...
	else if (func_190(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
	{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] Remove the script created scenario for: ", func_105(iParam0));
		if (TASK::_DOES_SCENARIO_POINT_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_6))
		{
	...
	if (iVar3 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "[NET_CLEAR_SHOP] - Shop: ", func_112(iParam0, 0), " current door count exceeds max door count.");
	...
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 139, "NET_CLEAR_SHOP: SPF_ALLOW_BLIP_OUT_OF_REGION for ", func_105(iParam0), " is kept; all other flags cleared.");
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_24) && func_195(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_CLEAR_SHOP] Removing relationship volume from shop ", func_112(iParam0, 0));
...
int func_107(int iParam0)
{
	...
	{
		Global_1051777.f_4480[iParam0] = func_199(iParam0);
	}
...
void func_109(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_SET_SHOP_TYPE_FLAG] ", func_105(iParam0), " flag ", func_200(iParam1));
	}
...
bool func_113(bool bParam0, bool bParam1, bool bParam2)
{
...
void func_116(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	func_113(bParam0, 0, 0);
	if (func_114(bParam0))
	{
		...
		if (bParam3)
		{
			func_203(bParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
{
	return func_208(iParam0, "sHash", iParam1, "fHeading", fParam2, "vPos", uParam3);
}

bool func_121(int iParam0, int iParam1, float fParam2, var uParam3)
{
	return func_208(iParam0, "sClosedHash", iParam1, "fClosedHeading", fParam2, "vClosedPos", uParam3);
}
...
void func_122(int iParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	...
	Global_1051777.f_80[iParam0 /*75*/].f_6 = func_209(iParam1, vParam2, uParam5, 0, 0, 0);
	...
	func_109(iParam0, 16384);
	DEBUG::_0xA308F935BDECCEC0(10920, 139, "[NET_ADD_SHOP_SCENARIO_AT_POINT] Creating scenario point: ", HUD::_GET_LABEL_TEXT_BY_HASH(iParam1), " for shop: ", func_112(iParam0, 0), " at: ", MISC::_0x6C4DBF553885F9EB(vParam2));
}
...
Vector3 func_124(int iParam0)
{
	...
	DEBUG::_0x9A6C65DDDBEC9C52(168, 221, "SHOP_GET_MAP_BLIP_LOCATION - No position found for shop: ", func_126(iParam0, 0), ", returning vector zero.");
	return 0f, 0f, 0f;
}

bool func_125(int iParam0, int iParam1)
{
	return func_210(Global_1915867.f_3[iParam0 /*447*/].f_5, iParam1);
}
...
void func_128(int iParam0)
{
	...
	if (func_97(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_211(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_212(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_213(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_135(iParam0, 536870912);
	iVar1 = func_137(iParam0);
	if (iVar1 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(2216, 139, "[SHOP_UNLOCK_DOORS] Shop: ", func_112(iParam0, 0), " door count is greater then the. Current door count: ", iVar1, " Max door count: ", 15);
		Global_1915867.f_3[iParam0 /*447*/].f_409 = 0;
	}
	else
	{
	...
	DEBUG::_0xF0783374333FD8CE(168, 139, "[CLEAR_SHOP] Shop: ", func_112(iParam0, 0), " has been cleared!");
}
...
bool func_129(int iParam0, int iParam1)
{
	...
	if (func_125(iParam0, 16384))
	{
		DEBUG::_0xF0783374333FD8CE(168, 139, "[SHOP_SET_SHOPKEEPER] Shop type: ", func_112(iParam0, 0), " is flagged to not require a shopkeeper.");
		return true;
	}
	if (!func_97(iParam1))
	{
	...
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[SHOP_SET_SHOPKEEPER] Failed to get the regional perchar ped index for shop ", func_112(iParam0, 0));
	}
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1915867.f_3[iParam0 /*447*/].f_25))
	{
		...
		func_64(iParam1, Global_1915867.f_3[iParam0 /*447*/].f_25, 1);
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1915867.f_3[iParam0 /*447*/].f_28))
	{
		...
		func_64(iParam1, Global_1915867.f_3[iParam0 /*447*/].f_28, 1);
...
bool func_138(int iParam0, bool bParam1)
{
	...
	if (!PERSCHAR::_0x800DF3FC913355F3(func_139(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - Checking if ", func_140(iParam0), " is alive when the perschar index is not created.");
		return false;
	}
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_215(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_140(iParam0), " does not have a ped spawned.");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(2216, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_140(iParam0), " being processed - ALIVE = ", !PERSCHAR::_0xEB98B38CA60742D7(func_139(iParam0)), "!");
...
bool func_143(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
...
struct<2> func_144(int iParam0)
{
	...
	return func_167(joaat("VISITED"), iVar0);
}
...
{
	if ((iParam0 == 22 || iParam0 == 39) && !func_221())
	{
		return true;
	}
	if (iParam0 == 66)
...
var func_149(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case joaat("RIOBRAVO"):
...
char* func_151(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893599.f_162)))
	{
		sVar0 = func_224(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_226(func_225(Global_34));
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		if (!func_227(iParam0) || func_228(44))
		{
			switch (iParam0)
			{
				case 2:
...
int func_154(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_229(PLAYER::PLAYER_ID()) };
...
char* func_163(char* sParam0, int iParam1)
{
	...
	return func_230(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}

var func_164(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	var uVar16;
...
void func_166(var uParam0, int iParam1)
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_231(iParam1, 0));
}
...
{
	DEBUG::_0x4DC69742196F818A(40, 195, "CLEAR_SALOON: Clearing ", func_232(iParam0));
	func_233(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_234(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
...
int func_170(int iParam0, bool bParam1)
{
	if (!func_97(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_140(iParam0), " is invalid");
		return 0;
	}
	if (!func_169(iParam0, 2))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_140(iParam0), " has not been initialized");
		return 0;
	}
	if (func_175(iParam0) == 0)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_140(iParam0), " doesn't exist");
		return 1;
	}
	if (!PERSCHAR::_0x800DF3FC913355F3(func_139(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_140(iParam0), " already destroyed");
		return 1;
	}
	if (func_169(iParam0, 1) && !bParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_140(iParam0), " is stolen, so it will be destoyed on release.");
		func_236(iParam0, 128);
		return 1;
	}
	func_177(iParam0, 129);
	func_237(iParam0);
	DEBUG::_0xA308F935BDECCEC0(40, 138, "DESTROY_REGIONAL_CHARACTER: Destroying ", func_140(iParam0));
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_139(iParam0));
	func_176(iParam0, 0);
	DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: ", func_140(iParam0), " destroyed.");
	return 1;
}
...
void func_173()
{
	...
	while (iVar0 <= 3)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ NET_CLEAR_BARTENDERS - Removed ", func_239(Global_1051777.f_3642[iVar0 /*19*/]));
...
void func_177(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_240(iParam1), " on ", func_140(iParam0));
}
...
bool func_178(int iParam0)
{
	...
	if (!func_169(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_140(iParam0), " has not been initialized");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(40, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_140(iParam0));
	return true;
}

bool func_179(struct<2> Param0)
{
	return func_241(Param0, 5, 8);
}
...
int func_182(int iParam0)
{
	...
	{
		DEBUG::_0xF0783374333FD8CE(680, 36, "CLEAR_NET_PLAYER_STATUS_FLAG - ", func_244(iParam0), " cleared by thread ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
		return 1;
	}
	return 0;
}
...
{
	func_245(iParam0);
	DEBUG::_0xF0783374333FD8CE(40, 37, "NET_SPECIAL_CAM__KILL - Setting new display to ", func_246(iParam0, 0));
	if (!func_247(1))
	{
	...
	else if (!func_248(128) && !func_249(19))
	{
		CAM::DO_SCREEN_FADE_OUT(iParam2);
	}
	if (bParam3 && func_250() == 4)
	{
...
{
	if (func_252(&(Global_1102630.f_4), iParam0, 5))
	{
		DEBUG::_0xF0783374333FD8CE(680, 36, "SET_NET_PLAYER_STATUS_FLAG - ", func_244(iParam0), " set by thread ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
		return 1;
	}
	return 0;
}
...
void func_187(struct<30> Param0, int iParam30)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, iParam30, "             outer.eType                     - ", func_253(Param0.f_17.f_9, 0));
	if (Param0.f_16)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, iParam30, "             inner.eType                     - ", func_253(Param0.f_6.f_9, 0));
	}
...
void func_188(struct<7> Param0, var uParam7, var uParam8, int iParam9)
{
...
void func_191(int iParam0, int iParam1)
{
	if (func_190(iParam0, iParam1))
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_105(iParam0), " flag ", func_200(iParam1));
	}
	Global_1051777.f_80[iParam0 /*75*/].f_1 = (Global_1051777.f_80[iParam0 /*75*/].f_1 - (Global_1051777.f_80[iParam0 /*75*/].f_1 && iParam1));
}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_FLAGS] ", func_105(iParam0));
	Global_1051777.f_80[iParam0 /*75*/].f_49 = 0;
}

bool func_195(int iParam0, int iParam1)
{
	return func_210(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}

void func_196(int iParam0)
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_SUPPORT_FLAGS] ", func_105(iParam0));
...
int func_199(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1139844.f_7) && !func_256(12, func_255(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
void func_203(bool bParam0, char* sParam1, bool bParam2, bool bParam3)
{
	if (func_114(bParam0))
	{
...
int func_208(int iParam0, char* sParam1, int iParam2, char* sParam3, float fParam4, char* sParam5, var uParam6)
{
	struct<4> Var0;

	Var0 = func_258();
	Var0.f_2 = -738708473;
	Var0.f_3 = func_255(iParam0);
	if (!DATAFILE::_DATAFILE_GET_DATA_NODE_INDEX(&(Var0.f_1), &Var0))
	{
		DEBUG::_0x4DC69742196F818A(40, 139, "[NET_GET_SHOP_AUTHOR_DATA_WITH_STRING] Could not fill out region node for: ", func_239(iParam0));
		return 0;
	}
	Var0.f_2 = -1407851228;
	...
	DEBUG::_0x4DC69742196F818A(1747624, 139, "[NET_GET_SHOP_AUTHOR_DATA_WITH_STRING] eShop = ", func_239(iParam0), ", ", sParam5, " = ", MISC::_0x6C4DBF553885F9EB(*uParam6), ", ", sParam3, " = ", *fParam4);
	return 1;
}

int func_209(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
void func_212(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that isnt stolen ", func_140(iParam0));
		return;
	}
	if (!func_169(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release an uninitialized regional character ", func_140(iParam0));
		return;
	}
	if ((!bParam4 && !func_211(iParam0)) && func_259(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that is stolen by a differnt script ", func_140(iParam0));
		return;
	}
	DEBUG::_0xF0783374333FD8CE(680, 138, "RELEASE_REGIONAL_CHARACTER: Regional character ", func_140(iParam0), " released by ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
	func_177(iParam0, 1);
	func_237(iParam0);
	if (func_260(func_175(iParam0)))
	{
		iVar0 = func_139(iParam0);
		if (!PERSCHAR::_0x800DF3FC913355F3(iVar0))
		{
			DEBUG::_0x9A6C65DDDBEC9C52(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character with no perschar index", func_140(iParam0));
			return;
		}
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being retasked ", func_140(iParam0));
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being destroyed on release ", func_140(iParam0));
		func_170(iParam0, 0);
	}
}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 139, "CLEAR_ALL_SHOP_TYPE_FLAGS: ", func_105(iParam0));
...
int func_220(int iParam0)
{
	...
	if (iVar0 == 0)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "@@ GET_SHOP_STAT_ITEM: STAT_ITEMS for shop ", func_126(iParam0, 0), " is missing, please Bug DD Shops and Stables.");
	}
	return iVar0;
}
...
bool func_223(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_265(func_56(0)))
	{
		return true;
	}
...
char* func_230(char* sParam0, int iParam1)
{
...
void func_235(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 195, "CLEAR_SALOON_CONFIG_FLAG: Clearing flag for ", func_270(iParam1, 0));
	func_271(&(Global_1940170.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_236(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_240(iParam1), " on ", func_140(iParam0));
}
...
void func_237(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar0, false))
		{
			...
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_140(iParam0), " set as no longer needed.");
		}
		else
		{
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_140(iParam0), " was asked to be set as no longer needed, but this script does not own the ped.");
		}
	}
...
bool func_241(struct<2> Param0, int iParam2, int iParam3)
{
	int iVar0;
...
bool func_242(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_273(&(Global_1102630.f_4), iVar0, 5);
	}
	if (iParam1 == func_274())
	{
		return func_273(&(Global_1102630.f_4), iVar0, 5);
	...
	{
		return func_273(&(Global_1100880[iParam1 /*53*/].f_4), iVar0, 5);
	}
...
bool func_256(int iParam0, char* sParam1, var uParam2)
{
	var uVar0;

	if (func_276(iParam0, sParam1, &uVar0))
	{
...
bool func_263()
{
	...
	if (!func_265(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_276(int iParam0, char* sParam1, var uParam2)
{
...
void func_277(var uParam0, int iParam1, var uParam2)
{
	...
	*uParam2 = iParam1;
	...
	{
		DEBUG::_0x83407B92D46F25C3(648, 84, "RETRIEVE_UNLOCK_DATA - Couldn't retrieve id at index ", uParam2->f_1, " of type ", func_286(iParam1, 0));
	}
	uParam0->f_2 = -2140901307;
...
int func_278(int iParam0)
{
	...
	DEBUG::_0xD9911C7B5F8CD69C(168, 139, "GET_SHOP_TYPE_FROM_SHOP - ", func_126(iParam0, 0), " undefined");
	return -1;
}
...
bool func_287(struct<2> Param0, var uParam2)
{
	if (!func_265(Param0))
	{
		return false;
