...
void func_2()
{
	...
	POPULATION::_0xB56D41A694E42E86(iLocal_20, 2228767, 0, false, -1, -1, 2);
	POPULATION::_0x18262CAFEBB5FBE1(iLocal_20, 2228767, 0, false, -1, -1, 0);
	func_12();
}
...
void func_5()
{
	if (BUILTIN::VDIST(Global_34, -573.6422f, 2709.223f, 320.4839f) < 100f)
	{
		switch (Global_1939807.f_314)
		{
			case 0:
				Global_1939807.f_313 = ENTITY::_0x6F3068258A499E52(joaat("P_VAL_GATE_SNOW01X"), -573.6422f, 2709.223f, 320.4839f, 11);
				Global_1939807.f_314 = 1;
				DEBUG::_0xA308F935BDECCEC0(8, 218, "UPDATE_WORLD_STATE -- ACTIVE Adler Ranch gate moving to WORLD_STATE_MAP_PIN_STATE_WAIT_FOR_PIN");
				break;
			case 1:
				if (ENTITY::_0x1FF441D7954F8709(Global_1939807.f_313))
				{
					ENTITY::SET_ENTITY_VISIBLE(ENTITY::_0x4735E2A4BB83D9DA(Global_1939807.f_313), false);
					ENTITY::SET_ENTITY_COMPLETELY_DISABLE_COLLISION(ENTITY::_0x4735E2A4BB83D9DA(Global_1939807.f_313), false, false);
					func_14(371690004);
					Global_1939807.f_314 = 2;
					DEBUG::_0xA308F935BDECCEC0(8, 218, "UPDATE_WORLD_STATE -- ACTIVE Adler Ranch gate moving to WORLD_STATE_MAP_PIN_STATE_HIDDEN");
				}
				break;
			case 3:
				Global_1939807.f_314 = 1;
...
bool func_6(int iParam0)
{
	...
	iVar0 = func_15(iParam0, 1);
	iVar1 = (iVar0 / 31);
	iVar2 = (iVar0 % 31);
	if (func_16(iVar1))
	{
		if (Global_1072032.f_19652.f_24 && !func_17(iParam0))
		{
			return false;
		}
...
void func_7()
{
	if (ENTITY::_0x1FF441D7954F8709(Global_1939807.f_313))
	{
		ENTITY::_0xD2B9C78537ED5759(Global_1939807.f_313);
	}
	Global_1939807.f_314 = 0;
}
...
int func_19(bool bParam0)
{
	...
	if (func_21())
	{
		DEBUG::_0x9A6C65DDDBEC9C52(168, 0, "REQUEST_IPL_HASH_SAFE - Could not request ", func_22(bParam0, 0), " b/c player is in the respawn sequence.");
		return 0;
	}
