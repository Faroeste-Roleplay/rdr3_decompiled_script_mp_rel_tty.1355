...
{
	DEBUG::_0xA308F935BDECCEC0(8, 201, "[SETUP_SHOW_ASSETS] -- Started");
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
...
bool func_103(var uParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1393[0]))
	{
		if (func_166(&(uParam0->f_1393[0]), uParam0->f_1385[0], func_165(0)))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] Stool INDEX: ", uParam0->f_1393[0]);
		}
		else
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "Stool was not created");
			return false;
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1393[1]))
	{
		if (func_166(&(uParam0->f_1393[1]), uParam0->f_1385[1], func_165(1)))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] Chair INDEX: ", uParam0->f_1393[1]);
		}
		else
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "Chair was not created");
			return false;
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1393[2]))
	{
		if (func_166(&(uParam0->f_1393[2]), uParam0->f_1385[2], func_165(2)))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] Chair^1 INDEX: ", uParam0->f_1393[2]);
		}
		else
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "Chair^1 was not created");
			return false;
		}
	}
	if (!func_167(uParam0, iVar0, 0, "PERFORMER"))
	{
		return false;
	}
	if (!func_167(uParam0, iVar0, 1, "CrowdMember"))
	{
		return false;
	}
