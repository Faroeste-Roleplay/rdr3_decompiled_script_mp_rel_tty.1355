...
int func_60(int iParam0, bool bParam1)
{
	...
	if ((!bParam1 && func_110(iVar0, &iVar1, &uVar2, &vVar3)) || (bParam1 && func_111(iVar0, &iVar1, &uVar2, &vVar3)))
	{
		func_112(iParam0, iVar1, vVar3, uVar2, 0);
...
{
	return func_177(iParam0, "sHash", iParam1, "fHeading", fParam2, "vPos", uParam3);
}

bool func_111(int iParam0, int iParam1, float fParam2, var uParam3)
{
	return func_177(iParam0, "sClosedHash", iParam1, "fClosedHeading", fParam2, "vClosedPos", uParam3);
}

void func_112(int iParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	if (bParam6)
	{
		MISC::GET_GROUND_Z_FOR_3D_COORD(vParam2, &(vParam2.f_2), false);
	}
	Global_1051777.f_80[iParam0 /*75*/].f_6 = func_178(iParam1, vParam2, uParam5, 0, 0, 0);
...
int func_177(int iParam0, char* sParam1, int iParam2, char* sParam3, float fParam4, char* sParam5, var uParam6)
{
	struct<4> Var0;
	...
	DEBUG::_0x4DC69742196F818A(1747624, 139, "[NET_GET_SHOP_AUTHOR_DATA_WITH_STRING] eShop = ", func_203(iParam0), ", ", sParam5, " = ", MISC::_0x6C4DBF553885F9EB(*uParam6), ", ", sParam3, " = ", *fParam4);
	return 1;
}

int func_178(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
bool func_250(int iParam0, char* sParam1, var uParam2)
{
	*uParam2 = Global_1139844.f_7;
	uParam2->f_2 = 1351168281;
	uParam2->f_3 = func_259(iParam0);
	uParam2->f_4 = sParam1;
...
void func_251(var uParam0, int iParam1, var uParam2)
{
	var uVar0;
...
bool func_261(struct<2> Param0, var uParam2)
{
	if (!func_229(Param0))
	{
		return false;
