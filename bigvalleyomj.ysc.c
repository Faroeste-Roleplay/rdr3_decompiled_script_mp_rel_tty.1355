...
bool func_13()
{
	if (func_45() != -1)
	{
		iLocal_19 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1250.937f, -607.247f, 101.083f, 0f, 0f, 34.99998f, 4.887809f, 3.929512f, 3.710694f, "m_volBGV_OldManJones");
		iLocal_20 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1250.937f, -607.247f, 101.083f, 0f, 0f, 34.99998f, 4.887809f, 3.929512f, 3.710694f, "m_volBGV_OldManJonesPrompt");
	}
	return true;
}
...
int func_59(int iParam0, bool bParam1)
{
	...
	if ((!bParam1 && func_107(iVar0, &iVar1, &uVar2, &vVar3)) || (bParam1 && func_108(iVar0, &iVar1, &uVar2, &vVar3)))
	{
		func_109(iParam0, iVar1, vVar3, uVar2, 0);
...
{
	return func_173(iParam0, "sHash", iParam1, "fHeading", fParam2, "vPos", uParam3);
}

bool func_108(int iParam0, int iParam1, float fParam2, var uParam3)
{
	return func_173(iParam0, "sClosedHash", iParam1, "fClosedHeading", fParam2, "vClosedPos", uParam3);
}

void func_109(int iParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	if (bParam6)
	{
		MISC::GET_GROUND_Z_FOR_3D_COORD(vParam2, &(vParam2.f_2), false);
	}
	Global_1051777.f_80[iParam0 /*75*/].f_6 = func_174(iParam1, vParam2, uParam5, 0, 0, 0);
	...
	DEBUG::_0xA308F935BDECCEC0(10920, 139, "[NET_ADD_SHOP_SCENARIO_AT_POINT] Creating scenario point: ", HUD::_GET_LABEL_TEXT_BY_HASH(iParam1), " for shop: ", func_159(iParam0, 0), " at: ", MISC::_0x6C4DBF553885F9EB(vParam2));
}
...
int func_173(int iParam0, char* sParam1, int iParam2, char* sParam3, float fParam4, char* sParam5, var uParam6)
{
	struct<4> Var0;
...
int func_174(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
bool func_246(int iParam0, char* sParam1, var uParam2)
{
...
bool func_257(struct<2> Param0, var uParam2)
{
	if (!func_225(Param0))
	{
		return false;
