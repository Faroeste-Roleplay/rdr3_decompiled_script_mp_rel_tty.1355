...
int func_93(int iParam0, bool bParam1)
{
	...
	if (func_126(iParam0, 32) && !bParam1)
	{
		...
		if (func_45() == -1)
		{
			...
			{
				PERSCHAR::_0x49A8C2CD97815215(func_95(iParam0));
			...
			PERSCHAR::_0xFCC6DB8DBE709BC8(func_95(iParam0));
		}
		return 0;
	}
	...
	if (PERSCHAR::_0x800DF3FC913355F3(func_95(iParam0)))
	{
	...
	func_134(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_133(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_95(iParam0));
...
bool func_94(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_137(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_96(iParam0), " does not have a ped spawned.");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(2216, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_96(iParam0), " being processed - ALIVE = ", !PERSCHAR::_0xEB98B38CA60742D7(func_95(iParam0)), "!");
	return !PERSCHAR::_0xEB98B38CA60742D7(func_95(iParam0));
}
...
void func_125(int iParam0)
{
	...
	if (func_91(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_154(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
...
int func_127(int iParam0, bool bParam1)
{
	...
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_95(iParam0));
	func_134(iParam0, 0);
...
void func_135(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_177(iParam1), " on ", func_96(iParam0));
}
...
void func_162(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_177(iParam1), " on ", func_96(iParam0));
}
