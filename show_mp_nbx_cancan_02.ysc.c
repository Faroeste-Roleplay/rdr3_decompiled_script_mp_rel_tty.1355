...
bool func_22(var uParam0)
{
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		...
		if (!ANIMSCENE::_DOES_ANIM_SCENE_EXIST(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)))
		{
			uParam0->f_1373 = ANIMSCENE::_CREATE_ANIM_SCENE(func_94(), 2, 0, true, true);
...
bool func_102(var uParam0)
{
	...
	if (!func_164(uParam0, iVar0, 0, "CS_CANCAN_01"))
	{
		return false;
	}
	if (!func_164(uParam0, iVar0, 1, "CS_CANCAN_02"))
	{
		return false;
	}
	if (!func_164(uParam0, iVar0, 2, "CS_CANCAN_03"))
	{
		return false;
	}
	if (!func_164(uParam0, iVar0, 3, "CS_CANCAN_04"))
	{
		return false;
	}
	if (!func_164(uParam0, iVar0, 4, "CS_CANCANMAN_01"))
	{
		return false;
	}
...
void func_107(bool bParam0, int iParam1, bool bParam2)
{
	...
	if (func_168(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != iParam1 || bParam2)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(680, 183, "SET_DOORSTATE_OF_DOOR_ID - Setting Door ID ", func_169(bParam0, 0), " to ", func_170(iParam1, 0));
...
int func_115(bool bParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12)
{
	...
	func_171(iVar0, bParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
char* func_118(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 201, "Projectionist playlist: ", func_172(iParam1, 0), " show: ", func_173(iParam0, 0));
...
{
	DEBUG::_0x1B08D1EB9D8C4931(40, 201, "[fireDance_02][CUSTOM_UPDATE_HOST] -- STATE: ", func_174(uParam0->f_1, 0));
	switch (uParam0->f_1)
	{
		case 0:
			func_175(&(uParam0->f_1), 32);
			break;
		case 32:
			if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false))
			{
				uParam0->f_3 = 1;
				func_91(uParam0, 1);
				func_175(&(uParam0->f_1), 33);
			}
			break;
		case 33:
			func_175(&(uParam0->f_1), 34);
			break;
		case 34:
		...
		case 37:
			...
			func_91(uParam0, 2);
			func_176(&(uParam0->f_27), 0);
			func_175(&(uParam0->f_1), 40);
			break;
		case 40:
			break;
	}
...
{
	DEBUG::_0x1B08D1EB9D8C4931(40, 201, "[fireDance_02][CUSTOM_UPDATE_CLIENT] -- STATE: ", func_174((uParam1[uParam2->f_1 /*18*/])->f_17, 0));
	switch ((uParam1[uParam2->f_1 /*18*/])->f_17)
	{
		case 0:
			func_177(&((uParam1[uParam2->f_1 /*18*/])->f_17), 32);
			break;
		case 32:
			if (uParam0->f_1 > 32)
			{
				func_177(&((uParam1[uParam2->f_1 /*18*/])->f_17), 33);
			}
			break;
		case 33:
			if (uParam0->f_1 > 33)
			{
				func_177(&((uParam1[uParam2->f_1 /*18*/])->f_17), 34);
			}
			break;
		case 34:
			if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)) > 0.978f)
			{
				func_177(&((uParam1[uParam2->f_1 /*18*/])->f_17), 37);
			}
			break;
		case 37:
			if (!func_13(uParam0->f_1358, 8388608))
			...
			func_18(&(uParam2->f_247), 32);
			func_177(&((uParam1[uParam2->f_1 /*18*/])->f_17), 40);
			break;
		case 40:
			break;
	}
...
void func_131(int iParam0)
{
	...
	iVar0 = func_178(iParam0, 1);
	iVar1 = (iVar0 / 31);
	iVar2 = (iVar0 % 31);
	MISC::CLEAR_BIT(&(Global_38.f_114[iVar1]), iVar2);
	DEBUG::_0xA308F935BDECCEC0(40, 218, "CLEAR_WORLD_STATE_FLAG: clearing world state - ", func_179(iParam0, 0));
	Global_1939807 = 0;
}
...
void func_134(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	...
	if (func_168(bParam0))
	{
		...
		if (bParam3)
		{
			func_181(bParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
			{
				func_182(bParam0, 1);
				UNK_0x355E72323AEE83CC(183, 9);
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking Door ID ", func_169(bParam0, 0));
			}
			else
			{
				func_183(bParam0, 1);
				UNK_0x355E72323AEE83CC(183, 9);
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking and making unbreakable Door ID ", func_169(bParam0, 0));
			}
		}
		else
		{
			func_184(bParam0, 1);
			UNK_0x355E72323AEE83CC(183, 9);
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Unlocking Door ID ", func_169(bParam0, 0));
		}
		if (bParam7)
		{
			DEBUG::_0x1B08D1EB9D8C4931(168, 183, "SET_STATE_OF_DOOR_ID - Treating Door ID ", func_169(bParam0, 0), " as shut.");
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 183, "SET_STATE_OF_DOOR_ID: Door with ID not registered by host yet ", func_169(bParam0, 0));
	}
}
...
int func_140(var uParam0, var uParam1, int iParam2)
{
	...
	if (!func_13(*uParam1, 1))
	{
		...
		{
			iVar3 = iVar0;
			if (func_190(uParam0[iVar0 /*5*/], func_188(iParam2), func_189(iParam2, iVar3), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 8))
	{
		...
		{
			iVar4 = iVar0;
			if (func_190(&(uParam0->f_31[iVar0 /*5*/]), func_192(iParam2), func_193(iParam2, iVar4), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 2048))
	{
		...
		{
			iVar5 = iVar0;
			if (func_190(&(uParam0->f_107[iVar0 /*5*/]), func_195(iParam2), func_196(iParam2, iVar5), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
	...
	{
		case 0:
			if (!func_13(*uParam1, 64) && func_190(&(uParam0->f_118[0 /*5*/]), func_197(iParam2, 0), func_198(iParam2, 0), 1065353216 /* Float: 1f */))
			{
				func_18(uParam1, 64);
			}
			if ((!func_13(*uParam1, 16384) && func_190(&(uParam0->f_118[1 /*5*/]), func_197(iParam2, 1), func_198(iParam2, 1), 1065353216 /* Float: 1f */)) && func_190(&(uParam0->f_118[2 /*5*/]), func_197(iParam2, 2), func_198(iParam2, 2), 1065353216 /* Float: 1f */))
			{
		...
		case 1:
			...
			if (!func_13(*uParam1, 2097152))
			{
				...
				{
					iVar6 = iVar0;
					if (func_190(&(uParam0->f_118[iVar0 /*5*/]), func_197(iParam2, 0), func_198(iParam2, iVar6), 1065353216 /* Float: 1f */))
					{
						iVar2++;
					}
					iVar0++;
...
void func_141(var uParam0, var uParam1, int iParam2)
{
	...
	{
		if (func_13(*uParam0, 2) && func_203(uParam1, func_200(uParam1), &(uParam1->f_229), func_201(uParam1), func_202(uParam1)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "WALL LIGHTS should be faded out");
			func_14(uParam0, 2);
		}
		if (func_13(*uParam0, 4) && func_205(uParam1, func_204(uParam1), &(uParam1->f_229), func_201(uParam1), func_202(uParam1)))
		{
	...
	{
		if (func_13(*uParam0, 16) && func_203(&(uParam1->f_31), func_206(uParam1), &(uParam1->f_232), func_207(uParam1), func_202(uParam1)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "STAGE LIGHTS should be faded out");
			func_14(uParam0, 16);
		}
		if (func_13(*uParam0, 32) && func_205(&(uParam1->f_31), func_208(uParam1), &(uParam1->f_232), func_207(uParam1), func_202(uParam1)))
		{
	...
	{
		if (func_13(*uParam0, 4096) && func_203(&(uParam1->f_107), func_209(uParam1), &(uParam1->f_235), func_210(uParam1), func_202(uParam1)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "BALCONY LIGHTS should be faded out");
			func_14(uParam0, 4096);
		}
		if (func_13(*uParam0, 8192) && func_205(&(uParam1->f_107), func_211(uParam1), &(uParam1->f_235), func_210(uParam1), func_202(uParam1)))
		{
	...
	if (iParam2 == 0)
	{
		...
		{
			if (func_13(*uParam0, 128) && func_214(&(uParam1->f_118[0 /*5*/]), func_212(uParam1), &(uParam1->f_238), func_213(uParam1), func_202(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE CENTER STAGE LIGHT should be faded out");
				func_14(uParam0, 128);
			}
			if (func_13(*uParam0, 256) && func_216(&(uParam1->f_118[0 /*5*/]), func_215(uParam1), &(uParam1->f_238), func_213(uParam1), func_202(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE CENTER STAGE LIGHT s should be faded in");
				func_14(uParam0, 256);
			}
			if (func_13(*uParam0, 512) && func_214(&(uParam1->f_118[0 /*5*/]), func_212(uParam1), &(uParam1->f_238), 0.5f, func_202(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE CENTER STAGE LIGHT s should be off");
				func_14(uParam0, 512);
			}
			if (func_13(*uParam0, 1024) && func_216(&(uParam1->f_118[0 /*5*/]), func_215(uParam1), &(uParam1->f_238), 0.5f, func_202(uParam1)))
			{
		...
		{
			if (func_13(*uParam0, 32768) && func_219(1, 2, &(uParam1->f_118), func_217(uParam1), &(uParam1->f_241), func_218(uParam1), func_202(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE RED LIGHTS should be faded out");
				func_14(uParam0, 32768);
			}
			if (func_13(*uParam0, 65536) && func_221(1, 2, &(uParam1->f_118), func_220(uParam1), &(uParam1->f_241), func_218(uParam1), func_202(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE RED LIGHTS should be faded in");
				func_14(uParam0, 65536);
			}
			if (func_13(*uParam0, 131072) && func_219(1, 2, &(uParam1->f_118), func_217(uParam1), &(uParam1->f_241), 0.5f, func_202(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE RED LIGHTS should be off");
				func_14(uParam0, 131072);
			}
			if (func_13(*uParam0, 262144) && func_221(1, 2, &(uParam1->f_118), func_220(uParam1), &(uParam1->f_241), 0.5f, func_202(uParam1)))
			{
		...
		{
			bVar0 = true;
			if (!func_203(&(uParam1->f_31), func_206(uParam1), &(uParam1->f_232), 0.1f, func_202(uParam1)))
			{
				bVar0 = false;
			}
			if (bVar0)
		...
		{
			bVar1 = true;
			if (!func_205(&(uParam1->f_31), func_208(uParam1), &(uParam1->f_232), 0.1f, func_202(uParam1)))
			{
				bVar1 = false;
			}
			if (bVar1)
	...
	if (iParam2 == 1)
	{
		...
		{
			if (func_13(*uParam0, 4194304) && func_203(&(uParam1->f_118), func_222(uParam1), &(uParam1->f_238), func_223(uParam1), func_202(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "SD MAGIC LANTERN / MOVIE Arch lights should be faded out");
				func_14(uParam0, 4194304);
			}
			if (func_13(*uParam0, 8388608) && func_205(&(uParam1->f_118), func_224(uParam1), &(uParam1->f_238), func_223(uParam1), func_202(uParam1)))
			{
...
{
	func_226(uParam0);
	func_226(&(uParam0->f_31));
	func_226(&(uParam0->f_107));
	func_226(&(uParam0->f_118));
	*uParam1 = 0;
}
...
{
	return func_227(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("VOLCYLINDER"), iParam0, iParam1);
}
...
bool func_164(var uParam0, int iParam1, int iParam2, char* sParam3)
{
...
bool func_167(bool bParam0, bool bParam1, bool bParam2)
{
	if (!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(bParam0))
	{
		if ((NETWORK::NETWORK_IS_IN_SESSION() && SCRIPTS::_DOES_THREAD_EXIST(Global_1051590.f_16[0])) && bParam1)
		{
			...
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add networked Door ", func_169(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
		else
		{
			OBJECT::_ADD_DOOR_TO_SYSTEM_NEW(bParam0, true, false, false, 0, 0, false);
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add Door ", func_169(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
	}
	...
	if (bParam2)
	{
		...
		DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Set door ", func_169(bParam0, 0), " able to change open ratio while locked");
		UNK_0x355E72323AEE83CC(183, 7);
	}
	return bParam0;
}
...
var func_169(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
void func_171(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
{
	DEBUG::_0xA308F935BDECCEC0(680, 201, "[GSMP_SET_INDIVIDUAL_SHOW_STATE_HOST] Changing from STATE: ,", func_174(*uParam0, 0), " TO STATE: ", func_174(iParam1, 0));
	*uParam0 = iParam1;
}
...
{
	DEBUG::_0xA308F935BDECCEC0(680, 201, "[GSMP_SET_INDIVIDUAL_SHOW_STATE_CLIENT] Changing from STATE: ,", func_174(*uParam0, 0), " TO STATE: ", func_174(iParam1, 0));
	*uParam0 = iParam1;
}
...
void func_181(bool bParam0, char* sParam1, bool bParam2, bool bParam3)
{
	if (func_168(bParam0))
	{
...
void func_182(bool bParam0, bool bParam1)
{
	if (func_168(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 2 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "LOCK_DOOR_ID - Locking Door ID ", func_169(bParam0, 0));
		}
	}
	else
	{
...
void func_183(bool bParam0, bool bParam1)
{
	if (func_168(bParam0))
	{
		...
		{
			DEBUG::_0x1B08D1EB9D8C4931(2216, 183, "SET_DOOR_ID_LOCKED_AND_UNBREAKABLE - Door ID ", func_169(bParam0, 0), " state = ", OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0), " pending state ", UNK_0x4BC2854478F3A749(bParam0));
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(bParam0, 1);
		}
	}
	else
...
void func_184(bool bParam0, bool bParam1)
{
	if (func_168(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 0 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "UNLOCK_DOOR_ID - Unlocking Door ID ", func_169(bParam0, 0));
		}
	}
	else
	{
...
bool func_190(var uParam0, bool bParam1, vector3 vParam2, int iParam5)
{
	if (uParam0->f_1 == 0)
	{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		DEBUG::_0x1B08D1EB9D8C4931(936, 201, "[SHOW_GET_LIGHT] Light not ready: ", func_237(bParam1, 0), " at position: ", &vParam2);
		return false;
	}
	uParam0->f_2 = 1f;
	return true;
...
bool func_214(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	float fVar0;
...
bool func_219(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	float fVar2;
...
var func_227(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	else
	{
		switch (iParam9)
		{
			case joaat("VOLCYLINDER"):
				iVar8 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_242());
				break;
			case joaat("VOLSPHERE"):
				iVar8 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_242());
				break;
			case joaat("VOLBOX"):
				iVar8 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_242());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_243(PLAYER::GET_PLAYER_TEAM(iVar5)));
	}
	...
	while (iVar2 < 32)
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(Global_1275959.f_154[iVar2]))
		{
			...
			if (!bVar3)
			{
				if (iVar9 & 8192 != 0 && func_245(iVar2) != 1)
				{
					bVar3 = true;
				}
			}
...
{
	DEBUG::_0xA308F935BDECCEC0(648, 28, "HORSE_SET_GENDER - pedHorse: ", sParam0, " eGender = ", func_247(iParam1, 0));
	if (iParam1 == 1)
	{
...
void func_238(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (uParam0->f_2 > fParam1 && uParam0->f_2 > uParam0->f_3)
		{
			...
			fVar0 = (fVar1 / fParam3);
			uParam0->f_2 = func_249(fParam1, uParam0->f_4, fVar0);
...
void func_239(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (uParam0->f_2 < fParam1 && uParam0->f_2 < uParam0->f_4)
		{
			...
			uParam0->f_2 = func_249(uParam0->f_3, fParam1, fVar0);
			if (uParam0->f_2 > fParam1)
			{
				uParam0->f_2 = fParam1;
			}
...
bool func_250(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_253(&(Global_1102630.f_4), iVar0, 5);
	}
	if (iParam1 == func_254())
	{
		return func_253(&(Global_1102630.f_4), iVar0, 5);
	...
	{
		return func_253(&(Global_1100880[iParam1 /*53*/].f_4), iVar0, 5);
	}
