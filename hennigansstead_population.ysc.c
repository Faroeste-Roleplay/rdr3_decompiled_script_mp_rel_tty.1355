...
bool func_4(bool bParam0, bool bParam1)
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		{
			DEBUG::_0xF0783374333FD8CE(168, 8, "KILL_EVENT_CAUGHT - NETWORK_IS_GAME_IN_PROGRESS() = FALSE - but bIgnoreTransition = TRUE and g_mpTransition.eMPState = ", func_10(Global_1572887, 0), ", so skipping");
		}
		else
		{
...
void func_5()
{
	...
	{
		if (!func_11(1167397384))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IMAP_STREAMING_EXTENTS(1736386364, Global_34))
			{
				func_12(1167397384);
			}
		}
	}
	else if (func_11(1167397384))
	{
		if (!STREAMING::_IS_POSITION_INSIDE_IMAP_STREAMING_EXTENTS(1736386364, Global_34))
		{
			func_13(1167397384);
...
void func_12(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 218, "SET_WORLD_STATE_FLAG: setting world state - ", func_18(iParam0, 0));
	Global_1939807 = 0;
}
...
void func_13(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 218, "CLEAR_WORLD_STATE_FLAG: clearing world state - ", func_18(iParam0, 0));
	Global_1939807 = 0;
}
