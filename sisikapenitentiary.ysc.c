...
bool func_13()
{
	...
	iLocal_16 = Global_1887351[33 /*36*/].f_5;
...
bool func_40(int iParam0)
{
	...
	if (bVar0 && func_65(255))
	{
		if (bVar1)
		{
			DEBUG::_0x9A6C65DDDBEC9C52(8, 11, "SisikaPenitentiary - Something set the respawn volume to kill.  You gonna die now.");
			func_66(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_DROWNING"), 0, 0);
		}
		else
		{
			DEBUG::_0x9A6C65DDDBEC9C52(8, 11, "SisikaPenitentiary - You are in Free Roam and on Sisika.  You are not supposed to be here.  To Saint Denis with you!");
			func_67(5, 0);
		}
	}
	return true;
...
bool func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_25)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_81(iLocal_25));
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_82(iLocal_25, 0), 1);
					break;
			}
		}
		if (func_10(func_74()))
	...
	else
	{
		...
		if (func_45() == -1)
		{
			func_86(iLocal_25);
			func_87(iLocal_25);
			if (!func_88(iLocal_25, 0))
			{
				return false;
			}
		}
		else if (!func_89(iLocal_25))
		{
			return false;
		}
	}
...
int func_53(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (!func_59(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Region index not valid ", func_92(iParam0));
		return 1;
	}
	if (func_91(iParam0, 16))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: RF_PERS_DISABLED is on for ", func_92(iParam0));
		return 1;
	}
	if (func_93(iParam0) && !func_94(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: IS_REGION_IN_LOCKDOWN is on for ", func_92(iParam0));
	}
	DEBUG::_0xF0783374333FD8CE(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Starting for ", func_92(iParam0));
	if (func_95(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if ((!func_93(iParam0) || func_94(iParam0)) || func_97(Global_1896632))
			{
				func_98(Global_1896632, 0);
			}
			Global_1896632++;
			iVar2++;
...
bool func_62()
{
	return func_101(Global_1572887.f_7, 1);
}
...
{
	return func_102(&(Global_3145858.f_6), iParam0);
}
...
void func_66(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(Global_1275959.f_8))
	{
		...
		func_104(&Var0, &(Global_1102630.f_3599));
...
void func_67(int iParam0, bool bParam1)
{
	...
	Var30.f_5 = 1;
	func_106(92);
	if (func_107(iParam0, &uVar0))
	{
		func_108(&uVar0, &Var30, 1, 1, 1);
		if (bParam1)
		{
			func_109(0);
		}
		DEBUG::_0xF0783374333FD8CE(40, 36, "NET_PLAYER_STATUS_FORCE_RESPAWN_IN_REGION - Respawning in ", func_110(iParam0, 0));
		return;
	}
	func_111(Var30.f_6, Var30, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, 1, 1, 1);
	if (bParam1)
	{
		func_109(0);
	}
	DEBUG::_0x9A6C65DDDBEC9C52(2728, 36, "NET_PLAYER_STATUS_FORCE_RESPAWN_IN_REGION - Couldn't load region data for ", func_110(iParam0, 0), ", respawning near ", MISC::_0x6C4DBF553885F9EB(Var30.f_6), ".");
}
...
bool func_72(int iParam0)
{
	...
	return ((Global_1887351[iParam0 /*36*/].f_21 == 1 || Global_1887351[iParam0 /*36*/].f_21 == 2) && !func_112(iParam0));
}
...
void func_75(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_110(iParam0, 0), " ", func_114(iParam1, 0), " ", func_115(bParam2, 0), " state ", func_116(iParam4, 0));
	...
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_110(iParam0, 0), " or ", func_114(iParam1, 0), " or ", func_115(bParam2, 0));
	...
	else if ((func_59(iParam0) && func_91(iParam0, 16777216)) && !Global_1893599.f_9)
	{
...
bool func_88(int iParam0, bool bParam1)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 138, "DELETE_ALL_REGIONAL_CHARACTERS starting for Region ", func_92(iParam0));
	if (func_95(iParam0, &iVar0, &iVar1, 0, 0))
	{
...
int func_98(int iParam0, bool bParam1)
{
	if (!func_96(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_144(iParam0), " is invalid");
		return 0;
	}
	if (!func_137(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_144(iParam0), " has not been initialized");
		return 0;
	}
	if (func_137(iParam0, 32) && !bParam1)
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_144(iParam0), " has been locked dead");
		...
		if (func_45() == -1)
		{
			if (func_137(iParam0, 2048))
			{
				...
				DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_144(iParam0), " has been revived!");
			}
			PERSCHAR::_0xFCC6DB8DBE709BC8(func_147(iParam0));
		}
		return 0;
	}
	if (!func_149(iParam0) && func_45() == -1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_144(iParam0), " dead or not spawning, turn scenario groups off");
		return 0;
	}
	if (PERSCHAR::_0x800DF3FC913355F3(func_147(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Persistent character ", func_144(iParam0), " already exists");
		func_148(iParam0, 128);
		return 1;
	}
	func_146(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_145(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_147(iParam0));
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_144(iParam0), " perschar index created!");
	if (func_137(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_147(iParam0));
		func_148(iParam0, 2048);
	...
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_144(iParam0), " created.");
...
bool func_105(char* sParam0, bool bParam1)
{
	char* sVar0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		if (func_154(sVar0, iVar2, sParam0, bParam1))
		{
			return true;
		}
...
int func_106(int iParam0)
{
	...
	{
		DEBUG::_0xF0783374333FD8CE(680, 36, "SET_NET_PLAYER_STATUS_FLAG - ", func_156(iParam0), " set by thread ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
		return 1;
	}
	return 0;
}
...
bool func_107(int iParam0, var uParam1)
{
	...
	{
		DEBUG::_0xF0783374333FD8CE(168, 36, "NET_PLAYER_STATUS__LOAD_SPAWN_SEARCH_LOCATION_DATA__IN_REGION - Volume does not exist for region ", func_81(iParam0), ", bailing.");
		return false;
	}
	...
	DEBUG::_0xF0783374333FD8CE(680, 36, "NET_PLAYER_STATUS__LOAD_SPAWN_SEARCH_LOCATION_DATA__IN_REGION - Using ", func_81(iParam0), ", with target at ", MISC::_0x6C4DBF553885F9EB(uParam1->f_17.f_6));
...
void func_108(var uParam0, var uParam1, int iParam2, bool bParam3, int iParam4)
{
	if (func_157(255) == 4)
	{
	...
	func_159(&(Global_1102630.f_3849));
	Global_1102630.f_3849 = { *uParam0 };
	func_160(&(Global_1102630.f_3888));
	...
	func_161(Global_1102630.f_3849, 36);
	func_162(Global_1102630.f_3888, 36);
...
{
	if (func_163(&(Global_1102630.f_4), iParam0, 5))
	{
		DEBUG::_0xF0783374333FD8CE(680, 36, "CLEAR_NET_PLAYER_STATUS_FLAG - ", func_156(iParam0), " cleared by thread ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
		return 1;
	}
	return 0;
}
...
void func_111(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, float fParam8)
{
	vector3 vVar0;
	int iVar3;
	...
	iVar3 = iParam3;
	if (!func_164(Global_1275959.f_17, &vVar0, &iVar3))
	{
		vVar0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false, false) };
		iVar3 = iParam3;
	}
	func_165(vParam0, iParam3, vVar0, iVar3, iParam4, iParam5, iParam6, iParam7, fParam8, 1);
}
...
char* func_117(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_169(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_171(func_170(Global_34));
	}
...
void func_132(var uParam0, int iParam1)
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_176(iParam1, 0));
}
...
{
	DEBUG::_0x4DC69742196F818A(40, 195, "CLEAR_SALOON: Clearing ", func_177(iParam0));
	func_178(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_179(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
...
void func_136(int iParam0)
{
	...
	if (func_96(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_181(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_182(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_183(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_184(iParam0, 536870912);
	iVar1 = func_185(iParam0);
	if (iVar1 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(2216, 139, "[SHOP_UNLOCK_DOORS] Shop: ", func_186(iParam0, 0), " door count is greater then the. Current door count: ", iVar1, " Max door count: ", 15);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_187(Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
	...
	DEBUG::_0xF0783374333FD8CE(168, 139, "[CLEAR_SHOP] Shop: ", func_186(iParam0, 0), " has been cleared!");
}
...
int func_138(int iParam0, bool bParam1)
{
	if (!func_96(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_144(iParam0), " is invalid");
		return 0;
	}
	if (!func_137(iParam0, 2))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_144(iParam0), " has not been initialized");
		return 0;
	}
	if (func_145(iParam0) == 0)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_144(iParam0), " doesn't exist");
		return 1;
	}
	if (!PERSCHAR::_0x800DF3FC913355F3(func_147(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_144(iParam0), " already destroyed");
		return 1;
	}
	if (func_137(iParam0, 1) && !bParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_144(iParam0), " is stolen, so it will be destoyed on release.");
		func_189(iParam0, 128);
		return 1;
	}
	func_148(iParam0, 129);
	func_190(iParam0);
	DEBUG::_0xA308F935BDECCEC0(40, 138, "DESTROY_REGIONAL_CHARACTER: Destroying ", func_144(iParam0));
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_147(iParam0));
	func_146(iParam0, 0);
	DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: ", func_144(iParam0), " destroyed.");
	return 1;
}
...
void func_141()
{
	...
	while (iVar0 <= 3)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ NET_CLEAR_BARTENDERS - Removed ", func_195(Global_1051777.f_3642[iVar0 /*19*/]));
...
void func_143(int iParam0, bool bParam1)
{
	...
	DEBUG::_0x4DC69742196F818A(40, 139, "NET_CLEAR_SHOP ", func_186(iParam0, 0));
	bVar0 = (func_196(iParam0) && !bParam1);
	if (!bVar0 && !func_197(iParam0, 65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] - Shop keeper deleted for shop: ", func_198(iParam0));
		}
	...
	else if (func_199(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
	{
	...
	if (func_199(iParam0, 16384) && !bVar0)
	{
		DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] Remove the script created scenario for: ", func_198(iParam0));
	...
	if (iVar3 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "[NET_CLEAR_SHOP] - Shop: ", func_186(iParam0, 0), " current door count exceeds max door count.");
		Global_1915867.f_3[iParam0 /*447*/].f_409 = 0;
	}
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_187(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar2]);
	...
	func_202(iParam0);
	if (func_197(iParam0, 262144))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 139, "NET_CLEAR_SHOP: SPF_ALLOW_BLIP_OUT_OF_REGION for ", func_198(iParam0), " is kept; all other flags cleared.");
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_24) && func_203(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_CLEAR_SHOP] Removing relationship volume from shop ", func_186(iParam0, 0));
...
void func_148(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_205(iParam1), " on ", func_144(iParam0));
}
...
bool func_149(int iParam0)
{
	...
	if (!func_137(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_144(iParam0), " has not been initialized");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(40, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_144(iParam0));
	return true;
}
...
bool func_151(var uParam0, var uParam1)
{
	...
	bVar0 = true;
	func_209(uParam1);
	if (!func_210(*uParam0, &(uParam1->f_18)))
	{
		bVar0 = false;
	...
	else if (!func_211(&(uParam1->f_18), &(uParam1->f_24)))
	{
	}
	...
	if (!func_210(uParam0->f_1, &(uParam1->f_6)))
	{
		bVar0 = false;
	...
	else if (!func_211(&(uParam1->f_6), &(uParam1->f_12)))
	{
	}
	if (bVar0)
	{
...
bool func_154(char* sParam0, int iParam1, char* sParam2, bool bParam3)
{
	struct<5> Var0;
...
void func_161(struct<30> Param0, int iParam30)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, iParam30, "             outer.eType                     - ", func_215(Param0.f_17.f_9, 0));
	if (Param0.f_16)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, iParam30, "             inner.eType                     - ", func_215(Param0.f_6.f_9, 0));
	}
...
void func_162(struct<7> Param0, var uParam7, var uParam8, int iParam9)
{
...
bool func_164(vector3 vParam0, char* sParam3, bool bParam4)
{
	char* sVar0;
	int iVar1;
	int iVar2;

	sVar0 = Global_1072032.f_23926.f_366[func_216(vParam0) /*272*/];
	iVar1 = func_153(sVar0);
	if (iVar1 <= 0)
	{
	...
	else
	{
		...
		if (func_154(sVar0, iVar2, sParam3, bParam4))
		{
			return true;
		}
...
void func_165(vector3 vParam0, int iParam3, vector3 vParam4, int iParam7, float fParam8, float fParam9, bool bParam10, int iParam11, float fParam12, int iParam13)
{
	if (func_157(255) == 4)
	{
...
bool func_168(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_220(func_56(0)))
	{
		return true;
	}
...
void func_180(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 195, "CLEAR_SALOON_CONFIG_FLAG: Clearing flag for ", func_225(iParam1, 0));
	func_226(&(Global_1940170.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_182(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	...
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that isnt stolen ", func_144(iParam0));
		return;
	}
	if (!func_137(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release an uninitialized regional character ", func_144(iParam0));
		return;
	}
	if ((!bParam4 && !func_181(iParam0)) && func_227(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that is stolen by a differnt script ", func_144(iParam0));
		return;
	}
	DEBUG::_0xF0783374333FD8CE(680, 138, "RELEASE_REGIONAL_CHARACTER: Regional character ", func_144(iParam0), " released by ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
	func_148(iParam0, 1);
	func_190(iParam0);
	if (func_228(func_145(iParam0)))
	{
		iVar0 = func_147(iParam0);
		if (!PERSCHAR::_0x800DF3FC913355F3(iVar0))
		{
			DEBUG::_0x9A6C65DDDBEC9C52(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character with no perschar index", func_144(iParam0));
			return;
		}
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being retasked ", func_144(iParam0));
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being destroyed on release ", func_144(iParam0));
		func_138(iParam0, 0);
	}
}
...
{
	if (func_235(bParam0) && func_236())
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 183, "RELEASE_DOOR_ID - Releasing Door ID ", func_237(bParam0, 0));
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 139, "CLEAR_ALL_SHOP_TYPE_FLAGS: ", func_198(iParam0));
...
void func_189(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_205(iParam1), " on ", func_144(iParam0));
}
...
void func_190(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar0, false))
		{
			...
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_144(iParam0), " set as no longer needed.");
		}
		else
		{
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_144(iParam0), " was asked to be set as no longer needed, but this script does not own the ped.");
		}
	}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_FLAGS] ", func_198(iParam0));
	Global_1051777.f_80[iParam0 /*75*/].f_49 = 0;
}

void func_192(int iParam0)
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_SUPPORT_FLAGS] ", func_198(iParam0));
...
void func_200(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_198(iParam0), " flag ", func_240(iParam1));
	}
	Global_1051777.f_80[iParam0 /*75*/].f_1 = (Global_1051777.f_80[iParam0 /*75*/].f_1 - (Global_1051777.f_80[iParam0 /*75*/].f_1 && iParam1));
}
...
{
	return func_101(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}
...
void func_208(var uParam0)
{
	...
	func_241(uParam0);
	func_241(&(uParam0->f_6));
	func_241(&(uParam0->f_12));
	func_241(&(uParam0->f_18));
	func_241(&(uParam0->f_24));
	uParam0->f_30 = { Var0 };
	uParam0->f_63 = 0;
}
...
bool func_210(char* sParam0, var uParam1)
{
	int iVar0;
...
bool func_211(var uParam0, var uParam1)
{
	...
	{
		case 3:
			return func_210(PED::_GET_RIDER_OF_MOUNT(uParam0->f_2, false), uParam1);
		case 4:
			return func_210(VEHICLE::GET_PED_IN_VEHICLE_SEAT(uParam0->f_1, -1), uParam1);
		default:
			break;
	}
	return false;
...
void func_217(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	func_243(iParam0);
	DEBUG::_0xF0783374333FD8CE(40, 37, "NET_SPECIAL_CAM__KILL - Setting new display to ", func_244(iParam0, 0));
	if (!func_245(1))
	{
	...
	else if (!func_246(128) && !func_247(19))
	{
		CAM::DO_SCREEN_FADE_OUT(iParam2);
	}
	if (bParam3 && func_248() == 4)
	{
...
bool func_218()
{
	...
	if (!func_220(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_222(vector3 vParam0, int iParam3)
{
	vector3 vVar0;
	struct<2> Var3;
	var uVar6;

	func_252(iParam3, &vVar0, &Var3, &uVar6);
	if (func_253(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
...
bool func_253(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
...
int func_254(int iParam0)
{
	...
	DEBUG::_0xD9911C7B5F8CD69C(168, 139, "GET_SHOP_TYPE_FROM_SHOP - ", func_239(iParam0, 0), " undefined");
	return -1;
}
