...
bool func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_24)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_77(iLocal_24));
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_78(iLocal_24, 0), 1);
					break;
			}
		}
		if (func_10(func_70()))
	...
	else
	{
		...
		if (func_45() == -1)
		{
			func_82(iLocal_24);
			func_83(iLocal_24);
			if (!func_84(iLocal_24, 0))
			{
				return false;
			}
		}
		else if (!func_85(iLocal_24))
		{
			return false;
		}
	}
...
void func_60()
{
	...
	bVar0 = false;
	if (func_96(356365161) || func_96(-1187950766))
	{
		bVar0 = true;
	}
	if (bVar0 != bLocal_16)
...
void func_62(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	...
	if (func_101(iParam0))
	{
		...
		else if (bParam1)
		{
			if (bParam4)
			{
				...
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking Door ID ", func_104(iParam0, 0));
			}
			else
			{
				func_105(iParam0, 1);
				UNK_0x355E72323AEE83CC(183, 9);
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking and making unbreakable Door ID ", func_104(iParam0, 0));
			}
		}
		else
		{
			func_106(iParam0, 1);
			UNK_0x355E72323AEE83CC(183, 9);
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Unlocking Door ID ", func_104(iParam0, 0));
		}
		if (bParam7)
		{
			DEBUG::_0x1B08D1EB9D8C4931(168, 183, "SET_STATE_OF_DOOR_ID - Treating Door ID ", func_104(iParam0, 0), " as shut.");
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 183, "SET_STATE_OF_DOOR_ID: Door with ID not registered by host yet ", func_104(iParam0, 0));
	}
}
...
void func_63(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_101(iParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(iParam0) != iParam1 || bParam2)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(680, 183, "SET_DOORSTATE_OF_DOOR_ID - Setting Door ID ", func_104(iParam0, 0), " to ", func_108(iParam1, 0));
			UNK_0x355E72323AEE83CC(183, 9);
		}
	}
	else
...
bool func_68(int iParam0)
{
	...
	return ((Global_1887351[iParam0 /*36*/].f_21 == 1 || Global_1887351[iParam0 /*36*/].f_21 == 2) && !func_109(iParam0));
}
...
void func_71(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_111(iParam0, 0), " ", func_112(iParam1, 0), " ", func_113(iParam2, 0), " state ", func_114(iParam4, 0));
	UNK_0x355E72323AEE83CC(11, 6);
	sVar1 = func_115(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &bVar0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_111(iParam0, 0), " or ", func_112(iParam1, 0), " or ", func_113(iParam2, 0));
	...
	if (!func_116(iParam4))
	{
		if (func_58(iParam0))
		{
			iParam4 = func_117(func_9(iParam0));
		}
		else
		{
			iParam4 = func_117(iParam1);
		}
	}
	if (func_116(iParam4))
	{
		iVar3 = func_118(iParam4);
	}
	if (bVar0 && bParam3)
	{
		sVar2 = func_120(func_119(iParam2));
	}
	else if ((func_121(iParam1, 2) || func_122(iParam4, 2)) && !Global_1893599.f_9)
	{
	...
	{
		iVar4 = func_124(func_123());
		iVar5 = func_125(func_123());
		if (iVar5 < 10)
		{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			{
				fVar7 = func_126(fVar7);
				sVar8 = "TIME_AND_TEMP_F";
			}
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_127(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_127(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_127(&cVar6, joaat("COLOR_PURE_WHITE")), func_127(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		Global_1893599.f_9 = 0;
	}
	DEBUG::_0xF0783374333FD8CE(680, 11, "DISPLAY_NAMED_LOCATION - Texture ", sVar1, " info ", sVar2);
	Global_1939313.f_145 = func_128(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_73(int iParam0, bool bParam1)
{
	...
	func_130(&Global_1940410, 16384);
	func_132(func_131(joaat("DISCOVERED"), joaat("AREAS")), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_132(func_131(joaat("DISCOVERED"), joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_132(func_131(joaat("DISCOVERED"), joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_132(func_131(joaat("DISCOVERED"), joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_132(func_131(joaat("DISCOVERED"), joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_132(func_131(joaat("DISCOVERED"), joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_132(func_131(joaat("DISCOVERED"), joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
bool func_84(int iParam0, bool bParam1)
{
	...
	if (func_91(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_135(Global_1896632.f_1, 16))
			{
				func_136(Global_1896632.f_1, 0);
			}
			Global_1896632.f_1++;
			iVar2++;
...
bool func_85(int iParam0)
{
	...
	while (iVar0 < 40)
	{
		if (func_137(iVar0) || func_138(iVar0))
		{
		}
		else
		{
...
int func_94(int iParam0, bool bParam1)
{
	if (!func_92(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_142(iParam0), " is invalid");
		return 0;
	}
	if (!func_135(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_142(iParam0), " has not been initialized");
		return 0;
	}
	if (func_135(iParam0, 32) && !bParam1)
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_142(iParam0), " has been locked dead");
		...
		if (func_45() == -1)
		{
			if (func_135(iParam0, 2048))
			{
				...
				DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_142(iParam0), " has been revived!");
			}
			PERSCHAR::_0xFCC6DB8DBE709BC8(func_145(iParam0));
		}
		return 0;
	}
	if (!func_147(iParam0) && func_45() == -1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_142(iParam0), " dead or not spawning, turn scenario groups off");
		return 0;
	}
	if (PERSCHAR::_0x800DF3FC913355F3(func_145(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Persistent character ", func_142(iParam0), " already exists");
		func_146(iParam0, 128);
		return 1;
	}
	func_144(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_143(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_145(iParam0));
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_142(iParam0), " perschar index created!");
	if (func_135(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_145(iParam0));
		func_146(iParam0, 2048);
	...
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_142(iParam0), " created.");
...
bool func_96(int iParam0)
{
	...
	if (func_149(iVar1))
	{
		if (Global_1072032.f_19652.f_24 && !func_150(iParam0))
		{
			return false;
		}
...
int func_97(int iParam0)
{
	...
	if (func_151())
	{
		DEBUG::_0x9A6C65DDDBEC9C52(168, 0, "REQUEST_IPL_HASH_SAFE - Could not request ", func_152(iParam0, 0), " b/c player is in the respawn sequence.");
		return 0;
	}
...
int func_98(int iParam0)
{
	...
	if (func_151())
	{
		DEBUG::_0x9A6C65DDDBEC9C52(168, 0, "REMOVE_IPL_HASH_SAFE - Could not remove ", func_152(iParam0, 0), " b/c player is in the respawn sequence.");
		return 0;
	}
...
int func_100(int iParam0, bool bParam1, bool bParam2)
{
	if (!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(iParam0))
	{
		...
		{
			OBJECT::_ADD_DOOR_TO_SYSTEM_NEW(iParam0, true, true, false, Global_1051590.f_16[0], 0, false);
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add networked Door ", func_104(iParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
		else
		{
			OBJECT::_ADD_DOOR_TO_SYSTEM_NEW(iParam0, true, false, false, 0, 0, false);
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add Door ", func_104(iParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
	}
	...
	if (bParam2)
	{
		...
		DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Set door ", func_104(iParam0, 0), " able to change open ratio while locked");
		UNK_0x355E72323AEE83CC(183, 7);
	}
	return iParam0;
}
...
void func_102(int iParam0, char* sParam1, bool bParam2, bool bParam3)
{
	if (func_101(iParam0))
	{
		...
		OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(iParam0, sParam1, bParam3);
	}
	else
	{
...
void func_103(int iParam0, bool bParam1)
{
	if (func_101(iParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(iParam0) != 2 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "LOCK_DOOR_ID - Locking Door ID ", func_104(iParam0, 0));
		}
	}
	else
	{
...
void func_105(int iParam0, bool bParam1)
{
	if (func_101(iParam0))
	{
		...
		{
			DEBUG::_0x1B08D1EB9D8C4931(2216, 183, "SET_DOOR_ID_LOCKED_AND_UNBREAKABLE - Door ID ", func_104(iParam0, 0), " state = ", OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(iParam0), " pending state ", UNK_0x4BC2854478F3A749(iParam0));
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(iParam0, 1);
		}
	}
	else
...
void func_106(int iParam0, bool bParam1)
{
	if (func_101(iParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(iParam0) != 0 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "UNLOCK_DOOR_ID - Unlocking Door ID ", func_104(iParam0, 0));
		}
	}
	else
	{
...
{
	if ((iParam0 == 22 || iParam0 == 39) && !func_154())
	{
		return true;
	}
	if (iParam0 == 66)
...
char* func_115(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893599.f_162)))
	{
		sVar0 = func_157(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_159(func_158(Global_34));
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		if (!func_160(iParam0) || func_161(44))
		{
			switch (iParam0)
			{
				case 2:
...
int func_118(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_162(PLAYER::PLAYER_ID()) };
...
var func_128(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	var uVar16;
...
void func_130(var uParam0, int iParam1)
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_164(iParam1, 0));
}
...
{
	DEBUG::_0x4DC69742196F818A(40, 195, "CLEAR_SALOON: Clearing ", func_165(iParam0));
	func_166(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_167(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
...
void func_134(int iParam0)
{
	...
	if (func_92(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_169(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_170(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_171(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_172(iParam0, 536870912);
	iVar1 = func_173(iParam0);
	if (iVar1 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(2216, 139, "[SHOP_UNLOCK_DOORS] Shop: ", func_174(iParam0, 0), " door count is greater then the. Current door count: ", iVar1, " Max door count: ", 15);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_175(Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
	...
	DEBUG::_0xF0783374333FD8CE(168, 139, "[CLEAR_SHOP] Shop: ", func_174(iParam0, 0), " has been cleared!");
}
...
int func_136(int iParam0, bool bParam1)
{
	if (!func_92(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_142(iParam0), " is invalid");
		return 0;
	}
	if (!func_135(iParam0, 2))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_142(iParam0), " has not been initialized");
		return 0;
	}
	if (func_143(iParam0) == 0)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_142(iParam0), " doesn't exist");
		return 1;
	}
	if (!PERSCHAR::_0x800DF3FC913355F3(func_145(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_142(iParam0), " already destroyed");
		return 1;
	}
	if (func_135(iParam0, 1) && !bParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_142(iParam0), " is stolen, so it will be destoyed on release.");
		func_177(iParam0, 128);
		return 1;
	}
	func_146(iParam0, 129);
	func_178(iParam0);
	DEBUG::_0xA308F935BDECCEC0(40, 138, "DESTROY_REGIONAL_CHARACTER: Destroying ", func_142(iParam0));
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_145(iParam0));
	func_144(iParam0, 0);
	DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: ", func_142(iParam0), " destroyed.");
	return 1;
}
...
void func_139()
{
	...
	while (iVar0 <= 3)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ NET_CLEAR_BARTENDERS - Removed ", func_183(Global_1051777.f_3642[iVar0 /*19*/]));
...
void func_141(int iParam0, bool bParam1)
{
	...
	DEBUG::_0x4DC69742196F818A(40, 139, "NET_CLEAR_SHOP ", func_174(iParam0, 0));
	bVar0 = (func_184(iParam0) && !bParam1);
	if (!bVar0 && !func_185(iParam0, 65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] - Shop keeper deleted for shop: ", func_186(iParam0));
		}
	...
	else if (func_187(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
	{
	...
	if (func_187(iParam0, 16384) && !bVar0)
	{
		DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] Remove the script created scenario for: ", func_186(iParam0));
	...
	if (iVar3 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "[NET_CLEAR_SHOP] - Shop: ", func_174(iParam0, 0), " current door count exceeds max door count.");
		Global_1915867.f_3[iParam0 /*447*/].f_409 = 0;
	}
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_175(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar2]);
	...
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 139, "NET_CLEAR_SHOP: SPF_ALLOW_BLIP_OUT_OF_REGION for ", func_186(iParam0), " is kept; all other flags cleared.");
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_24) && func_191(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_CLEAR_SHOP] Removing relationship volume from shop ", func_174(iParam0, 0));
...
void func_146(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_193(iParam1), " on ", func_142(iParam0));
}
...
bool func_147(int iParam0)
{
	...
	if (!func_135(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_142(iParam0), " has not been initialized");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(40, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_142(iParam0));
	return true;
}
...
bool func_156(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_198(func_56(0)))
	{
		return true;
	}
...
void func_168(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 195, "CLEAR_SALOON_CONFIG_FLAG: Clearing flag for ", func_203(iParam1, 0));
	func_204(&(Global_1940170.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_170(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that isnt stolen ", func_142(iParam0));
		return;
	}
	if (!func_135(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release an uninitialized regional character ", func_142(iParam0));
		return;
	}
	if ((!bParam4 && !func_169(iParam0)) && func_205(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that is stolen by a differnt script ", func_142(iParam0));
		return;
	}
	DEBUG::_0xF0783374333FD8CE(680, 138, "RELEASE_REGIONAL_CHARACTER: Regional character ", func_142(iParam0), " released by ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
	func_146(iParam0, 1);
	func_178(iParam0);
	if (func_206(func_143(iParam0)))
	{
		iVar0 = func_145(iParam0);
		if (!PERSCHAR::_0x800DF3FC913355F3(iVar0))
		{
			DEBUG::_0x9A6C65DDDBEC9C52(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character with no perschar index", func_142(iParam0));
			return;
		}
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being retasked ", func_142(iParam0));
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being destroyed on release ", func_142(iParam0));
		func_136(iParam0, 0);
	}
}
...
{
	if (func_101(iParam0) && func_213())
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 183, "RELEASE_DOOR_ID - Releasing Door ID ", func_104(iParam0, 0));
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 139, "CLEAR_ALL_SHOP_TYPE_FLAGS: ", func_186(iParam0));
...
void func_177(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_193(iParam1), " on ", func_142(iParam0));
}
...
void func_178(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar0, false))
		{
			...
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_142(iParam0), " set as no longer needed.");
		}
		else
		{
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_142(iParam0), " was asked to be set as no longer needed, but this script does not own the ped.");
		}
	}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_FLAGS] ", func_186(iParam0));
	Global_1051777.f_80[iParam0 /*75*/].f_49 = 0;
}

void func_180(int iParam0)
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_SUPPORT_FLAGS] ", func_186(iParam0));
...
void func_188(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_186(iParam0), " flag ", func_216(iParam1));
	}
	Global_1051777.f_80[iParam0 /*75*/].f_1 = (Global_1051777.f_80[iParam0 /*75*/].f_1 - (Global_1051777.f_80[iParam0 /*75*/].f_1 && iParam1));
}
...
{
	return func_217(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}
...
bool func_196()
{
	...
	if (!func_198(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
int func_223(int iParam0)
{
	...
	DEBUG::_0xD9911C7B5F8CD69C(168, 139, "GET_SHOP_TYPE_FROM_SHOP - ", func_215(iParam0, 0), " undefined");
	return -1;
}
