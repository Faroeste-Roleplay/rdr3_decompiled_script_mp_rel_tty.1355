...
bool func_103(var uParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1393[0]))
	{
		if (func_166(&(uParam0->f_1393[0]), uParam0->f_1385[0], func_165(0)))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] NOOSE_STAND INDEX: ", uParam0->f_1393[0]);
		}
		else
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "NOOSE_STAND was not created");
			return false;
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1393[1]))
	{
		if (func_166(&(uParam0->f_1393[1]), uParam0->f_1385[1], func_165(1)))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] JACKET INDEX: ", uParam0->f_1393[1]);
		}
		else
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "JACKET was not created");
			return false;
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1393[2]))
	{
		if (func_166(&(uParam0->f_1393[2]), uParam0->f_1385[2], func_165(2)))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] DIVIDER INDEX: ", uParam0->f_1393[2]);
		}
		else
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "DIVIDER was not created");
			return false;
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1393[3]))
	{
		if (func_166(&(uParam0->f_1393[3]), uParam0->f_1385[3], func_165(3)))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] Noose INDEX: ", uParam0->f_1393[3]);
		}
		else
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "Noose was not created");
			return false;
		}
	}
	if (!func_167(uParam0, iVar0, 0, "BENJAMIN_NO_JACKET"))
	{
		return false;
	}
	if (!func_167(uParam0, iVar0, 1, "Assistant"))
	{
		return false;
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_17))
	{
		if (func_166(&iLocal_17, joaat("P_SHOTGLASS01X"), 2546.771f, -1310.344f, 50.83665f))
		{
		...
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "P_SHOTGLASS01X was not created");
			return false;
		}
	}
...
bool func_166(int iParam0, bool bParam1, vector3 vParam2)
{
	...
	{
		*iParam0 = OBJECT::CREATE_OBJECT(bParam1, vParam2, true, true, false, false, true);
		DEBUG::_0xA308F935BDECCEC0(168, 201, "[CREATE_SHOW_OBJECT] CREATE_OBJECT called THIS FRAME for ", UNK_0x1B7C373FB4E76B85(bParam1), " AT INDEX: ", *iParam0);
	}
