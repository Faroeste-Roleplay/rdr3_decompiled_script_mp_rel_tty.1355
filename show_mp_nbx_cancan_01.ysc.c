...
bool func_103(var uParam0)
{
	...
	if (!func_165(uParam0, iVar0, 0, "CS_CANCAN_01"))
	{
		return false;
	}
	if (!func_165(uParam0, iVar0, 1, "CS_CANCAN_02"))
	{
		return false;
	}
	if (!func_165(uParam0, iVar0, 2, "CS_CANCAN_03"))
	{
		return false;
	}
	if (!func_165(uParam0, iVar0, 3, "CS_CANCAN_04"))
	{
		return false;
	}
	if (!func_165(uParam0, iVar0, 4, "CS_CANCANMAN_01"))
	{
		return false;
	}
...
void func_128(var uParam0, var uParam1, var uParam2, float fParam3)
{
	...
	{
		case 0:
			func_178(&((uParam1[uParam2->f_1 /*18*/])->f_17), 32);
			break;
		case 32:
			if (uParam0->f_1 > 32)
			{
				func_178(&((uParam1[uParam2->f_1 /*18*/])->f_17), 33);
			}
			break;
		case 33:
			if (uParam0->f_1 > 33)
			{
				func_178(&((uParam1[uParam2->f_1 /*18*/])->f_17), 34);
			}
			break;
		case 34:
			if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)) > 0.978f)
			{
				func_178(&((uParam1[uParam2->f_1 /*18*/])->f_17), 37);
			}
			break;
		case 37:
			if (!func_13(uParam0->f_1358, 8388608))
			...
			func_18(&(uParam2->f_247), 32);
			func_178(&((uParam1[uParam2->f_1 /*18*/])->f_17), 40);
			break;
		case 40:
			break;
	}
