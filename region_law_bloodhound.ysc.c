...
void __EntryFunction__()
{
	fLocal_13 = 1f;
	fLocal_14 = 1f;
	bLocal_76 = joaat("A_C_DOGHOUND_01");
...
void func_1(int iParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(8, 111, "REGION_BLOODHOUND_CLEANUP start");
...
void func_4()
{
	...
	{
		case 1:
			bLocal_77 = func_9(2, 2, -156825994, 1, 0, 0f, 0f, 0f);
			if (!STREAMING::IS_MODEL_VALID(bLocal_77))
			{
				bLocal_77 = joaat("S_M_M_AMBIENTLAWRURAL_01");
			}
			iLocal_75 = 2;
			break;
		case 2:
			STREAMING::REQUEST_MODEL(bLocal_76, false);
			STREAMING::REQUEST_MODEL(bLocal_77, false);
			if ((STREAMING::HAS_MODEL_LOADED(bLocal_76) && STREAMING::HAS_MODEL_LOADED(bLocal_77)) && PED::_0x5E420FF293EE5472())
			{
				iLocal_75 = 4;
			}
			break;
		...
		case 5:
			...
			while (iVar0 < 3)
			{
				if (Local_43[iVar0 /*10*/] == 1)
				{
					...
					{
						if (func_13(Global_33, Local_43[iVar0 /*10*/].f_9, 0, 1, 0))
						{
							func_14(iVar0);
						}
					}
					else if (func_13(Global_33, Local_43[iVar0 /*10*/].f_9, 0, 1, 0))
					{
						func_14(iVar0);
					}
					else
				...
				else if (Local_43[iVar0 /*10*/] == 2)
				{
					if (func_5(Local_43[iVar0 /*10*/].f_6, 0))
					{
						if (!PED::IS_PED_IN_COMBAT(Local_43[iVar0 /*10*/].f_6, 0) && !func_13(Global_33, Local_43[iVar0 /*10*/].f_9, 0, 1, 0))
						{
							func_12(iVar0);
						}
					}
...
bool func_10()
{
	...
	{
		DEBUG::_0xF0783374333FD8CE(8, 111, "Scanner attempt #", Local_78.f_2);
		return false;
	}
	vLocal_90 = { Local_78.f_3 };
	DEBUG::_0xF0783374333FD8CE(56, 111, "Found a point at ", &vLocal_90);
	return true;
}
...
void func_11(int iParam0)
{
	...
	Local_43[iParam0 /*10*/].f_6 = func_22(bLocal_77, vVar0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 180f), 1, 1, 0, 1, 1, 1, 0, 0);
	...
	while (iVar3 < 4)
	{
		DEBUG::_0x4DC69742196F818A(8, 111, "SPAWN_DOGS - creating a new dog member...");
		Local_43[iParam0 /*10*/].f_1[iVar3] = func_22(bLocal_76, vVar0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 180f), 1, 1, 0, 1, 1, 1, 0, 0);
...
void func_12(int iParam0)
{
	...
	{
		DEBUG::_0xD9911C7B5F8CD69C(8, 111, "START_BLOODHOUNG_GANG_SEARCH trying to start searching with a pack master that doesn't exist!");
		return;
	}
	...
	while (iVar0 < 4)
	{
		if (func_5(Local_43[iParam0 /*10*/].f_1[iVar0], 0))
		{
			...
			func_6(Local_43[iParam0 /*10*/].f_1[iVar0]);
			TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_43[iParam0 /*10*/].f_1[iVar0], Local_43[iParam0 /*10*/].f_6, vVar1, 2f, -1, 1036831949 /* Float: 0.1f */, 1, 1, 0, 0, 1, false);
		}
		iVar0++;
	}
}

bool func_13(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
...
void func_14(int iParam0)
{
	...
	while (iVar0 < 4)
	{
		if (func_5(Local_43[iParam0 /*10*/].f_1[iVar0], 0))
		{
			...
			TASK::TASK_COMBAT_PED(Local_43[iParam0 /*10*/].f_1[iVar0], Global_33, 0, 0);
...
bool func_20(vector3 vParam0, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, int iParam8, float fParam9, int iParam10, float fParam11)
{
	int iVar0;
...
int func_22(bool bParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12)
{
	int iVar0;
	...
	func_30(iVar0, bParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
void func_30(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
{
	DEBUG::_0xA308F935BDECCEC0(648, 28, "HORSE_SET_GENDER - pedHorse: ", sParam0, " eGender = ", func_39(iParam1, 0));
	if (iParam1 == 1)
	{
...
int func_40(vector3 vParam0)
{
	...
	iVar0 = func_41(vParam0, 0f, 0f, 0, 2);
	return func_41(vParam0, Global_1892752[iVar0 /*3*/].f_1, Global_1892752[iVar0 /*3*/].f_2, Global_1892752[iVar0 /*3*/], 4);
}

int func_41(struct<2> Param0, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6)
{
	if (Param0 < fParam3)
	{
