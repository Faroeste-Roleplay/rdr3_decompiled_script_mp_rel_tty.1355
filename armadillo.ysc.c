...
void __EntryFunction__()
{
	...
	DEBUG::_0xF0783374333FD8CE(43688, 17, "**** INITIALIZING REGION: ", &(Global_1887351[vScriptParam_0.x /*36*/].f_23), ", ", &(Global_1887351[iLocal_38 /*36*/].f_24), ", ", &(Global_1887351[iLocal_38 /*36*/].f_27), " ****");
	func_2();
	func_3();
	...
	while (func_4())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_37)
		{
			...
			{
				case 0:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_38 /*36*/].f_23), " global init...");
					if (Global_1901988.f_1.f_26 > 0)
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_38 /*36*/].f_23), "-> RBS_WAIT_FOR_UGC_EARLY_QUIT");
						iLocal_39 = (MISC::GET_GAME_TIMER() + Global_1901988.f_1.f_26);
						iLocal_36 = 1;
					}
					else
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_38 /*36*/].f_23), "-> RBS_INIT_REGION");
						iLocal_36 = 2;
					}
					break;
				case 1:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_38 /*36*/].f_23), " ugc early quit...");
					...
					break;
				case 2:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_38 /*36*/].f_23), " region init...");
					func_6(iLocal_38);
					func_7();
					func_8();
					...
					Global_1896632 = -1;
					DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_38 /*36*/].f_23), "-> RBS_INIT_VOLUME");
					iLocal_39 = (iLocal_35 + MISC::GET_GAME_TIMER());
					iLocal_36 = 3;
					break;
				case 3:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_38 /*36*/].f_23), " volume init...");
					if (func_13() || iLocal_39 < MISC::GET_GAME_TIMER())
					{
						func_14(iLocal_38);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_38 /*36*/].f_23), "-> RBS_LOAD_APPEARANCE");
						iLocal_39 = (MISC::GET_GAME_TIMER() + iLocal_35);
						iLocal_36 = 4;
					}
					break;
				case 4:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_38 /*36*/].f_23), " load appearance...");
					if (func_15(iLocal_38) || iLocal_39 < MISC::GET_GAME_TIMER())
					{
						func_16(iLocal_38);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_38 /*36*/].f_23), "-> RBS_LOAD_SPECIAL");
						iLocal_39 = (MISC::GET_GAME_TIMER() + iLocal_35);
						iLocal_36 = 5;
					}
					break;
				case 5:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_38 /*36*/].f_23), " load special...");
					if (func_17(iLocal_38) || iLocal_39 < MISC::GET_GAME_TIMER())
					{
						func_18(iLocal_38);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_38 /*36*/].f_23), "-> RBS_LOAD_PERS_CHARS");
						iLocal_39 = (iLocal_35 + MISC::GET_GAME_TIMER());
						iLocal_36 = 7;
					}
					break;
				case 7:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_38 /*36*/].f_23), " init regional chars...");
					if (func_10(func_9(iLocal_38)))
					{
						...
						else
						{
							if (func_20(iLocal_38) || iLocal_39 < MISC::GET_GAME_TIMER())
							{
								func_21(iLocal_38, 4);
								iLocal_39 = (MISC::GET_GAME_TIMER() + iLocal_35);
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_38 /*36*/].f_23), "-> RBS_INIT_AMBIENT");
								iLocal_36 = 8;
							}
							...
							{
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_38 /*36*/].f_23), " AMBIENT MINIGAMES ARE NOT BEING ENABLED AS A STORY OR RCM OR MISSION RETRY IS HAPPENING");
							}
							func_26();
							func_27();
							func_28();
							...
							func_31();
							func_32();
							DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": INIT_CURRENT_REGION_TOWN_DATA FOR ", &(Global_1887351[iLocal_38 /*36*/].f_23));
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_38 /*36*/].f_23), " RBS_INIT_AMBIENT -> RBS_INIT_LAW");
							iLocal_36 = 9;
							Jump @1356; //curOff = 1032
							func_33(iLocal_38);
							func_34();
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_38 /*36*/].f_23), "-> RBS_INIT_NAMED_LOCATIONS");
							iLocal_36 = 10;
							Jump @1356; //curOff = 1070
							func_35(&Global_1896686);
							func_36(iLocal_38, &Global_1896686);
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_38 /*36*/].f_23), "-> RBS_DONE_INIT");
							iLocal_36 = 11;
							Jump @1356; //curOff = 1116
							DEBUG::_0xF0783374333FD8CE(168, 17, "**** FINISHED INITIALIZING: ", &(Global_1887351[iLocal_38 /*36*/].f_23), " ****");
							func_37(iLocal_38);
							func_21(iLocal_38, 8);
							if (func_38(32))
							{
							...
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_38 /*36*/].f_23), "-> RBS_RUNNING");
							iLocal_36 = 12;
							...
							func_41(&Global_1896686, iLocal_38);
							func_42(iLocal_38);
							func_21(iLocal_38, 8);
							if (func_43())
							{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887351[iLocal_38 /*36*/].f_11);
							if (Global_1887351[iLocal_38 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887351[iLocal_38 /*36*/].f_12);
							}
							Jump @1356; //curOff = 1312
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_38 /*36*/].f_23), " RBS_CLEANUP");
							func_8();
							func_44(iVar0);
							iVar0++;
						}
						if (Global_1887351[iLocal_38 /*36*/].f_13 == 0)
						{
						}
						else
						{
							PED::_0x95423627A9CA598E(Global_1887351[iLocal_38 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
...
bool func_1()
{
	if (!bLocal_40)
	{
		if (Global_1051140)
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_38 /*36*/].f_23), ", g_mpUGC_QuitSessionRequest.bRequestRunning is still true");
			bLocal_40 = true;
			return true;
		}
		if (func_47() && func_48())
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_38 /*36*/].f_23), ", a session request is running and a UGC script is running");
			bLocal_40 = true;
			return true;
		}
	...
	if (func_48())
	{
		DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_38 /*36*/].f_23), ", content script still running for some player");
		return true;
	}
...
bool func_13()
{
	iLocal_19 = Global_1887351[127 /*36*/].f_5;
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_34, 0f, 0f, 0f) <= 5f || func_71(Global_1940410, 32768)) || func_71(Global_1940410, 16777216))
	{
		return;
	}
...
bool func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": REGION_TOWN_MANANGER_EXIT_TOWN FOR ", &(Global_1887351[iLocal_38 /*36*/].f_23));
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_38)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_84(iLocal_38));
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_85(iLocal_38, 0), 1);
					break;
			}
		}
		if (func_10(func_77()))
	...
	else
	{
		...
		if (func_45() == -1)
		{
			func_89(iLocal_38);
			func_90(iLocal_38);
			if (!func_91(iLocal_38, 0))
			{
				return false;
			}
		}
		else if (!func_92(iLocal_38))
		{
			return false;
		}
	}
	DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": Terminating. -- ", &(Global_1887351[iLocal_38 /*36*/].f_23));
	SCRIPTS::TERMINATE_THIS_THREAD();
	return true;
}
...
bool func_49(bool bParam0, bool bParam1)
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		{
			DEBUG::_0xF0783374333FD8CE(168, 8, "KILL_EVENT_CAUGHT - NETWORK_IS_GAME_IN_PROGRESS() = FALSE - but bIgnoreTransition = TRUE and g_mpTransition.eMPState = ", func_93(Global_1572887, 0), ", so skipping");
		}
		else
		{
...
int func_53(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (!func_66(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Region index not valid ", func_95(iParam0));
		return 1;
	}
	if (func_94(iParam0, 16))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: RF_PERS_DISABLED is on for ", func_95(iParam0));
		return 1;
	}
	if (func_96(iParam0) && !func_97(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: IS_REGION_IN_LOCKDOWN is on for ", func_95(iParam0));
	}
	DEBUG::_0xF0783374333FD8CE(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Starting for ", func_95(iParam0));
	if (func_98(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if ((!func_96(iParam0) || func_97(iParam0)) || func_100(Global_1896632))
			{
				func_101(Global_1896632, 0);
			}
			Global_1896632++;
			iVar2++;
...
void func_58(int iParam0, vector3 vParam1, int iParam4, int iParam5)
{
	...
	Global_1940170.f_5[iParam0 /*11*/].f_6 = func_104(iParam5, iParam0);
	DEBUG::_0xF0783374333FD8CE(680, 195, "ENABLE_SALOON_LOCATION: Registering ", func_105(iParam0), " in ", func_84(iParam5));
}
...
{
	DEBUG::_0x4DC69742196F818A(680, 55, "[NET_SHOP_PROPERTY_SET_BIT] Setting bit: ", func_117(iParam1), " for ", func_111(iParam0));
	func_118(&(Global_1051777.f_80[iParam0 /*75*/].f_49), iParam1);
}
...
int func_61(int iParam0, bool bParam1)
{
	...
	if ((func_119(iParam0, 16384) || func_119(iParam0, 32768)) || func_102(Global_1051777.f_80[iParam0 /*75*/].f_3))
	{
	...
	iVar0 = func_112(func_120(), iParam0);
	if ((!bParam1 && func_121(iVar0, &iVar1, &uVar2, &vVar3)) || (bParam1 && func_122(iVar0, &iVar1, &uVar2, &vVar3)))
	{
		func_123(iParam0, iVar1, vVar3, uVar2, 0);
...
void func_62()
{
	...
	while (iVar0 <= 3)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ NET_CLEAR_BARTENDERS - Removed ", func_128(Global_1051777.f_3642[iVar0 /*19*/]));
...
void func_63(int iParam0)
{
	...
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ g_mpShopsData.sBartenders[i].eSaloon = ", func_129(Global_1051777.f_3642[iVar0 /*19*/], 0));
		iVar0++;
	}
	if (iVar0 == 4)
	{
	...
	DEBUG::_0xF0783374333FD8CE(2216, 139, "[NET_ENABLE_SALOON_LOCATION] ", func_128(iParam0), " will be the #", iVar0, " saloon we created in this region.");
	Global_1051777.f_3642[iVar0 /*19*/].f_1 = 0;
	Global_1051777.f_3642[iVar0 /*19*/] = iParam0;
	if (func_121(Global_1051777.f_3642[iVar0 /*19*/], &iVar1, &uVar2, &vVar3))
	{
		Global_1051777.f_3642[iVar0 /*19*/].f_6 = func_130(iVar1, vVar3, uVar2, 0, 0, 0);
	...
	iVar6 = func_131(Global_1051777.f_3642[iVar0 /*19*/]);
	bVar7 = iVar6 != -1;
	if (bVar7)
	{
		Global_1051777.f_3642[iVar0 /*19*/].f_9 = iVar6;
		if (func_121(iVar6, &iVar1, &uVar2, &vVar3))
		{
			Global_1051777.f_3642[iVar0 /*19*/].f_13 = func_130(iVar1, vVar3, uVar2, 0, 0, 0);
	...
	Global_1051777.f_3642[iVar0 /*19*/].f_5 = func_113(Global_1051777.f_3642[iVar0 /*19*/]);
	if (!func_132(30, 4))
	{
		func_115(30, 4);
		func_116(30);
...
{
	func_136(bParam0, 1, 0, 0, 0, 0, 0, 0);
}
...
void func_70(int iParam0, int iParam1, var uParam2)
{
	if (!*uParam2)
	{
		if (func_137(Global_33, iParam1, 0, 1, 0))
		{
			DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_SHOPS_HANDLE_VISITED_VOLUME] - Player visited volume for ", func_129(iParam0, 0));
			func_139(func_138(iParam0), 1);
			*uParam2 = 1;
		}
	}
	else if (!func_137(Global_33, iParam1, 0, 1, 0))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_SHOPS_HANDLE_VISITED_VOLUME] - Player left volume for ", func_129(iParam0, 0));
		*uParam2 = 0;
	}
}
...
bool func_73()
{
	return func_71(Global_1940410, 8192);
}
...
bool func_75(int iParam0)
{
	...
	return ((Global_1887351[iParam0 /*36*/].f_21 == 1 || Global_1887351[iParam0 /*36*/].f_21 == 2) && !func_140(iParam0));
}
...
void func_78(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	char* sVar1;
	char* sVar2;
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_142(iParam0, 0), " ", func_143(iParam1, 0), " ", func_144(bParam2, 0), " state ", func_145(iParam4, 0));
	UNK_0x355E72323AEE83CC(11, 6);
	sVar1 = func_146(iParam0, iParam1, bParam2, iParam4, bParam5, bParam3, &bVar0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_142(iParam0, 0), " or ", func_143(iParam1, 0), " or ", func_144(bParam2, 0));
	...
	if (!func_147(iParam4))
	{
		if (func_66(iParam0))
		{
			iParam4 = func_148(func_9(iParam0));
		}
		else
		{
			iParam4 = func_148(iParam1);
		}
	}
	if (func_147(iParam4))
	{
		iVar3 = func_149(iParam4);
	}
	if (bVar0 && bParam3)
	{
		sVar2 = func_151(func_150(bParam2));
	}
	else if ((func_152(iParam1, 2) || func_153(iParam4, 2)) && !Global_1893599.f_9)
	{
	...
	else if ((func_66(iParam0) && func_94(iParam0, 16777216)) && !Global_1893599.f_9)
	{
	...
	{
		iVar4 = func_155(func_154());
		iVar5 = func_156(func_154());
		if (iVar5 < 10)
		{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			{
				fVar7 = func_157(fVar7);
				sVar8 = "TIME_AND_TEMP_F";
			}
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_158(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_158(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_158(&cVar6, joaat("COLOR_PURE_WHITE")), func_158(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		Global_1893599.f_9 = 0;
	}
	DEBUG::_0xF0783374333FD8CE(680, 11, "DISPLAY_NAMED_LOCATION - Texture ", sVar1, " info ", sVar2);
	Global_1939313.f_145 = func_159(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_80(int iParam0, bool bParam1)
{
	...
	func_161(&Global_1940410, 16384);
	func_139(func_162(joaat("DISCOVERED"), joaat("AREAS")), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_139(func_162(joaat("DISCOVERED"), joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_139(func_162(joaat("DISCOVERED"), joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_139(func_162(joaat("DISCOVERED"), joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_139(func_162(joaat("DISCOVERED"), joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_139(func_162(joaat("DISCOVERED"), joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_139(func_162(joaat("DISCOVERED"), joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
bool func_91(int iParam0, bool bParam1)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 138, "DELETE_ALL_REGIONAL_CHARACTERS starting for Region ", func_95(iParam0));
	if (func_98(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_164(Global_1896632.f_1, 16))
			{
				func_165(Global_1896632.f_1, 0);
			}
			Global_1896632.f_1++;
			iVar2++;
...
bool func_92(int iParam0)
{
	...
	while (iVar0 < 40)
	{
		if (func_166(iVar0) || func_167(iVar0))
		{
		}
		else
		{
	...
	switch (iParam0)
	{
		...
		case 139:
			...
			*iParam2 = 851;
			...
			break;
		default:
			DEBUG::_0xA308F935BDECCEC0(40, 138, "Attempting to get regional character bounds for a region that doesn't have them yet ", func_84(iParam0));
			*iParam1 = -1;
			*iParam2 = -1;
			break;
	}
...
int func_101(int iParam0, bool bParam1)
{
	if (!func_99(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_169(iParam0), " is invalid");
		return 0;
	}
	if (!func_164(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_169(iParam0), " has not been initialized");
		return 0;
	}
	if (func_164(iParam0, 32) && !bParam1)
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_169(iParam0), " has been locked dead");
		func_171(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_170(iParam0)));
		if (func_45() == -1)
		{
			if (func_164(iParam0, 2048))
			{
				PERSCHAR::_0x49A8C2CD97815215(func_172(iParam0));
				func_173(iParam0, 2048);
				DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_169(iParam0), " has been revived!");
			}
			PERSCHAR::_0xFCC6DB8DBE709BC8(func_172(iParam0));
		}
		return 0;
	}
	if (!func_174(iParam0) && func_45() == -1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_169(iParam0), " dead or not spawning, turn scenario groups off");
		return 0;
	}
	if (PERSCHAR::_0x800DF3FC913355F3(func_172(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Persistent character ", func_169(iParam0), " already exists");
		func_173(iParam0, 128);
		return 1;
	}
	func_171(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_170(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_172(iParam0));
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_169(iParam0), " perschar index created!");
	if (func_164(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_172(iParam0));
		func_173(iParam0, 2048);
	...
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_169(iParam0), " created.");
...
{
	DEBUG::_0x4DC69742196F818A(40, 195, "CLEAR_SALOON: Clearing ", func_105(iParam0));
	func_175(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_176(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
...
int func_104(int iParam0, int iParam1)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(680, 195, "GET_SALOON_FROM_REGION_AND_SALOON_TYPE - Doesn't have a link setup for this region/type and saloon enum. Region: ", func_84(iParam0), ", Saloon Type: ", func_105(iParam1));
	return -1;
}
...
void func_109(bool bParam0, bool bParam1)
{
	...
	if (func_102(ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), false, false)))
	{
	...
	else
	{
		...
		func_183(0);
		func_184(&(Global_1102630.f_3849));
		...
		func_185(&(Global_1102630.f_3888));
	...
	func_186(Global_1102630.f_3849, 36);
	func_187(Global_1102630.f_3888, 36);
...
void func_110(int iParam0, bool bParam1)
{
	...
	DEBUG::_0x4DC69742196F818A(40, 139, "NET_CLEAR_SHOP ", func_188(iParam0, 0));
	bVar0 = (func_189(iParam0) && !bParam1);
	if (!bVar0 && !func_119(iParam0, 65536))
	{
	...
	else if (func_132(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
	{
	...
	if (iVar3 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "[NET_CLEAR_SHOP] - Shop: ", func_188(iParam0, 0), " current door count exceeds max door count.");
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_192(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar2]);
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_24) && func_194(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_CLEAR_SHOP] Removing relationship volume from shop ", func_188(iParam0, 0));
...
int func_113(int iParam0)
{
	...
	{
		Global_1051777.f_4480[iParam0] = func_196(iParam0);
	}
...
void func_115(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_SET_SHOP_TYPE_FLAG] ", func_111(iParam0), " flag ", func_197(iParam1));
	}
...
int func_121(int iParam0, int iParam1, float fParam2, var uParam3)
{
	return func_199(iParam0, "sHash", iParam1, "fHeading", fParam2, "vPos", uParam3);
}

bool func_122(int iParam0, var uParam1, float fParam2, var uParam3)
{
	return func_199(iParam0, "sClosedHash", uParam1, "fClosedHeading", fParam2, "vClosedPos", uParam3);
}

void func_123(int iParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	if (bParam6)
	{
		MISC::GET_GROUND_Z_FOR_3D_COORD(vParam2, &(vParam2.f_2), false);
	}
	Global_1051777.f_80[iParam0 /*75*/].f_6 = func_130(iParam1, vParam2, uParam5, 0, 0, 0);
	...
	DEBUG::_0xA308F935BDECCEC0(10920, 139, "[NET_ADD_SHOP_SCENARIO_AT_POINT] Creating scenario point: ", HUD::_GET_LABEL_TEXT_BY_HASH(iParam1), " for shop: ", func_188(iParam0, 0), " at: ", MISC::_0x6C4DBF553885F9EB(vParam2));
}
...
var func_130(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
int func_131(int iParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 196, "@@ NET_GET_PIANIST_FROM_BARTENDER: This saloon has no pianist. ENUM = ", func_129(iParam0, 0));
	return -1;
}
...
void func_136(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	func_200(bParam0, 0, 0);
	if (func_201(bParam0))
	{
		...
		if (bParam3)
		{
			func_202(bParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
			{
				...
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking Door ID ", func_204(bParam0, 0));
			}
			else
			{
				func_205(bParam0, 1);
				UNK_0x355E72323AEE83CC(183, 9);
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking and making unbreakable Door ID ", func_204(bParam0, 0));
			}
		}
		else
		{
			func_206(bParam0, 1);
			UNK_0x355E72323AEE83CC(183, 9);
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Unlocking Door ID ", func_204(bParam0, 0));
		}
		if (bParam7)
		{
			DEBUG::_0x1B08D1EB9D8C4931(168, 183, "SET_STATE_OF_DOOR_ID - Treating Door ID ", func_204(bParam0, 0), " as shut.");
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 183, "SET_STATE_OF_DOOR_ID: Door with ID not registered by host yet ", func_204(bParam0, 0));
	}
}
...
struct<2> func_138(int iParam0)
{
	...
	return func_162(joaat("VISITED"), iVar0);
}
...
{
	if ((iParam0 == 22 || iParam0 == 39) && !func_209())
	{
		return true;
	}
	if (iParam0 == 66)
...
char* func_146(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893599.f_162)))
	{
		sVar0 = func_212(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_214(func_213(Global_34));
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		if (!func_215(iParam0) || func_216(44))
		{
			switch (iParam0)
			{
				case 2:
...
int func_149(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_217(PLAYER::PLAYER_ID()) };
...
char* func_158(char* sParam0, int iParam1)
{
	...
	return func_218(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}

var func_159(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	var uVar16;
...
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_219(iParam1, 0));
}
...
void func_163(int iParam0)
{
	...
	if (func_99(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_220(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_221(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_222(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_223(iParam0, 536870912);
	iVar1 = func_224(iParam0);
	if (iVar1 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(2216, 139, "[SHOP_UNLOCK_DOORS] Shop: ", func_188(iParam0, 0), " door count is greater then the. Current door count: ", iVar1, " Max door count: ", 15);
		Global_1915867.f_3[iParam0 /*447*/].f_409 = 0;
	}
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_192(Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
	...
	DEBUG::_0xF0783374333FD8CE(168, 139, "[CLEAR_SHOP] Shop: ", func_188(iParam0, 0), " has been cleared!");
}
...
int func_165(int iParam0, bool bParam1)
{
	if (!func_99(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_169(iParam0), " is invalid");
		return 0;
	}
	if (!func_164(iParam0, 2))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_169(iParam0), " has not been initialized");
		return 0;
	}
	if (func_170(iParam0) == 0)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_169(iParam0), " doesn't exist");
		return 1;
	}
	if (!PERSCHAR::_0x800DF3FC913355F3(func_172(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_169(iParam0), " already destroyed");
		return 1;
	}
	if (func_164(iParam0, 1) && !bParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_169(iParam0), " is stolen, so it will be destoyed on release.");
		func_226(iParam0, 128);
		return 1;
	}
	func_173(iParam0, 129);
	func_227(iParam0);
	DEBUG::_0xA308F935BDECCEC0(40, 138, "DESTROY_REGIONAL_CHARACTER: Destroying ", func_169(iParam0));
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_172(iParam0));
	func_171(iParam0, 0);
	DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: ", func_169(iParam0), " destroyed.");
	return 1;
}
...
void func_173(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_229(iParam1), " on ", func_169(iParam0));
}
...
bool func_174(int iParam0)
{
	...
	if (!func_164(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_169(iParam0), " has not been initialized");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(40, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_169(iParam0));
	return true;
}
...
void func_177(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 195, "CLEAR_SALOON_CONFIG_FLAG: Clearing flag for ", func_230(iParam1, 0));
	func_231(&(Global_1940170.f_5[iParam0 /*11*/].f_7), iParam1);
}

bool func_178(struct<2> Param0)
{
	return func_232(Param0, 5, 8);
}
...
{
	if (func_234(&(Global_1102630.f_4), iParam0, 5))
	{
		DEBUG::_0xF0783374333FD8CE(680, 36, "CLEAR_NET_PLAYER_STATUS_FLAG - ", func_235(iParam0), " cleared by thread ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
		return 1;
	}
	return 0;
}

void func_182(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	func_236(iParam0);
	DEBUG::_0xF0783374333FD8CE(40, 37, "NET_SPECIAL_CAM__KILL - Setting new display to ", func_237(iParam0, 0));
	if (!func_238(1))
	{
	...
	else if (!func_239(128) && !func_240(19))
	{
		CAM::DO_SCREEN_FADE_OUT(iParam2);
	}
	if (bParam3 && func_241() == 4)
	{
...
{
	if (func_243(&(Global_1102630.f_4), iParam0, 5))
	{
		DEBUG::_0xF0783374333FD8CE(680, 36, "SET_NET_PLAYER_STATUS_FLAG - ", func_235(iParam0), " set by thread ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
		return 1;
	}
	return 0;
}
...
void func_186(struct<30> Param0, int iParam30)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, iParam30, "             outer.eType                     - ", func_244(Param0.f_17.f_9, 0));
	if (Param0.f_16)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, iParam30, "             inner.eType                     - ", func_244(Param0.f_6.f_9, 0));
	}
...
void func_187(struct<7> Param0, var uParam7, var uParam8, int iParam9)
{
...
void func_190(int iParam0, int iParam1)
{
	if (func_132(iParam0, iParam1))
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_111(iParam0), " flag ", func_197(iParam1));
	}
...
{
	if (func_201(bParam0) && func_245())
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 183, "RELEASE_DOOR_ID - Releasing Door ID ", func_204(bParam0, 0));
...
{
	return func_246(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}
...
int func_196(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1139844.f_7) && !func_248(12, func_247(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
int func_199(int iParam0, char* sParam1, int iParam2, char* sParam3, float fParam4, char* sParam5, var uParam6)
{
	struct<4> Var0;

	Var0 = func_250();
	Var0.f_2 = -738708473;
	Var0.f_3 = func_247(iParam0);
	if (!DATAFILE::_DATAFILE_GET_DATA_NODE_INDEX(&(Var0.f_1), &Var0))
	{
		DEBUG::_0x4DC69742196F818A(40, 139, "[NET_GET_SHOP_AUTHOR_DATA_WITH_STRING] Could not fill out region node for: ", func_128(iParam0));
		return 0;
	}
	Var0.f_2 = -1407851228;
	...
	DEBUG::_0x4DC69742196F818A(1747624, 139, "[NET_GET_SHOP_AUTHOR_DATA_WITH_STRING] eShop = ", func_128(iParam0), ", ", sParam5, " = ", MISC::_0x6C4DBF553885F9EB(*uParam6), ", ", sParam3, " = ", *fParam4);
	return 1;
}
...
bool func_200(bool bParam0, bool bParam1, bool bParam2)
{
	if (!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(bParam0))
	{
		if ((NETWORK::NETWORK_IS_IN_SESSION() && SCRIPTS::_DOES_THREAD_EXIST(Global_1051590.f_16[0])) && bParam1)
		{
			...
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add networked Door ", func_204(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
		else
		{
			OBJECT::_ADD_DOOR_TO_SYSTEM_NEW(bParam0, true, false, false, 0, 0, false);
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add Door ", func_204(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
	}
	...
	if (bParam2)
	{
		...
		DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Set door ", func_204(bParam0, 0), " able to change open ratio while locked");
		UNK_0x355E72323AEE83CC(183, 7);
	}
	return bParam0;
}
...
void func_202(bool bParam0, char* sParam1, bool bParam2, bool bParam3)
{
	if (func_201(bParam0))
	{
...
void func_203(bool bParam0, bool bParam1)
{
	if (func_201(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 2 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "LOCK_DOOR_ID - Locking Door ID ", func_204(bParam0, 0));
		}
	}
	else
	{
...
void func_205(bool bParam0, bool bParam1)
{
	if (func_201(bParam0))
	{
		...
		{
			DEBUG::_0x1B08D1EB9D8C4931(2216, 183, "SET_DOOR_ID_LOCKED_AND_UNBREAKABLE - Door ID ", func_204(bParam0, 0), " state = ", OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0), " pending state ", UNK_0x4BC2854478F3A749(bParam0));
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(bParam0, 1);
		}
	}
	else
...
void func_206(bool bParam0, bool bParam1)
{
	if (func_201(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 0 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "UNLOCK_DOOR_ID - Unlocking Door ID ", func_204(bParam0, 0));
		}
	}
	else
	{
...
int func_208(int iParam0)
{
	...
	if (iVar0 == 0)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "@@ GET_SHOP_STAT_ITEM: STAT_ITEMS for shop ", func_129(iParam0, 0), " is missing, please Bug DD Shops and Stables.");
	}
	return iVar0;
}
...
bool func_211(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_254(func_56(0)))
	{
		return true;
	}
...
char* func_218(char* sParam0, int iParam1)
{
...
void func_221(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	...
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that isnt stolen ", func_169(iParam0));
		return;
	}
	if (!func_164(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release an uninitialized regional character ", func_169(iParam0));
		return;
	}
	if ((!bParam4 && !func_220(iParam0)) && func_259(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that is stolen by a differnt script ", func_169(iParam0));
		return;
	}
	DEBUG::_0xF0783374333FD8CE(680, 138, "RELEASE_REGIONAL_CHARACTER: Regional character ", func_169(iParam0), " released by ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
	func_173(iParam0, 1);
	func_227(iParam0);
	if (func_260(func_170(iParam0)))
	{
		iVar0 = func_172(iParam0);
		if (!PERSCHAR::_0x800DF3FC913355F3(iVar0))
		{
			DEBUG::_0x9A6C65DDDBEC9C52(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character with no perschar index", func_169(iParam0));
			return;
		}
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being retasked ", func_169(iParam0));
	...
	if (func_164(iParam0, 128) && !bParam3)
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being destroyed on release ", func_169(iParam0));
		func_165(iParam0, 0);
	}
}
...
void func_226(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_229(iParam1), " on ", func_169(iParam0));
}
...
void func_227(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar0, false))
		{
			...
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_169(iParam0), " set as no longer needed.");
		}
		else
		{
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_169(iParam0), " was asked to be set as no longer needed, but this script does not own the ped.");
		}
	}
...
bool func_232(struct<2> Param0, int iParam2, int iParam3)
{
	int iVar0;
...
bool func_233(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_268(&(Global_1102630.f_4), iVar0, 5);
	}
	if (iParam1 == func_269())
	{
		return func_268(&(Global_1102630.f_4), iVar0, 5);
	...
	{
		return func_268(&(Global_1100880[iParam1 /*53*/].f_4), iVar0, 5);
	}
...
bool func_248(int iParam0, char* sParam1, var uParam2)
{
	var uVar0;

	if (func_271(iParam0, sParam1, &uVar0))
	{
		func_272(&uVar0, iParam0, uParam2);
	}
	else
	{
...
bool func_252()
{
	...
	if (!func_254(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_256(vector3 vParam0, int iParam3)
{
	...
	func_275(iParam3, &vVar0, &Var3, &uVar6);
	if (func_276(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
...
void func_272(var uParam0, int iParam1, var uParam2)
{
	...
	*uParam2 = iParam1;
	...
	{
		DEBUG::_0x83407B92D46F25C3(648, 84, "RETRIEVE_UNLOCK_DATA - Couldn't retrieve id at index ", uParam2->f_1, " of type ", func_281(iParam1, 0));
	}
	uParam0->f_2 = -2140901307;
...
bool func_276(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
...
int func_277(int iParam0)
{
	...
	DEBUG::_0xD9911C7B5F8CD69C(168, 139, "GET_SHOP_TYPE_FROM_SHOP - ", func_129(iParam0, 0), " undefined");
	return -1;
}
