...
void __EntryFunction__()
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 157, "Interacting with ", func_1(Var0.f_2, 0));
	vVar181 = { 0f, 0f, 0f };
	vVar184 = { 0f, 0f, 0f };
	vVar187 = { 0f, 0f, 0f };
	switch (func_2(Var0.f_2, -949239683))
	{
		case -1919515848:
			vVar181 = { 25f, 0f, 90f };
			vVar184 = { 0f, 0f, 0f };
			...
			break;
		case 1443104131:
			iVar190 = TASK::_GET_ITEM_INTERACTION_FROM_PED(Global_33);
			switch (iVar190)
			{
	...
	while (!SCRIPTS::_0x9E4EF615E307FBBE())
	{
		if (!ScriptParam_0.f_3)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Var0.f_180))
			{
				...
				{
					DEBUG::_0xA308F935BDECCEC0(8, 158, "Attach to RIGHT HAND");
					ENTITY::DETACH_ENTITY(Var0.f_180, false, true);
					func_3(&Var0, 7966, 0f, 0f, 0f, vVar184);
					bVar192 = false;
				}
				else if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, -1188360335))
				{
					DEBUG::_0xA308F935BDECCEC0(8, 158, "Attach to LEFT HAND");
					ENTITY::DETACH_ENTITY(Var0.f_180, false, true);
					func_3(&Var0, 37709, 0f, 0f, 0f, vVar184);
					bVar192 = false;
				}
				else if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, 1377726152))
				{
					DEBUG::_0xA308F935BDECCEC0(8, 158, "Attach to MOUTH");
					func_3(&Var0, 9650, vVar187, vVar181);
					bVar192 = true;
				}
			...
			{
				Var0.f_180 = TASK::_0x05A0100EA714DB68(Global_33, joaat("PRIMARYITEM"));
			}
		}
		if (!ScriptParam_0.f_3)
		{
		...
		switch (Var0.f_1)
		{
			...
			case 1:
				...
				{
					Var0.f_2.f_1++;
					func_8(&(Var0.f_2), IntToFloat(Var0.f_2.f_1) >= Var0.f_2.f_2);
				}
			...
			case 3:
				...
				{
					if (func_9() == -1 && func_10(0))
					{
						if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, 108107462))
						{
							if (!AUDIO::IS_SCRIPTED_SPEECH_PLAYING(Global_33))
							{
								if (func_11(Global_33, "Player_Sick_Smoking_Cough", joaat("SPEECH_PARAMS_FORCE"), 0, 1, 0, 0, 1))
								{
									bVar191 = true;
								}
							}
	...
	DEBUG::_0xF0783374333FD8CE(8, 157, "generic_alcohol_item - terminating ...");
}
...
void func_3(var uParam0, int iParam1, vector3 vParam2, vector3 vParam5)
{
	ENTITY::DETACH_ENTITY(uParam0->f_180, false, true);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_180, Global_33, PED::GET_PED_BONE_INDEX(Global_33, iParam1), vParam2, vParam5, true, true, false, false, 2, true, false, false);
}
...
{
	DEBUG::_0xA308F935BDECCEC0(680, 157, "SET_SMOKING_ITEM_STATE: from ", func_15(uParam0->f_1, 0), " to ", func_15(iParam1, 0));
	uParam0->f_1 = iParam1;
}
...
void func_8(var uParam0, bool bParam1)
{
	...
	if ((func_16(*uParam0, 1573112293) || func_16(*uParam0, 672467738)) || func_16(*uParam0, -550842268))
	{
		bVar10 = true;
	}
	bVar11 = func_17(*uParam0);
	...
	while (iVar0 < uParam0->f_11)
	{
		...
		switch (uParam0->f_33[iVar0 /*7*/].f_1)
		{
			...
			case -1104847406:
				...
				func_20((IntToFloat(uParam0->f_33[iVar0 /*7*/].f_2) / uParam0->f_2), 0);
				bVar8 = true;
				break;
			case 381158954:
				...
				break;
			case -416929031:
				fVar4 = func_22((IntToFloat(uParam0->f_33[iVar0 /*7*/].f_2) / uParam0->f_2), (uParam0->f_33[iVar0 /*7*/].f_5 / uParam0->f_2));
				func_23(0, fVar4, 1, 1, bVar10);
				bVar9 = true;
				break;
			case 1857353317:
				fVar5 = func_22((IntToFloat(uParam0->f_33[iVar0 /*7*/].f_2) / uParam0->f_2), (uParam0->f_33[iVar0 /*7*/].f_5 / uParam0->f_2));
				func_23(2, fVar5, 1, 1, bVar10);
				bVar8 = true;
				break;
			case 1681823811:
				fVar6 = func_22((IntToFloat(uParam0->f_33[iVar0 /*7*/].f_2) / uParam0->f_2), (uParam0->f_33[iVar0 /*7*/].f_5 / uParam0->f_2));
				func_23(1, fVar6, 1, 1, bVar10);
				break;
			case -816334026:
				func_24((BUILTIN::TO_FLOAT(uParam0->f_33[iVar0 /*7*/].f_2) / uParam0->f_2), 1 == uParam0->f_1);
				break;
			default:
				if (bParam1)
				{
					...
					{
						case 2062242710:
							fVar7 = func_25(BUILTIN::TO_FLOAT(uParam0->f_33[iVar0 /*7*/].f_3), uParam0->f_33[iVar0 /*7*/].f_4);
							func_26(19, fVar7, bVar11, 1);
							bVar9 = true;
							break;
						case -826379728:
							fVar7 = func_25(BUILTIN::TO_FLOAT(uParam0->f_33[iVar0 /*7*/].f_3), uParam0->f_33[iVar0 /*7*/].f_4);
							func_26(20, fVar7, bVar11, 1);
							bVar8 = true;
							break;
						case -1191740624:
							fVar7 = func_25(BUILTIN::TO_FLOAT(uParam0->f_33[iVar0 /*7*/].f_3), uParam0->f_33[iVar0 /*7*/].f_4);
							func_26(18, fVar7, bVar11, 1);
							break;
						case 1869697234:
							fVar7 = func_25(BUILTIN::TO_FLOAT(uParam0->f_33[iVar0 /*7*/].f_3), uParam0->f_33[iVar0 /*7*/].f_4);
							func_26(0, fVar7, bVar11, 1);
							bVar9 = true;
							break;
						case 1342237631:
							fVar7 = func_25(BUILTIN::TO_FLOAT(uParam0->f_33[iVar0 /*7*/].f_3), uParam0->f_33[iVar0 /*7*/].f_4);
							func_26(2, fVar7, bVar11, 1);
							bVar8 = true;
							break;
						case -1240225157:
							fVar7 = func_25(BUILTIN::TO_FLOAT(uParam0->f_33[iVar0 /*7*/].f_3), uParam0->f_33[iVar0 /*7*/].f_4);
							func_26(1, fVar7, bVar11, 1);
							break;
					}
				}
				break;
	...
	{
		func_27(uParam0);
		func_28(*uParam0, bVar8, bVar9, 562618531);
	}
	func_12(uParam0);
...
bool func_16(bool bParam0, bool bParam1)
{
	if (!func_5(bParam0, 0))
	{
		return func_31(func_30(bParam0), bParam1);
	}
	if (bParam1 == 0)
	{
		return false;
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[ITEM_HAS_PROPERTY_TAG] Found tag ", func_32(bParam1, 0), " for item ", func_1(bParam0, 0), ", returning TRUE");
		return true;
	}
	return false;
}
...
void func_19(float fParam0)
{
	...
	func_34((fParam0 * IntToFloat(iVar1)), 0);
	DEBUG::_0xF0783374333FD8CE(8, 84, "RPG_GLOBAL_REFILL_PLAYER_HEALTH_TANKS - Total Health Reserves # ", PED::_0x16F2C8C084AB2092(iVar0));
...
void func_20(float fParam0, bool bParam1)
{
	...
	func_36((fParam0 * IntToFloat(iVar0)), 0, bParam1);
}
...
float func_22(float fParam0, float fParam1)
{
	if (fParam1 != 0f)
	{
...
void func_23(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (fParam1 == 0f)
	{
		return;
	...
	if (bParam4)
	{
		fParam1 = func_39(iParam0, fParam1, 1);
	}
	func_41(iParam0, (func_40(iParam0, 2) + fParam1), bParam2, bParam3, 1, 2);
}
...
float func_25(float fParam0, int iParam1)
{
	switch (iParam1)
	{
		case 0:
...
int func_26(int iParam0, char* sParam1, bool bParam2, bool bParam3)
{
	...
	DEBUG::_0xF0783374333FD8CE(2472, 84, "RPG_GLOBAL_SET_OVERPOWER_FOR_PLAYER_ATTRIBUTE - Attribute: ", func_45(iParam0, 0), " will be Overpowered this frame for  ", sParam1, " seconds");
	return func_46(iParam0, sParam1, bParam2, bParam3);
}
...
void func_27(var uParam0)
{
	...
	switch (*uParam0)
	{
		...
		case 1934214136:
			...
			func_47(-1196069774, joaat("CONSUMABLE__DAILY_STEW"), 8100);
			break;
	}
}

void func_28(bool bParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	if (bParam2 || func_16(bParam0, -537818634))
	{
		func_49(func_48(joaat("MEDICINE_ITEMS_USED")), 1);
	}
	if (func_16(bParam0, -1457797660))
	{
		func_49(func_48(joaat("PROVISION_ITEMS_USED")), 1);
	}
	if (func_16(bParam0, 1573112293))
	{
		func_51(func_50(bParam0), 1);
	}
	if (func_16(bParam0, 1939071949))
	{
		func_49(func_52(joaat("USED"), joaat("TONIC")), 1);
	}
	if (func_16(bParam0, 1992556171))
	{
		func_49(func_48(joaat("CAMP_STEWS_CONSUMED")), 1);
	}
	if (func_16(bParam0, 1239889275))
	{
		func_49(func_48(joaat("ANTIQUE_BOTTLES_DRUNK")), 1);
	}
	switch (bParam0)
	{
		...
		case joaat("CONSUMABLE_HAYCUBE"):
			func_49(func_52(joaat("USED"), joaat("FEED_BAG")), 1);
			break;
	}
	switch (bParam0)
	{
		case -611782825:
			func_49(func_52(joaat("USED"), -1875859641), 1);
			break;
		case joaat("CONSUMABLE_MOONSHINE"):
			func_49(func_52(joaat("USED"), joaat("MOONSHINE")), 1);
			break;
		case joaat("CONSUMABLE_WHISKEY_USED"):
		case joaat("CONSUMABLE_WHISKEY"):
			func_49(func_52(joaat("USED"), joaat("WHISKEY")), 1);
			break;
		case joaat("CONSUMABLE_COCAINE_CHEWING_GUM_USED"):
		case joaat("CONSUMABLE_COCAINE_CHEWING_GUM"):
			func_49(func_52(joaat("USED"), joaat("COCAINE_GUM")), 1);
			break;
		case joaat("CONSUMABLE_SNAKE_OIL"):
		case joaat("CONSUMABLE_POTENT_SNAKE_OIL"):
		case joaat("CONSUMABLE_SNAKE_OIL_USED"):
			func_49(func_52(joaat("USED"), joaat("SNAKE_OIL")), 1);
			break;
		case joaat("CONSUMABLE_CHEWING_TOBACCO"):
		case joaat("CONSUMABLE_CHEWING_TOBACCO_USED"):
			func_49(func_52(joaat("USED"), joaat("CHEWING_TOBACCO")), 1);
			break;
		...
		case joaat("CONSUMABLE_POTENT_HORSE_MEDICINE"):
			func_49(func_52(joaat("USED"), joaat("HORSE_PILLS")), 1);
			break;
		case joaat("CONSUMABLE_HERBIVORE_BAIT"):
		case joaat("CONSUMABLE_POTENT_HERBIVORE_BAIT"):
			func_49(func_52(joaat("USED"), joaat("POTENT_HERBIVORE_BAIT")), 1);
			break;
		case joaat("CONSUMABLE_PREDATOR_BAIT"):
		case joaat("CONSUMABLE_POTENT_PREDATOR_BAIT"):
			func_49(func_52(joaat("USED"), joaat("POTENT_PREDATOR_BAIT")), 1);
			break;
	}
	if (func_9() == -1)
	{
		...
		{
			func_49(func_52(joaat("USED"), joaat("SPECIAL_TONIC")), 1);
		}
	}
	if (bParam1)
	{
...
int func_31(bool bParam0, bool bParam1)
{
	if (!func_54(bParam0, 2))
	{
		return 0;
	}
	if (bParam1 == 0)
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[BUNDLE_HAS_PROPERTY_TAG] Found tag ", func_32(bParam1, 0), " for bundle ", func_55(bParam0, 0), ", returning TRUE");
		return 1;
	}
	return 0;
}
...
void func_34(float fParam0, int iParam1)
{
	if (fParam0 == 0f)
	{
...
void func_36(float fParam0, bool bParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	float fVar2;
...
float func_39(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
	int iVar1;

	iVar0 = func_58();
	func_59(&iVar0, 0, 0, 0, 1, 0, 0);
	iVar1 = func_60(iParam0, 2);
	DEBUG::_0x1B08D1EB9D8C4931(8, 84, "_RPG_GLOBAL_APPLY_CORE_FIX_DEGRADE - Degrade Count: ", iVar1);
	if (func_62(iVar0, func_61(iParam0, 2), 1))
	{
		func_63(iParam0, 0, 2);
		iVar1 = 0;
		DEBUG::_0x1B08D1EB9D8C4931(8, 84, "_RPG_GLOBAL_APPLY_CORE_FIX_DEGRADE - Reseting Degrade Count to 0, it's a whole new day!");
		DEBUG::_0x1B08D1EB9D8C4931(40, 84, "_RPG_GLOBAL_APPLY_CORE_FIX_DEGRADE - Degrade Time of Day: ", func_64(iVar0));
		DEBUG::_0x1B08D1EB9D8C4931(40, 84, "_RPG_GLOBAL_APPLY_CORE_FIX_DEGRADE - Current Time of Day: ", func_64(func_61(iParam0, 2)));
	}
	if (iVar1 >= 2)
	{
		func_44(103, bParam2);
	...
	func_65(iParam0, func_58(), 2);
	func_63(iParam0, iVar1 + 1, 2);
	return fParam1;
}
...
float func_40(int iParam0, int iParam1)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_ATTRIBUTE_CORE_DISPLAY_STATE - Failed to retrieve Core Value for ", func_66(iParam0, 0), " Returning -1.0. This is really bad. ");
	return -1f;
}

int func_41(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)
{
	int iVar0;
	...
	iVar0 = PLAYER::PLAYER_PED_ID();
	if (func_67(iVar0, iParam0, fParam1))
	{
		if (bParam2)
		{
			if (fParam1 >= 100f)
		...
		if (bParam3)
		{
			func_68(iParam0, 7000, iParam5);
		}
		func_69(iVar0, iParam0, fParam1);
		DEBUG::_0xA308F935BDECCEC0(10664, 84, "__RPG_GLOBAL_SET_PLAYER_ATTRIBUTE_CORE - Caching Player Attribute Core ", func_66(iParam0, 0), " Value Data. Setting to: ", fParam1, " Override Enabled: ", MISC::_0xF216F74101968DB0(func_70()));
		func_71(iParam0, fParam1, bParam4, iParam5);
	}
	return 1;
}
...
bool func_42()
{
	...
	return func_72(Global_1957252.f_1431.f_107, 0);
}

void func_43(float fParam0, bool bParam1)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar1 != iVar2)
	{
		Global_1957252.f_1431.f_107 = func_58();
		func_76(&(Global_1957252.f_1431.f_107), 0, 0, 1, 0, 0, 0, 0);
	}
	func_77(13, fVar0, 2);
...
void func_44(int iParam0, bool bParam1)
{
	...
	func_78(iParam0, &iVar0, &iVar1);
	if (!func_79(iParam0, iVar0, iVar1, bParam1))
	{
		return;
	}
	func_80(iVar0, iVar1);
	DEBUG::_0xA308F935BDECCEC0(10376, 105, "TUTORIAL_MARK_RUN() - Tutorial with Set: ", iVar0, " & Flag", iVar1, " marked to run. ", func_81(iParam0));
...
int func_46(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	...
	iVar1 = PLAYER::PLAYER_PED_ID();
	DEBUG::_0xF0783374333FD8CE(2472, 84, "__RPG_GLOBAL_SET_OVERPOWER_FOR_PLAYER_ATTRIBUTE_INTERNAL - Attribute: ", func_45(iParam0, 0), " will be Overpowered this frame for  ", fParam1, " seconds on local player...");
	if (fParam1 == -1f)
	{
		if (func_82(iParam0))
		{
	...
	{
		DEBUG::_0x6D2A5155B260E879(2472, 84, "__RPG_GLOBAL_SET_OVERPOWER_FOR_PLAYER_ATTRIBUTE_INTERNAL - Attribute: ", func_45(iParam0, 0), " was set to a Duration of: ", fParam1, " this is really bad. Correct this. ");
		return 0;
	}
	switch (iParam0)
	{
		...
		case 1:
			...
			func_85(joaat("STATUS_EFFECT__TRACKING"));
			func_86(-1);
			ATTRIBUTE::ENABLE_ATTRIBUTE_OVERPOWER(iVar1, iParam0, fParam1, bParam3);
		...
		case 2:
			...
			break;
		case 19:
			func_85(joaat("STATUS_EFFECT__POISON"));
			func_88(0, 1, 1);
			ATTRIBUTE::ENABLE_ATTRIBUTE_OVERPOWER(iVar1, iParam0, fParam1, bParam3);
		...
		case 20:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(168, 84, "__RPG_GLOBAL_SET_OVERPOWER_FOR_PLAYER_ATTRIBUTE_INTERNAL - Attribute: ", func_45(iParam0, 0), " cannot be overpowered... Why are you doing this?");
			return 0;
	}
	return 1;
}
...
int func_47(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_89(iParam1))
	{
		DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_CONSUMABLE_PUSH_TO_SOURCE - Perk Group: ", func_90(iParam1, 0), " is not for Consumables. Bailing... ");
		return 0;
	}
	if (!func_91(iParam1))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(168, 84, "RPG_GLOBAL_CONSUMABLE_PUSH_TO_SOURCE - Provided Perk Group: ", func_90(iParam1, 0), " is not valid. Bailing... ");
		return 0;
	}
	if (!func_92(iParam0))
	{
		DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_CONSUMABLE_PUSH_TO_SOURCE - Perk Source: ", func_93(iParam0, 0), " is not for Consumables. Bailing... ");
		return 0;
	}
	if (!func_94(iParam0))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(168, 84, "RPG_GLOBAL_CONSUMABLE_PUSH_TO_SOURCE - Provided Perk Source: ", func_93(iParam0, 0), " is not valid. Bailing... ");
		return 0;
	}
	if (!func_95(iParam0))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(2728, 84, "RPG_GLOBAL_CONSUMABLE_PUSH_TO_SOURCE - There was already a Perk Group of Type: ", func_90(Global_1146683.f_35859.f_919[func_96(iParam0, 1) /*12*/], 0), " in Source: ", func_93(iParam0, 0), " disabling previous perk group before attempting to add new Perk Group... ");
		func_97(iParam0);
	}
	DEBUG::_0xA308F935BDECCEC0(2728, 84, "RPG_GLOBAL_CONTENT_EFFECT_PUSH_TO_SOURCE - attempting to active Perk Group: ", func_90(iParam1, 0), " at Perk Source: ", func_93(iParam0, 0), " with Duration: ", iParam2);
	if (func_98(iParam0, iParam1))
	{
		...
		DEBUG::_0xA308F935BDECCEC0(680, 84, "RPG_GLOBAL_CONTENT_EFFECT_PUSH_TO_SOURCE - Enabled Source: ", func_93(iParam0, 0), " with Perk Group: ", func_90(iParam1, 0));
		DEBUG::_0xA308F935BDECCEC0(2216, 84, "RPG_GLOBAL_CONTENT_EFFECT_PUSH_TO_SOURCE - Source: ", func_93(iParam0, 0), " will be disabled automatically at timestamp: ", Global_1146683.f_47689.f_1[iVar0 /*2*/].f_1, " Current Time: ", Global_1275959.f_21);
		return 1;
	}
	return 0;
}
...
void func_51(int iParam0, int iParam1)
{
	...
	Var0 = { func_52(joaat("EATEN"), func_100(iParam0)) };
	STATS::_STAT_ID_INCREMENT_INT(&Var0, iParam1);
	func_49(func_101(joaat("HERBS_EATEN")), iParam1);
}

struct<2> func_52(int iParam0, int iParam1)
{
	struct<2> Var0;
...
void func_53(bool bParam0, int iParam1)
{
	...
	if (func_9() == 0)
	{
		...
		DEBUG::_0xF0783374333FD8CE(10920, 183, "GENERIC_ITEM_DAILY_CHALLENGES ", func_1(bParam0, 0), " with Tag ", func_32(bVar0, 0), " removed with reason ", func_102(iParam1, 0));
		if (iParam1 == -1387038764)
		{
			return;
		}
		if (func_16(bParam0, -136654233))
		{
			STATS::CHAL_ADD_GOAL_PROGRESS_INT(joaat("FEATURE_PM_DAILY_CHALLENGES"), joaat("MPDC_CONSUMABLE_CANNEDGOODSEATEN_00"), 1);
		}
		if ((func_16(bParam0, 1765172170) || 1443104131 == bVar0) || -1919515848 == bVar0)
		{
...
bool func_57(int iParam0)
{
	...
	fVar0 = (func_105(iParam0) - PLAYER::_0xDF66A37936D5F3D9(iParam0));
	return fVar0 <= 1f;
}
...
int func_60(int iParam0, int iParam1)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_ATTRIBUTE_CORE_DEGRADE_COUNT - Failed to retrieve Core Degrade Count for ", func_66(iParam0, 0), " Returning -1. This is really bad. ");
	return -1;
}
...
int func_61(int iParam0, int iParam1)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_ATTRIBUTE_CORE_DEGRADE_TIME_OF_DAY - Failed to retrieve Core Degrade Time of Day for ", func_66(iParam0, 0), " Returning -1. This is really bad. ");
	return -15;
}
...
void func_63(int iParam0, char* sParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DEGRADE_COUNT - Setting Core Degrade Count for ", func_66(iParam0, 0), " Pool: ", func_115(iParam2), " to ", sParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DEGRADE_COUNT - Failed to set Core Degrade Count for ", func_66(iParam0, 0), " Pool: ", func_115(iParam2), ". This is really bad. ");
			break;
	}
}
...
void func_65(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(10920, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DEGRADE_TIME_OF_DAY - Setting Core Degrade Time of Day for ", func_66(iParam0, 0), " Pool: ", func_115(iParam2), " to ", func_64(iParam1));
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DEGRADE_TIME_OF_DAY - Failed to set Core Degrade Time of Day for ", func_66(iParam0, 0), " Pool: ", func_115(iParam2), ". This is really bad. ");
			break;
	}
}
...
bool func_67(int iParam0, int iParam1, float fParam2)
{
	...
	ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(iParam0, func_117(iParam1), BUILTIN::CEIL(fParam2));
	return true;
}
...
void func_68(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DISPLAY_TIME - Setting Core Display Time for ", func_66(iParam0, 0), " Pool: ", func_115(iParam2), " to ", iParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DISPLAY_TIME - Failed to set Core Display Time for ", func_66(iParam0, 0), " Pool: ", func_115(iParam2), ". This is really bad. ");
			break;
	}
}

void func_69(int iParam0, int iParam1, float fParam2)
{
	char* sVar0;
	...
	{
		PED::_SET_PED_BLACKBOARD_FLOAT(iParam0, func_119(iParam1), fParam2, -1);
	}
	else
	{
		DEBUG::_0x6D2A5155B260E879(40, 84, "__RPG_GLOBAL_HANDLE_BLACKBOARD_FOR_ATTRIBUTE - INVALID BLACK BOARD NAME for Attribute Core: ", func_66(iParam1, 0));
	}
}
...
void func_71(int iParam0, char* sParam1, bool bParam2, int iParam3)
{
	...
	DEBUG::_0xA308F935BDECCEC0(43432, 84, "__RPG_GLOBAL_CACHE_ATTRIBUTE_CORE_DATA - Caching Attribute Core ", func_66(iParam0, 0), " Value Data. Setting to: ", sParam1, " Override Enabled: ", MISC::_0xF216F74101968DB0(func_70()), " Time Stamp: ", sVar0);
	func_120(iParam0, sParam1, iParam3);
	if (bParam2)
	{
		func_121(iParam0, sVar0, iParam3);
	}
}

bool func_72(int iParam0, bool bParam1)
{
	return func_62(func_58(), iParam0, bParam1);
}
...
float func_73(int iParam0, int iParam1)
{
	...
	{
		case 0:
			DEBUG::_0x1B08D1EB9D8C4931(424, 84, "[RPG_GLOBAL_GET_CACHED_PLAYER_ATTRIBUTE_XP] Pool for Attributes: ", func_122(0, 0), " Value: ", Global_1957252.f_1431.f_26[iParam0]);
			return Global_1957252.f_1431.f_26[iParam0];
		case 1:
			DEBUG::_0x1B08D1EB9D8C4931(424, 84, "[RPG_GLOBAL_GET_CACHED_PLAYER_ATTRIBUTE_XP] Pool for Attributes: ", func_122(1, 0), " Value: ", Global_1957252.f_1565.f_2.f_26[iParam0]);
			return Global_1957252.f_1565.f_2.f_26[iParam0];
		default:
			break;
	}
	DEBUG::_0x6D2A5155B260E879(40, 84, "[RPG_GLOBAL_GET_CACHED_PLAYER_ATTRIBUTE_XP] Couldn't retrieve Cached Attribute XP data for Attribute: ", func_45(iParam0, 0));
	return -1f;
}
...
void func_76(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar4 = func_110(*uParam0);
	iVar5 = func_111(*uParam0);
	if (((((iParam6 == 0 && iParam5 == 0) && iParam4 == 0) && iParam3 == 0) && iParam2 == 0) && iParam1 == 0)
	{
		return;
	}
...
int func_77(int iParam0, char* sParam1, int iParam2)
{
	...
	DEBUG::_0xA308F935BDECCEC0(10664, 84, "__RPG_GLOBAL_SET_PLAYER_ATTRIBUTE - Caching Attribute ", func_45(iParam0, 0), " XP Data. Setting to: ", sParam1, " Override Enabled: ", MISC::_0xF216F74101968DB0(func_70()));
	func_124(iParam0, sParam1, iParam2);
...
bool func_79(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_125(iParam1, iParam2))
	{
		if (!bParam3)
		{
			DEBUG::_0xA308F935BDECCEC0(168, 105, "TUTORIAL_CAN_GO_PENDING_CHECKS - Tutorial: ", func_81(iParam0), " has already run, and is not being forced.");
			return false;
		}
	}
	if (!func_126(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 105, "TUTORIAL_CAN_GO_PENDING_CHECKS - NOT CAN_TUTORIAL_PLAY_IN_MODE ", func_127(iParam0, 0));
		return false;
	}
	if (func_128(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 105, "TUTORIAL_CAN_GO_PENDING_CHECKS - Timed tutorial is delayed or finished ", func_127(iParam0, 0));
		return false;
	}
	if ((Global_1900777.f_67 && !func_129(iParam0, 1)) || func_130(32768))
	{
		if (!func_129(iParam0, 262144) || !Global_1904703.f_8785)
		{
...
char* func_83(int iParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(168, 84, "RPG_GLOBAL_GET_OVERPOWER_POSTFX_STRING_FOR_ATTRIBUTE - Attribute: ", func_45(iParam0, 0), " does not have an overpower post fx... Returning NULL ");
	return "";
}
...
void func_84(int iParam0)
{
	...
	func_34(BUILTIN::TO_FLOAT((iParam0 * iVar1)), 0);
	DEBUG::_0xF0783374333FD8CE(8, 84, "RPG_GLOBAL_REFILL_PLAYER_HEALTH_TANKS - Total Health Reserves # ", PED::_0x16F2C8C084AB2092(iVar0));
	DEBUG::_0xF0783374333FD8CE(8, 84, "RPG_GLOBAL_REFILL_PLAYER_HEALTH_TANKS - AFTER FILL - ENTITY CUR HP: ", ENTITY::GET_ENTITY_HEALTH(iVar0));
	DEBUG::_0xF0783374333FD8CE(8, 84, "RPG_GLOBAL_REFILL_PLAYER_HEALTH_TANKS - AFTER FILL - ENTITY MAX HP: ", ENTITY::GET_ENTITY_MAX_HEALTH(iVar0, true));
}
...
void func_85(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 84, "RPG_GLOBAL__DISABLE_ALL_STATUS_EFFECT_SOURCES_OF_TYPE - Now disabling all Status Effects with Perk Group: ", func_90(iParam0, 0));
	iVar1 = Global_1146683.f_47689.f_1.f_42;
	iVar2 = 0;
	while (iVar2 < iVar1)
	{
		iVar0 = Global_1146683.f_47689.f_1[iVar2 /*2*/];
		iVar3 = func_96(iVar0, 1);
		if (Global_1146683.f_35859.f_919[iVar3 /*12*/] == iParam0)
		{
			DEBUG::_0xA308F935BDECCEC0(168, 84, "RPG_GLOBAL__DISABLE_ALL_STATUS_EFFECT_SOURCES_OF_TYPE - Disabling Source: ", func_93(Global_1146683.f_47689.f_1[iVar2 /*2*/], 0), " at index: ", iVar2);
			func_97(iVar0);
...
void func_87(int iParam0, bool bParam1)
{
	...
	func_36(BUILTIN::TO_FLOAT((iParam0 * iVar0)), 0, bParam1);
}

void func_88(int iParam0, bool bParam1, bool bParam2)
{
	func_41(iParam0, 100f, bParam1, bParam2, 1, 2);
}
...
bool func_95(int iParam0)
{
	...
	return Global_1146683.f_35859.f_919[func_96(iParam0, 1) /*12*/] == -1;
}
...
int func_97(int iParam0)
{
	...
	iVar0 = func_96(iParam0, 1);
	if (!func_91(Global_1146683.f_35859.f_919[iVar0 /*12*/]))
	{
		return 1;
	}
	iVar3 = func_132(Global_1146683.f_35859.f_919[iVar0 /*12*/], 1);
	DEBUG::_0xA308F935BDECCEC0(2216, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Attempting to disable all Perks in Perk Group: ", func_90(Global_1146683.f_35859.f_919[iVar0 /*12*/], 0), " it has: ", Global_1146683.f_35859[iVar3 /*6*/].f_5, " perks...");
	iVar4 = 0;
	while (iVar4 < Global_1146683.f_35859[iVar3 /*6*/].f_5)
	{
		iVar1 = Global_1146683.f_35859[iVar3 /*6*/][iVar4];
		DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Disabling Perk: ", func_133(iVar1, 0), " from Source: ", func_93(iParam0, 0));
		switch (func_134(iParam0, iVar1))
		{
			case 0:
				DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - deactivating perk ", func_133(iVar1, 0), " directly");
				func_135(iVar1, iParam0, iVar4);
				break;
			case 1:
				iVar5 = 0;
				while (iVar5 < Global_1146683.f_35859.f_11700)
				{
					...
					{
						DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - removing perk ", func_133(iVar1, 0), " from the activation queue");
						func_135(iVar1, iParam0, iVar4);
						func_136(&(Global_1146683.f_35859.f_9503[iVar5 /*3*/]));
						...
						func_136(&(Global_1146683.f_35859.f_9503[Global_1146683.f_35859.f_11700 /*3*/]));
					}
					else
					{
						iVar5++;
				...
				break;
			case 2:
				DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - ignoring perk ", func_133(iVar1, 0), "...");
				Jump @977; //curOff = 554
				iVar2 = func_137(iVar1, 1);
				DEBUG::_0xA308F935BDECCEC0(2216, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Perk: ", func_133(iVar1, 0), " currently has num sources: ", Global_1146683.f_35859.f_3116[iVar2 /*31*/].f_29, " remaining... ");
				func_138(iVar2, -1);
				DEBUG::_0xA308F935BDECCEC0(2216, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Perk: ", func_133(iVar1, 0), " has num sources: ", Global_1146683.f_35859.f_3116[iVar2 /*31*/].f_29, " remaining... ");
				if (Global_1146683.f_35859.f_3116[iVar2 /*31*/].f_29 <= 0)
				{
					func_139(iVar2, 0);
					DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - all sources for Perk: ", func_133(iVar1, 0), " have been removed, disabling it");
					iVar6 = 0;
					while (iVar6 < Global_1146683.f_35859.f_9502)
					{
						if (Global_1146683.f_35859.f_9302[iVar6] != iVar1)
						{
							DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Evaluated Perk: ", func_133(iVar1, 0), " does not equal perk in slot: ", func_133(Global_1146683.f_35859.f_9302[iVar6], 0));
						}
						else
						{
							DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Evaluated Perk: ", func_133(iVar1, 0), " matches perk in slot! ");
			...
			func_140(&(Global_1146683.f_35859.f_919[iVar0 /*12*/]));
			return 1;
		}
...
bool func_98(int iParam0, int iParam1)
{
	...
	if (!func_94(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(648, 84, "__RPG_GLOBAL__ENABLE_PERK_SOURCE_INTERNAL - invalid Source ID ", iParam0, " Name: ", func_93(iParam0, 0));
		return false;
	}
	iVar0 = func_96(iParam0, 1);
	if (!func_91(iParam1))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(648, 84, "__RPG_GLOBAL__ENABLE_PERK_SOURCE_INTERNAL - invalid Perk ID ", iParam1, " Name: ", func_90(iParam1, 0));
		return false;
	}
	iVar1 = func_132(iParam1, 1);
	if (Global_1146683.f_35859.f_919[iVar0 /*12*/] == iParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(40, 84, "__RPG_GLOBAL__ENABLE_PERK_SOURCE_INTERNAL - Perk Group is already active: ", func_90(iParam1, 0));
		return true;
	}
	if (func_91(Global_1146683.f_35859.f_919[iVar0 /*12*/]))
	{
	...
	DEBUG::_0xA308F935BDECCEC0(2216, 84, "__RPG_GLOBAL__ENABLE_PERK_SOURCE_INTERNAL - Attempting to enable all Perks in Perk Group: ", func_90(Global_1146683.f_35859.f_919[iVar0 /*12*/], 0), " it has: ", Global_1146683.f_35859[iVar1 /*6*/].f_5, " perks...");
	iVar4 = 0;
	while (iVar4 < Global_1146683.f_35859[iVar1 /*6*/].f_5)
	{
		iVar2 = Global_1146683.f_35859[iVar1 /*6*/][iVar4];
		iVar3 = func_137(iVar2, 1);
		switch (func_141(iParam0, iVar2))
		{
			case 0:
				DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__ENABLE_PERK_SOURCE_INTERNAL - Activating perk ", func_133(iVar2, 0), " from enable");
				func_142(iVar2, iParam0, iVar4);
				break;
			case 1:
				DEBUG::_0xA308F935BDECCEC0(2728, 84, "__RPG_GLOBAL__ENABLE_PERK_SOURCE_INTERNAL - adding perk ", func_133(iVar2, 0), " + source ", func_93(iParam0, 0), " to activation queue");
				...
				break;
			case 2:
				DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__ENABLE_PERK_SOURCE_INTERNAL - ignoring perk ", func_133(iVar2, 0), "...");
				Jump @731; //curOff = 555
				if (Global_1146683.f_35859.f_3116[iVar3 /*31*/].f_29 <= 0)
				{
					...
					DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__ENABLE_PERK_SOURCE_INTERNAL - adding perk ", func_133(iVar2, 0), " to enabled queue. Number of enabled perks is now: ", Global_1146683.f_35859.f_9502);
				}
				func_138(iVar3, 1);
				DEBUG::_0xA308F935BDECCEC0(2728, 84, "__RPG_GLOBAL__ENABLE_PERK_SOURCE_INTERNAL - Registering perk ", func_133(iVar2, 0), " from source ", func_93(iParam0, 0), ". total sources: ", Global_1146683.f_35859.f_3116[iVar3 /*31*/].f_29);
				iVar4++;
			}
			return true;
		}
...
{
	return func_149(&(Global_1957252.f_1565), iParam0, 1);
}
...
{
	return (PLAYER::_0x592F58BC4D2A2CF3(iParam0, 0) - IntToFloat(func_150(2)));
}
...
int func_117(int iParam0)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_PED_ATTRIBUTE_FROM_RPG_GLOBAL_CORE - Attribute Core: ", func_66(iParam0, 0), " does not have an associated PED Attribute. This is REALLY bad, correct immediately... ");
	return 0;
}
...
void func_120(int iParam0, char* sParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(6824, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_VALUE - Setting Core Value for ", func_66(iParam0, 0), " Pool: ", func_115(iParam2), " to ", sParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_VALUE - Failed to set Core Value for ", func_66(iParam0, 0), " Pool: ", func_115(iParam2), ". This is really bad. ");
			break;
	}
}
...
void func_121(int iParam0, char* sParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_LAST_UPDATED_TIMESTAMP - Setting Last Updated Timestamp for ", func_66(iParam0, 0), " Pool: ", func_115(iParam2), " to ", sParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_LAST_UPDATED_TIMESTAMP - Failed to set Last Updated Timestamp for ", func_66(iParam0, 0), " Pool: ", func_115(iParam2), ". This is really bad. ");
			break;
	}
}
...
void func_124(int iParam0, float fParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(6824, 84, "__RPG_GLOBAL_SET_CACHED_ATTRIBUTE_XP - Setting Attribute XP for ", func_45(iParam0, 0), " Pool: ", func_115(iParam2), " to ", fParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_CACHED_ATTRIBUTE_XP - Failed to set Attribute XP for ", func_45(iParam0, 0), " Pool: ", func_115(iParam2), ". This is really bad. ");
			break;
	}
}
...
bool func_128(int iParam0)
{
	...
	while (iVar0 < Global_38.f_3538)
	{
		if (Global_38.f_3538[iVar0 /*3*/].f_2 == iParam0)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(168, 105, "IS_TIMED_TUTORIAL_DELAYED_OR_FINISHED time since last played tutorial ", func_127(iParam0, 0), " Seconds ", iVar2);
...
int func_134(int iParam0, int iParam1)
{
	...
	iVar2 = func_137(iParam1, 1);
	DEBUG::_0x1B08D1EB9D8C4931(10920, 84, "RPG_GLOBAL_STAT_GET_DEACTIVATION_TYPE - Source: ", func_93(iParam0, 0), " Perk: ", func_133(iParam1, 0), " Deactivation Trigger: ", func_161(Global_1146683.f_35859.f_3116[iVar2 /*31*/].f_1, 0));
...
int func_135(int iParam0, int iParam1, int iParam2)
{
	...
	func_163(iParam0, iParam1, iParam2);
	if (func_164(Global_1146683.f_35859.f_3116[iVar0 /*31*/]) && func_165(iParam0, Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK - Now checking Stack Group: ", func_166(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, 0), " for any perks that could be enabled now that this perk is diabled... ");
		vVar1 = { func_167(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4) };
		if (func_168(vVar1))
		{
			if (func_169(vVar1.x, vVar1.y, vVar1.z))
			{
				func_170(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, vVar1.x, vVar1.y, vVar1.z);
			}
			else
			{
				func_171(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4);
				DEBUG::_0x6D2A5155B260E879(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK - Failed to activate next availible perk in Stack Group: ", func_166(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, 0), " there was a critical failure... ");
			}
		}
		else
		{
			func_171(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4);
			DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK - No suitable replacement for active perk in Stack Group: ", func_166(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, 0), "...");
		}
	}
	return 1;
}
...
void func_138(int iParam0, int iParam1)
{
	...
	DEBUG::_0xF0783374333FD8CE(2216, 84, "__RPG_GLOBAL__ALTER_SOURCES_FOR_PERK_ID - Perk: ", func_133(func_172(iParam0, 1), 0), " is being altered by: ", iParam1, " to a total of: ", Global_1146683.f_35859.f_3116[iParam0 /*31*/].f_29);
}

void func_139(int iParam0, int iParam1)
{
	Global_1146683.f_35859.f_3116[iParam0 /*31*/].f_29 = iParam1;
	DEBUG::_0xF0783374333FD8CE(168, 84, "__RPG_GLOBAL__SET_SOURCES_FOR_PERK_ID - Perk: ", func_133(func_172(iParam0, 1), 0), " is being set to: ", Global_1146683.f_35859.f_3116[iParam0 /*31*/].f_29);
}
...
int func_141(int iParam0, int iParam1)
{
	...
	iVar1 = Global_1275959;
	iVar2 = func_137(iParam1, 1);
	DEBUG::_0x1B08D1EB9D8C4931(10920, 84, "RPG_GLOBAL_STAT_GET_ACTIVATION_TYPE -	Source: ", func_93(iParam0, 0), " Perk: ", func_133(iParam1, 0), " Activation Trigger: ", func_173(Global_1146683.f_35859.f_3116[iVar2 /*31*/], 0));
...
int func_142(int iParam0, int iParam1, int iParam2)
{
	...
	bVar1 = func_164(Global_1146683.f_35859.f_3116[iVar0 /*31*/]);
	if (bVar1 && func_175(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK - There is an active perk already in stack group: ", func_166(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, 0), " will need to disable perk first... ");
		vVar2 = { func_176(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4) };
		if (!func_163(vVar2.x, vVar2.y, vVar2.z))
		{
			DEBUG::_0x6D2A5155B260E879(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK - critical failure to deactivate active perk in stacking group: ", func_166(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, 0), " bailing out... ");
			return 0;
		}
	}
	if (func_169(iParam0, iParam1, iParam2))
	{
		if (bVar1)
		{
			func_170(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, iParam0, iParam1, iParam2);
		}
		return 1;
	}
	return 0;
...
int func_150(int iParam0)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_ATTRIBUTE_CORE_MAX_SIZE - Attribute Core: ", func_66(iParam0, 0), " is INVALID. Correct this immediately... ");
	return -1;
}
...
void func_154(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0x83407B92D46F25C3(559240, 0, "SET_TIMEOFDAY_DAY: Passed an invalid day [", iParam1, "] for the TIMEOFDAY's current month [", iVar0, "] for year ", iVar1, ". GET_NUMBER_OF_DAYS_IN_MONTH(eMonth, iYear) = ", func_112(iVar0, iVar1), ". Failed to set TIMEOFDAY.");
		return;
	}
...
bool func_163(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = func_96(iParam1, 1);
	iVar1 = func_137(iParam0, 1);
	iVar2 = func_132(Global_1146683.f_35859.f_919[iVar0 /*12*/], 1);
	if (Global_1146683.f_35859[iVar2 /*6*/][iParam2] != iParam0)
	{
		DEBUG::_0x9A6C65DDDBEC9C52(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK_INTERNAL - attempting to disable perk ", func_133(iParam0, 0), " from a source that hasn't previously enabled it ", func_93(iParam1, 0));
		return false;
	}
	...
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK_INTERNAL - deactivating perk ", func_133(iParam0, 0), " and source ", func_93(iParam1, 0));
	...
	while (iVar4 < Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_16)
	{
		...
		else
		{
			...
			Global_1146683.f_2169[iVar5 /*205*/].f_201 = (Global_1146683.f_2169[iVar5 /*205*/].f_201 - func_179(&(Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			DEBUG::_0xA308F935BDECCEC0(6824, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK_INTERNAL - removing perk ", func_133(iParam0, 0), " to stat mod ", func_180(iVar3, 0), " with strength ", Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/].f_1);
			func_181(iVar3);
		}
		iVar4++;
	}
...
bool func_164(struct<5> Param0, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30)
{
	return Param0.f_4 != 0;
}
...
bool func_169(int iParam0, int iParam1, int iParam2)
{
	...
	if (Global_1146683.f_35859[iVar2 /*6*/][iParam2] != iParam0)
	{
		DEBUG::_0x9A6C65DDDBEC9C52(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - attempting to disable perk ", func_133(iParam0, 0), " from a source that hasn't previously enabled it ", func_93(iParam1, 0));
		return false;
	}
	...
	DEBUG::_0xA308F935BDECCEC0(2728, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK - activating perk ", func_133(iParam0, 0), " and source ", func_93(iParam1, 0), " at POSIX time: ", Global_1275959.f_21);
	...
	while (iVar4 < Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_16)
	{
		...
		else
		{
			...
			Global_1146683.f_2169[iVar5 /*205*/].f_201 = (Global_1146683.f_2169[iVar5 /*205*/].f_201 + func_179(&(Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			DEBUG::_0xA308F935BDECCEC0(6824, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - adding perk ", func_133(iParam0, 0), " to stat mod ", func_180(iVar3, 0), " with strength ", func_179(&(Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			DEBUG::_0xA308F935BDECCEC0(6824, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - adding perk ", func_133(iParam0, 0), " to stat mod ", func_180(iVar3, 0), " with total ", Global_1146683.f_2169[iVar5 /*205*/].f_201);
			func_188(iVar3);
		}
		iVar4++;
	}
	DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - perk: ", func_133(iParam0, 0), " Flag Count: ", Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_28);
	iVar7 = 0;
	while (iVar7 < Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_28)
	{
		iVar6 = Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_17[iVar7 /*2*/];
		if (!func_182(iVar6))
		{
			DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - Flag: ", func_189(iVar6, 0), " is not valid... skipping... ");
		}
		else if (!func_190(&(Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_17[iVar7 /*2*/])))
		{
			DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - Flag: ", func_189(iVar6, 0), " is not currently disabled by tunables... skipping... ");
		}
		else
		{
			iVar8 = func_183(iVar6, 1);
			...
			{
				DEBUG::_0xA308F935BDECCEC0(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - Turning on flag ", func_189(iVar6, 0));
	...
	func_192(Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_2);
	return true;
}
...
void func_170(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (!func_185(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA - Perk Group: ", func_166(iParam0, 0), " is not valid... Bailing out... ");
		return;
	}
	iVar0 = func_186(iParam0, 1);
	if (!func_162(iParam1))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA - Perk: ", func_133(iParam1, 0), " is not valid... Bailing out... ");
		return;
	}
	if (!func_94(iParam2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA - Source: ", func_93(iParam2, 0), " is not valid... Bailing out... ");
		return;
	}
	if (!func_174(iParam3))
	{
	...
	DEBUG::_0xF0783374333FD8CE(680, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA - Setting Perk: ", func_133(iParam1, 0), " active for Perk Group: ", func_166(iParam0, 0));
...
void func_171(int iParam0)
{
	...
	iVar0 = func_186(iParam0, 1);
	DEBUG::_0xF0783374333FD8CE(680, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA_AS_INVALID - Setting Perk: ", func_133(-1, 0), " active for Perk Group: ", func_166(iParam0, 0));
...
bool func_179(var uParam0)
{
	...
	if (uParam0->f_2 != 0)
	{
		DEBUG::_0xF0783374333FD8CE(168, 84, "RPG_GLOBAL_STATS_GET_STAT_MOD_IMPACT - Stat Mod: ", func_180(*uParam0, 0), " has a Tunable associated with impact, looking up... ");
		bVar0 = func_194(794259616, uParam0->f_2, uParam0->f_1, "");
		DEBUG::_0xF0783374333FD8CE(424, 84, "RPG_GLOBAL_STATS_GET_STAT_MOD_IMPACT - Stat Mod: ", func_180(*uParam0, 0), " has an associated Tunable with impact: ", bVar0);
		return bVar0;
	}
	DEBUG::_0xF0783374333FD8CE(424, 84, "RPG_GLOBAL_STATS_GET_STAT_MOD_IMPACT - Stat Mod: ", func_180(*uParam0, 0), " using default Impact: ", uParam0->f_1);
	return uParam0->f_1;
}
...
void func_181(int iParam0)
{
	...
	if (!func_178(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__UNSUBSCRIBE_STAT_MOD - Stat Mod: ", func_180(iParam0, 0), " is Invalid... ");
		return;
	}
	iVar0 = func_177(iParam0, 1);
	if (!func_195(Global_1146683.f_2169[iVar0 /*205*/]))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__UNSUBSCRIBE_STAT_MOD - no RPG stat associated with stat mod ", func_180(iParam0, 0));
		return;
	}
	...
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__UNSUBSCRIBE_STAT_MOD - stat mod ", func_180(iParam0, 0), " is no longer impacting stat ", func_196(Global_1146683.f_2169[iVar0 /*205*/], 0));
	Global_1146683.f_2169[iVar0 /*205*/].f_204 = 0;
	if (!func_197(Global_1146683.f_2169[iVar0 /*205*/].f_203))
	{
		return;
	}
	iVar1 = func_198(Global_1146683.f_2169[iVar0 /*205*/].f_203, 1);
	...
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__UNSUBSCRIBE_STAT_MOD - removing stat ", func_196(Global_1146683.f_2169[iVar0 /*205*/], 0), " from subscribed action ", func_199(Global_1146683.f_2169[iVar0 /*205*/].f_203, 0));
	iVar2 = 0;
...
void func_184(int iParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_STAT_FLAG - Now Disabling Stat Flag: ", func_189(iParam0, 0));
	iVar0 = PLAYER::PLAYER_PED_ID();
	...
	switch (iParam0)
	{
		...
		case joaat("TRAIL_EFFECT"):
			...
			GRAPHICS::_0xC5CB91D65852ED7E(func_202(iParam0));
			break;
		case joaat("DRAIN_EFFECT"):
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
		case joaat("SLOW_AND_STEADY_VFX"):
			DEBUG::_0xF0783374333FD8CE(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_STAT_FLAG - Remove VFX ", func_189(iParam0, 0));
...
int func_187(int iParam0)
{
	...
	{
		iVar64 = func_137(Global_1146683.f_35859.f_9503[iVar65 /*3*/], 1);
		DEBUG::_0x1B08D1EB9D8C4931(168, 84, "RPG_GLOBAL_GET_ACTIVATION_QUEUE_PERK_INDEX_FROM_NEXT_AVAILIBLE_PERK_IN_STACK_GROUP - Now processing Perk: ", func_133(Global_1146683.f_35859.f_9503[iVar65 /*3*/], 0), "...");
		...
		else if (!func_206(Global_1146683.f_35859.f_9503[iVar65 /*3*/], Global_1146683.f_35859.f_9503[iVar65 /*3*/].f_1))
		{
		}
		else
		{
			Var1 = { func_207(Global_1146683.f_35859.f_9503[iVar65 /*3*/]) };
...
void func_188(int iParam0)
{
	...
	if (!func_178(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__SUBSCRIBE_STAT_MOD - Stat Mod: ", func_180(iParam0, 0), " is Invalid... ");
		return;
	}
	iVar0 = func_177(iParam0, 1);
	if (!func_195(Global_1146683.f_2169[iVar0 /*205*/]))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__SUBSCRIBE_STAT_MOD - no RPG stat associated with stat mod ", func_180(iParam0, 0));
		return;
	}
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__SUBSCRIBE_STAT_MOD - subcribing stat mod ", func_180(iParam0, 0), " to stat ", func_196(Global_1146683.f_2169[iVar0 /*205*/], 0));
	...
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__SUBSCRIBE_STAT_MOD - adding stat ", func_196(Global_1146683.f_2169[iVar0 /*205*/], 0), " to action ", func_199(Global_1146683.f_2169[iVar0 /*205*/].f_203, 0));
...
bool func_190(var uParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(680, 84, "RPG_GLOBAL_STATS_IS_STAT_FLAG_TUNABLE_ENABLED - Stat Flag: ", func_189(*uParam0, 0), " Associated Tunable: ", UNK_0x4379B6FA65D55295(uParam0->f_1));
	if (uParam0->f_1 != 0)
	{
		bVar0 = func_208(794259616, uParam0->f_1, 1, "");
		DEBUG::_0xF0783374333FD8CE(680, 84, "RPG_GLOBAL_STATS_IS_STAT_FLAG_TUNABLE_ENABLED - Stat Flag: ", func_189(*uParam0, 0), " is has Tunable Enabled State: ", MISC::_0xF216F74101968DB0(bVar0));
		return bVar0;
	}
	return true;
}
...
void func_191(int iParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_STAT_FLAG - Now Enabling Stat Flag: ", func_189(iParam0, 0));
	iVar0 = PLAYER::PLAYER_PED_ID();
	iVar1 = PLAYER::PLAYER_ID();
	switch (iParam0)
	{
		...
		case joaat("TRAIL_EFFECT"):
			...
			GRAPHICS::ANIMPOSTFX_PLAY(func_202(iParam0));
			break;
		case joaat("DRAIN_EFFECT"):
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			...
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_209(iParam0, 0));
			func_210(iVar2, 0, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_209(iParam0, 1));
			func_210(iVar2, 1, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_209(iParam0, 2));
			func_210(iVar2, 2, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_209(iParam0, 3));
			func_210(iVar2, 2, 1, iVar3, 0);
			break;
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
			DEBUG::_0xF0783374333FD8CE(8, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_STAT_FLAG - Moment to Recuperate VFX start. ");
			iVar2 = func_203(iParam0);
			func_210(iVar2, 3, 1, -1, 1);
			break;
		case joaat("SLOW_AND_STEADY_VFX"):
			DEBUG::_0xF0783374333FD8CE(8, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_STAT_FLAG - Slow and Steady VFX start. ");
			iVar2 = func_203(iParam0);
			func_210(iVar2, 4, 1, -1, 0);
			break;
		case joaat("MOMENT_TO_RECUPERATE_AURA"):
...
void func_192(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - Attempting to play Activation Sound: ", func_212(iParam0, 0));
	sVar0 = func_213(iParam0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - There is no sound name associated with Activation Sound: ", func_212(iParam0, 0), " not playing anything...");
		return;
	}
	DEBUG::_0x1B08D1EB9D8C4931(680, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - Found sound name: ", sVar0, " associated with Activation Sound: ", func_212(iParam0, 0));
	sVar1 = func_214(iParam0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - There is no sound set associated with Activation Sound: ", func_212(iParam0, 0), " not playing anything...");
		return;
	}
	DEBUG::_0x1B08D1EB9D8C4931(680, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - Found sound set: ", sVar1, " associated with Activation Sound: ", func_212(iParam0, 0));
	DEBUG::_0xF0783374333FD8CE(10920, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - Playing sound name: ", sVar0, " in sound set: ", sVar1, " for Activation Sound: ", func_212(iParam0, 0));
...
bool func_194(bool bParam0, bool bParam1, float fParam2, char* sParam3)
{
	struct<11> Var0;
	bool bVar22;

	if (func_215(bParam0, bParam1, &Var0))
	{
...
bool func_195(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(168, 84, "RPG_GLOBAL_STATS__ADD_STAT_ID_TO_UPDATE_QUEUE - adding stat ", func_196(iParam0, 0), " to update queue. Total stats in queue: ", Global_1146683.f_2165);
	return true;
}
...
void func_200()
{
	...
	{
		if (!func_216(Global_1277758[Global_1275959 /*87*/].f_86, 1))
		{
...
char* func_202(int iParam0)
{
	...
	DEBUG::_0x9A6C65DDDBEC9C52(168, 84, "RPG_GLOBAL_GET_STAT_FLAG_POSTFX_NAME - Stat Flag: ", func_189(iParam0, 0), " does not have a Post FX name. Should you set one up? ");
	return "";
}
...
int func_203(int iParam0)
{
	...
	DEBUG::_0x9A6C65DDDBEC9C52(168, 84, "RPG_GLOBAL_GET_STAT_FLAG_PTFX_SCRIPT_ID - Stat Flag: ", func_189(iParam0, 0), " does not have a Particle FX. Should you set one up? ");
	return 0;
}
...
bool func_206(int iParam0, int iParam1)
{
	...
	if (func_164(Global_1146683.f_35859.f_3116[iVar0 /*31*/]))
	{
		iVar3 = Global_1146683.f_35859.f_9286[func_186(iVar2, 1) /*3*/];
		Var4 = { func_207(iVar3) };
		if (iVar3 != iParam0 && Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_5 <= Var4.f_5)
		{
			DEBUG::_0x1B08D1EB9D8C4931(680, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - A stronger perk in the perk stack group: ", func_166(iVar2, 0), " is already active. Active Perk: ", func_133(iVar3, 0));
			return false;
		}
	}
	DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Evaluating Activation Trigger: ", func_173(Global_1146683.f_35859.f_3116[iVar0 /*31*/], 0), " for activation... ");
	switch (Global_1146683.f_35859.f_3116[iVar0 /*31*/])
	{
		...
		case joaat("ENTER_IN_VEHICLE"):
		case 2116793692:
			DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_133(iParam0, 0), " can be activated! ");
			return true;
		case joaat("ENTER_FREEROAM_OR_COOP"):
			if (!func_217() && !func_218())
			{
				DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_133(iParam0, 0), " can only be activated when you are in Free Roam or running COOP. Returning FALSE. ");
				return false;
			}
			DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_133(iParam0, 0), " can be activated! ");
			return true;
		case -2010146101:
			if (!func_217())
			{
				DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_133(iParam0, 0), " can only be activated when you are in Free Roam. Returning FALSE. ");
				return false;
			}
			DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_133(iParam0, 0), " can be activated! ");
			return true;
		case joaat("ENTER_REVIVED_REMOTE"):
			...
			{
				DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_133(iParam0, 0), " can only be activated from REMOTE players. Returning FALSE. ");
				return false;
			}
			DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_133(iParam0, 0), " can be activated from Remote Player Index: ", iVar1);
			return true;
		case -2129621195:
			iVar1 = func_160(iParam1);
			if (iVar1 == Global_1275959)
		...
		case joaat("ALLY_ENTER_DEADEYE"):
			...
			if (iVar1 != Global_1275959 && !func_219(Global_1275959.f_154[iVar1]))
			{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_133(iParam0, 0), " has no activation logic defined, fix this... ");
	return false;
}

struct<31> func_207(int iParam0)
{
	int iVar0;
...
bool func_208(bool bParam0, bool bParam1, bool bParam2, char* sParam3)
{
	struct<11> Var0;
	bool bVar22;
...
char* func_209(int iParam0, int iParam1)
{
	...
	DEBUG::_0x9A6C65DDDBEC9C52(168, 84, "RPG_GLOBAL_GET_STAT_FLAG_PTFX_BONE - Stat Flag: ", func_189(iParam0, 0), " does not have a Particle FX bone. Should you set one up? ");
	return "";
}
...
bool func_215(bool bParam0, bool bParam1, var uParam2)
{
	struct<5> Var0;
	int iVar7;
	...
	if (DATAFILE::_0x44B3A36933AC009C(&iVar7, &Var0, joaat("NAME")))
	{
		*uParam2 = bParam0;
		...
		uParam2->f_10.f_3 = func_221(iVar7);
...
bool func_218()
{
	...
	if (func_224(Global_524288.f_40400))
	{
