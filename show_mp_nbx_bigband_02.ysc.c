...
{
	DEBUG::_0xA308F935BDECCEC0(8, 201, "Launching GENERIC_SHOW_CORE_MP");
	...
	DEBUG::_0xF0783374333FD8CE(8, 201, "ENDING generic_show_core_mp.sch...");
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		func_6(&uLocal_16);
	}
...
void func_1(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(8, 201, "[PROCESS_PRE_GAME] Pre game processed");
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
	}
}
...
{
	DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_INIT_SHOW] INIT HOST INFORMATION!");
	if (vParam1.z == 1)
	{
		uParam0->f_1357 = 1;
		DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_INIT_SHOW] SET MC LAUCH ARG BOOL TO 1");
	}
	if (!uParam0->f_1357 && func_13(Global_1959062.f_1321, -2147483648))
	{
		func_14(&(Global_1959062.f_1321), -2147483648);
	}
	if (!uParam0->f_1559)
	{
...
bool func_3(var uParam0)
{
	if (func_15(0, 0))
	{
		DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOULD_EXIT] Kill event caught");
		return true;
	}
	if (uParam0->f_14 == 12)
	{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOULD_EXIT] Thread exit reason");
		return true;
	}
	return false;
}
...
void func_4(var uParam0, var uParam1, var uParam2)
{
	if (!func_16(uParam1, 2) && uParam0->f_1352 > 12)
	{
		uParam0->f_1352 = 12;
		func_17(uParam0, 2);
		DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_HOST_UPDATE] -- leaving due to no one being in the volume ");
	}
	if (uParam0->f_2 != -1)
	{
		uParam0->f_4 = !Global_1270114.f_3[uParam0->f_2 /*8*/].f_3;
		if (!uParam0->f_4)
		{
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 201, "[GSMP_HOST_UPDATE] -- STATE: ", func_19(uParam0->f_1352, 0));
	...
	switch (uParam0->f_1352)
	{
		case 0:
			if (uParam0->f_25 == 0)
			{
				uParam0->f_25 = Global_1275959.f_21;
			}
			if ((Global_1275959.f_21 - uParam0->f_25) > 5)
			{
				func_21(uParam0, 12);
				DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_HOST_STATE_INIT] Ending show due to failed due to attempts");
				return;
			}
			if (!func_22(uParam0))
			{
			...
			{
				func_23(uParam0, uParam1[uParam2->f_1 /*18*/]);
			}
			uParam0->f_25 = 0;
			func_24(uParam0);
			uParam0->f_5 = 0;
		...
		case 2:
			...
			DEBUG::_0x1B08D1EB9D8C4931(8, 201, "[GSMP_SHOW_HOST_STATE_CREATING] Reserved Ped Count: ", NETWORK::GET_NUM_RESERVED_MISSION_PEDS(false));
			DEBUG::_0x1B08D1EB9D8C4931(8, 201, "[GSMP_SHOW_HOST_STATE_CREATING] Reserved Object Count: ", NETWORK::GET_NUM_RESERVED_MISSION_OBJECTS(false));
			if ((Global_1275959.f_21 - uParam0->f_25) > 5)
			{
				func_21(uParam0, 12);
				DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_HOST_STATE_CREATING] Ending show due to failed reserve attempts - should return money to players. Set flag");
				return;
			}
			if (NETWORK::GET_NUM_RESERVED_MISSION_OBJECTS(false) < uParam0->f_24)
			{
				...
				DEBUG::_0x1B08D1EB9D8C4931(8, 201, "[GSMP_SHOW_HOST_STATE_CREATING] waiting for objects to reserve");
				return;
			}
			if (NETWORK::GET_NUM_RESERVED_MISSION_PEDS(false) < uParam0->f_23)
			{
				...
				DEBUG::_0x1B08D1EB9D8C4931(8, 201, "[GSMP_SHOW_HOST_STATE_CREATING] waiting for peds to reserve");
				return;
			}
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_HOST_STATE_CREATING] Reserved Ped Count: ", NETWORK::GET_NUM_RESERVED_MISSION_PEDS(false));
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_HOST_STATE_CREATING] Reserved Object Count: ", NETWORK::GET_NUM_RESERVED_MISSION_OBJECTS(false));
			uParam0->f_25 = 0;
			func_21(uParam0, 3);
			break;
		case 3:
		...
		case 8:
			...
			if (func_31(uParam0->f_1548.f_1))
			{
				if (uParam0->f_1559 && !func_32(uParam0, 4))
				{
					uParam0->f_23++;
					uParam0->f_24 += 5;
				...
				func_33(&(uParam0->f_1548), uParam0->f_1350);
			}
			if (func_34(uParam0))
			{
				if ((func_35(&(uParam0->f_1437)) && func_36(&(uParam0->f_1437)) > uParam0->f_1547) || uParam0->f_4)
				{
					func_28(&(uParam0->f_1437));
					func_21(uParam0, 9);
				}
			...
			break;
		case 9:
			if ((uParam0->f_1559 && uParam0->f_1548.f_10 == 0) && func_37(&(uParam0->f_1437)) > 3f)
			{
				uParam0->f_1548.f_10 = 1;
			}
			if ((func_35(&(uParam0->f_1437)) && func_36(&(uParam0->f_1437)) > 10000) || uParam0->f_1357)
			{
				uParam0->f_3 = 1;
			}
			if (uParam0->f_1559)
		...
		case 10:
			...
			else if (func_13(uParam0->f_1358, 256))
			{
				...
				func_39(uParam1[uParam2->f_1 /*18*/], 10);
			}
			break;
		case 11:
			if (func_27(uParam0))
			...
			{
				if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)) > func_41())
				{
			...
			else if (func_13(uParam0->f_1358, 8388608))
			{
				if (!func_13(uParam0->f_1358, 67108864))
				{
					if (uParam0->f_1357)
					{
						DEBUG::_0xA308F935BDECCEC0(8, 201, "show core - we have set g_showsData.bShowActOver");
						uParam0->f_8 = 1;
					}
					DEBUG::_0xA308F935BDECCEC0(8, 201, "show core - we completed single end show call");
					func_18(&(uParam0->f_1358), 67108864);
				}
				if (uParam0->f_1357)
				{
					if (func_43(&(uParam0->f_27)) && func_44(&(uParam0->f_27)) > 9000)
					{
						DEBUG::_0xA308F935BDECCEC0(8, 201, "show core - we are going to cleanup");
						func_21(uParam0, 12);
					}
				}
				else if (!uParam0->f_4)
		...
		case 12:
			if (!uParam0->f_1357 && func_13(uParam0->f_26, -2147483648))
			{
				...
				{
					uParam0->f_5 = 0;
					func_47(uParam0->f_1350);
				}
				uParam0->f_6 = 0;
				uParam0->f_7 = 0;
				DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_HOST_STATE_CLEANUP] we used the force cleanup");
				func_21(uParam0, 13);
				return;
			}
			if (uParam0->f_1357)
			{
				func_21(uParam0, 13);
				DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_HOST_STATE_CLEANUP] finished launched by MC cleanup");
			}
			else if (func_13(uParam0->f_1358, 536870912))
			{
				...
				uParam0->f_7 = 0;
				func_21(uParam0, 13);
				DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_HOST_STATE_CLEANUP] finished debug stop cleanup");
			}
			else if (!uParam0->f_4 && !uParam0->f_1357)
			{
				uParam0->f_6 = 0;
				uParam0->f_7 = 0;
				if (!func_48(uParam0->f_1350))
				{
					func_21(uParam0, 13);
					DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_HOST_STATE_CLEANUP] finished not in theater and not MC show cleanup");
				}
			}
			else
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_HOST_STATE_CLEANUP] should not be happening, but we are going back to playing state from cleanup");
				func_29(uParam0);
				func_21(uParam0, 11);
			}
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_HOST_STATE_CLEANUP] state finished -- ");
			break;
	}
}
...
void func_5(var uParam0, var uParam1, var uParam2)
{
	...
	func_50(uParam0, uParam1[uParam2->f_1 /*18*/]);
	if (!uParam0->f_1357)
	{
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 201, "[GSMP_CLIENT_UPDATE] -- STATE: ", func_52((uParam1[uParam2->f_1 /*18*/])->f_14, 0));
	switch ((uParam1[uParam2->f_1 /*18*/])->f_14)
	{
		case 0:
			if (!uParam0->f_1357)
			{
				func_53(&(uParam2->f_2), &(uParam2->f_247));
			}
			func_22(uParam0);
			func_39(uParam1[uParam2->f_1 /*18*/], 1);
			break;
		case 1:
			if (uParam0->f_1352 > 0)
			{
				func_39(uParam1[uParam2->f_1 /*18*/], 2);
			}
			break;
		case 2:
			func_23(uParam0, uParam1[uParam2->f_1 /*18*/]);
			func_39(uParam1[uParam2->f_1 /*18*/], 3);
			break;
		case 3:
			if (func_25(uParam0) && uParam0->f_1352 > 3)
			{
				func_39(uParam1[uParam2->f_1 /*18*/], 4);
			}
			break;
		case 4:
			if (!ANIMSCENE::_DOES_ANIM_SCENE_EXIST(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)))
			{
				func_54(uParam1[uParam2->f_1 /*18*/], 16);
				DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_CLIENT_STATE_PREP_ANIM]  Anim scene does not exist - skipping.");
			}
			else if (NETWORK::_NETWORK_HAS_CONTROL_OF_ANIM_SCENE(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)) && !func_16(uParam1, 16))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_CLIENT_STATE_PREP_ANIM]  HAS CONTROL OF ANIM SCENE.");
				func_55(uParam0, uParam1[uParam2->f_1 /*18*/]);
			}
			if (func_16(uParam1, 16))
			{
				func_39(uParam1[uParam2->f_1 /*18*/], 5);
			}
			break;
		case 5:
			func_29(uParam0);
			func_39(uParam1[uParam2->f_1 /*18*/], 6);
			break;
		case 6:
			if (func_56(uParam1[uParam2->f_1 /*18*/]))
			{
				...
				func_57(uParam1[uParam2->f_1 /*18*/]);
			}
			if (func_31(uParam0->f_1548.f_1) && func_32(uParam0, 4))
			{
				func_58(&(uParam0->f_1548), &((uParam1[uParam2->f_1 /*18*/])->f_15), uParam0->f_1350);
			}
			if (uParam0->f_1352 > 8)
			{
				func_39(uParam1[uParam2->f_1 /*18*/], 7);
			}
			break;
		case 7:
			if (uParam0->f_1559)
			...
			if (uParam0->f_3)
			{
				...
				if (uParam0->f_1559)
				{
					...
					Global_1959062.f_1325 = 1;
					if (uParam0->f_1351 == 1 || uParam0->f_1351 == 2)
					{
						func_18(&(uParam2->f_247), 4194304);
					}
				}
				func_39(uParam1[uParam2->f_1 /*18*/], 8);
			}
			break;
		case 8:
			if (uParam0->f_1559)
			{
				DEBUG::_0x1B08D1EB9D8C4931(8, 201, "[GSMP_CLIENT_UPDATE][STATE_START_STARTING] WAITING FOR SHOW_LIGHT_BIT_FADE_OUT_STAGE_LIGHTS TO CLEAR");
				func_58(&(uParam0->f_1548), &((uParam1[uParam2->f_1 /*18*/])->f_15), uParam0->f_1350);
				if (!func_13(uParam2->f_247, 16))
				{
					func_59(uParam0);
					func_60(uParam0->f_1350);
					func_39(uParam1[uParam2->f_1 /*18*/], 9);
				}
				return;
			}
			if ((func_61(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), 1) && !ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false)) && !func_13((uParam1[uParam2->f_1 /*18*/])->f_1, 128))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_CLIENT_UPDATE][STATE_START_STARTING] SHOW ANIM SCENE START CALLED");
			...
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_CLIENT_UPDATE][STATE_START_STARTING] curtainAnimScene DOESNT NOT EXIST");
			}
			if (!ANIMSCENE::_0x23E33CB9F4A3F547(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1376), func_62(1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_CLIENT_UPDATE][STATE_START_STARTING] PLAYLIST NOT LOADED~!!");
			}
			if (!ANIMSCENE::_0x1F0E401031E20146(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1376), func_62(1)))
			{
				ANIMSCENE::_SET_ANIM_SCENE_PLAYBACK_LIST_BOOL(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1376), func_62(1), true);
			}
			if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1376)) && !func_13(uParam0->f_1358, 512))
			{
			}
			else if (!func_13((uParam1[uParam2->f_1 /*18*/])->f_1, 1024))
			{
				...
				func_65(func_63(6), func_64());
				if (func_13(uParam0->f_1359, 1))
				{
					DEBUG::_0xA308F935BDECCEC0(8, 201, "CORE STREAM PLAY WAS CALLED");
					AUDIO::PLAY_STREAM_FROM_POSITION(2552.53f, -1310.069f, 49.21665f, AUDIO::_0x0556C784FA056628(func_66(uParam0->f_1350), func_67(uParam0->f_1350)));
				}
				if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)))
				{
					if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false))
		...
		case 10:
			...
			if (uParam0->f_1559)
			{
				...
				if (func_42())
				{
					...
					{
						func_47(uParam0->f_1350);
						func_39(uParam1[uParam2->f_1 /*18*/], 11);
					}
				}
			}
			else
			{
				...
				if (!func_70(uParam1[uParam2->f_1 /*18*/], 1))
				{
					func_71(&(uParam2->f_250), 1, 1);
				}
			}
			break;
		case 11:
			...
			if (!uParam0->f_1357 && func_13(uParam0->f_26, -2147483648))
			{
				...
				AUDIO::_0x531A78D6BF27014B(func_64());
				func_72(uParam0, uParam2);
				HUD::_DISPLAY_HUD_COMPONENT(-1618603322);
				DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_HOST_STATE_CLEANUP] we used the force cleanup");
				func_39(uParam1[uParam2->f_1 /*18*/], 12);
				return;
			}
			if (uParam0->f_1357)
			{
			...
			else
			{
				...
				func_29(uParam0);
				func_39(uParam1[uParam2->f_1 /*18*/], 10);
				func_73(uParam1[uParam2->f_1 /*18*/]);
			}
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_HOST_STATE_CLEANUP] state finished -- ");
			break;
	}
...
int func_9()
{
	...
	while (iVar0 != 2)
	{
		...
		{
			DEBUG::_0xF0783374333FD8CE(10660520, 8, "HANDLE_NET_SCRIPT_INITIALISATION: [", UNK_0x8F77B33B6A34D8BA(), ".sc]", &cVar3, ", ", &cVar7, " - ", " taking ", (MISC::GET_GAME_TIMER() - iVar1), " seconds to start.  Status = ", func_75(iVar0));
		}
...
bool func_15(bool bParam0, bool bParam1)
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		{
			DEBUG::_0xF0783374333FD8CE(168, 8, "KILL_EVENT_CAUGHT - NETWORK_IS_GAME_IN_PROGRESS() = FALSE - but bIgnoreTransition = TRUE and g_mpTransition.eMPState = ", func_79(Global_1572887, 0), ", so skipping");
		}
		else
		{
...
bool func_16(var uParam0, int iParam1)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 201, "[GSMP_ANY_CLIENT_HAS_FLAG_SET] --  checking if flag is set on any clients:  ", func_80(iParam1, 0));
	iVar0 = 0;
	while (iVar0 <= 31)
	{
		iVar1 = PLAYER::INT_TO_PARTICIPANTINDEX(iVar0);
		if (!func_81(iVar1) || !NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(iVar1))
		{
		}
		else
		{
			...
			else if (func_70(uParam0[iVar0 /*18*/], iParam1))
			{
				DEBUG::_0x4DC69742196F818A(8, 201, "[GSMP_ANY_CLIENT_HAS_FLAG_SET] -- Flag Found on at least one client");
				return true;
			}
		}
		iVar0++;
	}
	DEBUG::_0x4DC69742196F818A(8, 201, "[GSMP_ANY_CLIENT_HAS_FLAG_SET] -- Flag NOT found");
	return false;
}

void func_17(var uParam0, int iParam1)
{
	DEBUG::_0xA308F935BDECCEC0(40, 201, "[GSMP_HOST_SET_FLAG] Setting Host Flag: ", func_82(uParam0->f_11, 0));
	func_83(&(uParam0->f_11), iParam1);
}
...
char* func_19(int iParam0, int iParam1)
{
	...
	{
		case 0:
			return "GSMP_SHOW_HOST_STATE_INIT";
		case 1:
			return "GSMP_SHOW_HOST_STATE_STREAMING";
		case 2:
			return "GSMP_SHOW_HOST_STATE_RESERVING";
		case 3:
			return "GSMP_SHOW_HOST_STATE_CREATING";
		case 4:
			return "GSMP_SHOW_HOST_STATE_CREATED";
		case 5:
			return "GSMP_SHOW_HOST_STATE_STREAM_CROWD";
		case 6:
			return "GSMP_SHOW_HOST_STATE_CREATE_CROWD";
		case 7:
			return "GSMP_SHOW_HOST_STATE_PLACE_CROWD";
		case 8:
			return "GSMP_SHOW_HOST_STATE_WAITING";
		case 9:
			return "GSMP_SHOW_HOST_STATE_START_LIGHT_DIM";
		case 10:
			return "GSMP_SHOW_HOST_STATE_STARTING";
		case 11:
			return "GSMP_SHOW_HOST_STATE_PLAYING";
		case 12:
			return "GSMP_SHOW_HOST_STATE_CLEANUP";
		case 13:
			return "GSMP_SHOW_HOST_STATE_TERMINATE";
		default:
			break;
	}
	if (iParam1 >= 1)
...
void func_20(var uParam0, var uParam1)
{
	...
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 201, "[GSMP_SHOW_UPDATE_CURTAIN_HOST] anim scene does not exist.... [0]");
		return;
	}
	if (!NETWORK::_NETWORK_HAS_CONTROL_OF_ANIM_SCENE(iVar0))
	{
		NETWORK::_NETWORK_REQUEST_CONTROL_OF_ANIM_SCENE(iVar0);
		DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_UPDATE_CURTAIN_HOST] requesting control of the anim scene");
		return;
	}
	switch (uParam0->f_1356)
	{
		case 0:
			if (!func_85(iVar0, func_62(1), func_62(1)))
			{
				return;
			}
			func_86(&(uParam0->f_1356), 1);
			break;
		case 1:
			if (uParam0->f_30 == 1)
			{
				ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, func_87(), uParam0->f_1384, 0);
				func_89(iVar0, func_62(1), func_88());
				func_86(&(uParam0->f_1356), 2);
			}
			break;
		case 2:
			if (ANIMSCENE::_0x1F0E401031E20146(iVar0, func_62(1)))
			{
				func_90(iVar0, func_62(2), func_88());
				func_91(uParam0, 0);
				func_86(&(uParam0->f_1356), 3);
			}
			break;
		case 3:
			if (!func_85(iVar0, func_62(2), func_88()))
			{
				return;
			}
			func_86(&(uParam0->f_1356), 4);
			break;
		case 4:
			if (uParam0->f_30 == 2)
			{
				ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, func_87(), uParam0->f_1384, 0);
				func_89(iVar0, func_62(2), func_88());
				func_86(&(uParam0->f_1356), 5);
			}
			break;
		case 5:
			if (ANIMSCENE::_0x1F0E401031E20146(iVar0, func_62(2)))
			{
				func_90(iVar0, func_62(1), func_88());
				func_91(uParam0, 0);
				func_86(&(uParam0->f_1356), 0);
			}
			break;
	}
}
...
void func_21(var uParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 201, "[GSMP_CHANGE_HOST_SHOW_STATE]: moving from: ", func_19(func_92(uParam0), 0), " to ", func_19(iParam1, 0));
...
{
	DEBUG::_0xA308F935BDECCEC0(8, 201, "[SETUP_SHOW_ASSETS] -- show_mp_nbx_fireDance_01.sc");
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		DEBUG::_0xA308F935BDECCEC0(8, 201, "[SETUP_SHOW_ASSETS] Setting host data for show assets");
		uParam0->f_1351 = 0;
		uParam0->f_24 = 8;
		uParam0->f_23 = 4;
		uParam0->f_2 = 0;
		...
		if (!ANIMSCENE::_DOES_ANIM_SCENE_EXIST(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[SETUP_SHOW_ASSETS] Creating anim scene - script@shows@band_play@p1_and_p2");
			uParam0->f_1373 = ANIMSCENE::_CREATE_ANIM_SCENE("script@shows@band_play@p1_and_p2", 2, func_94(1), true, true);
			uParam0->f_1374 = NETWORK::_ANIM_SCENE_TO_NET(uParam0->f_1373);
		}
	}
	DEBUG::_0xA308F935BDECCEC0(8, 201, "[SETUP_SHOW_ASSETS] requesting Clip - script@shows@band_play@p1_and_p2");
	return true;
}
...
void func_23(var uParam0, var uParam1)
{
	...
	{
		bVar1 = uParam0->f_1385[iVar0];
		if (func_95(bVar1))
		{
			STREAMING::REQUEST_MODEL(bVar1, false);
			DEBUG::_0xF0783374333FD8CE(40, 201, "REQUEST_SHOW_ASSETS: requesting the object model asset: ", UNK_0x1B7C373FB4E76B85(bVar1));
		}
		iVar0++;
	}
	iVar0 = 0;
	...
	{
		bVar2 = uParam0->f_1401[iVar0];
		if (func_95(bVar2))
		{
			STREAMING::REQUEST_MODEL(bVar2, false);
			DEBUG::_0xF0783374333FD8CE(40, 201, "REQUEST_SHOW_ASSETS: requesting the actor model asset: ", UNK_0x1B7C373FB4E76B85(bVar2));
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < uParam0->f_1415)
	{
		...
		if (bVar3 != 0)
		{
			if (WEAPON::IS_WEAPON_VALID(bVar3))
			{
				...
				DEBUG::_0xF0783374333FD8CE(40, 201, "REQUEST_SHOW_ASSETS: requesting weapon model asset: ", WEAPON::_0x6D3AC61694A791C5(bVar3));
			}
		}
		iVar0++;
	}
	STREAMING::REQUEST_MODEL(uParam0->f_1383, false);
	DEBUG::_0xF0783374333FD8CE(8, 201, "REQUEST_SHOW_ASSETS: requesting the Curtain");
	if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)) && !ANIMSCENE::_IS_ANIM_SCENE_LOADED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), true, false))
	{
		...
		DEBUG::_0xF0783374333FD8CE(8, 201, "REQUEST_SHOW_ASSETS: requesting the anim scene ID: ", NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374));
	}
}
...
void func_24(var uParam0)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(8, 201, "[GSMP_SHOW_INITILIZE_WEAPON_ARRAY] -- Initializing: ");
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < uParam0->f_1415)
	{
...
bool func_25(var uParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_HAVE_SHOW_ASSETS_LOADED] -- ");
	iVar0 = 0;
	while (iVar0 < uParam0->f_1385)
	{
		bVar1 = uParam0->f_1385[iVar0];
		if (func_95(bVar1))
		{
			...
			{
				DEBUG::_0x4DC69742196F818A(40, 201, "HAVE_SHOW_ASSETS_LOADED: Model not currently loaded: ", UNK_0x1B7C373FB4E76B85(bVar1));
				return false;
			}
		}
		iVar0++;
	...
	while (iVar0 < uParam0->f_1401)
	{
		...
		if (func_95(bVar2))
		{
			if (!STREAMING::HAS_MODEL_LOADED(bVar2))
			{
				DEBUG::_0x4DC69742196F818A(40, 201, "HAVE_SHOW_ASSETS_LOADED: Model not currently loaded: ", UNK_0x1B7C373FB4E76B85(bVar2));
				return false;
			}
		}
		iVar0++;
	...
	while (iVar0 < uParam0->f_1415)
	{
		...
		if (bVar3 != 0)
		{
			...
			{
				DEBUG::_0x4DC69742196F818A(40, 201, "[GSMP_HAVE_SHOW_ASSETS_LOADED]: Weapon not currently loaded: ", WEAPON::_0x6D3AC61694A791C5(bVar3));
				return false;
			}
		}
		iVar0++;
	...
	{
		DEBUG::_0x4DC69742196F818A(8, 201, "[GSMP_HAVE_SHOW_ASSETS_LOADED]: Curtain not currently loaded");
		return false;
	}
	if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)))
	{
		...
		{
			DEBUG::_0x4DC69742196F818A(8, 201, "[GSMP_HAVE_SHOW_ASSETS_LOADED]: Anim scene not currently loaded, ID: ", NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374));
			return false;
		}
	}
	if (!AUDIO::_0xD9130842D7226045(func_64(), 1))
	{
		DEBUG::_0xA308F935BDECCEC0(8, 201, "Waiting on Sound Set to load");
		return false;
	}
	if (!func_96(uParam0))
	{
		DEBUG::_0x4DC69742196F818A(8, 201, "[GSMP_HAVE_SHOW_ASSETS_LOADED] -- CUSTOM_SHOW_LOADING not yet returning true.");
		return false;
	}
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_1435))
	{
		...
		{
			DEBUG::_0x9A6C65DDDBEC9C52(40, 201, "[GSMP_HAVE_SHOW_ASSETS_LOADED]TEXT REQUEST FAILED: dialogue text block doesn't exist! : ", uParam0->f_1435);
		}
		...
		{
			DEBUG::_0xA308F935BDECCEC0(168, 201, "[GSMP_HAVE_SHOW_ASSETS_LOADED] -- Audio Block Loaded: ", uParam0->f_1435, " ---------------------");
		}
	}
	if (!func_97(uParam0))
	{
	...
	DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_HAVE_SHOW_ASSETS_LOADED] -- ALL ASSETS PROPERLY LOADED");
	return true;
}
...
bool func_26(var uParam0)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_CREATE_SHOW_ASSETS_NEW] Light Show");
		if (!func_98(&(uParam0->f_1384), uParam0->f_1383, uParam0->f_1370))
		{
			DEBUG::_0x4DC69742196F818A(8, 201, "[CUSTOM_CREATE_SHOW_ASSETS_NEW] Curtains not created");
			return false;
		}
		if (!func_100(&(uParam0->f_1375), &(uParam0->f_1376), &(uParam0->f_1358), func_88(), func_99(0), 1))
		{
			DEBUG::_0x4DC69742196F818A(8, 201, "[CUSTOM_CREATE_SHOW_ASSETS_NEW] anim scene curtain scene not loaded");
			return false;
		}
		ANIMSCENE::SET_ANIM_SCENE_ENTITY(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1376), func_87(), uParam0->f_1384, 0);
		if (!func_85(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1376), func_99(1), func_88()))
		{
			DEBUG::_0x4DC69742196F818A(8, 201, "[CUSTOM_CREATE_SHOW_ASSETS_NEW] playback list not requested");
			return false;
		}
	}
	iVar0 = 0;
	while (iVar0 <= 5)
	{
		...
		{
			if (!func_101(&(uParam0->f_1408[iVar0]), uParam0->f_1401[iVar0], uParam0->f_1367, 0f))
			{
				DEBUG::_0x4DC69742196F818A(8, 201, "[CUSTOM_CREATE_SHOW_ASSETS_NEW] acctor not created");
				return false;
			}
		}
		iVar0++;
	...
	if (!func_102(uParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_CREATE_SHOW_ASSETS_NEW] waiting for this to complete");
		return false;
	}
	func_103(uParam0);
	if (!uParam0->f_1357 && !uParam0->f_1559)
	{
		DEBUG::_0xA308F935BDECCEC0(8, 201, "[CREATE_SHOW_ASSETS] - CALLING SET_ANIM_SCENE_ENTITY: CURTAIN");
...
void func_29(var uParam0)
{
	...
	func_105(uParam0, &uVar0);
	DEBUG::_0x1B08D1EB9D8C4931(8, 201, "SHOW_UNLOCK_DOORS - Unlocking show doors.");
	if (uVar0[0] == 0)
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 201, "SHOW_UNLOCK_DOORS - Show does not use doors.");
		return;
	}
	iVar5 = 0;
	while (iVar5 < 4)
...
{
	DEBUG::_0x4DC69742196F818A(680, 201, "[GSMP_HOST_IS_FLAG_SET] Client Host ", func_82(uParam0->f_11, 0), " Set: ", MISC::_0xF216F74101968DB0(func_108(uParam0->f_11, iParam1)));
	return func_108(uParam0->f_11, iParam1);
}
...
void func_33(var uParam0, int iParam1)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 201, "[GSMP_SHOW_HOST_PROJECTIONIST_UPDATE] -- STATE: ", func_109(*uParam0, 0));
	switch (*uParam0)
	{
		case 0:
			func_110(uParam0, 1);
			break;
		case 1:
			if (!STREAMING::HAS_MODEL_LOADED(func_111()) || !STREAMING::HAS_MODEL_LOADED(func_112(0)))
			{
				DEBUG::_0x4DC69742196F818A(8, 201, "[GSMP_SHOW_HOST_PROJECTIONIST_UPDATE][STATE_CREATE] Models not yet loaded");
				return;
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_2))
			{
				uParam0->f_2 = func_115(func_111(), func_113(uParam0->f_1), func_114(uParam0->f_1), 1, 1, 1, 1, 1, 1, 0, 0);
				DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_HOST_PROJECTIONIST_UPDATE][STATE_CREATE] CREATE_PED_WITH_DEFAULTS");
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_2))
			{
				DEBUG::_0x4DC69742196F818A(8, 201, "[GSMP_SHOW_HOST_PROJECTIONIST_UPDATE][STATE_CREATE] ped not yet created");
				return;
			}
			else
			{
				...
				{
					DEBUG::_0x4423BBAB7EB2B96B(8, 201, "[GSMP_SHOW_HOST_PROJECTIONIST_UPDATE] !!! ASSERT !!! WE DO NOT HAVE CONTROL OF THIS PED! - THIS NEEDS TO BE MOVED TO CLIENT UPDATE?");
				}
				DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_HOST_PROJECTIONIST_UPDATE][STATE_CREATE] Setting up ped config flags");
			...
			{
				iVar1 = iVar0;
				uParam0->f_3[iVar0] = OBJECT::CREATE_OBJECT(func_112(iVar1), func_116(iVar1), true, true, false, false, true);
				DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_HOST_PROJECTIONIST_UPDATE][STATE_CREATE] Creating Objects");
				iVar0++;
			}
			func_110(uParam0, 2);
			break;
		case 2:
			...
			{
				uParam0->f_9 = ANIMSCENE::_CREATE_ANIM_SCENE(func_117(iParam1), 0, func_118(iParam1, 0), true, true);
				ANIMSCENE::LOAD_ANIM_SCENE(uParam0->f_9);
				ANIMSCENE::SET_ANIM_SCENE_ORIGIN(uParam0->f_9, func_119(iParam1), func_120(iParam1), 2);
				DEBUG::_0xA308F935BDECCEC0(40, 201, "Load anim scene called on for: ", func_117(iParam1));
			}
		...
		case 3:
			...
			break;
		case 4:
			if (!ANIMSCENE::_0x1F0E401031E20146(uParam0->f_9, func_118(iParam1, 1)) || !ANIMSCENE::_0x23E33CB9F4A3F547(uParam0->f_9, func_118(iParam1, 1)))
			{
				return;
			}
			func_110(uParam0, 5);
...
bool func_38(var uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_39(var uParam0, int iParam1)
{
	...
	{
		DEBUG::_0xF0783374333FD8CE(680, 201, "CHANGE_SHOW_STATE: moving from: ", func_52(uParam0->f_14, 0), " to ", func_52(iParam1, 0));
...
void func_40(var uParam0, var uParam1, var uParam2)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(8, 201, "[fireDance_02][CUSTOM_UPDATE] -- ");
	if (!ANIMSCENE::_DOES_ANIM_SCENE_EXIST(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)))
	{
		DEBUG::_0xA308F935BDECCEC0(8, 201, "[fireDance_02][CUSTOM_UPDATE] ANIM SCENE DOES NOT EXIST - EXITING");
		return;
	}
	fVar0 = ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374));
	DEBUG::_0x1B08D1EB9D8C4931(24, 201, "[fireDance_02][CUSTOM_UPDATE] fPhase: ", fVar0);
	DEBUG::_0x4DC69742196F818A(40, 201, "[fireDance_02][CUSTOM_UPDATE] Anim Scene Running: ", MISC::_0xF216F74101968DB0(ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false)));
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		func_126(uParam0, uParam1, uParam2, fVar0);
	}
	func_127(uParam0, uParam1, uParam2, fVar0);
}
...
bool func_42()
{
	...
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 201, "SHOW_HAS_MOVIE_FINISHED_PLAYING: TRUE - NO TV CHANNEL SET");
		return true;
	}
	if (GRAPHICS::_IS_TV_PLAYLIST_ITEM_PLAYING(joaat("END_OF_MOVIE_MARKER")))
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 201, "SHOW_HAS_MOVIE_FINISHED_PLAYING: TRUE - END OF MOVIE MARKER REACHED");
		return true;
	}
	return false;
}
...
void func_46(var uParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(8, 201, "SHOW_STOP_MOVIE_PLAYBACK: MOVIE PLAYBACK STOPPED");
}
...
void func_47(int iParam0)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(8, 201, "SHOW_LOCK_DOORS - Locking show doors.");
	if (Global_1959062.f_7[iParam0 /*31*/].f_7[0] == 0)
	{
		if (func_130() == 81)
		{
			func_131(1015669983);
		}
		DEBUG::_0x1B08D1EB9D8C4931(8, 201, "SHOW_LOCK_DOORS - Show does not use doors.");
		return;
	}
	iVar0 = 0;
	while (iVar0 < 4)
	{
		bVar1 = Global_1959062.f_7[iParam0 /*31*/].f_7[iVar0];
		if (bVar1 != 0)
		{
			if (!func_132(bVar1) && !func_133(bVar1))
			{
				func_134(bVar1, 1, 0, 0, 0, 0, 0, 0);
			}
		}
		iVar0++;
	}
...
bool func_48(int iParam0)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(8, 201, "ARE_SHOW_DOORS_OPEN - Checking show doors...");
	if (Global_1959062.f_7[iParam0 /*31*/].f_7[0] == 0)
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 201, "ARE_SHOW_DOORS_OPEN - No doors used.");
		return false;
	}
	iVar0 = 0;
	while (iVar0 < 4)
...
{
	if (func_136(Global_33, uParam0->f_9, 0, 1, 0))
	{
		func_54(uParam1[uParam2->f_1 /*18*/], 1);
	}
	else if (func_70(uParam1[uParam2->f_1 /*18*/], 1))
	{
		func_137(uParam1[uParam2->f_1 /*18*/], 1);
	}
	if (func_136(Global_33, uParam0->f_10, 0, 1, 0))
	{
		func_54(uParam1[uParam2->f_1 /*18*/], 2);
	}
	else if (func_70(uParam1[uParam2->f_1 /*18*/], 2))
	{
		func_137(uParam1[uParam2->f_1 /*18*/], 2);
	}
}
...
void func_50(var uParam0, var uParam1)
{
	...
	while (iVar0 <= 2)
	{
		if (!uParam0->f_12[iVar0 /*3*/].f_2)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(8, 201, "GSMP_SHOW_LOAD_PLAYLIST_CLIENT Cleaning up Client Playlist: ", iVar0);
		}
		else
		{
			if (!func_138(&(uParam0->f_12[iVar0 /*3*/]), &(uParam1->f_3[iVar0 /*3*/])))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_LOAD_PLAYLIST_CLIENT] playlists do not match.");
				func_139(&(uParam0->f_12[iVar0 /*3*/]), &(uParam1->f_3[iVar0 /*3*/]));
			}
			uParam1->f_3[iVar0 /*3*/].f_2 = func_85(NETWORK::_NET_TO_ANIM_SCENE(uParam1->f_3[iVar0 /*3*/]), uParam1->f_3[iVar0 /*3*/].f_1, uParam1->f_3[iVar0 /*3*/].f_1);
			DEBUG::_0x4DC69742196F818A(680, 201, "GSMP_SHOW_LOAD_PLAYLIST_CLIENT - Playlist: ", uParam1->f_3[iVar0 /*3*/].f_1, " LOADED: ", MISC::_0xF216F74101968DB0(uParam1->f_3[iVar0 /*3*/].f_2));
		}
		iVar0++;
	}
}
...
{
	func_140(&(uParam1->f_2), &(uParam1->f_247), uParam0->f_2);
	func_141(&(uParam1->f_247), &(uParam1->f_2), uParam0->f_2);
}
...
char* func_52(int iParam0, int iParam1)
{
	...
	{
		case -1:
			return "GSMP_SHOW_CLIENT_STATE_INVALID";
		case 0:
			return "GSMP_SHOW_CLIENT_STATE_INIT";
		case 1:
			return "GSMP_SHOW_CLIENT_STATE_PRE_REQUEST";
		case 2:
			return "GSMP_SHOW_CLIENT_STATE_REQUEST";
		case 3:
			return "GSMP_SHOW_CLIENT_STATE_STREAMING";
		case 4:
			return "GSMP_SHOW_CLIENT_STATE_PREP_ANIM";
		case 5:
			return "GSMP_SHOW_CLIENT_STATE_CURTAINS";
		case 6:
			return "GSMP_SHOW_CLIENT_STATE_WAITING";
		case 7:
			return "GSMP_SHOW_CLIENT_STATE_START_LIGHT_DIM";
		case 8:
			return "GSMP_SHOW_CLIENT_STATE_START_STARTING";
		case 9:
			return "GSMP_SHOW_CLIENT_STATE_PRE_PLAYING";
		case 10:
			return "GSMP_SHOW_CLIENT_STATE_PLAYING";
		case 11:
			return "GSMP_SHOW_CLIENT_STATE_CLEANUP";
		case 12:
			return "GSMP_SHOW_CLIENT_STATE_TERMINATE";
		case 13:
			return "GSMP_SHOW_CLIENT_STATE_FINISHED";
		default:
			break;
	}
	if (iParam1 >= 1)
...
void func_53(var uParam0, var uParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(8, 201, "[SHOW_INIT_ALL_LIGHT_DATA] light init complete");
	func_18(uParam1, -2147483648);
}

void func_54(var uParam0, int iParam1)
{
	DEBUG::_0xA308F935BDECCEC0(40, 201, "[GSMP_CLIENT_SET_FLAG] Setting Client Flag: ", func_80(iParam1, 0));
	func_83(&(uParam0->f_13), iParam1);
}
...
void func_58(var uParam0, var uParam1, int iParam2)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 201, "[GSMP_SHOW_CLIENT_PROJECTIONIST_UPDATE] -- STATE: ", func_143(*uParam1, 0));
	DEBUG::_0x1B08D1EB9D8C4931(40, 201, "[GSMP_SHOW_CLIENT_PROJECTIONIST_UPDATE] -- ANIM SCENE EXISTS: ", MISC::_0xF216F74101968DB0(ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_9)));
	switch (*uParam1)
	{
		case 0:
			STREAMING::REQUEST_MODEL(func_111(), false);
			STREAMING::REQUEST_MODEL(func_112(0), false);
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_CLIENT_PROJECTIONIST_UPDATE][STATE_REQUEST] Requesting models");
			func_144(uParam1, 1);
			break;
		case 1:
			DEBUG::_0x4DC69742196F818A(8, 201, "[GSMP_SHOW_CLIENT_PROJECTIONIST_UPDATE][STATE_CREATE] waiting for host");
			if (*uParam0 > 1)
			{
				func_144(uParam1, 3);
			}
		...
		case 3:
			...
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_CLIENT_PROJECTIONIST_UPDATE][STATE_INIT] Setting up anim scene");
				ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_9, func_145(iParam2), uParam0->f_2, 0);
				iVar0 = 0;
				while (iVar0 <= (5 - 1))
				{
					ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_9, func_146(iParam2, iVar0), uParam0->f_3[iVar0], 0);
					iVar0++;
				}
			...
			if (!ANIMSCENE::_IS_ANIM_SCENE_STARTED(uParam0->f_9, false))
			{
				DEBUG::_0x4DC69742196F818A(8, 201, "[GSMP_SHOW_CLIENT_PROJECTIONIST_UPDATE][STATE_INIT] Anim scene not running");
				return;
			}
			func_144(uParam1, 4);
			break;
		case 4:
			...
			{
				if (!ANIMSCENE::_0x1F0E401031E20146(uParam0->f_9, func_118(iParam2, 1)))
				{
					DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_CLIENT_PROJECTIONIST_UPDATE][STATE_UPDATE][OWNER] Anim scene play list not active");
					if (!ANIMSCENE::_0x23E33CB9F4A3F547(uParam0->f_9, func_118(iParam2, 1)))
					{
						DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_CLIENT_PROJECTIONIST_UPDATE][STATE_UPDATE][OWNER] Not Loaded - REQUEST_ANIM_SCENE_PLAY_LIST");
						ANIMSCENE::_0xDF7B5144E25CD3FE(uParam0->f_9, func_118(iParam2, 1));
					}
					else
					{
						DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_CLIENT_PROJECTIONIST_UPDATE][STATE_UPDATE][OWNER] LOADED - SET_ANIM_SCENE_PLAY_LIST");
						ANIMSCENE::_SET_ANIM_SCENE_PLAYBACK_LIST_BOOL(uParam0->f_9, func_118(iParam2, 1), true);
					}
				}
			}
			if (!ANIMSCENE::_0x1F0E401031E20146(uParam0->f_9, func_118(iParam2, 1)) || !ANIMSCENE::_0x23E33CB9F4A3F547(uParam0->f_9, func_118(iParam2, 1)))
			{
				DEBUG::_0x4DC69742196F818A(8, 201, "[GSMP_SHOW_CLIENT_PROJECTIONIST_UPDATE][STATE_UPDATE] Scene not yet loaded");
				return;
			}
			func_144(uParam1, 5);
			break;
		case 5:
			...
			break;
		case 6:
			DEBUG::_0x1B08D1EB9D8C4931(8, 201, "[GSMP_SHOW_CLIENT_PROJECTIONIST_UPDATE] GSMP_SHOW_CLIENT_PROJECTIONIST_STATE_COMPLETE");
			break;
	}
}
...
void func_59(var uParam0)
{
	...
	if (uParam0->f_1561)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1577))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[SHOW_START_MOVIE_PLAYBACK] PROJECTOR LIGHT INITIALISED");
	...
	DEBUG::_0xA308F935BDECCEC0(8, 201, "[SHOW_START_MOVIE_PLAYBACK] MOVIE PLAYBACK STARTED");
}
...
bool func_61(int iParam0, bool bParam1)
{
	...
	{
		DEBUG::_0x4DC69742196F818A(136, 201, "[CAN_START_ANIM_SCENE] ANIM SCENE ", iParam0, " DOES NOT EXIST!");
		return false;
	}
	if (!ANIMSCENE::_IS_ANIM_SCENE_LOADED(iParam0, true, false))
	{
		DEBUG::_0x4DC69742196F818A(136, 201, "[CAN_START_ANIM_SCENE] ANIM SCENE ", iParam0, " IS NOT YET LOADED!");
		return false;
	}
	if (bParam1 && !NETWORK::_NETWORK_HAS_CONTROL_OF_ANIM_SCENE(iParam0))
	{
		DEBUG::_0x4DC69742196F818A(8, 201, "[CAN_START_ANIM_SCENE] NO NETWORK CONTROL OF ANIM SCENE ", iParam0);
		return false;
	}
	DEBUG::_0xA308F935BDECCEC0(8, 201, "[CAN_START_ANIM_SCENE] CAN START ANIM SCENE ", iParam0);
	return true;
}
...
void func_68(var uParam0)
{
	if (GRAPHICS::GET_TV_CHANNEL() == -1)
	{
		DEBUG::_0xA308F935BDECCEC0(8, 201, "UPDATE_GSMP_SHOW_MOVIE_PLAYBACK: NO TV CHANNEL ACTIVE");
		return;
	}
	if (uParam0->f_1560)
	{
...
{
	DEBUG::_0x4DC69742196F818A(680, 201, "[GSMP_CLIENT_IS_FLAG_SET] Client Flag ", func_80(iParam1, 0), " Set: ", MISC::_0xF216F74101968DB0(func_108(uParam0->f_13, iParam1)));
	return func_108(uParam0->f_13, iParam1);
}
...
void func_72(var uParam0, var uParam1)
{
	...
	while (iVar0 < uParam0->f_1393)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar1) && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iVar1))
		{
			...
			DEBUG::_0xF0783374333FD8CE(8, 201, "CLEANUP_SHOW: deleting object: ", iVar0);
		}
		iVar0++;
	}
	iVar0 = 0;
	...
	while (iVar0 < uParam0->f_1408)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar2) && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iVar2))
		{
			...
			DEBUG::_0xF0783374333FD8CE(8, 201, "CLEANUP_SHOW: deleting actor: ", iVar0);
		}
		iVar0++;
	}
	iVar0 = 0;
	...
	while (iVar0 < uParam0->f_1423)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar3) && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iVar3))
		{
			...
			DEBUG::_0xF0783374333FD8CE(8, 201, "CLEANUP_SHOW: deleting weapon: ", iVar0);
		}
		iVar0++;
	}
	if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)) && NETWORK::_NETWORK_HAS_CONTROL_OF_ANIM_SCENE(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)))
	{
		...
		DEBUG::_0xF0783374333FD8CE(8, 201, "CLEANUP_SHOW: clearing anim scene ID: ", NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374));
	}
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1384) && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(uParam0->f_1384))
	{
		...
		DEBUG::_0xF0783374333FD8CE(8, 201, "CLEANUP_SHOW: deleting curtain");
	}
	func_153(uParam0);
	if (!uParam0->f_1357)
	{
		func_154(&(uParam1->f_2), &(uParam1->f_247));
	}
	if (!uParam0->f_4)
	{
		func_47(uParam0->f_1350);
...
void func_74(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 201, "GSMP_HOST_END_SHOW -- Theater: ", func_155(iParam0, 0));
	Var0.f_6 = -1;
	Var0.f_4 = 1;
	Var0.f_6 = iParam0;
	Var0 = 31;
...
char* func_80(int iParam0, int iParam1)
{
	...
	{
		case 1:
			return "GSMP_CLIENT_FLAG_IN_THEATER_VOLUME";
		case 2:
			return "GSMP_CLIENT_FLAG_IN_SHUTDOWN_VOLUME";
		case 4:
			return "GSMP_CLIENT_FLAG_OWNS_SHOW_ANIM";
		case 8:
			return "GSMP_CLIENT_FLAG_OWNS_CURTAIN_ANIM";
		case 16:
			return "GSMP_CLIENT_FLAG_PREPARED_SHOW_ANIM_SCENE";
		case 32:
			return "GSMP_CLIENT_FLAG_REQUESTED_ASSETS";
		default:
			break;
	}
	if (iParam1 >= 1)
...
char* func_82(int iParam0, int iParam1)
{
	...
	{
		case 1:
			return "GSMP_SHOW_HOST_FLAG_RUNNING";
		case 2:
			return "GSMP_SHOW_HOST_FLAG_TERMINATE";
		case 4:
			return "GSMP_SHOW_HOST_FLAG_REQUESTED_PROJETIONIST";
		default:
			break;
	}
	if (iParam1 >= 1)
...
bool func_85(int iParam0, char* sParam1, char* sParam2)
{
	if (!ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iParam0))
	{
		return false;
	...
	if (!ANIMSCENE::_0x23E33CB9F4A3F547(iParam0, sParam1))
	{
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 201, "SHOW_REQUEST_PLAYBACK_LIST: Requesting Anim Scene play list- ", sParam1);
			ANIMSCENE::_0xDF7B5144E25CD3FE(iParam0, sParam1);
		}
		else
		{
			DEBUG::_0xA308F935BDECCEC0(40, 201, "SHOW_REQUEST_PLAYBACK_LIST: Anim Scene play list Loading - ", sParam1);
		}
	}
	if (!ANIMSCENE::_0x23E33CB9F4A3F547(iParam0, sParam1))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 201, "SHOW_REQUEST_PLAYBACK_LIST: PLAY LIST IS NOT LOADED - ", sParam1);
		return false;
	}
	DEBUG::_0xA308F935BDECCEC0(40, 201, "[SHOW_REQUEST_PLAYBACK_LIST]: PLAY LIST LOADED - ", sParam1);
	return true;
}

void func_86(var uParam0, int iParam1)
{
	DEBUG::_0xA308F935BDECCEC0(680, 201, "[SHOW_CHANGE_CURTAIN_STATE] old state: ", func_158(*uParam0, 0), " new state: ", func_158(iParam1, 0));
	*uParam0 = iParam1;
}
...
void func_89(int iParam0, char* sParam1, char* sParam2)
{
	if (!ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 201, "SHOW_SET_ANIM_SCENE_PLAYBACK_LIST: The anim scene ", sParam2, " does not exist. Exiting.");
		return;
	}
	DEBUG::_0xA308F935BDECCEC0(680, 201, "SHOW_SET_ANIM_SCENE_PLAYBACK_LIST: Setting anim scene ", sParam2, " playback to ", sParam1);
	ANIMSCENE::_SET_ANIM_SCENE_PLAYBACK_LIST_BOOL(iParam0, sParam1, true);
}

void func_90(int iParam0, char* sParam1, char* sParam2)
{
	if (ANIMSCENE::_0x23E33CB9F4A3F547(iParam0, sParam1))
	{
		DEBUG::_0xA308F935BDECCEC0(2728, 201, "SHOW_RELEASE_PLAYBACK_LIST: Playlist: ", sParam1, " for ", sParam2, " was released.");
...
bool func_97(var uParam0)
{
	...
	bVar0 = false;
	if (!func_35(&(uParam0->f_1363)))
	{
		func_28(&(uParam0->f_1363));
	}
	else if (func_159(&(uParam0->f_1363)) > 10f)
	{
		DEBUG::_0xA308F935BDECCEC0(8, 201, "[SHOW_LOAD_CURTAIN_MUSIC] Audio Load Timed out... Returning TRUE");
		bVar0 = true;
	}
	if (func_13(uParam0->f_1359, 1))
	{
		sVar1 = func_66(uParam0->f_1350);
		sVar2 = func_67(uParam0->f_1350);
		if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1) || MISC::IS_STRING_NULL_OR_EMPTY(sVar2))
		{
			DEBUG::_0x1B08D1EB9D8C4931(8, 201, "[SHOW_LOAD_CURTAIN_MUSIC] did not load music, string was null or empty");
			bVar0 = true;
		}
	...
	if (bVar0)
	{
		func_160(&(uParam0->f_1363));
		return true;
	}
	DEBUG::_0x1B08D1EB9D8C4931(8, 201, "[SHOW_LOAD_CURTAIN_MUSIC] did not load music -- returning FALSE");
	return false;
}

bool func_98(var uParam0, bool bParam1, vector3 vParam2)
{
	if (!STREAMING::HAS_MODEL_LOADED(bParam1))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 201, "[CREATE_SHOW_OBJECT] OBJECT MODEL WAS NOT LOADED - ", UNK_0x1B7C373FB4E76B85(bParam1));
		return false;
	}
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0) && NETWORK::CAN_REGISTER_MISSION_OBJECTS(1))
	{
		*uParam0 = OBJECT::CREATE_OBJECT(bParam1, vParam2, true, true, false, false, true);
		DEBUG::_0xA308F935BDECCEC0(40, 201, "[CREATE_SHOW_OBJECT] CREATE_OBJECT called THIS FRAME for ", UNK_0x1B7C373FB4E76B85(bParam1));
	}
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 201, "[CREATE_SHOW_OBJECT] OBJECT HAS NOT YET BEEN CREATED - ", UNK_0x1B7C373FB4E76B85(bParam1));
		return false;
	}
	return true;
}
...
bool func_100(var uParam0, var uParam1, var uParam2, char* sParam3, char* sParam4, bool bParam5)
{
	if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(*uParam0) && ANIMSCENE::_IS_ANIM_SCENE_LOADED(*uParam0, true, false))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 201, "SHOW_LOAD_ANIM_SCENE: Anim scene ", sParam3, " already loaded. Exiting.");
		func_14(uParam2, 1);
		return true;
	}
	if (!func_13(*uParam2, 1) && !ANIMSCENE::_DOES_ANIM_SCENE_EXIST(*uParam0))
	{
		...
		*uParam1 = NETWORK::_ANIM_SCENE_TO_NET(*uParam0);
		DEBUG::_0xA308F935BDECCEC0(40, 201, "SHOW_LOAD_ANIM_SCENE: Requesting anim scene ", sParam3);
...
bool func_101(var uParam0, bool bParam1, vector3 vParam2, float fParam5)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (!STREAMING::HAS_MODEL_LOADED(bParam1))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 201, "MODEL HAS NOT LOADED: ", UNK_0x1B7C373FB4E76B85(bParam1));
		return false;
	}
	bVar0 = true;
	bVar1 = false;
	bVar2 = func_161(bParam1);
	if (bVar2 != joaat("META_OUTFIT_DEFAULT"))
	{
		bVar0 = false;
		bVar1 = true;
	}
	...
	{
		*uParam0 = func_115(bParam1, vParam2, fParam5, 1, 1, 0, 1, 1, bVar0, 0, bVar1);
		return false;
	}
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0) && PED::_0xA0BC8FAED8CFEB3C(*uParam0))
	{
		if (!bVar0)
		{
			func_162(*uParam0, bVar2);
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CREATE_SHOW_PED] yes we are setting the outfit");
		}
		DEBUG::_0xA308F935BDECCEC0(40, 201, "[CREATE_SHOW_PED] ped is being created with a custom outfit: ", func_163(bVar2, 0));
		return true;
	}
	return false;
}
...
bool func_102(var uParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(8, 201, "[CUSTOM_CREATE_SHOW_ASSETS]: creating crafting objects for scene ID = ", uParam0->f_1373);
	...
	{
		if (func_165(&(uParam0->f_1393[0]), uParam0->f_1385[0], func_164(0)))
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "p_benchpiano02x", uParam0->f_1393[0], 0);
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] benchpiano INDEX: ", uParam0->f_1393[0]);
		}
		else
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "p_benchpiano02x was not created");
			return false;
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1393[1]))
	{
		if (func_165(&(uParam0->f_1393[1]), uParam0->f_1385[0], func_164(1)))
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "p_benchPiano02x^1", uParam0->f_1393[1], 0);
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] benchpiano2 INDEX: ", uParam0->f_1393[1]);
		}
		else
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "p_benchPiano02x^1 was not created");
			return false;
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1393[2]))
	{
		if (func_165(&(uParam0->f_1393[2]), uParam0->f_1385[1], func_164(2)))
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "p_cs_contrabass01x", uParam0->f_1393[2], 0);
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] contrabass INDEX: ", uParam0->f_1393[2]);
		}
		else
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "p_cs_contrabass01x was not created");
			return false;
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1393[3]))
	{
		if (func_165(&(uParam0->f_1393[3]), uParam0->f_1385[2], func_164(3)))
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "p_cs_drumkit01x", uParam0->f_1393[3], 0);
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] drumkit INDEX: ", uParam0->f_1393[3]);
		}
		else
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "p_cs_drumkit01x was not created");
			return false;
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1393[4]))
	{
		if (func_165(&(uParam0->f_1393[4]), uParam0->f_1385[3], func_164(4)))
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "p_drumstick01x", uParam0->f_1393[4], 0);
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] drumkit INDEX: ", uParam0->f_1393[4]);
		}
		else
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "p_drumstick01x was not created");
			return false;
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1393[5]))
	{
		if (func_165(&(uParam0->f_1393[5]), uParam0->f_1385[3], func_164(5)))
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "p_drumstick01x^1", uParam0->f_1393[5], 0);
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] drumkit INDEX: ", uParam0->f_1393[5]);
		}
		else
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "p_drumstick01x^1 was not created");
			return false;
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1393[6]))
	{
		if (func_165(&(uParam0->f_1393[6]), uParam0->f_1385[4], func_164(6)))
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "p_piano01x", uParam0->f_1393[6], 0);
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] drumkit INDEX: ", uParam0->f_1393[6]);
		}
		else
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "p_piano01x was not created");
			return false;
		}
	}
	if (!func_166(uParam0, iVar0, 3, "CS_BANDSINGER"))
	{
		return false;
	}
	if (!func_166(uParam0, iVar0, 0, "CS_BANDBASSIST"))
	{
		return false;
	}
	if (!func_166(uParam0, iVar0, 2, "CS_BANDPIANIST"))
	{
		return false;
	}
	if (!func_166(uParam0, iVar0, 1, "CS_BANDDRUMMER"))
	{
		return false;
	}
...
void func_107(bool bParam0, int iParam1, bool bParam2)
{
	func_169(bParam0, 0, 0);
	if (func_170(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != iParam1 || bParam2)
		{
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(bParam0, iParam1);
			DEBUG::_0x1B08D1EB9D8C4931(680, 183, "SET_DOORSTATE_OF_DOOR_ID - Setting Door ID ", func_171(bParam0, 0), " to ", func_172(iParam1, 0));
			UNK_0x355E72323AEE83CC(183, 9);
		}
	}
	else
	{
		DEBUG::_0x83407B92D46F25C3(8, 183, "SET_DOORSTATE_OF_DOOR_ID - Invalid Door ID");
	}
}
...
char* func_109(int iParam0, int iParam1)
{
	...
	{
		case 0:
			return "GSMP_SHOW_HOST_PROJECTIONIST_STATE_REQUEST";
		case 1:
			return "GSMP_SHOW_HOST_PROJECTIONIST_STATE_CREATE";
		case 2:
			return "GSMP_SHOW_HOST_PROJECTIONIST_STATE_LOAD_ANIM_SCENE";
		case 3:
			return "GSMP_SHOW_HOST_PROJECTIONIST_STATE_INIT";
		case 4:
			return "GSMP_SHOW_HOST_PROJECTIONIST_STATE_UPDATE";
		case 5:
			return "GSMP_SHOW_HOST_PROJECTIONIST_STATE_COMPLETE";
		default:
			break;
	}
	if (iParam1 >= 1)
...
{
	DEBUG::_0xA308F935BDECCEC0(680, 201, "[GSMP_SHOW_PROJECTIONIST_CHANGE_STATE] current state: ", func_109(*uParam0, 0), " new state: ", func_109(iParam1, 0));
	*uParam0 = iParam1;
}
...
int func_115(bool bParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12)
{
	int iVar0;
	...
	func_173(iVar0, bParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
char* func_118(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 201, "Projectionist playlist: ", func_174(iParam1, 0), " show: ", func_175(iParam0, 0));
...
void func_126(var uParam0, var uParam1, var uParam2, float fParam3)
{
	DEBUG::_0x1B08D1EB9D8C4931(40, 201, "[fireDance_02][CUSTOM_UPDATE_HOST] -- STATE: ", func_176(uParam0->f_1, 0));
	switch (uParam0->f_1)
	{
		case 0:
			func_177(&(uParam0->f_1), 32);
			break;
		case 32:
			if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false))
			{
				uParam0->f_3 = 1;
				func_91(uParam0, 1);
				func_177(&(uParam0->f_1), 33);
			}
			break;
		case 33:
			func_177(&(uParam0->f_1), 34);
			break;
		case 34:
		...
		case 37:
			...
			func_91(uParam0, 2);
			func_178(&(uParam0->f_27), 0);
			func_177(&(uParam0->f_1), 40);
			break;
		case 40:
			break;
	}
...
void func_127(var uParam0, var uParam1, var uParam2, float fParam3)
{
	DEBUG::_0x1B08D1EB9D8C4931(40, 201, "[fireDance_02][CUSTOM_UPDATE_CLIENT] -- STATE: ", func_176((uParam1[uParam2->f_1 /*18*/])->f_17, 0));
	switch ((uParam1[uParam2->f_1 /*18*/])->f_17)
	{
		case 0:
			func_179(&((uParam1[uParam2->f_1 /*18*/])->f_17), 32);
			break;
		case 32:
			if (uParam0->f_1 > 32)
			{
				func_179(&((uParam1[uParam2->f_1 /*18*/])->f_17), 33);
			}
			break;
		case 33:
			if (uParam0->f_1 > 33)
			{
				func_179(&((uParam1[uParam2->f_1 /*18*/])->f_17), 34);
			}
			break;
		case 34:
			if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)) > 0.978f)
			{
				func_179(&((uParam1[uParam2->f_1 /*18*/])->f_17), 37);
			}
			break;
		case 37:
			if (!func_13(uParam0->f_1358, 8388608))
			...
			func_18(&(uParam2->f_247), 32);
			func_179(&((uParam1[uParam2->f_1 /*18*/])->f_17), 40);
			break;
		case 40:
			break;
	}
...
void func_131(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 218, "CLEAR_WORLD_STATE_FLAG: clearing world state - ", func_181(iParam0, 0));
	Global_1939807 = 0;
}
...
bool func_132(bool bParam0)
{
	...
	if (func_170(bParam0))
	{
		return (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) == 2 || OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) == 1);
	}
	else
	{
		DEBUG::_0x83407B92D46F25C3(8, 183, "IS_DOOR_ID_LOCKED - Invalid Door ID");
	}
	return false;
}
...
{
	return func_182(bParam0, 23);
}

void func_134(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	func_169(bParam0, 0, 0);
	if (func_170(bParam0))
	{
		...
		if (bParam3)
		{
			func_183(bParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
			{
				func_184(bParam0, 1);
				UNK_0x355E72323AEE83CC(183, 9);
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking Door ID ", func_171(bParam0, 0));
			}
			else
			{
				func_185(bParam0, 1);
				UNK_0x355E72323AEE83CC(183, 9);
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking and making unbreakable Door ID ", func_171(bParam0, 0));
			}
		}
		else
		{
			func_186(bParam0, 1);
			UNK_0x355E72323AEE83CC(183, 9);
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Unlocking Door ID ", func_171(bParam0, 0));
		}
		if (bParam7)
		{
			DEBUG::_0x1B08D1EB9D8C4931(168, 183, "SET_STATE_OF_DOOR_ID - Treating Door ID ", func_171(bParam0, 0), " as shut.");
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 183, "SET_STATE_OF_DOOR_ID: Door with ID not registered by host yet ", func_171(bParam0, 0));
	}
}
...
bool func_135(bool bParam0)
{
	...
	if (func_170(bParam0))
	{
		return !OBJECT::IS_DOOR_CLOSED(bParam0);
	}
	DEBUG::_0x83407B92D46F25C3(8, 183, "IS_DOOR_OPEN - Invalid Door ID");
	return false;
}

bool func_136(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 201, "[GSMP_CLIENT_CLEAR_FLAG] Clearing Client Flag: ", func_80(iParam1, 0));
	func_188(&(uParam0->f_13), iParam1);
}
...
bool func_138(var uParam0, var uParam1)
{
	...
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 201, "GSMP_SHOW_DO_PLAYLISTS_MATCH Playlist one string is null or empty!");
		return false;
	}
	if (*uParam0 != *uParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(680, 201, "[1] host: ", uParam0->f_1, " client: ", uParam1->f_1);
		DEBUG::_0x1B08D1EB9D8C4931(8, 201, "GSMP_SHOW_DO_PLAYLISTS_MATCH Playlist Does Not Match! [1]");
		return false;
	}
	if (!MISC::ARE_STRINGS_EQUAL(uParam0->f_1, uParam1->f_1))
	{
		DEBUG::_0xA308F935BDECCEC0(680, 201, "[2] host: ", uParam0->f_1, " client: ", uParam1->f_1);
		DEBUG::_0x1B08D1EB9D8C4931(8, 201, "GSMP_SHOW_DO_PLAYLISTS_MATCH Playlist Does Not Match! [2]");
		return false;
	}
	return true;
}
...
{
	DEBUG::_0x1B08D1EB9D8C4931(40, 201, "GSMP_SHOW_SYNC_PLAYLIST_CLIENT syncing to ", uParam0->f_1);
	*uParam1 = *uParam0;
	uParam1->f_1 = uParam0->f_1;
	DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_SYNC_PLAYLIST_CLIENT] we are complete");
}
...
int func_140(var uParam0, var uParam1, int iParam2)
{
	...
	if (!func_13(*uParam1, 1))
	{
		...
		{
			iVar3 = iVar0;
			if (func_192(uParam0[iVar0 /*5*/], func_190(iParam2), func_191(iParam2, iVar3), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
		...
		if (iVar2 >= iVar1)
		{
			DEBUG::_0x1B08D1EB9D8C4931(136, 201, "[SHOW_FIND_ALL_LIGHTS] Wall lights ready. ", iVar2, " lights found.");
			func_18(uParam1, 1);
		}
	}
	iVar2 = 0;
	if (!func_13(*uParam1, 8))
	{
		...
		{
			iVar4 = iVar0;
			if (func_192(&(uParam0->f_31[iVar0 /*5*/]), func_194(iParam2), func_195(iParam2, iVar4), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
		...
		if (iVar2 >= iVar1)
		{
			DEBUG::_0x1B08D1EB9D8C4931(136, 201, "[SHOW_FIND_ALL_LIGHTS] Stage lights ready. ", iVar2, " lights found.");
			func_18(uParam1, 8);
		}
	}
	iVar2 = 0;
	if (!func_13(*uParam1, 2048))
	{
		...
		{
			iVar5 = iVar0;
			if (func_192(&(uParam0->f_107[iVar0 /*5*/]), func_197(iParam2), func_198(iParam2, iVar5), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
		...
		if (iVar2 >= iVar1)
		{
			DEBUG::_0x1B08D1EB9D8C4931(136, 201, "[SHOW_FIND_ALL_LIGHTS] Balcony lights ready. ", iVar2, " lights found.");
	...
	{
		case 0:
			if (!func_13(*uParam1, 64) && func_192(&(uParam0->f_118[0 /*5*/]), func_199(iParam2, 0), func_200(iParam2, 0), 1065353216 /* Float: 1f */))
			{
				func_18(uParam1, 64);
			}
			if ((!func_13(*uParam1, 16384) && func_192(&(uParam0->f_118[1 /*5*/]), func_199(iParam2, 1), func_200(iParam2, 1), 1065353216 /* Float: 1f */)) && func_192(&(uParam0->f_118[2 /*5*/]), func_199(iParam2, 2), func_200(iParam2, 2), 1065353216 /* Float: 1f */))
			{
		...
		case 1:
			...
			if (!func_13(*uParam1, 2097152))
			{
				...
				{
					iVar6 = iVar0;
					if (func_192(&(uParam0->f_118[iVar0 /*5*/]), func_199(iParam2, 0), func_200(iParam2, iVar6), 1065353216 /* Float: 1f */))
					{
						iVar2++;
					}
					iVar0++;
				...
				if (iVar2 >= iVar1)
				{
					DEBUG::_0x1B08D1EB9D8C4931(136, 201, "[SHOW_FIND_ALL_LIGHTS] Arch lights ready. ", iVar2, " lights found.");
...
void func_141(var uParam0, var uParam1, int iParam2)
{
	...
	{
		if (func_13(*uParam0, 2) && func_205(uParam1, func_202(uParam1), &(uParam1->f_229), func_203(uParam1), func_204(uParam1)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "WALL LIGHTS should be faded out");
			func_14(uParam0, 2);
		}
		if (func_13(*uParam0, 4) && func_207(uParam1, func_206(uParam1), &(uParam1->f_229), func_203(uParam1), func_204(uParam1)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "WALL LIGHTS should be faded in");
			func_14(uParam0, 4);
		}
	}
	if (func_13(*uParam0, 8))
	{
		if (func_13(*uParam0, 16) && func_205(&(uParam1->f_31), func_208(uParam1), &(uParam1->f_232), func_209(uParam1), func_204(uParam1)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "STAGE LIGHTS should be faded out");
			func_14(uParam0, 16);
		}
		if (func_13(*uParam0, 32) && func_207(&(uParam1->f_31), func_210(uParam1), &(uParam1->f_232), func_209(uParam1), func_204(uParam1)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "STAGE LIGHTS should be faded in");
			func_14(uParam0, 32);
		}
	}
	if (func_13(*uParam0, 2048))
	{
		if (func_13(*uParam0, 4096) && func_205(&(uParam1->f_107), func_211(uParam1), &(uParam1->f_235), func_212(uParam1), func_204(uParam1)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "BALCONY LIGHTS should be faded out");
			func_14(uParam0, 4096);
		}
		if (func_13(*uParam0, 8192) && func_207(&(uParam1->f_107), func_213(uParam1), &(uParam1->f_235), func_212(uParam1), func_204(uParam1)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "BALCONY LIGHTS should be faded in");
	...
	if (iParam2 == 0)
	{
		...
		{
			if (func_13(*uParam0, 128) && func_216(&(uParam1->f_118[0 /*5*/]), func_214(uParam1), &(uParam1->f_238), func_215(uParam1), func_204(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE CENTER STAGE LIGHT should be faded out");
				func_14(uParam0, 128);
			}
			if (func_13(*uParam0, 256) && func_218(&(uParam1->f_118[0 /*5*/]), func_217(uParam1), &(uParam1->f_238), func_215(uParam1), func_204(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE CENTER STAGE LIGHT s should be faded in");
				func_14(uParam0, 256);
			}
			if (func_13(*uParam0, 512) && func_216(&(uParam1->f_118[0 /*5*/]), func_214(uParam1), &(uParam1->f_238), 0.5f, func_204(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE CENTER STAGE LIGHT s should be off");
				func_14(uParam0, 512);
			}
			if (func_13(*uParam0, 1024) && func_218(&(uParam1->f_118[0 /*5*/]), func_217(uParam1), &(uParam1->f_238), 0.5f, func_204(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE CENTER STAGE LIGHT s should be on");
				func_14(uParam0, 1024);
			}
		}
		if (func_13(*uParam0, 16384))
		{
			if (func_13(*uParam0, 32768) && func_221(1, 2, &(uParam1->f_118), func_219(uParam1), &(uParam1->f_241), func_220(uParam1), func_204(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE RED LIGHTS should be faded out");
				func_14(uParam0, 32768);
			}
			if (func_13(*uParam0, 65536) && func_223(1, 2, &(uParam1->f_118), func_222(uParam1), &(uParam1->f_241), func_220(uParam1), func_204(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE RED LIGHTS should be faded in");
				func_14(uParam0, 65536);
			}
			if (func_13(*uParam0, 131072) && func_221(1, 2, &(uParam1->f_118), func_219(uParam1), &(uParam1->f_241), 0.5f, func_204(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE RED LIGHTS should be off");
				func_14(uParam0, 131072);
			}
			if (func_13(*uParam0, 262144) && func_223(1, 2, &(uParam1->f_118), func_222(uParam1), &(uParam1->f_241), 0.5f, func_204(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE RED LIGHTS should be on");
		...
		{
			bVar0 = true;
			if (!func_205(&(uParam1->f_31), func_208(uParam1), &(uParam1->f_232), 0.1f, func_204(uParam1)))
			{
				bVar0 = false;
			}
			if (bVar0)
		...
		{
			bVar1 = true;
			if (!func_207(&(uParam1->f_31), func_210(uParam1), &(uParam1->f_232), 0.1f, func_204(uParam1)))
			{
				bVar1 = false;
			}
			if (bVar1)
	...
	if (iParam2 == 1)
	{
		...
		{
			if (func_13(*uParam0, 4194304) && func_205(&(uParam1->f_118), func_224(uParam1), &(uParam1->f_238), func_225(uParam1), func_204(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "SD MAGIC LANTERN / MOVIE Arch lights should be faded out");
				func_14(uParam0, 4194304);
			}
			if (func_13(*uParam0, 8388608) && func_207(&(uParam1->f_118), func_226(uParam1), &(uParam1->f_238), func_225(uParam1), func_204(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "SD MAGIC LANTERN / MOVIE Arch lights should be faded in");
...
{
	DEBUG::_0xF0783374333FD8CE(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] : preparing show scene = ", uParam0->f_1373);
}
...
char* func_143(int iParam0, int iParam1)
{
	...
	{
		case 0:
			return "GSMP_SHOW_CLIENT_PROJECTIONIST_STATE_REQUEST";
		case 1:
			return "GSMP_SHOW_CLIENT_PROJECTIONIST_STATE_CREATE";
		case 2:
			return "GSMP_SHOW_CLIENT_PROJECTIONIST_STATE_LOAD_ANIM_SCENE";
		case 3:
			return "GSMP_SHOW_CLIENT_PROJECTIONIST_STATE_INIT";
		case 4:
			return "GSMP_SHOW_CLIENT_PROJECTIONIST_STATE_UPDATE";
		case 5:
			return "GSMP_SHOW_CLIENT_PROJECTIONIST_STATE_WAIT";
		case 6:
			return "GSMP_SHOW_CLIENT_PROJECTIONIST_STATE_COMPLETE";
		default:
			break;
	}
	if (iParam1 >= 1)
...
{
	DEBUG::_0xA308F935BDECCEC0(680, 201, "[GSMP_SHOW_HOST_PROJECTIONIST_CHANGE_STATE] current state: ", func_143(*uParam0, 0), " new state: ", func_143(iParam1, 0));
	*uParam0 = iParam1;
}
...
void func_147()
{
	DEBUG::_0xA308F935BDECCEC0(136, 201, "[SHOW_ADD_MC_SHOW_VIEW] total Magic Lantern views is now: ", Global_38.f_4652.f_15, " total all show views is now: ", Global_38.f_4652.f_13);
}

void func_148()
{
	DEBUG::_0xA308F935BDECCEC0(136, 201, "[SHOW_ADD_MC_SHOW_VIEW] total Movie views is now: ", Global_38.f_4652.f_16, " total all show views is now: ", Global_38.f_4652.f_13);
}
...
void func_152(var uParam0)
{
	...
	if (uParam0->f_1560)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1577))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(8, 201, "SHOW_CLEANUP_SCREEN: PROJECTOR OBJECT CLEANED UP.");
		}
		if (HUD::IS_NAMED_RENDERTARGET_REGISTERED(uParam0->f_1563))
		{
			HUD::RELEASE_NAMED_RENDERTARGET(uParam0->f_1563);
			DEBUG::_0xA308F935BDECCEC0(8, 201, "SHOW_CLEANUP_SCREEN: RENDER TARGET RELEASED.");
		}
		uParam0->f_1560 = 0;
	}
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1576) && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(uParam0->f_1576))
	{
		...
		DEBUG::_0xA308F935BDECCEC0(8, 201, "SHOW_CLEANUP_SCREEN: SCREEN OBJECT DELETED");
	}
	DEBUG::_0xA308F935BDECCEC0(8, 201, "SHOW_CLEANUP_SCREEN: MOVIE SCREEN CLEANED UP.");
}
...
{
	func_228(uParam0);
	func_228(&(uParam0->f_31));
	func_228(&(uParam0->f_107));
	func_228(&(uParam0->f_118));
	*uParam1 = 0;
}
...
char* func_155(int iParam0, int iParam1)
{
	...
	{
		case -1:
			return "GSMAN_THEATERS_INVALID";
		case 0:
			return "GSMAN_THEATERS_SAINT_DENIS";
		case 1:
			return "GSMAN_THEATERS_SAINT_DENIS_MAGIC";
		case 2:
			return "GSMAN_THEATERS_VALENTINE_MAGIC";
		case 3:
			return "GSMAN_THEATERS_COUNT";
		default:
			break;
	}
	if (iParam1 >= 1)
...
{
	return func_229(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("VOLCYLINDER"), iParam0, iParam1);
}
...
char* func_158(int iParam0, int iParam1)
{
	...
	{
		case 0:
			return "GSMP_SHOW_CURTAIN_STATE_REQUEST_OPEN";
		case 1:
			return "GSMP_SHOW_CURTAIN_STATE_OPEN_CURTAIN";
		case 2:
			return "GSMP_SHOW_CURTAIN_STATE_WAIT_ON_OPEN";
		case 3:
			return "GSMP_SHOW_CURTAIN_STATE_REQUEST_CLOSE";
		case 4:
			return "GSMP_SHOW_CURTAIN_STATE_CLOSE_CURTAIN";
		case 5:
			return "GSMP_SHOW_CURTAIN_STATE_WAIT_ON_CLOSE";
		default:
			break;
	}
	if (iParam1 >= 1)
...
void func_162(int iParam0, bool bParam1)
{
	...
	{
		DEBUG::_0x4DC69742196F818A(680, 131, "SWITCH_PED_TO_OUTFIT: Swapping to metaped outfit ", func_163(bParam1, 0), " for ped: ", UNK_0x1B7C373FB4E76B85(ENTITY::GET_ENTITY_MODEL(iParam0)));
		if (func_230(iParam0, bParam1))
		{
			if (func_231(iParam0, bParam1))
			{
				if (func_232(iParam0, bParam1))
				{
					DEBUG::_0xF0783374333FD8CE(648, 131, "SWITCH_PED_TO_OUTFIT: Applying and releasing outfit for request:  ", DECORATOR::DECOR_GET_INT(iParam0, "metaped_outfit_request"), " For model: ", UNK_0x1B7C373FB4E76B85(ENTITY::GET_ENTITY_MODEL(iParam0)));
					PED::_APPLY_PED_METAPED_OUTFIT(DECORATOR::DECOR_GET_INT(iParam0, "metaped_outfit_request"), iParam0, true, false);
					func_233(iParam0);
					DEBUG::_0xF0783374333FD8CE(680, 131, "SWITCH_PED_TO_OUTFIT: Successfullly applied requested metaped outfit ", func_163(bParam1, 0), " for: ", UNK_0x1B7C373FB4E76B85(ENTITY::GET_ENTITY_MODEL(iParam0)));
				}
			}
			else
			{
				PED::_SET_PED_BODY_COMPONENT(iParam0, bParam1);
				PED::_UPDATE_PED_VARIATION(iParam0, false, true, true, true, false);
				DEBUG::_0xF0783374333FD8CE(680, 131, "SWITCH_PED_TO_OUTFIT: Successfullly applied NON-requested outfit ", func_163(bParam1, 0), " for: ", UNK_0x1B7C373FB4E76B85(ENTITY::GET_ENTITY_MODEL(iParam0)));
			}
		...
		{
			DEBUG::_0x4DC69742196F818A(680, 131, "SWITCH_PED_TO_OUTFIT: Ped DOES NOT have outfit ", func_163(bParam1, 0), " : ", UNK_0x1B7C373FB4E76B85(ENTITY::GET_ENTITY_MODEL(iParam0)));
		}
	}
	else
	{
		DEBUG::_0x4DC69742196F818A(8, 131, "Ped was NULL. Not swapping outfit!");
	}
}
...
bool func_165(var uParam0, bool bParam1, vector3 vParam2)
{
	if (!STREAMING::HAS_MODEL_LOADED(bParam1))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 201, "[CREATE_SHOW_OBJECT] OBJECT MODEL WAS NOT LOADED - ", UNK_0x1B7C373FB4E76B85(bParam1));
	...
	{
		*uParam0 = OBJECT::CREATE_OBJECT(bParam1, vParam2, true, true, false, false, true);
		DEBUG::_0xA308F935BDECCEC0(168, 201, "[CREATE_SHOW_OBJECT] CREATE_OBJECT called THIS FRAME for ", UNK_0x1B7C373FB4E76B85(bParam1), " AT INDEX: ", *uParam0);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 201, "[CREATE_SHOW_OBJECT] OBJECT HAS NOT YET BEEN CREATED - ", UNK_0x1B7C373FB4E76B85(bParam1));
...
bool func_166(var uParam0, int iParam1, int iParam2, char* sParam3)
{
	if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iParam1))
	{
		if (NETWORK::_NETWORK_HAS_CONTROL_OF_ANIM_SCENE(iParam1))
		{
			if (!NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(uParam0->f_1408[iParam2]))
			{
				...
				DEBUG::_0xA308F935BDECCEC0(40, 201, "[SHOW_GSMP_IS_ENTITY_READY_IN_ANIM_SCENE] requesting control of entity : ", sParam3);
				return false;
			}
			else if ((ANIMSCENE::_GET_ANIM_SCENE_PED(iParam1, sParam3, false) != uParam0->f_1408[iParam2] && ENTITY::DOES_ENTITY_EXIST(uParam0->f_1408[iParam2])) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_1408[iParam2]))
			{
				...
				DEBUG::_0xA308F935BDECCEC0(40, 201, "[SHOW_GSMP_IS_ENTITY_READY_IN_ANIM_SCENE] setting anim scene entity: ", sParam3);
				return false;
			}
		}
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 201, "[SHOW_GSMP_IS_ENTITY_READY_IN_ANIM_SCENE] we are waiting on something ", sParam3);
			return false;
		}
	}
	else
	{
		DEBUG::_0xA308F935BDECCEC0(40, 201, "[SHOW_GSMP_IS_ENTITY_READY_IN_ANIM_SCENE] anim scene does not exist", sParam3);
		return false;
	}
	return true;
}
...
bool func_169(bool bParam0, bool bParam1, bool bParam2)
{
	if (!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(bParam0))
	{
		if ((NETWORK::NETWORK_IS_IN_SESSION() && SCRIPTS::_DOES_THREAD_EXIST(Global_1051590.f_16[0])) && bParam1)
		{
			...
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add networked Door ", func_171(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
		else
		{
			OBJECT::_ADD_DOOR_TO_SYSTEM_NEW(bParam0, true, false, false, 0, 0, false);
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add Door ", func_171(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
	}
	...
	if (bParam2)
	{
		...
		DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Set door ", func_171(bParam0, 0), " able to change open ratio while locked");
		UNK_0x355E72323AEE83CC(183, 7);
	}
	return bParam0;
}
...
char* func_172(int iParam0, int iParam1)
{
	...
	{
		case -1:
			return "DOORSTATE_INVALID";
		case 0:
			return "DOORSTATE_UNLOCKED";
		case 1:
			return "DOORSTATE_LOCKED_UNBREAKABLE";
		case 2:
			return "DOORSTATE_LOCKED_BREAKABLE";
		case 3:
			return "DOORSTATE_HOLD_OPEN_POSITIVE";
		case 4:
			return "DOORSTATE_HOLD_OPEN_NEGATIVE";
		default:
			break;
	}
	if (iParam1 >= 1)
...
void func_173(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
char* func_174(int iParam0, int iParam1)
{
	...
	{
		case 0:
			return "GSMP_SHOW_PROJECTIONIST_PLAYLIST_SITLOOP";
		case 1:
			return "GSMP_SHOW_PROJECTIONIST_PLAYLIST_ACTION";
		case 2:
			return "GSMP_SHOW_PROJECTIONIST_PLAYLIST_ITDOWN";
		default:
			break;
	}
	if (iParam1 >= 1)
...
char* func_175(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case -1:
			return "SHOW_INVALID";
		case 0:
			return "SHOW_SDN_FIRST";
		case 1:
			return "SHOW_NBX_MC_SET02";
		case 2:
			return "SHOW_NBX_MC_SET04";
		case 3:
			return "SHOW_SDN_LAST";
		case 4:
			return "SHOW_NBX_MC_SET03";
		case 5:
			return "SHOW_NBX_CANCAN";
		case 6:
			return "SHOW_NBX_CANCAN02";
		case 7:
			return "SHOW_NBX_BIGBAND";
		case 8:
			return "SHOW_NBX_BIGBAND02";
		case 9:
			return "SHOW_NBX_BULLET_CATCH";
		case 10:
			return "SHOW_NBX_ESCAPEARTIST";
		case 11:
			return "SHOW_NBX_ESCAPENOOSE";
		case 12:
			return "SHOW_NBX_FIREBREATH";
		case 13:
			return "SHOW_NBX_FIREDANCE01";
		case 14:
			return "SHOW_NBX_FIREDANCE02";
		case 15:
			return "SHOW_NBX_FLEXFIGHT";
		case 16:
			return "SHOW_NBX_SNAKEDANCE01";
		case 17:
			return "SHOW_NBX_SNAKEDANCE02";
		case 18:
			return "SHOW_NBX_STRONG_WOMAN";
		case 19:
			return "SHOW_NBX_SWORDDANCE01";
		case 20:
			return "SHOW_NBX_ODDFELLOWS";
		case 21:
			return "SHOW_SDN_MAGIC_LANTERN01";
		case 22:
			return "SHOW_SDN_MAGIC_LANTERN02";
		case 23:
			return "SHOW_SDN_MAGIC_LANTERN03";
		case 24:
			return "SHOW_SDN_MAGIC_LANTERN04";
		case 25:
			return "SHOW_SDN_MAGIC_LANTERN_LAST";
		case 26:
			return "SHOW_SDN_MOVIE01";
		case 27:
			return "SHOW_SDN_MOVIE02";
		case 28:
			return "SHOW_SDN_MOVIE03";
		case 29:
			return "SHOW_SDN_MOVIE04";
		case 30:
			return "SHOW_SDN_MOVIE05";
		case 31:
			return "SHOW_VAL_MAGIC_LANTERN01";
		case 32:
			return "SHOW_VAL_MAGIC_LANTERN02";
		case 33:
			return "SHOW_VAL_MAGIC_LANTERN03";
		case 34:
			return "SHOW_VAL_MAGIC_LANTERN04";
		case 35:
			return "SHOW_VAL_LAST";
		case 36:
			return "SHOW_BLA_FIRST";
		case 37:
			return "SHOW_BLA_MOVIE02";
		case 38:
			return "SHOW_BLA_MOVIE03";
		case 39:
			return "SHOW_BLA_LAST";
		case 40:
			return "SHOW_LAST";
		case 41:
			return "NUM_SHOWS";
...
char* func_176(int iParam0, int iParam1)
{
	...
	{
		case 0:
			return "ISS_GENERIC_INIT";
		case 32:
			return "ISS_FIREDANCE_MAIN_STATE_SINGLE_INIT";
		case 33:
			return "ISS_FIREDANCE_MAIN_STATE_INIT";
		case 34:
			return "ISS_FIREDANCE_MAIN_STATE_UPDATE";
		case 35:
			return "ISS_FIREDANCE_STATE_START_FALL";
		case 36:
			return "ISS_FIREDANCE_STATE_WAIT_IN_FALL";
		case 37:
			return "ISS_FIREDANCE_MAIN_STATE_CLOSE_CURTAINS";
		case 38:
			return "ISS_FIREDANCE_STATE_WAIT_FOR_FAIL_END";
		case 39:
			return "ISS_FIREDANCE_MAIN_STATE_COMPLETE";
		case 40:
			return "ISS_GENERIC_COMPLETE";
		default:
			break;
	}
	if (iParam1 >= 1)
...
{
	DEBUG::_0xA308F935BDECCEC0(680, 201, "[GSMP_SET_INDIVIDUAL_SHOW_STATE_HOST] Changing from STATE: ,", func_176(*uParam0, 0), " TO STATE: ", func_176(iParam1, 0));
	*uParam0 = iParam1;
}
...
{
	DEBUG::_0xA308F935BDECCEC0(680, 201, "[GSMP_SET_INDIVIDUAL_SHOW_STATE_CLIENT] Changing from STATE: ,", func_176(*uParam0, 0), " TO STATE: ", func_176(iParam1, 0));
	*uParam0 = iParam1;
}
...
int func_182(bool bParam0, int iParam1)
{
	...
	if (func_170(bParam0))
	{
		iVar0 = ENTITY::_0xF7424890E4A094C0(bParam0, 0);
		if (iVar0 != 0)
		{
...
void func_183(bool bParam0, char* sParam1, bool bParam2, bool bParam3)
{
	if (func_170(bParam0))
	{
...
void func_184(bool bParam0, bool bParam1)
{
	if (func_170(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 2 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "LOCK_DOOR_ID - Locking Door ID ", func_171(bParam0, 0));
		}
	}
	else
	{
...
void func_185(bool bParam0, bool bParam1)
{
	if (func_170(bParam0))
	{
		...
		{
			DEBUG::_0x1B08D1EB9D8C4931(2216, 183, "SET_DOOR_ID_LOCKED_AND_UNBREAKABLE - Door ID ", func_171(bParam0, 0), " state = ", OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0), " pending state ", UNK_0x4BC2854478F3A749(bParam0));
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(bParam0, 1);
		}
	}
	else
...
void func_186(bool bParam0, bool bParam1)
{
	if (func_170(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 0 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "UNLOCK_DOOR_ID - Unlocking Door ID ", func_171(bParam0, 0));
		}
	}
	else
	{
...
bool func_192(var uParam0, bool bParam1, vector3 vParam2, int iParam5)
{
	if (uParam0->f_1 == 0)
	{
	...
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 201, "[SHOW_GET_LIGHT] IS_MAP_ENTITY_PINNED is false -- waiting on this to happen");
	}
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		DEBUG::_0x1B08D1EB9D8C4931(936, 201, "[SHOW_GET_LIGHT] Light not ready: ", func_239(bParam1, 0), " at position: ", &vParam2);
		return false;
	}
	uParam0->f_2 = 1f;
	return true;
...
bool func_205(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	fVar1 = func_159(uParam2);
	iVar0 = 0;
	while (iVar0 <= (*uParam0 - 1))
	{
		func_240(uParam0[iVar0 /*5*/], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_207(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		func_241(uParam0[iVar0 /*5*/], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_216(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	float fVar0;
	...
	fVar0 = func_159(uParam2);
	func_240(uParam0, fParam1, fVar0, fParam3, iParam4);
	if (fVar0 >= fParam3)
	{
		func_160(uParam2);
		return true;
...
bool func_218(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	float fVar0;
	...
	fVar0 = func_159(uParam2);
	func_241(uParam0, fParam1, fVar0, fParam3, iParam4);
	if (fVar0 >= fParam3)
	{
		func_160(uParam2);
		return true;
...
bool func_221(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (iVar0 > iVar1)
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 201, "[SHOW_BRIGHTEN_LIGHT_RANGE] index values were not useable.");
		return true;
	}
	if (!func_35(uParam4))
	{
	...
	fVar2 = func_159(uParam4);
	iVar3 = iVar0;
	while (iVar3 <= iVar1)
	{
		func_240(uParam2[iVar3 /*5*/], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
bool func_223(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	while (iVar3 <= iVar1)
	{
		func_241(uParam2[iVar3 /*5*/], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
void func_228(var uParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(8, 201, "[SHOW_RELEASE_LIGHTS] SHOWS LIGHTS have been unpinned");
}

var func_229(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	else
	{
		switch (iParam9)
		{
			case joaat("VOLCYLINDER"):
				iVar8 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_244());
				break;
			case joaat("VOLSPHERE"):
				iVar8 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_244());
				break;
			case joaat("VOLBOX"):
				iVar8 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_244());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_245(PLAYER::GET_PLAYER_TEAM(iVar5)));
	}
	...
	while (iVar2 < 32)
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(Global_1275959.f_154[iVar2]))
		{
			...
			if (!bVar3)
			{
				if (iVar9 & 8192 != 0 && func_247(iVar2) != 1)
				{
					bVar3 = true;
				}
			}
...
bool func_230(int iParam0, bool bParam1)
{
	...
	{
		DEBUG::_0xF0783374333FD8CE(8, 131, "DOES_PED_HAVE_META_PED_OUTFIT: Ped did not exist! Returning FALSE!");
		return false;
	}
	bVar0 = PED::_DOES_METAPED_OUTFIT_EXIST_FOR_PED_MODEL(bParam1, ENTITY::GET_ENTITY_MODEL(iParam0));
	if (bVar0)
	{
		DEBUG::_0x1B08D1EB9D8C4931(2696, 131, "DOES_PED_HAVE_META_PED_OUTFIT: Ped[", iParam0, "] does have metaped outfit[", func_163(bParam1, 0), "]");
	}
	else
	{
		DEBUG::_0x1B08D1EB9D8C4931(2696, 131, "DOES_PED_HAVE_META_PED_OUTFIT: Ped[", iParam0, "] does NOT have metaped outfit[", func_163(bParam1, 0), "]");
	}
	return bVar0;
}
...
bool func_231(int iParam0, bool bParam1)
{
	...
	{
		DEBUG::_0xF0783374333FD8CE(8, 131, "DOES_PED_HAVE_PENDING_OUTFIT_PRELOAD: Decor did not exist! Ped does not have a pending outfit preload!");
		return false;
	}
	iVar0 = DECORATOR::DECOR_GET_INT(iParam0, "metaped_outfit_request_name");
	if (iVar0 == bParam1)
	{
		DEBUG::_0xF0783374333FD8CE(8, 131, "DOES_PED_HAVE_PENDING_OUTFIT_PRELOAD: Ped has a pending outfit preload that matches the checked outfit!");
		return true;
	}
	DEBUG::_0xF0783374333FD8CE(8, 131, "DOES_PED_HAVE_PENDING_OUTFIT_PRELOAD: Ped does NOT have a pending outfit preload that matches the checked outfit!");
	return false;
}
...
bool func_232(int iParam0, bool bParam1)
{
	...
	if (!DECORATOR::DECOR_EXIST_ON(iParam0, "metaped_outfit_request") || !DECORATOR::DECOR_EXIST_ON(iParam0, "metaped_outfit_request_name"))
	{
		DEBUG::_0xF0783374333FD8CE(8, 131, "DOES_PED_HAVE_PRELOADED_OUTFIT_READY: Decor did not exist! Outfit can't preload!");
		return false;
	}
	DEBUG::_0xF0783374333FD8CE(136, 131, "DOES_PED_HAVE_PRELOADED_OUTFIT_READY: Decorators exist! Values: metaped_outfit_request: ", DECORATOR::DECOR_GET_INT(iParam0, "metaped_outfit_request"), " metaped_outfit_request_name: ", DECORATOR::DECOR_GET_INT(iParam0, "metaped_outfit_request_name"));
	bVar0 = DECORATOR::DECOR_GET_INT(iParam0, "metaped_outfit_request_name");
	if (!func_230(iParam0, bVar0))
	{
		DEBUG::_0x4DC69742196F818A(8, 131, "DOES_PED_HAVE_PRELOADED_OUTFIT_READY: Ped DOES NOT have outfit. Returning TRUE to allow scripts to continue!");
		return true;
	}
	if (bVar0 != bParam1)
	{
		DEBUG::_0xF0783374333FD8CE(8, 131, "DOES_PED_HAVE_PRELOADED_OUTFIT_READY: Stored outfit didn't match passed in outfit! Can't apply preloaded outfit!");
		return false;
	}
...
{
	DEBUG::_0xA308F935BDECCEC0(648, 28, "HORSE_SET_GENDER - pedHorse: ", sParam0, " eGender = ", func_249(iParam1, 0));
	if (iParam1 == 1)
	{
...
void func_240(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (uParam0->f_2 > fParam1 && uParam0->f_2 > uParam0->f_3)
		{
			...
			fVar0 = (fVar1 / fParam3);
			uParam0->f_2 = func_251(fParam1, uParam0->f_4, fVar0);
...
void func_241(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4)
{
	float fVar0;
	float fVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (uParam0->f_2 < fParam1 && uParam0->f_2 < uParam0->f_4)
		{
			...
			uParam0->f_2 = func_251(uParam0->f_3, fParam1, fVar0);
			if (uParam0->f_2 > fParam1)
			{
				uParam0->f_2 = fParam1;
			}
...
bool func_252(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_255(&(Global_1102630.f_4), iVar0, 5);
	}
	if (iParam1 == func_256())
	{
		return func_255(&(Global_1102630.f_4), iVar0, 5);
	...
	{
		return func_255(&(Global_1100880[iParam1 /*53*/].f_4), iVar0, 5);
	}
