...
{
	if (!ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_1373))
	{
		return;
	}
}
...
void func_47(int iParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		if (bVar1 != 0)
		{
			if (!func_129(bVar1) && !func_130(bVar1))
			{
				func_131(bVar1, 1, 0, 0, 0, 0, 0, 0);
			}
		}
		iVar0++;
	}
...
{
	if (func_133(Global_33, uParam0->f_9, 0, 1, 0))
	{
		func_54(uParam1[uParam2->f_1 /*18*/], 1);
	}
	else if (func_70(uParam1[uParam2->f_1 /*18*/], 1))
	{
		func_134(uParam1[uParam2->f_1 /*18*/], 1);
	}
	if (func_133(Global_33, uParam0->f_10, 0, 1, 0))
	{
		func_54(uParam1[uParam2->f_1 /*18*/], 2);
	}
	else if (func_70(uParam1[uParam2->f_1 /*18*/], 2))
	{
		func_134(uParam1[uParam2->f_1 /*18*/], 2);
	}
}
...
void func_50(var uParam0, var uParam1)
{
	...
	while (iVar0 <= 2)
	{
		...
		{
			if (!func_135(&(uParam0->f_12[iVar0 /*3*/]), &(uParam1->f_3[iVar0 /*3*/])))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_LOAD_PLAYLIST_CLIENT] playlists do not match.");
				func_136(&(uParam0->f_12[iVar0 /*3*/]), &(uParam1->f_3[iVar0 /*3*/]));
			}
...
{
	func_137(&(uParam1->f_2), &(uParam1->f_247), uParam0->f_2);
	func_138(&(uParam1->f_247), &(uParam1->f_2), uParam0->f_2);
}
...
void func_58(var uParam0, var uParam1, int iParam2)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 201, "[GSMP_SHOW_CLIENT_PROJECTIONIST_UPDATE] -- STATE: ", func_140(*uParam1, 0));
	...
	switch (*uParam1)
	{
		...
		case 3:
			if ((ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_9) && ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_9, true, false)) && NETWORK::_NETWORK_HAS_CONTROL_OF_ANIM_SCENE(uParam0->f_9))
			{
				...
				ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_9, func_142(iParam2), uParam0->f_2, 0);
				iVar0 = 0;
				while (iVar0 <= (5 - 1))
				{
					ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_9, func_143(iParam2, iVar0), uParam0->f_3[iVar0], 0);
					iVar0++;
				}
...
void func_72(var uParam0, var uParam1)
{
	...
	if (!uParam0->f_1357)
	{
		func_151(&(uParam1->f_2), &(uParam1->f_247));
	}
	if (!uParam0->f_4)
	{
		func_47(uParam0->f_1350);
...
void func_74(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 201, "GSMP_HOST_END_SHOW -- Theater: ", func_152(iParam0, 0));
	Var0.f_6 = -1;
	Var0.f_4 = 1;
	Var0.f_6 = iParam0;
	Var0 = 31;
...
{
	DEBUG::_0xA308F935BDECCEC0(680, 201, "[SHOW_CHANGE_CURTAIN_STATE] old state: ", func_155(*uParam0, 0), " new state: ", func_155(iParam1, 0));
	*uParam0 = iParam1;
}
...
bool func_95(var uParam0)
{
	...
	{
		DEBUG::_0xF0783374333FD8CE(8, 201, "CUSTOM_SHOW_LOADING: Screen hasn't loaded. ");
	}
...
bool func_96(var uParam0)
{
	...
	else if (func_157(&(uParam0->f_1363)) > 10f)
	{
...
bool func_100(var uParam0, bool bParam1, vector3 vParam2, float fParam5)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0) && PED::_0xA0BC8FAED8CFEB3C(*uParam0))
	{
		if (!bVar0)
		{
			func_160(*uParam0, bVar2);
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CREATE_SHOW_PED] yes we are setting the outfit");
		}
		DEBUG::_0xA308F935BDECCEC0(40, 201, "[CREATE_SHOW_PED] ped is being created with a custom outfit: ", func_161(bVar2, 0));
		return true;
	}
	return false;
}
...
{
	DEBUG::_0xF0783374333FD8CE(8, 201, "@@@ CREATE_SHOW_ASSETS");
	func_162(uParam0);
}
...
void func_106(bool bParam0, int iParam1, bool bParam2)
{
	...
	if (func_166(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != iParam1 || bParam2)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(680, 183, "SET_DOORSTATE_OF_DOOR_ID - Setting Door ID ", func_167(bParam0, 0), " to ", func_168(iParam1, 0));
...
char* func_117(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 201, "Projectionist playlist: ", func_170(iParam1, 0), " show: ", func_171(iParam0, 0));
...
void func_128(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 218, "CLEAR_WORLD_STATE_FLAG: clearing world state - ", func_173(iParam0, 0));
	Global_1939807 = 0;
}
...
{
	return func_174(bParam0, 23);
}

void func_131(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	func_165(bParam0, 0, 0);
	if (func_166(bParam0))
	{
		...
		if (bParam3)
		{
			func_175(bParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
			{
				func_176(bParam0, 1);
				UNK_0x355E72323AEE83CC(183, 9);
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking Door ID ", func_167(bParam0, 0));
			}
			else
			{
				func_177(bParam0, 1);
				UNK_0x355E72323AEE83CC(183, 9);
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking and making unbreakable Door ID ", func_167(bParam0, 0));
			}
		}
		else
		{
			func_178(bParam0, 1);
			UNK_0x355E72323AEE83CC(183, 9);
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Unlocking Door ID ", func_167(bParam0, 0));
		}
		if (bParam7)
		{
			DEBUG::_0x1B08D1EB9D8C4931(168, 183, "SET_STATE_OF_DOOR_ID - Treating Door ID ", func_167(bParam0, 0), " as shut.");
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 183, "SET_STATE_OF_DOOR_ID: Door with ID not registered by host yet ", func_167(bParam0, 0));
	}
}
...
bool func_133(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
...
int func_137(var uParam0, var uParam1, int iParam2)
{
	...
	if (!func_13(*uParam1, 1))
	{
		...
		{
			iVar3 = iVar0;
			if (func_184(uParam0[iVar0 /*5*/], func_182(iParam2), func_183(iParam2, iVar3), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 8))
	{
		...
		{
			iVar4 = iVar0;
			if (func_184(&(uParam0->f_31[iVar0 /*5*/]), func_186(iParam2), func_187(iParam2, iVar4), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 2048))
	{
		...
		{
			iVar5 = iVar0;
			if (func_184(&(uParam0->f_107[iVar0 /*5*/]), func_189(iParam2), func_190(iParam2, iVar5), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
	...
	{
		case 0:
			if (!func_13(*uParam1, 64) && func_184(&(uParam0->f_118[0 /*5*/]), func_191(iParam2, 0), func_192(iParam2, 0), 1065353216 /* Float: 1f */))
			{
				func_18(uParam1, 64);
			}
			if ((!func_13(*uParam1, 16384) && func_184(&(uParam0->f_118[1 /*5*/]), func_191(iParam2, 1), func_192(iParam2, 1), 1065353216 /* Float: 1f */)) && func_184(&(uParam0->f_118[2 /*5*/]), func_191(iParam2, 2), func_192(iParam2, 2), 1065353216 /* Float: 1f */))
			{
		...
		case 1:
			...
			if (!func_13(*uParam1, 2097152))
			{
				...
				{
					iVar6 = iVar0;
					if (func_184(&(uParam0->f_118[iVar0 /*5*/]), func_191(iParam2, 0), func_192(iParam2, iVar6), 1065353216 /* Float: 1f */))
					{
						iVar2++;
					}
					iVar0++;
...
void func_138(var uParam0, var uParam1, int iParam2)
{
	...
	{
		if (func_13(*uParam0, 2) && func_197(uParam1, func_194(uParam1), &(uParam1->f_229), func_195(uParam1), func_196(uParam1)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "WALL LIGHTS should be faded out");
			func_14(uParam0, 2);
		}
		if (func_13(*uParam0, 4) && func_199(uParam1, func_198(uParam1), &(uParam1->f_229), func_195(uParam1), func_196(uParam1)))
		{
	...
	{
		if (func_13(*uParam0, 16) && func_197(&(uParam1->f_31), func_200(uParam1), &(uParam1->f_232), func_201(uParam1), func_196(uParam1)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "STAGE LIGHTS should be faded out");
			func_14(uParam0, 16);
		}
		if (func_13(*uParam0, 32) && func_199(&(uParam1->f_31), func_202(uParam1), &(uParam1->f_232), func_201(uParam1), func_196(uParam1)))
		{
	...
	{
		if (func_13(*uParam0, 4096) && func_197(&(uParam1->f_107), func_203(uParam1), &(uParam1->f_235), func_204(uParam1), func_196(uParam1)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "BALCONY LIGHTS should be faded out");
			func_14(uParam0, 4096);
		}
		if (func_13(*uParam0, 8192) && func_199(&(uParam1->f_107), func_205(uParam1), &(uParam1->f_235), func_204(uParam1), func_196(uParam1)))
		{
	...
	if (iParam2 == 0)
	{
		...
		{
			if (func_13(*uParam0, 128) && func_208(&(uParam1->f_118[0 /*5*/]), func_206(uParam1), &(uParam1->f_238), func_207(uParam1), func_196(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE CENTER STAGE LIGHT should be faded out");
				func_14(uParam0, 128);
			}
			if (func_13(*uParam0, 256) && func_210(&(uParam1->f_118[0 /*5*/]), func_209(uParam1), &(uParam1->f_238), func_207(uParam1), func_196(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE CENTER STAGE LIGHT s should be faded in");
				func_14(uParam0, 256);
			}
			if (func_13(*uParam0, 512) && func_208(&(uParam1->f_118[0 /*5*/]), func_206(uParam1), &(uParam1->f_238), 0.5f, func_196(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE CENTER STAGE LIGHT s should be off");
				func_14(uParam0, 512);
			}
			if (func_13(*uParam0, 1024) && func_210(&(uParam1->f_118[0 /*5*/]), func_209(uParam1), &(uParam1->f_238), 0.5f, func_196(uParam1)))
			{
		...
		{
			if (func_13(*uParam0, 32768) && func_213(1, 2, &(uParam1->f_118), func_211(uParam1), &(uParam1->f_241), func_212(uParam1), func_196(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE RED LIGHTS should be faded out");
				func_14(uParam0, 32768);
			}
			if (func_13(*uParam0, 65536) && func_215(1, 2, &(uParam1->f_118), func_214(uParam1), &(uParam1->f_241), func_212(uParam1), func_196(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE RED LIGHTS should be faded in");
				func_14(uParam0, 65536);
			}
			if (func_13(*uParam0, 131072) && func_213(1, 2, &(uParam1->f_118), func_211(uParam1), &(uParam1->f_241), 0.5f, func_196(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE RED LIGHTS should be off");
				func_14(uParam0, 131072);
			}
			if (func_13(*uParam0, 262144) && func_215(1, 2, &(uParam1->f_118), func_214(uParam1), &(uParam1->f_241), 0.5f, func_196(uParam1)))
			{
		...
		{
			bVar0 = true;
			if (!func_197(&(uParam1->f_31), func_200(uParam1), &(uParam1->f_232), 0.1f, func_196(uParam1)))
			{
				bVar0 = false;
			}
			if (bVar0)
		...
		{
			bVar1 = true;
			if (!func_199(&(uParam1->f_31), func_202(uParam1), &(uParam1->f_232), 0.1f, func_196(uParam1)))
			{
				bVar1 = false;
			}
			if (bVar1)
	...
	if (iParam2 == 1)
	{
		...
		{
			if (func_13(*uParam0, 4194304) && func_197(&(uParam1->f_118), func_216(uParam1), &(uParam1->f_238), func_217(uParam1), func_196(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "SD MAGIC LANTERN / MOVIE Arch lights should be faded out");
				func_14(uParam0, 4194304);
			}
			if (func_13(*uParam0, 8388608) && func_199(&(uParam1->f_118), func_218(uParam1), &(uParam1->f_238), func_217(uParam1), func_196(uParam1)))
			{
...
{
	DEBUG::_0xF0783374333FD8CE(8, 201, "@@@ PREPARE_NEW_SHOW_ANIM_SCENE: No anim scene necessary for Movies");
}
...
{
	DEBUG::_0xA308F935BDECCEC0(680, 201, "[GSMP_SHOW_HOST_PROJECTIONIST_CHANGE_STATE] current state: ", func_140(*uParam0, 0), " new state: ", func_140(iParam1, 0));
	*uParam0 = iParam1;
}
...
{
	func_220(uParam0);
	func_220(&(uParam0->f_31));
	func_220(&(uParam0->f_107));
	func_220(&(uParam0->f_118));
	*uParam1 = 0;
}
...
int func_156(var uParam0)
{
	if (!HUD::IS_NAMED_RENDERTARGET_REGISTERED(uParam0->f_1563))
	{
		...
		{
			DEBUG::_0x1B08D1EB9D8C4931(40, 201, "SHOW_SETUP_MOVIE_SCREEN: UNABLE TO LINK THE MOVIE SCREEN RENDERTARGET - ", uParam0->f_1563);
			HUD::RELEASE_NAMED_RENDERTARGET(uParam0->f_1563);
			return 0;
		}
	}
	...
	if (uParam0->f_1561)
	{
		if (uParam0->f_1578 == 0)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(8, 201, "[SHOW_SETUP_MOVIE_SCREEN] called pin closest entity");
		}
		...
		{
			DEBUG::_0x1B08D1EB9D8C4931(8, 201, "[SHOW_SETUP_MOVIE_SCREEN] IS_MAP_ENTITY_PINNED is false -- waiting on this to happen [Projector]");
		}
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1577))
		{
			DEBUG::_0x1B08D1EB9D8C4931(8, 201, "SHOW_SETUP_MOVIE_SCREEN: UNABLE TO FIND THE PROJECTOR.");
			return 0;
		}
		OBJECT::_0xF49574E2332A8F06(uParam0->f_1577, 0f);
		OBJECT::_0x04D1D4E411CE52D0(uParam0->f_1577, uParam0->f_1562);
		DEBUG::_0x1B08D1EB9D8C4931(8, 201, "SHOW_SETUP_MOVIE_SCREEN: PROJECTOR SUCCESSFULLY SETUP FOR BINK PLAYBACK.");
	}
	HUD::SET_TEXT_RENDER_ID(uParam0->f_1562);
	GRAPHICS::DRAW_RECT(0.5f, 0.5f, 1f, 1f, 0, 0, 0, 255, false, true);
	uParam0->f_1560 = 1;
	DEBUG::_0xA308F935BDECCEC0(8, 201, "SHOW_SETUP_MOVIE_SCREEN: MOVIE SCREEN SUCCESSFULLY SETUP FOR BINK PLAYBACK.");
	return 1;
}
...
void func_160(int iParam0, bool bParam1)
{
	...
	{
		DEBUG::_0x4DC69742196F818A(680, 131, "SWITCH_PED_TO_OUTFIT: Swapping to metaped outfit ", func_161(bParam1, 0), " for ped: ", UNK_0x1B7C373FB4E76B85(ENTITY::GET_ENTITY_MODEL(iParam0)));
		if (func_222(iParam0, bParam1))
		{
			if (func_223(iParam0, bParam1))
			{
				if (func_224(iParam0, bParam1))
				{
					...
					func_225(iParam0);
					DEBUG::_0xF0783374333FD8CE(680, 131, "SWITCH_PED_TO_OUTFIT: Successfullly applied requested metaped outfit ", func_161(bParam1, 0), " for: ", UNK_0x1B7C373FB4E76B85(ENTITY::GET_ENTITY_MODEL(iParam0)));
				}
			}
			else
			{
				...
				DEBUG::_0xF0783374333FD8CE(680, 131, "SWITCH_PED_TO_OUTFIT: Successfullly applied NON-requested outfit ", func_161(bParam1, 0), " for: ", UNK_0x1B7C373FB4E76B85(ENTITY::GET_ENTITY_MODEL(iParam0)));
			}
		...
		{
			DEBUG::_0x4DC69742196F818A(680, 131, "SWITCH_PED_TO_OUTFIT: Ped DOES NOT have outfit ", func_161(bParam1, 0), " : ", UNK_0x1B7C373FB4E76B85(ENTITY::GET_ENTITY_MODEL(iParam0)));
		}
	}
	else
	{
...
void func_162(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1576))
	{
		...
		DEBUG::_0xA308F935BDECCEC0(8, 201, "SHOW_CREATE_MOVIE_SCREEN: MOVIE SCREEN CREATED.");
	}
}
...
bool func_165(bool bParam0, bool bParam1, bool bParam2)
{
	if (!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(bParam0))
	{
		if ((NETWORK::NETWORK_IS_IN_SESSION() && SCRIPTS::_DOES_THREAD_EXIST(Global_1051590.f_16[0])) && bParam1)
		{
			...
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add networked Door ", func_167(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
		else
		{
			OBJECT::_ADD_DOOR_TO_SYSTEM_NEW(bParam0, true, false, false, 0, 0, false);
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add Door ", func_167(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
	}
	...
	if (bParam2)
	{
		...
		DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Set door ", func_167(bParam0, 0), " able to change open ratio while locked");
		UNK_0x355E72323AEE83CC(183, 7);
	}
	return bParam0;
}
...
var func_167(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
void func_175(bool bParam0, char* sParam1, bool bParam2, bool bParam3)
{
	if (func_166(bParam0))
	{
...
void func_176(bool bParam0, bool bParam1)
{
	if (func_166(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 2 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "LOCK_DOOR_ID - Locking Door ID ", func_167(bParam0, 0));
		}
	}
	else
	{
...
void func_177(bool bParam0, bool bParam1)
{
	if (func_166(bParam0))
	{
		...
		{
			DEBUG::_0x1B08D1EB9D8C4931(2216, 183, "SET_DOOR_ID_LOCKED_AND_UNBREAKABLE - Door ID ", func_167(bParam0, 0), " state = ", OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0), " pending state ", UNK_0x4BC2854478F3A749(bParam0));
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(bParam0, 1);
		}
	}
	else
...
void func_178(bool bParam0, bool bParam1)
{
	if (func_166(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 0 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "UNLOCK_DOOR_ID - Unlocking Door ID ", func_167(bParam0, 0));
		}
	}
	else
	{
...
bool func_184(var uParam0, bool bParam1, vector3 vParam2, int iParam5)
{
	if (uParam0->f_1 == 0)
	{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		DEBUG::_0x1B08D1EB9D8C4931(936, 201, "[SHOW_GET_LIGHT] Light not ready: ", func_230(bParam1, 0), " at position: ", &vParam2);
		return false;
	}
	uParam0->f_2 = 1f;
	return true;
...
bool func_197(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	fVar1 = func_157(uParam2);
	iVar0 = 0;
	while (iVar0 <= (*uParam0 - 1))
	{
		func_231(uParam0[iVar0 /*5*/], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_199(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		func_232(uParam0[iVar0 /*5*/], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_208(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	fVar0 = func_157(uParam2);
	func_231(uParam0, fParam1, fVar0, fParam3, iParam4);
	if (fVar0 >= fParam3)
	{
		func_158(uParam2);
		return true;
...
bool func_210(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	fVar0 = func_157(uParam2);
	func_232(uParam0, fParam1, fVar0, fParam3, iParam4);
	if (fVar0 >= fParam3)
	{
		func_158(uParam2);
		return true;
...
bool func_213(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	fVar2 = func_157(uParam4);
	iVar3 = iVar0;
	while (iVar3 <= iVar1)
	{
		func_231(uParam2[iVar3 /*5*/], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
bool func_215(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	while (iVar3 <= iVar1)
	{
		func_232(uParam2[iVar3 /*5*/], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
var func_221(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	else
	{
		switch (iParam9)
		{
			case joaat("VOLCYLINDER"):
				iVar8 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_235());
				break;
			case joaat("VOLSPHERE"):
				iVar8 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_235());
				break;
			case joaat("VOLBOX"):
				iVar8 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_235());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_236(PLAYER::GET_PLAYER_TEAM(iVar5)));
	}
	...
	while (iVar2 < 32)
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(Global_1275959.f_154[iVar2]))
		{
			...
			if (!bVar3)
			{
				if (iVar9 & 8192 != 0 && func_238(iVar2) != 1)
				{
					bVar3 = true;
				}
			}
...
bool func_222(int iParam0, bool bParam1)
{
	...
	if (bVar0)
	{
		DEBUG::_0x1B08D1EB9D8C4931(2696, 131, "DOES_PED_HAVE_META_PED_OUTFIT: Ped[", iParam0, "] does have metaped outfit[", func_161(bParam1, 0), "]");
	}
	else
	{
		DEBUG::_0x1B08D1EB9D8C4931(2696, 131, "DOES_PED_HAVE_META_PED_OUTFIT: Ped[", iParam0, "] does NOT have metaped outfit[", func_161(bParam1, 0), "]");
	}
	return bVar0;
}
...
{
	DEBUG::_0xA308F935BDECCEC0(648, 28, "HORSE_SET_GENDER - pedHorse: ", sParam0, " eGender = ", func_240(iParam1, 0));
	if (iParam1 == 1)
	{
...
void func_231(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (uParam0->f_2 > fParam1 && uParam0->f_2 > uParam0->f_3)
		{
			...
			fVar0 = (fVar1 / fParam3);
			uParam0->f_2 = func_241(fParam1, uParam0->f_4, fVar0);
...
void func_232(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4)
{
	float fVar0;
	float fVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (uParam0->f_2 < fParam1 && uParam0->f_2 < uParam0->f_4)
		{
			...
			uParam0->f_2 = func_241(uParam0->f_3, fParam1, fVar0);
			if (uParam0->f_2 > fParam1)
			{
				uParam0->f_2 = fParam1;
			}
...
bool func_242(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_245(&(Global_1102630.f_4), iVar0, 5);
	}
	if (iParam1 == func_246())
	{
		return func_245(&(Global_1102630.f_4), iVar0, 5);
	...
	{
		return func_245(&(Global_1100880[iParam1 /*53*/].f_4), iVar0, 5);
	}
