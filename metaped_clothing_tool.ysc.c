...
void __EntryFunction__()
{
	...
	fLocal_14 = 1f;
	func_1(-1);
	DEBUG::_0x4DC69742196F818A(8, 208, "...Starting Metaped Clothing Tool");
	bVar0 = false;
	while (!bVar0 && iLocal_259 < 3)
	{
		if (func_2() == -1)
		{
			bVar0 = func_3(1);
	...
	DEBUG::_0x4DC69742196F818A(8, 208, "...Ending Metaped Clothing Tool");
	func_6(&iLocal_259);
	func_7();
}
...
{
	func_9(iParam0, uParam1);
}

void func_6(int iParam0)
{
	DEBUG::_0xF0783374333FD8CE(8, 208, "[MC_TOOL__CLEANUP] Terminating Tool!");
}
...
{
	DEBUG::_0xF0783374333FD8CE(680, 207, "[METAPED_CLOTHING_TOOL__SET_LOCAL_STATE] From: ", func_12(*iParam0, 0), " To: ", func_12(iParam1, 0));
	*iParam0 = iParam1;
}

void func_11(var uParam0, int iParam1)
{
	DEBUG::_0xF0783374333FD8CE(40, 207, "[MC_TOOL_SET_FLAG] Setting: ", func_13(iParam1, 0));
