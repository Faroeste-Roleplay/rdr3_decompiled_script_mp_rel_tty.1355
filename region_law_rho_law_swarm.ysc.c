...
void __EntryFunction__()
{
	fLocal_13 = 1f;
	fLocal_14 = 1f;
	bLocal_47 = joaat("S_M_M_AMBIENTLAWRURAL_01");
...
void func_1()
{
	...
	DEBUG::_0xF0783374333FD8CE(8, 11, "REGION_LAW_SWARM_CLEANUP start");
}
...
void func_4()
{
	switch (iLocal_46)
	{
		case 1:
			...
			break;
		case 2:
			STREAMING::REQUEST_MODEL(bLocal_47, false);
			if (STREAMING::HAS_MODEL_LOADED(bLocal_47) && PED::_0x5E420FF293EE5472())
			{
				iLocal_46 = 4;
			}
			break;
...
bool func_6()
{
	...
	iLocal_48++;
	iVar0 = func_8(bLocal_47, vLocal_43, 0, 1, 1, 0, 1, 1, 1, 0, 0);
...
bool func_7()
{
	...
	if (!func_12(Global_34, &Local_49, &uVar5, 1, 1, fVar4, 50f, fVar0, fVar1, fVar3))
	{
		DEBUG::_0xF0783374333FD8CE(2184, 11, "Scanner attempt #", Local_49.f_2, " for spawn #", iLocal_48, " modifier #", iVar2);
		return false;
	}
	vLocal_43 = { Local_49.f_3 };
	DEBUG::_0xF0783374333FD8CE(56, 11, "Found a point at ", &vLocal_43);
	return true;
}

int func_8(bool bParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12)
{
	int iVar0;
	...
	func_13(iVar0, bParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
bool func_12(vector3 vParam0, int iParam3, int iParam4, int iParam5, bool bParam6, float fParam7, int iParam8, float fParam9, int iParam10, float fParam11)
{
	int iVar0;
...
void func_13(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
{
	DEBUG::_0xA308F935BDECCEC0(648, 28, "HORSE_SET_GENDER - pedHorse: ", sParam0, " eGender = ", func_24(iParam1, 0));
	if (iParam1 == 1)
	{
...
int func_22(vector3 vParam0, int iParam3)
{
	...
	return func_27(vParam0, iParam3);
}

int func_23(vector3 vParam0)
{
	return func_28(ZONE::_GET_MAP_ZONE_AT_COORDS(vParam0, 10));
}
...
int func_27(vector3 vParam0, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_29(vector3 vParam0)
{
	...
	iVar0 = func_30(vParam0, 0f, 0f, 0, 2);
	return func_30(vParam0, Global_1892752[iVar0 /*3*/].f_1, Global_1892752[iVar0 /*3*/].f_2, Global_1892752[iVar0 /*3*/], 4);
}

int func_30(struct<2> Param0, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6)
{
	if (Param0 < fParam3)
	{
