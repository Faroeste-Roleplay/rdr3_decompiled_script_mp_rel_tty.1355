...
bool func_13()
{
	...
	iLocal_22 = VOLUME::_0x0EB78C2B156635B1(joaat("VOLBOX"), -2183.285f, -2133.454f, 73.87f, 0f, 0f, 130f, 1f, 1f, 2f);
	VOLUME::_0xBE551C2CC421185D(iLocal_22, 1);
	VOLUME::_0x5B23DFF8E0948BB2(iLocal_22, 1);
	iLocal_23 = VOLUME::_0x0EB78C2B156635B1(joaat("VOLBOX"), -2184.635f, -2132.268f, 73.87f, 0f, 0f, 130f, 3.2f, 7.3f, 2f);
...
bool func_243(int iParam0, char* sParam1, var uParam2)
{
...
void func_244(var uParam0, int iParam1, var uParam2)
{
	var uVar0;
...
bool func_254(struct<2> Param0, int iParam2)
{
	if (!func_223(Param0))
	{
		return false;
