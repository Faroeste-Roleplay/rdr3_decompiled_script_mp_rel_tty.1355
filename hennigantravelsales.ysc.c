...
bool func_107(int iParam0, int iParam1, float fParam2, char* sParam3)
{
	return func_173(iParam0, "sHash", iParam1, "fHeading", fParam2, "vPos", sParam3);
}

bool func_108(int iParam0, int iParam1, float fParam2, char* sParam3)
{
	return func_173(iParam0, "sClosedHash", iParam1, "fClosedHeading", fParam2, "vClosedPos", sParam3);
}
...
int func_173(int iParam0, char* sParam1, int iParam2, char* sParam3, float fParam4, char* sParam5, char* sParam6)
{
	struct<4> Var0;
	...
	DEBUG::_0x4DC69742196F818A(1747624, 139, "[NET_GET_SHOP_AUTHOR_DATA_WITH_STRING] eShop = ", func_199(iParam0), ", ", sParam5, " = ", MISC::_0x6C4DBF553885F9EB(*sParam6), ", ", sParam3, " = ", *fParam4);
	return 1;
}
...
bool func_257(struct<2> Param0, int iParam2)
{
	if (!func_225(Param0))
	{
		return false;
