...
bool func_13()
{
	iLocal_19 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-2254.051f, -1913.108f, 117.618f, 0f, 0f, -103.235f, 7.714f, 11.713f, 7.583f, "Tall Trees Trapper - m_volTrapper");
	iLocal_20 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-2255.339f, -1911.733f, 116.4466f, 0f, 0f, -13.555f, 2.818f, 2.761f, 4.201f, "Tall Trees Trapper - m_volTrapperPrompt");
	iLocal_21 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-2251.532f, -1915.089f, 117.618f, 0f, 0f, -66.562f, 2.5f, 3f, 4.201f, "Tall Trees Trapper - m_volTrapperOfflimits");
	return true;
}
