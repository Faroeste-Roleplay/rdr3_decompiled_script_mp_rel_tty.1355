...
void func_7()
{
	...
	{
		if (!func_16(976539083))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IMAP_STREAMING_EXTENTS(71064384, Global_34))
			{
				func_17(976539083);
			}
		}
	}
	else if (func_16(976539083))
	{
		if (!STREAMING::_IS_POSITION_INSIDE_IMAP_STREAMING_EXTENTS(71064384, Global_34))
		{
			func_18(976539083);
...
bool func_16(int iParam0)
{
	...
	if (func_22(iVar1))
	{
		if (Global_1072032.f_19652.f_24 && !func_23(iParam0))
		{
			return false;
		}
...
void func_17(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 218, "SET_WORLD_STATE_FLAG: setting world state - ", func_24(iParam0, 0));
	Global_1939807 = 0;
}
...
void func_18(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 218, "CLEAR_WORLD_STATE_FLAG: clearing world state - ", func_24(iParam0, 0));
	Global_1939807 = 0;
}
...
void func_20(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	func_25(bParam0, 0, 0);
	if (func_26(bParam0))
	{
		...
		if (bParam3)
		{
			func_27(bParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
			{
				...
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking Door ID ", func_29(bParam0, 0));
			}
			else
			{
				func_30(bParam0, 1);
				UNK_0x355E72323AEE83CC(183, 9);
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking and making unbreakable Door ID ", func_29(bParam0, 0));
			}
		}
		else
		{
			func_31(bParam0, 1);
			UNK_0x355E72323AEE83CC(183, 9);
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Unlocking Door ID ", func_29(bParam0, 0));
		}
		if (bParam7)
		{
			DEBUG::_0x1B08D1EB9D8C4931(168, 183, "SET_STATE_OF_DOOR_ID - Treating Door ID ", func_29(bParam0, 0), " as shut.");
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 183, "SET_STATE_OF_DOOR_ID: Door with ID not registered by host yet ", func_29(bParam0, 0));
	}
}
...
bool func_25(bool bParam0, bool bParam1, bool bParam2)
{
	if (!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(bParam0))
	{
		if ((NETWORK::NETWORK_IS_IN_SESSION() && SCRIPTS::_DOES_THREAD_EXIST(Global_1051590.f_16[0])) && bParam1)
		{
			...
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add networked Door ", func_29(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
		else
		{
			OBJECT::_ADD_DOOR_TO_SYSTEM_NEW(bParam0, true, false, false, 0, 0, false);
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add Door ", func_29(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
	}
	...
	if (bParam2)
	{
		...
		DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Set door ", func_29(bParam0, 0), " able to change open ratio while locked");
		UNK_0x355E72323AEE83CC(183, 7);
	}
	return bParam0;
}
...
void func_27(bool bParam0, char* sParam1, bool bParam2, bool bParam3)
{
	if (func_26(bParam0))
	{
...
void func_28(bool bParam0, bool bParam1)
{
	if (func_26(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 2 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "LOCK_DOOR_ID - Locking Door ID ", func_29(bParam0, 0));
		}
	}
	else
	{
...
void func_30(bool bParam0, bool bParam1)
{
	if (func_26(bParam0))
	{
		...
		{
			DEBUG::_0x1B08D1EB9D8C4931(2216, 183, "SET_DOOR_ID_LOCKED_AND_UNBREAKABLE - Door ID ", func_29(bParam0, 0), " state = ", OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0), " pending state ", UNK_0x4BC2854478F3A749(bParam0));
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(bParam0, 1);
		}
	}
	else
...
void func_31(bool bParam0, bool bParam1)
{
	if (func_26(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 0 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "UNLOCK_DOOR_ID - Unlocking Door ID ", func_29(bParam0, 0));
		}
	}
	else
	{
