...
void func_1()
{
	...
	DEBUG::_0xF0783374333FD8CE(8, 111, "REGION_TOWN_MOB_CLEANUP start");
...
void func_4()
{
	...
	{
		case 1:
			if (func_10(Global_33, vLocal_62, 1) < 100f)
			{
				bLocal_46 = func_11(0, 2, -156825994, 1, 0, 0f, 0f, 0f);
				switch (iLocal_43)
				{
					case 81:
						bLocal_45 = joaat("A_M_M_VALDEPUTYRESIDENT_01");
						break;
					case 26:
						bLocal_45 = joaat("A_M_M_STRDEPUTYRESIDENT_01");
						break;
					case 111:
						bLocal_45 = joaat("A_M_M_RHDDEPUTYRESIDENT_01");
						break;
					default:
						bLocal_45 = joaat("A_M_M_VALDEPUTYRESIDENT_01");
						break;
			...
			{
				DEBUG::_0x4DC69742196F818A(8, 111, "UPDATE_TOWN_MOB - player is too far from main street");
				iLocal_44 = 6;
			}
			break;
		case 2:
			...
			if ((STREAMING::HAS_MODEL_LOADED(bLocal_46) && STREAMING::HAS_MODEL_LOADED(bLocal_45)) && PED::_0x5E420FF293EE5472())
			{
				iLocal_44 = 4;
			}
			break;
		case 4:
			...
			{
				DEBUG::_0x4DC69742196F818A(8, 111, "UPDATE_TOWN_MOB - player isn't in a good position for the mob to spawn, letting dispatch know!");
				iLocal_44 = 6;
			}
			break;
		case 5:
			...
			while (iVar3 < iLocal_48)
			{
				...
				{
					iVar2++;
					fVar1 = func_10(iLocal_48[iVar3], Global_34, 1);
					if (fVar1 < fVar0)
					{
						fVar0 = fVar1;
					}
...
int func_7(int iParam0)
{
	...
	return Global_1887351[iParam0 /*36*/].f_4;
}
...
Vector3 func_8(int iParam0, bool bParam1)
{
	...
	{
		vVar0 = { VOLUME::_GET_VOLUME_COORDS(Global_1887351[iParam0 /*36*/].f_4) };
		if (bParam1)
		{
...
{
	DEBUG::_0xF0783374333FD8CE(8, 0, "GET_RANDOM_MODEL_FROM_LOCAL_POPULATION CALLED!");
	if (!func_19(iParam0))
	{
		DEBUG::_0xF0783374333FD8CE(8, 0, "GET_RANDOM_MODEL_FROM_LOCAL_POPULATION - The ePopSetType value is NOT valid!!!");
		return 0;
	}
	if (func_20(iParam0) == -1)
	{
		DEBUG::_0xF0783374333FD8CE(8, 0, "GET_RANDOM_MODEL_FROM_LOCAL_POPULATION - The ePopSetType value provided maps to an invalid AMBIENT_PED_MODEL_SET!!!");
		return 0;
	}
...
bool func_12()
{
	...
	if (!func_21(iLocal_43, &vLocal_65, bLocal_45))
	{
		DEBUG::_0x4DC69742196F818A(8, 111, "INIT_TOWN_MOB_SPAWN_POSITION - No spawn point defined for town mob!");
		return false;
	}
	fVar0 = BUILTIN::VDIST2(Global_34, vLocal_65);
	if (fVar0 > 10000f)
	{
		DEBUG::_0x4DC69742196F818A(8, 111, "INIT_TOWN_MOB_SPAWN_POSITION - Best spawn point for town mob is too far away!");
		return false;
	}
	if (fVar0 < 1225f)
	{
		DEBUG::_0x4DC69742196F818A(8, 111, "INIT_TOWN_MOB_SPAWN_POSITION - Best spawn point for town mob is too close!");
		return false;
	}
	if (CAM::IS_SPHERE_VISIBLE(vLocal_65, 2f) || !ENTITY::WOULD_ENTITY_BE_OCCLUDED(bLocal_45, vLocal_65, true))
	{
		DEBUG::_0x4DC69742196F818A(8, 111, "INIT_TOWN_MOB_SPAWN_POSITION - Best spawn point for town mob is not occluded!");
		return false;
	}
	iLocal_68 = VOLUME::_CREATE_VOLUME_CYLINDER(vLocal_65, 0f, 0f, 0f, 3f, 3f, 3f);
	func_22(iLocal_68, 0, 0, 0, 0, 0);
	func_23(iLocal_68, 0);
	DEBUG::_0xF0783374333FD8CE(56, 111, "Found a point at ", &vLocal_65);
	return true;
}
...
void func_13()
{
	...
	while (iVar0 < iLocal_48)
	{
		DEBUG::_0x4DC69742196F818A(8, 111, "SPAWN_TOWN_MOB_MOB_PEDS - creating a new MOB member...");
		vVar1 = { func_24(vLocal_65, 3f, 1f) };
		if (iVar0 == 0)
		{
			iLocal_48[iVar0] = func_25(bLocal_45, vVar1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 180f), 1, 1, 0, 1, 1, 1, 0, 0);
		...
		{
			iLocal_48[iVar0] = func_25(bLocal_46, vVar1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 180f), 1, 1, 0, 1, 1, 1, 0, 0);
			if (func_5(iLocal_48[iVar0], 0))
			{
		...
		if (func_5(iLocal_48[iVar0], 0))
		{
			...
			PED::REGISTER_TARGET(iLocal_48[iVar0], Global_33, 1);
...
void func_16(int iParam0)
{
	...
	TASK::TASK_SMART_FLEE_PED(iParam0, Global_33, 500f, -1, false, 3f, 0);
	func_30(iParam0);
...
int func_20(int iParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(8, 0, "GET_LOCAL_POPULATION_MODEL_SET CALLED!");
	if (!func_19(iParam0))
	{
		DEBUG::_0xF0783374333FD8CE(8, 0, "SET_LOCAL_POPULATION_VALUE - The ePopSetType value is NOT valid!!!");
		return -1;
	}
	iVar0 = func_32(func_31());
	if (iVar0 != 1 && iVar0 != 2)
	{
		return Global_1900760[iParam0];
	}
	return Global_1900743[iParam0];
}

bool func_21(int iParam0, var uParam1, bool bParam2)
{
	vector3 vVar0[4];
	bool bVar13;
	float fVar14;
	...
	switch (iParam0)
	{
		...
		case 111:
			...
			break;
		default:
			DEBUG::_0x9A6C65DDDBEC9C52(8, 111, "GET_OCCLUDED_TOWN_MOB_SPAWN_FOR_REGION - region does not have a law spawn position defined");
...
int func_25(bool bParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12)
{
	int iVar0;
	...
	func_34(iVar0, bParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
void func_30(int iParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		DEBUG::_0xF0783374333FD8CE(8, 0, "REMOVE_BLIP_FROM_ENTITY: entity doesn't exist");
		return;
	}
...
int func_32(int iParam0)
{
	...
	return Global_1887351[iParam0 /*36*/].f_21;
}
...
void func_34(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
{
	DEBUG::_0xA308F935BDECCEC0(648, 28, "HORSE_SET_GENDER - pedHorse: ", sParam0, " eGender = ", func_42(iParam1, 0));
	if (iParam1 == 1)
	{
