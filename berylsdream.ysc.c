...
bool func_40(int iParam0)
{
	...
	switch (iLocal_14)
	{
		case 0:
			...
			{
				DEBUG::_0xF0783374333FD8CE(8, 11, "Beryl's Dream: Going to state: BERYLS_DREAM_STATE_CREATE_PROP");
				iLocal_14 = 1;
			}
			break;
		case 1:
			if (func_62())
			{
				DEBUG::_0xF0783374333FD8CE(8, 11, "Beryl's Dream: Going to state: BERYLS_DREAM_STATE_FINISHED");
				iLocal_14 = 2;
			}
			break;
		case 2:
...
bool func_62()
{
	...
	{
		DEBUG::_0xF0783374333FD8CE(8, 11, "Creating the Detonator prop...");
		iLocal_13 = OBJECT::CREATE_OBJECT(func_53(), func_94(), false, false, false, false, true);
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_13))
		{
			DEBUG::_0xF0783374333FD8CE(8, 11, "The Detonator prop was created successfully...");
			ENTITY::SET_ENTITY_COORDS(iLocal_13, func_94(), true, false, true, true);
			ENTITY::SET_ENTITY_ROTATION(iLocal_13, func_95(), 2, true);
		}
		else
		{
			DEBUG::_0xF0783374333FD8CE(8, 11, "The Detonator prop is NOT valid!!!");
			return false;
		}
	}
	else
	{
		DEBUG::_0xF0783374333FD8CE(8, 11, "The Detonator prop was already created!!! ");
	}
	return true;
}
...
{
	iParam0 = iParam0;
	DEBUG::_0xF0783374333FD8CE(8, 11, "Beryl's Dream: Cleaning up region!");
