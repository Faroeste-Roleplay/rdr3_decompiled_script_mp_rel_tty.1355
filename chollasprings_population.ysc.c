...
void func_6()
{
	...
	{
		if (!PERSCHAR::_0xEB98B38CA60742D7(iVar3) && func_14(-154581735))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IMAP_STREAMING_EXTENTS(-262371610, Global_34))
			{
				func_15(-154581735);
			}
		}
	...
	{
		if (!PERSCHAR::_0xEB98B38CA60742D7(iVar2) && func_14(-154581735))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IMAP_STREAMING_EXTENTS(-262371610, Global_34))
			{
				func_15(-154581735);
	...
	{
		if (!PERSCHAR::_0xEB98B38CA60742D7(iVar1) && func_14(-154581735))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IMAP_STREAMING_EXTENTS(-262371610, Global_34))
			{
				func_15(-154581735);
	...
	{
		if (!PERSCHAR::_0xEB98B38CA60742D7(iVar0) && func_14(-154581735))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IMAP_STREAMING_EXTENTS(-262371610, Global_34))
			{
				func_15(-154581735);
		...
		else if (PERSCHAR::_0xEB98B38CA60742D7(iVar0) && !func_14(-154581735))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IMAP_STREAMING_EXTENTS(-262371610, Global_34))
			{
				func_16(-154581735);
...
bool func_14(int iParam0)
{
	...
	if (func_19(iVar1))
	{
		if (Global_1072032.f_19652.f_24 && !func_20(iParam0))
		{
			return false;
		}
...
void func_15(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 218, "CLEAR_WORLD_STATE_FLAG: clearing world state - ", func_21(iParam0, 0));
	Global_1939807 = 0;
}
...
void func_16(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 218, "SET_WORLD_STATE_FLAG: setting world state - ", func_21(iParam0, 0));
	Global_1939807 = 0;
}
...
int func_24(bool bParam0)
{
	...
	if (func_26())
	{
		DEBUG::_0x9A6C65DDDBEC9C52(168, 0, "REMOVE_IPL_HASH_SAFE - Could not remove ", func_27(bParam0, 0), " b/c player is in the respawn sequence.");
		return 0;
	}
