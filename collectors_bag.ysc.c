void __EntryFunction__()
{
	...
	if (!UIAPPS::_IS_APP_ACTIVE_BY_HASH(joaat("COLLECTORS")))
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 224, "LAUNCH_UIAPP_BY_HASH: eLaunchResult - ", func_2(iVar0, 0));
		if (iVar0 != 0)
		{
			DEBUG::_0x83407B92D46F25C3(8, 224, "Unable to launch the UIApp");
			func_1();
		}
	}
	else
	{
		DEBUG::_0x9A6C65DDDBEC9C52(8, 224, "Collectors bag UIApp is already running!?");
	}
	while (!func_3())
	{
		BUILTIN::WAIT(0);
...
void func_1()
{
	DEBUG::_0xF0783374333FD8CE(8, 224, "COLLECTORS_BAG_ON_CLOSE");
...
bool func_3()
{
	if (func_4(1, 1))
	{
		DEBUG::_0xF0783374333FD8CE(8, 224, "COLLECTORS_BAG_SHOULD_THREAD_END - terminating satchel due to KILL_EVENT_CAUGHT");
		return true;
	}
	if (SCRIPTS::_0x9E4EF615E307FBBE())
	{
		DEBUG::_0xF0783374333FD8CE(8, 224, "COLLECTORS_BAG_SHOULD_THREAD_END: thread exit requested");
		return true;
	}
	if (!UIAPPS::_IS_APP_ACTIVE_BY_HASH(joaat("COLLECTORS")))
	{
		DEBUG::_0xF0783374333FD8CE(8, 224, "COLLECTORS_BAG_SHOULD_THREAD_END: UIApp is no longer runnning");
		return true;
	}
	return false;
}
