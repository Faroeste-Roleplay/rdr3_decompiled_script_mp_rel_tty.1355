...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_34, 0f, 0f, 0f) <= 5f || func_65(Global_1940410, 32768)) || func_65(Global_1940410, 16777216))
	{
		return;
	}
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_28)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_78(iLocal_28));
...
bool func_49(bool bParam0, bool bParam1)
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		{
			DEBUG::_0xF0783374333FD8CE(168, 8, "KILL_EVENT_CAUGHT - NETWORK_IS_GAME_IN_PROGRESS() = FALSE - but bIgnoreTransition = TRUE and g_mpTransition.eMPState = ", func_87(Global_1572887, 0), ", so skipping");
		}
		else
		{
...
int func_53(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (!func_62(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Region index not valid ", func_89(iParam0));
		return 1;
	}
	if (func_88(iParam0, 16))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: RF_PERS_DISABLED is on for ", func_89(iParam0));
		return 1;
	}
	if (func_90(iParam0) && !func_91(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: IS_REGION_IN_LOCKDOWN is on for ", func_89(iParam0));
	}
	DEBUG::_0xF0783374333FD8CE(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Starting for ", func_89(iParam0));
	if (func_92(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if ((!func_90(iParam0) || func_91(iParam0)) || func_94(Global_1896632))
			{
				func_95(Global_1896632, 0);
			}
			Global_1896632++;
			iVar2++;
...
int func_58(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == 0)
	{
		DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_97(iParam0), " IS INVALID.");
		return 0;
	}
	DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_97(iParam0), " IS VALID.");
...
void func_64()
{
	...
	if (PERSCHAR::_0x800DF3FC913355F3(iVar0))
	{
		if (!PERSCHAR::_0xEB98B38CA60742D7(iVar0) && TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-1625875143))
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(8, 17, "Blacksmith exists. Set bed to be unusable.");
			return;
		}
	}
	if (PERSCHAR::_0x800DF3FC913355F3(iVar1))
	{
		...
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(-1625875143, false);
			DEBUG::_0x1B08D1EB9D8C4931(8, 17, "Rancher exists. Set bed to be unusable.");
			return;
		}
	}
	if (PERSCHAR::_0x800DF3FC913355F3(iVar2))
	{
		...
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(-1625875143, false);
			DEBUG::_0x1B08D1EB9D8C4931(8, 17, "Ranch hand exists. Set bed to be unusable.");
			return;
		}
	}
	if (PERSCHAR::_0x800DF3FC913355F3(iVar3))
	{
		...
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(-1625875143, false);
			DEBUG::_0x1B08D1EB9D8C4931(8, 17, "Ranch hand two exists. Set bed to be unusable.");
			return;
		}
	}
	if (PERSCHAR::_0x800DF3FC913355F3(iVar4))
	{
		...
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(-1625875143, false);
			DEBUG::_0x1B08D1EB9D8C4931(8, 17, "Ranch hand three exists. Set bed to be unusable.");
			return;
		}
	}
	if (PERSCHAR::_0x800DF3FC913355F3(iVar5))
	{
		...
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(-1625875143, false);
			DEBUG::_0x1B08D1EB9D8C4931(8, 17, "Ranch hand four exists. Set bed to be unusable.");
		}
		else if (PERSCHAR::_0xEB98B38CA60742D7(iVar5) && !TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-1625875143))
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(8, 17, "All peds are invalid or dead. Set bed to be usable.");
		}
	}
}
...
bool func_67()
{
	return func_65(Global_1940410, 8192);
}
...
bool func_69(int iParam0)
{
	...
	return ((Global_1887351[iParam0 /*36*/].f_21 == 1 || Global_1887351[iParam0 /*36*/].f_21 == 2) && !func_100(iParam0));
}
...
void func_72(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	char* sVar1;
	char* sVar2;
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_102(iParam0, 0), " ", func_103(iParam1, 0), " ", func_104(bParam2, 0), " state ", func_105(iParam4, 0));
	UNK_0x355E72323AEE83CC(11, 6);
	sVar1 = func_106(iParam0, iParam1, bParam2, iParam4, bParam5, bParam3, &bVar0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_102(iParam0, 0), " or ", func_103(iParam1, 0), " or ", func_104(bParam2, 0));
	...
	if (bVar0 && bParam3)
	{
		sVar2 = func_111(func_110(bParam2));
	}
	else if ((func_112(iParam1, 2) || func_113(iParam4, 2)) && !Global_1893599.f_9)
	{
	...
	else if ((func_62(iParam0) && func_88(iParam0, 16777216)) && !Global_1893599.f_9)
	{
	...
	Global_1939313.f_145 = func_119(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
bool func_85(int iParam0, bool bParam1)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 138, "DELETE_ALL_REGIONAL_CHARACTERS starting for Region ", func_89(iParam0));
	if (func_92(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_127(Global_1896632.f_1, 16))
			{
				func_128(Global_1896632.f_1, 0);
			}
			Global_1896632.f_1++;
			iVar2++;
...
bool func_86(int iParam0)
{
	...
	while (iVar0 < 40)
	{
		if (func_129(iVar0) || func_130(iVar0))
		{
		}
		else
		{
	...
	switch (iParam0)
	{
		...
		case 139:
			...
			*iParam2 = 851;
			...
			break;
		default:
			DEBUG::_0xA308F935BDECCEC0(40, 138, "Attempting to get regional character bounds for a region that doesn't have them yet ", func_78(iParam0));
			*iParam1 = -1;
			*iParam2 = -1;
			break;
	}
...
int func_95(int iParam0, bool bParam1)
{
	if (!func_93(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_97(iParam0), " is invalid");
		return 0;
	}
	if (!func_127(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_97(iParam0), " has not been initialized");
		return 0;
	}
	if (func_127(iParam0, 32) && !bParam1)
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_97(iParam0), " has been locked dead");
		...
		if (func_45() == -1)
		{
			if (func_127(iParam0, 2048))
			{
				...
				DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_97(iParam0), " has been revived!");
			}
	...
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_97(iParam0), " dead or not spawning, turn scenario groups off");
		return 0;
	}
	if (PERSCHAR::_0x800DF3FC913355F3(func_59(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Persistent character ", func_97(iParam0), " already exists");
		func_136(iParam0, 128);
		return 1;
	}
	func_135(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_134(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_59(iParam0));
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_97(iParam0), " perschar index created!");
	if (func_127(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_59(iParam0));
		func_136(iParam0, 2048);
	...
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_97(iParam0), " created.");
...
bool func_96(int iParam0, bool bParam1)
{
	...
	if (!PERSCHAR::_0x800DF3FC913355F3(func_59(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - Checking if ", func_97(iParam0), " is alive when the perschar index is not created.");
		return false;
	}
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_138(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_97(iParam0), " does not have a ped spawned.");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(2216, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_97(iParam0), " being processed - ALIVE = ", !PERSCHAR::_0xEB98B38CA60742D7(func_59(iParam0)), "!");
...
{
	if ((iParam0 == 22 || iParam0 == 39) && !func_140())
	{
		return true;
	}
	if (iParam0 == 66)
...
var func_104(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case joaat("RIOBRAVO"):
...
char* func_106(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893599.f_162)))
	{
		sVar0 = func_143(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_145(func_144(Global_34));
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		if (!func_146(iParam0) || func_147(44))
		{
			switch (iParam0)
			{
				case 2:
...
int func_109(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_148(PLAYER::PLAYER_ID()) };
...
char* func_118(char* sParam0, int iParam1)
{
	...
	return func_149(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
void func_121(var uParam0, int iParam1)
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_150(iParam1, 0));
}
...
{
	DEBUG::_0x4DC69742196F818A(40, 195, "CLEAR_SALOON: Clearing ", func_151(iParam0));
	func_152(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_153(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
	...
	func_154(iParam0, 8192);
	func_154(iParam0, 32768);
	func_154(iParam0, 524288);
	func_154(iParam0, 1048576);
...
void func_126(int iParam0)
{
	...
	if (func_93(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_155(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_156(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_157(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_158(iParam0, 536870912);
	iVar1 = func_159(iParam0);
	if (iVar1 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(2216, 139, "[SHOP_UNLOCK_DOORS] Shop: ", func_160(iParam0, 0), " door count is greater then the. Current door count: ", iVar1, " Max door count: ", 15);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_161(Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
	...
	DEBUG::_0xF0783374333FD8CE(168, 139, "[CLEAR_SHOP] Shop: ", func_160(iParam0, 0), " has been cleared!");
}
...
int func_128(int iParam0, bool bParam1)
{
	if (!func_93(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_97(iParam0), " is invalid");
		return 0;
	}
	if (!func_127(iParam0, 2))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_97(iParam0), " has not been initialized");
		return 0;
	}
	if (func_134(iParam0) == 0)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_97(iParam0), " doesn't exist");
		return 1;
	}
	if (!PERSCHAR::_0x800DF3FC913355F3(func_59(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_97(iParam0), " already destroyed");
		return 1;
	}
	if (func_127(iParam0, 1) && !bParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_97(iParam0), " is stolen, so it will be destoyed on release.");
		func_163(iParam0, 128);
		return 1;
	}
	func_136(iParam0, 129);
	func_164(iParam0);
	DEBUG::_0xA308F935BDECCEC0(40, 138, "DESTROY_REGIONAL_CHARACTER: Destroying ", func_97(iParam0));
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_59(iParam0));
	func_135(iParam0, 0);
	DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: ", func_97(iParam0), " destroyed.");
	return 1;
}
...
void func_131()
{
	...
	while (iVar0 <= 3)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ NET_CLEAR_BARTENDERS - Removed ", func_169(Global_1051777.f_3642[iVar0 /*19*/]));
...
void func_133(int iParam0, bool bParam1)
{
	...
	DEBUG::_0x4DC69742196F818A(40, 139, "NET_CLEAR_SHOP ", func_160(iParam0, 0));
	bVar0 = (func_170(iParam0) && !bParam1);
	if (!bVar0 && !func_171(iParam0, 65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] - Shop keeper deleted for shop: ", func_172(iParam0));
		}
	...
	else if (func_173(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
	{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] Remove the script created scenario for: ", func_172(iParam0));
	...
	if (iVar3 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "[NET_CLEAR_SHOP] - Shop: ", func_160(iParam0, 0), " current door count exceeds max door count.");
		Global_1915867.f_3[iParam0 /*447*/].f_409 = 0;
	}
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_161(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar2]);
	...
	func_176(iParam0);
	if (func_171(iParam0, 262144))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 139, "NET_CLEAR_SHOP: SPF_ALLOW_BLIP_OUT_OF_REGION for ", func_172(iParam0), " is kept; all other flags cleared.");
	...
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_CLEAR_SHOP] Removing relationship volume from shop ", func_160(iParam0, 0));
...
void func_136(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_178(iParam1), " on ", func_97(iParam0));
}
...
bool func_137(int iParam0)
{
	...
	if (!func_127(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_97(iParam0), " has not been initialized");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(40, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_97(iParam0));
	return true;
}
...
bool func_142(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_181(func_56(0)))
	{
		return true;
	}
...
void func_154(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 195, "CLEAR_SALOON_CONFIG_FLAG: Clearing flag for ", func_186(iParam1, 0));
	func_187(&(Global_1940170.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_156(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that isnt stolen ", func_97(iParam0));
		return;
	}
	if (!func_127(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release an uninitialized regional character ", func_97(iParam0));
		return;
	}
	if ((!bParam4 && !func_155(iParam0)) && func_188(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that is stolen by a differnt script ", func_97(iParam0));
		return;
	}
	DEBUG::_0xF0783374333FD8CE(680, 138, "RELEASE_REGIONAL_CHARACTER: Regional character ", func_97(iParam0), " released by ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
	func_136(iParam0, 1);
	func_164(iParam0);
	if (func_189(func_134(iParam0)))
	{
		iVar0 = func_59(iParam0);
		if (!PERSCHAR::_0x800DF3FC913355F3(iVar0))
		{
			DEBUG::_0x9A6C65DDDBEC9C52(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character with no perschar index", func_97(iParam0));
			return;
		}
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being retasked ", func_97(iParam0));
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being destroyed on release ", func_97(iParam0));
		func_128(iParam0, 0);
	}
}
...
{
	if (func_196(bParam0) && func_197())
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 183, "RELEASE_DOOR_ID - Releasing Door ID ", func_198(bParam0, 0));
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 139, "CLEAR_ALL_SHOP_TYPE_FLAGS: ", func_172(iParam0));
...
void func_163(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_178(iParam1), " on ", func_97(iParam0));
}
...
void func_164(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar0, false))
		{
			...
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_97(iParam0), " set as no longer needed.");
		}
		else
		{
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_97(iParam0), " was asked to be set as no longer needed, but this script does not own the ped.");
		}
	}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_FLAGS] ", func_172(iParam0));
	Global_1051777.f_80[iParam0 /*75*/].f_49 = 0;
}

void func_166(int iParam0)
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_SUPPORT_FLAGS] ", func_172(iParam0));
...
void func_174(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_172(iParam0), " flag ", func_200(iParam1));
	}
	Global_1051777.f_80[iParam0 /*75*/].f_1 = (Global_1051777.f_80[iParam0 /*75*/].f_1 - (Global_1051777.f_80[iParam0 /*75*/].f_1 && iParam1));
}
...
{
	return func_201(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}
...
bool func_179()
{
	...
	if (!func_181(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
var func_198(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
int func_206(int iParam0)
{
	...
	DEBUG::_0xD9911C7B5F8CD69C(168, 139, "GET_SHOP_TYPE_FROM_SHOP - ", func_199(iParam0, 0), " undefined");
	return -1;
}
