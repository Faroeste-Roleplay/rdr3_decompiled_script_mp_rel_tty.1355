...
bool func_13()
{
	iLocal_13 = Global_1887351[131 /*36*/].f_5;
...
int func_58(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == 0)
	{
		DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_95(iParam0), " IS INVALID.");
		return 0;
	}
	DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_95(iParam0), " IS VALID.");
...
bool func_66(int iParam0)
{
	...
	return ((Global_1887351[iParam0 /*36*/].f_21 == 1 || Global_1887351[iParam0 /*36*/].f_21 == 2) && !func_98(iParam0));
}
...
void func_69(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_100(iParam0, 0), " ", func_101(iParam1, 0), " ", func_102(bParam2, 0), " state ", func_103(iParam4, 0));
	UNK_0x355E72323AEE83CC(11, 6);
	sVar1 = func_104(iParam0, iParam1, bParam2, iParam4, bParam5, bParam3, &bVar0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_100(iParam0, 0), " or ", func_101(iParam1, 0), " or ", func_102(bParam2, 0));
	...
	if (!func_105(iParam4))
	{
		if (func_60(iParam0))
		{
			iParam4 = func_106(func_9(iParam0));
		}
		else
		{
	...
	if (bVar0 && bParam3)
	{
		sVar2 = func_109(func_108(bParam2));
	}
	else if ((func_110(iParam1, 2) || func_111(iParam4, 2)) && !Global_1893599.f_9)
	{
	...
	Global_1939313.f_145 = func_117(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
bool func_82(int iParam0, bool bParam1)
{
	...
	if (func_89(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_124(Global_1896632.f_1, 16))
			{
				func_125(Global_1896632.f_1, 0);
			}
			Global_1896632.f_1++;
			iVar2++;
...
int func_92(int iParam0, bool bParam1)
{
	if (!func_90(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_95(iParam0), " is invalid");
		return 0;
	}
	if (!func_124(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_95(iParam0), " has not been initialized");
		return 0;
	}
	if (func_124(iParam0, 32) && !bParam1)
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_95(iParam0), " has been locked dead");
		func_132(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_131(iParam0)));
		if (func_45() == -1)
		{
			if (func_124(iParam0, 2048))
			{
				PERSCHAR::_0x49A8C2CD97815215(func_94(iParam0));
				func_133(iParam0, 2048);
				DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_95(iParam0), " has been revived!");
			}
			PERSCHAR::_0xFCC6DB8DBE709BC8(func_94(iParam0));
		}
		return 0;
	}
	if (!func_134(iParam0) && func_45() == -1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_95(iParam0), " dead or not spawning, turn scenario groups off");
		return 0;
	}
	if (PERSCHAR::_0x800DF3FC913355F3(func_94(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Persistent character ", func_95(iParam0), " already exists");
		func_133(iParam0, 128);
		return 1;
	}
	func_132(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_131(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_94(iParam0));
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_95(iParam0), " perschar index created!");
	if (func_124(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_94(iParam0));
		func_133(iParam0, 2048);
	...
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_95(iParam0), " created.");
...
bool func_93(int iParam0, bool bParam1)
{
	...
	if (!PERSCHAR::_0x800DF3FC913355F3(func_94(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - Checking if ", func_95(iParam0), " is alive when the perschar index is not created.");
		return false;
	}
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_135(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_95(iParam0), " does not have a ped spawned.");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(2216, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_95(iParam0), " being processed - ALIVE = ", !PERSCHAR::_0xEB98B38CA60742D7(func_94(iParam0)), "!");
	return !PERSCHAR::_0xEB98B38CA60742D7(func_94(iParam0));
}
...
char* func_104(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;
...
int func_125(int iParam0, bool bParam1)
{
	if (!func_90(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_95(iParam0), " is invalid");
		return 0;
	}
	if (!func_124(iParam0, 2))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_95(iParam0), " has not been initialized");
		return 0;
	}
	if (func_131(iParam0) == 0)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_95(iParam0), " doesn't exist");
		return 1;
	}
	if (!PERSCHAR::_0x800DF3FC913355F3(func_94(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_95(iParam0), " already destroyed");
		return 1;
	}
	if (func_124(iParam0, 1) && !bParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_95(iParam0), " is stolen, so it will be destoyed on release.");
		func_160(iParam0, 128);
		return 1;
	}
	func_133(iParam0, 129);
	func_161(iParam0);
	DEBUG::_0xA308F935BDECCEC0(40, 138, "DESTROY_REGIONAL_CHARACTER: Destroying ", func_95(iParam0));
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_94(iParam0));
	func_132(iParam0, 0);
	DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: ", func_95(iParam0), " destroyed.");
	return 1;
}
...
void func_133(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_175(iParam1), " on ", func_95(iParam0));
}
...
bool func_134(int iParam0)
{
	...
	if (!func_124(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_95(iParam0), " has not been initialized");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(40, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_95(iParam0));
	return true;
}
...
bool func_139(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_178(func_56(0)))
	{
		return true;
	}
...
void func_151(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 195, "CLEAR_SALOON_CONFIG_FLAG: Clearing flag for ", func_183(iParam1, 0));
	func_184(&(Global_1940170.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_153(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that isnt stolen ", func_95(iParam0));
		return;
	}
	if (!func_124(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release an uninitialized regional character ", func_95(iParam0));
		return;
	}
	if ((!bParam4 && !func_152(iParam0)) && func_185(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that is stolen by a differnt script ", func_95(iParam0));
		return;
	}
	DEBUG::_0xF0783374333FD8CE(680, 138, "RELEASE_REGIONAL_CHARACTER: Regional character ", func_95(iParam0), " released by ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
	func_133(iParam0, 1);
	func_161(iParam0);
	if (func_186(func_131(iParam0)))
	{
		iVar0 = func_94(iParam0);
		if (!PERSCHAR::_0x800DF3FC913355F3(iVar0))
		{
			DEBUG::_0x9A6C65DDDBEC9C52(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character with no perschar index", func_95(iParam0));
			return;
		}
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being retasked ", func_95(iParam0));
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being destroyed on release ", func_95(iParam0));
		func_125(iParam0, 0);
	}
}
...
{
	if (func_193(bParam0) && func_194())
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 183, "RELEASE_DOOR_ID - Releasing Door ID ", func_195(bParam0, 0));
...
void func_160(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_175(iParam1), " on ", func_95(iParam0));
}
...
void func_161(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar0, false))
		{
			...
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_95(iParam0), " set as no longer needed.");
		}
		else
		{
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_95(iParam0), " was asked to be set as no longer needed, but this script does not own the ped.");
		}
	}
...
void func_171(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_169(iParam0), " flag ", func_197(iParam1));
	}
	Global_1051777.f_80[iParam0 /*75*/].f_1 = (Global_1051777.f_80[iParam0 /*75*/].f_1 - (Global_1051777.f_80[iParam0 /*75*/].f_1 && iParam1));
}
...
bool func_176()
{
	...
	if (!func_178(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
