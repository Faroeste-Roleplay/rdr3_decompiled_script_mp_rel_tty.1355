...
bool func_13()
{
	iLocal_16 = Global_1887351[37 /*36*/].f_5;
...
bool func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_25)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_77(iLocal_25));
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_78(iLocal_25, 0), 1);
					break;
			}
		}
		if (func_10(func_70()))
	...
	else
	{
		...
		if (func_45() == -1)
		{
			func_82(iLocal_25);
			func_83(iLocal_25);
			if (!func_84(iLocal_25, 0))
			{
				return false;
			}
		}
		else if (!func_85(iLocal_25))
		{
			return false;
		}
	}
...
void func_71(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_60(iParam0) && func_87(iParam0, 16777216)) && !Global_1893599.f_9)
	{
...
void func_98(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	func_138(bParam0, 0, 0);
	if (func_139(bParam0))
	{
		...
		if (bParam3)
		{
			func_140(bParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
			{
				...
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking Door ID ", func_142(bParam0, 0));
			}
			else
			{
				func_143(bParam0, 1);
				UNK_0x355E72323AEE83CC(183, 9);
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking and making unbreakable Door ID ", func_142(bParam0, 0));
			}
		}
		else
		{
			func_144(bParam0, 1);
			UNK_0x355E72323AEE83CC(183, 9);
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Unlocking Door ID ", func_142(bParam0, 0));
		}
		if (bParam7)
		{
			DEBUG::_0x1B08D1EB9D8C4931(168, 183, "SET_STATE_OF_DOOR_ID - Treating Door ID ", func_142(bParam0, 0), " as shut.");
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 183, "SET_STATE_OF_DOOR_ID: Door with ID not registered by host yet ", func_142(bParam0, 0));
	}
}

bool func_99(int iParam0)
{
	if ((iParam0 == 22 || iParam0 == 39) && !func_146())
	{
		return true;
	}
	if (iParam0 == 66)
...
char* func_105(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_149(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_151(func_150(Global_34));
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		if (!func_152(iParam0) || func_153(44))
		{
			switch (iParam0)
			{
				case 2:
...
int func_108(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_154(PLAYER::PLAYER_ID()) };
...
void func_120(var uParam0, int iParam1)
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_156(iParam1, 0));
}
...
{
	DEBUG::_0x4DC69742196F818A(40, 195, "CLEAR_SALOON: Clearing ", func_157(iParam0));
	func_158(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_159(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
...
void func_124(int iParam0)
{
	...
	if (func_92(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_161(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_162(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_163(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_164(iParam0, 536870912);
	iVar1 = func_165(iParam0);
	if (iVar1 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(2216, 139, "[SHOP_UNLOCK_DOORS] Shop: ", func_166(iParam0, 0), " door count is greater then the. Current door count: ", iVar1, " Max door count: ", 15);
	...
	DEBUG::_0xF0783374333FD8CE(168, 139, "[CLEAR_SHOP] Shop: ", func_166(iParam0, 0), " has been cleared!");
}
...
void func_129()
{
	...
	while (iVar0 <= 3)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ NET_CLEAR_BARTENDERS - Removed ", func_175(Global_1051777.f_3642[iVar0 /*19*/]));
...
void func_131(int iParam0, bool bParam1)
{
	...
	DEBUG::_0x4DC69742196F818A(40, 139, "NET_CLEAR_SHOP ", func_166(iParam0, 0));
	bVar0 = (func_176(iParam0) && !bParam1);
	if (!bVar0 && !func_177(iParam0, 65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] - Shop keeper deleted for shop: ", func_178(iParam0));
		}
	...
	else if (func_179(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
	{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] Remove the script created scenario for: ", func_178(iParam0));
	...
	if (iVar3 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "[NET_CLEAR_SHOP] - Shop: ", func_166(iParam0, 0), " current door count exceeds max door count.");
		Global_1915867.f_3[iParam0 /*447*/].f_409 = 0;
	}
	else
	{
	...
	func_182(iParam0);
	if (func_177(iParam0, 262144))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 139, "NET_CLEAR_SHOP: SPF_ALLOW_BLIP_OUT_OF_REGION for ", func_178(iParam0), " is kept; all other flags cleared.");
	...
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_CLEAR_SHOP] Removing relationship volume from shop ", func_166(iParam0, 0));
...
void func_136(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_185(iParam1), " on ", func_132(iParam0));
}
...
bool func_138(bool bParam0, bool bParam1, bool bParam2)
{
	if (!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(bParam0))
	{
		if ((NETWORK::NETWORK_IS_IN_SESSION() && SCRIPTS::_DOES_THREAD_EXIST(Global_1051590.f_16[0])) && bParam1)
		{
			...
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add networked Door ", func_142(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
		else
		{
			OBJECT::_ADD_DOOR_TO_SYSTEM_NEW(bParam0, true, false, false, 0, 0, false);
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add Door ", func_142(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
	}
	...
	if (bParam2)
	{
		...
		DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Set door ", func_142(bParam0, 0), " able to change open ratio while locked");
		UNK_0x355E72323AEE83CC(183, 7);
	}
	return bParam0;
}
...
void func_140(bool bParam0, char* sParam1, bool bParam2, bool bParam3)
{
	if (func_139(bParam0))
	{
...
void func_141(bool bParam0, bool bParam1)
{
	if (func_139(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 2 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "LOCK_DOOR_ID - Locking Door ID ", func_142(bParam0, 0));
		}
	}
	else
	{
...
var func_142(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
void func_143(bool bParam0, bool bParam1)
{
	if (func_139(bParam0))
	{
		...
		{
			DEBUG::_0x1B08D1EB9D8C4931(2216, 183, "SET_DOOR_ID_LOCKED_AND_UNBREAKABLE - Door ID ", func_142(bParam0, 0), " state = ", OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0), " pending state ", UNK_0x4BC2854478F3A749(bParam0));
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(bParam0, 1);
		}
	}
	else
...
void func_144(bool bParam0, bool bParam1)
{
	if (func_139(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 0 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "UNLOCK_DOOR_ID - Unlocking Door ID ", func_142(bParam0, 0));
		}
	}
	else
	{
...
bool func_148(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_189(func_56(0)))
	{
		return true;
	}
...
void func_160(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 195, "CLEAR_SALOON_CONFIG_FLAG: Clearing flag for ", func_194(iParam1, 0));
	func_195(&(Global_1940170.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_162(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if ((!bParam4 && !func_161(iParam0)) && func_196(iParam0))
	{
...
{
	if (func_139(bParam0) && func_204())
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 183, "RELEASE_DOOR_ID - Releasing Door ID ", func_142(bParam0, 0));
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 139, "CLEAR_ALL_SHOP_TYPE_FLAGS: ", func_178(iParam0));
...
void func_169(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_185(iParam1), " on ", func_132(iParam0));
}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_FLAGS] ", func_178(iParam0));
	Global_1051777.f_80[iParam0 /*75*/].f_49 = 0;
}

void func_172(int iParam0)
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_SUPPORT_FLAGS] ", func_178(iParam0));
...
void func_180(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_178(iParam0), " flag ", func_207(iParam1));
	}
	Global_1051777.f_80[iParam0 /*75*/].f_1 = (Global_1051777.f_80[iParam0 /*75*/].f_1 - (Global_1051777.f_80[iParam0 /*75*/].f_1 && iParam1));
}
...
{
	return func_208(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}
...
bool func_187()
{
	...
	if (!func_189(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
int func_213(int iParam0)
{
	...
	DEBUG::_0xD9911C7B5F8CD69C(168, 139, "GET_SHOP_TYPE_FROM_SHOP - ", func_206(iParam0, 0), " undefined");
	return -1;
}
