...
bool func_13()
{
	iLocal_16 = Global_1887351[62 /*36*/].f_5;
	iLocal_17 = VOLUME::_CREATE_VOLUME_CYLINDER(1411.869f, -7032.472f, 71.50774f, 0f, 0f, -25.35288f, 142.4495f, 133.1683f, 45.87774f);
	return true;
}
...
bool func_40(int iParam0)
{
	if (VOLUME::_DOES_VOLUME_EXIST(iLocal_17))
	{
		if (func_62(62, 33554432))
		{
			if (!bLocal_18)
			{
				PATHFIND::_0xF2A2177AC848B3A8(iLocal_17, 0, 1);
				bLocal_18 = true;
			}
		}
		else if (bLocal_18)
		{
			PATHFIND::_0xF2A2177AC848B3A8(iLocal_17, 1, 1);
			bLocal_18 = false;
		}
	}
	return false;
...
void func_70(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_97(iParam0, 0), " ", func_98(iParam1, 0), " ", func_99(iParam2, 0), " state ", func_100(iParam4, 0));
	...
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_97(iParam0, 0), " or ", func_98(iParam1, 0), " or ", func_99(iParam2, 0));
	...
	else if ((func_60(iParam0) && func_62(iParam0, 16777216)) && !Global_1893599.f_9)
	{
...
bool func_83(int iParam0, bool bParam1)
{
	...
	if (func_89(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_121(Global_1896632.f_1, 16))
			{
				func_122(Global_1896632.f_1, 0);
			}
			Global_1896632.f_1++;
			iVar2++;
...
int func_92(int iParam0, bool bParam1)
{
	if (!func_90(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_128(iParam0), " is invalid");
		return 0;
	}
	if (!func_121(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_128(iParam0), " has not been initialized");
		return 0;
	}
	if (func_121(iParam0, 32) && !bParam1)
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_128(iParam0), " has been locked dead");
		func_130(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_129(iParam0)));
		if (func_45() == -1)
		{
			if (func_121(iParam0, 2048))
			{
				PERSCHAR::_0x49A8C2CD97815215(func_131(iParam0));
				func_132(iParam0, 2048);
				DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_128(iParam0), " has been revived!");
			}
	...
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_128(iParam0), " dead or not spawning, turn scenario groups off");
		return 0;
	}
	if (PERSCHAR::_0x800DF3FC913355F3(func_131(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Persistent character ", func_128(iParam0), " already exists");
		func_132(iParam0, 128);
		return 1;
	}
	func_130(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_129(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_131(iParam0));
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_128(iParam0), " perschar index created!");
	if (func_121(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_131(iParam0));
		func_132(iParam0, 2048);
	...
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_128(iParam0), " created.");
...
char* func_101(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_137(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_139(func_138(Global_34));
	}
...
void func_116(var uParam0, int iParam1)
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_144(iParam1, 0));
}
...
void func_119(int iParam0)
{
	...
	func_146(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_147(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
...
void func_120(int iParam0)
{
	...
	if (func_90(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_149(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_150(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_151(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_152(iParam0, 536870912);
	iVar1 = func_153(iParam0);
	if (iVar1 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(2216, 139, "[SHOP_UNLOCK_DOORS] Shop: ", func_154(iParam0, 0), " door count is greater then the. Current door count: ", iVar1, " Max door count: ", 15);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_155(Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
	...
	DEBUG::_0xF0783374333FD8CE(168, 139, "[CLEAR_SHOP] Shop: ", func_154(iParam0, 0), " has been cleared!");
}
...
int func_122(int iParam0, bool bParam1)
{
	if (!func_90(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_128(iParam0), " is invalid");
		return 0;
	}
	if (!func_121(iParam0, 2))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_128(iParam0), " has not been initialized");
		return 0;
	}
	if (func_129(iParam0) == 0)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_128(iParam0), " doesn't exist");
		return 1;
	}
	if (!PERSCHAR::_0x800DF3FC913355F3(func_131(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_128(iParam0), " already destroyed");
		return 1;
	}
	if (func_121(iParam0, 1) && !bParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_128(iParam0), " is stolen, so it will be destoyed on release.");
		func_157(iParam0, 128);
		return 1;
	}
	func_132(iParam0, 129);
	func_158(iParam0);
	DEBUG::_0xA308F935BDECCEC0(40, 138, "DESTROY_REGIONAL_CHARACTER: Destroying ", func_128(iParam0));
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_131(iParam0));
	func_130(iParam0, 0);
	DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: ", func_128(iParam0), " destroyed.");
	return 1;
}
...
void func_125()
{
	...
	while (iVar0 <= 3)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ NET_CLEAR_BARTENDERS - Removed ", func_163(Global_1051777.f_3642[iVar0 /*19*/]));
...
void func_127(int iParam0, bool bParam1)
{
	...
	DEBUG::_0x4DC69742196F818A(40, 139, "NET_CLEAR_SHOP ", func_154(iParam0, 0));
	bVar0 = (func_164(iParam0) && !bParam1);
	if (!bVar0 && !func_165(iParam0, 65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] - Shop keeper deleted for shop: ", func_166(iParam0));
		}
	...
	else if (func_167(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
	{
	...
	if (func_167(iParam0, 16384) && !bVar0)
	{
		DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] Remove the script created scenario for: ", func_166(iParam0));
	...
	if (iVar3 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "[NET_CLEAR_SHOP] - Shop: ", func_154(iParam0, 0), " current door count exceeds max door count.");
		Global_1915867.f_3[iParam0 /*447*/].f_409 = 0;
	}
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_155(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar2]);
	...
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 139, "NET_CLEAR_SHOP: SPF_ALLOW_BLIP_OUT_OF_REGION for ", func_166(iParam0), " is kept; all other flags cleared.");
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_24) && func_171(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_CLEAR_SHOP] Removing relationship volume from shop ", func_154(iParam0, 0));
...
void func_132(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_173(iParam1), " on ", func_128(iParam0));
}
...
bool func_133(int iParam0)
{
	...
	if (!func_121(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_128(iParam0), " has not been initialized");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(40, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_128(iParam0));
	return true;
}
...
bool func_136(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_176(func_56(0)))
	{
		return true;
	}
...
void func_148(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 195, "CLEAR_SALOON_CONFIG_FLAG: Clearing flag for ", func_181(iParam1, 0));
	func_182(&(Global_1940170.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_150(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that isnt stolen ", func_128(iParam0));
		return;
	}
	if (!func_121(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release an uninitialized regional character ", func_128(iParam0));
		return;
	}
	if ((!bParam4 && !func_149(iParam0)) && func_183(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that is stolen by a differnt script ", func_128(iParam0));
		return;
	}
	DEBUG::_0xF0783374333FD8CE(680, 138, "RELEASE_REGIONAL_CHARACTER: Regional character ", func_128(iParam0), " released by ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
	func_132(iParam0, 1);
	func_158(iParam0);
	if (func_184(func_129(iParam0)))
	{
		iVar0 = func_131(iParam0);
		if (!PERSCHAR::_0x800DF3FC913355F3(iVar0))
		{
			DEBUG::_0x9A6C65DDDBEC9C52(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character with no perschar index", func_128(iParam0));
			return;
		}
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being retasked ", func_128(iParam0));
	...
	if (func_121(iParam0, 128) && !bParam3)
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being destroyed on release ", func_128(iParam0));
		func_122(iParam0, 0);
	}
}
...
{
	if (func_191(iParam0) && func_192())
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 183, "RELEASE_DOOR_ID - Releasing Door ID ", func_193(iParam0, 0));
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 139, "CLEAR_ALL_SHOP_TYPE_FLAGS: ", func_166(iParam0));
...
void func_157(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_173(iParam1), " on ", func_128(iParam0));
}
...
void func_158(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar0, false))
		{
			...
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_128(iParam0), " set as no longer needed.");
		}
		else
		{
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_128(iParam0), " was asked to be set as no longer needed, but this script does not own the ped.");
		}
	}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_FLAGS] ", func_166(iParam0));
	Global_1051777.f_80[iParam0 /*75*/].f_49 = 0;
}

void func_160(int iParam0)
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_SUPPORT_FLAGS] ", func_166(iParam0));
...
void func_168(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_166(iParam0), " flag ", func_196(iParam1));
	}
	Global_1051777.f_80[iParam0 /*75*/].f_1 = (Global_1051777.f_80[iParam0 /*75*/].f_1 - (Global_1051777.f_80[iParam0 /*75*/].f_1 && iParam1));
}
...
{
	return func_197(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}
...
bool func_174()
{
	...
	if (!func_176(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
int func_202(int iParam0)
{
	...
	DEBUG::_0xD9911C7B5F8CD69C(168, 139, "GET_SHOP_TYPE_FROM_SHOP - ", func_195(iParam0, 0), " undefined");
	return -1;
}
