...
bool func_22(var uParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 201, "[SETUP_SHOW_ASSETS] : ", func_94());
	return true;
}
...
bool func_103(var uParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1393[0]))
	{
		if (func_166(&(uParam0->f_1393[0]), uParam0->f_1385[0], func_165(0)))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] BOX INDEX: ", uParam0->f_1393[0]);
		}
		else
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "BOX was not created");
			return false;
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1393[1]))
	{
		if (func_166(&(uParam0->f_1393[1]), uParam0->f_1385[1], func_165(1)))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] Knife INDEX: ", uParam0->f_1393[1]);
		}
		else
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "Knife was not created");
			return false;
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1393[2]))
	{
		if (func_166(&(uParam0->f_1393[2]), uParam0->f_1385[2], func_165(2)))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] mask INDEX: ", uParam0->f_1393[2]);
		}
		else
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "mask was not created");
			return false;
		}
	}
	if (!func_167(uParam0, iVar0, 0, "Benjamin"))
	{
		return false;
	}
	if (!func_167(uParam0, iVar0, 1, "ASSISTANT_"))
	{
		return false;
	}
