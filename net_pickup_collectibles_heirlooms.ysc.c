...
void func_1(var uParam0, struct<2> Param1, var uParam3)
{
	...
	while (iVar2 < 56)
	{
		...
		{
			case 0:
				uParam0->f_81[iVar2] = joaat("MP005_S_HL_BR_BOARBRISTLE");
				break;
			case 1:
				uParam0->f_81[iVar2] = joaat("MP005_S_HL_BR_EBNY");
				break;
			case 2:
				uParam0->f_81[iVar2] = joaat("MP005_S_HL_BR_GOAT");
				break;
			case 3:
				uParam0->f_81[iVar2] = joaat("MP005_S_HL_BR_HORSE");
				break;
			case 4:
				uParam0->f_81[iVar2] = joaat("MP005_S_HL_BR_NG_RSEWD");
				break;
			case 5:
				uParam0->f_81[iVar2] = joaat("MP005_S_HL_BR_RSEWD");
				break;
			case 6:
				uParam0->f_81[iVar2] = joaat("MP005_S_HL_CMB_BOXWOOD");
				break;
			case 7:
				uParam0->f_81[iVar2] = joaat("MP005_S_HL_CMB_CHRYWD");
				break;
			case 8:
				uParam0->f_81[iVar2] = joaat("MP005_S_HL_CMB_IVRY");
				break;
			case 9:
				uParam0->f_81[iVar2] = joaat("MP005_S_HL_CMB_TORTSHELL");
				break;
			case 10:
				uParam0->f_81[iVar2] = joaat("MP005_S_HL_HP_CRVDWD");
				break;
			case 11:
				uParam0->f_81[iVar2] = joaat("MP005_S_HL_HP_CRVDWD001");
				break;
			case 12:
				uParam0->f_81[iVar2] = joaat("MP005_S_HL_HP_EBNY");
				break;
			case 13:
				uParam0->f_81[iVar2] = joaat("MP005_S_HL_HP_IVRY");
				break;
			case 14:
				uParam0->f_81[iVar2] = joaat("MP005_S_HL_HP_IVRY_EXAMPLE");
				break;
			case 15:
				uParam0->f_81[iVar2] = joaat("MP005_S_HL_HP_JDE");
				break;
			case 16:
				uParam0->f_81[iVar2] = joaat("MP005_S_HL_HP_MTL");
				break;
			case 17:
				uParam0->f_81[iVar2] = joaat("MP005_S_HL_HP_MTL001");
				break;
			default:
				uParam0->f_81[iVar2] = joaat("MP005_S_HL_HP_MTL");
				break;
