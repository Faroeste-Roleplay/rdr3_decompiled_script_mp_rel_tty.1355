...
bool func_103(var uParam0)
{
	...
	if (!func_165(uParam0, iVar0, 0, "DANCER"))
	{
		return false;
	}
	if (!func_165(uParam0, iVar0, 1, "SNAKE"))
	{
		return false;
	}
...
void func_108(bool bParam0, int iParam1, bool bParam2)
{
	...
	if (func_169(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != iParam1 || bParam2)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(680, 183, "SET_DOORSTATE_OF_DOOR_ID - Setting Door ID ", func_170(bParam0, 0), " to ", func_171(iParam1, 0));
...
int func_116(bool bParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12)
{
	...
	func_172(iVar0, bParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
char* func_119(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 201, "Projectionist playlist: ", func_173(iParam1, 0), " show: ", func_174(iParam0, 0));
...
{
	DEBUG::_0x1B08D1EB9D8C4931(40, 201, "[fireDance_02][CUSTOM_UPDATE_HOST] -- STATE: ", func_175(uParam0->f_1, 0));
	switch (uParam0->f_1)
	{
		case 0:
			func_176(&(uParam0->f_1), 32);
			break;
		case 32:
			if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false))
			{
				uParam0->f_3 = 1;
				func_91(uParam0, 1);
				func_176(&(uParam0->f_1), 33);
			}
			break;
		case 33:
			func_176(&(uParam0->f_1), 34);
			break;
		case 34:
			if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)) > func_177(iLocal_16))
			{
				func_176(&(uParam0->f_1), 37);
			}
			break;
		case 37:
			uParam0->f_5 = 1;
...
{
	DEBUG::_0x1B08D1EB9D8C4931(40, 201, "[fireDance_02][CUSTOM_UPDATE_CLIENT] -- STATE: ", func_175((uParam1[uParam2->f_1 /*18*/])->f_17, 0));
...
void func_135(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	...
	if (func_169(bParam0))
	{
		...
		else if (bParam1)
		{
			if (bParam4)
			{
				func_184(bParam0, 1);
				UNK_0x355E72323AEE83CC(183, 9);
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking Door ID ", func_170(bParam0, 0));
			}
			else
			{
				func_185(bParam0, 1);
				UNK_0x355E72323AEE83CC(183, 9);
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking and making unbreakable Door ID ", func_170(bParam0, 0));
			}
		}
		else
		{
			func_186(bParam0, 1);
			UNK_0x355E72323AEE83CC(183, 9);
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Unlocking Door ID ", func_170(bParam0, 0));
		}
		if (bParam7)
		{
			DEBUG::_0x1B08D1EB9D8C4931(168, 183, "SET_STATE_OF_DOOR_ID - Treating Door ID ", func_170(bParam0, 0), " as shut.");
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 183, "SET_STATE_OF_DOOR_ID: Door with ID not registered by host yet ", func_170(bParam0, 0));
	}
}
...
bool func_165(var uParam0, int iParam1, int iParam2, char* sParam3)
{
...
bool func_168(bool bParam0, bool bParam1, bool bParam2)
{
	if (!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(bParam0))
	{
		if ((NETWORK::NETWORK_IS_IN_SESSION() && SCRIPTS::_DOES_THREAD_EXIST(Global_1051590.f_16[0])) && bParam1)
		{
			...
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add networked Door ", func_170(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
		else
		{
			OBJECT::_ADD_DOOR_TO_SYSTEM_NEW(bParam0, true, false, false, 0, 0, false);
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add Door ", func_170(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
	}
	...
	if (bParam2)
	{
		...
		DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Set door ", func_170(bParam0, 0), " able to change open ratio while locked");
		UNK_0x355E72323AEE83CC(183, 7);
	}
	return bParam0;
}
...
void func_172(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
{
	DEBUG::_0xA308F935BDECCEC0(680, 201, "[GSMP_SET_INDIVIDUAL_SHOW_STATE_HOST] Changing from STATE: ,", func_175(*uParam0, 0), " TO STATE: ", func_175(iParam1, 0));
	*uParam0 = iParam1;
}
...
{
	DEBUG::_0xA308F935BDECCEC0(680, 201, "[GSMP_SET_INDIVIDUAL_SHOW_STATE_CLIENT] Changing from STATE: ,", func_175(*uParam0, 0), " TO STATE: ", func_175(iParam1, 0));
	*uParam0 = iParam1;
}
...
void func_184(bool bParam0, bool bParam1)
{
	if (func_169(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 2 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "LOCK_DOOR_ID - Locking Door ID ", func_170(bParam0, 0));
		}
	}
	else
	{
...
void func_185(bool bParam0, bool bParam1)
{
	if (func_169(bParam0))
	{
		...
		{
			DEBUG::_0x1B08D1EB9D8C4931(2216, 183, "SET_DOOR_ID_LOCKED_AND_UNBREAKABLE - Door ID ", func_170(bParam0, 0), " state = ", OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0), " pending state ", UNK_0x4BC2854478F3A749(bParam0));
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(bParam0, 1);
		}
	}
	else
...
void func_186(bool bParam0, bool bParam1)
{
	if (func_169(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 0 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "UNLOCK_DOOR_ID - Unlocking Door ID ", func_170(bParam0, 0));
		}
	}
	else
	{
