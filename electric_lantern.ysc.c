...
void __EntryFunction__()
{
	...
	DEBUG::_0xF0783374333FD8CE(8, 132, "Electic lantern script - STARTED");
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(514))
	{
		DEBUG::_0xF0783374333FD8CE(8, 132, "Electic lantern script - HAS_FORCE_CLEANUP_OCCURRED = TRUE");
		func_1();
	...
	func_1();
	DEBUG::_0xF0783374333FD8CE(8, 132, "Electic lantern script - TERMINATED");
	SCRIPTS::TERMINATE_THIS_THREAD();
}

void func_1()
{
	DEBUG::_0xF0783374333FD8CE(8, 132, "ELECTRIC_LANTERN_CLEANUP");
...
bool func_2()
{
	...
	{
		DEBUG::_0xF0783374333FD8CE(8, 132, "ELECTRIC_LANTERN_SCRIPT_SHOULD_CLEANUP = TRUE, player is dead");
		return true;
	}
	if (bLocal_1 && !ENTITY::DOES_ENTITY_EXIST(iLocal_0))
	{
		DEBUG::_0xF0783374333FD8CE(8, 132, "ELECTRIC_LANTERN_SCRIPT_SHOULD_CLEANUP = TRUE, the prop doesn't exist");
		return true;
	}
	if (Global_1940410.f_38 != joaat("WEAPON_MELEE_LANTERN_ELECTRIC"))
	{
		DEBUG::_0xF0783374333FD8CE(8, 132, "ELECTRIC_LANTERN_SCRIPT_SHOULD_CLEANUP = TRUE, current weapon isn't WEAPON_MELEE_LANTERN_ELECTRIC");
		return true;
	}
	return false;
}
...
bool func_3()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_0))
	{
		DEBUG::_0xF0783374333FD8CE(8, 132, "ELECTRIC_LANTERN_GRABBED_PROP = TRUE");
		bLocal_1 = true;
		return true;
	}
	return false;
