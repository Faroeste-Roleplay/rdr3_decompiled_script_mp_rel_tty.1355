...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_34, 0f, 0f, 0f) <= 5f || func_74(Global_1940410, 32768)) || func_74(Global_1940410, 16777216))
	{
		return;
	}
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_36)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_87(iLocal_36));
...
bool func_49(bool bParam0, bool bParam1)
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		{
			DEBUG::_0xF0783374333FD8CE(168, 8, "KILL_EVENT_CAUGHT - NETWORK_IS_GAME_IN_PROGRESS() = FALSE - but bIgnoreTransition = TRUE and g_mpTransition.eMPState = ", func_96(Global_1572887, 0), ", so skipping");
		}
		else
		{
...
int func_54(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (!func_69(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Region index not valid ", func_98(iParam0));
		return 1;
	}
	if (func_97(iParam0, 16))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: RF_PERS_DISABLED is on for ", func_98(iParam0));
		return 1;
	}
	if (func_99(iParam0) && !func_100(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: IS_REGION_IN_LOCKDOWN is on for ", func_98(iParam0));
	}
	DEBUG::_0xF0783374333FD8CE(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Starting for ", func_98(iParam0));
	if (func_101(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if ((!func_99(iParam0) || func_100(iParam0)) || func_103(Global_1896632))
			{
				func_104(Global_1896632, 0);
			}
			Global_1896632++;
			iVar2++;
...
void func_59(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	...
	if (iParam0 == 11)
	{
		DEBUG::_0xF0783374333FD8CE(8, 139, "[ENABLE_SHOP_LOCATION] Shop is a dynamic shop, please use: CREATE_SHOP_DYNAMIC");
		return;
	}
	iVar0 = func_105(iParam3, iParam0);
	vVar1 = { func_106(iVar0) };
	vVar4 = { func_107(iVar0) };
	if (func_108(vVar1))
	{
		DEBUG::_0xD9911C7B5F8CD69C(8, 139, "ENABLE_SHOP_LOCATION: Shop position is zero! Cannot init.");
		return;
	}
	if (!func_109(16, 16384))
	{
		if (!func_102(iParam1))
		{
			DEBUG::_0xD9911C7B5F8CD69C(8, 139, "ENABLE_SHOP_LOCATION: Shopkeeper RC is invalid! Cannot init.");
			return;
		}
	}
	if (!VOLUME::_DOES_VOLUME_EXIST(iParam2))
	{
		DEBUG::_0x83407B92D46F25C3(680, 139, "[ENABLE_SHOP_LOCATION] Shop volume does not exist for shop: ", func_110(iVar0, 0), " in the region: ", func_111(iParam3, 0));
		return;
	}
	...
	Global_1915867.f_3[iParam0 /*447*/].f_10 = { vVar1 };
	if (func_108(vVar4))
	{
		Global_1915867.f_3[iParam0 /*447*/].f_10 = { vVar1 };
	}
	...
	{
		Global_1915867.f_18260[iVar0 /*11*/].f_2 = { vVar4 };
	}
	Global_1915867.f_3[iParam0 /*447*/].f_9 = iVar0;
	Global_1915867.f_3[iParam0 /*447*/].f_25 = iParam2;
	Global_1915867.f_3[iParam0 /*447*/].f_26 = iParam4;
	Global_1915867.f_3[iParam0 /*447*/].f_28 = iParam5;
	Global_1915867.f_3[iParam0 /*447*/].f_29 = iParam9;
	Global_1915867.f_3[iParam0 /*447*/].f_8 = iParam3;
	Global_1915867.f_3[iParam0 /*447*/].f_410 = iParam8;
	Global_1960427.f_129[iParam0 /*3*/] = { 0f, 0f, 0f };
	Global_1960427.f_250[iParam0] = 0f;
	Global_1960427.f_648[iParam0] = 0;
	StringCopy(&(Global_1960427.f_327[iParam0 /*8*/]), "", 64);
	if (fParam7 <= 0f)
	{
		fParam7 = func_113(iParam0);
	}
	DEBUG::_0xA308F935BDECCEC0(424, 139, "[ENABLE_SHOP_LOCATION] Setting prestream distance for: ", func_110(iVar0, 0), " to ", fParam7);
	Global_1915867.f_3[iParam0 /*447*/].f_18 = fParam7;
	Global_1915867.f_3[iParam0 /*447*/].f_7 = iParam6;
	if (!func_114(iParam0, iParam1))
	{
		DEBUG::_0xF0783374333FD8CE(8, 139, "[ENABLE_SHOP_LOCATION] Failed to set shoptype shopkeeper!");
	}
	switch (iParam0)
	{
		case 1:
	...
	func_119(Global_1915867.f_3[iParam0 /*447*/].f_9);
	func_120(iParam0, 16);
	func_121(iParam0, 4);
	VOLUME::_0x748C5F51A18CB8F0(1);
	DEBUG::_0xF0783374333FD8CE(40, 139, "ENABLE_SHOP_LOCATION: Enabling shop: ", func_110(Global_1915867.f_3[iParam0 /*447*/].f_9, 0));
}

void func_60(int iParam0, int iParam1)
{
	DEBUG::_0x4DC69742196F818A(680, 139, "[SHOP_PROPERTY_SET_BIT] Setting bit: ", func_122(iParam1), " for ", func_123(iParam0));
	func_124(&(Global_1915867.f_3[iParam0 /*447*/].f_5), iParam1);
}
...
void func_61(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar0 < 0 || iVar0 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(8, 139, "ADD_SHOP_DOOR - Invalid door index.");
		return;
	}
	Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/] = iParam1;
	Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/].f_4 = iParam2;
	Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/].f_5 = iParam3;
	Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/].f_1 = { 0f, 0f, 0f };
	Global_1915867.f_3[iParam0 /*447*/].f_409++;
}
...
void func_62(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		...
		{
			DEBUG::_0xA308F935BDECCEC0(168, 221, "SET_SHOP_BLIP_HIDDEN - Hiding ", func_110(iParam0, 0), " blip.");
			func_128(iParam0, 4);
		}
	}
	else
...
void func_63(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	MISC::SET_THIS_SCRIPT_CAN_REMOVE_BLIPS_CREATED_BY_ANY_SCRIPT(true);
	func_134(iParam0, 1);
	DEBUG::_0xF0783374333FD8CE(40, 139, "NET_ENABLE_SHOP_LOCATION: Registering ", func_123(iParam0));
	Global_1051777.f_80[iParam0 /*75*/] = 0;
	Global_1051777.f_80[iParam0 /*75*/].f_18 = func_105(iParam2, iParam0);
...
{
	DEBUG::_0x4DC69742196F818A(680, 55, "[NET_SHOP_PROPERTY_SET_BIT] Setting bit: ", func_122(iParam1), " for ", func_123(iParam0));
	func_124(&(Global_1051777.f_80[iParam0 /*75*/].f_49), iParam1);
}
...
bool func_66()
{
	return func_138(func_57(0));
}

void func_67(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	...
	if (iVar0 < 0 || iVar0 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(40, 139, "[NET_ADD_SHOP_DOOR] - Invalid door index for shop: ", func_140(iParam0, 0));
		return;
	}
	Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0] = func_141(bParam1, 0, 0);
	if (func_142(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0]))
	{
		if (!func_143(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0]))
		{
			func_144(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0], 0, fParam2, bParam3, 1, 0, bParam4, 0);
		}
	}
...
int func_68(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == 0)
	{
		DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_147(iParam0), " IS INVALID.");
		return 0;
	}
	DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_147(iParam0), " IS VALID.");
...
void func_71(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!VOLUME::_DOES_VOLUME_EXIST(iParam2))
	{
		DEBUG::_0x4DC69742196F818A(8, 11, "MANAGE_OWNED_HORSE_DECORATOR_FOR_SHOP - Volume does not exist.");
		return;
	}
	if (!func_102(iParam1))
	{
		DEBUG::_0x4DC69742196F818A(8, 11, "MANAGE_OWNED_HORSE_DECORATOR_FOR_SHOP - Regional character horse is not valid.");
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (*iParam4)
		{
			...
			while (iVar4 < iVar1)
			{
				...
				else if (func_151(iVar6))
				{
				}
				else if (func_152(iVar6))
				{
				}
				else
				{
					DEBUG::_0x4DC69742196F818A(8, 11, "MANAGE_OWNED_HORSE_DECORATOR_FOR_SHOP - Setting horse as stable owned.");
					func_153(iVar6, iParam0);
					iVar2++;
				}
				iVar4++;
			}
			...
			if (iVar2 < iParam3)
			{
				DEBUG::_0x4DC69742196F818A(8, 11, "MANAGE_OWNED_HORSE_DECORATOR_FOR_SHOP - Did not find all horses, trying again next update.");
				*iParam4 = 1;
			}
			else
			{
				DEBUG::_0x4DC69742196F818A(8, 11, "MANAGE_OWNED_HORSE_DECORATOR_FOR_SHOP - Found all horses.");
				*iParam4 = 0;
			}
		}
	}
...
{
	func_144(bParam0, 1, 0, 0, 0, 0, 0, 0);
}
...
bool func_76()
{
	return func_74(Global_1940410, 8192);
}
...
bool func_78(int iParam0)
{
	...
	return ((Global_1887351[iParam0 /*36*/].f_21 == 1 || Global_1887351[iParam0 /*36*/].f_21 == 2) && !func_155(iParam0));
}
...
void func_81(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	char* sVar1;
	char* sVar2;
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_111(iParam0, 0), " ", func_157(iParam1, 0), " ", func_158(bParam2, 0), " state ", func_159(iParam4, 0));
	UNK_0x355E72323AEE83CC(11, 6);
	sVar1 = func_160(iParam0, iParam1, bParam2, iParam4, bParam5, bParam3, &bVar0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_111(iParam0, 0), " or ", func_157(iParam1, 0), " or ", func_158(bParam2, 0));
	...
	if (bVar0 && bParam3)
	{
		sVar2 = func_165(func_164(bParam2));
	}
	else if ((func_166(iParam1, 2) || func_167(iParam4, 2)) && !Global_1893599.f_9)
	{
	...
	else if ((func_69(iParam0) && func_97(iParam0, 16777216)) && !Global_1893599.f_9)
	{
	...
	Global_1939313.f_145 = func_173(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
bool func_94(int iParam0, bool bParam1)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 138, "DELETE_ALL_REGIONAL_CHARACTERS starting for Region ", func_98(iParam0));
	if (func_101(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_179(Global_1896632.f_1, 16))
			{
				func_180(Global_1896632.f_1, 0);
			}
			Global_1896632.f_1++;
			iVar2++;
...
bool func_99(int iParam0)
{
	...
	return func_97(iParam0, 33554432);
}
	...
	switch (iParam0)
	{
		...
		case 139:
			...
			*iParam2 = 851;
			...
			break;
		default:
			DEBUG::_0xA308F935BDECCEC0(40, 138, "Attempting to get regional character bounds for a region that doesn't have them yet ", func_87(iParam0));
			*iParam1 = -1;
			*iParam2 = -1;
			break;
	}
...
int func_104(int iParam0, bool bParam1)
{
	if (!func_102(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_147(iParam0), " is invalid");
		return 0;
	}
	if (!func_179(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_147(iParam0), " has not been initialized");
		return 0;
	}
	if (func_179(iParam0, 32) && !bParam1)
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_147(iParam0), " has been locked dead");
		...
		if (func_45() == -1)
		{
			if (func_179(iParam0, 2048))
			{
				...
				func_187(iParam0, 2048);
				DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_147(iParam0), " has been revived!");
			}
			PERSCHAR::_0xFCC6DB8DBE709BC8(func_146(iParam0));
		}
		return 0;
	}
	if (!func_188(iParam0) && func_45() == -1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_147(iParam0), " dead or not spawning, turn scenario groups off");
		return 0;
	}
	if (PERSCHAR::_0x800DF3FC913355F3(func_146(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Persistent character ", func_147(iParam0), " already exists");
		func_187(iParam0, 128);
		return 1;
	}
	func_186(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_185(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_146(iParam0));
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_147(iParam0), " perschar index created!");
	if (func_179(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_146(iParam0));
		func_187(iParam0, 2048);
	...
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_147(iParam0), " created.");
...
Vector3 func_107(int iParam0)
{
	if (!func_189(iParam0))
	{
		DEBUG::_0xF0783374333FD8CE(8, 221, "SHOP_GET_MAP_BLIP_LOCATION - Passed invalid shop, returning vector zero.");
		return 0f, 0f, 0f;
	}
	switch (iParam0)
	{
	...
	DEBUG::_0x9A6C65DDDBEC9C52(168, 221, "SHOP_GET_MAP_BLIP_LOCATION - No position found for shop: ", func_110(iParam0, 0), ", returning vector zero.");
	return 0f, 0f, 0f;
}
...
{
	return func_190(Global_1915867.f_3[iParam0 /*447*/].f_5, iParam1);
}
...
void func_112(int iParam0)
{
	...
	if (func_102(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_191(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_192(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_193(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_120(iParam0, 536870912);
	iVar1 = func_125(iParam0);
	if (iVar1 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(2216, 139, "[SHOP_UNLOCK_DOORS] Shop: ", func_140(iParam0, 0), " door count is greater then the. Current door count: ", iVar1, " Max door count: ", 15);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_194(Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
	...
	DEBUG::_0xF0783374333FD8CE(168, 139, "[CLEAR_SHOP] Shop: ", func_140(iParam0, 0), " has been cleared!");
}
...
bool func_114(int iParam0, int iParam1)
{
	...
	if (func_109(iParam0, 16384))
	{
		DEBUG::_0xF0783374333FD8CE(168, 139, "[SHOP_SET_SHOPKEEPER] Shop type: ", func_140(iParam0, 0), " is flagged to not require a shopkeeper.");
		return true;
	}
	if (!func_102(iParam1))
	{
		DEBUG::_0xF0783374333FD8CE(8, 139, "[SHOP_SET_SHOPKEEPER] Regional char type is invalid!");
		return false;
	}
	iVar0 = func_149(iParam1);
	if (!ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[SHOP_SET_SHOPKEEPER] Failed to get the regional perchar ped index for shop ", func_140(iParam0, 0));
	}
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1915867.f_3[iParam0 /*447*/].f_25))
	{
		iVar1 = VOLUME::_0x7FD78DFD0C5D7B9B(Global_1915867.f_3[iParam0 /*447*/].f_25);
		if (ENTITY::DOES_ENTITY_EXIST(iVar1))
		{
			if (iVar1 != iVar0)
			{
				VOLUME::_0x6D5F9E69BA1BE783(Global_1915867.f_3[iParam0 /*447*/].f_25);
			}
		}
		func_68(iParam1, Global_1915867.f_3[iParam0 /*447*/].f_25, 1);
		VOLUME::_0x4A8FEFC43FD8AC9B(Global_1915867.f_3[iParam0 /*447*/].f_25, 1, 1);
		DEBUG::_0xF0783374333FD8CE(8, 139, "[SHOP_SET_SHOPKEEPER] Set shop owner global");
	}
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1915867.f_3[iParam0 /*447*/].f_28))
	{
		iVar2 = VOLUME::_0x7FD78DFD0C5D7B9B(Global_1915867.f_3[iParam0 /*447*/].f_28);
		if (ENTITY::DOES_ENTITY_EXIST(iVar2))
		{
			if (iVar2 != iVar0)
			{
				VOLUME::_0x6D5F9E69BA1BE783(Global_1915867.f_3[iParam0 /*447*/].f_28);
			}
		}
		func_68(iParam1, Global_1915867.f_3[iParam0 /*447*/].f_28, 1);
		VOLUME::_0x4A8FEFC43FD8AC9B(Global_1915867.f_3[iParam0 /*447*/].f_28, 0, 1);
	}
	Global_1915867.f_3[iParam0 /*447*/].f_21 = iParam1;
	Global_1915867.f_3[iParam0 /*447*/].f_23 = iVar0;
	return true;
}
...
void func_115(int iParam0)
{
	...
	{
		case 98:
			StringCopy(&(Global_1960427.f_327[2 /*8*/]), "0507_U_M_M_VhtStationClerk_01", 64);
			StringCopy(&(Global_1960427.f_327[1 /*8*/]), "0507_U_M_M_VhtStationClerk_01", 64);
			return;
		case 40:
			StringCopy(&(Global_1960427.f_327[2 /*8*/]), "0078_U_M_M_BlWTrainStationWorker_01", 64);
			StringCopy(&(Global_1960427.f_327[1 /*8*/]), "0078_U_M_M_BlWTrainStationWorker_01", 64);
			return;
		case 26:
			StringCopy(&(Global_1960427.f_327[2 /*8*/]), "0442_U_M_M_StrFreightStationOwner_01", 64);
			StringCopy(&(Global_1960427.f_327[1 /*8*/]), "0442_U_M_M_StrFreightStationOwner_01", 64);
			return;
		default:
			break;
	}
	...
	DEBUG::_0x1B08D1EB9D8C4931(8, 113, "SHOP_KEEPER_POSTOFFICE_SHOP_SET_DIALOGUE_VOICE: iFirstRand ", iVar0);
	DEBUG::_0x1B08D1EB9D8C4931(8, 113, "SHOP_KEEPER_POSTOFFICE_SHOP_SET_DIALOGUE_VOICE: iSecondRand ", iVar1);
	if (iVar1 > 80)
	{
		StringCopy(&(Global_1960427.f_327[2 /*8*/]), "0833_S_M_M_TrainStationWorker_01_WHITE_02", 64);
		StringCopy(&(Global_1960427.f_327[1 /*8*/]), "0833_S_M_M_TrainStationWorker_01_WHITE_02", 64);
	}
	else if (iVar1 < 40)
	{
		StringCopy(&(Global_1960427.f_327[2 /*8*/]), "0834_S_M_M_TrainStationWorker_01_WHITE_03", 64);
		StringCopy(&(Global_1960427.f_327[1 /*8*/]), "0834_S_M_M_TrainStationWorker_01_WHITE_03", 64);
	}
	else
	{
		StringCopy(&(Global_1960427.f_327[2 /*8*/]), "0832_S_M_M_TrainStationWorker_01_WHITE_01", 64);
		StringCopy(&(Global_1960427.f_327[1 /*8*/]), "0832_S_M_M_TrainStationWorker_01_WHITE_01", 64);
	}
}
...
void func_116(int iParam0)
{
	if (iParam0 == 81)
	{
		StringCopy(&(Global_1960427.f_327[10 /*8*/]), "1025_U_M_M_ValButcher_01", 64);
	}
	else if (iParam0 == 121)
	{
		StringCopy(&(Global_1960427.f_327[10 /*8*/]), "1086_U_M_M_TumButcher_01", 64);
	}
	else
	{
		switch (MISC::GET_RANDOM_INT_IN_RANGE(0, 6))
		{
			case 0:
			case 3:
				StringCopy(&(Global_1960427.f_327[10 /*8*/]), "0842_S_M_M_UniButchers_01_WHITE_01", 64);
				break;
			case 1:
			case 4:
				StringCopy(&(Global_1960427.f_327[10 /*8*/]), "0843_S_M_M_UniButchers_01_WHITE_02", 64);
				break;
			case 2:
			case 5:
				StringCopy(&(Global_1960427.f_327[10 /*8*/]), "0844_S_M_M_UniButchers_01_WHITE_03", 64);
				break;
		}
	}
}
...
void func_117()
{
	StringCopy(&(Global_1960427.f_327[15 /*8*/]), "GUS", 64);
}
...
void func_118()
{
	...
	iVar0 = MISC::GET_RANDOM_INT_IN_RANGE(100, 200);
	iVar1 = MISC::GET_RANDOM_INT_IN_RANGE(0, iVar0);
	DEBUG::_0x1B08D1EB9D8C4931(8, 113, "SHOP_KEEPER_HORSE_SHOP_SET_DIALOGUE_VOICE: iFirstRand ", iVar0);
	DEBUG::_0x1B08D1EB9D8C4931(8, 113, "SHOP_KEEPER_HORSE_SHOP_SET_DIALOGUE_VOICE: iSecondRand ", iVar1);
	if (iVar1 > 80)
	{
		StringCopy(&(Global_1960427.f_327[9 /*8*/]), "0825_S_M_M_LiveryWorker_01_WHITE_01", 64);
	}
	else if (iVar1 < 40)
	{
		StringCopy(&(Global_1960427.f_327[9 /*8*/]), "0826_S_M_M_LiveryWorker_01_WHITE_02", 64);
	}
	else
	{
		StringCopy(&(Global_1960427.f_327[9 /*8*/]), "0827_S_M_M_LiveryWorker_01_WHITE_03", 64);
	}
}
...
bool func_127(int iParam0, int iParam1)
{
	if (!func_189(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(8, 139, "[IS_SHOP_SAVED_FLAG_SET] Passed in Invalid shop");
		return false;
	}
	return (Global_5863.f_2074[iParam0] && iParam1) != 0;
}
...
void func_128(int iParam0, int iParam1)
{
	if (!func_189(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(8, 139, "[SET_SHOP_SAVED_FLAG] Passed in Invalid shop");
	}
	else
	{
		Global_5863.f_2074[iParam0] = (Global_5863.f_2074[iParam0] || iParam1);
	}
}
...
void func_129(int iParam0, int iParam1)
{
	if (!func_189(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(8, 139, "[CLEAR_SHOP_SAVED_FLAG] Passed in Invalid shop");
	}
	else
	{
		Global_5863.f_2074[iParam0] = (Global_5863.f_2074[iParam0] - (Global_5863.f_2074[iParam0] && iParam1));
	}
}
...
void func_130(int iParam0)
{
	if (iParam0 != -1)
	{
		DEBUG::_0xF0783374333FD8CE(40, 221, "[FORCE_SHOP_BLIP_UPDATE] Forcing blip update for ", func_110(iParam0, 0));
		Global_1915867.f_18246 = iParam0;
	}
}

bool func_131()
{
	return func_201(func_57(0));
}
...
void func_133(bool bParam0, bool bParam1)
{
	...
	else
	{
		...
		func_206(0);
		func_207(&(Global_1102630.f_3849));
		...
		func_208(&(Global_1102630.f_3888));
	...
	func_209(Global_1102630.f_3849, 36);
	func_210(Global_1102630.f_3888, 36);
...
void func_134(int iParam0, bool bParam1)
{
	...
	DEBUG::_0x4DC69742196F818A(40, 139, "NET_CLEAR_SHOP ", func_140(iParam0, 0));
	bVar0 = (func_211(iParam0) && !bParam1);
	if (!bVar0 && !func_212(iParam0, 65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] - Shop keeper deleted for shop: ", func_123(iParam0));
		}
	...
	else if (func_213(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
	{
	...
	if (func_213(iParam0, 16384) && !bVar0)
	{
		DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] Remove the script created scenario for: ", func_123(iParam0));
	...
	if (iVar3 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "[NET_CLEAR_SHOP] - Shop: ", func_140(iParam0, 0), " current door count exceeds max door count.");
		Global_1915867.f_3[iParam0 /*447*/].f_409 = 0;
	}
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_194(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar2]);
	...
	func_215(iParam0);
	if (func_212(iParam0, 262144))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 139, "NET_CLEAR_SHOP: SPF_ALLOW_BLIP_OUT_OF_REGION for ", func_123(iParam0), " is kept; all other flags cleared.");
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_24) && func_217(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_CLEAR_SHOP] Removing relationship volume from shop ", func_140(iParam0, 0));
...
int func_135(int iParam0)
{
	...
	{
		Global_1051777.f_4480[iParam0] = func_220(iParam0);
	}
...
void func_136(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_SET_SHOP_TYPE_FLAG] ", func_123(iParam0), " flag ", func_221(iParam1));
	}
	Global_1051777.f_80[iParam0 /*75*/].f_1 = (Global_1051777.f_80[iParam0 /*75*/].f_1 || iParam1);
}
...
bool func_141(bool bParam0, bool bParam1, bool bParam2)
{
	if (!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(bParam0))
	{
		if ((NETWORK::NETWORK_IS_IN_SESSION() && SCRIPTS::_DOES_THREAD_EXIST(Global_1051590.f_16[0])) && bParam1)
		{
			...
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add networked Door ", func_223(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
		else
		{
			OBJECT::_ADD_DOOR_TO_SYSTEM_NEW(bParam0, true, false, false, 0, 0, false);
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add Door ", func_223(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
	}
	...
	if (bParam2)
	{
		...
		DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Set door ", func_223(bParam0, 0), " able to change open ratio while locked");
		UNK_0x355E72323AEE83CC(183, 7);
	}
	return bParam0;
}
...
void func_144(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	func_141(bParam0, 0, 0);
	if (func_142(bParam0))
	{
		...
		if (bParam3)
		{
			func_225(bParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
			{
				...
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking Door ID ", func_223(bParam0, 0));
			}
			else
			{
				func_227(bParam0, 1);
				UNK_0x355E72323AEE83CC(183, 9);
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking and making unbreakable Door ID ", func_223(bParam0, 0));
			}
		}
		else
		{
			func_228(bParam0, 1);
			UNK_0x355E72323AEE83CC(183, 9);
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Unlocking Door ID ", func_223(bParam0, 0));
		}
		if (bParam7)
		{
			DEBUG::_0x1B08D1EB9D8C4931(168, 183, "SET_STATE_OF_DOOR_ID - Treating Door ID ", func_223(bParam0, 0), " as shut.");
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 183, "SET_STATE_OF_DOOR_ID: Door with ID not registered by host yet ", func_223(bParam0, 0));
	}
}
...
bool func_145(int iParam0, bool bParam1)
{
	...
	if (!PERSCHAR::_0x800DF3FC913355F3(func_146(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - Checking if ", func_147(iParam0), " is alive when the perschar index is not created.");
		return false;
	}
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_149(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_147(iParam0), " does not have a ped spawned.");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(2216, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_147(iParam0), " being processed - ALIVE = ", !PERSCHAR::_0xEB98B38CA60742D7(func_146(iParam0)), "!");
...
bool func_151(int iParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(8, 25, "IS_PED_A_PLAYER_HORSE - The entity doesn't exist!");
		return false;
	}
	if (ENTITY::IS_ENTITY_DEAD(iParam0) || PED::IS_PED_INJURED(iParam0))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(8, 25, "IS_PED_A_PLAYER_HORSE - The ped is dead or injured!");
	}
...
{
	if ((iParam0 == 22 || iParam0 == 39) && !func_232())
	{
		return true;
	}
	if (iParam0 == 66)
...
var func_158(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case joaat("RIOBRAVO"):
...
char* func_160(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893599.f_162)))
	{
		sVar0 = func_235(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_237(func_236(Global_34));
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		if (!func_238(iParam0) || func_239(44))
		{
			switch (iParam0)
			{
				case 2:
...
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_242(iParam1, 0));
}
...
{
	DEBUG::_0x4DC69742196F818A(40, 195, "CLEAR_SALOON: Clearing ", func_243(iParam0));
	func_244(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_245(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
	...
	func_246(iParam0, 8192);
	func_246(iParam0, 32768);
	func_246(iParam0, 524288);
	func_246(iParam0, 1048576);
...
int func_180(int iParam0, bool bParam1)
{
	if (!func_102(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_147(iParam0), " is invalid");
		return 0;
	}
	if (!func_179(iParam0, 2))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_147(iParam0), " has not been initialized");
		return 0;
	}
	if (func_185(iParam0) == 0)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_147(iParam0), " doesn't exist");
		return 1;
	}
	if (!PERSCHAR::_0x800DF3FC913355F3(func_146(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_147(iParam0), " already destroyed");
		return 1;
	}
	if (func_179(iParam0, 1) && !bParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_147(iParam0), " is stolen, so it will be destoyed on release.");
		func_247(iParam0, 128);
		return 1;
	}
	func_187(iParam0, 129);
	func_248(iParam0);
	DEBUG::_0xA308F935BDECCEC0(40, 138, "DESTROY_REGIONAL_CHARACTER: Destroying ", func_147(iParam0));
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_146(iParam0));
	func_186(iParam0, 0);
	DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: ", func_147(iParam0), " destroyed.");
	return 1;
}
...
void func_183()
{
	...
	while (iVar0 <= 3)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ NET_CLEAR_BARTENDERS - Removed ", func_250(Global_1051777.f_3642[iVar0 /*19*/]));
...
void func_187(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_251(iParam1), " on ", func_147(iParam0));
}
...
bool func_188(int iParam0)
{
	...
	if (!func_179(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_147(iParam0), " has not been initialized");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(40, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_147(iParam0));
	return true;
}
...
void func_192(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	...
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that isnt stolen ", func_147(iParam0));
		return;
	}
	if (!func_179(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release an uninitialized regional character ", func_147(iParam0));
		return;
	}
	if ((!bParam4 && !func_191(iParam0)) && func_252(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that is stolen by a differnt script ", func_147(iParam0));
		return;
	}
	DEBUG::_0xF0783374333FD8CE(680, 138, "RELEASE_REGIONAL_CHARACTER: Regional character ", func_147(iParam0), " released by ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
	func_187(iParam0, 1);
	func_248(iParam0);
	if (func_253(func_185(iParam0)))
	{
		iVar0 = func_146(iParam0);
		if (!PERSCHAR::_0x800DF3FC913355F3(iVar0))
		{
			DEBUG::_0x9A6C65DDDBEC9C52(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character with no perschar index", func_147(iParam0));
			return;
		}
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being retasked ", func_147(iParam0));
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being destroyed on release ", func_147(iParam0));
		func_180(iParam0, 0);
	}
}
...
{
	if (func_142(bParam0) && func_256())
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 183, "RELEASE_DOOR_ID - Releasing Door ID ", func_223(bParam0, 0));
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 139, "CLEAR_ALL_SHOP_TYPE_FLAGS: ", func_123(iParam0));
...
int func_200(int iParam0)
{
	...
	DEBUG::_0xD9911C7B5F8CD69C(168, 139, "GET_SHOP_TYPE_FROM_SHOP - ", func_110(iParam0, 0), " undefined");
	return -1;
}

bool func_201(struct<2> Param0)
{
	return func_222(Param0, 5, 8);
}
...
void func_209(struct<30> Param0, int iParam30)
{
...
void func_210(struct<7> Param0, var uParam7, var uParam8, int iParam9)
{
...
void func_214(int iParam0, int iParam1)
{
	if (func_213(iParam0, iParam1))
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_123(iParam0), " flag ", func_221(iParam1));
	}
	Global_1051777.f_80[iParam0 /*75*/].f_1 = (Global_1051777.f_80[iParam0 /*75*/].f_1 - (Global_1051777.f_80[iParam0 /*75*/].f_1 && iParam1));
}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_FLAGS] ", func_123(iParam0));
	Global_1051777.f_80[iParam0 /*75*/].f_49 = 0;
}

bool func_217(int iParam0, int iParam1)
{
	return func_190(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}

void func_218(int iParam0)
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_SUPPORT_FLAGS] ", func_123(iParam0));
...
int func_220(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1139844.f_7) && !func_270(12, func_269(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
bool func_222(struct<2> Param0, int iParam2, int iParam3)
{
	int iVar0;
	...
	iVar0 = func_273(Param0);
	return (iVar0 >= iParam2 && iVar0 <= iParam3);
}

var func_223(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
void func_225(bool bParam0, char* sParam1, bool bParam2, bool bParam3)
{
	if (func_142(bParam0))
	{
...
void func_226(bool bParam0, bool bParam1)
{
	if (func_142(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 2 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "LOCK_DOOR_ID - Locking Door ID ", func_223(bParam0, 0));
		}
	}
	else
	{
...
void func_227(bool bParam0, bool bParam1)
{
	if (func_142(bParam0))
	{
		...
		{
			DEBUG::_0x1B08D1EB9D8C4931(2216, 183, "SET_DOOR_ID_LOCKED_AND_UNBREAKABLE - Door ID ", func_223(bParam0, 0), " state = ", OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0), " pending state ", UNK_0x4BC2854478F3A749(bParam0));
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(bParam0, 1);
		}
	}
	else
...
void func_228(bool bParam0, bool bParam1)
{
	if (func_142(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 0 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "UNLOCK_DOOR_ID - Unlocking Door ID ", func_223(bParam0, 0));
		}
	}
	else
	{
...
int func_231(int iParam0)
{
	...
	while (iVar0 < 7)
	{
		if (iParam0 == Global_1903188[iVar0 /*43*/])
		{
			return iVar0;
		}
		iVar0++;
...
bool func_234(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_272(func_57(0)))
	{
		return true;
	}
...
char* func_235(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
void func_246(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 195, "CLEAR_SALOON_CONFIG_FLAG: Clearing flag for ", func_280(iParam1, 0));
	func_281(&(Global_1940170.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_247(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_251(iParam1), " on ", func_147(iParam0));
}
...
void func_248(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar0, false))
		{
			...
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_147(iParam0), " set as no longer needed.");
		}
		else
		{
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_147(iParam0), " was asked to be set as no longer needed, but this script does not own the ped.");
		}
	}
...
bool func_257(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_283(&(Global_1102630.f_4), iVar0, 5);
	}
	if (iParam1 == func_284())
	{
		return func_283(&(Global_1102630.f_4), iVar0, 5);
	...
	{
		return func_283(&(Global_1100880[iParam1 /*53*/].f_4), iVar0, 5);
	}
...
bool func_270(int iParam0, char* sParam1, var uParam2)
{
	var uVar0;

	if (func_286(iParam0, sParam1, &uVar0))
	{
		func_287(&uVar0, iParam0, uParam2);
	}
	else
	{
...
bool func_274()
{
	...
	if (!func_272(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_277(vector3 vParam0, int iParam3)
{
	...
	func_291(iParam3, &vVar0, &Var3, &uVar6);
	if (func_292(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
...
bool func_286(int iParam0, char* sParam1, bool bParam2)
{
	*bParam2 = Global_1139844.f_7;
	bParam2->f_2 = 1351168281;
	bParam2->f_3 = func_293(iParam0);
	bParam2->f_4 = sParam1;
...
void func_287(bool bParam0, int iParam1, var uParam2)
{
	var uVar0;
	...
	*uParam2 = iParam1;
	...
	{
		DEBUG::_0x83407B92D46F25C3(648, 84, "RETRIEVE_UNLOCK_DATA - Couldn't retrieve id at index ", uParam2->f_1, " of type ", func_294(iParam1, 0));
	}
	bParam0->f_2 = -2140901307;
...
bool func_292(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
...
bool func_295(struct<2> Param0, bool bParam2)
{
	if (!func_272(Param0))
	{
		return false;
