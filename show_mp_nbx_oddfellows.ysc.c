...
bool func_103(var uParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1393[0]))
	{
		if (func_166(&(uParam0->f_1393[0]), uParam0->f_1385[0], func_165(0)))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] p_cs_bullwhip01x INDEX: ", uParam0->f_1393[0]);
		}
		else
		{
			return false;
	...
	if (!func_167(uParam0, iVar0, 0, "CS_GENSTORYFEMALE"))
	{
		return false;
	}
	if (!func_167(uParam0, iVar0, 1, "CS_ODDFELLOWSPINHEAD"))
	{
		return false;
	}
	if (!func_167(uParam0, iVar0, 2, "CS_MAGNIFICO"))
	{
		return false;
	}
	if (!func_167(uParam0, iVar0, 3, "CS_GENSTORYMALE"))
	{
		return false;
	}
...
void func_128(var uParam0, var uParam1, var uParam2, float fParam3)
{
	...
	{
		case 0:
			func_180(&((uParam1[uParam2->f_1 /*18*/])->f_17), 32);
			break;
		case 32:
			if (uParam0->f_1 > 32)
			{
				func_180(&((uParam1[uParam2->f_1 /*18*/])->f_17), 33);
			}
			break;
		case 33:
			if (uParam0->f_1 > 33)
			{
				func_180(&((uParam1[uParam2->f_1 /*18*/])->f_17), 34);
			}
			break;
		case 34:
			if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)) > 0.978f)
			{
				func_180(&((uParam1[uParam2->f_1 /*18*/])->f_17), 37);
			}
			break;
		case 37:
			if (!func_13(uParam0->f_1358, 8388608))
			...
			func_18(&(uParam2->f_247), 32);
			func_180(&((uParam1[uParam2->f_1 /*18*/])->f_17), 40);
			break;
		case 40:
			break;
	}
...
void func_132(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 218, "CLEAR_WORLD_STATE_FLAG: clearing world state - ", func_182(iParam0, 0));
	Global_1939807 = 0;
}
...
void func_135(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	...
	if (func_171(bParam0))
	{
		...
		if (bParam3)
		{
			func_184(bParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
int func_141(var uParam0, var uParam1, int iParam2)
{
	...
	if (!func_13(*uParam1, 1))
	{
		...
		{
			iVar3 = iVar0;
			if (func_193(uParam0[iVar0 /*5*/], func_191(iParam2), func_192(iParam2, iVar3), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 8))
	{
		...
		{
			iVar4 = iVar0;
			if (func_193(&(uParam0->f_31[iVar0 /*5*/]), func_195(iParam2), func_196(iParam2, iVar4), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 2048))
	{
		...
		{
			iVar5 = iVar0;
			if (func_193(&(uParam0->f_107[iVar0 /*5*/]), func_198(iParam2), func_199(iParam2, iVar5), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
	...
	{
		case 0:
			if (!func_13(*uParam1, 64) && func_193(&(uParam0->f_118[0 /*5*/]), func_200(iParam2, 0), func_201(iParam2, 0), 1065353216 /* Float: 1f */))
			{
				func_18(uParam1, 64);
			}
			if ((!func_13(*uParam1, 16384) && func_193(&(uParam0->f_118[1 /*5*/]), func_200(iParam2, 1), func_201(iParam2, 1), 1065353216 /* Float: 1f */)) && func_193(&(uParam0->f_118[2 /*5*/]), func_200(iParam2, 2), func_201(iParam2, 2), 1065353216 /* Float: 1f */))
			{
		...
		case 1:
			...
			if (!func_13(*uParam1, 2097152))
			{
				...
				{
					iVar6 = iVar0;
					if (func_193(&(uParam0->f_118[iVar0 /*5*/]), func_200(iParam2, 0), func_201(iParam2, iVar6), 1065353216 /* Float: 1f */))
					{
						iVar2++;
					}
					iVar0++;
...
void func_142(var uParam0, var uParam1, int iParam2)
{
	...
	{
		if (func_13(*uParam0, 2) && func_206(uParam1, func_203(uParam1), &(uParam1->f_229), func_204(uParam1), func_205(uParam1)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "WALL LIGHTS should be faded out");
			func_14(uParam0, 2);
		}
		if (func_13(*uParam0, 4) && func_208(uParam1, func_207(uParam1), &(uParam1->f_229), func_204(uParam1), func_205(uParam1)))
		{
	...
	{
		if (func_13(*uParam0, 16) && func_206(&(uParam1->f_31), func_209(uParam1), &(uParam1->f_232), func_210(uParam1), func_205(uParam1)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "STAGE LIGHTS should be faded out");
			func_14(uParam0, 16);
		}
		if (func_13(*uParam0, 32) && func_208(&(uParam1->f_31), func_211(uParam1), &(uParam1->f_232), func_210(uParam1), func_205(uParam1)))
		{
	...
	{
		if (func_13(*uParam0, 4096) && func_206(&(uParam1->f_107), func_212(uParam1), &(uParam1->f_235), func_213(uParam1), func_205(uParam1)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "BALCONY LIGHTS should be faded out");
			func_14(uParam0, 4096);
		}
		if (func_13(*uParam0, 8192) && func_208(&(uParam1->f_107), func_214(uParam1), &(uParam1->f_235), func_213(uParam1), func_205(uParam1)))
		{
	...
	if (iParam2 == 0)
	{
		...
		{
			if (func_13(*uParam0, 128) && func_217(&(uParam1->f_118[0 /*5*/]), func_215(uParam1), &(uParam1->f_238), func_216(uParam1), func_205(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE CENTER STAGE LIGHT should be faded out");
				func_14(uParam0, 128);
			}
			if (func_13(*uParam0, 256) && func_219(&(uParam1->f_118[0 /*5*/]), func_218(uParam1), &(uParam1->f_238), func_216(uParam1), func_205(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE CENTER STAGE LIGHT s should be faded in");
				func_14(uParam0, 256);
			}
			if (func_13(*uParam0, 512) && func_217(&(uParam1->f_118[0 /*5*/]), func_215(uParam1), &(uParam1->f_238), 0.5f, func_205(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE CENTER STAGE LIGHT s should be off");
				func_14(uParam0, 512);
			}
			if (func_13(*uParam0, 1024) && func_219(&(uParam1->f_118[0 /*5*/]), func_218(uParam1), &(uParam1->f_238), 0.5f, func_205(uParam1)))
			{
		...
		{
			if (func_13(*uParam0, 32768) && func_222(1, 2, &(uParam1->f_118), func_220(uParam1), &(uParam1->f_241), func_221(uParam1), func_205(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE RED LIGHTS should be faded out");
				func_14(uParam0, 32768);
			}
			if (func_13(*uParam0, 65536) && func_224(1, 2, &(uParam1->f_118), func_223(uParam1), &(uParam1->f_241), func_221(uParam1), func_205(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE RED LIGHTS should be faded in");
				func_14(uParam0, 65536);
			}
			if (func_13(*uParam0, 131072) && func_222(1, 2, &(uParam1->f_118), func_220(uParam1), &(uParam1->f_241), 0.5f, func_205(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE RED LIGHTS should be off");
				func_14(uParam0, 131072);
			}
			if (func_13(*uParam0, 262144) && func_224(1, 2, &(uParam1->f_118), func_223(uParam1), &(uParam1->f_241), 0.5f, func_205(uParam1)))
			{
		...
		{
			bVar0 = true;
			if (!func_206(&(uParam1->f_31), func_209(uParam1), &(uParam1->f_232), 0.1f, func_205(uParam1)))
			{
				bVar0 = false;
			}
			if (bVar0)
		...
		{
			bVar1 = true;
			if (!func_208(&(uParam1->f_31), func_211(uParam1), &(uParam1->f_232), 0.1f, func_205(uParam1)))
			{
				bVar1 = false;
			}
			if (bVar1)
	...
	if (iParam2 == 1)
	{
		...
		{
			if (func_13(*uParam0, 4194304) && func_206(&(uParam1->f_118), func_225(uParam1), &(uParam1->f_238), func_226(uParam1), func_205(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "SD MAGIC LANTERN / MOVIE Arch lights should be faded out");
				func_14(uParam0, 4194304);
			}
			if (func_13(*uParam0, 8388608) && func_208(&(uParam1->f_118), func_227(uParam1), &(uParam1->f_238), func_226(uParam1), func_205(uParam1)))
			{
...
{
	func_229(uParam0);
	func_229(&(uParam0->f_31));
	func_229(&(uParam0->f_107));
	func_229(&(uParam0->f_118));
	*uParam1 = 0;
}
...
{
	return func_230(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("VOLCYLINDER"), iParam0, iParam1);
}
...
void func_184(bool bParam0, char* sParam1, bool bParam2, bool bParam3)
{
	if (func_171(bParam0))
	{
...
bool func_193(var uParam0, bool bParam1, vector3 vParam2, int iParam5)
{
	if (uParam0->f_1 == 0)
	{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		DEBUG::_0x1B08D1EB9D8C4931(936, 201, "[SHOW_GET_LIGHT] Light not ready: ", func_240(bParam1, 0), " at position: ", &vParam2);
		return false;
	}
	uParam0->f_2 = 1f;
	return true;
...
bool func_206(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
bool func_208(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
bool func_217(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	float fVar0;
...
bool func_219(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	float fVar0;
...
bool func_222(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	float fVar2;
...
bool func_224(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	float fVar2;
...
var func_230(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	else
	{
		switch (iParam9)
		{
			case joaat("VOLCYLINDER"):
				iVar8 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_245());
				break;
			case joaat("VOLSPHERE"):
				iVar8 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_245());
				break;
			case joaat("VOLBOX"):
				iVar8 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_245());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_246(PLAYER::GET_PLAYER_TEAM(iVar5)));
	}
	...
	while (iVar2 < 32)
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(Global_1275959.f_154[iVar2]))
		{
			...
			if (!bVar3)
			{
				if (iVar9 & 8192 != 0 && func_248(iVar2) != 1)
				{
					bVar3 = true;
				}
			}
...
{
	DEBUG::_0xA308F935BDECCEC0(648, 28, "HORSE_SET_GENDER - pedHorse: ", sParam0, " eGender = ", func_250(iParam1, 0));
	if (iParam1 == 1)
	{
...
void func_241(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (uParam0->f_2 > fParam1 && uParam0->f_2 > uParam0->f_3)
		{
			...
			fVar0 = (fVar1 / fParam3);
			uParam0->f_2 = func_252(fParam1, uParam0->f_4, fVar0);
...
void func_242(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (uParam0->f_2 < fParam1 && uParam0->f_2 < uParam0->f_4)
		{
			...
			uParam0->f_2 = func_252(uParam0->f_3, fParam1, fVar0);
			if (uParam0->f_2 > fParam1)
			{
				uParam0->f_2 = fParam1;
			}
...
bool func_253(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_256(&(Global_1102630.f_4), iVar0, 5);
	}
	if (iParam1 == func_257())
	{
		return func_256(&(Global_1102630.f_4), iVar0, 5);
	...
	{
		return func_256(&(Global_1100880[iParam1 /*53*/].f_4), iVar0, 5);
	}
