...
void func_1(var uParam0, struct<2> Param1, var uParam3)
{
	...
	while (iVar2 < 56)
	{
		...
		{
			case 0:
				uParam0->f_81[iVar2] = joaat("MP005_S_AWB_C");
				break;
			case 1:
				uParam0->f_81[iVar2] = joaat("MP005_S_AWB_CB");
				break;
			case 2:
				uParam0->f_81[iVar2] = joaat("MP005_S_AWB_CR");
				break;
			case 3:
				uParam0->f_81[iVar2] = joaat("MP005_S_AWB_IW");
				break;
			case 4:
				uParam0->f_81[iVar2] = joaat("MP005_S_AWB_LDG");
				break;
			case 5:
				uParam0->f_81[iVar2] = joaat("MP005_S_AWB_OTG");
				break;
			case 6:
				uParam0->f_81[iVar2] = joaat("MP005_S_AWB_PG");
				break;
			case 7:
				uParam0->f_81[iVar2] = joaat("MP005_S_AWB_SW");
				break;
			case 8:
				uParam0->f_81[iVar2] = joaat("MP005_S_AWB_TW");
				break;
			default:
				uParam0->f_81[iVar2] = joaat("MP005_S_AWB_TW");
				break;
