...
bool func_13()
{
	...
	iLocal_13 = Global_1887351[22 /*36*/].f_5;
...
{
	iParam0 = iParam0;
	DEBUG::_0xF0783374333FD8CE(8, 11, "region init running!");
	if (!func_55())
	{
		return false;
	}
...
bool func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_23)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_77(iLocal_23));
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_78(iLocal_23, 0), 1);
					break;
			}
		}
		if (func_10(func_70()))
	...
	else
	{
		...
		if (func_45() == -1)
		{
			func_82(iLocal_23);
			func_83(iLocal_23);
			if (!func_84(iLocal_23, 0))
			{
				return false;
			}
		}
		else if (!func_85(iLocal_23))
		{
			return false;
		}
	}
...
void func_53()
{
	DEBUG::_0xF0783374333FD8CE(8, 11, "[PHRV] - SET_UP_PRONGHORN_RANCH_VOLUMES");
	DEBUG::_0xF0783374333FD8CE(8, 11, "[PHRV] - SET_UP_PRONGHORN_RANCH_VOLUMES - Bail");
	return;
}
...
bool func_54(int iParam0)
{
	...
	if (func_89(iVar1))
	{
		if (Global_1072032.f_19652.f_24 && !func_90(iParam0))
		{
			return false;
		}
...
bool func_55()
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(8, 11, "REGION_LOAD_INTERIOR_FOR_SHACK");
	sVar0 = func_91();
	vVar1 = { func_92() };
	...
	{
		DEBUG::_0xA308F935BDECCEC0(8, 11, "REGION_LOAD_INTERIOR_FOR_SHACK - setting back door active");
		INTERIOR::ACTIVATE_INTERIOR_ENTITY_SET(iVar4, sVar0, 0);
	}
	if (INTERIOR::IS_INTERIOR_ENTITY_SET_ACTIVE(iVar4, sVar0))
	{
		DEBUG::_0xA308F935BDECCEC0(8, 11, "REGION_LOAD_INTERIOR_FOR_SHACK - Loaded!");
		return true;
	}
	return false;
}
...
bool func_68(int iParam0)
{
	...
	return ((Global_1887351[iParam0 /*36*/].f_21 == 1 || Global_1887351[iParam0 /*36*/].f_21 == 2) && !func_102(iParam0));
}
...
void func_71(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_104(iParam0, 0), " ", func_105(iParam1, 0), " ", func_106(bParam2, 0), " state ", func_107(iParam4, 0));
	UNK_0x355E72323AEE83CC(11, 6);
	sVar1 = func_108(iParam0, iParam1, bParam2, iParam4, bParam5, bParam3, &bVar0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_104(iParam0, 0), " or ", func_105(iParam1, 0), " or ", func_106(bParam2, 0));
	...
	if (!func_109(iParam4))
	{
		if (func_62(iParam0))
		{
			iParam4 = func_110(func_9(iParam0));
		}
		else
		{
	...
	if (bVar0 && bParam3)
	{
		sVar2 = func_113(func_112(bParam2));
	}
	else if ((func_114(iParam1, 2) || func_115(iParam4, 2)) && !Global_1893599.f_9)
	{
	...
	Global_1939313.f_145 = func_121(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
int func_99(int iParam0, bool bParam1)
{
	if (!func_97(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_137(iParam0), " is invalid");
		return 0;
	}
	if (!func_129(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_137(iParam0), " has not been initialized");
		return 0;
	}
	if (func_129(iParam0, 32) && !bParam1)
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_137(iParam0), " has been locked dead");
		...
		if (func_45() == -1)
		{
			if (func_129(iParam0, 2048))
			{
				...
				DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_137(iParam0), " has been revived!");
			}
	...
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_137(iParam0), " dead or not spawning, turn scenario groups off");
		return 0;
	}
	if (PERSCHAR::_0x800DF3FC913355F3(func_140(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Persistent character ", func_137(iParam0), " already exists");
		func_141(iParam0, 128);
		return 1;
	}
	func_139(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_138(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_140(iParam0));
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_137(iParam0), " perschar index created!");
	if (func_129(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_140(iParam0));
		func_141(iParam0, 2048);
	...
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_137(iParam0), " created.");
...
char* func_108(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;
...
void func_126()
{
	...
	DEBUG::_0xA308F935BDECCEC0(8, 11, "REGION_UNLOAD_INTERIOR_FOR_SHACK - !");
	sVar0 = func_91();
	vVar1 = { func_92() };
	if (!INTERIOR::IS_VALID_INTERIOR(iVar4))
	{
...
void func_128(int iParam0)
{
	...
	if (func_97(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_158(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
...
int func_130(int iParam0, bool bParam1)
{
	if (!func_97(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_137(iParam0), " is invalid");
		return 0;
	}
	if (!func_129(iParam0, 2))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_137(iParam0), " has not been initialized");
		return 0;
	}
	if (func_138(iParam0) == 0)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_137(iParam0), " doesn't exist");
		return 1;
	}
	if (!PERSCHAR::_0x800DF3FC913355F3(func_140(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_137(iParam0), " already destroyed");
		return 1;
	}
	if (func_129(iParam0, 1) && !bParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_137(iParam0), " is stolen, so it will be destoyed on release.");
		func_166(iParam0, 128);
		return 1;
	}
	func_141(iParam0, 129);
	func_167(iParam0);
	DEBUG::_0xA308F935BDECCEC0(40, 138, "DESTROY_REGIONAL_CHARACTER: Destroying ", func_137(iParam0));
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_140(iParam0));
	func_139(iParam0, 0);
	DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: ", func_137(iParam0), " destroyed.");
	return 1;
}
...
void func_141(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_183(iParam1), " on ", func_137(iParam0));
}
...
bool func_142(int iParam0)
{
	...
	if (!func_129(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_137(iParam0), " has not been initialized");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(40, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_137(iParam0));
	return true;
}
...
bool func_145(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_186(func_59(0)))
	{
		return true;
	}
...
void func_159(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that isnt stolen ", func_137(iParam0));
		return;
	}
	if (!func_129(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release an uninitialized regional character ", func_137(iParam0));
		return;
	}
	if ((!bParam4 && !func_158(iParam0)) && func_193(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that is stolen by a differnt script ", func_137(iParam0));
		return;
	}
	DEBUG::_0xF0783374333FD8CE(680, 138, "RELEASE_REGIONAL_CHARACTER: Regional character ", func_137(iParam0), " released by ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
	func_141(iParam0, 1);
	func_167(iParam0);
	if (func_194(func_138(iParam0)))
	{
		iVar0 = func_140(iParam0);
		if (!PERSCHAR::_0x800DF3FC913355F3(iVar0))
		{
			DEBUG::_0x9A6C65DDDBEC9C52(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character with no perschar index", func_137(iParam0));
			return;
		}
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being retasked ", func_137(iParam0));
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being destroyed on release ", func_137(iParam0));
		func_130(iParam0, 0);
	}
}
...
{
	if (func_201(bParam0) && func_202())
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 183, "RELEASE_DOOR_ID - Releasing Door ID ", func_203(bParam0, 0));
...
void func_166(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_183(iParam1), " on ", func_137(iParam0));
}
...
void func_167(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar0, false))
		{
			...
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_137(iParam0), " set as no longer needed.");
		}
		else
		{
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_137(iParam0), " was asked to be set as no longer needed, but this script does not own the ped.");
		}
	}
...
void func_177(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_175(iParam0), " flag ", func_206(iParam1));
	}
	Global_1051777.f_80[iParam0 /*75*/].f_1 = (Global_1051777.f_80[iParam0 /*75*/].f_1 - (Global_1051777.f_80[iParam0 /*75*/].f_1 && iParam1));
}
...
{
	return func_207(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}
...
int func_212(int iParam0)
{
	...
	DEBUG::_0xD9911C7B5F8CD69C(168, 139, "GET_SHOP_TYPE_FROM_SHOP - ", func_205(iParam0, 0), " undefined");
	return -1;
}
