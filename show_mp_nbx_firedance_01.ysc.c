...
bool func_22(var uParam0)
{
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		...
		if (!ANIMSCENE::_DOES_ANIM_SCENE_EXIST(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[SETUP_SHOW_ASSETS] Creating anim scene - script@shows@fire_performer@act1_p1@action");
	...
	DEBUG::_0xA308F935BDECCEC0(8, 201, "[SETUP_SHOW_ASSETS] requesting Clip - script_shows@fireperformer@act1_p1");
...
bool func_26(var uParam0)
{
	...
	if (!uParam0->f_1357 && !uParam0->f_1559)
	{
		...
		if (!func_97(&(uParam0->f_1384), uParam0->f_1383, uParam0->f_1370))
		{
			DEBUG::_0x4DC69742196F818A(8, 201, "[CUSTOM_CREATE_SHOW_ASSETS_NEW] Curtains not created");
			return false;
		}
		if (!func_99(&(uParam0->f_1375), &(uParam0->f_1376), &(uParam0->f_1358), func_88(), func_98(0), 1))
		{
		...
		if (!func_85(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1376), func_98(1), func_88()))
		{
	...
	while (iVar0 <= 5)
	{
		...
		{
			if (!func_100(&(uParam0->f_1408[iVar0]), uParam0->f_1401[iVar0], uParam0->f_1367, 0f))
			{
...
{
	DEBUG::_0x4DC69742196F818A(680, 201, "[GSMP_HOST_IS_FLAG_SET] Client Host ", func_82(uParam0->f_11, 0), " Set: ", MISC::_0xF216F74101968DB0(func_107(uParam0->f_11, iParam1)));
	return func_107(uParam0->f_11, iParam1);
}
...
void func_33(var uParam0, int iParam1)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 201, "[GSMP_SHOW_HOST_PROJECTIONIST_UPDATE] -- STATE: ", func_108(*uParam0, 0));
	switch (*uParam0)
	{
		case 0:
			func_109(uParam0, 1);
			break;
		case 1:
			if (!STREAMING::HAS_MODEL_LOADED(func_110()) || !STREAMING::HAS_MODEL_LOADED(func_111(0)))
			{
			...
			{
				uParam0->f_2 = func_114(func_110(), func_112(uParam0->f_1), func_113(uParam0->f_1), 1, 1, 1, 1, 1, 1, 0, 0);
			...
			{
				iVar1 = iVar0;
				uParam0->f_3[iVar0] = OBJECT::CREATE_OBJECT(func_111(iVar1), func_115(iVar1), true, true, false, false, true);
		...
		case 2:
			...
			{
				uParam0->f_9 = ANIMSCENE::_CREATE_ANIM_SCENE(func_116(iParam1), 0, func_117(iParam1, 0), true, true);
				ANIMSCENE::LOAD_ANIM_SCENE(uParam0->f_9);
				ANIMSCENE::SET_ANIM_SCENE_ORIGIN(uParam0->f_9, func_118(iParam1), func_119(iParam1), 2);
				DEBUG::_0xA308F935BDECCEC0(40, 201, "Load anim scene called on for: ", func_116(iParam1));
			}
		...
		case 3:
			...
			break;
		case 4:
			if (!ANIMSCENE::_0x1F0E401031E20146(uParam0->f_9, func_117(iParam1, 1)) || !ANIMSCENE::_0x23E33CB9F4A3F547(uParam0->f_9, func_117(iParam1, 1)))
			{
				return;
			}
			func_109(uParam0, 5);
...
void func_40(var uParam0, var uParam1, var uParam2)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(8, 201, "[fireDance_01][CUSTOM_UPDATE] -- ");
	if (!ANIMSCENE::_DOES_ANIM_SCENE_EXIST(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)))
	{
		DEBUG::_0xA308F935BDECCEC0(8, 201, "[fireDance_01][CUSTOM_UPDATE] ANIM SCENE DOES NOT EXIST - EXITING");
		return;
	}
	fVar0 = ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374));
	DEBUG::_0x1B08D1EB9D8C4931(24, 201, "[fireDance_01][CUSTOM_UPDATE] fPhase: ", fVar0);
	DEBUG::_0x4DC69742196F818A(40, 201, "[fireDance_01][CUSTOM_UPDATE] Anim Scene Running: ", MISC::_0xF216F74101968DB0(ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false)));
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		func_125(uParam0, uParam1, uParam2, fVar0);
	}
...
void func_47(int iParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		if (bVar1 != 0)
		{
			if (!func_131(bVar1) && !func_132(bVar1))
			{
				func_133(bVar1, 1, 0, 0, 0, 0, 0, 0);
			}
		}
		iVar0++;
	}
...
{
	if (func_135(Global_33, uParam0->f_9, 0, 1, 0))
	{
		func_54(uParam1[uParam2->f_1 /*18*/], 1);
	}
	else if (func_70(uParam1[uParam2->f_1 /*18*/], 1))
	{
		func_136(uParam1[uParam2->f_1 /*18*/], 1);
	}
	if (func_135(Global_33, uParam0->f_10, 0, 1, 0))
	{
		func_54(uParam1[uParam2->f_1 /*18*/], 2);
	}
	else if (func_70(uParam1[uParam2->f_1 /*18*/], 2))
	{
		func_136(uParam1[uParam2->f_1 /*18*/], 2);
	}
}
...
void func_50(var uParam0, var uParam1)
{
	...
	while (iVar0 <= 2)
	{
		...
		{
			if (!func_137(&(uParam0->f_12[iVar0 /*3*/]), &(uParam1->f_3[iVar0 /*3*/])))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_LOAD_PLAYLIST_CLIENT] playlists do not match.");
				func_138(&(uParam0->f_12[iVar0 /*3*/]), &(uParam1->f_3[iVar0 /*3*/]));
			}
...
{
	func_139(&(uParam1->f_2), &(uParam1->f_247), uParam0->f_2);
	func_140(&(uParam1->f_247), &(uParam1->f_2), uParam0->f_2);
}
...
void func_58(var uParam0, var uParam1, int iParam2)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 201, "[GSMP_SHOW_CLIENT_PROJECTIONIST_UPDATE] -- STATE: ", func_142(*uParam1, 0));
	...
	{
		case 0:
			STREAMING::REQUEST_MODEL(func_110(), false);
			STREAMING::REQUEST_MODEL(func_111(0), false);
		...
		case 3:
			if ((ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_9) && ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_9, true, false)) && NETWORK::_NETWORK_HAS_CONTROL_OF_ANIM_SCENE(uParam0->f_9))
			{
				...
				ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_9, func_144(iParam2), uParam0->f_2, 0);
				iVar0 = 0;
				while (iVar0 <= (5 - 1))
				{
					ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_9, func_145(iParam2, iVar0), uParam0->f_3[iVar0], 0);
					iVar0++;
				}
		...
		case 4:
			...
			{
				if (!ANIMSCENE::_0x1F0E401031E20146(uParam0->f_9, func_117(iParam2, 1)))
				{
					DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_CLIENT_PROJECTIONIST_UPDATE][STATE_UPDATE][OWNER] Anim scene play list not active");
					if (!ANIMSCENE::_0x23E33CB9F4A3F547(uParam0->f_9, func_117(iParam2, 1)))
					{
						...
						ANIMSCENE::_0xDF7B5144E25CD3FE(uParam0->f_9, func_117(iParam2, 1));
					}
					else
					{
						DEBUG::_0xA308F935BDECCEC0(8, 201, "[GSMP_SHOW_CLIENT_PROJECTIONIST_UPDATE][STATE_UPDATE][OWNER] LOADED - SET_ANIM_SCENE_PLAY_LIST");
						ANIMSCENE::_SET_ANIM_SCENE_PLAYBACK_LIST_BOOL(uParam0->f_9, func_117(iParam2, 1), true);
					}
				}
			}
			if (!ANIMSCENE::_0x1F0E401031E20146(uParam0->f_9, func_117(iParam2, 1)) || !ANIMSCENE::_0x23E33CB9F4A3F547(uParam0->f_9, func_117(iParam2, 1)))
			{
...
{
	DEBUG::_0x4DC69742196F818A(680, 201, "[GSMP_CLIENT_IS_FLAG_SET] Client Flag ", func_80(iParam1, 0), " Set: ", MISC::_0xF216F74101968DB0(func_107(uParam0->f_13, iParam1)));
	return func_107(uParam0->f_13, iParam1);
}
...
void func_72(var uParam0, var uParam1)
{
	...
	if (!uParam0->f_1357)
	{
		func_153(&(uParam1->f_2), &(uParam1->f_247));
	}
	if (!uParam0->f_4)
	{
		func_47(uParam0->f_1350);
...
void func_74(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 201, "GSMP_HOST_END_SHOW -- Theater: ", func_154(iParam0, 0));
	Var0.f_6 = -1;
	Var0.f_4 = 1;
	Var0.f_6 = iParam0;
	Var0 = 31;
...
{
	DEBUG::_0xA308F935BDECCEC0(680, 201, "[SHOW_CHANGE_CURTAIN_STATE] old state: ", func_157(*uParam0, 0), " new state: ", func_157(iParam1, 0));
	*uParam0 = iParam1;
}
...
bool func_96(var uParam0)
{
	...
	else if (func_158(&(uParam0->f_1363)) > 10f)
	{
...
bool func_97(var uParam0, bool bParam1, vector3 vParam2)
{
...
bool func_99(var uParam0, var uParam1, var uParam2, char* sParam3, char* sParam4, bool bParam5)
{
...
bool func_100(var uParam0, bool bParam1, vector3 vParam2, float fParam5)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	{
		*uParam0 = func_114(bParam1, vParam2, fParam5, 1, 1, 0, 1, 1, bVar0, 0, bVar1);
		return false;
	}
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0) && PED::_0xA0BC8FAED8CFEB3C(*uParam0))
	{
		if (!bVar0)
		{
			func_161(*uParam0, bVar2);
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CREATE_SHOW_PED] yes we are setting the outfit");
		}
		DEBUG::_0xA308F935BDECCEC0(40, 201, "[CREATE_SHOW_PED] ped is being created with a custom outfit: ", func_162(bVar2, 0));
		return true;
	}
	return false;
}
...
bool func_101(var uParam0)
{
	...
	{
		if (func_163(&(uParam0->f_1393[0]), uParam0->f_1385[0], 2543.663f, -1308.578f, 49.0058f))
		{
	...
	{
		if (func_163(&(uParam0->f_1393[1]), uParam0->f_1385[1], 2548.551f, -1308.547f, 48.2211f))
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "lantern", uParam0->f_1393[1], 0);
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] lantern INDEX: ", uParam0->f_1393[1]);
		}
		else
		{
			return false;
	...
	{
		if (func_163(&(uParam0->f_1393[2]), uParam0->f_1385[2], 2553.659f, -1313.054f, 48.2166f))
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "BATON", uParam0->f_1393[2], 0);
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] BATON INDEX: ", uParam0->f_1393[2]);
		}
		else
		{
			return false;
	...
	{
		if (func_163(&(uParam0->f_1393[3]), uParam0->f_1385[3], 2543.673f, -1308.602f, 48.2201f))
		{
	...
	if ((NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(uParam0->f_1408[0]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_1408[0])) && STREAMING::HAS_CLIP_SET_LOADED("script_shows@fireperformer@act1_p1"))
	{
		...
		DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] PERFORMER INDEX: ", uParam0->f_1408[0]);
	}
	else
	{
		return false;
...
void func_106(bool bParam0, int iParam1, bool bParam2)
{
	func_166(bParam0, 0, 0);
	if (func_167(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != iParam1 || bParam2)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(680, 183, "SET_DOORSTATE_OF_DOOR_ID - Setting Door ID ", func_168(bParam0, 0), " to ", func_169(iParam1, 0));
...
{
	DEBUG::_0xA308F935BDECCEC0(680, 201, "[GSMP_SHOW_PROJECTIONIST_CHANGE_STATE] current state: ", func_108(*uParam0, 0), " new state: ", func_108(iParam1, 0));
	*uParam0 = iParam1;
}
...
int func_114(bool bParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12)
{
	int iVar0;
	...
	func_170(iVar0, bParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
char* func_117(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 201, "Projectionist playlist: ", func_171(iParam1, 0), " show: ", func_172(iParam0, 0));
...
void func_125(var uParam0, var uParam1, var uParam2, float fParam3)
{
	DEBUG::_0x1B08D1EB9D8C4931(40, 201, "[fireDance_01][CUSTOM_UPDATE_HOST] -- STATE: ", func_173(uParam0->f_1, 0));
	switch (uParam0->f_1)
	{
		case 0:
		...
		case 32:
			if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false))
			{
				...
				uParam0->f_3 = 1;
				func_91(uParam0, 1);
				func_174(&(uParam0->f_1), 33);
			}
			break;
		case 33:
			func_174(&(uParam0->f_1), 34);
			break;
		case 34:
			...
			{
				func_174(&(uParam0->f_1), 37);
			}
			break;
		case 37:
			uParam0->f_5 = 1;
			func_91(uParam0, 2);
			func_175(&(uParam0->f_27), 0);
			func_18(&(uParam0->f_1358), 8388608);
			func_174(&(uParam0->f_1), 40);
			break;
		case 40:
			break;
	}
...
{
	DEBUG::_0x1B08D1EB9D8C4931(40, 201, "[fireDance_01][CUSTOM_UPDATE_CLIENT] -- STATE: ", func_173((uParam1[uParam2->f_1 /*18*/])->f_17, 0));
	switch ((uParam1[uParam2->f_1 /*18*/])->f_17)
	{
		case 0:
			func_176(&((uParam1[uParam2->f_1 /*18*/])->f_17), 32);
			break;
		case 32:
			if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false))
			{
			...
			if (uParam0->f_1 > 32)
			{
				func_176(&((uParam1[uParam2->f_1 /*18*/])->f_17), 33);
			}
			break;
		case 33:
			if (uParam0->f_1 > 33)
			{
				func_176(&((uParam1[uParam2->f_1 /*18*/])->f_17), 34);
			}
			break;
		case 34:
			if ((fParam3 > 0.9f && !func_13(*uParam2, 1)) && AUDIO::LOAD_STREAM(func_177(3), func_178()))
			{
				func_18(uParam2, 1);
			}
			if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)) > 0.978f)
			{
				...
				{
					AUDIO::PLAY_STREAM_FROM_POSITION(2552.53f, -1310.069f, 49.21665f, AUDIO::_0x0556C784FA056628(func_177(3), func_178()));
				}
				func_176(&((uParam1[uParam2->f_1 /*18*/])->f_17), 37);
			}
			break;
		case 37:
			if (!func_13(uParam0->f_1358, 8388608))
			...
			func_18(&(uParam2->f_247), 32);
			func_176(&((uParam1[uParam2->f_1 /*18*/])->f_17), 40);
			break;
		case 40:
			break;
	}
...
void func_130(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 218, "CLEAR_WORLD_STATE_FLAG: clearing world state - ", func_180(iParam0, 0));
	Global_1939807 = 0;
}
...
{
	return func_181(bParam0, 23);
}

void func_133(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	func_166(bParam0, 0, 0);
	if (func_167(bParam0))
	{
		...
		if (bParam3)
		{
			func_182(bParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
			{
				func_183(bParam0, 1);
				UNK_0x355E72323AEE83CC(183, 9);
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking Door ID ", func_168(bParam0, 0));
			}
			else
			{
				func_184(bParam0, 1);
				UNK_0x355E72323AEE83CC(183, 9);
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking and making unbreakable Door ID ", func_168(bParam0, 0));
			}
		}
		else
		{
			func_185(bParam0, 1);
			UNK_0x355E72323AEE83CC(183, 9);
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Unlocking Door ID ", func_168(bParam0, 0));
		}
		if (bParam7)
		{
			DEBUG::_0x1B08D1EB9D8C4931(168, 183, "SET_STATE_OF_DOOR_ID - Treating Door ID ", func_168(bParam0, 0), " as shut.");
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 183, "SET_STATE_OF_DOOR_ID: Door with ID not registered by host yet ", func_168(bParam0, 0));
	}
}
...
bool func_135(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
...
int func_139(var uParam0, var uParam1, int iParam2)
{
	...
	if (!func_13(*uParam1, 1))
	{
		...
		{
			iVar3 = iVar0;
			if (func_191(uParam0[iVar0 /*5*/], func_189(iParam2), func_190(iParam2, iVar3), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 8))
	{
		...
		{
			iVar4 = iVar0;
			if (func_191(&(uParam0->f_31[iVar0 /*5*/]), func_193(iParam2), func_194(iParam2, iVar4), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 2048))
	{
		...
		{
			iVar5 = iVar0;
			if (func_191(&(uParam0->f_107[iVar0 /*5*/]), func_196(iParam2), func_197(iParam2, iVar5), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
	...
	{
		case 0:
			if (!func_13(*uParam1, 64) && func_191(&(uParam0->f_118[0 /*5*/]), func_198(iParam2, 0), func_199(iParam2, 0), 1065353216 /* Float: 1f */))
			{
				func_18(uParam1, 64);
			}
			if ((!func_13(*uParam1, 16384) && func_191(&(uParam0->f_118[1 /*5*/]), func_198(iParam2, 1), func_199(iParam2, 1), 1065353216 /* Float: 1f */)) && func_191(&(uParam0->f_118[2 /*5*/]), func_198(iParam2, 2), func_199(iParam2, 2), 1065353216 /* Float: 1f */))
			{
		...
		case 1:
			...
			if (!func_13(*uParam1, 2097152))
			{
				...
				{
					iVar6 = iVar0;
					if (func_191(&(uParam0->f_118[iVar0 /*5*/]), func_198(iParam2, 0), func_199(iParam2, iVar6), 1065353216 /* Float: 1f */))
					{
						iVar2++;
					}
					iVar0++;
...
void func_140(var uParam0, var uParam1, int iParam2)
{
	...
	{
		if (func_13(*uParam0, 2) && func_204(uParam1, func_201(uParam1), &(uParam1->f_229), func_202(uParam1), func_203(uParam1)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "WALL LIGHTS should be faded out");
			func_14(uParam0, 2);
		}
		if (func_13(*uParam0, 4) && func_206(uParam1, func_205(uParam1), &(uParam1->f_229), func_202(uParam1), func_203(uParam1)))
		{
	...
	{
		if (func_13(*uParam0, 16) && func_204(&(uParam1->f_31), func_207(uParam1), &(uParam1->f_232), func_208(uParam1), func_203(uParam1)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "STAGE LIGHTS should be faded out");
			func_14(uParam0, 16);
		}
		if (func_13(*uParam0, 32) && func_206(&(uParam1->f_31), func_209(uParam1), &(uParam1->f_232), func_208(uParam1), func_203(uParam1)))
		{
	...
	{
		if (func_13(*uParam0, 4096) && func_204(&(uParam1->f_107), func_210(uParam1), &(uParam1->f_235), func_211(uParam1), func_203(uParam1)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "BALCONY LIGHTS should be faded out");
			func_14(uParam0, 4096);
		}
		if (func_13(*uParam0, 8192) && func_206(&(uParam1->f_107), func_212(uParam1), &(uParam1->f_235), func_211(uParam1), func_203(uParam1)))
		{
	...
	if (iParam2 == 0)
	{
		...
		{
			if (func_13(*uParam0, 128) && func_215(&(uParam1->f_118[0 /*5*/]), func_213(uParam1), &(uParam1->f_238), func_214(uParam1), func_203(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE CENTER STAGE LIGHT should be faded out");
				func_14(uParam0, 128);
			}
			if (func_13(*uParam0, 256) && func_217(&(uParam1->f_118[0 /*5*/]), func_216(uParam1), &(uParam1->f_238), func_214(uParam1), func_203(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE CENTER STAGE LIGHT s should be faded in");
				func_14(uParam0, 256);
			}
			if (func_13(*uParam0, 512) && func_215(&(uParam1->f_118[0 /*5*/]), func_213(uParam1), &(uParam1->f_238), 0.5f, func_203(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE CENTER STAGE LIGHT s should be off");
				func_14(uParam0, 512);
			}
			if (func_13(*uParam0, 1024) && func_217(&(uParam1->f_118[0 /*5*/]), func_216(uParam1), &(uParam1->f_238), 0.5f, func_203(uParam1)))
			{
		...
		{
			if (func_13(*uParam0, 32768) && func_220(1, 2, &(uParam1->f_118), func_218(uParam1), &(uParam1->f_241), func_219(uParam1), func_203(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE RED LIGHTS should be faded out");
				func_14(uParam0, 32768);
			}
			if (func_13(*uParam0, 65536) && func_222(1, 2, &(uParam1->f_118), func_221(uParam1), &(uParam1->f_241), func_219(uParam1), func_203(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE RED LIGHTS should be faded in");
				func_14(uParam0, 65536);
			}
			if (func_13(*uParam0, 131072) && func_220(1, 2, &(uParam1->f_118), func_218(uParam1), &(uParam1->f_241), 0.5f, func_203(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE RED LIGHTS should be off");
				func_14(uParam0, 131072);
			}
			if (func_13(*uParam0, 262144) && func_222(1, 2, &(uParam1->f_118), func_221(uParam1), &(uParam1->f_241), 0.5f, func_203(uParam1)))
			{
		...
		{
			bVar0 = true;
			if (!func_204(&(uParam1->f_31), func_207(uParam1), &(uParam1->f_232), 0.1f, func_203(uParam1)))
			{
				bVar0 = false;
			}
			if (bVar0)
		...
		{
			bVar1 = true;
			if (!func_206(&(uParam1->f_31), func_209(uParam1), &(uParam1->f_232), 0.1f, func_203(uParam1)))
			{
				bVar1 = false;
			}
			if (bVar1)
	...
	if (iParam2 == 1)
	{
		...
		{
			if (func_13(*uParam0, 4194304) && func_204(&(uParam1->f_118), func_223(uParam1), &(uParam1->f_238), func_224(uParam1), func_203(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "SD MAGIC LANTERN / MOVIE Arch lights should be faded out");
				func_14(uParam0, 4194304);
			}
			if (func_13(*uParam0, 8388608) && func_206(&(uParam1->f_118), func_225(uParam1), &(uParam1->f_238), func_224(uParam1), func_203(uParam1)))
			{
...
{
	DEBUG::_0xF0783374333FD8CE(136, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] : preparing show scene = ", uParam0->f_1373, " Currnetly Does nothing");
}
...
{
	DEBUG::_0xA308F935BDECCEC0(680, 201, "[GSMP_SHOW_HOST_PROJECTIONIST_CHANGE_STATE] current state: ", func_142(*uParam0, 0), " new state: ", func_142(iParam1, 0));
	*uParam0 = iParam1;
}
...
{
	func_227(uParam0);
	func_227(&(uParam0->f_31));
	func_227(&(uParam0->f_107));
	func_227(&(uParam0->f_118));
	*uParam1 = 0;
}
...
{
	return func_228(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("VOLCYLINDER"), iParam0, iParam1);
}
...
void func_161(int iParam0, bool bParam1)
{
	...
	{
		DEBUG::_0x4DC69742196F818A(680, 131, "SWITCH_PED_TO_OUTFIT: Swapping to metaped outfit ", func_162(bParam1, 0), " for ped: ", UNK_0x1B7C373FB4E76B85(ENTITY::GET_ENTITY_MODEL(iParam0)));
		if (func_229(iParam0, bParam1))
		{
			if (func_230(iParam0, bParam1))
			{
				if (func_231(iParam0, bParam1))
				{
					...
					func_232(iParam0);
					DEBUG::_0xF0783374333FD8CE(680, 131, "SWITCH_PED_TO_OUTFIT: Successfullly applied requested metaped outfit ", func_162(bParam1, 0), " for: ", UNK_0x1B7C373FB4E76B85(ENTITY::GET_ENTITY_MODEL(iParam0)));
				}
			}
			else
			{
				...
				DEBUG::_0xF0783374333FD8CE(680, 131, "SWITCH_PED_TO_OUTFIT: Successfullly applied NON-requested outfit ", func_162(bParam1, 0), " for: ", UNK_0x1B7C373FB4E76B85(ENTITY::GET_ENTITY_MODEL(iParam0)));
			}
		...
		{
			DEBUG::_0x4DC69742196F818A(680, 131, "SWITCH_PED_TO_OUTFIT: Ped DOES NOT have outfit ", func_162(bParam1, 0), " : ", UNK_0x1B7C373FB4E76B85(ENTITY::GET_ENTITY_MODEL(iParam0)));
		}
	}
	else
	{
...
var func_162(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
bool func_163(var uParam0, bool bParam1, vector3 vParam2)
{
	if (!STREAMING::HAS_MODEL_LOADED(bParam1))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 201, "[CREATE_SHOW_OBJECT] OBJECT MODEL WAS NOT LOADED - ", UNK_0x1B7C373FB4E76B85(bParam1));
...
bool func_166(bool bParam0, bool bParam1, bool bParam2)
{
	if (!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(bParam0))
	{
		if ((NETWORK::NETWORK_IS_IN_SESSION() && SCRIPTS::_DOES_THREAD_EXIST(Global_1051590.f_16[0])) && bParam1)
		{
			...
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add networked Door ", func_168(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
		else
		{
			OBJECT::_ADD_DOOR_TO_SYSTEM_NEW(bParam0, true, false, false, 0, 0, false);
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add Door ", func_168(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
	}
	...
	if (bParam2)
	{
		...
		DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Set door ", func_168(bParam0, 0), " able to change open ratio while locked");
		UNK_0x355E72323AEE83CC(183, 7);
	}
	return bParam0;
}
...
void func_170(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
{
	DEBUG::_0xA308F935BDECCEC0(680, 201, "[GSMP_SET_INDIVIDUAL_SHOW_STATE_HOST] Changing from STATE: ,", func_173(*uParam0, 0), " TO STATE: ", func_173(iParam1, 0));
	*uParam0 = iParam1;
}
...
{
	DEBUG::_0xA308F935BDECCEC0(680, 201, "[GSMP_SET_INDIVIDUAL_SHOW_STATE_CLIENT] Changing from STATE: ,", func_173(*uParam0, 0), " TO STATE: ", func_173(iParam1, 0));
	*uParam0 = iParam1;
}
...
void func_182(bool bParam0, char* sParam1, bool bParam2, bool bParam3)
{
	if (func_167(bParam0))
	{
...
void func_183(bool bParam0, bool bParam1)
{
	if (func_167(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 2 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "LOCK_DOOR_ID - Locking Door ID ", func_168(bParam0, 0));
		}
	}
	else
	{
...
void func_184(bool bParam0, bool bParam1)
{
	if (func_167(bParam0))
	{
		...
		{
			DEBUG::_0x1B08D1EB9D8C4931(2216, 183, "SET_DOOR_ID_LOCKED_AND_UNBREAKABLE - Door ID ", func_168(bParam0, 0), " state = ", OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0), " pending state ", UNK_0x4BC2854478F3A749(bParam0));
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(bParam0, 1);
		}
	}
	else
...
void func_185(bool bParam0, bool bParam1)
{
	if (func_167(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 0 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "UNLOCK_DOOR_ID - Unlocking Door ID ", func_168(bParam0, 0));
		}
	}
	else
	{
...
bool func_191(var uParam0, bool bParam1, vector3 vParam2, int iParam5)
{
	if (uParam0->f_1 == 0)
	{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		DEBUG::_0x1B08D1EB9D8C4931(936, 201, "[SHOW_GET_LIGHT] Light not ready: ", func_238(bParam1, 0), " at position: ", &vParam2);
		return false;
	}
	uParam0->f_2 = 1f;
	return true;
...
bool func_204(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	...
	fVar1 = func_158(uParam2);
	iVar0 = 0;
	while (iVar0 <= (*uParam0 - 1))
	{
		func_239(uParam0[iVar0 /*5*/], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_215(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	float fVar0;
	...
	fVar0 = func_158(uParam2);
	func_239(uParam0, fParam1, fVar0, fParam3, iParam4);
	if (fVar0 >= fParam3)
	{
		func_159(uParam2);
		return true;
...
bool func_220(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	fVar2 = func_158(uParam4);
	iVar3 = iVar0;
	while (iVar3 <= iVar1)
	{
		func_239(uParam2[iVar3 /*5*/], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
var func_228(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	else
	{
		switch (iParam9)
		{
			case joaat("VOLCYLINDER"):
				iVar8 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_243());
				break;
			case joaat("VOLSPHERE"):
				iVar8 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_243());
				break;
			case joaat("VOLBOX"):
				iVar8 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_243());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_244(PLAYER::GET_PLAYER_TEAM(iVar5)));
	}
...
bool func_229(int iParam0, bool bParam1)
{
	...
	if (bVar0)
	{
		DEBUG::_0x1B08D1EB9D8C4931(2696, 131, "DOES_PED_HAVE_META_PED_OUTFIT: Ped[", iParam0, "] does have metaped outfit[", func_162(bParam1, 0), "]");
	}
	else
	{
		DEBUG::_0x1B08D1EB9D8C4931(2696, 131, "DOES_PED_HAVE_META_PED_OUTFIT: Ped[", iParam0, "] does NOT have metaped outfit[", func_162(bParam1, 0), "]");
	}
	return bVar0;
}
...
{
	DEBUG::_0xA308F935BDECCEC0(648, 28, "HORSE_SET_GENDER - pedHorse: ", sParam0, " eGender = ", func_248(iParam1, 0));
	if (iParam1 == 1)
	{
...
void func_239(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (uParam0->f_2 > fParam1 && uParam0->f_2 > uParam0->f_3)
		{
			...
			fVar0 = (fVar1 / fParam3);
			uParam0->f_2 = func_250(fParam1, uParam0->f_4, fVar0);
...
void func_240(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (uParam0->f_2 < fParam1 && uParam0->f_2 < uParam0->f_4)
		{
			...
			uParam0->f_2 = func_250(uParam0->f_3, fParam1, fVar0);
			if (uParam0->f_2 > fParam1)
			{
				uParam0->f_2 = fParam1;
			}
...
bool func_251(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_254(&(Global_1102630.f_4), iVar0, 5);
	}
	if (iParam1 == func_255())
	{
		return func_254(&(Global_1102630.f_4), iVar0, 5);
	...
	{
		return func_254(&(Global_1100880[iParam1 /*53*/].f_4), iVar0, 5);
	}
