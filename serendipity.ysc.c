...
void __EntryFunction__()
{
	...
	DEBUG::_0xF0783374333FD8CE(43688, 17, "**** INITIALIZING REGION: ", &(Global_1887351[vScriptParam_0.x /*36*/].f_23), ", ", &(Global_1887351[iLocal_52 /*36*/].f_24), ", ", &(Global_1887351[iLocal_52 /*36*/].f_27), " ****");
	func_2();
	func_3();
	...
	while (func_4())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_51)
		{
			...
			{
				case 0:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_52 /*36*/].f_23), " global init...");
					if (Global_1901988.f_1.f_26 > 0)
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_52 /*36*/].f_23), "-> RBS_WAIT_FOR_UGC_EARLY_QUIT");
						iLocal_53 = (MISC::GET_GAME_TIMER() + Global_1901988.f_1.f_26);
						iLocal_50 = 1;
					}
					else
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_52 /*36*/].f_23), "-> RBS_INIT_REGION");
						iLocal_50 = 2;
					}
					break;
				case 1:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_52 /*36*/].f_23), " ugc early quit...");
					...
					break;
				case 2:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_52 /*36*/].f_23), " region init...");
					func_6(iLocal_52);
					func_7();
					func_8();
					...
					Global_1896632 = -1;
					DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_52 /*36*/].f_23), "-> RBS_INIT_VOLUME");
					iLocal_53 = (iLocal_49 + MISC::GET_GAME_TIMER());
					iLocal_50 = 3;
					break;
				case 3:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_52 /*36*/].f_23), " volume init...");
					if (func_13() || iLocal_53 < MISC::GET_GAME_TIMER())
					{
						func_14(iLocal_52);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_52 /*36*/].f_23), "-> RBS_LOAD_APPEARANCE");
						iLocal_53 = (MISC::GET_GAME_TIMER() + iLocal_49);
						iLocal_50 = 4;
					}
					break;
				case 4:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_52 /*36*/].f_23), " load appearance...");
					if (func_15(iLocal_52) || iLocal_53 < MISC::GET_GAME_TIMER())
					{
						func_16(iLocal_52);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_52 /*36*/].f_23), "-> RBS_LOAD_SPECIAL");
						iLocal_53 = (MISC::GET_GAME_TIMER() + iLocal_49);
						iLocal_50 = 5;
					}
					break;
				case 5:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_52 /*36*/].f_23), " load special...");
					if (func_17(iLocal_52) || iLocal_53 < MISC::GET_GAME_TIMER())
					{
						func_18(iLocal_52);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_52 /*36*/].f_23), "-> RBS_LOAD_PERS_CHARS");
						iLocal_53 = (iLocal_49 + MISC::GET_GAME_TIMER());
						iLocal_50 = 7;
					}
					break;
				case 7:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_52 /*36*/].f_23), " init regional chars...");
					if (func_10(func_9(iLocal_52)))
					{
						...
						else
						{
							if (func_20(iLocal_52) || iLocal_53 < MISC::GET_GAME_TIMER())
							{
								func_21(iLocal_52, 4);
								iLocal_53 = (MISC::GET_GAME_TIMER() + iLocal_49);
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_52 /*36*/].f_23), "-> RBS_INIT_AMBIENT");
								iLocal_50 = 8;
							}
							...
							{
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_52 /*36*/].f_23), " AMBIENT MINIGAMES ARE NOT BEING ENABLED AS A STORY OR RCM OR MISSION RETRY IS HAPPENING");
							}
							func_26();
							func_27();
							func_28();
							...
							func_31();
							func_32();
							DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": INIT_CURRENT_REGION_TOWN_DATA FOR ", &(Global_1887351[iLocal_52 /*36*/].f_23));
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_52 /*36*/].f_23), " RBS_INIT_AMBIENT -> RBS_INIT_LAW");
							iLocal_50 = 9;
							Jump @1356; //curOff = 1032
							func_33(iLocal_52);
							func_34();
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_52 /*36*/].f_23), "-> RBS_INIT_NAMED_LOCATIONS");
							iLocal_50 = 10;
							Jump @1356; //curOff = 1070
							func_35(&Global_1896686);
							func_36(iLocal_52, &Global_1896686);
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_52 /*36*/].f_23), "-> RBS_DONE_INIT");
							iLocal_50 = 11;
							Jump @1356; //curOff = 1116
							DEBUG::_0xF0783374333FD8CE(168, 17, "**** FINISHED INITIALIZING: ", &(Global_1887351[iLocal_52 /*36*/].f_23), " ****");
							func_37(iLocal_52);
							func_21(iLocal_52, 8);
							if (func_38(32))
							{
							...
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_52 /*36*/].f_23), "-> RBS_RUNNING");
							iLocal_50 = 12;
							...
							func_41(&Global_1896686, iLocal_52);
							func_42(iLocal_52);
							func_21(iLocal_52, 8);
							if (func_43())
							{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887351[iLocal_52 /*36*/].f_11);
							if (Global_1887351[iLocal_52 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887351[iLocal_52 /*36*/].f_12);
							}
							Jump @1356; //curOff = 1312
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_52 /*36*/].f_23), " RBS_CLEANUP");
							func_8();
							func_44(iVar0);
							iVar0++;
						}
						if (Global_1887351[iLocal_52 /*36*/].f_13 == 0)
						{
						}
						else
						{
							PED::_0x95423627A9CA598E(Global_1887351[iLocal_52 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
...
bool func_1()
{
	if (!bLocal_54)
	{
		if (Global_1051140)
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_52 /*36*/].f_23), ", g_mpUGC_QuitSessionRequest.bRequestRunning is still true");
			bLocal_54 = true;
			return true;
		}
		if (func_47() && func_48())
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_52 /*36*/].f_23), ", a session request is running and a UGC script is running");
			bLocal_54 = true;
			return true;
		}
	...
	if (func_48())
	{
		DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_52 /*36*/].f_23), ", content script still running for some player");
		return true;
	}
...
bool func_40(int iParam0)
{
	...
	{
		DEBUG::_0x9A6C65DDDBEC9C52(8, 11, "Serendipity/Grand Korrigan - You are in Free Roam and on the boat.  You are not supposed to be here.  To Saint Denis with you!");
		func_63(5, 0);
	}
	return false;
}
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_34, 0f, 0f, 0f) <= 5f || func_64(Global_1940410, 32768)) || func_64(Global_1940410, 16777216))
	{
		return;
	}
...
bool func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": REGION_TOWN_MANANGER_EXIT_TOWN FOR ", &(Global_1887351[iLocal_52 /*36*/].f_23));
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_52)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_77(iLocal_52));
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_78(iLocal_52, 0), 1);
					break;
			}
		}
		if (func_10(func_70()))
	...
	else
	{
		...
		if (func_45() == -1)
		{
			func_82(iLocal_52);
			func_83(iLocal_52);
			if (!func_84(iLocal_52, 0))
			{
				return false;
			}
		}
		else if (!func_85(iLocal_52))
		{
			return false;
		}
	}
	DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": Terminating. -- ", &(Global_1887351[iLocal_52 /*36*/].f_23));
	SCRIPTS::TERMINATE_THIS_THREAD();
	return true;
}
...
bool func_49(bool bParam0, bool bParam1)
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		{
			DEBUG::_0xF0783374333FD8CE(168, 8, "KILL_EVENT_CAUGHT - NETWORK_IS_GAME_IN_PROGRESS() = FALSE - but bIgnoreTransition = TRUE and g_mpTransition.eMPState = ", func_86(Global_1572887, 0), ", so skipping");
		}
		else
		{
...
int func_53(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (!func_58(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Region index not valid ", func_88(iParam0));
		return 1;
	}
	if (func_87(iParam0, 16))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: RF_PERS_DISABLED is on for ", func_88(iParam0));
		return 1;
	}
	if (func_89(iParam0) && !func_90(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: IS_REGION_IN_LOCKDOWN is on for ", func_88(iParam0));
	}
	DEBUG::_0xF0783374333FD8CE(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Starting for ", func_88(iParam0));
	if (func_91(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if ((!func_89(iParam0) || func_90(iParam0)) || func_93(Global_1896632))
			{
				func_94(Global_1896632, 0);
			}
			Global_1896632++;
			iVar2++;
...
bool func_62()
{
	return func_97(Global_1572887.f_7, 1);
}
...
void func_63(int iParam0, bool bParam1)
{
	...
	Var30.f_5 = 1;
	func_99(92);
	if (func_100(iParam0, &uVar0))
	{
		func_101(&uVar0, &Var30, 1, 1, 1);
		if (bParam1)
		{
			func_102(0);
		}
		DEBUG::_0xF0783374333FD8CE(40, 36, "NET_PLAYER_STATUS_FORCE_RESPAWN_IN_REGION - Respawning in ", func_103(iParam0, 0));
		return;
	}
	func_104(Var30.f_6, Var30, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, 1, 1, 1);
	if (bParam1)
	{
		func_102(0);
	}
	DEBUG::_0x9A6C65DDDBEC9C52(2728, 36, "NET_PLAYER_STATUS_FORCE_RESPAWN_IN_REGION - Couldn't load region data for ", func_103(iParam0, 0), ", respawning near ", MISC::_0x6C4DBF553885F9EB(Var30.f_6), ".");
}
...
bool func_66()
{
	return func_64(Global_1940410, 8192);
}
...
bool func_68(int iParam0)
{
	...
	return ((Global_1887351[iParam0 /*36*/].f_21 == 1 || Global_1887351[iParam0 /*36*/].f_21 == 2) && !func_105(iParam0));
}
...
void func_71(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	char* sVar1;
	char* sVar2;
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_103(iParam0, 0), " ", func_107(iParam1, 0), " ", func_108(bParam2, 0), " state ", func_109(iParam4, 0));
	UNK_0x355E72323AEE83CC(11, 6);
	sVar1 = func_110(iParam0, iParam1, bParam2, iParam4, bParam5, bParam3, &bVar0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_103(iParam0, 0), " or ", func_107(iParam1, 0), " or ", func_108(bParam2, 0));
	...
	if (bVar0 && bParam3)
	{
		sVar2 = func_115(func_114(bParam2));
	}
	else if ((func_116(iParam1, 2) || func_117(iParam4, 2)) && !Global_1893599.f_9)
	{
	...
	else if ((func_58(iParam0) && func_87(iParam0, 16777216)) && !Global_1893599.f_9)
	{
	...
	Global_1939313.f_145 = func_123(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
{
	iParam0 = iParam0;
	func_128(&uLocal_16, 0);
	func_128(&uLocal_26, 0);
	func_128(&uLocal_36, 0);
}
...
bool func_84(int iParam0, bool bParam1)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 138, "DELETE_ALL_REGIONAL_CHARACTERS starting for Region ", func_88(iParam0));
	if (func_91(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_131(Global_1896632.f_1, 16))
			{
				func_132(Global_1896632.f_1, 0);
			}
			Global_1896632.f_1++;
			iVar2++;
	...
	switch (iParam0)
	{
		...
		case 139:
			...
			*iParam2 = 851;
			...
			break;
		default:
			DEBUG::_0xA308F935BDECCEC0(40, 138, "Attempting to get regional character bounds for a region that doesn't have them yet ", func_77(iParam0));
			*iParam1 = -1;
			*iParam2 = -1;
			break;
	}
...
bool func_98(char* sParam0, bool bParam1)
{
	char* sVar0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		if (func_146(sVar0, iVar2, sParam0, bParam1))
		{
			return true;
		}
...
{
	if (func_147(&(Global_1102630.f_4), iParam0, 5))
	{
		DEBUG::_0xF0783374333FD8CE(680, 36, "SET_NET_PLAYER_STATUS_FLAG - ", func_148(iParam0), " set by thread ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
		return 1;
	}
	return 0;
}
...
bool func_100(int iParam0, var uParam1)
{
	...
	{
		DEBUG::_0xF0783374333FD8CE(168, 36, "NET_PLAYER_STATUS__LOAD_SPAWN_SEARCH_LOCATION_DATA__IN_REGION - Volume does not exist for region ", func_77(iParam0), ", bailing.");
		return false;
	}
	...
	DEBUG::_0xF0783374333FD8CE(680, 36, "NET_PLAYER_STATUS__LOAD_SPAWN_SEARCH_LOCATION_DATA__IN_REGION - Using ", func_77(iParam0), ", with target at ", MISC::_0x6C4DBF553885F9EB(uParam1->f_17.f_6));
...
void func_101(var uParam0, var uParam1, int iParam2, bool bParam3, int iParam4)
{
	if (func_149(255) == 4)
	{
	...
	func_151(&(Global_1102630.f_3849));
	Global_1102630.f_3849 = { *uParam0 };
	func_152(&(Global_1102630.f_3888));
	...
	func_153(Global_1102630.f_3849, 36);
	func_154(Global_1102630.f_3888, 36);
...
{
	if (func_155(&(Global_1102630.f_4), iParam0, 5))
	{
		DEBUG::_0xF0783374333FD8CE(680, 36, "CLEAR_NET_PLAYER_STATUS_FLAG - ", func_148(iParam0), " cleared by thread ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
		return 1;
	}
	return 0;
}
...
void func_104(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, float fParam8)
{
	vector3 vVar0;
	int iVar3;
	...
	iVar3 = iParam3;
	if (!func_156(Global_1275959.f_17, &vVar0, &iVar3))
	{
		vVar0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false, false) };
		iVar3 = iParam3;
	}
	func_157(vParam0, iParam3, vVar0, iVar3, iParam4, iParam5, iParam6, iParam7, fParam8, 1);
}

bool func_105(int iParam0)
{
	if ((iParam0 == 22 || iParam0 == 39) && !func_158())
	{
		return true;
	}
	if (iParam0 == 66)
...
char* func_110(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893599.f_162)))
	{
		sVar0 = func_161(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_163(func_162(Global_34));
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		if (!func_164(iParam0) || func_165(44))
		{
			switch (iParam0)
			{
				case 2:
...
char* func_122(char* sParam0, int iParam1)
{
	...
	return func_167(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
void func_125(var uParam0, int iParam1)
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_168(iParam1, 0));
}
...
void func_128(var uParam0, bool bParam1)
{
	...
	{
		func_170(uParam0->f_1);
	}
	if (MAP::DOES_BLIP_EXIST(uParam0->f_9) && bParam1)
	{
		MAP::REMOVE_BLIP(&(uParam0->f_9));
	}
	if (func_171(uParam0->f_8))
	{
		func_172(&(uParam0->f_8), 1, 1);
	}
}

void func_129(int iParam0)
{
	DEBUG::_0x4DC69742196F818A(40, 195, "CLEAR_SALOON: Clearing ", func_173(iParam0));
	func_174(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_175(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
...
void func_130(int iParam0)
{
	...
	if (func_92(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_177(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_178(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_179(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_180(iParam0, 536870912);
	iVar1 = func_181(iParam0);
	if (iVar1 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(2216, 139, "[SHOP_UNLOCK_DOORS] Shop: ", func_182(iParam0, 0), " door count is greater then the. Current door count: ", iVar1, " Max door count: ", 15);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_183(Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
	...
	DEBUG::_0xF0783374333FD8CE(168, 139, "[CLEAR_SHOP] Shop: ", func_182(iParam0, 0), " has been cleared!");
}
...
void func_135()
{
	...
	while (iVar0 <= 3)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ NET_CLEAR_BARTENDERS - Removed ", func_191(Global_1051777.f_3642[iVar0 /*19*/]));
...
void func_137(int iParam0, bool bParam1)
{
	...
	DEBUG::_0x4DC69742196F818A(40, 139, "NET_CLEAR_SHOP ", func_182(iParam0, 0));
	bVar0 = (func_192(iParam0) && !bParam1);
	if (!bVar0 && !func_193(iParam0, 65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] - Shop keeper deleted for shop: ", func_194(iParam0));
		}
	...
	else if (func_195(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
	{
	...
	if (func_195(iParam0, 16384) && !bVar0)
	{
		DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] Remove the script created scenario for: ", func_194(iParam0));
	...
	if (iVar3 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "[NET_CLEAR_SHOP] - Shop: ", func_182(iParam0, 0), " current door count exceeds max door count.");
		Global_1915867.f_3[iParam0 /*447*/].f_409 = 0;
	}
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_183(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar2]);
	...
	func_198(iParam0);
	if (func_193(iParam0, 262144))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 139, "NET_CLEAR_SHOP: SPF_ALLOW_BLIP_OUT_OF_REGION for ", func_194(iParam0), " is kept; all other flags cleared.");
	...
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_CLEAR_SHOP] Removing relationship volume from shop ", func_182(iParam0, 0));
...
void func_142(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_201(iParam1), " on ", func_138(iParam0));
}
...
bool func_144(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_202(&(Global_1102630.f_4), iVar0, 5);
	}
	if (iParam1 == func_203())
	{
		return func_202(&(Global_1102630.f_4), iVar0, 5);
	...
	{
		return func_202(&(Global_1100880[iParam1 /*53*/].f_4), iVar0, 5);
	}
...
bool func_146(char* sParam0, int iParam1, char* sParam2, bool bParam3)
{
	struct<5> Var0;
...
void func_153(struct<30> Param0, int iParam30)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, iParam30, "             outer.eType                     - ", func_204(Param0.f_17.f_9, 0));
	if (Param0.f_16)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, iParam30, "             inner.eType                     - ", func_204(Param0.f_6.f_9, 0));
	}
...
void func_154(struct<7> Param0, var uParam7, var uParam8, int iParam9)
{
...
bool func_156(vector3 vParam0, char* sParam3, bool bParam4)
{
	char* sVar0;
	int iVar1;
	int iVar2;

	sVar0 = Global_1072032.f_23926.f_366[func_205(vParam0) /*272*/];
	iVar1 = func_145(sVar0);
	if (iVar1 <= 0)
	{
	...
	else
	{
		...
		if (func_146(sVar0, iVar2, sParam3, bParam4))
		{
			return true;
		}
...
void func_157(vector3 vParam0, int iParam3, vector3 vParam4, int iParam7, float fParam8, float fParam9, bool bParam10, int iParam11, float fParam12, int iParam13)
{
	if (func_149(255) == 4)
	{
...
bool func_160(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_209(func_56(0)))
	{
		return true;
	}
...
bool func_169(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	return VOLUME::_DOES_VOLUME_EXIST(iParam0);
}

void func_170(struct<6> Param0, var uParam6)
{
...
void func_176(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 195, "CLEAR_SALOON_CONFIG_FLAG: Clearing flag for ", func_216(iParam1, 0));
	func_217(&(Global_1940170.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_178(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if ((!bParam4 && !func_177(iParam0)) && func_218(iParam0))
	{
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 139, "CLEAR_ALL_SHOP_TYPE_FLAGS: ", func_194(iParam0));
...
void func_185(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_201(iParam1), " on ", func_138(iParam0));
}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_FLAGS] ", func_194(iParam0));
	Global_1051777.f_80[iParam0 /*75*/].f_49 = 0;
}

void func_188(int iParam0)
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_SUPPORT_FLAGS] ", func_194(iParam0));
...
void func_196(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_194(iParam0), " flag ", func_231(iParam1));
	}
	Global_1051777.f_80[iParam0 /*75*/].f_1 = (Global_1051777.f_80[iParam0 /*75*/].f_1 - (Global_1051777.f_80[iParam0 /*75*/].f_1 && iParam1));
}
...
{
	return func_97(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}
...
void func_206(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	func_232(iParam0);
...
bool func_207()
{
	...
	if (!func_209(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_211(vector3 vParam0, int iParam3)
{
	...
	func_241(iParam3, &vVar0, &Var3, &uVar6);
	if (func_242(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
...
bool func_242(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
...
int func_244(int iParam0)
{
	...
	DEBUG::_0xD9911C7B5F8CD69C(168, 139, "GET_SHOP_TYPE_FROM_SHOP - ", func_230(iParam0, 0), " undefined");
	return -1;
}
