...
void func_7()
{
	...
	{
		iLocal_13 = 0;
		DEBUG::_0xA308F935BDECCEC0(8, 0, "PROCESS_SCENARIO: Exiting. Player is injured or not using scenario");
		return;
	}
	if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, joaat("OBJECTEXCHANGE")))
	{
		DEBUG::_0xF0783374333FD8CE(8, 0, "PROCESS_SCENARIO: Eating scenario is refilling current tanks");
		func_13(0, 12.5f, 0, 0, 0);
		func_14(10f, 1);
		switch (bLocal_17)
		{
			case joaat("PROP_PLAYER_EAT_ALMONDS_COUNTER"):
			case joaat("PROP_PLAYER_EAT_ALMONDS_COUNTER_NO_DOF"):
				func_15(-241345764 /* GXTEntry: "Almonds" */);
				break;
			case joaat("PROP_PLAYER_EAT_PICKLED_EGG"):
				func_15(-1735850413 /* GXTEntry: "Pickled Egg" */);
				break;
		}
		if (func_16(1))
		{
...
void func_13(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (fParam1 == 0f)
	{
		return;
	...
	if (bParam4)
	{
		fParam1 = func_21(iParam0, fParam1, 1);
	}
	func_23(iParam0, (func_22(iParam0, 2) + fParam1), bParam2, bParam3, 1, 2);
}
...
void func_15(bool bParam0)
{
	...
	Var0.f_1 = 20;
	if ((func_27(bParam0, 1573112293) || func_27(bParam0, 672467738)) || func_27(bParam0, -550842268))
	{
		bVar37 = true;
	}
	DEBUG::_0x4DC69742196F818A(40, 158, "PROCESS_GENERIC_ITEM_USE - Inventory Item Group - ", func_29(func_28(bParam0), 0));
	if (func_28(bParam0) == joaat("CONSUMABLE"))
	{
		ITEMDATABASE::_ITEM_DATABASE_FILLOUT_ITEM_EFFECTS_IDS(bParam0, &Var0);
		DEBUG::_0xF0783374333FD8CE(168, 158, "PROCESS_GENERIC_ITEM_USE - ", func_30(bParam0, 0), " Num Effects ", Var0);
		ATTRIBUTE::_0xD962F8579D702DB5();
		iVar29 = 0;
		while (iVar29 < Var0)
		{
			DEBUG::_0xF0783374333FD8CE(648, 158, "PROCESS_GENERIC_ITEM_USE - Effect ", iVar29, ":", func_31(Var0.f_1[iVar29], 0));
			if (!ITEMDATABASE::_ITEM_DATABASE_FILLOUT_ITEM_EFFECTS_ID_INFO(Var0.f_1[iVar29], &Var22))
			{
				DEBUG::_0x9A6C65DDDBEC9C52(2696, 158, "PROCESS_GENERIC_ITEM_USE - Effect ", iVar29, ":", func_31(Var0.f_1[iVar29], 0), " failed to Fillout via ITEMDATABASE_FILLOUT_EFFECT_ID_INFO.");
			}
			else
			{
				DEBUG::_0xF0783374333FD8CE(25725608, 158, "PROCESS_GENERIC_ITEM_USE - Key ", func_31(Var22, 0), " Enum ID ", func_32(Var22.f_1, 0), " Value ", Var22.f_2, " Time ", Var22.f_3, " unit ", Var22.f_4, " percent ", Var22.f_5);
				if (-943921969 == Var22.f_1)
				{
					fVar30 = func_33(0, Var22.f_2);
					func_34(Var22.f_2);
					iVar39 = 1;
				}
				else if (-1104847406 == Var22.f_1)
				{
					fVar31 = func_33(2, Var22.f_2);
					func_35(Var22.f_2, 0);
					bVar38 = true;
				}
				else if (381158954 == Var22.f_1)
				{
					fVar32 = func_33(1, Var22.f_2);
					func_36(Var22.f_2);
				}
				else if (-416929031 == Var22.f_1)
				{
					fVar33 = func_37(BUILTIN::TO_FLOAT(Var22.f_2), Var22.f_5);
					func_13(0, fVar33, 1, 1, bVar37);
					iVar39 = 1;
				}
				else if (1857353317 == Var22.f_1)
				{
					fVar34 = func_37(BUILTIN::TO_FLOAT(Var22.f_2), Var22.f_5);
					func_13(2, fVar34, 1, 1, bVar37);
					bVar38 = true;
				}
				else if (1681823811 == Var22.f_1)
				{
					fVar35 = func_37(BUILTIN::TO_FLOAT(Var22.f_2), Var22.f_5);
					func_13(1, fVar35, 1, 1, bVar37);
				}
				...
				{
					func_14(BUILTIN::TO_FLOAT(Var22.f_2), 1);
				}
			}
			iVar29++;
		}
		if (iVar39 || func_27(bParam0, -537818634))
		{
			func_41(func_40(joaat("MEDICINE_ITEMS_USED")), 1);
		}
		if (func_27(bParam0, -1457797660))
		{
...
void func_17(float fParam0, bool bParam1)
{
	...
	func_42((Global_1940237.f_9 + fParam0), bParam1);
}
...
float func_21(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
	int iVar1;

	iVar0 = func_43();
	func_44(&iVar0, 0, 0, 0, 1, 0, 0);
	iVar1 = func_45(iParam0, 2);
	DEBUG::_0x1B08D1EB9D8C4931(8, 84, "_RPG_GLOBAL_APPLY_CORE_FIX_DEGRADE - Degrade Count: ", iVar1);
	if (func_47(iVar0, func_46(iParam0, 2), 1))
	{
		func_48(iParam0, 0, 2);
		iVar1 = 0;
		DEBUG::_0x1B08D1EB9D8C4931(8, 84, "_RPG_GLOBAL_APPLY_CORE_FIX_DEGRADE - Reseting Degrade Count to 0, it's a whole new day!");
		DEBUG::_0x1B08D1EB9D8C4931(40, 84, "_RPG_GLOBAL_APPLY_CORE_FIX_DEGRADE - Degrade Time of Day: ", func_49(iVar0));
		DEBUG::_0x1B08D1EB9D8C4931(40, 84, "_RPG_GLOBAL_APPLY_CORE_FIX_DEGRADE - Current Time of Day: ", func_49(func_46(iParam0, 2)));
	}
	if (iVar1 >= 2)
	{
		func_26(103, bParam2);
	...
	func_50(iParam0, func_43(), 2);
	func_48(iParam0, iVar1 + 1, 2);
	return fParam1;
}

float func_22(int iParam0, int iParam1)
{
	if (iParam1 == 2)
	{
		iParam1 = func_51(2);
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_ATTRIBUTE_CORE_DISPLAY_STATE - Failed to retrieve Core Value for ", func_52(iParam0, 0), " Returning -1.0. This is really bad. ");
	return -1f;
}

int func_23(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)
{
	int iVar0;
	...
	if (func_53(iVar0, iParam0, fParam1))
	{
		if (bParam2)
		{
			if (fParam1 >= 100f)
		...
		if (bParam3)
		{
			func_54(iParam0, 7000, iParam5);
		}
		func_55(iVar0, iParam0, fParam1);
		DEBUG::_0xA308F935BDECCEC0(10664, 84, "__RPG_GLOBAL_SET_PLAYER_ATTRIBUTE_CORE - Caching Player Attribute Core ", func_52(iParam0, 0), " Value Data. Setting to: ", fParam1, " Override Enabled: ", MISC::_0xF216F74101968DB0(func_56()));
...
bool func_24()
{
	...
	return func_58(Global_1957252.f_1431.f_107, 0);
}
...
void func_25(float fParam0, bool bParam1)
{
	...
	if (iVar1 != iVar2)
	{
		Global_1957252.f_1431.f_107 = func_43();
		func_62(&(Global_1957252.f_1431.f_107), 0, 0, 1, 0, 0, 0, 0);
	}
	func_63(13, fVar0, 2);
...
void func_26(int iParam0, bool bParam1)
{
	...
	func_66(iVar0, iVar1);
	DEBUG::_0xA308F935BDECCEC0(10376, 105, "TUTORIAL_MARK_RUN() - Tutorial with Set: ", iVar0, " & Flag", iVar1, " marked to run. ", func_67(iParam0));
...
bool func_27(bool bParam0, bool bParam1)
{
	...
	{
		return func_70(func_69(bParam0), bParam1);
	}
	if (bParam1 == 0)
	{
		return false;
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[ITEM_HAS_PROPERTY_TAG] Found tag ", func_71(bParam1, 0), " for item ", func_30(bParam0, 0), ", returning TRUE");
		return true;
	}
	return false;
}
...
void func_35(int iParam0, bool bParam1)
{
	...
	func_75(BUILTIN::TO_FLOAT((iParam0 * iVar0)), 0, bParam1);
}
...
void func_36(int iParam0)
{
	...
	iVar1 = func_76(2);
	func_77(BUILTIN::TO_FLOAT((iParam0 * iVar1)), 0);
}
...
int func_39(int iParam0, char* sParam1, bool bParam2, bool bParam3)
{
	...
	DEBUG::_0xF0783374333FD8CE(2472, 84, "RPG_GLOBAL_SET_OVERPOWER_FOR_PLAYER_ATTRIBUTE - Attribute: ", func_78(iParam0, 0), " will be Overpowered this frame for  ", sParam1, " seconds");
	return func_79(iParam0, sParam1, bParam2, bParam3);
}
...
void func_42(float fParam0, bool bParam1)
{
	...
	if (PED::IS_PED_ON_MOUNT(Global_33) || PED::IS_PED_IN_ANY_VEHICLE(Global_33, false))
	{
		if (fParam0 >= func_80())
		{
			Global_1940237.f_9 = (func_80() - 0.01f);
...
int func_45(int iParam0, int iParam1)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_ATTRIBUTE_CORE_DEGRADE_COUNT - Failed to retrieve Core Degrade Count for ", func_52(iParam0, 0), " Returning -1. This is really bad. ");
	return -1;
}
...
int func_46(int iParam0, int iParam1)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_ATTRIBUTE_CORE_DEGRADE_TIME_OF_DAY - Failed to retrieve Core Degrade Time of Day for ", func_52(iParam0, 0), " Returning -1. This is really bad. ");
	return -15;
}
...
bool func_47(int iParam0, int iParam1, bool bParam2)
{
	if (bParam2)
	{
		if (!func_89(iParam1) || !func_89(iParam0))
		{
			return true;
		}
	}
...
void func_48(int iParam0, char* sParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DEGRADE_COUNT - Setting Core Degrade Count for ", func_52(iParam0, 0), " Pool: ", func_90(iParam2), " to ", sParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DEGRADE_COUNT - Failed to set Core Degrade Count for ", func_52(iParam0, 0), " Pool: ", func_90(iParam2), ". This is really bad. ");
			break;
	}
}
...
void func_50(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(10920, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DEGRADE_TIME_OF_DAY - Setting Core Degrade Time of Day for ", func_52(iParam0, 0), " Pool: ", func_90(iParam2), " to ", func_49(iParam1));
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DEGRADE_TIME_OF_DAY - Failed to set Core Degrade Time of Day for ", func_52(iParam0, 0), " Pool: ", func_90(iParam2), ". This is really bad. ");
			break;
	}
}
...
{
	return func_93(func_92(iParam0));
}
...
bool func_53(int iParam0, int iParam1, float fParam2)
{
	...
	ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(iParam0, func_94(iParam1), BUILTIN::CEIL(fParam2));
	return true;
}
...
void func_54(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DISPLAY_TIME - Setting Core Display Time for ", func_52(iParam0, 0), " Pool: ", func_90(iParam2), " to ", iParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DISPLAY_TIME - Failed to set Core Display Time for ", func_52(iParam0, 0), " Pool: ", func_90(iParam2), ". This is really bad. ");
			break;
	}
}

void func_55(int iParam0, int iParam1, float fParam2)
{
	char* sVar0;

	sVar0 = func_95(iParam1);
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		PED::_SET_PED_BLACKBOARD_FLOAT(iParam0, func_96(iParam1), fParam2, -1);
	}
	else
	{
		DEBUG::_0x6D2A5155B260E879(40, 84, "__RPG_GLOBAL_HANDLE_BLACKBOARD_FOR_ATTRIBUTE - INVALID BLACK BOARD NAME for Attribute Core: ", func_52(iParam1, 0));
	}
}
...
void func_57(int iParam0, char* sParam1, bool bParam2, int iParam3)
{
	char* sVar0;
	...
	DEBUG::_0xA308F935BDECCEC0(43432, 84, "__RPG_GLOBAL_CACHE_ATTRIBUTE_CORE_DATA - Caching Attribute Core ", func_52(iParam0, 0), " Value Data. Setting to: ", sParam1, " Override Enabled: ", MISC::_0xF216F74101968DB0(func_56()), " Time Stamp: ", sVar0);
	func_97(iParam0, sParam1, iParam3);
	if (bParam2)
	{
		func_98(iParam0, sVar0, iParam3);
	}
}

bool func_58(int iParam0, bool bParam1)
{
	return func_47(func_43(), iParam0, bParam1);
}
...
float func_59(int iParam0, int iParam1)
{
	...
	{
		case 0:
			DEBUG::_0x1B08D1EB9D8C4931(424, 84, "[RPG_GLOBAL_GET_CACHED_PLAYER_ATTRIBUTE_XP] Pool for Attributes: ", func_99(0, 0), " Value: ", Global_1957252.f_1431.f_26[iParam0]);
			return Global_1957252.f_1431.f_26[iParam0];
		case 1:
			DEBUG::_0x1B08D1EB9D8C4931(424, 84, "[RPG_GLOBAL_GET_CACHED_PLAYER_ATTRIBUTE_XP] Pool for Attributes: ", func_99(1, 0), " Value: ", Global_1957252.f_1565.f_2.f_26[iParam0]);
			return Global_1957252.f_1565.f_2.f_26[iParam0];
		default:
			break;
	}
	DEBUG::_0x6D2A5155B260E879(40, 84, "[RPG_GLOBAL_GET_CACHED_PLAYER_ATTRIBUTE_XP] Couldn't retrieve Cached Attribute XP data for Attribute: ", func_78(iParam0, 0));
	return -1f;
}
...
void func_62(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, char* sParam1, int iParam2)
{
	if (!func_100(iParam0))
	{
		return 0;
	...
	DEBUG::_0xA308F935BDECCEC0(10664, 84, "__RPG_GLOBAL_SET_PLAYER_ATTRIBUTE - Caching Attribute ", func_78(iParam0, 0), " XP Data. Setting to: ", sParam1, " Override Enabled: ", MISC::_0xF216F74101968DB0(func_56()));
	func_101(iParam0, sParam1, iParam2);
...
bool func_65(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_102(iParam1, iParam2))
	{
		if (!bParam3)
		{
			DEBUG::_0xA308F935BDECCEC0(168, 105, "TUTORIAL_CAN_GO_PENDING_CHECKS - Tutorial: ", func_67(iParam0), " has already run, and is not being forced.");
			return false;
		}
	}
	if (!func_103(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 105, "TUTORIAL_CAN_GO_PENDING_CHECKS - NOT CAN_TUTORIAL_PLAY_IN_MODE ", func_104(iParam0, 0));
		return false;
	}
	if (func_105(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 105, "TUTORIAL_CAN_GO_PENDING_CHECKS - Timed tutorial is delayed or finished ", func_104(iParam0, 0));
		return false;
	}
	if ((Global_1900777.f_67 && !func_106(iParam0, 1)) || func_107(32768))
	{
		if (!func_106(iParam0, 262144) || !Global_1904703.f_8785)
		{
...
int func_70(bool bParam0, bool bParam1)
{
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[BUNDLE_HAS_PROPERTY_TAG] Found tag ", func_71(bParam1, 0), " for bundle ", func_110(bParam0, 0), ", returning TRUE");
		return 1;
	}
	return 0;
}

var func_71(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
void func_75(float fParam0, bool bParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	float fVar2;
...
void func_77(float fParam0, int iParam1)
{
	if (fParam0 == 0f)
	{
...
int func_79(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	...
	iVar1 = PLAYER::PLAYER_PED_ID();
	DEBUG::_0xF0783374333FD8CE(2472, 84, "__RPG_GLOBAL_SET_OVERPOWER_FOR_PLAYER_ATTRIBUTE_INTERNAL - Attribute: ", func_78(iParam0, 0), " will be Overpowered this frame for  ", fParam1, " seconds on local player...");
	if (fParam1 == -1f)
	{
		if (func_112(iParam0))
		{
	...
	{
		DEBUG::_0x6D2A5155B260E879(2472, 84, "__RPG_GLOBAL_SET_OVERPOWER_FOR_PLAYER_ATTRIBUTE_INTERNAL - Attribute: ", func_78(iParam0, 0), " was set to a Duration of: ", fParam1, " this is really bad. Correct this. ");
		return 0;
	}
	switch (iParam0)
	{
		...
		case 1:
			...
			func_114(joaat("STATUS_EFFECT__TRACKING"));
			func_36(-1);
			ATTRIBUTE::ENABLE_ATTRIBUTE_OVERPOWER(iVar1, iParam0, fParam1, bParam3);
		...
		case 2:
			...
			break;
		case 19:
			func_114(joaat("STATUS_EFFECT__POISON"));
			func_115(0, 1, 1);
			ATTRIBUTE::ENABLE_ATTRIBUTE_OVERPOWER(iVar1, iParam0, fParam1, bParam3);
		...
		case 20:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(168, 84, "__RPG_GLOBAL_SET_OVERPOWER_FOR_PLAYER_ATTRIBUTE_INTERNAL - Attribute: ", func_78(iParam0, 0), " cannot be overpowered... Why are you doing this?");
			return 0;
	}
	return 1;
}
...
{
	return func_123(&(Global_1957252.f_1565), iParam0, 1);
}
...
int func_94(int iParam0)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_PED_ATTRIBUTE_FROM_RPG_GLOBAL_CORE - Attribute Core: ", func_52(iParam0, 0), " does not have an associated PED Attribute. This is REALLY bad, correct immediately... ");
	return 0;
}
...
void func_97(int iParam0, char* sParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(6824, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_VALUE - Setting Core Value for ", func_52(iParam0, 0), " Pool: ", func_90(iParam2), " to ", sParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_VALUE - Failed to set Core Value for ", func_52(iParam0, 0), " Pool: ", func_90(iParam2), ". This is really bad. ");
			break;
	}
}
...
void func_98(int iParam0, char* sParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_LAST_UPDATED_TIMESTAMP - Setting Last Updated Timestamp for ", func_52(iParam0, 0), " Pool: ", func_90(iParam2), " to ", sParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_LAST_UPDATED_TIMESTAMP - Failed to set Last Updated Timestamp for ", func_52(iParam0, 0), " Pool: ", func_90(iParam2), ". This is really bad. ");
			break;
	}
}
...
void func_101(int iParam0, float fParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(6824, 84, "__RPG_GLOBAL_SET_CACHED_ATTRIBUTE_XP - Setting Attribute XP for ", func_78(iParam0, 0), " Pool: ", func_90(iParam2), " to ", fParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_CACHED_ATTRIBUTE_XP - Failed to set Attribute XP for ", func_78(iParam0, 0), " Pool: ", func_90(iParam2), ". This is really bad. ");
			break;
	}
}
...
bool func_105(int iParam0)
{
	...
	while (iVar0 < Global_38.f_3538)
	{
		if (Global_38.f_3538[iVar0 /*3*/].f_2 == iParam0)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(168, 105, "IS_TIMED_TUTORIAL_DELAYED_OR_FINISHED time since last played tutorial ", func_104(iParam0, 0), " Seconds ", iVar2);
...
bool func_111(int iParam0)
{
	...
	fVar0 = (func_126(iParam0) - PLAYER::_0xDF66A37936D5F3D9(iParam0));
	return fVar0 <= 1f;
}
...
char* func_113(int iParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(168, 84, "RPG_GLOBAL_GET_OVERPOWER_POSTFX_STRING_FOR_ATTRIBUTE - Attribute: ", func_78(iParam0, 0), " does not have an overpower post fx... Returning NULL ");
	return "";
}
...
void func_114(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 84, "RPG_GLOBAL__DISABLE_ALL_STATUS_EFFECT_SOURCES_OF_TYPE - Now disabling all Status Effects with Perk Group: ", func_127(iParam0, 0));
	iVar1 = Global_1146683.f_47689.f_1.f_42;
	iVar2 = 0;
	while (iVar2 < iVar1)
	{
		iVar0 = Global_1146683.f_47689.f_1[iVar2 /*2*/];
		iVar3 = func_128(iVar0, 1);
		if (Global_1146683.f_35859.f_919[iVar3 /*12*/] == iParam0)
		{
			DEBUG::_0xA308F935BDECCEC0(168, 84, "RPG_GLOBAL__DISABLE_ALL_STATUS_EFFECT_SOURCES_OF_TYPE - Disabling Source: ", func_129(Global_1146683.f_47689.f_1[iVar2 /*2*/], 0), " at index: ", iVar2);
			func_130(iVar0);
...
{
	func_23(iParam0, 100f, bParam1, bParam2, 1, 2);
}
...
void func_119(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0x83407B92D46F25C3(559240, 0, "SET_TIMEOFDAY_DAY: Passed an invalid day [", iParam1, "] for the TIMEOFDAY's current month [", iVar0, "] for year ", iVar1, ". GET_NUMBER_OF_DAYS_IN_MONTH(eMonth, iYear) = ", func_87(iVar0, iVar1), ". Failed to set TIMEOFDAY.");
		return;
	}
...
int func_130(int iParam0)
{
	...
	if (!func_133(Global_1146683.f_35859.f_919[iVar0 /*12*/]))
	{
		return 1;
	}
	iVar3 = func_134(Global_1146683.f_35859.f_919[iVar0 /*12*/], 1);
	DEBUG::_0xA308F935BDECCEC0(2216, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Attempting to disable all Perks in Perk Group: ", func_127(Global_1146683.f_35859.f_919[iVar0 /*12*/], 0), " it has: ", Global_1146683.f_35859[iVar3 /*6*/].f_5, " perks...");
	iVar4 = 0;
	while (iVar4 < Global_1146683.f_35859[iVar3 /*6*/].f_5)
	{
		iVar1 = Global_1146683.f_35859[iVar3 /*6*/][iVar4];
		DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Disabling Perk: ", func_135(iVar1, 0), " from Source: ", func_129(iParam0, 0));
		switch (func_136(iParam0, iVar1))
		{
			case 0:
				DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - deactivating perk ", func_135(iVar1, 0), " directly");
				func_137(iVar1, iParam0, iVar4);
				break;
			case 1:
				iVar5 = 0;
				while (iVar5 < Global_1146683.f_35859.f_11700)
				{
					...
					{
						DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - removing perk ", func_135(iVar1, 0), " from the activation queue");
						func_137(iVar1, iParam0, iVar4);
						func_138(&(Global_1146683.f_35859.f_9503[iVar5 /*3*/]));
						...
						func_138(&(Global_1146683.f_35859.f_9503[Global_1146683.f_35859.f_11700 /*3*/]));
					}
					else
					{
						iVar5++;
				...
				break;
			case 2:
				DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - ignoring perk ", func_135(iVar1, 0), "...");
				Jump @1002; //curOff = 566
				iVar2 = func_139(iVar1, 1);
				DEBUG::_0xA308F935BDECCEC0(2216, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Perk: ", func_135(iVar1, 0), " currently has num sources: ", Global_1146683.f_35859.f_3116[iVar2 /*31*/].f_29, " remaining... ");
				func_140(iVar2, -1);
				DEBUG::_0xA308F935BDECCEC0(2216, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Perk: ", func_135(iVar1, 0), " has num sources: ", Global_1146683.f_35859.f_3116[iVar2 /*31*/].f_29, " remaining... ");
				if (Global_1146683.f_35859.f_3116[iVar2 /*31*/].f_29 <= 0)
				{
					func_141(iVar2, 0);
					DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - all sources for Perk: ", func_135(iVar1, 0), " have been removed, disabling it");
					iVar6 = 0;
					while (iVar6 < Global_1146683.f_35859.f_9502)
					{
						if (Global_1146683.f_35859.f_9302[iVar6] != iVar1)
						{
							DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Evaluated Perk: ", func_135(iVar1, 0), " does not equal perk in slot: ", func_135(Global_1146683.f_35859.f_9302[iVar6], 0));
						}
						else
						{
							DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Evaluated Perk: ", func_135(iVar1, 0), " matches perk in slot! ");
			...
			func_142(&(Global_1146683.f_35859.f_919[iVar0 /*12*/]));
			return 1;
		}
...
int func_131(int iParam0)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_ATTRIBUTE_CORE_MAX_SIZE - Attribute Core: ", func_52(iParam0, 0), " is INVALID. Correct this immediately... ");
	return -1;
}
...
int func_136(int iParam0, int iParam1)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(10920, 84, "RPG_GLOBAL_STAT_GET_DEACTIVATION_TYPE - Source: ", func_129(iParam0, 0), " Perk: ", func_135(iParam1, 0), " Deactivation Trigger: ", func_144(Global_1146683.f_35859.f_3116[iVar2 /*31*/].f_1, 0));
...
int func_137(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_147(Global_1146683.f_35859.f_3116[iVar0 /*31*/]) && func_148(iParam0, Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK - Now checking Stack Group: ", func_149(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, 0), " for any perks that could be enabled now that this perk is diabled... ");
		vVar1 = { func_150(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4) };
		if (func_151(vVar1))
		{
			if (func_152(vVar1.x, vVar1.y, vVar1.z))
			{
				func_153(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, vVar1.x, vVar1.y, vVar1.z);
			}
			else
			{
				func_154(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4);
				DEBUG::_0x6D2A5155B260E879(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK - Failed to activate next availible perk in Stack Group: ", func_149(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, 0), " there was a critical failure... ");
			}
		}
		else
		{
			func_154(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4);
			DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK - No suitable replacement for active perk in Stack Group: ", func_149(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, 0), "...");
		}
	}
	return 1;
}
...
void func_140(int iParam0, int iParam1)
{
	...
	DEBUG::_0xF0783374333FD8CE(2216, 84, "__RPG_GLOBAL__ALTER_SOURCES_FOR_PERK_ID - Perk: ", func_135(func_155(iParam0, 1), 0), " is being altered by: ", iParam1, " to a total of: ", Global_1146683.f_35859.f_3116[iParam0 /*31*/].f_29);
}

void func_141(int iParam0, int iParam1)
{
	Global_1146683.f_35859.f_3116[iParam0 /*31*/].f_29 = iParam1;
	DEBUG::_0xF0783374333FD8CE(168, 84, "__RPG_GLOBAL__SET_SOURCES_FOR_PERK_ID - Perk: ", func_135(func_155(iParam0, 1), 0), " is being set to: ", Global_1146683.f_35859.f_3116[iParam0 /*31*/].f_29);
}
...
int func_146(int iParam0, int iParam1, int iParam2)
{
	...
	iVar2 = func_134(Global_1146683.f_35859.f_919[iVar0 /*12*/], 1);
	if (Global_1146683.f_35859[iVar2 /*6*/][iParam2] != iParam0)
	{
		DEBUG::_0x9A6C65DDDBEC9C52(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK_INTERNAL - attempting to disable perk ", func_135(iParam0, 0), " from a source that hasn't previously enabled it ", func_129(iParam1, 0));
		return 0;
	}
	...
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK_INTERNAL - deactivating perk ", func_135(iParam0, 0), " and source ", func_129(iParam1, 0));
	...
	while (iVar4 < Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_16)
	{
		...
		else
		{
			...
			Global_1146683.f_2169[iVar5 /*205*/].f_201 = (Global_1146683.f_2169[iVar5 /*205*/].f_201 - func_160(&(Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			DEBUG::_0xA308F935BDECCEC0(6824, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK_INTERNAL - removing perk ", func_135(iParam0, 0), " to stat mod ", func_161(iVar3, 0), " with strength ", Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/].f_1);
			func_162(iVar3);
		}
		iVar4++;
	}
...
bool func_152(int iParam0, int iParam1, int iParam2)
{
	...
	if (Global_1146683.f_35859[iVar2 /*6*/][iParam2] != iParam0)
	{
		DEBUG::_0x9A6C65DDDBEC9C52(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - attempting to disable perk ", func_135(iParam0, 0), " from a source that hasn't previously enabled it ", func_129(iParam1, 0));
		return false;
	}
	...
	DEBUG::_0xA308F935BDECCEC0(2728, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK - activating perk ", func_135(iParam0, 0), " and source ", func_129(iParam1, 0), " at POSIX time: ", Global_1275959.f_21);
	...
	while (iVar4 < Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_16)
	{
		...
		else
		{
			...
			Global_1146683.f_2169[iVar5 /*205*/].f_201 = (Global_1146683.f_2169[iVar5 /*205*/].f_201 + func_160(&(Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			DEBUG::_0xA308F935BDECCEC0(6824, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - adding perk ", func_135(iParam0, 0), " to stat mod ", func_161(iVar3, 0), " with strength ", func_160(&(Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			DEBUG::_0xA308F935BDECCEC0(6824, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - adding perk ", func_135(iParam0, 0), " to stat mod ", func_161(iVar3, 0), " with total ", Global_1146683.f_2169[iVar5 /*205*/].f_201);
			func_170(iVar3);
		}
		iVar4++;
	}
	DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - perk: ", func_135(iParam0, 0), " Flag Count: ", Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_28);
	iVar7 = 0;
	while (iVar7 < Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_28)
	{
		iVar6 = Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_17[iVar7 /*2*/];
		if (!func_163(iVar6))
		{
			DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - Flag: ", func_171(iVar6, 0), " is not valid... skipping... ");
		}
		else if (!func_172(&(Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_17[iVar7 /*2*/])))
		{
			DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - Flag: ", func_171(iVar6, 0), " is not currently disabled by tunables... skipping... ");
		}
		else
		{
			iVar8 = func_164(iVar6, 1);
			...
			{
				DEBUG::_0xA308F935BDECCEC0(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - Turning on flag ", func_171(iVar6, 0));
	...
	func_174(Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_2);
	return true;
}
...
void func_153(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (!func_166(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA - Perk Group: ", func_149(iParam0, 0), " is not valid... Bailing out... ");
		return;
	}
	iVar0 = func_167(iParam0, 1);
	if (!func_145(iParam1))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA - Perk: ", func_135(iParam1, 0), " is not valid... Bailing out... ");
		return;
	}
	if (!func_132(iParam2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA - Source: ", func_129(iParam2, 0), " is not valid... Bailing out... ");
		return;
	}
	if (!func_169(iParam3))
	{
	...
	DEBUG::_0xF0783374333FD8CE(680, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA - Setting Perk: ", func_135(iParam1, 0), " active for Perk Group: ", func_149(iParam0, 0));
...
void func_154(int iParam0)
{
	...
	iVar0 = func_167(iParam0, 1);
	DEBUG::_0xF0783374333FD8CE(680, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA_AS_INVALID - Setting Perk: ", func_135(-1, 0), " active for Perk Group: ", func_149(iParam0, 0));
...
float func_160(var uParam0)
{
	...
	if (uParam0->f_2 != 0)
	{
		DEBUG::_0xF0783374333FD8CE(168, 84, "RPG_GLOBAL_STATS_GET_STAT_MOD_IMPACT - Stat Mod: ", func_161(*uParam0, 0), " has a Tunable associated with impact, looking up... ");
		fVar0 = func_181(794259616, uParam0->f_2, uParam0->f_1, "");
		DEBUG::_0xF0783374333FD8CE(424, 84, "RPG_GLOBAL_STATS_GET_STAT_MOD_IMPACT - Stat Mod: ", func_161(*uParam0, 0), " has an associated Tunable with impact: ", fVar0);
		return fVar0;
	}
	DEBUG::_0xF0783374333FD8CE(424, 84, "RPG_GLOBAL_STATS_GET_STAT_MOD_IMPACT - Stat Mod: ", func_161(*uParam0, 0), " using default Impact: ", uParam0->f_1);
	return uParam0->f_1;
}
...
void func_162(int iParam0)
{
	...
	if (!func_159(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__UNSUBSCRIBE_STAT_MOD - Stat Mod: ", func_161(iParam0, 0), " is Invalid... ");
		return;
	}
	iVar0 = func_158(iParam0, 1);
	if (!func_182(Global_1146683.f_2169[iVar0 /*205*/]))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__UNSUBSCRIBE_STAT_MOD - no RPG stat associated with stat mod ", func_161(iParam0, 0));
		return;
	}
	...
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__UNSUBSCRIBE_STAT_MOD - stat mod ", func_161(iParam0, 0), " is no longer impacting stat ", func_183(Global_1146683.f_2169[iVar0 /*205*/], 0));
	Global_1146683.f_2169[iVar0 /*205*/].f_204 = 0;
	if (!func_184(Global_1146683.f_2169[iVar0 /*205*/].f_203))
	{
		return;
	}
	iVar1 = func_185(Global_1146683.f_2169[iVar0 /*205*/].f_203, 1);
	...
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__UNSUBSCRIBE_STAT_MOD - removing stat ", func_183(Global_1146683.f_2169[iVar0 /*205*/], 0), " from subscribed action ", func_186(Global_1146683.f_2169[iVar0 /*205*/].f_203, 0));
	iVar2 = 0;
...
void func_165(int iParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_STAT_FLAG - Now Disabling Stat Flag: ", func_171(iParam0, 0));
	iVar0 = PLAYER::PLAYER_PED_ID();
	...
	switch (iParam0)
	{
		...
		case joaat("TRAIL_EFFECT"):
			...
			GRAPHICS::_0xC5CB91D65852ED7E(func_189(iParam0));
			break;
		case joaat("DRAIN_EFFECT"):
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
		case joaat("SLOW_AND_STEADY_VFX"):
			DEBUG::_0xF0783374333FD8CE(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_STAT_FLAG - Remove VFX ", func_171(iParam0, 0));
...
int func_168(int iParam0)
{
	...
	{
		iVar64 = func_139(Global_1146683.f_35859.f_9503[iVar65 /*3*/], 1);
		DEBUG::_0x1B08D1EB9D8C4931(168, 84, "RPG_GLOBAL_GET_ACTIVATION_QUEUE_PERK_INDEX_FROM_NEXT_AVAILIBLE_PERK_IN_STACK_GROUP - Now processing Perk: ", func_135(Global_1146683.f_35859.f_9503[iVar65 /*3*/], 0), "...");
		...
		else if (!func_194(Global_1146683.f_35859.f_9503[iVar65 /*3*/], Global_1146683.f_35859.f_9503[iVar65 /*3*/].f_1))
		{
		}
		else
		{
			Var1 = { func_195(Global_1146683.f_35859.f_9503[iVar65 /*3*/]) };
...
void func_170(int iParam0)
{
	...
	if (!func_159(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__SUBSCRIBE_STAT_MOD - Stat Mod: ", func_161(iParam0, 0), " is Invalid... ");
		return;
	}
	iVar0 = func_158(iParam0, 1);
	if (!func_182(Global_1146683.f_2169[iVar0 /*205*/]))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__SUBSCRIBE_STAT_MOD - no RPG stat associated with stat mod ", func_161(iParam0, 0));
		return;
	}
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__SUBSCRIBE_STAT_MOD - subcribing stat mod ", func_161(iParam0, 0), " to stat ", func_183(Global_1146683.f_2169[iVar0 /*205*/], 0));
	...
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__SUBSCRIBE_STAT_MOD - adding stat ", func_183(Global_1146683.f_2169[iVar0 /*205*/], 0), " to action ", func_186(Global_1146683.f_2169[iVar0 /*205*/].f_203, 0));
...
bool func_172(var uParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(680, 84, "RPG_GLOBAL_STATS_IS_STAT_FLAG_TUNABLE_ENABLED - Stat Flag: ", func_171(*uParam0, 0), " Associated Tunable: ", UNK_0x4379B6FA65D55295(uParam0->f_1));
	if (uParam0->f_1 != 0)
	{
		bVar0 = func_196(794259616, uParam0->f_1, 1, "");
		DEBUG::_0xF0783374333FD8CE(680, 84, "RPG_GLOBAL_STATS_IS_STAT_FLAG_TUNABLE_ENABLED - Stat Flag: ", func_171(*uParam0, 0), " is has Tunable Enabled State: ", MISC::_0xF216F74101968DB0(bVar0));
		return bVar0;
	}
	return true;
}
...
void func_173(int iParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_STAT_FLAG - Now Enabling Stat Flag: ", func_171(iParam0, 0));
	iVar0 = PLAYER::PLAYER_PED_ID();
	iVar1 = PLAYER::PLAYER_ID();
	switch (iParam0)
	{
		...
		case joaat("TRAIL_EFFECT"):
			...
			GRAPHICS::ANIMPOSTFX_PLAY(func_189(iParam0));
			break;
		case joaat("DRAIN_EFFECT"):
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			...
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_197(iParam0, 0));
			func_198(iVar2, 0, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_197(iParam0, 1));
			func_198(iVar2, 1, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_197(iParam0, 2));
			func_198(iVar2, 2, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_197(iParam0, 3));
			func_198(iVar2, 2, 1, iVar3, 0);
			break;
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
			DEBUG::_0xF0783374333FD8CE(8, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_STAT_FLAG - Moment to Recuperate VFX start. ");
			iVar2 = func_190(iParam0);
			func_198(iVar2, 3, 1, -1, 1);
			break;
		case joaat("SLOW_AND_STEADY_VFX"):
			DEBUG::_0xF0783374333FD8CE(8, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_STAT_FLAG - Slow and Steady VFX start. ");
			iVar2 = func_190(iParam0);
			func_198(iVar2, 4, 1, -1, 0);
			break;
		case joaat("MOMENT_TO_RECUPERATE_AURA"):
...
void func_174(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - Attempting to play Activation Sound: ", func_200(iParam0, 0));
	sVar0 = func_201(iParam0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - There is no sound name associated with Activation Sound: ", func_200(iParam0, 0), " not playing anything...");
		return;
	}
	DEBUG::_0x1B08D1EB9D8C4931(680, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - Found sound name: ", sVar0, " associated with Activation Sound: ", func_200(iParam0, 0));
	sVar1 = func_202(iParam0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - There is no sound set associated with Activation Sound: ", func_200(iParam0, 0), " not playing anything...");
		return;
	}
	DEBUG::_0x1B08D1EB9D8C4931(680, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - Found sound set: ", sVar1, " associated with Activation Sound: ", func_200(iParam0, 0));
	DEBUG::_0xF0783374333FD8CE(10920, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - Playing sound name: ", sVar0, " in sound set: ", sVar1, " for Activation Sound: ", func_200(iParam0, 0));
...
float func_181(bool bParam0, bool bParam1, float fParam2, char* sParam3)
{
	struct<11> Var0;
	float fVar22;

	if (func_203(bParam0, bParam1, &Var0))
	{
...
bool func_182(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(168, 84, "RPG_GLOBAL_STATS__ADD_STAT_ID_TO_UPDATE_QUEUE - adding stat ", func_183(iParam0, 0), " to update queue. Total stats in queue: ", Global_1146683.f_2165);
	return true;
}
...
void func_187()
{
	...
	{
		if (!func_204(Global_1277758[Global_1275959 /*87*/].f_86, 1))
		{
...
char* func_189(int iParam0)
{
	...
	DEBUG::_0x9A6C65DDDBEC9C52(168, 84, "RPG_GLOBAL_GET_STAT_FLAG_POSTFX_NAME - Stat Flag: ", func_171(iParam0, 0), " does not have a Post FX name. Should you set one up? ");
	return "";
}
...
int func_190(int iParam0)
{
	...
	DEBUG::_0x9A6C65DDDBEC9C52(168, 84, "RPG_GLOBAL_GET_STAT_FLAG_PTFX_SCRIPT_ID - Stat Flag: ", func_171(iParam0, 0), " does not have a Particle FX. Should you set one up? ");
	return 0;
}
...
bool func_194(int iParam0, int iParam1)
{
	...
	if (func_147(Global_1146683.f_35859.f_3116[iVar0 /*31*/]))
	{
		iVar3 = Global_1146683.f_35859.f_9286[func_167(iVar2, 1) /*3*/];
		Var4 = { func_195(iVar3) };
		if (iVar3 != iParam0 && Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_5 <= Var4.f_5)
		{
			DEBUG::_0x1B08D1EB9D8C4931(680, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - A stronger perk in the perk stack group: ", func_149(iVar2, 0), " is already active. Active Perk: ", func_135(iVar3, 0));
			return false;
		}
	}
	DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Evaluating Activation Trigger: ", func_205(Global_1146683.f_35859.f_3116[iVar0 /*31*/], 0), " for activation... ");
	switch (Global_1146683.f_35859.f_3116[iVar0 /*31*/])
	{
		...
		case 2116793692:
			DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_135(iParam0, 0), " can be activated! ");
			return true;
		case joaat("ENTER_FREEROAM_OR_COOP"):
			if (!func_206() && !func_207())
			{
				DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_135(iParam0, 0), " can only be activated when you are in Free Roam or running COOP. Returning FALSE. ");
				return false;
			}
			DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_135(iParam0, 0), " can be activated! ");
			return true;
		case -2010146101:
			if (!func_206())
			{
				DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_135(iParam0, 0), " can only be activated when you are in Free Roam. Returning FALSE. ");
				return false;
			}
			DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_135(iParam0, 0), " can be activated! ");
			return true;
		case joaat("ENTER_REVIVED_REMOTE"):
			...
			{
				DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_135(iParam0, 0), " can only be activated from REMOTE players. Returning FALSE. ");
				return false;
			}
			DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_135(iParam0, 0), " can be activated from Remote Player Index: ", iVar1);
			return true;
		case -2129621195:
			iVar1 = func_143(iParam1);
			if (iVar1 == Global_1275959)
		...
		case joaat("ALLY_ENTER_DEADEYE"):
			...
			if (iVar1 != Global_1275959 && !func_208(Global_1275959.f_154[iVar1]))
			{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_135(iParam0, 0), " has no activation logic defined, fix this... ");
	return false;
}

struct<31> func_195(int iParam0)
{
	int iVar0;
...
bool func_196(bool bParam0, bool bParam1, bool bParam2, char* sParam3)
{
	struct<11> Var0;
	bool bVar22;
...
char* func_197(int iParam0, int iParam1)
{
	...
	DEBUG::_0x9A6C65DDDBEC9C52(168, 84, "RPG_GLOBAL_GET_STAT_FLAG_PTFX_BONE - Stat Flag: ", func_171(iParam0, 0), " does not have a Particle FX bone. Should you set one up? ");
	return "";
}
...
bool func_203(bool bParam0, bool bParam1, var uParam2)
{
	struct<5> Var0;
	int iVar7;
	...
	if (DATAFILE::_0x44B3A36933AC009C(&iVar7, &Var0, joaat("NAME")))
	{
		*uParam2 = bParam0;
		...
		uParam2->f_10.f_3 = func_210(iVar7);
...
bool func_207()
{
	...
	if (func_213(Global_524288.f_40400))
	{
