...
void func_1()
{
	...
	DEBUG::_0xA308F935BDECCEC0(8, 111, "CLEANUP_LAW_ROADBLOCK start");
...
void func_6()
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 111, "UPDATE_LAW_SPAWN state: ", func_22(iLocal_16, 0));
	switch (iLocal_16)
	{
		case 1:
			func_23(&uLocal_125);
		...
		case 2:
			...
			if (((STREAMING::HAS_MODEL_LOADED(bLocal_30) && STREAMING::HAS_MODEL_LOADED(iLocal_31)) && STREAMING::HAS_MODEL_LOADED(iLocal_32)) && PED::_0x5E420FF293EE5472())
			{
				iLocal_16 = 3;
			}
			break;
		case 3:
			if (func_25(Global_34, &Local_17, &bVar1, 16, 1, 45f, 25f, 100f, 180f, 0))
			{
				vLocal_33 = { Local_17.f_3 };
				func_26(&uLocal_38, vLocal_33, 5f, 2, 2, 0);
				func_26(&uLocal_37, vLocal_33, 7f, 1, 61, 0);
				iLocal_16 = 4;
			}
			else if (bVar1)
			{
				func_27(&Local_17, 1, 0);
			}
			break;
		case 4:
			if (!bLocal_29)
			...
			else
			{
				...
				while (iVar2 < iLocal_39)
				{
					if (func_9(iLocal_39[iVar2], 0))
					{
						if (iVar2 <= 1)
						{
							iVar3 = iLocal_119[iVar2];
						}
						else if (func_31())
						{
							iVar3 = iLocal_113[iVar2];
						}
						else
						{
							iVar3 = iLocal_119[iVar2];
						}
						TASK::_TASK_USE_SCENARIO_POINT(iLocal_39[iVar2], iVar3, 0, 0, false, true, 0, false, -1f, false);
					}
					iVar2++;
				}
				iLocal_16 = 5;
		...
		case 5:
			...
			while (iVar4 < iLocal_39)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_39[iVar4]))
				{
					...
					if (func_32(Global_33, iLocal_39[iVar4], 1, 1) > 200f)
					{
						iLocal_16 = 6;
						return;
					}
...
int func_7()
{
	return func_34(func_33(func_15()));
}
...
void func_11(vector3 vParam0, float fParam3, int iParam4)
{
	...
	vVar6 = { func_37(vVar0, vVar3, 0f) };
	vVar9 = { func_38(vVar0, vVar3, 0f) };
	if (iParam4 == 5)
	{
...
bool func_19()
{
	...
	if (func_45(Global_38.f_194[iVar0 /*12*/].f_1) || Global_38.f_194[iVar0 /*12*/].f_4 < 1f)
	{
		return false;
	}
	if (func_46(Global_33, Global_38.f_194[iVar0 /*12*/].f_1, (Global_38.f_194[iVar0 /*12*/].f_4 + 10f), 1, 1))
	{
		return true;
	}
	return false;
...
bool func_20(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_47(&(Global_1102630.f_4), iVar0, 5);
	}
	if (iParam1 == func_48())
	{
		return func_47(&(Global_1102630.f_4), iVar0, 5);
	...
	{
		return func_47(&(Global_1100880[iParam1 /*53*/].f_4), iVar0, 5);
	}
...
bool func_25(vector3 vParam0, int iParam3, bool bParam4, int iParam5, bool bParam6, float fParam7, int iParam8, float fParam9, int iParam10, float fParam11)
{
	int iVar0;
	...
	switch (*iParam3)
	{
		case 0:
			...
			func_53(&(iParam3->f_1), iParam3->f_2, vParam0, iParam5, fParam7, iParam8, fParam9, iParam10, fParam11);
			if (!TASK::_0x1AC5A8AB50CFAA33(iParam3->f_1))
			{
			}
			else
			{
				func_54(&(iParam3->f_1), iParam5, vParam0);
				if (!func_45(iParam3->f_6))
				{
					TASK::_0xCE4E669400E5F8AA(iParam3->f_1, func_55(iParam3->f_6));
				}
...
void func_26(var uParam0, vector3 vParam1, bool bParam4, int iParam5, bool bParam6, int iParam7)
{
	if (!func_35(uParam0))
	{
...
void func_28()
{
	...
	DEBUG::_0xA308F935BDECCEC0(8, 111, "UPDATE_LAW_SPAWN creating lawman #", iLocal_28);
	...
	func_56(&vVar0, 50, 10, 0, 0);
	iLocal_39[iLocal_28] = func_57(bLocal_30, vVar0, (fLocal_36 + MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 60f)), 1, 1, 0, 1, 1, 1, 0, 0);
	...
	func_58(iLocal_39[iLocal_28], iLocal_128);
	iLocal_28++;
...
void func_29()
{
	...
	{
		Var7 = { func_59(&Local_80) };
		vVar3 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_45, Var7.f_1) };
		func_56(&vVar3, 50, 10, 0, 0);
		fVar6 = func_60(vVar0, vVar3);
		iLocal_119[iVar11] = TASK::CREATE_SCENARIO_POINT(Var7, vVar3, fVar6, 0, 0, 0);
		iVar11++;
	}
	...
	{
		Var7 = { func_59(&Local_47) };
		fVar16 = 1.5f;
		vVar12 = { func_61(((360f / IntToFloat(iLocal_27)) * IntToFloat(iVar15))) };
		vVar3 = { vVar0 + vVar12 * Vector(fVar16, fVar16, fVar16) };
		fVar6 = func_60(vVar3, vVar0);
		func_56(&vVar3, 50, 10, 0, 0);
		iLocal_113[iVar15] = TASK::CREATE_SCENARIO_POINT(Var7, vVar3, fVar6, 0, 0, 0);
		iVar15++;
	}
}

void func_30(vector3 vParam0, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_34(int iParam0)
{
	...
	if (func_62(iParam0) > 0 && PLAYER::GET_WANTED_LEVEL_THRESHOLD(5) > 0)
	{
		return func_63(func_62(iParam0));
	}
	return 0;
}
...
Vector3 func_38(vector3 vParam0, vector3 vParam3, float fParam6)
{
	vector3 vVar0;
...
void func_53(var uParam0, int iParam1, vector3 vParam2, int iParam5, float fParam6, int iParam7, float fParam8, float fParam9, float fParam10)
{
	int iVar0;
	int iVar1;
	...
	if (fParam8 == -0.01f)
	{
		switch (iParam5)
		{
			...
			case 36:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_68(10f, 40f, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_68(30f, 60f, 5f, iParam1));
			...
			case 37:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_68(40f, 80f, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_68(50f, 90f, 5f, iParam1));
				TASK::_0x450080DDEDB91258(*uParam0, 10f);
			...
			case 38:
				TASK::_0x2EB977293923C723(*uParam0, 30f);
				TASK::_0x954451EA2D2120FB(*uParam0, func_68(30f, 60f, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_68(50f, 80f, 5f, iParam1));
			...
			case 39:
				TASK::_0x2EB977293923C723(*uParam0, 10f);
				TASK::_0x954451EA2D2120FB(*uParam0, func_68(0f, 10f, 1f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_68(5f, 15f, 1f, iParam1));
			...
			case 40:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_68(60f, 120f, 10f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_68(100f, 130f, 5f, iParam1));
			...
			case 41:
				TASK::_0x2EB977293923C723(*uParam0, 10f);
				TASK::_0x954451EA2D2120FB(*uParam0, func_68(10f, 35f, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_68(25f, 50f, 5f, iParam1));
			...
			case 45:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_68(60f, 80f, 10f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_68(75f, 95f, 5f, iParam1));
				TASK::_0xBC3F847AE2C3DC65(*uParam0, 10f);
			...
			case 50:
				TASK::_0x2EB977293923C723(*uParam0, 30f);
				TASK::_0x954451EA2D2120FB(*uParam0, func_68(30f, 70f, 10f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_68(65f, 95f, 5f, iParam1));
			...
			case 51:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_68(25f, 35f, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_68(40f, 50f, 5f, iParam1));
			...
			case 52:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, 0f);
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_68(40f, 100f, 10f, iParam1));
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				break;
			case 42:
				TASK::_0x2EB977293923C723(*uParam0, 50f);
				TASK::_0x954451EA2D2120FB(*uParam0, func_68(50f, 70f, 10f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_68(65f, 85f, 5f, iParam1));
				TASK::_0xBC3F847AE2C3DC65(*uParam0, 10f);
				TASK::_0x450080DDEDB91258(*uParam0, 25f);
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				break;
			case 49:
				...
				TASK::_0x2EB977293923C723(*uParam0, 50f);
				TASK::_0x954451EA2D2120FB(*uParam0, 0f);
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_68(10f, 50f, 10f, iParam1));
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				break;
			case 43:
				TASK::_0x2EB977293923C723(*uParam0, func_68(95f, 90f, 80f, iParam1));
				TASK::_0x954451EA2D2120FB(*uParam0, func_68(95f, 90f, 80f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_68(125f, 115f, 100f, iParam1));
				TASK::_0x450080DDEDB91258(*uParam0, 5f);
				TASK::_0xBC3F847AE2C3DC65(*uParam0, 10f);
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				break;
			case 46:
				iVar0 = func_69(vParam2, 1);
				iVar1 = func_70(vParam2);
				if ((((iVar1 == 15 || iVar1 == 14) || iVar1 == 13) || (iVar1 == 9 && iVar0 == -1)) || (iVar1 == 4 && iVar0 == -1))
				{
					TASK::_0x2EB977293923C723(*uParam0, func_68(100f, 80f, -5f, iParam1));
					TASK::_0x954451EA2D2120FB(*uParam0, func_68(100f, 80f, -5f, iParam1));
					TASK::_0x0F4F6C4CE471259D(*uParam0, func_68(110f, 160f, 12.5f, iParam1));
				}
				else
				{
					TASK::_0x2EB977293923C723(*uParam0, func_68(100f, 70f, -7.5f, iParam1));
					TASK::_0x954451EA2D2120FB(*uParam0, 70f);
					TASK::_0x0F4F6C4CE471259D(*uParam0, func_68(80f, 150f, 17.5f, iParam1));
				}
				TASK::_0xBC3F847AE2C3DC65(*uParam0, 10f);
				TASK::_0x450080DDEDB91258(*uParam0, 25f);
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
			...
			case 47:
				...
				TASK::_0x2EB977293923C723(*uParam0, 50f);
				TASK::_0x954451EA2D2120FB(*uParam0, 0f);
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_68(50f, 90f, 10f, iParam1));
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				if (iParam1 <= 2)
				{
					TASK::_0x764DB5A48390FBAD(*uParam0, 1);
			...
			case 48:
				...
				TASK::_0x2EB977293923C723(*uParam0, func_68(100f, 70f, -7.5f, iParam1));
				TASK::_0x954451EA2D2120FB(*uParam0, 70f);
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_68(150f, 190f, 10f, iParam1));
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				if (iParam1 <= 2)
				{
					TASK::_0x764DB5A48390FBAD(*uParam0, 1);
...
void func_54(var uParam0, int iParam1, vector3 vParam2)
{
	switch (iParam1)
	{
		case 0:
...
Vector3 func_55(vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
int func_56(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	char* sVar0;
	int iVar1;
	bool bVar2;
...
int func_57(bool bParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12)
{
	int iVar0;
	...
	func_72(iVar0, bParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
struct<4> func_59(int iParam0)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(8, 111, "GET_AND_BURN_RANDOM_SCENARIO_FROM_POTENTIAL_LIST try #: ", iVar4);
	iVar5 = 0;
	while (iVar5 < 8)
	{
		if ((*iParam0)[iVar4 /*4*/] != iLocal_26)
		{
			DEBUG::_0x1B08D1EB9D8C4931(136, 111, "GET_AND_BURN_RANDOM_SCENARIO_FROM_POTENTIAL_LIST #: ", iVar4, " is good. Value: ", (*iParam0)[iVar4 /*4*/]);
		...
		else
		{
			...
			if (iVar4 >= 8)
			{
				DEBUG::_0x1B08D1EB9D8C4931(8, 111, "GET_AND_BURN_RANDOM_SCENARIO_FROM_POTENTIAL_LIST index has looped around, reset to 0");
				iVar4 = 0;
			}
			iVar5++;
		}
...
float func_60(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)
{
	return MISC::GET_HEADING_FROM_VECTOR_2D((Param3 - Param0), (Param3.f_1 - Param0.f_1));
}

Vector3 func_61(float fParam0)
{
...
float func_68(float fParam0, float fParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_69(vector3 vParam0, int iParam3)
{
	int iVar0;
...
void func_72(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
{
	DEBUG::_0xA308F935BDECCEC0(648, 28, "HORSE_SET_GENDER - pedHorse: ", sParam0, " eGender = ", func_80(iParam1, 0));
	if (iParam1 == 1)
	{
...
int func_79(vector3 vParam0)
{
	...
	iVar0 = func_81(vParam0, 0f, 0f, 0, 2);
	return func_81(vParam0, Global_1892752[iVar0 /*3*/].f_1, Global_1892752[iVar0 /*3*/].f_2, Global_1892752[iVar0 /*3*/], 4);
}
...
int func_81(struct<2> Param0, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6)
{
	if (Param0 < fParam3)
	{
