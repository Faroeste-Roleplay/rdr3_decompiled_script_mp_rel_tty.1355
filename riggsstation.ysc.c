...
void __EntryFunction__()
{
	...
	DEBUG::_0xF0783374333FD8CE(43688, 17, "**** INITIALIZING REGION: ", &(Global_1887351[vScriptParam_0.x /*36*/].f_23), ", ", &(Global_1887351[iLocal_26 /*36*/].f_24), ", ", &(Global_1887351[iLocal_26 /*36*/].f_27), " ****");
	func_2();
	func_3();
	...
	while (func_4())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_25)
		{
			...
			{
				case 0:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_26 /*36*/].f_23), " global init...");
					if (Global_1901988.f_1.f_26 > 0)
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_26 /*36*/].f_23), "-> RBS_WAIT_FOR_UGC_EARLY_QUIT");
						iLocal_27 = (MISC::GET_GAME_TIMER() + Global_1901988.f_1.f_26);
						iLocal_24 = 1;
					}
					else
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_26 /*36*/].f_23), "-> RBS_INIT_REGION");
						iLocal_24 = 2;
					}
					break;
				case 1:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_26 /*36*/].f_23), " ugc early quit...");
					...
					break;
				case 2:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_26 /*36*/].f_23), " region init...");
					func_6(iLocal_26);
					func_7();
					func_8();
					...
					Global_1896632 = -1;
					DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_26 /*36*/].f_23), "-> RBS_INIT_VOLUME");
					iLocal_27 = (iLocal_23 + MISC::GET_GAME_TIMER());
					iLocal_24 = 3;
					break;
				case 3:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_26 /*36*/].f_23), " volume init...");
					if (func_13() || iLocal_27 < MISC::GET_GAME_TIMER())
					{
						func_14(iLocal_26);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_26 /*36*/].f_23), "-> RBS_LOAD_APPEARANCE");
						iLocal_27 = (MISC::GET_GAME_TIMER() + iLocal_23);
						iLocal_24 = 4;
					}
					break;
				case 4:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_26 /*36*/].f_23), " load appearance...");
					if (func_15(iLocal_26) || iLocal_27 < MISC::GET_GAME_TIMER())
					{
						func_16(iLocal_26);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_26 /*36*/].f_23), "-> RBS_LOAD_SPECIAL");
						iLocal_27 = (MISC::GET_GAME_TIMER() + iLocal_23);
						iLocal_24 = 5;
					}
					break;
				case 5:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_26 /*36*/].f_23), " load special...");
					if (func_17(iLocal_26) || iLocal_27 < MISC::GET_GAME_TIMER())
					{
						func_18(iLocal_26);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_26 /*36*/].f_23), "-> RBS_LOAD_PERS_CHARS");
						iLocal_27 = (iLocal_23 + MISC::GET_GAME_TIMER());
						iLocal_24 = 7;
					}
					break;
				case 7:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_26 /*36*/].f_23), " init regional chars...");
					if (func_10(func_9(iLocal_26)))
					{
						...
						else
						{
							if (func_20(iLocal_26) || iLocal_27 < MISC::GET_GAME_TIMER())
							{
								func_21(iLocal_26, 4);
								iLocal_27 = (MISC::GET_GAME_TIMER() + iLocal_23);
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_26 /*36*/].f_23), "-> RBS_INIT_AMBIENT");
								iLocal_24 = 8;
							}
							...
							{
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_26 /*36*/].f_23), " AMBIENT MINIGAMES ARE NOT BEING ENABLED AS A STORY OR RCM OR MISSION RETRY IS HAPPENING");
							}
							func_26();
							func_27();
							func_28();
							...
							func_31();
							func_32();
							DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": INIT_CURRENT_REGION_TOWN_DATA FOR ", &(Global_1887351[iLocal_26 /*36*/].f_23));
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_26 /*36*/].f_23), " RBS_INIT_AMBIENT -> RBS_INIT_LAW");
							iLocal_24 = 9;
							Jump @1356; //curOff = 1032
							func_33(iLocal_26);
							func_34();
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_26 /*36*/].f_23), "-> RBS_INIT_NAMED_LOCATIONS");
							iLocal_24 = 10;
							Jump @1356; //curOff = 1070
							func_35(&Global_1896686);
							func_36(iLocal_26, &Global_1896686);
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_26 /*36*/].f_23), "-> RBS_DONE_INIT");
							iLocal_24 = 11;
							Jump @1356; //curOff = 1116
							DEBUG::_0xF0783374333FD8CE(168, 17, "**** FINISHED INITIALIZING: ", &(Global_1887351[iLocal_26 /*36*/].f_23), " ****");
							func_37(iLocal_26);
							func_21(iLocal_26, 8);
							if (func_38(32))
							{
							...
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_26 /*36*/].f_23), "-> RBS_RUNNING");
							iLocal_24 = 12;
							...
							func_41(&Global_1896686, iLocal_26);
							func_42(iLocal_26);
							func_21(iLocal_26, 8);
							if (func_43())
							{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887351[iLocal_26 /*36*/].f_11);
							if (Global_1887351[iLocal_26 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887351[iLocal_26 /*36*/].f_12);
							}
							Jump @1356; //curOff = 1312
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_26 /*36*/].f_23), " RBS_CLEANUP");
							func_8();
							func_44(iVar0);
							iVar0++;
						}
						if (Global_1887351[iLocal_26 /*36*/].f_13 == 0)
						{
						}
						else
						{
							PED::_0x95423627A9CA598E(Global_1887351[iLocal_26 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
...
bool func_1()
{
	if (!bLocal_28)
	{
		if (Global_1051140)
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_26 /*36*/].f_23), ", g_mpUGC_QuitSessionRequest.bRequestRunning is still true");
			bLocal_28 = true;
			return true;
		}
		if (func_47() && func_48())
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_26 /*36*/].f_23), ", a session request is running and a UGC script is running");
			bLocal_28 = true;
			return true;
		}
	...
	if (func_48())
	{
		DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_26 /*36*/].f_23), ", content script still running for some player");
		return true;
	}
...
bool func_13()
{
	iLocal_20 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Riggs Stn - m_volPostOfficePrompt Agg");
	VOLUME::_0x39816F6F94F385AD(iLocal_20, -1095.52f, -576.564f, 82.8243f, 0f, 0f, 52.00422f, 2.27305f, 1.013785f, 2.820909f);
	VOLUME::_0x39816F6F94F385AD(iLocal_20, -1094.093f, -574.7371f, 82.8243f, 0f, 0f, 52.00422f, 2.27305f, 1.013785f, 2.820909f);
	iLocal_19 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1094.383f, -575.865f, 82.807f, 0f, 0f, 52.00422f, 4.73f, 5.502f, 2.821f, "Riggs Stn - m_volPostOfficeOwner");
	iLocal_21 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1093.137f, -576.9941f, 82.84734f, 0f, 0f, 52.00422f, 4.470828f, 2.119287f, 2.820909f, "Riggs Stn - m_volPostOfficeOfflimits");
	VOLUME::_0xB469CFD9E065EB99(iLocal_19, 10025);
	return true;
}
...
{
	func_58(2, iLocal_19, iParam0, iLocal_20, iLocal_21, 1277952, 0, 0, -1082130432 /* Float: -1f */, 0);
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_34, 0f, 0f, 0f) <= 5f || func_66(Global_1940410, 32768)) || func_66(Global_1940410, 16777216))
	{
		return;
	}
...
bool func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": REGION_TOWN_MANANGER_EXIT_TOWN FOR ", &(Global_1887351[iLocal_26 /*36*/].f_23));
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_26)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_79(iLocal_26));
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_80(iLocal_26, 0), 1);
					break;
			}
		}
		if (func_10(func_72()))
	...
	else
	{
		...
		if (func_45() == -1)
		{
			func_84(iLocal_26);
			func_85(iLocal_26);
			if (!func_86(iLocal_26, 0))
			{
				return false;
			}
		}
		else if (!func_87(iLocal_26))
		{
			return false;
		}
	}
	DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": Terminating. -- ", &(Global_1887351[iLocal_26 /*36*/].f_23));
	SCRIPTS::TERMINATE_THIS_THREAD();
	return true;
}
...
bool func_49(bool bParam0, bool bParam1)
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		{
			DEBUG::_0xF0783374333FD8CE(168, 8, "KILL_EVENT_CAUGHT - NETWORK_IS_GAME_IN_PROGRESS() = FALSE - but bIgnoreTransition = TRUE and g_mpTransition.eMPState = ", func_88(Global_1572887, 0), ", so skipping");
		}
		else
		{
...
int func_53(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (!func_63(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Region index not valid ", func_90(iParam0));
		return 1;
	}
	if (func_89(iParam0, 16))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: RF_PERS_DISABLED is on for ", func_90(iParam0));
		return 1;
	}
	if (func_91(iParam0) && !func_92(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: IS_REGION_IN_LOCKDOWN is on for ", func_90(iParam0));
	}
	DEBUG::_0xF0783374333FD8CE(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Starting for ", func_90(iParam0));
	if (func_93(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if ((!func_91(iParam0) || func_92(iParam0)) || func_95(Global_1896632))
			{
				func_96(Global_1896632, 0);
			}
			Global_1896632++;
			iVar2++;
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	func_101(iParam0, 1);
	DEBUG::_0xF0783374333FD8CE(40, 139, "NET_ENABLE_SHOP_LOCATION: Registering ", func_102(iParam0));
	Global_1051777.f_80[iParam0 /*75*/] = 0;
	Global_1051777.f_80[iParam0 /*75*/].f_18 = func_103(iParam2, iParam0);
...
void func_59(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	if (iVar0 < 0 || iVar0 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(40, 139, "[NET_ADD_SHOP_DOOR] - Invalid door index for shop: ", func_109(iParam0, 0));
		return;
	}
	Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0] = func_110(bParam1, 0, 0);
	if (func_111(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0]))
	{
		if (!func_112(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0]))
		{
			func_113(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0], 0, fParam2, bParam3, 1, 0, bParam4, 0);
		}
	}
...
int func_60(int iParam0, bool bParam1)
{
	...
	if ((func_114(iParam0, 16384) || func_114(iParam0, 32768)) || func_115(Global_1051777.f_80[iParam0 /*75*/].f_3))
	{
	...
	iVar0 = func_103(func_116(), iParam0);
	if ((!bParam1 && func_117(iVar0, &bVar1, &uVar2, &vVar3)) || (bParam1 && func_118(iVar0, &bVar1, &uVar2, &vVar3)))
	{
		func_119(iParam0, bVar1, vVar3, uVar2, 0);
...
int func_61(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == 0)
	{
		DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_122(iParam0), " IS INVALID.");
		return 0;
	}
	DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_122(iParam0), " IS VALID.");
...
bool func_68()
{
	return func_66(Global_1940410, 8192);
}
...
bool func_70(int iParam0)
{
	...
	return ((Global_1887351[iParam0 /*36*/].f_21 == 1 || Global_1887351[iParam0 /*36*/].f_21 == 2) && !func_129(iParam0));
}
...
void func_73(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	char* sVar1;
	char* sVar2;
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_131(iParam0, 0), " ", func_132(iParam1, 0), " ", func_133(bParam2, 0), " state ", func_134(iParam4, 0));
	UNK_0x355E72323AEE83CC(11, 6);
	sVar1 = func_135(iParam0, iParam1, bParam2, iParam4, bParam5, bParam3, &bVar0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_131(iParam0, 0), " or ", func_132(iParam1, 0), " or ", func_133(bParam2, 0));
	...
	if (bVar0 && bParam3)
	{
		sVar2 = func_140(func_139(bParam2));
	}
	else if ((func_141(iParam1, 2) || func_142(iParam4, 2)) && !Global_1893599.f_9)
	{
	...
	else if ((func_63(iParam0) && func_89(iParam0, 16777216)) && !Global_1893599.f_9)
	{
	...
	Global_1939313.f_145 = func_148(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_75(int iParam0, bool bParam1)
{
	...
	func_150(&Global_1940410, 16384);
	func_128(func_151(joaat("DISCOVERED"), joaat("AREAS")), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_128(func_151(joaat("DISCOVERED"), joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_128(func_151(joaat("DISCOVERED"), joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_128(func_151(joaat("DISCOVERED"), joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_128(func_151(joaat("DISCOVERED"), joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_128(func_151(joaat("DISCOVERED"), joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_128(func_151(joaat("DISCOVERED"), joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
bool func_86(int iParam0, bool bParam1)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 138, "DELETE_ALL_REGIONAL_CHARACTERS starting for Region ", func_90(iParam0));
	if (func_93(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_154(Global_1896632.f_1, 16))
			{
				func_155(Global_1896632.f_1, 0);
			}
			Global_1896632.f_1++;
			iVar2++;
...
bool func_87(int iParam0)
{
	...
	while (iVar0 < 40)
	{
		if (func_156(iVar0) || func_157(iVar0))
		{
		}
		else
		{
	...
	switch (iParam0)
	{
		...
		case 139:
			...
			*iParam2 = 851;
			...
			break;
		default:
			DEBUG::_0xA308F935BDECCEC0(40, 138, "Attempting to get regional character bounds for a region that doesn't have them yet ", func_79(iParam0));
			*iParam1 = -1;
			*iParam2 = -1;
			break;
	}
...
int func_96(int iParam0, bool bParam1)
{
	if (!func_94(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_122(iParam0), " is invalid");
		return 0;
	}
	if (!func_154(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_122(iParam0), " has not been initialized");
		return 0;
	}
	if (func_154(iParam0, 32) && !bParam1)
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_122(iParam0), " has been locked dead");
		func_161(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_160(iParam0)));
		if (func_45() == -1)
		{
			if (func_154(iParam0, 2048))
			{
				...
				DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_122(iParam0), " has been revived!");
			}
			PERSCHAR::_0xFCC6DB8DBE709BC8(func_121(iParam0));
		}
		return 0;
	}
	if (!func_163(iParam0) && func_45() == -1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_122(iParam0), " dead or not spawning, turn scenario groups off");
		return 0;
	}
	if (PERSCHAR::_0x800DF3FC913355F3(func_121(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Persistent character ", func_122(iParam0), " already exists");
		func_162(iParam0, 128);
		return 1;
	}
	func_161(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_160(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_121(iParam0));
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_122(iParam0), " perschar index created!");
	if (func_154(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_121(iParam0));
		func_162(iParam0, 2048);
	...
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_122(iParam0), " created.");
...
void func_100(bool bParam0, bool bParam1)
{
	...
	else
	{
		...
		func_169(0);
		func_170(&(Global_1102630.f_3849));
		...
		func_171(&(Global_1102630.f_3888));
	...
	func_172(Global_1102630.f_3849, 36);
	func_173(Global_1102630.f_3888, 36);
...
void func_101(int iParam0, bool bParam1)
{
	...
	DEBUG::_0x4DC69742196F818A(40, 139, "NET_CLEAR_SHOP ", func_109(iParam0, 0));
	bVar0 = (func_174(iParam0) && !bParam1);
	if (!bVar0 && !func_114(iParam0, 65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] - Shop keeper deleted for shop: ", func_102(iParam0));
		}
	...
	else if (func_175(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
	{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] Remove the script created scenario for: ", func_102(iParam0));
		if (TASK::_DOES_SCENARIO_POINT_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_6))
		{
	...
	if (iVar3 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "[NET_CLEAR_SHOP] - Shop: ", func_109(iParam0, 0), " current door count exceeds max door count.");
	...
	func_178(iParam0);
	if (func_114(iParam0, 262144))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 139, "NET_CLEAR_SHOP: SPF_ALLOW_BLIP_OUT_OF_REGION for ", func_102(iParam0), " is kept; all other flags cleared.");
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_24) && func_180(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_CLEAR_SHOP] Removing relationship volume from shop ", func_109(iParam0, 0));
...
int func_104(int iParam0)
{
	...
	{
		Global_1051777.f_4480[iParam0] = func_184(iParam0);
	}
...
void func_106(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_SET_SHOP_TYPE_FLAG] ", func_102(iParam0), " flag ", func_185(iParam1));
	}
...
bool func_110(bool bParam0, bool bParam1, bool bParam2)
{
	if (!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(bParam0))
	{
		if ((NETWORK::NETWORK_IS_IN_SESSION() && SCRIPTS::_DOES_THREAD_EXIST(Global_1051590.f_16[0])) && bParam1)
		{
			...
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add networked Door ", func_186(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
		else
		{
			OBJECT::_ADD_DOOR_TO_SYSTEM_NEW(bParam0, true, false, false, 0, 0, false);
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add Door ", func_186(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
	}
	...
	if (bParam2)
	{
		...
		DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Set door ", func_186(bParam0, 0), " able to change open ratio while locked");
		UNK_0x355E72323AEE83CC(183, 7);
	}
	return bParam0;
}
...
void func_113(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	func_110(bParam0, 0, 0);
	if (func_111(bParam0))
	{
		...
		else if (bParam1)
		{
			if (bParam4)
			{
				...
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking Door ID ", func_186(bParam0, 0));
			}
			else
			{
				func_190(bParam0, 1);
				UNK_0x355E72323AEE83CC(183, 9);
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking and making unbreakable Door ID ", func_186(bParam0, 0));
			}
		}
		else
		{
			func_191(bParam0, 1);
			UNK_0x355E72323AEE83CC(183, 9);
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Unlocking Door ID ", func_186(bParam0, 0));
		}
		if (bParam7)
		{
			DEBUG::_0x1B08D1EB9D8C4931(168, 183, "SET_STATE_OF_DOOR_ID - Treating Door ID ", func_186(bParam0, 0), " as shut.");
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 183, "SET_STATE_OF_DOOR_ID: Door with ID not registered by host yet ", func_186(bParam0, 0));
	}
}
...
bool func_117(int iParam0, bool bParam1, bool bParam2, char* sParam3)
{
	return func_193(iParam0, "sHash", bParam1, "fHeading", bParam2, "vPos", sParam3);
}

bool func_118(int iParam0, bool bParam1, bool bParam2, char* sParam3)
{
	return func_193(iParam0, "sClosedHash", bParam1, "fClosedHeading", bParam2, "vClosedPos", sParam3);
}

void func_119(int iParam0, bool bParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	if (bParam6)
	{
		MISC::GET_GROUND_Z_FOR_3D_COORD(vParam2, &(vParam2.f_2), false);
	}
	Global_1051777.f_80[iParam0 /*75*/].f_6 = func_194(bParam1, vParam2, uParam5, 0, 0, 0);
	...
	func_106(iParam0, 16384);
	DEBUG::_0xA308F935BDECCEC0(10920, 139, "[NET_ADD_SHOP_SCENARIO_AT_POINT] Creating scenario point: ", HUD::_GET_LABEL_TEXT_BY_HASH(bParam1), " for shop: ", func_109(iParam0, 0), " at: ", MISC::_0x6C4DBF553885F9EB(vParam2));
}
...
bool func_120(int iParam0, bool bParam1)
{
	...
	if (!PERSCHAR::_0x800DF3FC913355F3(func_121(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - Checking if ", func_122(iParam0), " is alive when the perschar index is not created.");
		return false;
	}
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_195(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_122(iParam0), " does not have a ped spawned.");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(2216, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_122(iParam0), " being processed - ALIVE = ", !PERSCHAR::_0xEB98B38CA60742D7(func_121(iParam0)), "!");
	return !PERSCHAR::_0xEB98B38CA60742D7(func_121(iParam0));
}
...
bool func_125(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
...
var func_133(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case joaat("RIOBRAVO"):
...
char* func_135(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893599.f_162)))
	{
		sVar0 = func_201(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_203(func_202(Global_34));
	}
...
void func_150(var uParam0, int iParam1)
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_208(iParam1, 0));
}
...
{
	DEBUG::_0x4DC69742196F818A(40, 195, "CLEAR_SALOON: Clearing ", func_209(iParam0));
	func_210(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_211(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
	...
	func_212(iParam0, 8192);
	func_212(iParam0, 32768);
	func_212(iParam0, 524288);
	func_212(iParam0, 1048576);
...
void func_153(int iParam0)
{
	...
	if (func_94(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_213(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_214(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_215(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_216(iParam0, 536870912);
	iVar1 = func_217(iParam0);
	if (iVar1 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(2216, 139, "[SHOP_UNLOCK_DOORS] Shop: ", func_109(iParam0, 0), " door count is greater then the. Current door count: ", iVar1, " Max door count: ", 15);
		Global_1915867.f_3[iParam0 /*447*/].f_409 = 0;
	}
	else
	{
	...
	DEBUG::_0xF0783374333FD8CE(168, 139, "[CLEAR_SHOP] Shop: ", func_109(iParam0, 0), " has been cleared!");
}
...
int func_155(int iParam0, bool bParam1)
{
	if (!func_94(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_122(iParam0), " is invalid");
		return 0;
	}
	if (!func_154(iParam0, 2))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_122(iParam0), " has not been initialized");
		return 0;
	}
	if (func_160(iParam0) == 0)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_122(iParam0), " doesn't exist");
		return 1;
	}
	if (!PERSCHAR::_0x800DF3FC913355F3(func_121(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_122(iParam0), " already destroyed");
		return 1;
	}
	if (func_154(iParam0, 1) && !bParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_122(iParam0), " is stolen, so it will be destoyed on release.");
		func_219(iParam0, 128);
		return 1;
	}
	func_162(iParam0, 129);
	func_220(iParam0);
	DEBUG::_0xA308F935BDECCEC0(40, 138, "DESTROY_REGIONAL_CHARACTER: Destroying ", func_122(iParam0));
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_121(iParam0));
	func_161(iParam0, 0);
	DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: ", func_122(iParam0), " destroyed.");
	return 1;
}
...
void func_158()
{
	...
	while (iVar0 <= 3)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ NET_CLEAR_BARTENDERS - Removed ", func_222(Global_1051777.f_3642[iVar0 /*19*/]));
...
void func_162(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_223(iParam1), " on ", func_122(iParam0));
}
...
bool func_163(int iParam0)
{
	...
	if (!func_154(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_122(iParam0), " has not been initialized");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(40, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_122(iParam0));
	return true;
}

bool func_164(struct<2> Param0)
{
	return func_224(Param0, 5, 8);
}
...
{
	if (func_226(&(Global_1102630.f_4), iParam0, 5))
	{
		DEBUG::_0xF0783374333FD8CE(680, 36, "CLEAR_NET_PLAYER_STATUS_FLAG - ", func_227(iParam0), " cleared by thread ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
		return 1;
	}
	return 0;
}

void func_168(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	func_228(iParam0);
	DEBUG::_0xF0783374333FD8CE(40, 37, "NET_SPECIAL_CAM__KILL - Setting new display to ", func_229(iParam0, 0));
	if (!func_230(1))
	{
	...
	else if (!func_231(128) && !func_232(19))
	{
		CAM::DO_SCREEN_FADE_OUT(iParam2);
	}
	if (bParam3 && func_233() == 4)
	{
...
{
	if (func_235(&(Global_1102630.f_4), iParam0, 5))
	{
		DEBUG::_0xF0783374333FD8CE(680, 36, "SET_NET_PLAYER_STATUS_FLAG - ", func_227(iParam0), " set by thread ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
		return 1;
	}
	return 0;
}
...
void func_172(struct<30> Param0, int iParam30)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, iParam30, "             outer.eType                     - ", func_236(Param0.f_17.f_9, 0));
	if (Param0.f_16)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, iParam30, "             inner.eType                     - ", func_236(Param0.f_6.f_9, 0));
	}
...
void func_173(struct<7> Param0, var uParam7, var uParam8, int iParam9)
{
...
void func_176(int iParam0, int iParam1)
{
	if (func_175(iParam0, iParam1))
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_102(iParam0), " flag ", func_185(iParam1));
	}
...
{
	if (func_111(bParam0) && func_237())
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 183, "RELEASE_DOOR_ID - Releasing Door ID ", func_186(bParam0, 0));
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_FLAGS] ", func_102(iParam0));
	Global_1051777.f_80[iParam0 /*75*/].f_49 = 0;
}

bool func_180(int iParam0, int iParam1)
{
	return func_238(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}

void func_181(int iParam0)
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_SUPPORT_FLAGS] ", func_102(iParam0));
...
int func_184(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1139844.f_7) && !func_240(12, func_239(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
void func_189(bool bParam0, bool bParam1)
{
	if (func_111(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 2 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "LOCK_DOOR_ID - Locking Door ID ", func_186(bParam0, 0));
		}
	}
	else
	{
...
void func_190(bool bParam0, bool bParam1)
{
	if (func_111(bParam0))
	{
		...
		{
			DEBUG::_0x1B08D1EB9D8C4931(2216, 183, "SET_DOOR_ID_LOCKED_AND_UNBREAKABLE - Door ID ", func_186(bParam0, 0), " state = ", OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0), " pending state ", UNK_0x4BC2854478F3A749(bParam0));
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(bParam0, 1);
		}
	}
	else
...
void func_191(bool bParam0, bool bParam1)
{
	if (func_111(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 0 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "UNLOCK_DOOR_ID - Unlocking Door ID ", func_186(bParam0, 0));
		}
	}
	else
	{
...
int func_193(int iParam0, char* sParam1, bool bParam2, char* sParam3, bool bParam4, char* sParam5, char* sParam6)
{
	struct<4> Var0;

	Var0 = func_242();
	Var0.f_2 = -738708473;
	Var0.f_3 = func_239(iParam0);
	if (!DATAFILE::_DATAFILE_GET_DATA_NODE_INDEX(&(Var0.f_1), &Var0))
	{
		DEBUG::_0x4DC69742196F818A(40, 139, "[NET_GET_SHOP_AUTHOR_DATA_WITH_STRING] Could not fill out region node for: ", func_222(iParam0));
		return 0;
	}
	Var0.f_2 = -1407851228;
	...
	DEBUG::_0x4DC69742196F818A(1747624, 139, "[NET_GET_SHOP_AUTHOR_DATA_WITH_STRING] eShop = ", func_222(iParam0), ", ", sParam5, " = ", MISC::_0x6C4DBF553885F9EB(*sParam6), ", ", sParam3, " = ", *bParam4);
	return 1;
}

int func_194(bool bParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
bool func_200(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_245(func_56(0)))
	{
		return true;
	}
...
void func_212(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 195, "CLEAR_SALOON_CONFIG_FLAG: Clearing flag for ", func_250(iParam1, 0));
	func_251(&(Global_1940170.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_214(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	...
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that isnt stolen ", func_122(iParam0));
		return;
	}
	if (!func_154(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release an uninitialized regional character ", func_122(iParam0));
		return;
	}
	if ((!bParam4 && !func_213(iParam0)) && func_252(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that is stolen by a differnt script ", func_122(iParam0));
		return;
	}
	DEBUG::_0xF0783374333FD8CE(680, 138, "RELEASE_REGIONAL_CHARACTER: Regional character ", func_122(iParam0), " released by ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
	func_162(iParam0, 1);
	func_220(iParam0);
	if (func_253(func_160(iParam0)))
	{
		iVar0 = func_121(iParam0);
		if (!PERSCHAR::_0x800DF3FC913355F3(iVar0))
		{
			DEBUG::_0x9A6C65DDDBEC9C52(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character with no perschar index", func_122(iParam0));
			return;
		}
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being retasked ", func_122(iParam0));
	...
	if (func_154(iParam0, 128) && !bParam3)
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being destroyed on release ", func_122(iParam0));
		func_155(iParam0, 0);
	}
}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 139, "CLEAR_ALL_SHOP_TYPE_FLAGS: ", func_102(iParam0));
...
void func_219(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_223(iParam1), " on ", func_122(iParam0));
}
...
void func_220(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar0, false))
		{
			...
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_122(iParam0), " set as no longer needed.");
		}
		else
		{
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_122(iParam0), " was asked to be set as no longer needed, but this script does not own the ped.");
		}
	}
...
bool func_224(struct<2> Param0, int iParam2, int iParam3)
{
	int iVar0;
...
bool func_240(int iParam0, char* sParam1, var uParam2)
{
	var uVar0;

	if (func_263(iParam0, sParam1, &uVar0))
	{
		func_264(&uVar0, iParam0, uParam2);
	}
	else
	{
...
bool func_243()
{
	...
	if (!func_245(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_263(int iParam0, char* sParam1, bool bParam2)
{
	*bParam2 = Global_1139844.f_7;
	bParam2->f_2 = 1351168281;
	bParam2->f_3 = func_272(iParam0);
	bParam2->f_4 = sParam1;
...
void func_264(bool bParam0, int iParam1, var uParam2)
{
	var uVar0;
	...
	*uParam2 = iParam1;
	...
	{
		DEBUG::_0x83407B92D46F25C3(648, 84, "RETRIEVE_UNLOCK_DATA - Couldn't retrieve id at index ", uParam2->f_1, " of type ", func_273(iParam1, 0));
	}
	bParam0->f_2 = -2140901307;
...
bool func_274(struct<2> Param0, bool bParam2)
{
	if (!func_245(Param0))
	{
		return false;
