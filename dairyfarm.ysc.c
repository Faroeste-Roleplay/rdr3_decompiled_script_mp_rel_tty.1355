	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_27)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_75(iLocal_27));
...
void func_69(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_59(iParam0) && func_85(iParam0, 16777216)) && !Global_1893599.f_9)
	{
...
bool func_82(int iParam0, bool bParam1)
{
	...
	if (func_89(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_125(Global_1896632.f_1, 16))
			{
				func_126(Global_1896632.f_1, 0);
			}
			Global_1896632.f_1++;
			iVar2++;
...
bool func_83(int iParam0)
{
	...
	while (iVar0 < 40)
	{
		if (func_127(iVar0) || func_128(iVar0))
		{
		}
		else
		{
...
int func_92(int iParam0, bool bParam1)
{
	if (!func_90(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_132(iParam0), " is invalid");
		return 0;
	}
	if (!func_125(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_132(iParam0), " has not been initialized");
		return 0;
	}
	if (func_125(iParam0, 32) && !bParam1)
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_132(iParam0), " has been locked dead");
		...
		if (func_45() == -1)
		{
			if (func_125(iParam0, 2048))
			{
				...
				DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_132(iParam0), " has been revived!");
			}
	...
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_132(iParam0), " dead or not spawning, turn scenario groups off");
		return 0;
	}
	if (PERSCHAR::_0x800DF3FC913355F3(func_135(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Persistent character ", func_132(iParam0), " already exists");
		func_136(iParam0, 128);
		return 1;
	}
	func_134(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_133(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_135(iParam0));
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_132(iParam0), " perschar index created!");
	if (func_125(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_135(iParam0));
		func_136(iParam0, 2048);
	...
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_132(iParam0), " created.");
...
void func_95()
{
	func_138(754, iLocal_15, 1);
	func_138(755, iLocal_15, 0);
	func_138(756, iLocal_15, 0);
	VOLUME::_0x4A8FEFC43FD8AC9B(iLocal_15, 3, 1);
	VOLUME::_0x53D05D60E5F5B40C(iLocal_15, 3, 1, func_135(755));
	VOLUME::_0x53D05D60E5F5B40C(iLocal_15, 3, 1, func_135(756));
}
...
{
	if ((iParam0 == 22 || iParam0 == 39) && !func_139())
	{
		return true;
	}
	if (iParam0 == 66)
...
char* func_104(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_142(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_144(func_143(Global_34));
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		if (!func_145(iParam0) || func_146(44))
		{
			switch (iParam0)
			{
				case 2:
...
void func_119(var uParam0, int iParam1)
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_149(iParam1, 0));
}
...
{
	DEBUG::_0x4DC69742196F818A(40, 195, "CLEAR_SALOON: Clearing ", func_150(iParam0));
	func_151(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_152(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
	...
	func_153(iParam0, 8192);
	func_153(iParam0, 32768);
	func_153(iParam0, 524288);
	func_153(iParam0, 1048576);
...
void func_124(int iParam0)
{
	...
	if (func_90(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_154(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_155(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_156(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_157(iParam0, 536870912);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_160(Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
int func_126(int iParam0, bool bParam1)
{
	if (!func_90(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_132(iParam0), " is invalid");
		return 0;
	}
	if (!func_125(iParam0, 2))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_132(iParam0), " has not been initialized");
		return 0;
	}
	if (func_133(iParam0) == 0)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_132(iParam0), " doesn't exist");
		return 1;
	}
	if (!PERSCHAR::_0x800DF3FC913355F3(func_135(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_132(iParam0), " already destroyed");
		return 1;
	}
	if (func_125(iParam0, 1) && !bParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_132(iParam0), " is stolen, so it will be destoyed on release.");
		func_162(iParam0, 128);
		return 1;
	}
	func_136(iParam0, 129);
	func_163(iParam0);
	DEBUG::_0xA308F935BDECCEC0(40, 138, "DESTROY_REGIONAL_CHARACTER: Destroying ", func_132(iParam0));
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_135(iParam0));
	func_134(iParam0, 0);
	DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: ", func_132(iParam0), " destroyed.");
	return 1;
}
...
void func_131(int iParam0, bool bParam1)
{
	...
	if (!bVar0 && !func_170(iParam0, 65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] - Shop keeper deleted for shop: ", func_171(iParam0));
		}
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] Remove the script created scenario for: ", func_171(iParam0));
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_160(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar2]);
	...
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 139, "NET_CLEAR_SHOP: SPF_ALLOW_BLIP_OUT_OF_REGION for ", func_171(iParam0), " is kept; all other flags cleared.");
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_24) && func_176(iParam0, 2))
	{
...
void func_136(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_178(iParam1), " on ", func_132(iParam0));
}
...
bool func_137(int iParam0)
{
	...
	if (!func_125(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_132(iParam0), " has not been initialized");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(40, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_132(iParam0));
	return true;
}
...
int func_138(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == 0)
	{
		DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_132(iParam0), " IS INVALID.");
		return 0;
	}
	DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_132(iParam0), " IS VALID.");
...
void func_155(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	...
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that isnt stolen ", func_132(iParam0));
		return;
	}
	if (!func_125(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release an uninitialized regional character ", func_132(iParam0));
		return;
	}
	if ((!bParam4 && !func_154(iParam0)) && func_189(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that is stolen by a differnt script ", func_132(iParam0));
		return;
	}
	DEBUG::_0xF0783374333FD8CE(680, 138, "RELEASE_REGIONAL_CHARACTER: Regional character ", func_132(iParam0), " released by ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
	func_136(iParam0, 1);
	func_163(iParam0);
	if (func_190(func_133(iParam0)))
	{
		iVar0 = func_135(iParam0);
		if (!PERSCHAR::_0x800DF3FC913355F3(iVar0))
		{
			DEBUG::_0x9A6C65DDDBEC9C52(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character with no perschar index", func_132(iParam0));
			return;
		}
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being retasked ", func_132(iParam0));
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being destroyed on release ", func_132(iParam0));
		func_126(iParam0, 0);
	}
}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 139, "CLEAR_ALL_SHOP_TYPE_FLAGS: ", func_171(iParam0));
...
void func_162(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_178(iParam1), " on ", func_132(iParam0));
}
...
void func_163(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar0, false))
		{
			...
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_132(iParam0), " set as no longer needed.");
		}
		else
		{
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_132(iParam0), " was asked to be set as no longer needed, but this script does not own the ped.");
		}
	}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_FLAGS] ", func_171(iParam0));
	Global_1051777.f_80[iParam0 /*75*/].f_49 = 0;
}

void func_165(int iParam0)
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_SUPPORT_FLAGS] ", func_171(iParam0));
...
void func_173(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_171(iParam0), " flag ", func_201(iParam1));
	}
	Global_1051777.f_80[iParam0 /*75*/].f_1 = (Global_1051777.f_80[iParam0 /*75*/].f_1 - (Global_1051777.f_80[iParam0 /*75*/].f_1 && iParam1));
}
...
{
	return func_202(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}
...
bool func_179(int iParam0, bool bParam1)
{
	...
	if (!PERSCHAR::_0x800DF3FC913355F3(func_135(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - Checking if ", func_132(iParam0), " is alive when the perschar index is not created.");
		return false;
	}
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_96(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_132(iParam0), " does not have a ped spawned.");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(2216, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_132(iParam0), " being processed - ALIVE = ", !PERSCHAR::_0xEB98B38CA60742D7(func_135(iParam0)), "!");
...
bool func_184(vector3 vParam0, int iParam3)
{
	...
	func_205(iParam3, &vVar0, &Var3, &uVar6);
	if (func_206(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
...
void func_205(int iParam0, var uParam1, var uParam2, var uParam3)
{
	switch (iParam0)
	{
		case 0:
...
bool func_206(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
...
int func_207(int iParam0)
{
	...
	DEBUG::_0xD9911C7B5F8CD69C(168, 139, "GET_SHOP_TYPE_FROM_SHOP - ", func_200(iParam0, 0), " undefined");
	return -1;
}
