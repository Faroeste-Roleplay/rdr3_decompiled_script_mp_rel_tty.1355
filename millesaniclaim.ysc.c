#region Local Var
	...
	char* sLocal_21[4] = { NULL, NULL, NULL, NULL };
...
void __EntryFunction__()
{
	...
	DEBUG::_0xF0783374333FD8CE(43688, 17, "**** INITIALIZING REGION: ", &(Global_1887351[vScriptParam_0.x /*36*/].f_23), ", ", &(Global_1887351[iLocal_33 /*36*/].f_24), ", ", &(Global_1887351[iLocal_33 /*36*/].f_27), " ****");
	func_2();
	func_3();
	...
	while (func_4())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_32)
		{
			...
			{
				case 0:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_33 /*36*/].f_23), " global init...");
					if (Global_1901988.f_1.f_26 > 0)
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_33 /*36*/].f_23), "-> RBS_WAIT_FOR_UGC_EARLY_QUIT");
						iLocal_34 = (MISC::GET_GAME_TIMER() + Global_1901988.f_1.f_26);
						iLocal_31 = 1;
					}
					else
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_33 /*36*/].f_23), "-> RBS_INIT_REGION");
						iLocal_31 = 2;
					}
					break;
				case 1:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_33 /*36*/].f_23), " ugc early quit...");
					...
					break;
				case 2:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_33 /*36*/].f_23), " region init...");
					func_6(iLocal_33);
					func_7();
					func_8();
					...
					Global_1896632 = -1;
					DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_33 /*36*/].f_23), "-> RBS_INIT_VOLUME");
					iLocal_34 = (iLocal_30 + MISC::GET_GAME_TIMER());
					iLocal_31 = 3;
					break;
				case 3:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_33 /*36*/].f_23), " volume init...");
					if (func_13() || iLocal_34 < MISC::GET_GAME_TIMER())
					{
						func_14(iLocal_33);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_33 /*36*/].f_23), "-> RBS_LOAD_APPEARANCE");
						iLocal_34 = (MISC::GET_GAME_TIMER() + iLocal_30);
						iLocal_31 = 4;
					}
					break;
				case 4:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_33 /*36*/].f_23), " load appearance...");
					if (func_15(iLocal_33) || iLocal_34 < MISC::GET_GAME_TIMER())
					{
						func_16(iLocal_33);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_33 /*36*/].f_23), "-> RBS_LOAD_SPECIAL");
						iLocal_34 = (MISC::GET_GAME_TIMER() + iLocal_30);
						iLocal_31 = 5;
					}
					break;
				case 5:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_33 /*36*/].f_23), " load special...");
					if (func_17(iLocal_33) || iLocal_34 < MISC::GET_GAME_TIMER())
					{
						func_18(iLocal_33);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_33 /*36*/].f_23), "-> RBS_LOAD_PERS_CHARS");
						iLocal_34 = (iLocal_30 + MISC::GET_GAME_TIMER());
						iLocal_31 = 7;
					}
					break;
				case 7:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_33 /*36*/].f_23), " init regional chars...");
					if (func_10(func_9(iLocal_33)))
					{
						...
						else
						{
							if (func_20(iLocal_33) || iLocal_34 < MISC::GET_GAME_TIMER())
							{
								func_21(iLocal_33, 4);
								iLocal_34 = (MISC::GET_GAME_TIMER() + iLocal_30);
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_33 /*36*/].f_23), "-> RBS_INIT_AMBIENT");
								iLocal_31 = 8;
							}
							...
							{
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_33 /*36*/].f_23), " AMBIENT MINIGAMES ARE NOT BEING ENABLED AS A STORY OR RCM OR MISSION RETRY IS HAPPENING");
							}
							func_26();
							func_27();
							func_28();
							...
							func_31();
							func_32();
							DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": INIT_CURRENT_REGION_TOWN_DATA FOR ", &(Global_1887351[iLocal_33 /*36*/].f_23));
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_33 /*36*/].f_23), " RBS_INIT_AMBIENT -> RBS_INIT_LAW");
							iLocal_31 = 9;
							Jump @1356; //curOff = 1032
							func_33(iLocal_33);
							func_34();
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_33 /*36*/].f_23), "-> RBS_INIT_NAMED_LOCATIONS");
							iLocal_31 = 10;
							Jump @1356; //curOff = 1070
							func_35(&Global_1896686);
							func_36(iLocal_33, &Global_1896686);
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_33 /*36*/].f_23), "-> RBS_DONE_INIT");
							iLocal_31 = 11;
							Jump @1356; //curOff = 1116
							DEBUG::_0xF0783374333FD8CE(168, 17, "**** FINISHED INITIALIZING: ", &(Global_1887351[iLocal_33 /*36*/].f_23), " ****");
							func_37(iLocal_33);
							func_21(iLocal_33, 8);
							if (func_38(32))
							{
							...
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_33 /*36*/].f_23), "-> RBS_RUNNING");
							iLocal_31 = 12;
							...
							func_41(&Global_1896686, iLocal_33);
							func_42(iLocal_33);
							func_21(iLocal_33, 8);
							if (func_43())
							{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887351[iLocal_33 /*36*/].f_11);
							if (Global_1887351[iLocal_33 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887351[iLocal_33 /*36*/].f_12);
							}
							Jump @1356; //curOff = 1312
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_33 /*36*/].f_23), " RBS_CLEANUP");
							func_8();
							func_44(iVar0);
							iVar0++;
						}
						if (Global_1887351[iLocal_33 /*36*/].f_13 == 0)
						{
						}
						else
						{
							PED::_0x95423627A9CA598E(Global_1887351[iLocal_33 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
...
bool func_1()
{
	if (!bLocal_35)
	{
		if (Global_1051140)
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_33 /*36*/].f_23), ", g_mpUGC_QuitSessionRequest.bRequestRunning is still true");
			bLocal_35 = true;
			return true;
		}
		if (func_47() && func_48())
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_33 /*36*/].f_23), ", a session request is running and a UGC script is running");
			bLocal_35 = true;
			return true;
		}
	...
	if (func_48())
	{
		DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_33 /*36*/].f_23), ", content script still running for some player");
		return true;
	}
...
{
	iParam0 = iParam0;
	iLocal_16[0] = INTERIOR::GET_INTERIOR_AT_COORDS(-1420.278f, 1171.593f, 226.7f);
	iLocal_16[1] = INTERIOR::GET_INTERIOR_AT_COORDS(-1440.127f, 1189.548f, 226.4f);
	iLocal_16[2] = INTERIOR::GET_INTERIOR_AT_COORDS(-1418.762f, 1197.32f, 225.4f);
	iLocal_16[3] = INTERIOR::GET_INTERIOR_AT_COORDS(-1393.259f, 1181.42f, 222.2f);
...
bool func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": REGION_TOWN_MANANGER_EXIT_TOWN FOR ", &(Global_1887351[iLocal_33 /*36*/].f_23));
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_33)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_76(iLocal_33));
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_77(iLocal_33, 0), 1);
					break;
			}
		}
		if (func_10(func_69()))
	...
	else
	{
		...
		if (func_45() == -1)
		{
			func_81(iLocal_33);
			func_82(iLocal_33);
			if (!func_83(iLocal_33, 0))
			{
				return false;
			}
		}
		else if (!func_84(iLocal_33))
		{
			return false;
		}
	}
	DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": Terminating. -- ", &(Global_1887351[iLocal_33 /*36*/].f_23));
	SCRIPTS::TERMINATE_THIS_THREAD();
	return true;
}
...
void func_60()
{
	...
	while (iVar0 <= 3)
	{
		if (INTERIOR::IS_VALID_INTERIOR(iLocal_16[iVar0]))
		{
			if (INTERIOR::IS_INTERIOR_READY(iLocal_16[iVar0]) && (INTERIOR::GET_INTERIOR_FROM_ENTITY(Global_33) != iLocal_16[iVar0] || CAM::IS_SCREEN_FADED_OUT()))
			{
				if (!INTERIOR::IS_INTERIOR_ENTITY_SET_ACTIVE(iLocal_16[iVar0], sLocal_21[iVar0]))
				{
					INTERIOR::ACTIVATE_INTERIOR_ENTITY_SET(iLocal_16[iVar0], sLocal_21[iVar0], 0);
				}
			}
		}
		iVar0++;
...
bool func_62(bool bParam0, bool bParam1, bool bParam2)
{
	if (!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(bParam0))
	{
		if ((NETWORK::NETWORK_IS_IN_SESSION() && SCRIPTS::_DOES_THREAD_EXIST(Global_1051590.f_16[0])) && bParam1)
		{
			...
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add networked Door ", func_96(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
		else
		{
			OBJECT::_ADD_DOOR_TO_SYSTEM_NEW(bParam0, true, false, false, 0, 0, false);
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add Door ", func_96(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
	}
	...
	if (bParam2)
	{
		...
		DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Set door ", func_96(bParam0, 0), " able to change open ratio while locked");
		UNK_0x355E72323AEE83CC(183, 7);
	}
	return bParam0;
}
...
void func_70(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_58(iParam0) && func_86(iParam0, 16777216)) && !Global_1893599.f_9)
	{
...
var func_96(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
void func_122(int iParam0)
{
	...
	if (func_91(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_151(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
...
void func_157(bool bParam0)
{
	...
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 183, "RELEASE_DOOR_ID - Releasing Door ID ", func_96(bParam0, 0));
...
void func_170(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_168(iParam0), " flag ", func_197(iParam1));
	}
	Global_1051777.f_80[iParam0 /*75*/].f_1 = (Global_1051777.f_80[iParam0 /*75*/].f_1 - (Global_1051777.f_80[iParam0 /*75*/].f_1 && iParam1));
}
