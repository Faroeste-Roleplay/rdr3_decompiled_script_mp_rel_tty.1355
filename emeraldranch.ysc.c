...
void __EntryFunction__()
{
	...
	DEBUG::_0xF0783374333FD8CE(43688, 17, "**** INITIALIZING REGION: ", &(Global_1887351[vScriptParam_0.x /*36*/].f_23), ", ", &(Global_1887351[iLocal_36 /*36*/].f_24), ", ", &(Global_1887351[iLocal_36 /*36*/].f_27), " ****");
	func_2();
	func_3();
	...
	while (func_4())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_35)
		{
			...
			{
				case 0:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_36 /*36*/].f_23), " global init...");
					if (Global_1901988.f_1.f_26 > 0)
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_36 /*36*/].f_23), "-> RBS_WAIT_FOR_UGC_EARLY_QUIT");
						iLocal_37 = (MISC::GET_GAME_TIMER() + Global_1901988.f_1.f_26);
						iLocal_34 = 1;
					}
					else
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_36 /*36*/].f_23), "-> RBS_INIT_REGION");
						iLocal_34 = 2;
					}
					break;
				case 1:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_36 /*36*/].f_23), " ugc early quit...");
					...
					break;
				case 2:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_36 /*36*/].f_23), " region init...");
					func_6(iLocal_36);
					func_7();
					func_8();
					...
					Global_1896632 = -1;
					DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_36 /*36*/].f_23), "-> RBS_INIT_VOLUME");
					iLocal_37 = (iLocal_33 + MISC::GET_GAME_TIMER());
					iLocal_34 = 3;
					break;
				case 3:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_36 /*36*/].f_23), " volume init...");
					if (func_13() || iLocal_37 < MISC::GET_GAME_TIMER())
					{
						func_14(iLocal_36);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_36 /*36*/].f_23), "-> RBS_LOAD_APPEARANCE");
						iLocal_37 = (MISC::GET_GAME_TIMER() + iLocal_33);
						iLocal_34 = 4;
					}
					break;
				case 4:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_36 /*36*/].f_23), " load appearance...");
					if (func_15(iLocal_36) || iLocal_37 < MISC::GET_GAME_TIMER())
					{
						func_16(iLocal_36);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_36 /*36*/].f_23), "-> RBS_LOAD_SPECIAL");
						iLocal_37 = (MISC::GET_GAME_TIMER() + iLocal_33);
						iLocal_34 = 5;
					}
					break;
				case 5:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_36 /*36*/].f_23), " load special...");
					if (func_17(iLocal_36) || iLocal_37 < MISC::GET_GAME_TIMER())
					{
						func_18(iLocal_36);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_36 /*36*/].f_23), "-> RBS_LOAD_PERS_CHARS");
						iLocal_37 = (iLocal_33 + MISC::GET_GAME_TIMER());
						iLocal_34 = 7;
					}
					break;
				case 7:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_36 /*36*/].f_23), " init regional chars...");
					if (func_10(func_9(iLocal_36)))
					{
						...
						else
						{
							if (func_20(iLocal_36) || iLocal_37 < MISC::GET_GAME_TIMER())
							{
								func_21(iLocal_36, 4);
								iLocal_37 = (MISC::GET_GAME_TIMER() + iLocal_33);
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_36 /*36*/].f_23), "-> RBS_INIT_AMBIENT");
								iLocal_34 = 8;
							}
							...
							{
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_36 /*36*/].f_23), " AMBIENT MINIGAMES ARE NOT BEING ENABLED AS A STORY OR RCM OR MISSION RETRY IS HAPPENING");
							}
							func_26();
							func_27();
							func_28();
							...
							func_31();
							func_32();
							DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": INIT_CURRENT_REGION_TOWN_DATA FOR ", &(Global_1887351[iLocal_36 /*36*/].f_23));
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_36 /*36*/].f_23), " RBS_INIT_AMBIENT -> RBS_INIT_LAW");
							iLocal_34 = 9;
							Jump @1356; //curOff = 1032
							func_33(iLocal_36);
							func_34();
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_36 /*36*/].f_23), "-> RBS_INIT_NAMED_LOCATIONS");
							iLocal_34 = 10;
							Jump @1356; //curOff = 1070
							func_35(&Global_1896686);
							func_36(iLocal_36, &Global_1896686);
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_36 /*36*/].f_23), "-> RBS_DONE_INIT");
							iLocal_34 = 11;
							Jump @1356; //curOff = 1116
							DEBUG::_0xF0783374333FD8CE(168, 17, "**** FINISHED INITIALIZING: ", &(Global_1887351[iLocal_36 /*36*/].f_23), " ****");
							func_37(iLocal_36);
							func_21(iLocal_36, 8);
							if (func_38(32))
							{
							...
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_36 /*36*/].f_23), "-> RBS_RUNNING");
							iLocal_34 = 12;
							...
							func_41(&Global_1896686, iLocal_36);
							func_42(iLocal_36);
							func_21(iLocal_36, 8);
							if (func_43())
							{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887351[iLocal_36 /*36*/].f_11);
							if (Global_1887351[iLocal_36 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887351[iLocal_36 /*36*/].f_12);
							}
							Jump @1356; //curOff = 1312
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_36 /*36*/].f_23), " RBS_CLEANUP");
							func_8();
							func_44(iVar0);
							iVar0++;
						}
						if (Global_1887351[iLocal_36 /*36*/].f_13 == 0)
						{
						}
						else
						{
							PED::_0x95423627A9CA598E(Global_1887351[iLocal_36 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
...
bool func_1()
{
	if (!bLocal_38)
	{
		if (Global_1051140)
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_36 /*36*/].f_23), ", g_mpUGC_QuitSessionRequest.bRequestRunning is still true");
			bLocal_38 = true;
			return true;
		}
		if (func_47() && func_48())
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_36 /*36*/].f_23), ", a session request is running and a UGC script is running");
			bLocal_38 = true;
			return true;
		}
	...
	if (func_48())
	{
		DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_36 /*36*/].f_23), ", content script still running for some player");
		return true;
	}
...
bool func_13()
{
	iLocal_19 = Global_1887351[74 /*36*/].f_5;
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_34, 0f, 0f, 0f) <= 5f || func_75(Global_1940410, 32768)) || func_75(Global_1940410, 16777216))
	{
		return;
	}
...
bool func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": REGION_TOWN_MANANGER_EXIT_TOWN FOR ", &(Global_1887351[iLocal_36 /*36*/].f_23));
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_36)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_88(iLocal_36));
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_89(iLocal_36, 0), 1);
					break;
			}
		}
		if (func_10(func_81()))
	...
	else
	{
		...
		if (func_45() == -1)
		{
			func_93(iLocal_36);
			func_94(iLocal_36);
			if (!func_95(iLocal_36, 0))
			{
				return false;
			}
		}
		else if (!func_96(iLocal_36))
		{
			return false;
		}
	}
	DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": Terminating. -- ", &(Global_1887351[iLocal_36 /*36*/].f_23));
	SCRIPTS::TERMINATE_THIS_THREAD();
	return true;
}
...
bool func_49(bool bParam0, bool bParam1)
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		{
			DEBUG::_0xF0783374333FD8CE(168, 8, "KILL_EVENT_CAUGHT - NETWORK_IS_GAME_IN_PROGRESS() = FALSE - but bIgnoreTransition = TRUE and g_mpTransition.eMPState = ", func_97(Global_1572887, 0), ", so skipping");
		}
		else
		{
...
bool func_54(char* sParam0)
{
	...
	{
		HUD::_TEXT_DATABASE_REQUEST(sParam0);
		DEBUG::_0x1B08D1EB9D8C4931(40, 101, "Still waiting for text block to load...", sParam0);
		return false;
	}
	return true;
}
...
int func_55(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (!func_66(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Region index not valid ", func_99(iParam0));
		return 1;
	}
	if (func_98(iParam0, 16))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: RF_PERS_DISABLED is on for ", func_99(iParam0));
		return 1;
	}
	if (func_100(iParam0) && !func_101(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: IS_REGION_IN_LOCKDOWN is on for ", func_99(iParam0));
	}
	DEBUG::_0xF0783374333FD8CE(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Starting for ", func_99(iParam0));
	if (func_102(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if ((!func_100(iParam0) || func_101(iParam0)) || func_104(Global_1896632))
			{
				func_105(Global_1896632, 0);
			}
			Global_1896632++;
			iVar2++;
...
{
	if (iParam0 == 9 && !(!func_106() && func_107()))
	{
		if (func_108(255))
		{
	...
	func_110(iParam0, 1);
	DEBUG::_0xF0783374333FD8CE(40, 139, "NET_ENABLE_SHOP_LOCATION: Registering ", func_111(iParam0));
	Global_1051777.f_80[iParam0 /*75*/] = 0;
	Global_1051777.f_80[iParam0 /*75*/].f_18 = func_112(iParam2, iParam0);
...
void func_61(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	...
	if (iVar0 < 0 || iVar0 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(40, 139, "[NET_ADD_SHOP_DOOR] - Invalid door index for shop: ", func_118(iParam0, 0));
		return;
	}
	Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0] = func_119(bParam1, 0, 0);
	if (func_120(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0]))
	{
		if (!func_121(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0]))
		{
			func_122(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0], 0, fParam2, bParam3, 1, 0, bParam4, 0);
		}
	}
...
int func_62(int iParam0, bool bParam1)
{
	...
	if ((func_123(iParam0, 16384) || func_123(iParam0, 32768)) || func_124(Global_1051777.f_80[iParam0 /*75*/].f_3))
	{
	...
	iVar0 = func_112(func_125(), iParam0);
	if ((!bParam1 && func_126(iVar0, &iVar1, &uVar2, &vVar3)) || (bParam1 && func_127(iVar0, &iVar1, &uVar2, &vVar3)))
	{
		func_128(iParam0, iVar1, vVar3, uVar2, 0);
...
int func_63(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == 0)
	{
		DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_131(iParam0), " IS INVALID.");
		return 0;
	}
	DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_131(iParam0), " IS VALID.");
...
{
	func_122(bParam0, 1, 0, 0, 0, 0, 0, 0);
}
...
void func_71(int iParam0, int iParam1, var uParam2)
{
	if (!*uParam2)
	{
		if (func_135(Global_33, iParam1, 0, 1, 0))
		{
			DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_SHOPS_HANDLE_VISITED_VOLUME] - Player visited volume for ", func_136(iParam0, 0));
			func_138(func_137(iParam0), 1);
			*uParam2 = 1;
		}
	}
	else if (!func_135(Global_33, iParam1, 0, 1, 0))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_SHOPS_HANDLE_VISITED_VOLUME] - Player left volume for ", func_136(iParam0, 0));
		*uParam2 = 0;
	}
}
...
bool func_72(int iParam0)
{
	...
	return Global_1272244[iParam0] == iParam0;
}
...
bool func_73(int iParam0)
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 109, "[NCH][", func_139(iParam0, 0), "] - GET_COMPLETE - NETWORK_IS_GAME_IN_PROGRESS = FALSE, waiting...");
		return false;
	}
	...
	{
		bVar1 = func_141(1, iParam0);
		if (bVar1 == 0)
		{
			DEBUG::_0xA308F935BDECCEC0(168, 109, "[NCH][", func_139(iParam0, 0), "] - GET_COMPLETE - No valid 'complete' award.");
			return false;
		}
...
bool func_74(bool bParam0, int iParam1)
{
	...
	return func_146(bParam0, 0, 0, 0) >= iParam1;
}
...
bool func_77()
{
	return func_75(Global_1940410, 8192);
}
...
bool func_79(int iParam0)
{
	...
	return ((Global_1887351[iParam0 /*36*/].f_21 == 1 || Global_1887351[iParam0 /*36*/].f_21 == 2) && !func_147(iParam0));
}
...
void func_82(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	char* sVar1;
	char* sVar2;
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_149(iParam0, 0), " ", func_150(iParam1, 0), " ", func_151(bParam2, 0), " state ", func_152(iParam4, 0));
	UNK_0x355E72323AEE83CC(11, 6);
	sVar1 = func_153(iParam0, iParam1, bParam2, iParam4, bParam5, bParam3, &bVar0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_149(iParam0, 0), " or ", func_150(iParam1, 0), " or ", func_151(bParam2, 0));
	...
	if (!func_154(iParam4))
	{
		if (func_66(iParam0))
		{
			iParam4 = func_155(func_9(iParam0));
		}
		else
		{
			iParam4 = func_155(iParam1);
		}
	}
	if (func_154(iParam4))
	{
		iVar3 = func_156(iParam4);
	}
	if (bVar0 && bParam3)
	{
		sVar2 = func_158(func_157(bParam2));
	}
	else if ((func_159(iParam1, 2) || func_160(iParam4, 2)) && !Global_1893599.f_9)
	{
	...
	else if ((func_66(iParam0) && func_98(iParam0, 16777216)) && !Global_1893599.f_9)
	{
	...
	{
		iVar4 = func_162(func_161());
		iVar5 = func_163(func_161());
		if (iVar5 < 10)
		{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			{
				fVar7 = func_164(fVar7);
				sVar8 = "TIME_AND_TEMP_F";
			}
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_165(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_165(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_165(&cVar6, joaat("COLOR_PURE_WHITE")), func_165(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		Global_1893599.f_9 = 0;
	}
	DEBUG::_0xF0783374333FD8CE(680, 11, "DISPLAY_NAMED_LOCATION - Texture ", sVar1, " info ", sVar2);
	Global_1939313.f_145 = func_166(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_84(int iParam0, bool bParam1)
{
	...
	func_168(&Global_1940410, 16384);
	func_138(func_169(joaat("DISCOVERED"), joaat("AREAS")), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_138(func_169(joaat("DISCOVERED"), joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_138(func_169(joaat("DISCOVERED"), joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_138(func_169(joaat("DISCOVERED"), joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_138(func_169(joaat("DISCOVERED"), joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_138(func_169(joaat("DISCOVERED"), joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_138(func_169(joaat("DISCOVERED"), joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
bool func_95(int iParam0, bool bParam1)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 138, "DELETE_ALL_REGIONAL_CHARACTERS starting for Region ", func_99(iParam0));
	if (func_102(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_173(Global_1896632.f_1, 16))
			{
				func_174(Global_1896632.f_1, 0);
			}
			Global_1896632.f_1++;
			iVar2++;
...
bool func_96(int iParam0)
{
	...
	while (iVar0 < 40)
	{
		if (func_175(iVar0) || func_176(iVar0))
		{
		}
		else
		{
...
bool func_100(int iParam0)
{
	...
	return func_98(iParam0, 33554432);
}
	...
	switch (iParam0)
	{
		...
		case 139:
			...
			*iParam2 = 851;
			...
			break;
		default:
			DEBUG::_0xA308F935BDECCEC0(40, 138, "Attempting to get regional character bounds for a region that doesn't have them yet ", func_88(iParam0));
			*iParam1 = -1;
			*iParam2 = -1;
			break;
	}
...
int func_105(int iParam0, bool bParam1)
{
	if (!func_103(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_131(iParam0), " is invalid");
		return 0;
	}
	if (!func_173(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_131(iParam0), " has not been initialized");
		return 0;
	}
	if (func_173(iParam0, 32) && !bParam1)
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_131(iParam0), " has been locked dead");
		func_180(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_179(iParam0)));
		if (func_45() == -1)
		{
			if (func_173(iParam0, 2048))
			{
				PERSCHAR::_0x49A8C2CD97815215(func_130(iParam0));
				func_181(iParam0, 2048);
				DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_131(iParam0), " has been revived!");
			}
			PERSCHAR::_0xFCC6DB8DBE709BC8(func_130(iParam0));
		}
		return 0;
	}
	if (!func_182(iParam0) && func_45() == -1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_131(iParam0), " dead or not spawning, turn scenario groups off");
		return 0;
	}
	if (PERSCHAR::_0x800DF3FC913355F3(func_130(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Persistent character ", func_131(iParam0), " already exists");
		func_181(iParam0, 128);
		return 1;
	}
	func_180(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_179(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_130(iParam0));
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_131(iParam0), " perschar index created!");
	if (func_173(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_130(iParam0));
		func_181(iParam0, 2048);
	...
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_131(iParam0), " created.");
...
void func_109(bool bParam0, bool bParam1)
{
	...
	if (func_124(ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), false, false)))
	{
	...
	else
	{
		...
		func_188(0);
		func_189(&(Global_1102630.f_3849));
		...
		func_190(&(Global_1102630.f_3888));
	...
	func_191(Global_1102630.f_3849, 36);
	func_192(Global_1102630.f_3888, 36);
...
void func_110(int iParam0, bool bParam1)
{
	...
	DEBUG::_0x4DC69742196F818A(40, 139, "NET_CLEAR_SHOP ", func_118(iParam0, 0));
	bVar0 = (func_193(iParam0) && !bParam1);
	if (!bVar0 && !func_123(iParam0, 65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] - Shop keeper deleted for shop: ", func_111(iParam0));
		}
	...
	else if (func_194(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
	{
	...
	if (func_194(iParam0, 16384) && !bVar0)
	{
		DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] Remove the script created scenario for: ", func_111(iParam0));
		if (TASK::_DOES_SCENARIO_POINT_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_6))
		{
	...
	if (iVar3 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "[NET_CLEAR_SHOP] - Shop: ", func_118(iParam0, 0), " current door count exceeds max door count.");
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_196(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar2]);
	...
	func_197(iParam0);
	if (func_123(iParam0, 262144))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 139, "NET_CLEAR_SHOP: SPF_ALLOW_BLIP_OUT_OF_REGION for ", func_111(iParam0), " is kept; all other flags cleared.");
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_24) && func_199(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_CLEAR_SHOP] Removing relationship volume from shop ", func_118(iParam0, 0));
...
int func_113(int iParam0)
{
	...
	{
		Global_1051777.f_4480[iParam0] = func_203(iParam0);
	}
...
void func_115(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_SET_SHOP_TYPE_FLAG] ", func_111(iParam0), " flag ", func_204(iParam1));
	}
...
bool func_119(bool bParam0, bool bParam1, bool bParam2)
{
	if (!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(bParam0))
	{
		if ((NETWORK::NETWORK_IS_IN_SESSION() && SCRIPTS::_DOES_THREAD_EXIST(Global_1051590.f_16[0])) && bParam1)
		{
			...
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add networked Door ", func_205(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
		else
		{
			OBJECT::_ADD_DOOR_TO_SYSTEM_NEW(bParam0, true, false, false, 0, 0, false);
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add Door ", func_205(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
	}
	...
	if (bParam2)
	{
		...
		DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Set door ", func_205(bParam0, 0), " able to change open ratio while locked");
		UNK_0x355E72323AEE83CC(183, 7);
	}
	return bParam0;
}
...
void func_122(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	func_119(bParam0, 0, 0);
	if (func_120(bParam0))
	{
		...
		if (bParam3)
		{
			func_207(bParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
			{
				...
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking Door ID ", func_205(bParam0, 0));
			}
			else
			{
				func_209(bParam0, 1);
				UNK_0x355E72323AEE83CC(183, 9);
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking and making unbreakable Door ID ", func_205(bParam0, 0));
			}
		}
		else
		{
			func_210(bParam0, 1);
			UNK_0x355E72323AEE83CC(183, 9);
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Unlocking Door ID ", func_205(bParam0, 0));
		}
		if (bParam7)
		{
			DEBUG::_0x1B08D1EB9D8C4931(168, 183, "SET_STATE_OF_DOOR_ID - Treating Door ID ", func_205(bParam0, 0), " as shut.");
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 183, "SET_STATE_OF_DOOR_ID: Door with ID not registered by host yet ", func_205(bParam0, 0));
	}
}
...
bool func_126(int iParam0, int iParam1, float fParam2, var uParam3)
{
	return func_212(iParam0, "sHash", iParam1, "fHeading", fParam2, "vPos", uParam3);
}

bool func_127(int iParam0, int iParam1, float fParam2, var uParam3)
{
	return func_212(iParam0, "sClosedHash", iParam1, "fClosedHeading", fParam2, "vClosedPos", uParam3);
}

void func_128(int iParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	if (bParam6)
	{
		MISC::GET_GROUND_Z_FOR_3D_COORD(vParam2, &(vParam2.f_2), false);
	}
	Global_1051777.f_80[iParam0 /*75*/].f_6 = func_213(iParam1, vParam2, uParam5, 0, 0, 0);
	...
	func_115(iParam0, 16384);
	DEBUG::_0xA308F935BDECCEC0(10920, 139, "[NET_ADD_SHOP_SCENARIO_AT_POINT] Creating scenario point: ", HUD::_GET_LABEL_TEXT_BY_HASH(iParam1), " for shop: ", func_118(iParam0, 0), " at: ", MISC::_0x6C4DBF553885F9EB(vParam2));
}
...
bool func_129(int iParam0, bool bParam1)
{
	...
	if (!PERSCHAR::_0x800DF3FC913355F3(func_130(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - Checking if ", func_131(iParam0), " is alive when the perschar index is not created.");
		return false;
	}
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_214(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_131(iParam0), " does not have a ped spawned.");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(2216, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_131(iParam0), " being processed - ALIVE = ", !PERSCHAR::_0xEB98B38CA60742D7(func_130(iParam0)), "!");
...
struct<2> func_137(int iParam0)
{
	...
	return func_169(joaat("VISITED"), iVar0);
}
...
bool func_144(bool bParam0, int iParam1)
{
	...
	if (func_218("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if (!func_220(Var4.f_4))
			{
				DEBUG::_0x1B08D1EB9D8C4931(40, 150, "DOES_PLAYER_HAVE_WEAPON_THAT_REQUIRES_AMMO_ITEM: IS_WEAPON_VALID_AND_NOT_UNARMED ", func_221(Var4.f_4, 0));
			}
			else
			{
				DEBUG::_0x1B08D1EB9D8C4931(680, 150, "DOES_PLAYER_HAVE_WEAPON_THAT_REQUIRES_AMMO_ITEM: checking weapon ", func_221(Var4.f_4, 0), " that uses the ammo - ", func_221(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(Var4.f_4), 0));
				if (WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(Var4.f_4) == bVar0)
				{
					func_222(iVar1);
					DEBUG::_0x1B08D1EB9D8C4931(680, 150, "DOES_PLAYER_HAVE_WEAPON_THAT_REQUIRES_AMMO_ITEM: player has the weapon ", func_221(Var4.f_4, 0), " that uses the ammo - ", func_221(bParam0, 0));
					return true;
				}
			}
			iVar3++;
	...
	DEBUG::_0x9A6C65DDDBEC9C52(40, 150, "DOES_PLAYER_HAVE_WEAPON_THAT_REQUIRES_AMMO_ITEM: couldn't find a player weapon linked to ammo item - ", func_221(bParam0, 0));
	return false;
}
...
bool func_145(bool bParam0)
{
	...
	if (!iVar1 == 0)
	{
		iVar2 = func_225(&(Global_17414.f_55.f_664.f_1354.f_5), iVar1);
		if (iVar2 == -1)
		{
			DEBUG::_0xF0783374333FD8CE(40, 139, "[BARBER_IS_PLAYER_WEARING_MAKEUP] player is wearing an invalid item so none applied is true: ", func_221(bParam0, 0));
			return true;
		}
	}
	...
	{
		return false;
		DEBUG::_0xF0783374333FD8CE(40, 139, "[BARBER_IS_PLAYER_WEARING_MAKEUP] saved overlay item was invalid for : ", func_221(bParam0, 0));
	}
	return bParam0 == Global_17414.f_55.f_664.f_1354.f_5[iVar2 /*17*/];
}

int func_146(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	if (!func_142(bParam0, 0))
	{
		DEBUG::_0xD9911C7B5F8CD69C(168, 157, "GET_PLAYER_SATCHEL_ITEM_COUNT - Attempting to check for an invalid item ", func_221(bParam0, 0), " in the player's inventory!");
	...
	if (func_228(bParam0, joaat("DEFAULT")) != 0)
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_229(bParam2), bParam0, bParam3);
	}
	else
	{
		Var3 = { func_230(bParam0, bParam2) };
		if (!INVENTORY::_0xB881CA836CC4B6D4(&Var3))
		{
			DEBUG::_0x1B08D1EB9D8C4931(168, 157, "GET_PLAYER_SATCHEL_ITEM_COUNT - No GUID found for item ", func_221(bParam0, 0), ", returning 0");
			return 0;
		}
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_229(bParam2), &Var3, bParam3);
	}
	DEBUG::_0x1B08D1EB9D8C4931(648, 157, "GET_PLAYER_SATCHEL_ITEM_COUNT - Found ", iVar0, " of item ", func_221(bParam0, 0));
	return iVar0;
}

bool func_147(int iParam0)
{
	if ((iParam0 == 22 || iParam0 == 39) && !func_231())
	{
		return true;
	}
	if (iParam0 == 66)
...
char* func_153(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893599.f_162)))
	{
		sVar0 = func_234(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_236(func_235(Global_34));
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		if (!func_237(iParam0) || func_238(44))
		{
			switch (iParam0)
			{
				case 2:
...
int func_156(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_239(PLAYER::PLAYER_ID()) };
...
char* func_165(char* sParam0, int iParam1)
{
	...
	return func_240(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}

var func_166(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	var uVar16;
...
void func_168(var uParam0, int iParam1)
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_241(iParam1, 0));
}
...
{
	DEBUG::_0x4DC69742196F818A(40, 195, "CLEAR_SALOON: Clearing ", func_242(iParam0));
	func_243(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_244(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
	...
	func_245(iParam0, 8192);
	func_245(iParam0, 32768);
	func_245(iParam0, 524288);
	func_245(iParam0, 1048576);
...
void func_172(int iParam0)
{
	...
	if (func_103(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_246(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_247(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_248(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_249(iParam0, 536870912);
	iVar1 = func_250(iParam0);
	if (iVar1 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(2216, 139, "[SHOP_UNLOCK_DOORS] Shop: ", func_118(iParam0, 0), " door count is greater then the. Current door count: ", iVar1, " Max door count: ", 15);
		Global_1915867.f_3[iParam0 /*447*/].f_409 = 0;
	}
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_196(Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
	...
	DEBUG::_0xF0783374333FD8CE(168, 139, "[CLEAR_SHOP] Shop: ", func_118(iParam0, 0), " has been cleared!");
}
...
int func_174(int iParam0, bool bParam1)
{
	if (!func_103(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_131(iParam0), " is invalid");
		return 0;
	}
	if (!func_173(iParam0, 2))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_131(iParam0), " has not been initialized");
		return 0;
	}
	if (func_179(iParam0) == 0)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_131(iParam0), " doesn't exist");
		return 1;
	}
	if (!PERSCHAR::_0x800DF3FC913355F3(func_130(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_131(iParam0), " already destroyed");
		return 1;
	}
	if (func_173(iParam0, 1) && !bParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_131(iParam0), " is stolen, so it will be destoyed on release.");
		func_252(iParam0, 128);
		return 1;
	}
	func_181(iParam0, 129);
	func_253(iParam0);
	DEBUG::_0xA308F935BDECCEC0(40, 138, "DESTROY_REGIONAL_CHARACTER: Destroying ", func_131(iParam0));
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_130(iParam0));
	func_180(iParam0, 0);
	DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: ", func_131(iParam0), " destroyed.");
	return 1;
}
...
void func_177()
{
	...
	while (iVar0 <= 3)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ NET_CLEAR_BARTENDERS - Removed ", func_255(Global_1051777.f_3642[iVar0 /*19*/]));
...
void func_181(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_256(iParam1), " on ", func_131(iParam0));
}
...
bool func_182(int iParam0)
{
	...
	if (!func_173(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_131(iParam0), " has not been initialized");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(40, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_131(iParam0));
	return true;
}

bool func_183(struct<2> Param0)
{
	return func_257(Param0, 5, 8);
}

bool func_184(int iParam0)
{
	return func_258(1, iParam0);
}
...
{
	if (func_259(&(Global_1102630.f_4), iParam0, 5))
	{
		DEBUG::_0xF0783374333FD8CE(680, 36, "CLEAR_NET_PLAYER_STATUS_FLAG - ", func_260(iParam0), " cleared by thread ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
		return 1;
	}
	return 0;
}
...
{
	func_261(iParam0);
	DEBUG::_0xF0783374333FD8CE(40, 37, "NET_SPECIAL_CAM__KILL - Setting new display to ", func_262(iParam0, 0));
	if (!func_263(1))
	{
	...
	else if (!func_264(128) && !func_265(19))
	{
		CAM::DO_SCREEN_FADE_OUT(iParam2);
	}
	if (bParam3 && func_266() == 4)
	{
...
{
	if (func_268(&(Global_1102630.f_4), iParam0, 5))
	{
		DEBUG::_0xF0783374333FD8CE(680, 36, "SET_NET_PLAYER_STATUS_FLAG - ", func_260(iParam0), " set by thread ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
		return 1;
	}
	return 0;
}
...
void func_191(struct<30> Param0, int iParam30)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, iParam30, "             outer.eType                     - ", func_269(Param0.f_17.f_9, 0));
	if (Param0.f_16)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, iParam30, "             inner.eType                     - ", func_269(Param0.f_6.f_9, 0));
	}
...
void func_192(struct<7> Param0, var uParam7, var uParam8, int iParam9)
{
...
void func_195(int iParam0, int iParam1)
{
	if (func_194(iParam0, iParam1))
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_111(iParam0), " flag ", func_204(iParam1));
	}
...
{
	if (func_120(bParam0) && func_270())
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 183, "RELEASE_DOOR_ID - Releasing Door ID ", func_205(bParam0, 0));
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_FLAGS] ", func_111(iParam0));
	Global_1051777.f_80[iParam0 /*75*/].f_49 = 0;
}

bool func_199(int iParam0, int iParam1)
{
	return func_271(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}

void func_200(int iParam0)
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_SUPPORT_FLAGS] ", func_111(iParam0));
...
int func_203(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1139844.f_7) && !func_273(12, func_272(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
void func_207(bool bParam0, char* sParam1, bool bParam2, bool bParam3)
{
	if (func_120(bParam0))
	{
...
void func_208(bool bParam0, bool bParam1)
{
	if (func_120(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 2 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "LOCK_DOOR_ID - Locking Door ID ", func_205(bParam0, 0));
		}
	}
	else
	{
...
void func_209(bool bParam0, bool bParam1)
{
	if (func_120(bParam0))
	{
		...
		{
			DEBUG::_0x1B08D1EB9D8C4931(2216, 183, "SET_DOOR_ID_LOCKED_AND_UNBREAKABLE - Door ID ", func_205(bParam0, 0), " state = ", OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0), " pending state ", UNK_0x4BC2854478F3A749(bParam0));
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(bParam0, 1);
		}
	}
	else
...
void func_210(bool bParam0, bool bParam1)
{
	if (func_120(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 0 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "UNLOCK_DOOR_ID - Unlocking Door ID ", func_205(bParam0, 0));
		}
	}
	else
	{
...
int func_212(int iParam0, char* sParam1, int iParam2, char* sParam3, float fParam4, char* sParam5, var uParam6)
{
	struct<4> Var0;

	Var0 = func_275();
	Var0.f_2 = -738708473;
	Var0.f_3 = func_272(iParam0);
	if (!DATAFILE::_DATAFILE_GET_DATA_NODE_INDEX(&(Var0.f_1), &Var0))
	{
		DEBUG::_0x4DC69742196F818A(40, 139, "[NET_GET_SHOP_AUTHOR_DATA_WITH_STRING] Could not fill out region node for: ", func_255(iParam0));
		return 0;
	}
	Var0.f_2 = -1407851228;
	...
	DEBUG::_0x4DC69742196F818A(1747624, 139, "[NET_GET_SHOP_AUTHOR_DATA_WITH_STRING] eShop = ", func_255(iParam0), ", ", sParam5, " = ", MISC::_0x6C4DBF553885F9EB(*uParam6), ", ", sParam3, " = ", *fParam4);
	return 1;
}

int func_213(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
int func_216(int iParam0)
{
	...
	if (iVar0 == 0)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "@@ GET_SHOP_STAT_ITEM: STAT_ITEMS for shop ", func_136(iParam0, 0), " is missing, please Bug DD Shops and Stables.");
	}
	return iVar0;
}
...
bool func_217(bool bParam0, int iParam1)
{
	...
	if (!func_142(bParam0, 0))
	{
		DEBUG::_0x4423BBAB7EB2B96B(40, 158, "GET_AMMO_TYPE_FROM_SATCHEL_ITEM - Invalid item: ", func_221(bParam0, 0));
		return false;
	}
	iVar0 = func_143(bParam0);
	...
	if (func_276(bParam0, 1399091007))
	{
		func_277(bParam0, &uVar1, &uVar2);
		return uVar2;
	}
	DEBUG::_0x9A6C65DDDBEC9C52(168, 158, "GET_AMMO_TYPE_FROM_SATCHEL_ITEM - ", func_221(bParam0, 0), " does not map to a valid ammo item");
	return false;
}

bool func_218(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_229(bParam4), sParam0, bParam3, iParam2);
	if (*iParam1 >= 0)
	{
		DEBUG::_0xA308F935BDECCEC0(174216, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION - Created collection '", *iParam1, "' with size ", *iParam2, " from predicate '", sParam0, "' with ", func_278(bParam3, 0));
...
bool func_219(var uParam0, int iParam1, int iParam2, int iParam3)
{
	if (iParam2 < 0)
	{
...
int func_225(var uParam0, int iParam1)
{
	...
	DEBUG::_0x9A6C65DDDBEC9C52(40, 208, "[METAPED_SAVE__OVERLAY_FIND_LAYER_BY_TYPE] Failed to find: ", func_279(iParam1, 0));
	return -1;
}
...
int func_226(bool bParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 208, "[METAPED_CLOTHING_OVERLAY_GET_MAKEUP_LAYER_TYPE_FROM_IVENTORY_ITEM] Failed not get a layer type from: ", func_221(bParam0, 0));
	return 0;
}

char[] func_227(bool bParam0, bool bParam1)
{
	struct<14> Var0;
	int iVar14;
	char[] cVar15[8];
	...
	Var0 = { func_280(bParam0, -1591664384, -1591664384, -1591664384, 0, 0, 0) };
	if (bParam1)
	{
		func_282(&Var0, func_281(0));
	}
	if (!func_283(&Var0, &iVar14, &cVar15, 0))
	{
		DEBUG::_0x1B08D1EB9D8C4931(648, 157, "GET_PLAYER_WEAPON_ITEM_COUNT bCarriedOnly = ", bParam1, " - Found 0 of item ", func_221(bParam0, 0));
		return 0;
	}
	func_222(iVar14);
	DEBUG::_0x1B08D1EB9D8C4931(10376, 157, "GET_PLAYER_WEAPON_ITEM_COUNT bCarriedOnly = ", bParam1, " - Found ", cVar15, " of item ", func_221(bParam0, 0));
	return cVar15;
}
...
int func_228(bool bParam0, int iParam1)
{
	...
	if (func_285(func_284(bParam0), 2))
	{
...
struct<4> func_230(bool bParam0, bool bParam1)
{
	struct<5> Var0;

	Var0 = { func_286(bParam0, bParam1, 0) };
	return func_287(bParam0, Var0, Var0.f_4, bParam1);
}
...
bool func_233(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_290(func_58(0)))
	{
		return true;
	}
...
char* func_234(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
void func_245(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 195, "CLEAR_SALOON_CONFIG_FLAG: Clearing flag for ", func_295(iParam1, 0));
	func_296(&(Global_1940170.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_247(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	...
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that isnt stolen ", func_131(iParam0));
		return;
	}
	if (!func_173(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release an uninitialized regional character ", func_131(iParam0));
		return;
	}
	if ((!bParam4 && !func_246(iParam0)) && func_297(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that is stolen by a differnt script ", func_131(iParam0));
		return;
	}
	DEBUG::_0xF0783374333FD8CE(680, 138, "RELEASE_REGIONAL_CHARACTER: Regional character ", func_131(iParam0), " released by ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
	func_181(iParam0, 1);
	func_253(iParam0);
	if (func_298(func_179(iParam0)))
	{
		iVar0 = func_130(iParam0);
		if (!PERSCHAR::_0x800DF3FC913355F3(iVar0))
		{
			DEBUG::_0x9A6C65DDDBEC9C52(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character with no perschar index", func_131(iParam0));
			return;
		}
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being retasked ", func_131(iParam0));
	...
	if (func_173(iParam0, 128) && !bParam3)
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being destroyed on release ", func_131(iParam0));
		func_174(iParam0, 0);
	}
}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 139, "CLEAR_ALL_SHOP_TYPE_FLAGS: ", func_111(iParam0));
...
void func_252(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_256(iParam1), " on ", func_131(iParam0));
}
...
void func_253(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar0, false))
		{
			...
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_131(iParam0), " set as no longer needed.");
		}
		else
		{
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_131(iParam0), " was asked to be set as no longer needed, but this script does not own the ped.");
		}
	}
...
bool func_257(struct<2> Param0, int iParam2, int iParam3)
{
	int iVar0;
...
bool func_258(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_305(&(Global_1102630.f_4), iVar0, 5);
	}
	if (iParam1 == func_306())
	{
		return func_305(&(Global_1102630.f_4), iVar0, 5);
	...
	{
		return func_305(&(Global_1100880[iParam1 /*53*/].f_4), iVar0, 5);
	}
...
char* func_262(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case 0:
...
bool func_273(int iParam0, char* sParam1, var uParam2)
{
	var uVar0;

	if (func_308(iParam0, sParam1, &uVar0))
	{
		func_309(&uVar0, iParam0, uParam2);
	}
	else
	{
...
int func_276(bool bParam0, bool bParam1)
{
	if (!func_142(bParam0, 0))
	{
		return func_310(func_284(bParam0), bParam1);
	}
	if (bParam1 == 0)
	{
		return 0;
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[ITEM_HAS_PROPERTY_TAG] Found tag ", func_311(bParam1, 0), " for item ", func_221(bParam0, 0), ", returning TRUE");
		return 1;
	}
	return 0;
}

void func_277(bool bParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
struct<14> func_280(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6)
{
	struct<14> Var0;
	...
	{
		Var0 = bParam0;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - Item:      ", func_221(bParam0, 0));
	}
	if (bParam1 != 0 && bParam1 != -1591664384)
	{
		Var0.f_1 = bParam1;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eSlot:     ", func_278(bParam1, 0));
	}
	if (bParam2 != 0 && bParam2 != -1591664384)
	{
		Var0.f_2 = bParam2;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eFitsSlot: ", func_278(bParam2, 0));
	}
	if (bParam3 != 0 && bParam3 != -1591664384)
	{
		Var0.f_3 = bParam3;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eHasSlot:  ", func_278(bParam3, 0));
	}
	if (bParam4 != 0)
	{
		Var0.f_4 = bParam4;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eCategory: ", func_312(bParam4, 0));
	}
	if (bParam5 != 0)
	{
		Var0.f_5 = bParam5;
	...
	{
		Var0.f_8 = iParam6;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eItemGroup:  ", func_313(iParam6, 0));
	}
	return Var0;
}
...
struct<4> func_281(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		if (!INVENTORY::_0xB881CA836CC4B6D4(&(Global_1272425.f_4)))
		{
			...
			Global_1272425.f_4 = { func_287(923904168, func_314(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		if (!INVENTORY::_0xB881CA836CC4B6D4(&(Global_1272425.f_16)))
		{
			...
			Global_1272425.f_16 = { func_287(923904168, func_314(bParam0), -740156546, 0) };
		}
		return Global_1272425.f_16;
	}
	return func_287(923904168, func_314(bParam0), -740156546, 0);
}

void func_282(var uParam0, struct<4> Param1)
{
...
bool func_283(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_229(bParam3), uParam0, sParam2);
	if (*iParam1 >= 0)
	{
...
struct<5> func_286(bool bParam0, bool bParam1, bool bParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 157, "PLAYER_INVENTORY_GET_DEFAULT_ITEM_SLOT_INFO - eInventoryItem = ", func_221(bParam0, 0));
	DEBUG::_0x1B08D1EB9D8C4931(40, 157, "PLAYER_INVENTORY_GET_DEFAULT_ITEM_SLOT_INFO - eInvItemGroup = ", func_313(iVar5, 0));
	switch (iVar5)
	{
		case joaat("CLOTHING"):
			Var0 = { func_287(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			{
				Var6.f_9 = -1591664384;
				if (!func_316(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_316(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_317(bParam0, &Var6, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
		case joaat("DOG"):
			if (func_319(bParam0, -1823706425))
			{
				Var0 = { func_287(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, joaat("KIT_CAMP"));
			}
			else if (func_319(bParam0, -1483207246))
			{
				Var0 = { func_287(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, joaat("WARDROBE"));
			}
			...
			else if (func_319(bParam0, -1653629781))
			{
				Var0 = { func_287(1384535894, Var0, 1784584921, bParam1) };
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(bParam0, -833319691))
			{
				...
				if (!func_320(Var0, &Var28, bParam1, 0, -1))
				{
			...
			else
			{
				...
				if (Var0.f_4 == 0)
				{
					DEBUG::_0xD9911C7B5F8CD69C(40, 157, "PLAYER_INVENTORY_GET_DEFAULT_ITEM_SLOT_INFO - Unable to find an approprite default slot for item ", func_221(bParam0, 0));
				}
			}
			break;
	}
	DEBUG::_0xA308F935BDECCEC0(10920, 157, "PLAYER_INVENTORY_GET_DEFAULT_ITEM_SLOT_INFO - ", func_221(bParam0, 0), ": ", func_278(Var0.f_4, 0), " - ", UNK_0xD2E4270E5D98EEE4(&Var0));
	return Var0;
}

struct<4> func_287(bool bParam0, var uParam1, bool bParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	struct<4> Var0;

	if (!func_142(bParam0, 0))
	{
		DEBUG::_0xD9911C7B5F8CD69C(2216, 157, "GET_PLAYER_INVENTORY_ITEM_GUID - Attempting to check for an invalid item ", func_221(bParam0, 0), " (", bParam0, ") in the player's inventory!");
		return Var0;
	}
	INVENTORY::_0x886DFD3E185C8A89(func_229(bParam6), &uParam1, bParam0, bParam5, &Var0);
	return Var0;
}
...
bool func_288()
{
	...
	if (!func_290(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_292(vector3 vParam0, int iParam3)
{
	...
	func_323(iParam3, &vVar0, &Var3, &uVar6);
	if (func_324(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
...
int func_304(struct<2> Param0)
{
	if (Param0 == 2)
	{
		return func_327(Param0);
	}
	return -1;
}
...
bool func_308(int iParam0, char* sParam1, var uParam2)
{
	*uParam2 = Global_1139844.f_7;
	uParam2->f_2 = 1351168281;
	uParam2->f_3 = func_328(iParam0);
	uParam2->f_4 = sParam1;
...
void func_309(var uParam0, int iParam1, var uParam2)
{
	...
	*uParam2 = iParam1;
	...
	{
		DEBUG::_0x83407B92D46F25C3(648, 84, "RETRIEVE_UNLOCK_DATA - Couldn't retrieve id at index ", uParam2->f_1, " of type ", func_329(iParam1, 0));
	}
	uParam0->f_2 = -2140901307;
...
int func_310(bool bParam0, bool bParam1)
{
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[BUNDLE_HAS_PROPERTY_TAG] Found tag ", func_311(bParam1, 0), " for bundle ", func_330(bParam0, 0), ", returning TRUE");
		return 1;
	}
	return 0;
}
...
var func_312(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
struct<4> func_314(bool bParam0)
{
	...
	if (Global_1572887.f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				Global_1272425 = { func_287(joaat("CHARACTER"), func_331(), -1591664384, bParam0) };
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1272425.f_12 = { func_287(joaat("CHARACTER"), func_331(), -1591664384, 0) };
	...
	return func_287(joaat("CHARACTER"), func_331(), -1591664384, bParam0);
}

bool func_315(bool bParam0, bool bParam1)
{
	if (func_223(bParam0) == 1779021115)
	{
		return false;
	}
...
bool func_316(bool bParam0, var uParam1, int iParam2, int iParam3, bool bParam4)
{
	return func_333(bParam0, *uParam1, iParam2, iParam3, 1, bParam4) > 0;
}

bool func_317(bool bParam0, var uParam1, bool bParam2)
{
	var uVar0;

	if (func_334(bParam0, &uVar0, uParam1, bParam2))
	{
...
struct<4> func_318(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		if (!INVENTORY::_0xB881CA836CC4B6D4(&(Global_1272425.f_8)))
		{
			...
			Global_1272425.f_8 = { func_287(271701509, func_314(bParam0), 12999093, 0) };
		}
		return Global_1272425.f_8;
	}
	return func_287(271701509, func_314(bParam0), 12999093, 0);
}
...
bool func_319(bool bParam0, int iParam1)
{
	...
	while (iVar2 < iVar3)
	{
		...
		{
			if (func_335(bParam0, iParam1, iVar0))
			{
				return true;
			}
		}
...
bool func_320(var uParam0, var uParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, int iParam7)
{
	return func_336(&uParam0, iParam4, bParam5, bParam6, iParam7);
}
...
bool func_324(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
...
int func_325(int iParam0)
{
	...
	DEBUG::_0xD9911C7B5F8CD69C(168, 139, "GET_SHOP_TYPE_FROM_SHOP - ", func_136(iParam0, 0), " undefined");
	return -1;
}
...
bool func_332()
{
	return (func_338(joaat("UPGRADE_OFFHAND_HOLSTER"), 0, 0, 0) > 0 && func_339(func_287(joaat("WARDROBE"), func_314(1), 1034665895, 1), -234132662, 1, -1) != 0);
}

int func_333(bool bParam0, struct<4> Param1, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	struct<4> Var1;
	...
	if (!bParam7 && func_228(bParam0, joaat("DEFAULT")) == 0)
	{
		DEBUG::_0x4DC69742196F818A(168, 157, "PLAYER_INVENTORY_GET_ITEM_COUNT - ", func_221(bParam0, 0), " doesn't have a default pathset, using supplied slot only");
		bParam7 = true;
	}
	iVar0 = 0;
	if (bParam7)
	{
		DEBUG::_0x1B08D1EB9D8C4931(43688, 157, "PLAYER_INVENTORY_GET_ITEM_COUNT - eInventoryItem: ", func_221(bParam0, 0), " sParentGUID: ", UNK_0xD2E4270E5D98EEE4(&Param1), " eSlot: ", func_278(bParam5, 0), " bPlayerOnly: ", bParam6);
		Var1 = { func_287(bParam0, Param1, bParam5, bParam6) };
		if (!INVENTORY::_0xB881CA836CC4B6D4(&Var1))
		{
			DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_GET_ITEM_COUNT - Unable to find GUID for item ", func_221(bParam0, 0));
			return 0;
		}
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_229(bParam6), &Var1, bParam8);
		DEBUG::_0xA308F935BDECCEC0(648, 157, "PLAYER_INVENTORY_GET_ITEM_COUNT - Found ", iVar0, " of item ", func_221(bParam0, 0));
	}
	else
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_229(bParam6), bParam0, bParam8);
		DEBUG::_0xA308F935BDECCEC0(648, 157, "PLAYER_INVENTORY_GET_ITEM_COUNT - Found total ", iVar0, " of item ", func_221(bParam0, 0));
	}
	return iVar0;
}

bool func_334(bool bParam0, int iParam1, var uParam2, bool bParam3)
{
	int iVar0;

	iVar0 = func_229(0);
	*iParam1 = { func_287(bParam0, func_281(0), bParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(iParam1))
	{
		DEBUG::_0xF0783374333FD8CE(2728, 139, "[SHOP_GET_INVENTORY_WEAPON_DATA] Invalid INVENTORY_ITEM_GUID for ", func_221(bParam0, 0), " eSlot: ", func_278(bParam3, 0), " iPlayerInventoryID: ", iVar0);
		return false;
	}
	if (!INVENTORY::_0x025A1B1FB03FBF61(iVar0, iParam1, uParam2, 22, 1))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[SHOP_GET_INVENTORY_WEAPON_DATA] We couldn't grab the data for ", func_221(bParam0, 0));
		return false;
	}
	return true;
}

bool func_335(bool bParam0, int iParam1, int iParam2)
{
...
bool func_336(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 157, "PLAYER_INVENTORY_GET_ITEM_DATA -  ItemId:      ", func_221(iParam1->f_4, 0));
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 157, "PLAYER_INVENTORY_GET_ITEM_DATA -  SlotId:      ", func_278(iParam1->f_9, 0));
...
bool func_337(struct<2> Param0, var uParam2)
{
	if (!func_290(Param0))
	{
		return false;
...
int func_338(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (func_341(bParam0) && !bParam2)
	{
		return WEAPON::GET_PED_AMMO_BY_TYPE(Global_33, bParam0);
	}
	return INVENTORY::_0xE787F05DFC977BDE(func_229(bParam1), bParam0, bParam3);
}

int func_339(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, int iParam6)
{
	return func_342(&uParam0, bParam4, bParam5, iParam6);
}
...
int func_342(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	Var0.f_9 = -1591664384;
	if (func_343(iParam0, bParam1, &Var0, bParam2, iParam3))
	{
		DEBUG::_0x4DC69742196F818A(680, 157, "PLAYER_INVENTORY_GET_ITEM_EQUIPPED_IN_SLOT_BY_REF - Found ", func_221(Var0.f_4, 0), " equipped on item ", UNK_0xD2E4270E5D98EEE4(iParam0));
		return Var0.f_4;
	}
...
bool func_343(int iParam0, bool bParam1, int iParam2, bool bParam3, int iParam4)
{
	var uVar0;
	...
	if (iParam4 == -1)
	{
		iParam4 = func_229(bParam3);
	}
	if (!INVENTORY::_0x22E590F108289A9D(iParam4, iParam0, bParam1, &uVar0))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(40, 157, "PLAYER_INVENTORY_GET_ITEM_DATA_EQUIPPED_IN_SLOT_BY_REF - nothing is equipped for slot ", func_278(bParam1, 0));
		return false;
	}
	if (!func_336(&uVar0, iParam2, bParam3, 0, iParam4))
	{
		DEBUG::_0xD9911C7B5F8CD69C(40, 157, "PLAYER_INVENTORY_GET_ITEM_DATA_EQUIPPED_IN_SLOT_BY_REF - failed to get equipment data for slot ", func_278(bParam1, 0));
		return false;
	}
	DEBUG::_0x1B08D1EB9D8C4931(10920, 157, "PLAYER_INVENTORY_GET_ITEM_DATA_EQUIPPED_IN_SLOT_BY_REF - ", func_221(iParam2->f_4, 0), " (", UNK_0xD2E4270E5D98EEE4(iParam2), ") is equipped in slot ", func_278(bParam1, 0));
	return true;
}
