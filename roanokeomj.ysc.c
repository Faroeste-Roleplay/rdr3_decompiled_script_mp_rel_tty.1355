...
void __EntryFunction__()
{
	...
	DEBUG::_0xF0783374333FD8CE(43688, 17, "**** INITIALIZING REGION: ", &(Global_1887351[vScriptParam_0.x /*36*/].f_23), ", ", &(Global_1887351[iLocal_24 /*36*/].f_24), ", ", &(Global_1887351[iLocal_24 /*36*/].f_27), " ****");
	func_2();
	func_3();
	...
	while (func_4())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_23)
		{
			...
			{
				case 0:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_24 /*36*/].f_23), " global init...");
					if (Global_1901988.f_1.f_26 > 0)
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_24 /*36*/].f_23), "-> RBS_WAIT_FOR_UGC_EARLY_QUIT");
						iLocal_25 = (MISC::GET_GAME_TIMER() + Global_1901988.f_1.f_26);
						iLocal_22 = 1;
					}
					else
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_24 /*36*/].f_23), "-> RBS_INIT_REGION");
						iLocal_22 = 2;
					}
					break;
				case 1:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_24 /*36*/].f_23), " ugc early quit...");
					...
					break;
				case 2:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_24 /*36*/].f_23), " region init...");
					func_6(iLocal_24);
					func_7();
					func_8();
					...
					Global_1896632 = -1;
					DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_24 /*36*/].f_23), "-> RBS_INIT_VOLUME");
					iLocal_25 = (iLocal_21 + MISC::GET_GAME_TIMER());
					iLocal_22 = 3;
					break;
				case 3:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_24 /*36*/].f_23), " volume init...");
					if (func_13() || iLocal_25 < MISC::GET_GAME_TIMER())
					{
						func_14(iLocal_24);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_24 /*36*/].f_23), "-> RBS_LOAD_APPEARANCE");
						iLocal_25 = (MISC::GET_GAME_TIMER() + iLocal_21);
						iLocal_22 = 4;
					}
					break;
				case 4:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_24 /*36*/].f_23), " load appearance...");
					if (func_15(iLocal_24) || iLocal_25 < MISC::GET_GAME_TIMER())
					{
						func_16(iLocal_24);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_24 /*36*/].f_23), "-> RBS_LOAD_SPECIAL");
						iLocal_25 = (MISC::GET_GAME_TIMER() + iLocal_21);
						iLocal_22 = 5;
					}
					break;
				case 5:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_24 /*36*/].f_23), " load special...");
					if (func_17(iLocal_24) || iLocal_25 < MISC::GET_GAME_TIMER())
					{
						func_18(iLocal_24);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_24 /*36*/].f_23), "-> RBS_LOAD_PERS_CHARS");
						iLocal_25 = (iLocal_21 + MISC::GET_GAME_TIMER());
						iLocal_22 = 7;
					}
					break;
				case 7:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_24 /*36*/].f_23), " init regional chars...");
					if (func_10(func_9(iLocal_24)))
					{
						...
						else
						{
							if (func_20(iLocal_24) || iLocal_25 < MISC::GET_GAME_TIMER())
							{
								func_21(iLocal_24, 4);
								iLocal_25 = (MISC::GET_GAME_TIMER() + iLocal_21);
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_24 /*36*/].f_23), "-> RBS_INIT_AMBIENT");
								iLocal_22 = 8;
							}
							...
							{
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_24 /*36*/].f_23), " AMBIENT MINIGAMES ARE NOT BEING ENABLED AS A STORY OR RCM OR MISSION RETRY IS HAPPENING");
							}
							func_26();
							func_27();
							func_28();
							...
							func_31();
							func_32();
							DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": INIT_CURRENT_REGION_TOWN_DATA FOR ", &(Global_1887351[iLocal_24 /*36*/].f_23));
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_24 /*36*/].f_23), " RBS_INIT_AMBIENT -> RBS_INIT_LAW");
							iLocal_22 = 9;
							Jump @1356; //curOff = 1032
							func_33(iLocal_24);
							func_34();
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_24 /*36*/].f_23), "-> RBS_INIT_NAMED_LOCATIONS");
							iLocal_22 = 10;
							Jump @1356; //curOff = 1070
							func_35(&Global_1896686);
							func_36(iLocal_24, &Global_1896686);
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_24 /*36*/].f_23), "-> RBS_DONE_INIT");
							iLocal_22 = 11;
							Jump @1356; //curOff = 1116
							DEBUG::_0xF0783374333FD8CE(168, 17, "**** FINISHED INITIALIZING: ", &(Global_1887351[iLocal_24 /*36*/].f_23), " ****");
							func_37(iLocal_24);
							func_21(iLocal_24, 8);
							if (func_38(32))
							{
							...
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_24 /*36*/].f_23), "-> RBS_RUNNING");
							iLocal_22 = 12;
							...
							func_41(&Global_1896686, iLocal_24);
							func_42(iLocal_24);
							func_21(iLocal_24, 8);
							if (func_43())
							{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887351[iLocal_24 /*36*/].f_11);
							if (Global_1887351[iLocal_24 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887351[iLocal_24 /*36*/].f_12);
							}
							Jump @1356; //curOff = 1312
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_24 /*36*/].f_23), " RBS_CLEANUP");
							func_8();
							func_44(iVar0);
							iVar0++;
						}
						if (Global_1887351[iLocal_24 /*36*/].f_13 == 0)
						{
						}
						else
						{
							PED::_0x95423627A9CA598E(Global_1887351[iLocal_24 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
...
bool func_1()
{
	if (!bLocal_26)
	{
		if (Global_1051140)
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_24 /*36*/].f_23), ", g_mpUGC_QuitSessionRequest.bRequestRunning is still true");
			bLocal_26 = true;
			return true;
		}
		if (func_47() && func_48())
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_24 /*36*/].f_23), ", a session request is running and a UGC script is running");
			bLocal_26 = true;
			return true;
		}
	...
	if (func_48())
	{
		DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_24 /*36*/].f_23), ", content script still running for some player");
		return true;
	}
...
bool func_13()
{
	if (func_45() != -1)
	{
		iLocal_19 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2627.639f, 1326.591f, 114.8667f, 0f, 0f, 0f, 5.445365f, 5.947449f, 4.273689f, "m_volROA_OldManJones");
		iLocal_20 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2627.639f, 1326.591f, 114.8667f, 0f, 0f, 0f, 5.445365f, 5.947449f, 4.273689f, "m_volROA_OldManJonesPrompt");
	}
	return true;
}
...
void func_29(int iParam0)
{
	if (func_45() != -1)
	{
		func_58(35, iLocal_19, iParam0, iLocal_20, 0, 4, 0, 0, -1082130432 /* Float: -1f */, 0);
		func_59(35, 0);
	}
}
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_34, 0f, 0f, 0f) <= 5f || func_62(Global_1940410, 32768)) || func_62(Global_1940410, 16777216))
	{
		return;
	}
...
bool func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": REGION_TOWN_MANANGER_EXIT_TOWN FOR ", &(Global_1887351[iLocal_24 /*36*/].f_23));
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_24)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_75(iLocal_24));
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_76(iLocal_24, 0), 1);
					break;
			}
		}
		if (func_10(func_68()))
	...
	else
	{
		...
		if (func_45() == -1)
		{
			func_80(iLocal_24);
			func_81(iLocal_24);
			if (!func_82(iLocal_24, 0))
			{
				return false;
			}
		}
		else if (!func_83(iLocal_24))
		{
			return false;
		}
	}
	DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": Terminating. -- ", &(Global_1887351[iLocal_24 /*36*/].f_23));
	SCRIPTS::TERMINATE_THIS_THREAD();
	return true;
}
...
bool func_49(bool bParam0, bool bParam1)
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		{
			DEBUG::_0xF0783374333FD8CE(168, 8, "KILL_EVENT_CAUGHT - NETWORK_IS_GAME_IN_PROGRESS() = FALSE - but bIgnoreTransition = TRUE and g_mpTransition.eMPState = ", func_84(Global_1572887, 0), ", so skipping");
		}
		else
		{
...
int func_53(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (!func_60(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Region index not valid ", func_86(iParam0));
		return 1;
	}
	if (func_85(iParam0, 16))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: RF_PERS_DISABLED is on for ", func_86(iParam0));
		return 1;
	}
	if (func_87(iParam0) && !func_88(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: IS_REGION_IN_LOCKDOWN is on for ", func_86(iParam0));
	}
	DEBUG::_0xF0783374333FD8CE(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Starting for ", func_86(iParam0));
	if (func_89(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if ((!func_87(iParam0) || func_88(iParam0)) || func_91(Global_1896632))
			{
				func_92(Global_1896632, 0);
			}
			Global_1896632++;
			iVar2++;
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	func_97(iParam0, 1);
	DEBUG::_0xF0783374333FD8CE(40, 139, "NET_ENABLE_SHOP_LOCATION: Registering ", func_98(iParam0));
	Global_1051777.f_80[iParam0 /*75*/] = 0;
	Global_1051777.f_80[iParam0 /*75*/].f_18 = func_99(iParam2, iParam0);
	...
	Global_1051777.f_80[iParam0 /*75*/].f_63 = func_100(Global_1051777.f_80[iParam0 /*75*/].f_18);
...
int func_59(int iParam0, bool bParam1)
{
	...
	if ((func_104(iParam0, 16384) || func_104(iParam0, 32768)) || func_105(Global_1051777.f_80[iParam0 /*75*/].f_3))
	{
	...
	iVar0 = func_99(func_106(), iParam0);
	if ((!bParam1 && func_107(iVar0, &bVar1, &uVar2, &vVar3)) || (bParam1 && func_108(iVar0, &bVar1, &uVar2, &vVar3)))
	{
		func_109(iParam0, bVar1, vVar3, uVar2, 0);
...
bool func_64()
{
	return func_62(Global_1940410, 8192);
}
...
bool func_66(int iParam0)
{
	...
	return ((Global_1887351[iParam0 /*36*/].f_21 == 1 || Global_1887351[iParam0 /*36*/].f_21 == 2) && !func_111(iParam0));
}
...
void func_69(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	char* sVar1;
	char* sVar2;
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_113(iParam0, 0), " ", func_114(iParam1, 0), " ", func_115(bParam2, 0), " state ", func_116(iParam4, 0));
	UNK_0x355E72323AEE83CC(11, 6);
	sVar1 = func_117(iParam0, iParam1, bParam2, iParam4, bParam5, bParam3, &bVar0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_113(iParam0, 0), " or ", func_114(iParam1, 0), " or ", func_115(bParam2, 0));
	...
	if (!func_118(iParam4))
	{
		if (func_60(iParam0))
		{
			iParam4 = func_119(func_9(iParam0));
		}
		else
		{
			iParam4 = func_119(iParam1);
		}
	}
	if (func_118(iParam4))
	{
		iVar3 = func_120(iParam4);
	}
	if (bVar0 && bParam3)
	{
		sVar2 = func_122(func_121(bParam2));
	}
	else if ((func_123(iParam1, 2) || func_124(iParam4, 2)) && !Global_1893599.f_9)
	{
	...
	else if ((func_60(iParam0) && func_85(iParam0, 16777216)) && !Global_1893599.f_9)
	{
	...
	{
		iVar4 = func_126(func_125());
		iVar5 = func_127(func_125());
		if (iVar5 < 10)
		{
	...
	Global_1939313.f_145 = func_130(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_71(int iParam0, bool bParam1)
{
	...
	func_132(&Global_1940410, 16384);
	func_134(func_133(joaat("DISCOVERED"), joaat("AREAS")), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_134(func_133(joaat("DISCOVERED"), joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_134(func_133(joaat("DISCOVERED"), joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_134(func_133(joaat("DISCOVERED"), joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_134(func_133(joaat("DISCOVERED"), joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_134(func_133(joaat("DISCOVERED"), joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_134(func_133(joaat("DISCOVERED"), joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
bool func_82(int iParam0, bool bParam1)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 138, "DELETE_ALL_REGIONAL_CHARACTERS starting for Region ", func_86(iParam0));
	if (func_89(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_137(Global_1896632.f_1, 16))
			{
				func_138(Global_1896632.f_1, 0);
			}
			Global_1896632.f_1++;
			iVar2++;
...
bool func_83(int iParam0)
{
	...
	while (iVar0 < 40)
	{
		if (func_139(iVar0) || func_140(iVar0))
		{
		}
		else
		{
	...
	switch (iParam0)
	{
		...
		case 139:
			...
			*iParam2 = 851;
			...
			break;
		default:
			DEBUG::_0xA308F935BDECCEC0(40, 138, "Attempting to get regional character bounds for a region that doesn't have them yet ", func_75(iParam0));
			*iParam1 = -1;
			*iParam2 = -1;
			break;
	}
...
int func_92(int iParam0, bool bParam1)
{
	if (!func_90(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_143(iParam0), " is invalid");
		return 0;
	}
	if (!func_137(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_143(iParam0), " has not been initialized");
		return 0;
	}
	if (func_137(iParam0, 32) && !bParam1)
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_143(iParam0), " has been locked dead");
		func_145(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_144(iParam0)));
		if (func_45() == -1)
		{
			if (func_137(iParam0, 2048))
			{
				PERSCHAR::_0x49A8C2CD97815215(func_146(iParam0));
				func_147(iParam0, 2048);
				DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_143(iParam0), " has been revived!");
			}
	...
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_143(iParam0), " dead or not spawning, turn scenario groups off");
		return 0;
	}
	if (PERSCHAR::_0x800DF3FC913355F3(func_146(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Persistent character ", func_143(iParam0), " already exists");
		func_147(iParam0, 128);
		return 1;
	}
	func_145(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_144(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_146(iParam0));
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_143(iParam0), " perschar index created!");
	if (func_137(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_146(iParam0));
		func_147(iParam0, 2048);
	...
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_143(iParam0), " created.");
...
void func_96(bool bParam0, bool bParam1)
{
	...
	else
	{
		...
		func_154(0);
		func_155(&(Global_1102630.f_3849));
		...
		func_156(&(Global_1102630.f_3888));
	...
	func_157(Global_1102630.f_3849, 36);
	func_158(Global_1102630.f_3888, 36);
...
void func_97(int iParam0, bool bParam1)
{
	...
	if (!bVar0 && !func_104(iParam0, 65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] - Shop keeper deleted for shop: ", func_98(iParam0));
		}
	...
	else if (func_161(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
	{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] Remove the script created scenario for: ", func_98(iParam0));
		if (TASK::_DOES_SCENARIO_POINT_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_6))
		{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_164(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar2]);
	...
	func_165(iParam0);
	if (func_104(iParam0, 262144))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 139, "NET_CLEAR_SHOP: SPF_ALLOW_BLIP_OUT_OF_REGION for ", func_98(iParam0), " is kept; all other flags cleared.");
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_24) && func_167(iParam0, 2))
	{
...
int func_100(int iParam0)
{
	...
	{
		Global_1051777.f_4480[iParam0] = func_171(iParam0);
	}
...
void func_102(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_SET_SHOP_TYPE_FLAG] ", func_98(iParam0), " flag ", func_172(iParam1));
	}
...
bool func_107(int iParam0, bool bParam1, bool bParam2, char* sParam3)
{
	return func_173(iParam0, "sHash", bParam1, "fHeading", bParam2, "vPos", sParam3);
}

bool func_108(int iParam0, bool bParam1, bool bParam2, char* sParam3)
{
	return func_173(iParam0, "sClosedHash", bParam1, "fClosedHeading", bParam2, "vClosedPos", sParam3);
}

void func_109(int iParam0, bool bParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	if (bParam6)
	{
		MISC::GET_GROUND_Z_FOR_3D_COORD(vParam2, &(vParam2.f_2), false);
	}
	Global_1051777.f_80[iParam0 /*75*/].f_6 = func_174(bParam1, vParam2, uParam5, 0, 0, 0);
...
{
	if ((iParam0 == 22 || iParam0 == 39) && !func_175())
	{
		return true;
	}
	if (iParam0 == 66)
...
char* func_117(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893599.f_162)))
	{
		sVar0 = func_178(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_180(func_179(Global_34));
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		if (!func_181(iParam0) || func_182(44))
		{
			switch (iParam0)
			{
				case 2:
...
int func_120(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_183(PLAYER::PLAYER_ID()) };
...
char* func_129(char* sParam0, int iParam1)
{
	...
	return func_184(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
void func_132(var uParam0, int iParam1)
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_185(iParam1, 0));
}

struct<2> func_133(int iParam0, int iParam1)
{
	struct<2> Var0;
...
{
	DEBUG::_0x4DC69742196F818A(40, 195, "CLEAR_SALOON: Clearing ", func_186(iParam0));
	func_187(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_188(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
	...
	func_189(iParam0, 8192);
	func_189(iParam0, 32768);
	func_189(iParam0, 524288);
	func_189(iParam0, 1048576);
...
void func_136(int iParam0)
{
	...
	if (func_90(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_190(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_191(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_192(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_193(iParam0, 536870912);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_164(Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
int func_138(int iParam0, bool bParam1)
{
	if (!func_90(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_143(iParam0), " is invalid");
		return 0;
	}
	if (!func_137(iParam0, 2))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_143(iParam0), " has not been initialized");
		return 0;
	}
	if (func_144(iParam0) == 0)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_143(iParam0), " doesn't exist");
		return 1;
	}
	if (!PERSCHAR::_0x800DF3FC913355F3(func_146(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_143(iParam0), " already destroyed");
		return 1;
	}
	if (func_137(iParam0, 1) && !bParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_143(iParam0), " is stolen, so it will be destoyed on release.");
		func_196(iParam0, 128);
		return 1;
	}
	func_147(iParam0, 129);
	func_197(iParam0);
	DEBUG::_0xA308F935BDECCEC0(40, 138, "DESTROY_REGIONAL_CHARACTER: Destroying ", func_143(iParam0));
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_146(iParam0));
	func_145(iParam0, 0);
	DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: ", func_143(iParam0), " destroyed.");
	return 1;
}
...
void func_147(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_201(iParam1), " on ", func_143(iParam0));
}
...
bool func_148(int iParam0)
{
	...
	if (!func_137(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_143(iParam0), " has not been initialized");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(40, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_143(iParam0));
	return true;
}

bool func_149(struct<2> Param0)
{
	return func_202(Param0, 5, 8);
}

bool func_150(int iParam0)
{
	return func_203(1, iParam0);
}
...
{
	if (func_204(&(Global_1102630.f_4), iParam0, 5))
	{
		DEBUG::_0xF0783374333FD8CE(680, 36, "CLEAR_NET_PLAYER_STATUS_FLAG - ", func_205(iParam0), " cleared by thread ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
		return 1;
	}
	return 0;
}
...
{
	func_206(iParam0);
	DEBUG::_0xF0783374333FD8CE(40, 37, "NET_SPECIAL_CAM__KILL - Setting new display to ", func_207(iParam0, 0));
	if (!func_208(1))
	{
	...
	else if (!func_209(128) && !func_210(19))
	{
		CAM::DO_SCREEN_FADE_OUT(iParam2);
	}
	if (bParam3 && func_211() == 4)
	{
...
int func_154(int iParam0)
{
	...
	{
		DEBUG::_0xF0783374333FD8CE(680, 36, "SET_NET_PLAYER_STATUS_FLAG - ", func_205(iParam0), " set by thread ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
		return 1;
	}
	return 0;
}
...
void func_157(struct<30> Param0, int iParam30)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, iParam30, "             outer.eType                     - ", func_214(Param0.f_17.f_9, 0));
	if (Param0.f_16)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, iParam30, "             inner.eType                     - ", func_214(Param0.f_6.f_9, 0));
	}
...
void func_158(struct<7> Param0, var uParam7, var uParam8, int iParam9)
{
...
void func_162(int iParam0, int iParam1)
{
	if (func_161(iParam0, iParam1))
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_98(iParam0), " flag ", func_172(iParam1));
	}
...
{
	if (func_215(bParam0) && func_216())
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 183, "RELEASE_DOOR_ID - Releasing Door ID ", func_217(bParam0, 0));
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_FLAGS] ", func_98(iParam0));
	Global_1051777.f_80[iParam0 /*75*/].f_49 = 0;
}

bool func_167(int iParam0, int iParam1)
{
	return func_218(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}

void func_168(int iParam0)
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_SUPPORT_FLAGS] ", func_98(iParam0));
...
int func_171(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1139844.f_7) && !func_220(12, func_219(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
int func_173(int iParam0, char* sParam1, bool bParam2, char* sParam3, bool bParam4, char* sParam5, char* sParam6)
{
	struct<4> Var0;

	Var0 = func_222();
	Var0.f_2 = -738708473;
	Var0.f_3 = func_219(iParam0);
	...
	DEBUG::_0x4DC69742196F818A(1747624, 139, "[NET_GET_SHOP_AUTHOR_DATA_WITH_STRING] eShop = ", func_199(iParam0), ", ", sParam5, " = ", MISC::_0x6C4DBF553885F9EB(*sParam6), ", ", sParam3, " = ", *bParam4);
	return 1;
}

int func_174(bool bParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
void func_191(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	...
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that isnt stolen ", func_143(iParam0));
		return;
	}
	if (!func_137(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release an uninitialized regional character ", func_143(iParam0));
		return;
	}
	if ((!bParam4 && !func_190(iParam0)) && func_232(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that is stolen by a differnt script ", func_143(iParam0));
		return;
	}
	DEBUG::_0xF0783374333FD8CE(680, 138, "RELEASE_REGIONAL_CHARACTER: Regional character ", func_143(iParam0), " released by ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
	func_147(iParam0, 1);
	func_197(iParam0);
	if (func_233(func_144(iParam0)))
	{
		iVar0 = func_146(iParam0);
		if (!PERSCHAR::_0x800DF3FC913355F3(iVar0))
		{
			DEBUG::_0x9A6C65DDDBEC9C52(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character with no perschar index", func_143(iParam0));
			return;
		}
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being retasked ", func_143(iParam0));
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being destroyed on release ", func_143(iParam0));
		func_138(iParam0, 0);
	}
}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 139, "CLEAR_ALL_SHOP_TYPE_FLAGS: ", func_98(iParam0));
...
void func_196(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_201(iParam1), " on ", func_143(iParam0));
}
...
void func_197(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar0, false))
		{
			...
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_143(iParam0), " set as no longer needed.");
		}
		else
		{
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_143(iParam0), " was asked to be set as no longer needed, but this script does not own the ped.");
		}
	}
...
bool func_202(struct<2> Param0, int iParam2, int iParam3)
{
	int iVar0;
...
bool func_203(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_242(&(Global_1102630.f_4), iVar0, 5);
	}
	if (iParam1 == func_243())
	{
		return func_242(&(Global_1102630.f_4), iVar0, 5);
	...
	{
		return func_242(&(Global_1100880[iParam1 /*53*/].f_4), iVar0, 5);
	}
...
bool func_220(int iParam0, char* sParam1, var uParam2)
{
	var uVar0;

	if (func_246(iParam0, sParam1, &uVar0))
	{
...
bool func_223()
{
	...
	if (!func_225(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_246(int iParam0, char* sParam1, bool bParam2)
{
	*bParam2 = Global_1139844.f_7;
	bParam2->f_2 = 1351168281;
	bParam2->f_3 = func_255(iParam0);
	bParam2->f_4 = sParam1;
...
void func_247(bool bParam0, int iParam1, var uParam2)
{
	var uVar0;
	...
	*uParam2 = iParam1;
	...
	{
		DEBUG::_0x83407B92D46F25C3(648, 84, "RETRIEVE_UNLOCK_DATA - Couldn't retrieve id at index ", uParam2->f_1, " of type ", func_256(iParam1, 0));
	}
	bParam0->f_2 = -2140901307;
...
int func_252(int iParam0)
{
	...
	DEBUG::_0xD9911C7B5F8CD69C(168, 139, "GET_SHOP_TYPE_FROM_SHOP - ", func_240(iParam0, 0), " undefined");
	return -1;
}
...
bool func_257(struct<2> Param0, bool bParam2)
{
	if (!func_225(Param0))
	{
		return false;
