...
void __EntryFunction__()
{
	...
	{
		DEBUG::_0xF0783374333FD8CE(8, 193, "Respond Parcel Item: HAS_FORCE_CLEANUP_OCCURRED");
		func_1(&Var1, 3);
	}
	...
	while (true)
	{
		...
		switch (func_3(&Var1))
		{
			...
			case 2:
				...
				{
					DEBUG::_0xF0783374333FD8CE(8, 193, "Respond Parcel Item: Positive reply composed!");
					func_8(&Var1, 1);
				}
				else if (func_7(Var1.f_3[1], 1))
				{
					DEBUG::_0xF0783374333FD8CE(8, 193, "Respond Parcel Item: Negative reply composed!");
					func_8(&Var1, 0);
				}
				if (Global_1940463.f_11700 != 1061777683 || Global_1940463.f_11701 != iVar0)
				{
					func_1(&Var1, 3);
				}
				break;
...
{
	DEBUG::_0xF0783374333FD8CE(680, 193, "SET_RESP_PARCEL_STATE: moving from ", func_10(func_3(uParam0)), " to ", func_10(iParam1));
	*uParam0 = iParam1;
}
...
void func_4(var uParam0)
{
	...
	{
		if (func_11(uParam0->f_3[iVar0]))
		{
			func_12(&(uParam0->f_3[iVar0]), 1, 1);
		}
		iVar0++;
	}
}
...
void func_6(var uParam0)
{
	...
	{
		DEBUG::_0xD9911C7B5F8CD69C(8, 193, "RESP_PARCEL_SETUP_USE_CONTEXTS: Setup was called with an invalid Tracked Parcel value!");
		return;
	}
	if (!DATAFILE::_0x603AC35FD4602C76(uParam0->f_2))
	{
		DEBUG::_0xD9911C7B5F8CD69C(8, 193, "RESP_PARCEL_SETUP_USE_CONTEXTS: Cannot setup contexts without loading the Post Office XML!");
		return;
	}
	if (func_15(uParam0->f_1))
	{
		DEBUG::_0xF0783374333FD8CE(8, 193, "RESP_PARCEL_SETUP_USE_CONTEXTS: We already replied to this message!");
		return;
	}
	iVar0 = func_16(uParam0->f_1, uParam0->f_2);
	iVar1 = func_17(uParam0->f_1, uParam0->f_2);
	if (iVar0 > 0)
	{
		uParam0->f_3[0] = func_18("IB_POS_RESP", joaat("INPUT_INTERACT_LOCKON_POS"), Global_33, 1, 0, 0, 1, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
	}
	if (iVar1 > 0)
	{
		uParam0->f_3[1] = func_18("IB_NEG_RESP", joaat("INPUT_INTERACT_LOCKON_NEG"), Global_33, 1, 0, 0, 1, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
	}
}
...
void func_8(var uParam0, bool bParam1)
{
	...
	if (!func_14(uParam0->f_1))
	{
		DEBUG::_0xD9911C7B5F8CD69C(8, 193, "RESP_PARCEL_COMPOSE_REPLY: Attempted to reply to an invalid Tracked Parcel value!");
		return;
	}
	if (!DATAFILE::_0x603AC35FD4602C76(uParam0->f_2))
	{
		DEBUG::_0xD9911C7B5F8CD69C(8, 193, "RESP_PARCEL_COMPOSE_REPLY: Cannot reply without loading the Post Office XML!");
		return;
	}
	if (bParam1)
	{
	...
	iVar1 = func_20(uParam0->f_1);
	if (iVar1 == -1)
	{
		DEBUG::_0xD9911C7B5F8CD69C(8, 193, "RESP_PARCEL_COMPOSE_REPLY: An attempt was made to reply to an unknown tracked parcel.");
		return;
	}
	func_21(&(Global_38.f_4726[iVar1 /*6*/]), iVar0);
	func_22(uParam0->f_1, uParam0->f_2, bParam1);
	func_4(uParam0);
}
...
char* func_10(int iParam0)
{
	...
	{
		case 0:
			return "RESP_PARCEL_STATE_PENDING_INIT";
		case 1:
			return "RESP_PARCEL_STATE_SETUP";
		case 2:
			return "RESP_PARCEL_STATE_UPDATE";
		case 3:
			return "RESP_PARCEL_STATE_CLEANUP";
	}
	return "RESP_PARCEL_STATE_INVALID";
}
...
bool func_15(int iParam0)
{
	...
	if (!func_14(iParam0))
	{
		DEBUG::_0xD9911C7B5F8CD69C(8, 193, "HAS_TRACKED_PARCEL_BEEN_REPLIED_TO: Attempted to check the reply status of an invalid tracked parcel!");
		return false;
	}
	iVar0 = func_20(iParam0);
	if (iVar0 == -1)
	{
		DEBUG::_0xD9911C7B5F8CD69C(8, 193, "HAS_TRACKED_PARCEL_BEEN_REPLIED_TO: Attempted to check the reply status of a tracked parcel that doesn't exist!");
		return false;
	}
	return (func_24(&(Global_38.f_4726[iVar0 /*6*/]), 1) || func_24(&(Global_38.f_4726[iVar0 /*6*/]), 2));
}
...
int func_16(int iParam0, var uParam1)
{
	...
	if (!func_14(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(8, 193, "PO_XML_RETRIEVE_TRACKED_PARCEL_POS_ITEM_COUNT: Attempted to retrieve the positive item count of an invalid tracked parcel!");
		return 0;
	}
	Var0 = uParam1;
	Var0.f_2 = 396654621;
...
int func_17(int iParam0, var uParam1)
{
	...
	if (!func_14(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(8, 193, "PO_XML_RETRIEVE_TRACKED_PARCEL_NEG_ITEM_COUNT: Attempted to retrieve the negative item count of an invalid tracked parcel!");
		return 0;
	}
	Var0 = uParam1;
	Var0.f_2 = 1450050975;
...
int func_18(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, char* sParam9, bool bParam10, int iParam11, bool bParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 60)
	{
		if (func_25(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_26(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, sParam9, bParam10, iParam11, bParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
...
int func_20(int iParam0)
{
	...
	if (!func_14(iParam0))
	{
		DEBUG::_0xD9911C7B5F8CD69C(8, 193, "GET_TRACKED_PARCEL_INDEX: Attempted to retrieve the index of an invalid tracked parcel!");
		return iVar0;
	}
	iVar1 = 0;
	while (iVar1 < 180)
	{
		if (Global_38.f_4726[iVar1 /*6*/] == iParam0)
		{
			iVar0 = iVar1;
		}
		else
...
void func_22(int iParam0, var uParam1, bool bParam2)
{
	...
	if (!func_14(iParam0))
	{
		DEBUG::_0xD9911C7B5F8CD69C(8, 193, "PO_XML_PROCESS_TRACKED_PARCEL_REPLY: Attempted to process the sending of an invalid tracked parcel!");
		return;
	}
	if (bParam2)
	{
	...
	while (iVar1 < iVar0)
	{
		if (bParam2)
		{
			func_27(iParam0, iVar1, uParam1, &bVar2, &sVar3);
		}
		else
		{
			func_28(iParam0, iVar1, uParam1, &bVar2, &sVar3);
		}
		func_29(bVar2, sVar3, 0, 0, 0, 752097756, 0, 0, 0, 0);
		iVar1++;
	}
	if (func_30())
	{
...
void func_26(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, vector3 vParam6, float fParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, bool bParam16, int iParam17, bool bParam18, int iParam19, int iParam20, int iParam21, bool bParam22, int iParam23, int iParam24, bool bParam25)
{
	int iVar0;
	...
	func_34(iParam0, 1);
	func_35(iParam0, 128);
	DEBUG::_0xA308F935BDECCEC0(680, 145, "USE_CONTEXT_CREATE_PROMPT ", sParam2, " mode ", func_36(iParam14, 0));
}

int func_27(int iParam0, char* sParam1, var uParam2, int iParam3, int iParam4)
{
	struct<5> Var0;

	if (!func_14(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(8, 193, "PO_XML_RETRIEVE_POS_REP_ITEM_VALUE: Attempted to retrieve the item value of an invalid tracked parcel!");
		return 0;
	}
	Var0 = uParam2;
	Var0.f_2 = -122991295;
	...
	{
		DEBUG::_0xA308F935BDECCEC0(136, 193, "PO_XML_RETRIEVE_POS_REP_ITEM_VALUE: couldn't find data for ", iParam0, " at index ", sParam1);
		return 0;
	}
	return 1;
}

int func_28(int iParam0, char* sParam1, var uParam2, int iParam3, int iParam4)
{
	struct<5> Var0;

	if (!func_14(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(8, 193, "PO_XML_RETRIEVE_NEG_REP_ITEM_VALUE: Attempted to retrieve the item value of an invalid tracked parcel!");
		return 0;
	}
	Var0 = uParam2;
	Var0.f_2 = -1902296053;
	...
	{
		DEBUG::_0xA308F935BDECCEC0(136, 193, "PO_XML_RETRIEVE_NEG_REP_ITEM_VALUE: couldn't find data for ", iParam0, " at index ", sParam1);
		return 0;
	}
	return 1;
}

int func_29(bool bParam0, char* sParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (!func_39(bParam0, sParam1, bParam2, iParam5))
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 157, "ADD_PLAYER_SATCHEL_ITEM: __ADD_SATCHEL_ITEM_EXCEPTION_CHECKS: False");
		return 0;
	}
	if (!func_40(bParam0, &bVar0, sParam1))
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 157, "ADD_PLAYER_SATCHEL_ITEM: __ADD_SATCHEL_ITEM_ADJUST_COUNT: False");
		return 0;
	}
	func_41(bParam0, bParam2);
	bVar2 = false;
	if (func_42(bParam0) == joaat("CLOTHING"))
	{
		if (!func_43(bParam0, 866047851) && !func_43(bParam0, -1979000645))
		{
			bVar3 = true;
		}
	}
	if (func_44(bParam0, 8388608) && !func_45(27))
	{
	...
	if (!bVar3)
	{
		if (func_43(bParam0, -1588156645))
		{
			bParam2 = true;
			bVar4 = true;
			DEBUG::_0xA308F935BDECCEC0(40, 147, "ADD_PLAYER_SATCHEL_ITEM: Trying to add thrown weapon- ", HUD::_GET_LABEL_TEXT_BY_HASH(func_48(bParam0, 0)));
			bVar1 = func_50(func_49(bParam0, 1), 0);
			if (WEAPON::IS_WEAPON_VALID(bVar1))
			{
				...
				if (func_53(0) && func_54(bVar1, 0, 0, 1, 0, 0, iParam5, 0))
				{
					func_55(bParam0, bVar0, iParam5);
					if (!bParam9)
					{
						bParam2 = false;
					}
				...
				{
					func_56(bParam0, bVar0, iParam5);
				}
			}
		}
		else if (func_42(bParam0) == joaat("WEAPON"))
		{
			if (!func_57(bParam0, iParam5, &bParam2, bParam3, bParam4))
			{
				bParam2 = true;
			}
			bVar4 = true;
		}
		else if (func_42(bParam0) == joaat("AMMO") && func_58(bParam0))
		{
			if (!func_59(bParam0, &bVar0, iParam5))
			{
				bParam2 = true;
			}
			bVar4 = true;
		}
		else if (func_43(bParam0, -103750053))
		{
			DEBUG::_0x4DC69742196F818A(8, 157, "ADD_PLAYER_SATCHEL_ITEM - claw");
			func_61(func_60(joaat("CLAWS_COLLECTED")), bVar0);
		}
		else if (bParam0 == joaat("PROVISION_ALLIGATOR_TOOTH"))
		{
			func_61(func_62(joaat("COLLECTED"), joaat("ALLIGATOR_TOOTH")), bVar0);
		}
		else if (func_43(bParam0, -121341956) && !func_43(bParam0, 606799272))
		{
			...
			if (func_43(bParam0, -2017733358) || func_43(bParam0, -1369131378))
			{
			}
		}
		else if (func_43(bParam0, -136654233))
		{
			if (func_43(bParam0, -1021472396))
			{
		...
		else if (func_43(bParam0, -1466706512) && func_43(bParam0, 1147021565))
		{
			DEBUG::_0x4DC69742196F818A(8, 157, "ADD_PLAYER_SATCHEL_ITEM - used consumable");
			func_63(519, 0);
		}
		else if (func_43(bParam0, 1147021565) && func_43(bParam0, -524514947))
		{
			DEBUG::_0x4DC69742196F818A(8, 157, "ADD_PLAYER_SATCHEL_ITEM - snacks");
		}
		else if (func_43(bParam0, 554195525))
		{
			DEBUG::_0x4DC69742196F818A(8, 157, "ADD_PLAYER_SATCHEL_ITEM - candy");
		}
		else if (func_43(bParam0, 589988438))
		{
			if (func_64())
			{
				DEBUG::_0xA308F935BDECCEC0(8, 147, "POSTER LOGIC IF CHECK IS PASSING");
				func_65(joaat("REWARD_SMALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
		else if (func_43(bParam0, 787083290) && func_43(bParam0, 949916894))
		{
			DEBUG::_0xF0783374333FD8CE(40, 215, "CI_TAG_ITEM_LETTER_INVITATION: eItemToAdd = ", func_37(bParam0, 0));
			func_66(bParam0);
		}
		else if (func_43(bParam0, -1718133314))
		{
			func_67(bParam0);
		}
		else if (func_43(bParam0, -1738650224))
		{
			func_68(bParam0);
		}
		else if (func_43(bParam0, -1112814642) && func_43(bParam0, 949916894))
		{
			func_69(bParam0);
		}
		...
		else if (func_43(bParam0, 1841149704))
		{
			DEBUG::_0xF0783374333FD8CE(40, 215, "CI_TAG_ITEM_TREASURE_HUNTER_MAP: eItemToAdd = ", func_37(bParam0, 0));
			func_70();
		}
		else if (func_43(bParam0, -1979000645))
		{
		}
		else if (func_43(bParam0, 606799272))
		{
		}
		else if (func_43(bParam0, -1112814642) && func_43(bParam0, -1697809989))
		{
		}
		else if (func_43(bParam0, -2017733358) || func_43(bParam0, -1369131378))
		{
		}
		else if (func_43(bParam0, -1921346699))
		{
			DEBUG::_0xD9911C7B5F8CD69C(8, 158, "ADD_PLAYER_SATCHEL_ITEM - Cannot add MONEY items in MP, aborting!");
			return 0;
		}
		else if (func_43(bParam0, 1192444843))
		{
			switch (bParam0)
			{
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_LAKE"):
					if (!func_71(215778062 /* GXTEntry: "Special Lake Lure Handbill" */, 1))
					{
						func_29(215778062 /* GXTEntry: "Special Lake Lure Handbill" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_RIVER"):
					if (!func_71(670273567 /* GXTEntry: "Special River Lure Handbill" */, 1))
					{
						func_29(670273567 /* GXTEntry: "Special River Lure Handbill" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_SWAMP"):
					if (!func_71(-967317137 /* GXTEntry: "Special Swamp Lure Handbill" */, 1))
					{
						func_29(-967317137 /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_LAKE"):
					if (!func_71(526074061 /* GXTEntry: "Lake Lure Handbill" */, 1))
					{
						func_29(526074061 /* GXTEntry: "Lake Lure Handbill" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_RIVER"):
					if (!func_71(-1045488665 /* GXTEntry: "River Lure Handbill" */, 1))
					{
						func_29(-1045488665 /* GXTEntry: "River Lure Handbill" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_SWAMP"):
					if (!func_71(471514780 /* GXTEntry: "Swamp Lure Handbill" */, 1))
					{
						func_29(471514780 /* GXTEntry: "Swamp Lure Handbill" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					}
					break;
			}
		}
		else if (func_43(bParam0, -839724752) && func_44(bParam0, 4))
		{
		}
		else if (func_43(bParam0, 1399091007))
		{
			func_72(bParam0, &bVar2);
			bParam2 = true;
			bVar4 = true;
		}
		switch (bParam0)
		{
			...
			case joaat("CONSUMABLE_AGED_PIRATE_RUM"):
				func_73(272, func_48(joaat("CONSUMABLE_AGED_PIRATE_RUM"), 0), 0);
				break;
			case joaat("CONSUMABLE_GINSENG_ELIXIER"):
				func_73(270, func_48(joaat("CONSUMABLE_GINSENG_ELIXIER"), 0), 0);
				break;
			case joaat("CONSUMABLE_VALERIAN_ROOT"):
				func_73(271, func_48(joaat("CONSUMABLE_VALERIAN_ROOT"), 0), 0);
				break;
			...
			case joaat("CONSUMABLE_MOONSHINE"):
				...
				{
					func_74(685, 1934060482 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Health Bar." */, 1, 1);
			...
			case joaat("CONSUMABLE_RESTORATIVE"):
				if (MISC::GET_GAME_TIMER() >= (Global_1940463.f_11711 + 60000))
				{
					func_74(685, 1110018439 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Stamina Bar." */, 1, 1);
			...
			case joaat("CONSUMABLE_CHEWING_TOBACCO_USED"):
				if (MISC::GET_GAME_TIMER() >= (Global_1940463.f_11711 + 60000))
				{
					func_74(685, 1408511260 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Dead Eye Bar." */, 1, 1);
			...
			case joaat("CONSUMABLE_POTENT_TONIC"):
				if (MISC::GET_GAME_TIMER() >= (Global_1940463.f_11711 + 60000))
				{
					func_74(685, -1228016946 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    ...
    "d Eye Bars." */, 1, 1);
			...
			case 1955751248: /* GXTEntry: "Roast Beef" */
				if (MISC::GET_GAME_TIMER() >= (Global_1940463.f_11711 + 60000))
				{
					func_74(686, -103579 /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
    "for a short period of time. This Provision will Fortify your Health Core." */, 1, 1);
			...
			case -399865011: /* GXTEntry: "Regional Beef and Eggs Stew" */
				if (MISC::GET_GAME_TIMER() >= (Global_1940463.f_11711 + 60000))
				{
					func_74(686, -1531530025 /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
	...
	if (!bVar4)
	{
		...
		if (!func_56(bVar5, bVar0, iParam5))
		{
	...
	else if (bVar2 != 0)
	{
		if (func_53(0) && !func_77())
		{
			...
			while (iVar29 < Var6)
			{
				func_29(Var6.f_1[iVar29], Var6.f_12[iVar29], 0, 0, 0, -897553835, 0, 0, 0, 0);
				DEBUG::_0xA308F935BDECCEC0(40, 147, "Item: ", HUD::_GET_LABEL_TEXT_BY_HASH(func_48(Var6.f_1[iVar29], 0)));
	...
	if (fParam6 > 0f)
	{
		...
		if (func_43(bParam0, -839724752))
		{
			func_81(bParam0, fParam6);
		}
		else
		{
	...
	else if (!bParam2)
	{
		...
		func_82(bParam0, bVar0, 0, bVar32, 0, 0, 0);
	}
	return 1;
}
...
void func_33(int iParam0, bool bParam1)
{
	if (HUD::_UIPROMPT_IS_VALID(Global_1952230[iParam0 /*23*/].f_3))
	{
		if (Global_1952230[iParam0 /*23*/].f_5 == 5 && !func_25(iParam0, 8))
		{
...
bool func_39(bool bParam0, int iParam1, bool bParam2, int iParam3)
{
	if (func_51() == -1)
	{
		DEBUG::_0xF0783374333FD8CE(2216, 157, "__ADD_SATCHEL_ITEM_EXCEPTION_CHECKS: ADDING ", HUD::_GET_LABEL_TEXT_BY_HASH(func_48(bParam0, 0)), "; DOES_PLAYER_HAVE_ITEM_IN_SATCHEL = ", func_71(bParam0, 1), ", CHECK_ITEM_DATA_ITEM_FLAG = ", func_44(bParam0, 1048576));
		if (func_86(bParam0) && func_87(bParam0))
		{
			DEBUG::_0xF0783374333FD8CE(8, 157, "__ADD_SATCHEL_ITEM_EXCEPTION_CHECKS: Can't add this item as it has a purchase limit...");
			func_88(bParam0, iParam1, 1, &bParam2, iParam3);
			return false;
		}
	}
...
bool func_40(bool bParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	int iVar5;
	int iVar6;
	...
	*bParam1 = iParam2;
	func_89(bParam0, bParam1);
	Var0 = { func_90(bParam0, 0, 1) };
	iVar5 = func_91(bParam0, &Var0, 0, 0);
	iVar6 = func_92(bParam0, 0, 0, 0);
	if (iVar5 > 1 && (iVar6 + iParam2) >= iVar5)
	{
		DEBUG::_0xF0783374333FD8CE(8, 157, "__ADD_SATCHEL_ITEM_ADJUST_COUNT - tutorial should run now....");
		if (func_43(bParam0, -2051813666))
		{
			func_63(674, 1);
		}
		else if (func_51() == -1)
	...
	if (func_93(bParam0, &Var0, *bParam1, 0, 0, -1, 0))
	{
		if (iVar6 < iVar5)
		{
			*bParam1 = (iVar5 - iVar6);
...
void func_41(bool bParam0, bool bParam1)
{
	...
	switch (func_95(bParam0, -949239683))
	{
		case -1565009253:
		case -1420737577:
		case -1273369295:
...
bool func_43(bool bParam0, bool bParam1)
{
	if (!func_38(bParam0, 0))
	{
		return func_97(func_96(bParam0), bParam1);
	}
	if (bParam1 == 0)
	{
		return false;
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[ITEM_HAS_PROPERTY_TAG] Found tag ", func_98(bParam1, 0), " for item ", func_37(bParam0, 0), ", returning TRUE");
		return true;
	}
	return false;
}
...
{
	if (func_43(bParam0, -1522723129))
	{
		func_103(-848633709, 0, 255, 0, 0);
	}
	else if (func_43(bParam0, -283942357))
	{
		func_103(-981153234, 0, 255, 0, 0);
	}
	else if (func_43(bParam0, 683680997))
	{
		func_103(-756350192, 0, 255, 0, 0);
	}
	else if (func_43(bParam0, 1307628809))
	{
		func_103(603094518, 0, 255, 0, 0);
	}
}
...
bool func_48(bool bParam0, bool bParam1)
{
	...
	iVar0 = func_104(bParam0, bParam1);
	if (iVar0 != 0)
	{
		return iVar0;
	}
...
bool func_49(bool bParam0, bool bParam1)
{
	...
	if (func_38(bVar0, 0))
	{
		if (bParam1)
		{
			if (func_105(bVar0) || func_106(bVar0))
			{
				return bVar0;
			}
		}
...
bool func_53(bool bParam0)
{
	...
	return INVENTORY::_INVENTORY_ARE_LOCAL_CHANGES_ALLOWED(func_108(bParam0));
}

bool func_54(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<4> Var27;
	...
	DEBUG::_0xF0783374333FD8CE(34984, 157, "[ADD_WEAPON_TO_PLAYER_INVENTORY] - ", func_37(bParam0, 0), ", iAmmoAmount = ", bParam1, ", bForceInHand = ", bParam2, ", bForceInHolster = ", bParam3);
	DEBUG::_0xF0783374333FD8CE(43176, 157, "  attachPoint = ", func_109(iParam4, 0), ", bAllowMultipleCopies = ", bParam5, ", eAddReason = ", func_110(iParam6, 0), ", bIgnoreUnlocks = ", bParam7);
	...
	{
		Var0 = { func_90(bParam0, 0, 1) };
		if (func_111(bParam0, &Var0, Var0.f_4, 0, 0))
		{
			Var5.f_9 = -1591664384;
			if (func_112(bParam0, &Var5, Var0.f_4))
			{
				DEBUG::_0xF0783374333FD8CE(680, 157, "[ADD_WEAPON_TO_PLAYER_INVENTORY] We have removed 'worn' ", func_37(bParam0, 0), " from ", func_113(Var0.f_4, 0));
				Var27 = { func_114(bParam0, Var0, Var0.f_4, 0) };
				func_115(bParam0, &Var27, &Var0, 1, -142743235, 1, 0);
			}
		}
	}
	if (func_53(0))
	{
		...
		func_55(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), bParam1, iParam6);
...
bool func_55(bool bParam0, bool bParam1, int iParam2)
{
	...
	DEBUG::_0xF0783374333FD8CE(648, 157, "[ADD_AMMO_TO_PLAYER_INVENTORY] - Ammo add for ", bParam1, "x ", func_37(bParam0, 0));
	return true;
}

int func_56(bool bParam0, bool bParam1, int iParam2)
{
	int iVar0;
	struct<5> Var1;
	struct<4> Var6;
	...
	if (bParam1 < 1)
	{
		DEBUG::_0xD9911C7B5F8CD69C(2696, 157, "ADD_ITEM_TO_PLAYER_INVENTORY - Attempting to add ", bParam1, " of ", func_37(bParam0, 0), ", must be a non-zero positive amount");
		return 0;
	}
	iVar0 = func_117(bParam0, joaat("DEFAULT"));
	if (iVar0 != 0)
	{
		return func_118(bParam0, bParam1, iParam2);
	}
	Var1 = { func_90(bParam0, 0, 1) };
	Var6 = { func_114(bParam0, Var1, Var1.f_4, 0) };
	return func_119(bParam0, &Var6, &Var1, bParam1, iParam2, 0);
}

bool func_57(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	var uVar1;
	bool bVar6;
	...
	if (WEAPON::IS_WEAPON_VALID(bVar0))
	{
		...
		if (!func_93(bParam0, &uVar1, 1, 0, 0, -1, 0))
		{
			func_88(bParam0, 1, 0, bParam2, iParam1);
			DEBUG::_0xF0783374333FD8CE(40, 157, "ADD_PLAYER_SATCHEL_ITEM: Trying to give weapon to player: ", func_121(bVar0));
			bVar6 = func_122(bVar0);
			if (WEAPON::_IS_WEAPON_SNIPER(bVar0))
			{
				func_54(bVar0, bVar6, bParam3, bParam4, 0, 0, iParam1, 0);
			}
			else if (bVar0 == joaat("WEAPON_FISHINGROD") || WEAPON::_IS_WEAPON_BINOCULARS(bVar0))
			{
				func_54(bVar0, 0, bParam3, bParam4, 0, 0, iParam1, 0);
			}
			else if (WEAPON::_IS_WEAPON_LASSO(bVar0))
			{
				func_54(bVar0, 1, bParam3, bParam4, 0, 0, iParam1, 0);
			}
			else if (WEAPON::_IS_WEAPON_MELEE(bVar0))
			{
				if (bVar0 == joaat("WEAPON_MELEE_KNIFE_JOHN") && !func_123())
				{
				...
				else if (!func_124(bVar0))
				{
					func_54(bVar0, 1, bParam3, bParam4, 0, 0, iParam1, 0);
				}
				else
				{
					func_54(bVar0, WEAPON::_GET_WEAPON_CLIP_SIZE(bVar0) * 4, bParam3, bParam4, 0, 0, iParam1, 0);
				}
			}
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(bVar0))
			{
				bVar7 = func_125(Global_33, 2, 0, 1);
				if ((((func_107(bVar7) && !Global_26681) && bVar7 != bVar0) && !func_71(joaat("UPGRADE_OFFHAND_HOLSTER"), 1)) && bParam4)
				{
				...
				if (func_107(bVar7) && func_71(joaat("UPGRADE_OFFHAND_HOLSTER"), 1))
				{
					if (!func_54(bVar0, bVar6, bParam3, bParam4, 3, 1, iParam1, 0))
					{
						return false;
					}
				...
				{
					if (!func_54(bVar0, bVar6, bParam3, bParam4, 0, 1, iParam1, 0))
					{
						return false;
					}
			...
			else if (!func_54(bVar0, bVar6, bParam3, bParam4, 0, 0, iParam1, 0))
			{
				return false;
			}
		}
		...
		{
			DEBUG::_0xF0783374333FD8CE(40, 157, "ADD_PLAYER_SATCHEL_ITEM: Player already has the maximum amount of weapon: ", func_121(bVar0));
		}
	}
	else
	{
		DEBUG::_0xF0783374333FD8CE(40, 157, "ADD_PLAYER_SATCHEL_ITEM: Trying to give an unhandled weapon to the player: ", func_121(bVar0));
		return false;
	}
...
int func_59(bool bParam0, bool bParam1, int iParam2)
{
	...
	{
		func_73(func_126(bParam0), func_48(bParam0, 0), 1);
		return 0;
	}
	...
	if (func_53(0))
	{
		if (func_55(bParam0, bVar0, iParam2))
		{
			*bParam1 = bVar0;
	...
	{
		return func_56(bParam0, *bParam1, iParam2);
	}
	return 0;
}
...
struct<2> func_62(int iParam0, int iParam1)
{
	struct<2> Var0;
...
void func_63(int iParam0, bool bParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(10376, 105, "TUTORIAL_MARK_RUN() - Tutorial with Set: ", iVar0, " & Flag", iVar1, " marked to run. ", func_130(iParam0));
...
int func_65(bool bParam0, bool bParam1, float fParam2, int iParam3, char* sParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
	...
	iVar0 = func_131(bParam0, bParam6, iParam7);
	if (!bParam1)
	{
		func_132(iVar0, sParam4, iParam5, 0);
	}
	func_133(iVar0, bParam1, fParam2, iParam3);
	return iVar0;
}
...
bool func_71(bool bParam0, int iParam1)
{
	...
	return func_136(bParam0, 0, 0, 0) >= iParam1;
}
...
void func_72(bool bParam0, bool bParam1)
{
	...
	func_137(bParam0, bParam1, &uVar0);
}
...
void func_73(int iParam0, bool bParam1, bool bParam2)
{
	...
	func_127(iParam0, &iVar0, &iVar1);
	if (!func_128(iParam0, iVar0, iVar1, bParam2))
	{
		return;
	}
...
void func_74(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	DEBUG::_0xF0783374333FD8CE(10376, 105, "TUTORIAL_MARK_RUN_WITH_NUMBER - Tutorial with Set: ", iVar0, " & Flag", iVar1, " marked to run. ", func_130(iParam0));
}
...
int func_78(bool bParam0, int iParam1)
{
	...
	Var4.f_1 = 10;
	func_139(&Var4, joaat("LOOT_TYPE_NORMAL"));
	return func_140(bParam0, &Var4, &iVar0, iParam1, 0);
}

struct<2> func_79(bool bParam0)
{
	struct<2> Var0;
	struct<2> Var2;
	...
	if (func_43(bParam0, -305066475))
	{
		if (func_51() == -1)
		{
			if (func_43(bParam0, -537818634))
			{
				return func_141(joaat("MEDICINE_AND_DEADEYE_ITEMS"));
			}
			else
			{
				return func_141(joaat("DEADEYE_ITEMS"));
			}
		}
	}
	else if (func_43(bParam0, -537818634))
	{
		return func_141(joaat("MEDICINE_ITEMS"));
	}
	if (func_43(bParam0, 2084895747))
	{
		return func_141(joaat("LOCK_BREAKER_ITEMS"));
	}
	return Var2;
}
...
void func_81(bool bParam0, char* sParam1)
{
	char* sVar0;

	sVar0 = func_142(Global_1903123.f_37);
	func_144(MISC::_CREATE_VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_143(bParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}

void func_82(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	int iVar1;
	char cVar2[32];
	...
	if (!func_145() || bParam6)
	{
		func_146(bParam0, bParam1, bParam2, bParam4, bParam3, bParam5);
		return;
	}
	bVar0 = false;
	iVar1 = MISC::ABSI(bParam1);
	StringCopy(&cVar2, func_147(iVar1 == 1, "ITEM_GET_PUMP", "ITEM_GET_PUMP_MULT"), 32);
	...
	else if (bParam2 && func_44(bParam0, 2097152))
	{
	...
	if ((((((((iVar6 == joaat("AMMO") && bParam0 != joaat("AMMO_HATCHET")) && bParam0 != joaat("AMMO_HATCHET_CLEAVER")) && bParam0 != joaat("AMMO_HATCHET_HUNTER")) && bParam0 != joaat("AMMO_TOMAHAWK_ANCIENT")) && bParam0 != joaat("AMMO_POISONBOTTLE")) && bParam0 != joaat("AMMO_MOONSHINEJUG_MP")) && !func_43(bParam0, -1982291600)) && !func_43(bParam0, 137764179))
	{
		iVar10 = joaat("AMMO_TYPES");
		iVar11 = joaat("AMMO_TYPES");
	}
	iVar12 = func_148(bParam0);
	...
	else if (!func_149(bParam0, &Var7, iVar11, iVar10, 0, joaat("UI_ITEMVIEWER")))
	{
		Var7 = "_PLACEHOLDER";
	...
	if (func_43(bParam0, 474910316))
	{
		sVar17 = func_150(bParam0);
	...
	bVar18 = func_48(bParam0, 0);
	if ((func_152(iVar12) && func_43(bParam0, -306684263)) && bVar18 != 0)
	{
		bVar18 = func_153(bParam0);
	}
	else if (func_42(bParam0) == joaat("CLOTHING"))
	{
		bVar19 = func_154(bParam0);
		if (func_38(bVar19, 0))
		{
			bVar18 = func_48(bVar19, 0);
		}
	...
	if (func_155(bParam0, 1443104131) && bParam3)
	{
		iVar20 = 1;
		func_156(bParam0, -915411861, &iVar20, 0);
	...
	sVar21 = func_157(MISC::_CREATE_VAR_STRING(10, &cVar2, MISC::_CREATE_VAR_STRING(0, bVar18), iVar1), iVar13);
	if (bParam1 == 1)
	{
	...
	{
		sVar21 = MISC::_CREATE_VAR_STRING(0, func_158(bParam0, -442898163));
	}
	if (iVar12 == -126813555 || iVar12 == 1946043663)
	{
		StringCopy(&cVar22, "", 128);
		if (func_159(bParam0, &cVar22))
		{
			sVar21 = func_161(func_160(cVar22), joaat("COLOR_PURE_WHITE"));
		}
	}
	DEBUG::_0xF0783374333FD8CE(174760, 158, "ADD_QUEUED_ITEM_DISPLAY: Adding - ", func_37(bParam0, 0), " with color ", func_162(iVar13, 0), " sound ", sVar14, " set ", sVar15);
	func_144(sVar21, Var7.f_1, MISC::GET_HASH_KEY(Var7), iVar16, iVar13, sVar15, sVar14, 0, 1);
}

bool func_83()
{
	if ((Global_1940463.f_11709 != (Global_1940463.f_41.f_203 - 1) || func_164(func_163(0), Global_1940463.f_11701, 0, 1, 1) > 0) || Global_1940463.f_11709 == 15)
	{
		return true;
	}
	func_165(0);
...
{
	return func_42(bParam0) == joaat("WEAPON");
}
...
bool func_87(bool bParam0)
{
	...
	if (func_44(bParam0, 1048576))
	{
		return false;
	}
	if (WEAPON::IS_WEAPON_VALID(bParam0))
	{
		return func_93(bParam0, &uVar0, 1, 0, 0, -1, 0);
	}
	return func_71(bParam0, 1);
}

void func_88(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	bool bVar0;

	if (func_42(bParam0) != joaat("WEAPON"))
	{
		return;
	}
	bVar0 = func_50(bParam0, 0);
	...
	if (bParam2 || !func_106(bVar0))
	{
		if (bParam2 || (!WEAPON::HAS_PED_GOT_WEAPON(Global_33, bVar0, 0, false) && func_136(bParam0, 0, 0, 0) == 0))
		{
			if (func_51() == -1)
			{
			...
			if (!*bParam3 && !iParam4 == 1248274121)
			{
				...
				func_82(bParam0, bParam1, 0, 0, 0, 0, 0);
...
{
	if (func_43(bParam0, 58855631))
	{
		func_156(bParam0, -915411861, bParam1, 1);
		DEBUG::_0xF0783374333FD8CE(8, 157, "__ADD_SATCHEL_ITEM_CONVERT_ADD_AMOUNT_TO_USES adding uses = ", *bParam1);
	}
}

struct<5> func_90(bool bParam0, bool bParam1, bool bParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 157, "PLAYER_INVENTORY_GET_DEFAULT_ITEM_SLOT_INFO - eInvItemGroup = ", func_167(iVar5, 0));
	switch (iVar5)
	{
		case joaat("CLOTHING"):
			Var0 = { func_114(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
			Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, joaat("WARDROBE"));
			break;
		case joaat("WEAPON"):
			Var0 = { func_168(bParam1) };
			if (bParam2 && func_169(bParam0, 1))
			{
				Var6.f_9 = -1591664384;
				if (!func_111(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_111(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_112(bParam0, &Var6, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
		case joaat("DOG"):
			if (func_171(bParam0, -1823706425))
			{
				Var0 = { func_114(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, joaat("KIT_CAMP"));
			}
			else if (func_171(bParam0, -1483207246))
			{
				Var0 = { func_114(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, joaat("WARDROBE"));
			}
			...
			else if (func_171(bParam0, -1653629781))
			{
				Var0 = { func_114(1384535894, Var0, 1784584921, bParam1) };
	...
	DEBUG::_0xA308F935BDECCEC0(10920, 157, "PLAYER_INVENTORY_GET_DEFAULT_ITEM_SLOT_INFO - ", func_37(bParam0, 0), ": ", func_113(Var0.f_4, 0), " - ", UNK_0xD2E4270E5D98EEE4(&Var0));
	return Var0;
}

int func_91(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
	if (!func_38(bParam0, 0))
	{
		...
		if (func_173(func_96(bParam0), 2))
		{
			return -1;
		}
		return 0;
	}
	if (func_42(bParam0) == joaat("FEE"))
	{
		return -1;
	}
	DEBUG::_0x1B08D1EB9D8C4931(567976, 157, "PLAYER_INVENTORY_GET_ITEM_MAX_COUNT - eInventoryItem: ", func_37(bParam0, 0), " sParentGUID: ", UNK_0xD2E4270E5D98EEE4(iParam1), " eSlot: ", func_113(iParam1->f_4, 0), " bCurrentSlotOnly: ", bParam2, " bPlayerOnly: ", bParam3);
	if (!bParam2 && func_117(bParam0, joaat("DEFAULT")) == 0)
	{
	...
	return INVENTORY::_0xADDD1E7C0ECF7D95(func_108(bParam3), bParam0);
}

int func_92(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (func_58(bParam0) && !bParam2)
	{
		return WEAPON::GET_PED_AMMO_BY_TYPE(Global_33, bParam0);
	}
	return INVENTORY::_0xE787F05DFC977BDE(func_108(bParam1), bParam0, bParam3);
}

bool func_93(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
	struct<10> Var4;
	int iVar26;
	...
	func_174(&bParam0);
	if (!func_38(bParam0, 0) && !func_173(func_96(bParam0), 2))
	{
		DEBUG::_0x4DC69742196F818A(8, 157, "[PLAYER_INVENTORY_IS_ITEM_MAXED] Item is invalid - Failing!");
		return false;
	}
	if (!bParam3 && func_117(bParam0, joaat("DEFAULT")) == 0)
	{
	...
	if (func_86(bParam0) && WEAPON::_0x705BE297EEBDB95D(bParam0))
	{
		Var0 = { func_168(0) };
		Var4.f_9 = -1591664384;
		if (!func_111(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0, 0))
		...
		else if (func_112(bParam0, &Var4, 1728382685 /* GXTEntry: "Right" */))
		{
			return false;
		}
		if (func_169(bParam0, 1))
		{
			if (!func_111(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0, 0))
			{
				return false;
			}
			else if (func_112(bParam0, &Var4, -649335959 /* GXTEntry: "Left" */))
			{
				return false;
			}
		}
	...
	if (iParam5 < 0)
	{
		iVar26 = func_91(bParam0, iParam1, bParam3, bParam4);
	}
	if (iVar26 < 0)
	{
		return false;
	...
	iVar27 = func_175(bParam0, *iParam1, iParam1->f_4, bParam4, bParam3, bParam6);
...
bool func_94()
{
	if (((((!ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_33, -1) && !PED::IS_PED_USING_ANY_SCENARIO(Global_33)) && !func_176(Global_33, 1369124074)) && !func_176(Global_33, 713668775)) && !TASK::_0xEC7E480FF8BD0BED(Global_33)) && !PED::IS_PED_IN_ANY_VEHICLE(Global_33, false))
	{
		return true;
	}
	return false;
...
int func_97(bool bParam0, bool bParam1)
{
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[BUNDLE_HAS_PROPERTY_TAG] Found tag ", func_98(bParam1, 0), " for bundle ", func_177(bParam0, 0), ", returning TRUE");
		return 1;
	}
	return 0;
}

var func_98(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
void func_102(int iParam0)
{
	switch (iParam0)
	{
		...
		case 1:
			...
			DEBUG::_0xF0783374333FD8CE(40, 0, "Doing unlock: ", func_186(iParam0));
			break;
		case 2:
			if (func_187() && PLAYER::_IS_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2))
			{
				func_188("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_MANUAL_PAINT", joaat("HUD_TOASTS"), 1963346246, 8000, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			...
			break;
		case 3:
			if (func_187() && PLAYER::_IS_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3))
			{
				func_188("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_STAY_ACTIVE", joaat("HUD_TOASTS"), 1963346246, 8000, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			...
			break;
		case 4:
			if (func_187() && PLAYER::_IS_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 4))
			{
				func_188("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_FATAL", joaat("HUD_TOASTS"), 1963346246, 8000, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
			...
			break;
		case 5:
			if (func_187() && PLAYER::_IS_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 5))
			{
				func_188("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_CRITICAL", joaat("HUD_TOASTS"), 1963346246, 8000, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 47:
			...
			if (func_51() == -1)
			{
				if (!func_71(1013902307, 1))
				{
					func_56(1013902307, 1, 752097756);
				}
			}
			break;
		case 49:
			...
			if (func_51() == -1)
			{
				...
				if (!func_71(142640135, 1))
				{
					func_56(142640135, 1, 752097756);
				}
			}
			break;
		case 48:
			...
			if (func_51() == -1)
			{
				if (!func_71(786809402, 1))
				{
					func_56(786809402, 1, 752097756);
				}
			}
			break;
		case 50:
			...
			if (func_51() == -1)
			{
				...
				if (!func_71(-518019409, 1))
				{
					func_56(-518019409, 1, 752097756);
				}
			}
			break;
		case 22:
...
int func_103(bool bParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	struct<2> Var0;
	struct<2> Var12;
	int iVar25;
	...
	Var0.f_1 = 10;
	Var12.f_1 = 11;
	return func_189(bParam0, &iVar25, &Var12, &Var0, iParam1, iParam2, iParam3, bParam4);
}
...
{
	return func_175(bParam0, *uParam1, iParam2, bParam3, 1, bParam4) > 0;
}
...
bool func_112(bool bParam0, int iParam1, bool bParam2)
{
	...
	if (func_190(bParam0, &uVar0, iParam1, bParam2))
	{
...
var func_113(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
struct<4> func_114(bool bParam0, var uParam1, bool bParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_108(bParam6), &uParam1, bParam0, bParam5, &Var0);
	return Var0;
}

bool func_115(bool bParam0, int iParam1, var uParam2, bool bParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<14> Var0;
	int iVar14;
	struct<13> Var15;
	...
	Var0.f_9 = -1591664384;
	if (!func_172(*iParam1, &Var0, bParam6, 0, -1))
	{
	...
	if (!func_53(bParam6))
	{
		...
		else if (func_51() == 0)
		{
			...
			Var15.f_9 = bParam3;
			Var15.f_12 = iParam4;
			DEBUG::_0xF0783374333FD8CE(10888, 157, "PLAYER_INVENTORY_REMOVE_ITEM_WITH_GUID - Sending a Use transaction for ", bParam3, "x item ", func_37(bParam0, 0), " in ", func_113(uParam2->f_4, 0));
			iVar14 = func_192(joaat("USE"), &Var15, 1);
			if (iVar14 != -1)
			{
				Var32.f_7 = -142743235;
				Var32.f_16 = -1;
				Var32 = iParam5;
				Var32.f_7 = iParam4;
				func_193(iVar14, Var32);
			}
		}
		return iVar14 != -1;
	}
	DEBUG::_0x4DC69742196F818A(174728, 157, "PLAYER_INVENTORY_REMOVE_ITEM_WITH_GUID - Removing ", bParam3, "x item ", func_37(bParam0, 0), " in ", func_113(uParam2->f_4, 0), " with reason ", func_194(iParam4, 0));
	if (!INVENTORY::_0x3E4E811480B3AE79(func_108(bParam6), iParam1, bParam3, iParam4))
	{
...
void func_116(bool bParam0, bool bParam1)
{
	...
	{
		iVar2 = func_195(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), bParam1);
...
int func_118(bool bParam0, bool bParam1, int iParam2)
{
	...
	Var1 = { func_90(bParam0, 0, 0) };
	if (func_93(bParam0, &Var1, bParam1, 0, 0, -1, 0))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(2696, 157, "PLAYER_INVENTORY_ADD_ITEM_WITH_ITEMID - Cannot add ", bParam1, "x of item ", func_37(bParam0, 0), " as it would exceed max quantity, aborting!");
		return 0;
	}
	if (!func_53(0))
	{
		DEBUG::_0x83407B92D46F25C3(2696, 157, "PLAYER_INVENTORY_ADD_ITEM_WITH_ITEMID - Cannot directly add  ", bParam1, "x item ", func_37(bParam0, 0), " in MP, use awards instead!");
		UNK_0x355E72323AEE83CC(157, 1);
		return 0;
	}
	DEBUG::_0x4DC69742196F818A(174728, 157, "PLAYER_INVENTORY_ADD_ITEM_WITH_ITEMID - Adding ", bParam1, "x item ", func_37(bParam0, 0), " to ", func_113(Var1.f_4, 0), " with reason ", func_110(iParam2, 0));
	if (!INVENTORY::_0xCB5D11F9508A928D(func_108(0), &uVar6, &Var1, bParam0, Var1.f_4, bParam1, iParam2))
	{
...
int func_119(bool bParam0, var uParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	if (!func_38(bParam0, 0))
	{
	...
	if (func_93(bParam0, iParam2, bParam3, bParam5, 0, -1, 0))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(2696, 157, "PLAYER_INVENTORY_ADD_ITEM - Cannot add ", bParam3, "x of item ", func_37(bParam0, 0), " as it would exceed max quantity, aborting!");
		return 0;
	}
	if (!func_53(0))
	{
		DEBUG::_0x83407B92D46F25C3(2696, 157, "PLAYER_INVENTORY_ADD_ITEM_WITH_GUID - Cannot directly add  ", bParam3, "x item ", func_37(bParam0, 0), " in MP, use awards instead!");
		UNK_0x355E72323AEE83CC(157, 1);
		return 0;
	}
	DEBUG::_0x4DC69742196F818A(174728, 157, "PLAYER_INVENTORY_ADD_ITEM_WITH_GUID - Adding ", bParam3, "x item ", func_37(bParam0, 0), " to ", func_113(iParam2->f_4, 0), " with reason ", func_110(iParam4, 0));
	if (!INVENTORY::_0xCB5D11F9508A928D(func_108(0), uParam1, iParam2, bParam0, iParam2->f_4, bParam3, iParam4))
	{
...
void func_120(bool bParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(168, 0, "REGISTER_NEW_PLAYER_WEAPON - Flagging ", func_196(bParam0), " as temporarily new for the player!");
	DECORATOR::DECOR_SET_INT(Global_33, sVar0, bParam0);
	iVar2 = func_197();
	func_198(&iVar2, 0, 0, 0, 1, 0, 0, 0);
...
int func_122(bool bParam0)
{
	...
	if (func_199(bParam0))
	{
		...
		DEBUG::_0xF0783374333FD8CE(648, 157, "GET_AMMO_TO_ADD_FOR_WEAPON: going to give the bow this amount of ammo - ", iVar0, " for the weapon ", func_121(bParam0));
	}
	else if (WEAPON::_0x705BE297EEBDB95D(bParam0))
	{
		...
		DEBUG::_0xF0783374333FD8CE(648, 157, "GET_AMMO_TO_ADD_FOR_WEAPON: going to give the gun this amount of ammo - ", iVar0, " for the weapon ", func_121(bParam0));
	}
	return iVar0;
}
...
bool func_128(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_200(iParam1, iParam2))
	{
		if (!bParam3)
		{
			DEBUG::_0xA308F935BDECCEC0(168, 105, "TUTORIAL_CAN_GO_PENDING_CHECKS - Tutorial: ", func_130(iParam0), " has already run, and is not being forced.");
			return false;
		}
	}
	if (!func_201(iParam0))
	...
	if ((Global_1900777.f_67 && !func_138(iParam0, 1)) || func_204(32768))
	{
		if (!func_138(iParam0, 262144) || !Global_1904703.f_8785)
		{
...
int func_131(bool bParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1f;
	if (bParam1 && func_71(joaat("PROVISION_TRINKET_ELK_ANTLER"), 1))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
	...
	while (iVar24 < Var1)
	{
		...
		else
		{
			...
			if (func_38(bVar25, 0) && func_43(bVar25, -1921346699))
			{
				return BUILTIN::CEIL((IntToFloat(Var1.f_12[iVar24]) * fVar0));
			}
		}
...
void func_132(int iParam0, char* sParam1, int iParam2, bool bParam3)
{
	if (iParam0 == 0)
	{
		return;
	...
	if (MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
	{
		if (bParam3)
		{
			...
			func_206(iParam0, 1000);
			return;
		}
		sParam1 = "FEED_MONEY_EARN";
	}
	func_144(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}

void func_133(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	DEBUG::_0xF0783374333FD8CE(168, 0, "[SP-MONEY] Total: $", func_207(bParam0), ".");
	if (bParam1)
	{
		...
		bVar1 = (bVar1 + iVar2);
		func_144(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_TOTAL_EARN", bParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_TOTAL_TAKE"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		DEBUG::_0xF0783374333FD8CE(168, 0, "[SP-MONEY] Gang Savings: $", func_207(bVar0), ".");
		bParam0 = (bParam0 - bVar0);
		DEBUG::_0xF0783374333FD8CE(2216, 0, "[SP-MONEY] Remainder: $", func_207(bParam0), ". Split between ", iParam3, ", with player getting ", bVar1);
		if (bVar0 > 0)
		{
		}
		func_144(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_PLAYER_EARN", bVar1), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		bVar1 = bParam0;
	...
	if (bVar1 > 0)
	{
		DEBUG::_0xF0783374333FD8CE(40, 0, "[SP-MONEY] Player: $", func_207(bVar1));
		MONEY::_MONEY_INCREMENT_CASH_BALANCE(bVar1, 752097756);
		func_61(func_141(joaat("CAREER_CASH")), bVar1);
		DEBUG::_0xF0783374333FD8CE(43688, 0, "[inventory_playerbalance] Event: [EARN], Current Cash: [", UNK_0xAB3EA66D3B2C264A(), "], Value: [$", func_207(bVar1), "] Category:[", UNK_0x8F77B33B6A34D8BA(), "]");
	}
...
bool func_134(bool bParam0, int iParam1)
{
	...
	bVar0 = func_210(bParam0, iParam1);
	Var4.f_9 = -1591664384;
	if (func_211("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 150, "DOES_PLAYER_HAVE_WEAPON_THAT_REQUIRES_AMMO_ITEM: icollectsize ", iVar2);
		bVar3 = false;
		while (bVar3 < iVar2)
		{
			if (!func_212(&Var4, bVar3, iVar1, iVar2))
			{
...
bool func_135(bool bParam0)
{
	...
	if (!iVar1 == 0)
	{
		iVar2 = func_215(&(Global_17414.f_55.f_664.f_1354.f_5), iVar1);
		if (iVar2 == -1)
		{
...
int func_136(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		return func_217(bParam0, 0);
	}
	if (func_117(bParam0, joaat("DEFAULT")) != 0)
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_108(bParam2), bParam0, bParam3);
	}
	else
	{
		Var3 = { func_218(bParam0, bParam2) };
		...
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_108(bParam2), &Var3, bParam3);
	}
	DEBUG::_0x1B08D1EB9D8C4931(648, 157, "GET_PLAYER_SATCHEL_ITEM_COUNT - Found ", iVar0, " of item ", func_37(bParam0, 0));
	return iVar0;
}

void func_137(bool bParam0, bool bParam1, var uParam2)
{
	*bParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
int func_140(bool bParam0, var uParam1, int* iParam2, int iParam3, int iParam4)
{
	var uVar0;
	struct<15> Var1;
	...
	{
		DEBUG::_0xD9911C7B5F8CD69C(40, 84, "PERSONA_REQUEST_AWARD_LOOT - Failed to request loot award ", func_220(bParam0, 0));
		return 0;
	}
	Var1.f_3.f_1 = 10;
	Var1 = iParam3;
...
int func_143(bool bParam0)
{
	...
	if (!func_222(bParam0, &uVar0, joaat("INVENTORY"), 0, 0, joaat("UI_ITEMVIEWER")))
	{
...
var func_144(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, int iParam8)
{
	...
	func_223(sParam0, sParam1, iParam2);
	return uVar20;
}
...
void func_146(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	while (iVar0 < Global_1913655.f_3)
	{
		if ((((Global_1913655.f_4[iVar0 /*6*/] == bParam0 && Global_1913655.f_4[iVar0 /*6*/].f_2 == bParam2) && Global_1913655.f_4[iVar0 /*6*/].f_3 == iParam3) && Global_1913655.f_4[iVar0 /*6*/].f_4 == bParam4) && Global_1913655.f_4[iVar0 /*6*/].f_5 == bParam5)
		{
			...
			DEBUG::_0xF0783374333FD8CE(2696, 158, "ADD_ITEM_TO_DELAYED_QUEUE: Adding - ", bParam1, "x ", func_37(bParam0, 0), " to existing entry ", iVar0);
			return;
		}
		iVar0++;
	}
	...
	{
		DEBUG::_0xF0783374333FD8CE(2696, 158, "ADD_ITEM_TO_DELAYED_QUEUE: Adding - ", bParam1, "x ", func_37(bParam0, 0), " to new entry ", Global_1913655.f_3);
...
bool func_149(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 158, "FIND_INVENTORY_ITEM_TEXTURE_UI_DATA - eTextureType = ", func_224(iParam2, 0));
	...
	if (ITEMDATABASE::_ITEM_DATABASE_FILLOUT_UI_DATA(bParam0, &Var3))
	{
		...
		while (iVar0 < 5)
		{
			...
			else
			{
				...
				{
					DEBUG::_0x1B08D1EB9D8C4931(40, 158, "FIND_INVENTORY_ITEM_TEXTURE_UI_DATA: Skipping entry with type: ", func_224(Var3.f_2[iVar0 /*3*/].f_2, 0));
					Jump @476; //curOff = 261
				}
				...
				else
				{
					...
					DEBUG::_0x1B08D1EB9D8C4931(40, 158, "FIND_INVENTORY_ITEM_TEXTURE_UI_DATA:    Type: ", func_224(Var3.f_2[iVar0 /*3*/].f_2, 0));
	...
	DEBUG::_0x9A6C65DDDBEC9C52(680, 158, "FIND_INVENTORY_ITEM_TEXTURE_UI_DATA: Unable to find texture of type ", func_224(iParam2, 0), " for item ", func_37(bParam0, 0));
	return false;
}

char* func_150(bool bParam0)
{
	if (func_43(bParam0, -1995062316))
	{
		return "collectible_arrowheads";
	}
	if (func_43(bParam0, 1239889275))
	{
		return "collectible_liquor_bottles";
	}
	if (func_43(bParam0, 143267379))
	{
		return "collectible_coins";
	}
	if (func_43(bParam0, -944041124))
	{
		return "colectible_heirlooms";
	}
	if (func_43(bParam0, 1562621600))
	{
		return "collectible_jewelry";
	}
	if (func_43(bParam0, -149719013))
	{
		return "collectible_bird_eggs";
	}
	if (func_43(bParam0, 1940829793))
	{
		return "collectible_tarot_cards";
	}
	if (func_43(bParam0, 781094263))
	{
		return "collectible_flowers";
	}
	if (((func_43(bParam0, -352095726) || func_43(bParam0, -2014783736)) || func_43(bParam0, -545064757)) || func_43(bParam0, 679186220))
	{
...
{
	if (func_43(bParam0, -189374246))
	{
		if (((func_225(bParam0, -1305775593) || func_225(bParam0, 1384151091)) || func_225(bParam0, 2075388272)) || func_225(bParam0, -1738780413))
		{
			return true;
		}
	}
	if (func_43(bParam0, -753854379) || func_43(bParam0, 173360570))
	{
		return true;
	}
	return false;
...
bool func_154(bool bParam0)
{
	...
	Var1 = { func_227(-1591664384, -1591664384, 0, 0, 0, 0, -1, iVar0, 0) };
	if (func_228(Var1, &iVar11, &iVar12, 0))
	{
		iVar13 = 0;
		while (iVar13 < iVar12)
		{
			if (ITEMDATABASE::_0x8750F69A720C2E41(iVar11, iVar13, &bVar14) && func_229(bVar14))
			{
				func_230(iVar11);
				return bVar14;
			}
...
bool func_155(bool bParam0, bool bParam1)
{
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[ITEM_HAS_INTERACTION_TAG] Found tag ", func_98(bParam1, 0), " for item ", func_37(bParam0, 0), ", returning TRUE");
		return true;
	}
	return false;
}
...
int func_156(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (!ITEMDATABASE::_ITEM_DATABASE_FILLOUT_ACQUIRE_COST(bParam0, bParam1, &Var0))
	{
		if (!bParam3)
		{
			DEBUG::_0xA308F935BDECCEC0(680, 158, "GET_ITEM_ACQUIRE_COST_OUTPUT_QUANTITY - Unable to find cost ", func_231(bParam1, 0), " for item ", func_37(bParam0, 0));
		}
		return 0;
	}
	if (!bParam3)
	{
		DEBUG::_0x4DC69742196F818A(168, 158, "GET_ITEM_ACQUIRE_COST_OUTPUT_QUANTITY - Found requested identifier of ", func_231(bParam1, 0), " with output quantity ", Var0.f_1);
	}
	*bParam2 = Var0.f_1;
	return 1;
}
...
bool func_158(bool bParam0, int iParam1)
{
	...
	bVar0 = func_232(bParam0, iParam1);
	if (bVar0 == 0)
	{
...
bool func_159(bool bParam0, char* sParam1)
{
	int iVar0;
	char cVar1[128];
	...
	StringCopy(sParam1, func_233(bParam0), 128);
	...
	StringCopy(&cVar1, func_235(bParam0), 128);
...
char* func_160(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)
{
...
int func_164(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;

	iVar0 = func_136(bParam1, bParam2, 0, 0);
	iVar0 = (iVar0 + func_236(iParam0, bParam1));
	if (bParam3)
	{
		iVar0 = (iVar0 + func_237(bParam1, bParam4));
	}
	return iVar0;
}
...
{
	if (!func_38(Global_1940463.f_11701, 0))
	{
	...
	else if ((((func_95(Global_1940463.f_11701, 1224357681) != 0 && Global_1940463.f_11700 != 0) && Global_1940463.f_11700 != -2074770370) && !Global_1915867.f_20638) && !Global_1915867.f_22504.f_1)
	{
...
struct<4> func_166(bool bParam0)
{
	...
	if (Global_1572887.f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				Global_1272425 = { func_114(joaat("CHARACTER"), func_238(), -1591664384, bParam0) };
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1272425.f_12 = { func_114(joaat("CHARACTER"), func_238(), -1591664384, 0) };
	...
	return func_114(joaat("CHARACTER"), func_238(), -1591664384, bParam0);
}
...
struct<4> func_168(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		if (!INVENTORY::_0xB881CA836CC4B6D4(&(Global_1272425.f_4)))
		{
			...
			Global_1272425.f_4 = { func_114(923904168, func_166(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		if (!INVENTORY::_0xB881CA836CC4B6D4(&(Global_1272425.f_16)))
		{
			...
			Global_1272425.f_16 = { func_114(923904168, func_166(bParam0), -740156546, 0) };
		}
		return Global_1272425.f_16;
	}
	return func_114(923904168, func_166(bParam0), -740156546, 0);
}

bool func_169(bool bParam0, bool bParam1)
{
	if (func_148(bParam0) == 1779021115)
	{
		return false;
	}
...
struct<4> func_170(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		if (!INVENTORY::_0xB881CA836CC4B6D4(&(Global_1272425.f_8)))
		{
			...
			Global_1272425.f_8 = { func_114(271701509, func_166(bParam0), 12999093, 0) };
		}
		return Global_1272425.f_8;
	}
	return func_114(271701509, func_166(bParam0), 12999093, 0);
}
...
bool func_171(bool bParam0, bool bParam1)
{
	...
	while (iVar2 < iVar3)
	{
		...
		{
			if (func_240(bParam0, bParam1, bVar0))
			{
				return true;
			}
		}
...
bool func_172(var uParam0, var uParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, int iParam7)
{
	return func_241(&uParam0, iParam4, bParam5, bParam6, iParam7);
}
...
int func_175(bool bParam0, struct<4> Param1, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	struct<4> Var1;
	...
	if (!bParam7 && func_117(bParam0, joaat("DEFAULT")) == 0)
	{
	...
	if (bParam7)
	{
		DEBUG::_0x1B08D1EB9D8C4931(43688, 157, "PLAYER_INVENTORY_GET_ITEM_COUNT - eInventoryItem: ", func_37(bParam0, 0), " sParentGUID: ", UNK_0xD2E4270E5D98EEE4(&Param1), " eSlot: ", func_113(bParam5, 0), " bPlayerOnly: ", bParam6);
		Var1 = { func_114(bParam0, Param1, bParam5, bParam6) };
		if (!INVENTORY::_0xB881CA836CC4B6D4(&Var1))
		{
			DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_GET_ITEM_COUNT - Unable to find GUID for item ", func_37(bParam0, 0));
			return 0;
		}
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_108(bParam6), &Var1, bParam8);
		DEBUG::_0xA308F935BDECCEC0(648, 157, "PLAYER_INVENTORY_GET_ITEM_COUNT - Found ", iVar0, " of item ", func_37(bParam0, 0));
	}
	else
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_108(bParam6), bParam0, bParam8);
...
var func_177(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
void func_179(bool bParam0)
{
	...
	if (DATABINDING::_DATABINDING_GET_ARRAY_COUNT(Global_1957252.f_5.f_7) > bParam0)
	{
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 84, "RPG_GLOBAL_UI_ADD_PANEL - entry already exist at index ", func_243(bParam0, 0));
			return;
		}
	}
	DEBUG::_0xA308F935BDECCEC0(40, 84, "RPG_GLOBAL_UI_ADD_PANEL - adding ", func_243(bParam0, 0));
...
var func_188(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	struct<4> Var0;
	struct<8> Var13;
	var uVar21;
...
int func_189(bool bParam0, int* iParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	bool bVar0;
	int iVar1;
	var uVar2;
	...
	{
		DEBUG::_0x9A6C65DDDBEC9C52(2216, 84, "PERSONA_REQUEST_AWARD_MODIFIED_WITH_CONDS_WITH_RPC_GUID - Award ", func_244(bParam0, 0), "(", bParam0, ") has already reached maxclaims. Ignoring and returning TRUE.");
		return 1;
	}
	if (bParam7)
	{
	...
	if (iVar1 != 0)
	{
		func_245(iParam2, -372840566);
	}
	if (!bParam7)
	{
		if (!NETWORK::_0x64A36BA85CE01A81(&uVar2, &(uParam3->f_1), &(iParam2->f_1), iParam1))
		{
			DEBUG::_0xD9911C7B5F8CD69C(2216, 84, "PERSONA_REQUEST_AWARD_MODIFIED_WITH_CONDS_WITH_RPC_GUID - Failed to request award ", func_244(bParam0, 0), "(", bParam0, ")");
			return 0;
		}
	}
	else if (!NETWORK::_0x7A8E8DF782B47EB0(&uVar2, &(iParam2->f_1), iParam1))
	{
		DEBUG::_0xD9911C7B5F8CD69C(2216, 84, "PERSONA_REQUEST_AWARD_MODIFIED_WITH_CONDS_WITH_RPC_GUID - Posse Split - Failed to request award ", func_244(bParam0, 0), "(", bParam0, ")");
		return 0;
	}
	Var3.f_1 = 11;
	Var3.f_16 = 255;
	...
	Var3.f_14 = iParam6;
	Var3 = { *iParam2 };
	func_246(iParam1, bParam0, Var3);
	return 1;
}

bool func_190(bool bParam0, int iParam1, int iParam2, bool bParam3)
{
	int iVar0;

	iVar0 = func_108(0);
	*iParam1 = { func_114(bParam0, func_168(0), bParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(iParam1))
	{
		DEBUG::_0xF0783374333FD8CE(2728, 139, "[SHOP_GET_INVENTORY_WEAPON_DATA] Invalid INVENTORY_ITEM_GUID for ", func_37(bParam0, 0), " eSlot: ", func_113(bParam3, 0), " iPlayerInventoryID: ", iVar0);
		return false;
	}
...
int func_192(int iParam0, int iParam1, bool bParam2)
{
	...
	DEBUG::_0xA308F935BDECCEC0(168, 157, "CASHINVENTORY_FIRE_AND_FORGET_ITEM_TRANSACTION - ", func_247(iParam0, 0), ", immediate = ", bParam2);
	...
	if (bParam2)
	{
		...
		{
			return func_250(func_249(iVar0, iParam0, iParam1), iVar0, iParam1);
		}
	}
	else
	{
		return func_251(NETSHOPPING::_CASHINVENTORY_TRANSACTION_FIRE_AND_FORGET_ITEM(iParam0, &iVar0, iParam1, 17), iVar0, iParam1);
	}
...
void func_193(int iParam0, struct<17> Param1)
{
	int iVar0;
	...
	while (iVar0 < Global_1272425.f_20)
	{
		if (Global_1272425.f_20.f_1[iVar0 /*21*/] == iParam0)
		{
			if (Global_1272425.f_20.f_1[iVar0 /*21*/].f_1 == 1 || Global_1272425.f_20.f_1[iVar0 /*21*/].f_1 == 5)
			{
				...
				DEBUG::_0x4DC69742196F818A(40, 205, "UPDATE_CASHINVENTORY_TRANSACTION_HANDLER_DATA -   eStatus:                        ", func_252(Global_1272425.f_20.f_1[iVar0 /*21*/].f_1, 0));
...
void func_198(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_206(int iParam0, char* sParam1)
{
	if (iParam0 <= 0)
	{
...
bool func_210(bool bParam0, int iParam1)
{
	...
	if (func_43(bParam0, 1399091007))
	{
		func_137(bParam0, &uVar1, &uVar2);
		return uVar2;
	}
...
bool func_211(char* sParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_108(bParam4), sParam0, bParam3, bParam2);
	if (*iParam1 >= 0)
	{
		DEBUG::_0xA308F935BDECCEC0(174216, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION - Created collection '", *iParam1, "' with size ", *bParam2, " from predicate '", sParam0, "' with ", func_113(bParam3, 0));
...
bool func_212(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	if (iParam2 < 0)
	{
...
int func_215(var uParam0, int iParam1)
{
	...
	DEBUG::_0x9A6C65DDDBEC9C52(40, 208, "[METAPED_SAVE__OVERLAY_FIND_LAYER_BY_TYPE] Failed to find: ", func_263(iParam1, 0));
	return -1;
}
...
char* func_217(bool bParam0, bool bParam1)
{
	struct<14> Var0;
	int iVar14;
	char* sVar15;
	...
	Var0 = { func_264(bParam0, -1591664384, -1591664384, -1591664384, 0, 0, 0) };
	if (bParam1)
	{
		func_265(&Var0, func_168(0));
	}
	if (!func_266(&Var0, &iVar14, &sVar15, 0))
	{
		DEBUG::_0x1B08D1EB9D8C4931(648, 157, "GET_PLAYER_WEAPON_ITEM_COUNT bCarriedOnly = ", bParam1, " - Found 0 of item ", func_37(bParam0, 0));
		return 0;
	}
	func_213(iVar14);
	DEBUG::_0x1B08D1EB9D8C4931(10376, 157, "GET_PLAYER_WEAPON_ITEM_COUNT bCarriedOnly = ", bParam1, " - Found ", sVar15, " of item ", func_37(bParam0, 0));
	return sVar15;
}

struct<4> func_218(bool bParam0, bool bParam1)
{
	struct<5> Var0;

	Var0 = { func_90(bParam0, bParam1, 0) };
	return func_114(bParam0, Var0, Var0.f_4, bParam1);
}
...
var func_220(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
void func_221(int* iParam0, bool bParam1, struct<15> Param2)
{
	int iVar0;
	struct<22> Var1;
	...
	DEBUG::_0x4DC69742196F818A(2696, 205, "ADD_AWARD_LOOT_TRANSACTION_DATA -   eLootTable:                     ", Var1.f_4, " (", func_220(Var1.f_4, 0), ")");
	DEBUG::_0x4DC69742196F818A(40, 205, "ADD_AWARD_LOOT_TRANSACTION_DATA -   eStatus:                        ", func_269(Var1.f_6, 0));
...
bool func_222(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (ITEMDATABASE::_ITEM_DATABASE_FILLOUT_UI_DATA(bParam0, &Var3))
	{
		...
		while (iVar0 < 5)
		{
			...
			else
			{
				...
				if (iParam2 != 0 && Var3.f_2[iVar0 /*3*/].f_2 != iParam2)
				{
					DEBUG::_0x1B08D1EB9D8C4931(40, 158, "FIND_INVENTORY_ITEM_TEXTURE_UI_DATA_HASHED: Skipping entry with type: ", func_224(Var3.f_2[iVar0 /*3*/].f_2, 0));
					Jump @437; //curOff = 202
				}
				else if (iParam3 != 0 && iVar2 != iParam3)
				{
				...
				else
				{
					...
					DEBUG::_0x4DC69742196F818A(40, 158, "FIND_INVENTORY_ITEM_TEXTURE_UI_DATA_HASHED:    Type: ", func_224(Var3.f_2[iVar0 /*3*/].f_2, 0));
					*uParam1 = iVar1;
					uParam1->f_1 = iVar2;
					uParam1->f_2 = iParam2;
					return true;
	...
	DEBUG::_0x9A6C65DDDBEC9C52(680, 158, "FIND_INVENTORY_ITEM_TEXTURE_UI_DATA_HASHED: Unable to find texture of type ", func_224(iParam2, 0), " for item ", func_37(bParam0, 0));
	return false;
}

void func_223(char* sParam0, char* sParam1, int iParam2)
{
...
int func_225(bool bParam0, bool bParam1)
{
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[ITEM_HAS_FOLDER_TAG] Found tag ", func_98(bParam1, 0), " for item ", func_37(bParam0, 0), ", returning TRUE");
		return 1;
	}
	return 0;
}
...
struct<10> func_227(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	struct<10> Var0;
...
bool func_228(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, int iParam10, int iParam11, char* sParam12)
{
...
char* func_231(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case -2141192156:
	...
	if (ITEMDATABASE::_ITEM_DATABASE_FILLOUT_TAG_DATA(bParam0, &Var0, &iVar42, 20))
	{
		...
		while (iVar43 < iVar42)
		{
			if (Var0[iVar43 /*2*/].f_1 == iParam1)
			{
				...
				DEBUG::_0x4DC69742196F818A(10920, 158, "[INVENTORY_ITEM__HAS_TAG_OF_TYPE] Found tag type ", func_270(iParam1, 0), " for item ", func_37(bParam0, 0), ", returning tag : ", func_98(bVar41, 0));
				return bVar41;
			}
			iVar43++;
		}
...
{
	if (func_148(bParam0) == -126813555 || func_148(bParam0) == 1946043663)
	{
		return true;
	}
	return false;
...
int func_236(int iParam0, bool bParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		...
		{
			return func_272(INVENTORY::_INVENTORY_GET_PED_INVENTORY_ID(iParam0), bParam1);
		}
	}
	return 0;
}
...
int func_237(bool bParam0, bool bParam1)
{
	if (!bParam1 || func_273())
	{
		return func_175(bParam0, func_166(1), -2015960939, 1, 1, 0);
	}
	return 0;
}
...
bool func_239()
{
	return (func_92(joaat("UPGRADE_OFFHAND_HOLSTER"), 0, 0, 0) > 0 && func_274(func_114(joaat("WARDROBE"), func_166(1), 1034665895, 1), -234132662, 1, -1) != 0);
}
...
bool func_241(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 157, "PLAYER_INVENTORY_GET_ITEM_DATA -  SlotId:      ", func_113(iParam1->f_9, 0));
...
{
	return func_43(bParam0, 1279601681);
}
...
void func_245(int iParam0, bool bParam1)
{
	...
	{
		DEBUG::_0xD9911C7B5F8CD69C(168, 157, "PUSH_AWARD_MODIFIER: Failed to push modifier ", func_275(bParam1, 0), ", array is full");
		return;
	}
	DEBUG::_0x4DC69742196F818A(40, 157, "PUSH_AWARD_MODIFIER: Adding modifier ", func_275(bParam1, 0));
}

void func_246(int* iParam0, bool bParam1, struct<17> Param2)
{
	int iVar0;
	struct<24> Var1;
	...
	DEBUG::_0x4DC69742196F818A(40, 205, "ADD_AWARD_TRANSACTION_DATA -   eAward:                         ", func_244(Var1.f_4, 0));
	DEBUG::_0x4DC69742196F818A(40, 205, "ADD_AWARD_TRANSACTION_DATA -   eStatus:                        ", func_276(Var1.f_6, 0));
...
bool func_248(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(2728, 157, "CASHINVENTORY_VALIDATE_TRANSACTION_ITEM - ", func_247(iParam0, 0), " -> ", func_37(iParam1->f_8, 0), " has iFailedValidationFlags = ", sVar0);
	if (iParam0 == joaat("USE"))
	{
		if ((func_277(iParam1->f_8, iParam0, sVar0, 2048) || func_277(iParam1->f_8, iParam0, sVar0, 32768)) || func_277(iParam1->f_8, iParam0, sVar0, 65536))
		{
			return false;
		}
	}
	...
	{
		if (((func_277(iParam1->f_8, iParam0, sVar0, 4) || func_277(iParam1->f_8, iParam0, sVar0, 256)) || func_277(iParam1->f_8, iParam0, sVar0, 65536)) || func_277(iParam1->f_8, iParam0, sVar0, 131072))
		{
			return false;
		}
	}
	...
	{
		if (((func_277(iParam1->f_8, iParam0, sVar0, 1) || func_277(iParam1->f_8, iParam0, sVar0, 8)) || func_277(iParam1->f_8, iParam0, sVar0, 65536)) || func_277(iParam1->f_8, iParam0, sVar0, 32))
		{
			return false;
		}
	}
	...
	{
		if (((func_277(iParam1->f_8, iParam0, sVar0, 1) || func_277(iParam1->f_8, iParam0, sVar0, 16)) || func_277(iParam1->f_8, iParam0, sVar0, 2)) || func_277(iParam1->f_8, iParam0, sVar0, 65536))
		{
			return false;
		}
	}
	else if (((func_277(iParam1->f_8, iParam0, sVar0, 8) || func_277(iParam1->f_8, iParam0, sVar0, 4096)) || func_277(iParam1->f_8, iParam0, sVar0, 256)) || func_277(iParam1->f_8, iParam0, sVar0, 65536))
	{
		return false;
	}
	return true;
...
int func_251(bool bParam0, char* sParam1, int iParam2)
{
	if (bParam0)
	{
...
void func_260(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
struct<14> func_264(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6)
{
	struct<14> Var0;
	...
	{
		Var0.f_1 = bParam1;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eSlot:     ", func_113(bParam1, 0));
	}
	if (bParam2 != 0 && bParam2 != -1591664384)
	{
		Var0.f_2 = bParam2;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eFitsSlot: ", func_113(bParam2, 0));
	}
	if (bParam3 != 0 && bParam3 != -1591664384)
	{
		Var0.f_3 = bParam3;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eHasSlot:  ", func_113(bParam3, 0));
	}
	if (bParam4 != 0)
	{
		Var0.f_4 = bParam4;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eCategory: ", func_286(bParam4, 0));
	}
	if (bParam5 != 0)
	{
		Var0.f_5 = bParam5;
	...
	{
		Var0.f_8 = iParam6;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eItemGroup:  ", func_167(iParam6, 0));
	}
	return Var0;
}
...
bool func_266(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_108(bParam3), uParam0, bParam2);
	if (*iParam1 >= 0)
	{
...
{
	if (!func_155(bParam0, 1955773996))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(40, 158, "IS_SATCHEL_ITEM_STOWABLE: item does not have required horse cargo tag - ", func_37(bParam0, 0));
		return false;
	}
	if (!func_287(bParam0, 1))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(40, 158, "IS_SATCHEL_ITEM_STOWABLE: item considered too small to be stowable - ", func_37(bParam0, 0));
		return false;
	}
	return true;
}
...
int func_272(int iParam0, bool bParam1)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(168, 157, "GET_PED_SATCHEL_ITEM_COUNT - Checking if item: ", func_37(bParam1, 0), " has a valid GUID.");
	Var0 = { func_288(iParam0, bParam1) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(&Var0))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 157, "GET_PED_SATCHEL_ITEM_COUNT - No GUID found for item ", func_37(bParam1, 0), ", returning 0");
		return 0;
	}
	iVar4 = INVENTORY::_0xC97E0D2302382211(iParam0, &Var0, false);
	DEBUG::_0x1B08D1EB9D8C4931(648, 157, "GET_PED_SATCHEL_ITEM_COUNT - Found ", iVar4, " of item ", func_37(bParam1, 0));
	return iVar4;
}
...
int func_274(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, int iParam6)
{
	return func_290(&uParam0, bParam4, bParam5, iParam6);
}

var func_275(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
int func_277(var uParam0, int iParam1, char* sParam2, int iParam3)
{
	if (func_291(sParam2, iParam3))
	{
		return 1;
	}
	return 0;
...
void func_278(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	while (iVar0 < Global_1272425.f_20)
	{
		if (Global_1272425.f_20.f_1[iVar0 /*21*/] == iParam0)
		{
			...
			{
				DEBUG::_0x4DC69742196F818A(648, 157, "UPDATE_CASHINVENTORY_TRANSACTION_STATUS - Transaction ", iParam0, " status was already ", func_252(Global_1272425.f_20.f_1[iVar0 /*21*/].f_1, 0));
			}
			else
			{
				DEBUG::_0xA308F935BDECCEC0(10888, 157, "UPDATE_CASHINVENTORY_TRANSACTION_STATUS - Updated transaction ", iParam0, " status from ", func_252(Global_1272425.f_20.f_1[iVar0 /*21*/].f_1, 0), " to ", func_252(iParam1, 0));
				Global_1272425.f_20.f_1[iVar0 /*21*/].f_1 = iParam1;
			}
			if (iParam2 != 0 && iParam3 != 0)
			{
				DEBUG::_0xA308F935BDECCEC0(10888, 157, "UPDATE_CASHINVENTORY_TRANSACTION_STATUS - Updated transaction ", iParam0, " batch action A to ", func_247(iParam2, 0), " and action B to ", func_247(iParam3, 0));
	...
	func_292(iParam0, iParam1, iParam2, iParam3);
}
...
void func_282(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0x83407B92D46F25C3(559240, 0, "SET_TIMEOFDAY_DAY: Passed an invalid day [", iParam1, "] for the TIMEOFDAY's current month [", iVar0, "] for year ", iVar1, ". GET_NUMBER_OF_DAYS_IN_MONTH(eMonth, iYear) = ", func_259(iVar0, iVar1), ". Failed to set TIMEOFDAY.");
		return;
	}
...
struct<4> func_288(int iParam0, bool bParam1)
{
	...
	return func_295(iParam0, bParam1, Var0, Var0.f_4);
}
...
int func_290(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	Var0.f_9 = -1591664384;
	if (func_296(iParam0, bParam1, &Var0, bParam2, iParam3))
	{
...
bool func_291(char* sParam0, int iParam1)
{
...
void func_292(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	func_297(&(Global_1272425.f_20.f_1[(Global_1272425.f_20 - 1) /*21*/]));
	...
	if (iParam2 != 0 && iParam3 != 0)
	{
		...
		DEBUG::_0xA308F935BDECCEC0(10888, 157, "ADD_CASHINVENTORY_TRANSACTION_STATUS - Added transaction ", iParam0, " with batch action A ", func_247(iParam2, 0), " and action B ", func_247(iParam3, 0));
	}
	DEBUG::_0xA308F935BDECCEC0(648, 157, "ADD_CASHINVENTORY_TRANSACTION_STATUS - Added transaction ", iParam0, " with status ", func_252(iParam1, 0));
}
...
int func_293(bool bParam0)
{
	...
	{
		DEBUG::_0x9A6C65DDDBEC9C52(40, 158, "GET_INVENTORY_ITEM_SATCHEL_SIZE - failed to retreive the satchel item data from the itemdatabase for item: ", func_37(bParam0, 0));
		return -1;
	}
	return uVar0;
}

struct<5> func_294(int iParam0)
{
	struct<5> Var0;

	Var0 = { func_295(iParam0, joaat("CHARACTER"), func_238(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}

struct<4> func_295(int iParam0, bool bParam1, var uParam2, int iParam3, var uParam4, var uParam5, bool bParam6)
{
	struct<4> Var0;

	if (!func_38(bParam1, 0))
	{
		DEBUG::_0xD9911C7B5F8CD69C(2216, 157, "GET_PED_INVENTORY_ITEM_GUID - Attempting to check for an invalid item ", func_37(bParam1, 0), " (", bParam1, ") in the player's inventory!");
		return Var0;
	}
...
bool func_296(int iParam0, bool bParam1, int iParam2, bool bParam3, int iParam4)
{
	var uVar0;
	...
	if (iParam4 == -1)
	{
		iParam4 = func_108(bParam3);
	}
	if (!INVENTORY::_0x22E590F108289A9D(iParam4, iParam0, bParam1, &uVar0))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(40, 157, "PLAYER_INVENTORY_GET_ITEM_DATA_EQUIPPED_IN_SLOT_BY_REF - nothing is equipped for slot ", func_113(bParam1, 0));
		return false;
	}
	if (!func_241(&uVar0, iParam2, bParam3, 0, iParam4))
	{
		DEBUG::_0xD9911C7B5F8CD69C(40, 157, "PLAYER_INVENTORY_GET_ITEM_DATA_EQUIPPED_IN_SLOT_BY_REF - failed to get equipment data for slot ", func_113(bParam1, 0));
		return false;
	}
	DEBUG::_0x1B08D1EB9D8C4931(10920, 157, "PLAYER_INVENTORY_GET_ITEM_DATA_EQUIPPED_IN_SLOT_BY_REF - ", func_37(iParam2->f_4, 0), " (", UNK_0xD2E4270E5D98EEE4(iParam2), ") is equipped in slot ", func_113(bParam1, 0));
	return true;
}
