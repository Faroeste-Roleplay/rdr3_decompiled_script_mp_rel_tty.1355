...
void __EntryFunction__()
{
	...
	DEBUG::_0xF0783374333FD8CE(43688, 17, "**** INITIALIZING REGION: ", &(Global_1887351[vScriptParam_0.x /*36*/].f_23), ", ", &(Global_1887351[iLocal_53 /*36*/].f_24), ", ", &(Global_1887351[iLocal_53 /*36*/].f_27), " ****");
	func_2();
	func_3();
	...
	while (func_4())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_52)
		{
			...
			{
				case 0:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_53 /*36*/].f_23), " global init...");
					if (Global_1901988.f_1.f_26 > 0)
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_53 /*36*/].f_23), "-> RBS_WAIT_FOR_UGC_EARLY_QUIT");
						iLocal_54 = (MISC::GET_GAME_TIMER() + Global_1901988.f_1.f_26);
						iLocal_51 = 1;
					}
					else
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_53 /*36*/].f_23), "-> RBS_INIT_REGION");
						iLocal_51 = 2;
					}
					break;
				case 1:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_53 /*36*/].f_23), " ugc early quit...");
					...
					break;
				case 2:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_53 /*36*/].f_23), " region init...");
					func_6(iLocal_53);
					func_7();
					func_8();
					...
					Global_1896632 = -1;
					DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_53 /*36*/].f_23), "-> RBS_INIT_VOLUME");
					iLocal_54 = (iLocal_50 + MISC::GET_GAME_TIMER());
					iLocal_51 = 3;
					break;
				case 3:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_53 /*36*/].f_23), " volume init...");
					if (func_13() || iLocal_54 < MISC::GET_GAME_TIMER())
					{
						func_14(iLocal_53);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_53 /*36*/].f_23), "-> RBS_LOAD_APPEARANCE");
						iLocal_54 = (MISC::GET_GAME_TIMER() + iLocal_50);
						iLocal_51 = 4;
					}
					break;
				case 4:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_53 /*36*/].f_23), " load appearance...");
					if (func_15(iLocal_53) || iLocal_54 < MISC::GET_GAME_TIMER())
					{
						func_16(iLocal_53);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_53 /*36*/].f_23), "-> RBS_LOAD_SPECIAL");
						iLocal_54 = (MISC::GET_GAME_TIMER() + iLocal_50);
						iLocal_51 = 5;
					}
					break;
				case 5:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_53 /*36*/].f_23), " load special...");
					if (func_17(iLocal_53) || iLocal_54 < MISC::GET_GAME_TIMER())
					{
						func_18(iLocal_53);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_53 /*36*/].f_23), "-> RBS_LOAD_PERS_CHARS");
						iLocal_54 = (iLocal_50 + MISC::GET_GAME_TIMER());
						iLocal_51 = 7;
					}
					break;
				case 7:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_53 /*36*/].f_23), " init regional chars...");
					if (func_10(func_9(iLocal_53)))
					{
						...
						else
						{
							if (func_20(iLocal_53) || iLocal_54 < MISC::GET_GAME_TIMER())
							{
								func_21(iLocal_53, 4);
								iLocal_54 = (MISC::GET_GAME_TIMER() + iLocal_50);
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_53 /*36*/].f_23), "-> RBS_INIT_AMBIENT");
								iLocal_51 = 8;
							}
							...
							{
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_53 /*36*/].f_23), " AMBIENT MINIGAMES ARE NOT BEING ENABLED AS A STORY OR RCM OR MISSION RETRY IS HAPPENING");
							}
							func_26();
							func_27();
							func_28();
							...
							func_31();
							func_32();
							DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": INIT_CURRENT_REGION_TOWN_DATA FOR ", &(Global_1887351[iLocal_53 /*36*/].f_23));
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_53 /*36*/].f_23), " RBS_INIT_AMBIENT -> RBS_INIT_LAW");
							iLocal_51 = 9;
							Jump @1375; //curOff = 1051
							func_33(iLocal_53);
							func_34();
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_53 /*36*/].f_23), "-> RBS_INIT_NAMED_LOCATIONS");
							iLocal_51 = 10;
							Jump @1375; //curOff = 1089
							func_35(&Global_1896686);
							func_36(iLocal_53, &Global_1896686);
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_53 /*36*/].f_23), "-> RBS_DONE_INIT");
							iLocal_51 = 11;
							Jump @1375; //curOff = 1135
							DEBUG::_0xF0783374333FD8CE(168, 17, "**** FINISHED INITIALIZING: ", &(Global_1887351[iLocal_53 /*36*/].f_23), " ****");
							func_37(iLocal_53);
							func_21(iLocal_53, 8);
							if (func_38(32))
							{
							...
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_53 /*36*/].f_23), "-> RBS_RUNNING");
							iLocal_51 = 12;
							...
							func_41(&Global_1896686, iLocal_53);
							func_42(iLocal_53);
							func_21(iLocal_53, 8);
							if (func_43())
							{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887351[iLocal_53 /*36*/].f_11);
							if (Global_1887351[iLocal_53 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887351[iLocal_53 /*36*/].f_12);
							}
							Jump @1375; //curOff = 1331
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_53 /*36*/].f_23), " RBS_CLEANUP");
							func_8();
							func_44(iVar0);
							iVar0++;
						}
						if (Global_1887351[iLocal_53 /*36*/].f_13 == 0)
						{
						}
						else
						{
							PED::_0x95423627A9CA598E(Global_1887351[iLocal_53 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
...
bool func_1()
{
	if (!bLocal_55)
	{
		if (Global_1051140)
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_53 /*36*/].f_23), ", g_mpUGC_QuitSessionRequest.bRequestRunning is still true");
			bLocal_55 = true;
			return true;
		}
		if (func_47() && func_48())
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_53 /*36*/].f_23), ", a session request is running and a UGC script is running");
			bLocal_55 = true;
			return true;
		}
	...
	if (func_48())
	{
		DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_53 /*36*/].f_23), ", content script still running for some player");
		return true;
	}
...
bool func_13()
{
	iLocal_19 = Global_1887351[26 /*36*/].f_5;
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_34, 0f, 0f, 0f) <= 5f || func_78(Global_1940410, 32768)) || func_78(Global_1940410, 16777216))
	{
		return;
	}
...
bool func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": REGION_TOWN_MANANGER_EXIT_TOWN FOR ", &(Global_1887351[iLocal_53 /*36*/].f_23));
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_53)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_91(iLocal_53));
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_92(iLocal_53, 0), 1);
					break;
			}
		}
		if (func_10(func_84()))
	...
	else
	{
		...
		if (func_45() == -1)
		{
			func_96(iLocal_53);
			func_97(iLocal_53);
			if (!func_98(iLocal_53, 0))
			{
				return false;
			}
		}
		else if (!func_99(iLocal_53))
		{
			return false;
		}
	}
	DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": Terminating. -- ", &(Global_1887351[iLocal_53 /*36*/].f_23));
	SCRIPTS::TERMINATE_THIS_THREAD();
	return true;
}
...
bool func_49(bool bParam0, bool bParam1)
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		{
			DEBUG::_0xF0783374333FD8CE(168, 8, "KILL_EVENT_CAUGHT - NETWORK_IS_GAME_IN_PROGRESS() = FALSE - but bIgnoreTransition = TRUE and g_mpTransition.eMPState = ", func_100(Global_1572887, 0), ", so skipping");
		}
		else
		{
...
int func_56(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (!func_71(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Region index not valid ", func_102(iParam0));
		return 1;
	}
	if (func_101(iParam0, 16))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: RF_PERS_DISABLED is on for ", func_102(iParam0));
		return 1;
	}
	if (func_103(iParam0) && !func_104(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: IS_REGION_IN_LOCKDOWN is on for ", func_102(iParam0));
	}
	DEBUG::_0xF0783374333FD8CE(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Starting for ", func_102(iParam0));
	if (func_105(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if ((!func_103(iParam0) || func_104(iParam0)) || func_107(Global_1896632))
			{
				func_108(Global_1896632, 0);
			}
			Global_1896632++;
			iVar2++;
...
void func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	func_112(iParam0, 1);
	DEBUG::_0xF0783374333FD8CE(40, 139, "NET_ENABLE_SHOP_LOCATION: Registering ", func_113(iParam0));
	Global_1051777.f_80[iParam0 /*75*/] = 0;
	Global_1051777.f_80[iParam0 /*75*/].f_18 = func_114(iParam2, iParam0);
	...
	Global_1051777.f_80[iParam0 /*75*/].f_63 = func_115(Global_1051777.f_80[iParam0 /*75*/].f_18);
...
void func_62(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	...
	if (iVar0 < 0 || iVar0 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(40, 139, "[NET_ADD_SHOP_DOOR] - Invalid door index for shop: ", func_120(iParam0, 0));
		return;
	}
	Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0] = func_121(bParam1, 0, 0);
	if (func_122(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0]))
	{
		if (!func_123(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0]))
		{
			func_77(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0], 0, fParam2, bParam3, 1, 0, bParam4, 0);
		}
	}
...
{
	DEBUG::_0x4DC69742196F818A(680, 55, "[NET_SHOP_PROPERTY_SET_BIT] Setting bit: ", func_124(iParam1), " for ", func_113(iParam0));
	func_125(&(Global_1051777.f_80[iParam0 /*75*/].f_49), iParam1);
}
...
int func_64(int iParam0, bool bParam1)
{
	...
	if ((func_126(iParam0, 16384) || func_126(iParam0, 32768)) || func_127(Global_1051777.f_80[iParam0 /*75*/].f_3))
	{
	...
	iVar0 = func_114(func_128(), iParam0);
	if ((!bParam1 && func_129(iVar0, &bVar1, &uVar2, &vVar3)) || (bParam1 && func_130(iVar0, &bVar1, &uVar2, &vVar3)))
	{
		func_131(iParam0, bVar1, vVar3, uVar2, 0);
...
bool func_68(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == 0)
	{
		DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_136(iParam0), " IS INVALID.");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_136(iParam0), " IS VALID.");
...
{
	func_77(bParam0, 1, 0, 0, 0, 0, 0, 0);
}

void func_77(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	func_121(bParam0, 0, 0);
	if (func_122(bParam0))
	{
		...
		if (bParam3)
		{
			func_143(bParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
			{
				...
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking Door ID ", func_145(bParam0, 0));
			}
			else
			{
				func_146(bParam0, 1);
				UNK_0x355E72323AEE83CC(183, 9);
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking and making unbreakable Door ID ", func_145(bParam0, 0));
			}
		}
		else
		{
			func_147(bParam0, 1);
			UNK_0x355E72323AEE83CC(183, 9);
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Unlocking Door ID ", func_145(bParam0, 0));
		}
		if (bParam7)
		{
			DEBUG::_0x1B08D1EB9D8C4931(168, 183, "SET_STATE_OF_DOOR_ID - Treating Door ID ", func_145(bParam0, 0), " as shut.");
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 183, "SET_STATE_OF_DOOR_ID: Door with ID not registered by host yet ", func_145(bParam0, 0));
	}
}
...
bool func_80()
{
	return func_78(Global_1940410, 8192);
}
...
bool func_82(int iParam0)
{
	...
	return ((Global_1887351[iParam0 /*36*/].f_21 == 1 || Global_1887351[iParam0 /*36*/].f_21 == 2) && !func_149(iParam0));
}
...
void func_85(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	char* sVar1;
	char* sVar2;
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_151(iParam0, 0), " ", func_152(iParam1, 0), " ", func_153(bParam2, 0), " state ", func_154(iParam4, 0));
	UNK_0x355E72323AEE83CC(11, 6);
	sVar1 = func_155(iParam0, iParam1, bParam2, iParam4, bParam5, bParam3, &bVar0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_151(iParam0, 0), " or ", func_152(iParam1, 0), " or ", func_153(bParam2, 0));
	...
	if (!func_156(iParam4))
	{
		if (func_71(iParam0))
		{
			iParam4 = func_157(func_9(iParam0));
		}
		else
		{
			iParam4 = func_157(iParam1);
		}
	}
	if (func_156(iParam4))
	{
		iVar3 = func_158(iParam4);
	}
	if (bVar0 && bParam3)
	{
		sVar2 = func_160(func_159(bParam2));
	}
	else if ((func_161(iParam1, 2) || func_162(iParam4, 2)) && !Global_1893599.f_9)
	{
	...
	else if ((func_71(iParam0) && func_101(iParam0, 16777216)) && !Global_1893599.f_9)
	{
	...
	{
		iVar4 = func_164(func_163());
		iVar5 = func_165(func_163());
		if (iVar5 < 10)
		{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			{
				fVar7 = func_166(fVar7);
				sVar8 = "TIME_AND_TEMP_F";
			}
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_167(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_167(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_167(&cVar6, joaat("COLOR_PURE_WHITE")), func_167(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		Global_1893599.f_9 = 0;
	}
	DEBUG::_0xF0783374333FD8CE(680, 11, "DISPLAY_NAMED_LOCATION - Texture ", sVar1, " info ", sVar2);
	Global_1939313.f_145 = func_168(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_87(int iParam0, bool bParam1)
{
	...
	func_170(&Global_1940410, 16384);
	func_172(func_171(joaat("DISCOVERED"), joaat("AREAS")), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_172(func_171(joaat("DISCOVERED"), joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_172(func_171(joaat("DISCOVERED"), joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_172(func_171(joaat("DISCOVERED"), joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_172(func_171(joaat("DISCOVERED"), joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_172(func_171(joaat("DISCOVERED"), joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_172(func_171(joaat("DISCOVERED"), joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
bool func_98(int iParam0, bool bParam1)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 138, "DELETE_ALL_REGIONAL_CHARACTERS starting for Region ", func_102(iParam0));
	if (func_105(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_175(Global_1896632.f_1, 16))
			{
				func_176(Global_1896632.f_1, 0);
			}
			Global_1896632.f_1++;
			iVar2++;
...
bool func_99(int iParam0)
{
	...
	while (iVar0 < 40)
	{
		if (func_177(iVar0) || func_178(iVar0))
		{
		}
		else
		{
	...
	switch (iParam0)
	{
		...
		case 139:
			...
			*iParam2 = 851;
			...
			break;
		default:
			DEBUG::_0xA308F935BDECCEC0(40, 138, "Attempting to get regional character bounds for a region that doesn't have them yet ", func_91(iParam0));
			*iParam1 = -1;
			*iParam2 = -1;
			break;
	}
...
int func_108(int iParam0, bool bParam1)
{
	if (!func_106(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_136(iParam0), " is invalid");
		return 0;
	}
	if (!func_175(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_136(iParam0), " has not been initialized");
		return 0;
	}
	if (func_175(iParam0, 32) && !bParam1)
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_136(iParam0), " has been locked dead");
		func_182(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_181(iParam0)));
		if (func_45() == -1)
		{
			if (func_175(iParam0, 2048))
			{
				PERSCHAR::_0x49A8C2CD97815215(func_135(iParam0));
				func_183(iParam0, 2048);
				DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_136(iParam0), " has been revived!");
			}
			PERSCHAR::_0xFCC6DB8DBE709BC8(func_135(iParam0));
		}
		return 0;
	}
	if (!func_184(iParam0) && func_45() == -1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_136(iParam0), " dead or not spawning, turn scenario groups off");
		return 0;
	}
	if (PERSCHAR::_0x800DF3FC913355F3(func_135(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Persistent character ", func_136(iParam0), " already exists");
		func_183(iParam0, 128);
		return 1;
	}
	func_182(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_181(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_135(iParam0));
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_136(iParam0), " perschar index created!");
	if (func_175(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_135(iParam0));
		func_183(iParam0, 2048);
	...
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_136(iParam0), " created.");
...
void func_111(bool bParam0, bool bParam1)
{
	...
	if (func_127(ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), false, false)))
	{
	...
	else
	{
		...
		func_190(0);
		func_191(&(Global_1102630.f_3849));
		...
		func_192(&(Global_1102630.f_3888));
	...
	func_193(Global_1102630.f_3849, 36);
	func_194(Global_1102630.f_3888, 36);
...
void func_112(int iParam0, bool bParam1)
{
	...
	DEBUG::_0x4DC69742196F818A(40, 139, "NET_CLEAR_SHOP ", func_120(iParam0, 0));
	bVar0 = (func_195(iParam0) && !bParam1);
	if (!bVar0 && !func_126(iParam0, 65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] - Shop keeper deleted for shop: ", func_113(iParam0));
		}
	...
	else if (func_196(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
	{
	...
	if (func_196(iParam0, 16384) && !bVar0)
	{
		DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] Remove the script created scenario for: ", func_113(iParam0));
		if (TASK::_DOES_SCENARIO_POINT_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_6))
		{
	...
	if (iVar3 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "[NET_CLEAR_SHOP] - Shop: ", func_120(iParam0, 0), " current door count exceeds max door count.");
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_198(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar2]);
	...
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 139, "NET_CLEAR_SHOP: SPF_ALLOW_BLIP_OUT_OF_REGION for ", func_113(iParam0), " is kept; all other flags cleared.");
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_24) && func_201(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_CLEAR_SHOP] Removing relationship volume from shop ", func_120(iParam0, 0));
...
int func_115(int iParam0)
{
	...
	{
		Global_1051777.f_4480[iParam0] = func_205(iParam0);
	}
...
void func_117(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_SET_SHOP_TYPE_FLAG] ", func_113(iParam0), " flag ", func_206(iParam1));
	}
...
bool func_121(bool bParam0, bool bParam1, bool bParam2)
{
	if (!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(bParam0))
	{
		if ((NETWORK::NETWORK_IS_IN_SESSION() && SCRIPTS::_DOES_THREAD_EXIST(Global_1051590.f_16[0])) && bParam1)
		{
			...
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add networked Door ", func_145(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
		else
		{
			OBJECT::_ADD_DOOR_TO_SYSTEM_NEW(bParam0, true, false, false, 0, 0, false);
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add Door ", func_145(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
	}
	...
	if (bParam2)
	{
		...
		DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Set door ", func_145(bParam0, 0), " able to change open ratio while locked");
		UNK_0x355E72323AEE83CC(183, 7);
	}
	return bParam0;
}
...
bool func_129(int iParam0, bool bParam1, bool bParam2, char* sParam3)
{
	return func_209(iParam0, "sHash", bParam1, "fHeading", bParam2, "vPos", sParam3);
}

bool func_130(int iParam0, bool bParam1, bool bParam2, char* sParam3)
{
	return func_209(iParam0, "sClosedHash", bParam1, "fClosedHeading", bParam2, "vClosedPos", sParam3);
}

void func_131(int iParam0, bool bParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	if (bParam6)
	{
		MISC::GET_GROUND_Z_FOR_3D_COORD(vParam2, &(vParam2.f_2), false);
	}
	Global_1051777.f_80[iParam0 /*75*/].f_6 = func_210(bParam1, vParam2, uParam5, 0, 0, 0);
	...
	DEBUG::_0xA308F935BDECCEC0(10920, 139, "[NET_ADD_SHOP_SCENARIO_AT_POINT] Creating scenario point: ", HUD::_GET_LABEL_TEXT_BY_HASH(bParam1), " for shop: ", func_120(iParam0, 0), " at: ", MISC::_0x6C4DBF553885F9EB(vParam2));
}

bool func_132(struct<2> Param0)
{
	return func_211(Param0, 9, 12);
}
...
int func_133(int iParam0)
{
	...
	cVar2 = { 0f, 0f, 0f };
	if (!func_129(iParam0, &bVar0, &uVar1, &cVar2) || func_127(cVar2))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_REGISTER_MUSICIAN] Missing data for musician: ", func_212(iParam0, 0));
		return 0;
	}
	DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_REGISTER_MUSICIAN] Registering ", func_212(iParam0, 0));
	iVar6 = 4;
	iVar5 = 0;
	while (iVar5 < 4)
	{
	...
	if (iVar6 == 4)
	{
		DEBUG::_0x83407B92D46F25C3(40, 139, "[NET_REGISTER_MUSICIAN] Too many musicians in this region! We can't find a slot for ", func_212(iParam0, 0));
		return 0;
	}
	Global_1051777.f_4435[iVar6 /*8*/] = iParam0;
	Global_1051777.f_4435[iVar6 /*8*/].f_6 = func_210(bVar0, cVar2, uVar1, 0, 0, 0);
	...
	iVar7 = 0;
	iVar8 = 0;
	if (func_213(iParam0, &iVar7, &iVar8))
	{
		Global_1051777.f_4435[iVar6 /*8*/].f_3 = iVar7;
		Global_1051777.f_4435[iVar6 /*8*/].f_4 = iVar8;
	}
	DEBUG::_0xF0783374333FD8CE(10920, 139, "[NET_REGISTER_MUSICIAN] Creating scenario point: ", HUD::_GET_LABEL_TEXT_BY_HASH(bVar0), " for musician: ", func_212(iParam0, 0), " at: ", MISC::_0x6C4DBF553885F9EB(cVar2));
	return 1;
}
...
bool func_134(int iParam0, bool bParam1)
{
	...
	if (!PERSCHAR::_0x800DF3FC913355F3(func_135(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - Checking if ", func_136(iParam0), " is alive when the perschar index is not created.");
		return false;
	}
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_214(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_136(iParam0), " does not have a ped spawned.");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(2216, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_136(iParam0), " being processed - ALIVE = ", !PERSCHAR::_0xEB98B38CA60742D7(func_135(iParam0)), "!");
...
void func_141(int iParam0)
{
	...
	if (!LAW::_0xC7DC5A0A7DF608CB(func_217(1)))
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 11, "UPDATE_TOWN_MOB_MANAGER - Can't launch because our town mob flag is not set");
		return;
	}
	if (func_218(0, 0, 1))
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 11, "UPDATE_TOWN_MOB_MANAGER - Can't launch because some content is running");
		return;
	}
	if (func_204(func_114(iParam0, 3)))
	{
		if (func_219(Global_33, Global_1915867.f_3[3 /*447*/].f_10, 1) > 80f)
		{
			DEBUG::_0x1B08D1EB9D8C4931(8, 11, "UPDATE_TOWN_MOB_MANAGER - Can't launch because we're too far from the general store");
			return;
		}
	}
	if (func_204(func_114(iParam0, 0)))
	{
		if (func_219(Global_33, Global_1915867.f_3[0 /*447*/].f_10, 1) > 100f)
		{
			DEBUG::_0x1B08D1EB9D8C4931(8, 11, "UPDATE_TOWN_MOB_MANAGER - Can't launch because we're too far from the doctor");
			return;
		}
	}
	func_220(1, iParam0);
...
void func_143(bool bParam0, char* sParam1, bool bParam2, bool bParam3)
{
	if (func_122(bParam0))
	{
...
void func_144(bool bParam0, bool bParam1)
{
	if (func_122(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 2 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "LOCK_DOOR_ID - Locking Door ID ", func_145(bParam0, 0));
		}
	}
	else
	{
...
void func_146(bool bParam0, bool bParam1)
{
	if (func_122(bParam0))
	{
		...
		{
			DEBUG::_0x1B08D1EB9D8C4931(2216, 183, "SET_DOOR_ID_LOCKED_AND_UNBREAKABLE - Door ID ", func_145(bParam0, 0), " state = ", OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0), " pending state ", UNK_0x4BC2854478F3A749(bParam0));
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(bParam0, 1);
		}
	}
	else
...
void func_147(bool bParam0, bool bParam1)
{
	if (func_122(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 0 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "UNLOCK_DOOR_ID - Unlocking Door ID ", func_145(bParam0, 0));
		}
	}
	else
	{
...
var func_153(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case joaat("RIOBRAVO"):
...
char* func_155(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893599.f_162)))
	{
		sVar0 = func_223(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_225(func_224(Global_34));
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		if (!func_226(iParam0) || func_227(44))
		{
			switch (iParam0)
			{
				case 2:
...
int func_158(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_228(PLAYER::PLAYER_ID()) };
...
char* func_167(char* sParam0, int iParam1)
{
	if (iParam1 == joaat("COLOR_PURE_WHITE"))
	{
		return MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0);
	}
	return func_229(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}

var func_168(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	var uVar16;
...
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_230(iParam1, 0));
}
...
{
	DEBUG::_0x4DC69742196F818A(40, 195, "CLEAR_SALOON: Clearing ", func_231(iParam0));
	func_232(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_233(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
	...
	func_234(iParam0, 8192);
	func_234(iParam0, 32768);
	func_234(iParam0, 524288);
	func_234(iParam0, 1048576);
...
void func_174(int iParam0)
{
	...
	if (func_106(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_235(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_236(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_237(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_238(iParam0, 536870912);
	iVar1 = func_239(iParam0);
	if (iVar1 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(2216, 139, "[SHOP_UNLOCK_DOORS] Shop: ", func_120(iParam0, 0), " door count is greater then the. Current door count: ", iVar1, " Max door count: ", 15);
		Global_1915867.f_3[iParam0 /*447*/].f_409 = 0;
	}
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_198(Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
	...
	DEBUG::_0xF0783374333FD8CE(168, 139, "[CLEAR_SHOP] Shop: ", func_120(iParam0, 0), " has been cleared!");
}
...
int func_176(int iParam0, bool bParam1)
{
	if (!func_106(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_136(iParam0), " is invalid");
		return 0;
	}
	if (!func_175(iParam0, 2))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_136(iParam0), " has not been initialized");
		return 0;
	}
	if (func_181(iParam0) == 0)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_136(iParam0), " doesn't exist");
		return 1;
	}
	if (!PERSCHAR::_0x800DF3FC913355F3(func_135(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_136(iParam0), " already destroyed");
		return 1;
	}
	if (func_175(iParam0, 1) && !bParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_136(iParam0), " is stolen, so it will be destoyed on release.");
		func_241(iParam0, 128);
		return 1;
	}
	func_183(iParam0, 129);
	func_242(iParam0);
	DEBUG::_0xA308F935BDECCEC0(40, 138, "DESTROY_REGIONAL_CHARACTER: Destroying ", func_136(iParam0));
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_135(iParam0));
	func_182(iParam0, 0);
	DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: ", func_136(iParam0), " destroyed.");
	return 1;
}
...
void func_179()
{
	...
	while (iVar0 <= 3)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ NET_CLEAR_BARTENDERS - Removed ", func_244(Global_1051777.f_3642[iVar0 /*19*/]));
...
void func_183(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_245(iParam1), " on ", func_136(iParam0));
}
...
bool func_184(int iParam0)
{
	...
	if (!func_175(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_136(iParam0), " has not been initialized");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(40, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_136(iParam0));
	return true;
}
...
{
	if (func_247(&(Global_1102630.f_4), iParam0, 5))
	{
		DEBUG::_0xF0783374333FD8CE(680, 36, "CLEAR_NET_PLAYER_STATUS_FLAG - ", func_248(iParam0), " cleared by thread ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
		return 1;
	}
	return 0;
}
...
{
	func_249(iParam0);
	DEBUG::_0xF0783374333FD8CE(40, 37, "NET_SPECIAL_CAM__KILL - Setting new display to ", func_250(iParam0, 0));
	if (!func_251(1))
	{
	...
	else if (!func_252(128) && !func_253(19))
	{
		CAM::DO_SCREEN_FADE_OUT(iParam2);
	}
	if (bParam3 && func_254() == 4)
	{
...
{
	if (func_256(&(Global_1102630.f_4), iParam0, 5))
	{
		DEBUG::_0xF0783374333FD8CE(680, 36, "SET_NET_PLAYER_STATUS_FLAG - ", func_248(iParam0), " set by thread ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
		return 1;
	}
	return 0;
}
...
void func_193(struct<30> Param0, int iParam30)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, iParam30, "             outer.eType                     - ", func_257(Param0.f_17.f_9, 0));
	if (Param0.f_16)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, iParam30, "             inner.eType                     - ", func_257(Param0.f_6.f_9, 0));
	}
...
void func_194(struct<7> Param0, var uParam7, var uParam8, int iParam9)
{
...
void func_197(int iParam0, int iParam1)
{
	if (func_196(iParam0, iParam1))
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_113(iParam0), " flag ", func_206(iParam1));
	}
...
{
	if (func_122(bParam0) && func_258())
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 183, "RELEASE_DOOR_ID - Releasing Door ID ", func_145(bParam0, 0));
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_FLAGS] ", func_113(iParam0));
	Global_1051777.f_80[iParam0 /*75*/].f_49 = 0;
}

bool func_201(int iParam0, int iParam1)
{
	return func_259(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}

void func_202(int iParam0)
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_SUPPORT_FLAGS] ", func_113(iParam0));
...
int func_205(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1139844.f_7) && !func_261(12, func_260(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
int func_209(int iParam0, char* sParam1, bool bParam2, char* sParam3, bool bParam4, char* sParam5, char* sParam6)
{
	struct<4> Var0;

	Var0 = func_263();
	Var0.f_2 = -738708473;
	Var0.f_3 = func_260(iParam0);
	if (!DATAFILE::_DATAFILE_GET_DATA_NODE_INDEX(&(Var0.f_1), &Var0))
	{
		DEBUG::_0x4DC69742196F818A(40, 139, "[NET_GET_SHOP_AUTHOR_DATA_WITH_STRING] Could not fill out region node for: ", func_244(iParam0));
		return 0;
	}
	Var0.f_2 = -1407851228;
	...
	DEBUG::_0x4DC69742196F818A(1747624, 139, "[NET_GET_SHOP_AUTHOR_DATA_WITH_STRING] eShop = ", func_244(iParam0), ", ", sParam5, " = ", MISC::_0x6C4DBF553885F9EB(*sParam6), ", ", sParam3, " = ", *bParam4);
	return 1;
}

int func_210(bool bParam0, char[12] cParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
bool func_213(int iParam0, int iParam1, int iParam2)
{
	...
	if (!DATAFILE::_DATAFILE_GET_DATA_NODE_INDEX(&(Var0.f_1), &Var0))
	{
		DEBUG::_0x4DC69742196F818A(40, 139, "[NET_GET_MUSICIAN_OPEN_CLOSE_TIME] Could not fill out region node for: ", func_244(iParam0));
		return false;
	}
	Var0.f_2 = 110382701;
	...
	DEBUG::_0x4DC69742196F818A(2216, 139, "[NET_GET_MUSICIAN_OPEN_CLOSE_TIME] Musician = ", func_244(iParam0), " runs through ", *iParam1, " ~ ", *iParam2);
	return true;
}
...
{
	DEBUG::_0x1B08D1EB9D8C4931(8, 11, "CAN_LAUNCH_NEW_REGION_LAW_SCRIPT - No! We're not in SP");
	return false;
}
...
bool func_218(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_264(func_59(0)))
	{
		return true;
	}
...
char* func_223(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
void func_234(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 195, "CLEAR_SALOON_CONFIG_FLAG: Clearing flag for ", func_272(iParam1, 0));
	func_273(&(Global_1940170.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_236(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that isnt stolen ", func_136(iParam0));
		return;
	}
	if (!func_175(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release an uninitialized regional character ", func_136(iParam0));
		return;
	}
	if ((!bParam4 && !func_235(iParam0)) && func_274(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that is stolen by a differnt script ", func_136(iParam0));
		return;
	}
	DEBUG::_0xF0783374333FD8CE(680, 138, "RELEASE_REGIONAL_CHARACTER: Regional character ", func_136(iParam0), " released by ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
	func_183(iParam0, 1);
	func_242(iParam0);
	if (func_275(func_181(iParam0)))
	{
		iVar0 = func_135(iParam0);
		if (!PERSCHAR::_0x800DF3FC913355F3(iVar0))
		{
			DEBUG::_0x9A6C65DDDBEC9C52(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character with no perschar index", func_136(iParam0));
			return;
		}
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being retasked ", func_136(iParam0));
	...
	if (func_175(iParam0, 128) && !bParam3)
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being destroyed on release ", func_136(iParam0));
		func_176(iParam0, 0);
	}
}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 139, "CLEAR_ALL_SHOP_TYPE_FLAGS: ", func_113(iParam0));
...
void func_241(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_245(iParam1), " on ", func_136(iParam0));
}
...
void func_242(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar0, false))
		{
			...
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_136(iParam0), " set as no longer needed.");
		}
		else
		{
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_136(iParam0), " was asked to be set as no longer needed, but this script does not own the ped.");
		}
	}
...
bool func_246(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_281(&(Global_1102630.f_4), iVar0, 5);
	}
	if (iParam1 == func_282())
	{
		return func_281(&(Global_1102630.f_4), iVar0, 5);
	...
	{
		return func_281(&(Global_1100880[iParam1 /*53*/].f_4), iVar0, 5);
	}
...
bool func_261(int iParam0, char* sParam1, var uParam2)
{
	var uVar0;

	if (func_284(iParam0, sParam1, &uVar0))
	{
		func_285(&uVar0, iParam0, uParam2);
	}
	else
	{
...
bool func_266()
{
	...
	if (!func_264(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_269(vector3 vParam0, int iParam3)
{
	...
	func_289(iParam3, &vVar0, &Var3, &uVar6);
	if (func_290(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
...
bool func_284(int iParam0, char* sParam1, bool bParam2)
{
...
void func_285(bool bParam0, int iParam1, var uParam2)
{
	var uVar0;
...
bool func_290(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
...
int func_291(int iParam0)
{
	...
	DEBUG::_0xD9911C7B5F8CD69C(168, 139, "GET_SHOP_TYPE_FROM_SHOP - ", func_212(iParam0, 0), " undefined");
	return -1;
}
