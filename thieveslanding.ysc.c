	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_28)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_77(iLocal_28));
...
void func_59(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	func_99(iParam0, 1);
	DEBUG::_0xF0783374333FD8CE(40, 139, "NET_ENABLE_SHOP_LOCATION: Registering ", func_100(iParam0));
	Global_1051777.f_80[iParam0 /*75*/] = 0;
	Global_1051777.f_80[iParam0 /*75*/].f_18 = func_101(iParam2, iParam0);
...
int func_60(int iParam0, bool bParam1)
{
	...
	if ((func_106(iParam0, 16384) || func_106(iParam0, 32768)) || func_107(Global_1051777.f_80[iParam0 /*75*/].f_3))
	{
	...
	iVar0 = func_101(func_108(), iParam0);
	if ((!bParam1 && func_109(iVar0, &bVar1, &uVar2, &vVar3)) || (bParam1 && func_110(iVar0, &bVar1, &uVar2, &vVar3)))
	{
		func_111(iParam0, bVar1, vVar3, uVar2, 0);
...
void func_63()
{
	DEBUG::_0x1B08D1EB9D8C4931(8, 11, "MANAGE_BOAT_INTERIOR");
	if (!Local_21.f_1)
	{
		if ((MISC::GET_FRAME_COUNT() % 10) == 0)
		{
			DEBUG::_0x1B08D1EB9D8C4931(8, 11, "MANAGE_BOAT_INTERIOR - searching for water entity");
			Local_21.f_3 = ENTITY::_0x66B2B83B94B22458(joaat("A_WATER_LMR_L_INSIDE_SHIP"));
			if (ENTITY::DOES_ENTITY_EXIST(Local_21.f_3))
			{
				DEBUG::_0x1B08D1EB9D8C4931(8, 11, "MANAGE_BOAT_INTERIOR - making water entity invisible");
	...
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 11, "MANAGE_BOAT_INTERIOR - creating volume as it doesn't exist");
		func_53(&Local_21, -1355.28f, -2296.67f, 40.62f, 0f, 0f, 0f, 6f, 5f, 3f, "HTL_VOLUME_BOAT_INTERIOR");
	}
	if (Local_21.f_2)
	{
		if (!func_113(PLAYER::PLAYER_PED_ID(), Local_21, 0, 1))
		{
			DEBUG::_0x1B08D1EB9D8C4931(8, 11, "MANAGE_BOAT_INTERIOR - left interior, calling ENABLE_WATER_LOOKUP");
			WATER::_ENABLE_WATER_COLLISION();
			Local_21.f_2 = 0;
		}
		else
		{
			DEBUG::_0x1B08D1EB9D8C4931(8, 11, "MANAGE_BOAT_INTERIOR - inside interior, calling DISABLE_WATER_LOOKUP");
			WATER::_DISABLE_WATER_COLLISION();
		}
	}
	else if (func_113(PLAYER::PLAYER_PED_ID(), Local_21, 0, 1))
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 11, "MANAGE_BOAT_INTERIOR - entered interior, calling DISABLE_WATER_LOOKUP every frame from now until we leave");
		WATER::_DISABLE_WATER_COLLISION();
		Local_21.f_2 = 1;
	}
}
...
void func_71(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_61(iParam0) && func_87(iParam0, 16777216)) && !Global_1893599.f_9)
	{
...
void func_98(bool bParam0, bool bParam1)
{
	...
	if (func_107(ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), false, false)))
	{
...
void func_99(int iParam0, bool bParam1)
{
	...
	if (!bVar0 && !func_106(iParam0, 65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] - Shop keeper deleted for shop: ", func_100(iParam0));
		}
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] Remove the script created scenario for: ", func_100(iParam0));
		if (TASK::_DOES_SCENARIO_POINT_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_6))
		{
	...
	func_168(iParam0);
	if (func_106(iParam0, 262144))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 139, "NET_CLEAR_SHOP: SPF_ALLOW_BLIP_OUT_OF_REGION for ", func_100(iParam0), " is kept; all other flags cleared.");
...
void func_104(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_SET_SHOP_TYPE_FLAG] ", func_100(iParam0), " flag ", func_175(iParam1));
	}
...
bool func_109(int iParam0, bool bParam1, bool bParam2, char* sParam3)
{
	return func_176(iParam0, "sHash", bParam1, "fHeading", bParam2, "vPos", sParam3);
}

bool func_110(int iParam0, bool bParam1, bool bParam2, char* sParam3)
{
	return func_176(iParam0, "sClosedHash", bParam1, "fClosedHeading", bParam2, "vClosedPos", sParam3);
}

void func_111(int iParam0, bool bParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	if (bParam6)
	{
		MISC::GET_GROUND_Z_FOR_3D_COORD(vParam2, &(vParam2.f_2), false);
	}
	Global_1051777.f_80[iParam0 /*75*/].f_6 = func_177(bParam1, vParam2, uParam5, 0, 0, 0);
...
bool func_113(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, iParam2, "IS_ENTITY_IN_VOLUME_SAFE: entity is dead");
		return false;
	}
	if (!VOLUME::_DOES_VOLUME_EXIST(iParam1))
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, iParam2, "IS_ENTITY_IN_VOLUME_SAFE: Invalid volume passed into IS_ENTITY_IN_VOLUME_SAFE");
		return false;
	}
...
{
	if ((iParam0 == 22 || iParam0 == 39) && !func_178())
	{
		return true;
	}
	if (iParam0 == 66)
...
char* func_120(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_181(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_183(func_182(Global_34));
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		if (!func_184(iParam0) || func_185(44))
		{
			switch (iParam0)
			{
				case 2:
...
int func_123(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_186(PLAYER::PLAYER_ID()) };
...
void func_135(var uParam0, int iParam1)
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_188(iParam1, 0));
}
...
{
	DEBUG::_0x4DC69742196F818A(40, 195, "CLEAR_SALOON: Clearing ", func_189(iParam0));
	func_190(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_191(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
...
void func_139(int iParam0)
{
	...
	if (func_92(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_193(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_194(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_195(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_196(iParam0, 536870912);
...
void func_144()
{
	...
	while (iVar0 <= 3)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ NET_CLEAR_BARTENDERS - Removed ", func_202(Global_1051777.f_3642[iVar0 /*19*/]));
...
void func_150(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_204(iParam1), " on ", func_146(iParam0));
}
...
{
	return func_205(Param0, 5, 8);
}

bool func_153(int iParam0)
{
	return func_206(1, iParam0);
}
...
{
	if (func_207(&(Global_1102630.f_4), iParam0, 5))
	{
		DEBUG::_0xF0783374333FD8CE(680, 36, "CLEAR_NET_PLAYER_STATUS_FLAG - ", func_208(iParam0), " cleared by thread ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
		return 1;
	}
	return 0;
}
...
{
	func_209(iParam0);
	DEBUG::_0xF0783374333FD8CE(40, 37, "NET_SPECIAL_CAM__KILL - Setting new display to ", func_210(iParam0, 0));
	if (!func_211(1))
	{
...
int func_157(int iParam0)
{
	...
	{
		DEBUG::_0xF0783374333FD8CE(680, 36, "SET_NET_PLAYER_STATUS_FLAG - ", func_208(iParam0), " set by thread ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
		return 1;
	}
	return 0;
}
...
void func_160(struct<30> Param0, int iParam30)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, iParam30, "             outer.eType                     - ", func_217(Param0.f_17.f_9, 0));
	if (Param0.f_16)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, iParam30, "             inner.eType                     - ", func_217(Param0.f_6.f_9, 0));
	}
...
void func_165(int iParam0, int iParam1)
{
	if (func_164(iParam0, iParam1))
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_100(iParam0), " flag ", func_175(iParam1));
	}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_FLAGS] ", func_100(iParam0));
	Global_1051777.f_80[iParam0 /*75*/].f_49 = 0;
}

bool func_170(int iParam0, int iParam1)
{
	return func_221(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}

void func_171(int iParam0)
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_SUPPORT_FLAGS] ", func_100(iParam0));
...
int func_174(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1139844.f_7) && !func_223(12, func_222(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
int func_176(int iParam0, char* sParam1, bool bParam2, char* sParam3, bool bParam4, char* sParam5, char* sParam6)
{
	struct<4> Var0;

	Var0 = func_225();
	Var0.f_2 = -738708473;
	Var0.f_3 = func_222(iParam0);
	if (!DATAFILE::_DATAFILE_GET_DATA_NODE_INDEX(&(Var0.f_1), &Var0))
	{
		DEBUG::_0x4DC69742196F818A(40, 139, "[NET_GET_SHOP_AUTHOR_DATA_WITH_STRING] Could not fill out region node for: ", func_202(iParam0));
		return 0;
	}
	Var0.f_2 = -1407851228;
	...
	DEBUG::_0x4DC69742196F818A(1747624, 139, "[NET_GET_SHOP_AUTHOR_DATA_WITH_STRING] eShop = ", func_202(iParam0), ", ", sParam5, " = ", MISC::_0x6C4DBF553885F9EB(*sParam6), ", ", sParam3, " = ", *bParam4);
	return 1;
}

int func_177(bool bParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
bool func_180(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_228(func_57(0)))
	{
		return true;
	}
...
char* func_181(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
void func_192(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 195, "CLEAR_SALOON_CONFIG_FLAG: Clearing flag for ", func_233(iParam1, 0));
	func_234(&(Global_1940170.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_194(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	...
	if ((!bParam4 && !func_193(iParam0)) && func_235(iParam0))
	{
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 139, "CLEAR_ALL_SHOP_TYPE_FLAGS: ", func_100(iParam0));
...
void func_199(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_204(iParam1), " on ", func_146(iParam0));
}
...
bool func_205(struct<2> Param0, int iParam2, int iParam3)
{
	int iVar0;
...
bool func_223(int iParam0, char* sParam1, var uParam2)
{
	var uVar0;

	if (func_249(iParam0, sParam1, &uVar0))
	{
...
bool func_226()
{
	...
	if (!func_228(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_230(vector3 vParam0, int iParam3)
{
	...
	func_253(iParam3, &vVar0, &Var3, &uVar6);
	if (func_254(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
...
bool func_249(int iParam0, char* sParam1, bool bParam2)
{
	*bParam2 = Global_1139844.f_7;
	bParam2->f_2 = 1351168281;
	bParam2->f_3 = func_258(iParam0);
	bParam2->f_4 = sParam1;
...
void func_250(bool bParam0, int iParam1, var uParam2)
{
	var uVar0;
	...
	*uParam2 = iParam1;
	...
	{
		DEBUG::_0x83407B92D46F25C3(648, 84, "RETRIEVE_UNLOCK_DATA - Couldn't retrieve id at index ", uParam2->f_1, " of type ", func_259(iParam1, 0));
	}
	bParam0->f_2 = -2140901307;
...
bool func_254(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
...
bool func_260(struct<2> Param0, bool bParam2)
{
	if (!func_228(Param0))
	{
		return false;
