...
bool func_40(int iParam0)
{
	if (!bLocal_21)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_19))
		{
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_19))
			{
				if (!DECORATOR::DECOR_EXIST_ON(iLocal_19, "HAS_VOICE") || !DECORATOR::DECOR_GET_BOOL(iLocal_19, "HAS_VOICE"))
				{
					...
					DEBUG::_0x4DC69742196F818A(168, 17, "Ped voice for character: ", func_61(651), " IS VALID.");
		...
		{
			iLocal_19 = func_62(651);
			DEBUG::_0x4DC69742196F818A(168, 17, "Attempting to set ", func_61(651), " ped index failed; entity does not exist yet.");
		}
	}
	if (!bLocal_20)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_18))
		{
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_18))
			{
				if (!DECORATOR::DECOR_EXIST_ON(iLocal_18, "HAS_VOICE") || !DECORATOR::DECOR_GET_BOOL(iLocal_18, "HAS_VOICE"))
				{
					...
					DEBUG::_0x4DC69742196F818A(168, 17, "Ped voice for character: ", func_61(652), " IS VALID.");
		...
		{
			iLocal_18 = func_62(652);
			DEBUG::_0x4DC69742196F818A(168, 17, "Attempting to set ", func_61(652), " ped index failed; entity does not exist yet.");
		}
	}
	return true;
}
...
bool func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_31)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_76(iLocal_31));
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_77(iLocal_31, 0), 1);
					break;
			}
		}
		if (func_10(func_69()))
	...
	else
	{
		...
		if (func_45() == -1)
		{
			func_81(iLocal_31);
			func_82(iLocal_31);
			if (!func_83(iLocal_31, 0))
			{
				return false;
			}
		}
		else if (!func_84(iLocal_31))
		{
			return false;
		}
	}
...
void func_70(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_59(iParam0) && func_86(iParam0, 16777216)) && !Global_1893599.f_9)
	{
...
int func_93(int iParam0, bool bParam1)
{
	if (!func_91(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_61(iParam0), " is invalid");
		return 0;
	}
	if (!func_126(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_61(iParam0), " has not been initialized");
		return 0;
	}
	if (func_126(iParam0, 32) && !bParam1)
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_61(iParam0), " has been locked dead");
		...
		if (func_45() == -1)
		{
			if (func_126(iParam0, 2048))
			{
				...
				DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_61(iParam0), " has been revived!");
			}
	...
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_61(iParam0), " dead or not spawning, turn scenario groups off");
		return 0;
	}
	if (PERSCHAR::_0x800DF3FC913355F3(func_97(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Persistent character ", func_61(iParam0), " already exists");
		func_135(iParam0, 128);
		return 1;
	}
	func_134(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_133(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_97(iParam0));
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_61(iParam0), " perschar index created!");
	if (func_126(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_97(iParam0));
		func_135(iParam0, 2048);
	...
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_61(iParam0), " created.");
...
void func_125(int iParam0)
{
	...
	if (func_91(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_153(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
...
int func_127(int iParam0, bool bParam1)
{
	if (!func_91(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_61(iParam0), " is invalid");
		return 0;
	}
	if (!func_126(iParam0, 2))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_61(iParam0), " has not been initialized");
		return 0;
	}
	if (func_133(iParam0) == 0)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_61(iParam0), " doesn't exist");
		return 1;
	}
	if (!PERSCHAR::_0x800DF3FC913355F3(func_97(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_61(iParam0), " already destroyed");
		return 1;
	}
	if (func_126(iParam0, 1) && !bParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_61(iParam0), " is stolen, so it will be destoyed on release.");
		func_161(iParam0, 128);
		return 1;
	}
	func_135(iParam0, 129);
	func_162(iParam0);
	DEBUG::_0xA308F935BDECCEC0(40, 138, "DESTROY_REGIONAL_CHARACTER: Destroying ", func_61(iParam0));
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_97(iParam0));
	func_134(iParam0, 0);
	DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: ", func_61(iParam0), " destroyed.");
	return 1;
}
...
void func_135(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_176(iParam1), " on ", func_61(iParam0));
}
...
bool func_136(int iParam0)
{
	...
	if (!func_126(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_61(iParam0), " has not been initialized");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(40, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_61(iParam0));
	return true;
}
...
void func_154(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that isnt stolen ", func_61(iParam0));
		return;
	}
	if (!func_126(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release an uninitialized regional character ", func_61(iParam0));
		return;
	}
	if ((!bParam4 && !func_153(iParam0)) && func_186(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that is stolen by a differnt script ", func_61(iParam0));
		return;
	}
	DEBUG::_0xF0783374333FD8CE(680, 138, "RELEASE_REGIONAL_CHARACTER: Regional character ", func_61(iParam0), " released by ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
	func_135(iParam0, 1);
	func_162(iParam0);
	if (func_187(func_133(iParam0)))
	{
		...
		if (!PERSCHAR::_0x800DF3FC913355F3(iVar0))
		{
			DEBUG::_0x9A6C65DDDBEC9C52(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character with no perschar index", func_61(iParam0));
			return;
		}
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being retasked ", func_61(iParam0));
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being destroyed on release ", func_61(iParam0));
		func_127(iParam0, 0);
	}
}
...
void func_161(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_176(iParam1), " on ", func_61(iParam0));
}
...
void func_162(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar0, false))
		{
			...
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_61(iParam0), " set as no longer needed.");
		}
		else
		{
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_61(iParam0), " was asked to be set as no longer needed, but this script does not own the ped.");
		}
	}
