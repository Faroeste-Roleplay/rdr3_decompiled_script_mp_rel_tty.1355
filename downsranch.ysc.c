...
bool func_13()
{
	iLocal_16 = Global_1887351[73 /*36*/].f_5;
...
{
	func_124(0.775f, 0.2f, 0.025f, 0f);
...
bool func_85(int iParam0, bool bParam1)
{
	...
	if (func_92(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_128(Global_1896632.f_1, 16))
			{
				func_129(Global_1896632.f_1, 0);
			}
			Global_1896632.f_1++;
			iVar2++;
...
void func_124(float fParam0, float fParam1, float fParam2, float fParam3)
{
