...
void __EntryFunction__()
{
	...
	DEBUG::_0xF0783374333FD8CE(43688, 17, "**** INITIALIZING REGION: ", &(Global_1887351[vScriptParam_0.x /*36*/].f_23), ", ", &(Global_1887351[iLocal_30 /*36*/].f_24), ", ", &(Global_1887351[iLocal_30 /*36*/].f_27), " ****");
	func_2();
	func_3();
	...
	while (func_4())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_29)
		{
			...
			{
				case 0:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_30 /*36*/].f_23), " global init...");
					if (Global_1901988.f_1.f_26 > 0)
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_30 /*36*/].f_23), "-> RBS_WAIT_FOR_UGC_EARLY_QUIT");
						iLocal_31 = (MISC::GET_GAME_TIMER() + Global_1901988.f_1.f_26);
						iLocal_28 = 1;
					}
					else
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_30 /*36*/].f_23), "-> RBS_INIT_REGION");
						iLocal_28 = 2;
					}
					break;
				case 1:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_30 /*36*/].f_23), " ugc early quit...");
					...
					break;
				case 2:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_30 /*36*/].f_23), " region init...");
					func_6(iLocal_30);
					func_7();
					func_8();
					...
					Global_1896632 = -1;
					DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_30 /*36*/].f_23), "-> RBS_INIT_VOLUME");
					iLocal_31 = (iLocal_27 + MISC::GET_GAME_TIMER());
					iLocal_28 = 3;
					break;
				case 3:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_30 /*36*/].f_23), " volume init...");
					if (func_13() || iLocal_31 < MISC::GET_GAME_TIMER())
					{
						func_14(iLocal_30);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_30 /*36*/].f_23), "-> RBS_LOAD_APPEARANCE");
						iLocal_31 = (MISC::GET_GAME_TIMER() + iLocal_27);
						iLocal_28 = 4;
					}
					break;
				case 4:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_30 /*36*/].f_23), " load appearance...");
					if (func_15(iLocal_30) || iLocal_31 < MISC::GET_GAME_TIMER())
					{
						func_16(iLocal_30);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_30 /*36*/].f_23), "-> RBS_LOAD_SPECIAL");
						iLocal_31 = (MISC::GET_GAME_TIMER() + iLocal_27);
						iLocal_28 = 5;
					}
					break;
				case 5:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_30 /*36*/].f_23), " load special...");
					if (func_17(iLocal_30) || iLocal_31 < MISC::GET_GAME_TIMER())
					{
						func_18(iLocal_30);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_30 /*36*/].f_23), "-> RBS_LOAD_PERS_CHARS");
						iLocal_31 = (iLocal_27 + MISC::GET_GAME_TIMER());
						iLocal_28 = 7;
					}
					break;
				case 7:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_30 /*36*/].f_23), " init regional chars...");
					if (func_10(func_9(iLocal_30)))
					{
						...
						else
						{
							if (func_20(iLocal_30) || iLocal_31 < MISC::GET_GAME_TIMER())
							{
								func_21(iLocal_30, 4);
								iLocal_31 = (MISC::GET_GAME_TIMER() + iLocal_27);
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_30 /*36*/].f_23), "-> RBS_INIT_AMBIENT");
								iLocal_28 = 8;
							}
							...
							{
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_30 /*36*/].f_23), " AMBIENT MINIGAMES ARE NOT BEING ENABLED AS A STORY OR RCM OR MISSION RETRY IS HAPPENING");
							}
							func_26();
							func_27();
							func_28();
							...
							func_31();
							func_32();
							DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": INIT_CURRENT_REGION_TOWN_DATA FOR ", &(Global_1887351[iLocal_30 /*36*/].f_23));
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_30 /*36*/].f_23), " RBS_INIT_AMBIENT -> RBS_INIT_LAW");
							iLocal_28 = 9;
							Jump @1356; //curOff = 1032
							func_33(iLocal_30);
							func_34();
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_30 /*36*/].f_23), "-> RBS_INIT_NAMED_LOCATIONS");
							iLocal_28 = 10;
							Jump @1356; //curOff = 1070
							func_35(&Global_1896686);
							func_36(iLocal_30, &Global_1896686);
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_30 /*36*/].f_23), "-> RBS_DONE_INIT");
							iLocal_28 = 11;
							Jump @1356; //curOff = 1116
							DEBUG::_0xF0783374333FD8CE(168, 17, "**** FINISHED INITIALIZING: ", &(Global_1887351[iLocal_30 /*36*/].f_23), " ****");
							func_37(iLocal_30);
							func_21(iLocal_30, 8);
							if (func_38(32))
							{
							...
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_30 /*36*/].f_23), "-> RBS_RUNNING");
							iLocal_28 = 12;
							...
							func_41(&Global_1896686, iLocal_30);
							func_42(iLocal_30);
							func_21(iLocal_30, 8);
							if (func_43())
							{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887351[iLocal_30 /*36*/].f_11);
							if (Global_1887351[iLocal_30 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887351[iLocal_30 /*36*/].f_12);
							}
							Jump @1356; //curOff = 1312
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_30 /*36*/].f_23), " RBS_CLEANUP");
							func_8();
							func_44(iVar0);
							iVar0++;
						}
						if (Global_1887351[iLocal_30 /*36*/].f_13 == 0)
						{
						}
						else
						{
							PED::_0x95423627A9CA598E(Global_1887351[iLocal_30 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
...
bool func_1()
{
	if (!bLocal_32)
	{
		if (Global_1051140)
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_30 /*36*/].f_23), ", g_mpUGC_QuitSessionRequest.bRequestRunning is still true");
			bLocal_32 = true;
			return true;
		}
		if (func_47() && func_48())
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_30 /*36*/].f_23), ", a session request is running and a UGC script is running");
			bLocal_32 = true;
			return true;
		}
	...
	if (func_48())
	{
		DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_30 /*36*/].f_23), ", content script still running for some player");
		return true;
	}
...
bool func_13()
{
	...
	iLocal_19 = Global_1887351[3 /*36*/].f_5;
	...
	iLocal_25 = VOLUME::_0x0EB78C2B156635B1(joaat("VOLBOX"), 1964.789f, -528.676f, 41.852f, 0f, 0f, 0f, 1f, 1f, 2f);
	VOLUME::_0xBE551C2CC421185D(iLocal_25, 1);
	VOLUME::_0x5B23DFF8E0948BB2(iLocal_25, 1);
	iLocal_26 = VOLUME::_0x0EB78C2B156635B1(joaat("VOLBOX"), 1966.414f, -528.38f, 41.852f, 0f, 0f, 0f, 3.2f, 7.3f, 2f);
	VOLUME::_0xBE551C2CC421185D(iLocal_26, 1);
	VOLUME::_0x5B23DFF8E0948BB2(iLocal_26, 0);
	return true;
}
...
bool func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": REGION_TOWN_MANANGER_EXIT_TOWN FOR ", &(Global_1887351[iLocal_30 /*36*/].f_23));
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_30)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_80(iLocal_30));
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_81(iLocal_30, 0), 1);
					break;
			}
		}
		if (func_10(func_73()))
	...
	else
	{
		...
		if (func_45() == -1)
		{
			func_85(iLocal_30);
			func_86(iLocal_30);
			if (!func_87(iLocal_30, 0))
			{
				return false;
			}
		}
		else if (!func_88(iLocal_30))
		{
			return false;
		}
	}
	DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": Terminating. -- ", &(Global_1887351[iLocal_30 /*36*/].f_23));
	SCRIPTS::TERMINATE_THIS_THREAD();
	return true;
}
...
int func_59(int iParam0, bool bParam1)
{
	...
	if ((func_109(iParam0, 16384) || func_109(iParam0, 32768)) || func_110(Global_1051777.f_80[iParam0 /*75*/].f_3))
	{
	...
	iVar0 = func_104(func_111(), iParam0);
	if ((!bParam1 && func_112(iVar0, &bVar1, &uVar2, &vVar3)) || (bParam1 && func_113(iVar0, &bVar1, &uVar2, &vVar3)))
	{
		func_114(iParam0, bVar1, vVar3, uVar2, 0);
...
void func_61(int iParam0, int iParam1)
{
	...
	func_116(&(Global_1915867.f_3[iParam0 /*447*/].f_7), iParam1);
}
...
int func_62(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == 0)
	{
		DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_120(iParam0), " IS INVALID.");
		return 0;
	}
	DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_120(iParam0), " IS VALID.");
...
bool func_71(int iParam0)
{
	...
	return ((Global_1887351[iParam0 /*36*/].f_21 == 1 || Global_1887351[iParam0 /*36*/].f_21 == 2) && !func_123(iParam0));
}
...
void func_74(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_125(iParam0, 0), " ", func_126(iParam1, 0), " ", func_127(bParam2, 0), " state ", func_128(iParam4, 0));
	UNK_0x355E72323AEE83CC(11, 6);
	sVar1 = func_129(iParam0, iParam1, bParam2, iParam4, bParam5, bParam3, &bVar0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_125(iParam0, 0), " or ", func_126(iParam1, 0), " or ", func_127(bParam2, 0));
	...
	if (bVar0 && bParam3)
	{
		sVar2 = func_134(func_133(bParam2));
	}
	else if ((func_135(iParam1, 2) || func_136(iParam4, 2)) && !Global_1893599.f_9)
	{
	...
	else if ((func_65(iParam0) && func_90(iParam0, 16777216)) && !Global_1893599.f_9)
	{
	...
	Global_1939313.f_145 = func_142(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
bool func_87(int iParam0, bool bParam1)
{
	...
	if (func_94(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_149(Global_1896632.f_1, 16))
			{
				func_150(Global_1896632.f_1, 0);
			}
			Global_1896632.f_1++;
			iVar2++;
...
bool func_88(int iParam0)
{
	...
	while (iVar0 < 40)
	{
		if (func_151(iVar0) || func_152(iVar0))
		{
		}
		else
		{
...
int func_97(int iParam0, bool bParam1)
{
	if (!func_95(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_120(iParam0), " is invalid");
		return 0;
	}
	if (!func_149(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_120(iParam0), " has not been initialized");
		return 0;
	}
	if (func_149(iParam0, 32) && !bParam1)
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_120(iParam0), " has been locked dead");
		func_156(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_155(iParam0)));
		if (func_45() == -1)
		{
			if (func_149(iParam0, 2048))
			{
				PERSCHAR::_0x49A8C2CD97815215(func_119(iParam0));
				func_157(iParam0, 2048);
				DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_120(iParam0), " has been revived!");
			}
			PERSCHAR::_0xFCC6DB8DBE709BC8(func_119(iParam0));
		}
		return 0;
	}
	if (!func_158(iParam0) && func_45() == -1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_120(iParam0), " dead or not spawning, turn scenario groups off");
		return 0;
	}
	if (PERSCHAR::_0x800DF3FC913355F3(func_119(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Persistent character ", func_120(iParam0), " already exists");
		func_157(iParam0, 128);
		return 1;
	}
	func_156(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_155(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_119(iParam0));
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_120(iParam0), " perschar index created!");
	if (func_149(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_119(iParam0));
		func_157(iParam0, 2048);
	...
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_120(iParam0), " created.");
...
void func_101(bool bParam0, bool bParam1)
{
	...
	else
	{
		...
		func_164(0);
		func_165(&(Global_1102630.f_3849));
		...
		func_166(&(Global_1102630.f_3888));
	...
	func_167(Global_1102630.f_3849, 36);
	func_168(Global_1102630.f_3888, 36);
...
void func_102(int iParam0, bool bParam1)
{
	...
	DEBUG::_0x4DC69742196F818A(40, 139, "NET_CLEAR_SHOP ", func_169(iParam0, 0));
	bVar0 = (func_170(iParam0) && !bParam1);
	...
	else if (func_171(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
	{
	...
	if (iVar3 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "[NET_CLEAR_SHOP] - Shop: ", func_169(iParam0, 0), " current door count exceeds max door count.");
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_174(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar2]);
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_24) && func_177(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_CLEAR_SHOP] Removing relationship volume from shop ", func_169(iParam0, 0));
...
int func_105(int iParam0)
{
	...
	{
		Global_1051777.f_4480[iParam0] = func_181(iParam0);
	}
...
void func_107(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_SET_SHOP_TYPE_FLAG] ", func_103(iParam0), " flag ", func_182(iParam1));
	}
...
bool func_112(int iParam0, int iParam1, float fParam2, char* sParam3)
{
	return func_183(iParam0, "sHash", iParam1, "fHeading", fParam2, "vPos", sParam3);
}

bool func_113(int iParam0, int iParam1, float fParam2, char* sParam3)
{
	return func_183(iParam0, "sClosedHash", iParam1, "fClosedHeading", fParam2, "vClosedPos", sParam3);
}

void func_114(int iParam0, bool bParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	if (bParam6)
	{
		MISC::GET_GROUND_Z_FOR_3D_COORD(vParam2, &(vParam2.f_2), false);
	}
	Global_1051777.f_80[iParam0 /*75*/].f_6 = func_184(bParam1, vParam2, uParam5, 0, 0, 0);
	...
	DEBUG::_0xA308F935BDECCEC0(10920, 139, "[NET_ADD_SHOP_SCENARIO_AT_POINT] Creating scenario point: ", HUD::_GET_LABEL_TEXT_BY_HASH(bParam1), " for shop: ", func_169(iParam0, 0), " at: ", MISC::_0x6C4DBF553885F9EB(vParam2));
}
...
bool func_118(int iParam0, bool bParam1)
{
	...
	if (!PERSCHAR::_0x800DF3FC913355F3(func_119(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - Checking if ", func_120(iParam0), " is alive when the perschar index is not created.");
		return false;
	}
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_186(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_120(iParam0), " does not have a ped spawned.");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(2216, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_120(iParam0), " being processed - ALIVE = ", !PERSCHAR::_0xEB98B38CA60742D7(func_119(iParam0)), "!");
	return !PERSCHAR::_0xEB98B38CA60742D7(func_119(iParam0));
}
...
{
	if ((iParam0 == 22 || iParam0 == 39) && !func_188())
	{
		return true;
	}
	if (iParam0 == 66)
...
char* func_129(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893599.f_162)))
	{
		sVar0 = func_191(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_193(func_192(Global_34));
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		if (!func_194(iParam0) || func_195(44))
		{
			switch (iParam0)
			{
				case 2:
...
int func_132(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_196(PLAYER::PLAYER_ID()) };
...
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_198(iParam1, 0));
}
...
{
	DEBUG::_0x4DC69742196F818A(40, 195, "CLEAR_SALOON: Clearing ", func_199(iParam0));
	func_200(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_201(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
...
void func_148(int iParam0)
{
	...
	if (func_95(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_203(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_204(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_205(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_206(iParam0, 536870912);
	iVar1 = func_207(iParam0);
	if (iVar1 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(2216, 139, "[SHOP_UNLOCK_DOORS] Shop: ", func_169(iParam0, 0), " door count is greater then the. Current door count: ", iVar1, " Max door count: ", 15);
		Global_1915867.f_3[iParam0 /*447*/].f_409 = 0;
	}
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_174(Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
	...
	DEBUG::_0xF0783374333FD8CE(168, 139, "[CLEAR_SHOP] Shop: ", func_169(iParam0, 0), " has been cleared!");
}
...
int func_150(int iParam0, bool bParam1)
{
	if (!func_95(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_120(iParam0), " is invalid");
		return 0;
	}
	if (!func_149(iParam0, 2))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_120(iParam0), " has not been initialized");
		return 0;
	}
	if (func_155(iParam0) == 0)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_120(iParam0), " doesn't exist");
		return 1;
	}
	if (!PERSCHAR::_0x800DF3FC913355F3(func_119(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_120(iParam0), " already destroyed");
		return 1;
	}
	if (func_149(iParam0, 1) && !bParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_120(iParam0), " is stolen, so it will be destoyed on release.");
		func_209(iParam0, 128);
		return 1;
	}
	func_157(iParam0, 129);
	func_210(iParam0);
	DEBUG::_0xA308F935BDECCEC0(40, 138, "DESTROY_REGIONAL_CHARACTER: Destroying ", func_120(iParam0));
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_119(iParam0));
	func_156(iParam0, 0);
	DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: ", func_120(iParam0), " destroyed.");
	return 1;
}
...
void func_153()
{
	...
	while (iVar0 <= 3)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ NET_CLEAR_BARTENDERS - Removed ", func_212(Global_1051777.f_3642[iVar0 /*19*/]));
...
void func_157(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_213(iParam1), " on ", func_120(iParam0));
}
...
bool func_158(int iParam0)
{
	...
	if (!func_149(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_120(iParam0), " has not been initialized");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(40, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_120(iParam0));
	return true;
}

bool func_159(struct<2> Param0)
{
...
void func_167(struct<30> Param0, int iParam30)
{
...
void func_168(struct<7> Param0, var uParam7, var uParam8, int iParam9)
{
...
void func_172(int iParam0, int iParam1)
{
	if (func_171(iParam0, iParam1))
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_103(iParam0), " flag ", func_182(iParam1));
	}
...
{
	if (func_227(bParam0) && func_228())
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 183, "RELEASE_DOOR_ID - Releasing Door ID ", func_229(bParam0, 0));
...
{
	return func_230(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}
...
int func_181(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1139844.f_7) && !func_232(12, func_231(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
int func_183(int iParam0, char* sParam1, int iParam2, char* sParam3, float fParam4, char* sParam5, char* sParam6)
{
	struct<4> Var0;

	Var0 = func_234();
	Var0.f_2 = -738708473;
	Var0.f_3 = func_231(iParam0);
	if (!DATAFILE::_DATAFILE_GET_DATA_NODE_INDEX(&(Var0.f_1), &Var0))
	{
		DEBUG::_0x4DC69742196F818A(40, 139, "[NET_GET_SHOP_AUTHOR_DATA_WITH_STRING] Could not fill out region node for: ", func_212(iParam0));
		return 0;
	}
	Var0.f_2 = -1407851228;
	...
	DEBUG::_0x4DC69742196F818A(1747624, 139, "[NET_GET_SHOP_AUTHOR_DATA_WITH_STRING] eShop = ", func_212(iParam0), ", ", sParam5, " = ", MISC::_0x6C4DBF553885F9EB(*sParam6), ", ", sParam3, " = ", *fParam4);
	return 1;
}

int func_184(bool bParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
bool func_190(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_237(func_56(0)))
	{
		return true;
	}
...
void func_202(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 195, "CLEAR_SALOON_CONFIG_FLAG: Clearing flag for ", func_242(iParam1, 0));
	func_243(&(Global_1940170.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_204(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that isnt stolen ", func_120(iParam0));
		return;
	}
	if (!func_149(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release an uninitialized regional character ", func_120(iParam0));
		return;
	}
	if ((!bParam4 && !func_203(iParam0)) && func_244(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that is stolen by a differnt script ", func_120(iParam0));
		return;
	}
	DEBUG::_0xF0783374333FD8CE(680, 138, "RELEASE_REGIONAL_CHARACTER: Regional character ", func_120(iParam0), " released by ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
	func_157(iParam0, 1);
	func_210(iParam0);
	if (func_245(func_155(iParam0)))
	{
		iVar0 = func_119(iParam0);
		if (!PERSCHAR::_0x800DF3FC913355F3(iVar0))
		{
			DEBUG::_0x9A6C65DDDBEC9C52(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character with no perschar index", func_120(iParam0));
			return;
		}
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being retasked ", func_120(iParam0));
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being destroyed on release ", func_120(iParam0));
		func_150(iParam0, 0);
	}
}
...
void func_209(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_213(iParam1), " on ", func_120(iParam0));
}
...
void func_210(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar0, false))
		{
			...
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_120(iParam0), " set as no longer needed.");
		}
		else
		{
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_120(iParam0), " was asked to be set as no longer needed, but this script does not own the ped.");
		}
	}
...
bool func_232(int iParam0, char* sParam1, var uParam2)
{
	var uVar0;

	if (func_256(iParam0, sParam1, &uVar0))
	{
		func_257(&uVar0, iParam0, uParam2);
	}
	else
	{
...
bool func_235()
{
	...
	if (!func_237(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_239(vector3 vParam0, int iParam3)
{
	vector3 vVar0;
	struct<2> Var3;
	var uVar6;

	func_260(iParam3, &vVar0, &Var3, &uVar6);
	if (func_261(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
...
void func_257(var uParam0, int iParam1, var uParam2)
{
	var uVar0;
	...
	*uParam2 = iParam1;
	...
	{
		DEBUG::_0x83407B92D46F25C3(648, 84, "RETRIEVE_UNLOCK_DATA - Couldn't retrieve id at index ", uParam2->f_1, " of type ", func_266(iParam1, 0));
	}
	uParam0->f_2 = -2140901307;
...
bool func_261(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
...
int func_262(int iParam0)
{
	...
	DEBUG::_0xD9911C7B5F8CD69C(168, 139, "GET_SHOP_TYPE_FROM_SHOP - ", func_250(iParam0, 0), " undefined");
	return -1;
}
...
bool func_267(struct<2> Param0, int iParam2)
{
	if (!func_237(Param0))
	{
		return false;
