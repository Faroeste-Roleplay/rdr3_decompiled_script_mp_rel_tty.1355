...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_34, 0f, 0f, 0f) <= 5f || func_67(Global_1940410, 32768)) || func_67(Global_1940410, 16777216))
	{
		return;
	}
...
bool func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_28)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_80(iLocal_28));
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_81(iLocal_28, 0), 1);
					break;
			}
		}
		if (func_10(func_73()))
	...
	else
	{
		...
		if (func_45() == -1)
		{
			func_85(iLocal_28);
			func_86(iLocal_28);
			if (!func_87(iLocal_28, 0))
			{
				return false;
			}
		}
		else if (!func_88(iLocal_28))
		{
			return false;
		}
	}
...
bool func_49(bool bParam0, bool bParam1)
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		{
			DEBUG::_0xF0783374333FD8CE(168, 8, "KILL_EVENT_CAUGHT - NETWORK_IS_GAME_IN_PROGRESS() = FALSE - but bIgnoreTransition = TRUE and g_mpTransition.eMPState = ", func_89(Global_1572887, 0), ", so skipping");
		}
		else
		{
...
int func_53(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (!func_64(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Region index not valid ", func_91(iParam0));
		return 1;
	}
	if (func_90(iParam0, 16))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: RF_PERS_DISABLED is on for ", func_91(iParam0));
		return 1;
	}
	if (func_92(iParam0) && !func_93(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: IS_REGION_IN_LOCKDOWN is on for ", func_91(iParam0));
	}
	DEBUG::_0xF0783374333FD8CE(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Starting for ", func_91(iParam0));
	if (func_94(iParam0, &iVar0, &iVar1, 0, 0))
	{
		if (func_95(iParam1))
		{
			iVar0 = iParam1;
		...
		while (true)
		{
			if ((!func_92(iParam0) || func_93(iParam0)) || func_96(Global_1896632))
			{
				func_97(Global_1896632, 0);
			}
			Global_1896632++;
			iVar2++;
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	func_102(iParam0, 1);
	DEBUG::_0xF0783374333FD8CE(40, 139, "NET_ENABLE_SHOP_LOCATION: Registering ", func_103(iParam0));
	Global_1051777.f_80[iParam0 /*75*/] = 0;
	Global_1051777.f_80[iParam0 /*75*/].f_18 = func_104(iParam2, iParam0);
...
void func_59(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	if (iVar0 < 0 || iVar0 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(40, 139, "[NET_ADD_SHOP_DOOR] - Invalid door index for shop: ", func_110(iParam0, 0));
		return;
	}
	Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0] = func_111(bParam1, 0, 0);
	if (func_112(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0]))
	{
		if (!func_113(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0]))
		{
			func_114(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar0], 0, fParam2, bParam3, 1, 0, bParam4, 0);
		}
	}
...
{
	DEBUG::_0x4DC69742196F818A(680, 55, "[NET_SHOP_PROPERTY_SET_BIT] Setting bit: ", func_115(iParam1), " for ", func_103(iParam0));
	func_116(&(Global_1051777.f_80[iParam0 /*75*/].f_49), iParam1);
}
...
int func_61(int iParam0, bool bParam1)
{
	...
	iVar0 = func_104(func_119(), iParam0);
	if ((!bParam1 && func_120(iVar0, &bVar1, &uVar2, &vVar3)) || (bParam1 && func_121(iVar0, &bVar1, &uVar2, &vVar3)))
	{
		func_122(iParam0, bVar1, vVar3, uVar2, 0);
...
int func_62(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == 0)
	{
		DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_125(iParam0), " IS INVALID.");
		return 0;
	}
	DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_125(iParam0), " IS VALID.");
...
void func_66(int iParam0, int iParam1, var uParam2)
{
	if (!*uParam2)
	{
		if (func_128(Global_33, iParam1, 0, 1, 0))
		{
	...
	else if (!func_128(Global_33, iParam1, 0, 1, 0))
	{
...
bool func_69()
{
	return func_67(Global_1940410, 8192);
}
...
bool func_71(int iParam0)
{
	...
	return ((Global_1887351[iParam0 /*36*/].f_21 == 1 || Global_1887351[iParam0 /*36*/].f_21 == 2) && !func_132(iParam0));
}
...
void func_74(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	char* sVar1;
	char* sVar2;
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_134(iParam0, 0), " ", func_135(iParam1, 0), " ", func_136(bParam2, 0), " state ", func_137(iParam4, 0));
	UNK_0x355E72323AEE83CC(11, 6);
	sVar1 = func_138(iParam0, iParam1, bParam2, iParam4, bParam5, bParam3, &bVar0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_134(iParam0, 0), " or ", func_135(iParam1, 0), " or ", func_136(bParam2, 0));
	...
	if (!func_139(iParam4))
	{
		if (func_64(iParam0))
		{
			iParam4 = func_140(func_9(iParam0));
		}
		else
		{
	...
	if (bVar0 && bParam3)
	{
		sVar2 = func_143(func_142(bParam2));
	}
	else if ((func_144(iParam1, 2) || func_145(iParam4, 2)) && !Global_1893599.f_9)
	{
	...
	else if ((func_64(iParam0) && func_90(iParam0, 16777216)) && !Global_1893599.f_9)
	{
	...
	Global_1939313.f_145 = func_151(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_76(int iParam0, bool bParam1)
{
	...
	func_153(&Global_1940410, 16384);
	func_131(func_154(joaat("DISCOVERED"), joaat("AREAS")), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_131(func_154(joaat("DISCOVERED"), joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_131(func_154(joaat("DISCOVERED"), joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_131(func_154(joaat("DISCOVERED"), joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_131(func_154(joaat("DISCOVERED"), joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_131(func_154(joaat("DISCOVERED"), joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_131(func_154(joaat("DISCOVERED"), joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
bool func_87(int iParam0, bool bParam1)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 138, "DELETE_ALL_REGIONAL_CHARACTERS starting for Region ", func_91(iParam0));
	if (func_94(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_157(Global_1896632.f_1, 16))
			{
				func_158(Global_1896632.f_1, 0);
			}
			Global_1896632.f_1++;
			iVar2++;
...
bool func_88(int iParam0)
{
	...
	while (iVar0 < 40)
	{
		if (func_159(iVar0) || func_160(iVar0))
		{
		}
		else
		{
	...
	switch (iParam0)
	{
		...
		case 139:
			...
			*iParam2 = 851;
			...
			break;
		default:
			DEBUG::_0xA308F935BDECCEC0(40, 138, "Attempting to get regional character bounds for a region that doesn't have them yet ", func_80(iParam0));
			*iParam1 = -1;
			*iParam2 = -1;
			break;
	}
...
int func_97(int iParam0, bool bParam1)
{
	if (!func_95(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_125(iParam0), " is invalid");
		return 0;
	}
	if (!func_157(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_125(iParam0), " has not been initialized");
		return 0;
	}
	if (func_157(iParam0, 32) && !bParam1)
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_125(iParam0), " has been locked dead");
		func_164(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_163(iParam0)));
		if (func_45() == -1)
		{
			if (func_157(iParam0, 2048))
			{
				PERSCHAR::_0x49A8C2CD97815215(func_124(iParam0));
				func_165(iParam0, 2048);
				DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_125(iParam0), " has been revived!");
			}
			PERSCHAR::_0xFCC6DB8DBE709BC8(func_124(iParam0));
		}
		return 0;
	}
	if (!func_166(iParam0) && func_45() == -1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_125(iParam0), " dead or not spawning, turn scenario groups off");
		return 0;
	}
	if (PERSCHAR::_0x800DF3FC913355F3(func_124(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Persistent character ", func_125(iParam0), " already exists");
		func_165(iParam0, 128);
		return 1;
	}
	func_164(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_163(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_124(iParam0));
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_125(iParam0), " perschar index created!");
	if (func_157(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_124(iParam0));
		func_165(iParam0, 2048);
	...
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_125(iParam0), " created.");
...
void func_101(bool bParam0, bool bParam1)
{
	...
	else
	{
		...
		func_172(0);
		func_173(&(Global_1102630.f_3849));
		...
		func_174(&(Global_1102630.f_3888));
	...
	func_175(Global_1102630.f_3849, 36);
	func_176(Global_1102630.f_3888, 36);
...
void func_102(int iParam0, bool bParam1)
{
	...
	DEBUG::_0x4DC69742196F818A(40, 139, "NET_CLEAR_SHOP ", func_110(iParam0, 0));
	...
	if (!bVar0 && !func_117(iParam0, 65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] - Shop keeper deleted for shop: ", func_103(iParam0));
		}
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] Remove the script created scenario for: ", func_103(iParam0));
		if (TASK::_DOES_SCENARIO_POINT_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_6))
		{
	...
	if (iVar3 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "[NET_CLEAR_SHOP] - Shop: ", func_110(iParam0, 0), " current door count exceeds max door count.");
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_180(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar2]);
	...
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 139, "NET_CLEAR_SHOP: SPF_ALLOW_BLIP_OUT_OF_REGION for ", func_103(iParam0), " is kept; all other flags cleared.");
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_24) && func_183(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_CLEAR_SHOP] Removing relationship volume from shop ", func_110(iParam0, 0));
...
int func_105(int iParam0)
{
	...
	{
		Global_1051777.f_4480[iParam0] = func_187(iParam0);
	}
...
void func_107(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_SET_SHOP_TYPE_FLAG] ", func_103(iParam0), " flag ", func_188(iParam1));
	}
...
bool func_111(bool bParam0, bool bParam1, bool bParam2)
{
...
void func_114(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	func_111(bParam0, 0, 0);
	if (func_112(bParam0))
	{
		...
		if (bParam3)
		{
			func_191(bParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
bool func_120(int iParam0, bool bParam1, bool bParam2, char* sParam3)
{
	return func_197(iParam0, "sHash", bParam1, "fHeading", bParam2, "vPos", sParam3);
}

bool func_121(int iParam0, bool bParam1, bool bParam2, char* sParam3)
{
	return func_197(iParam0, "sClosedHash", bParam1, "fClosedHeading", bParam2, "vClosedPos", sParam3);
}

void func_122(int iParam0, bool bParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	if (bParam6)
	{
		MISC::GET_GROUND_Z_FOR_3D_COORD(vParam2, &(vParam2.f_2), false);
	}
	Global_1051777.f_80[iParam0 /*75*/].f_6 = func_198(bParam1, vParam2, uParam5, 0, 0, 0);
	...
	func_107(iParam0, 16384);
	DEBUG::_0xA308F935BDECCEC0(10920, 139, "[NET_ADD_SHOP_SCENARIO_AT_POINT] Creating scenario point: ", HUD::_GET_LABEL_TEXT_BY_HASH(bParam1), " for shop: ", func_110(iParam0, 0), " at: ", MISC::_0x6C4DBF553885F9EB(vParam2));
}
...
bool func_123(int iParam0, bool bParam1)
{
	...
	if (!PERSCHAR::_0x800DF3FC913355F3(func_124(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - Checking if ", func_125(iParam0), " is alive when the perschar index is not created.");
		return false;
	}
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_199(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_125(iParam0), " does not have a ped spawned.");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(2216, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_125(iParam0), " being processed - ALIVE = ", !PERSCHAR::_0xEB98B38CA60742D7(func_124(iParam0)), "!");
...
bool func_128(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
...
struct<2> func_130(int iParam0)
{
	...
	return func_154(joaat("VISITED"), iVar0);
}
...
{
	if ((iParam0 == 22 || iParam0 == 39) && !func_202())
	{
		return true;
	}
	if (iParam0 == 66)
...
var func_136(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case joaat("RIOBRAVO"):
...
char* func_138(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893599.f_162)))
	{
		sVar0 = func_205(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_207(func_206(Global_34));
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		if (!func_208(iParam0) || func_209(44))
		{
			switch (iParam0)
			{
				case 2:
...
int func_141(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_210(PLAYER::PLAYER_ID()) };
...
char* func_150(char* sParam0, int iParam1)
{
	...
	return func_211(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_212(iParam1, 0));
}
...
{
	DEBUG::_0x4DC69742196F818A(40, 195, "CLEAR_SALOON: Clearing ", func_213(iParam0));
	func_214(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_215(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
...
void func_156(int iParam0)
{
	...
	if (func_95(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_217(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_218(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_219(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_220(iParam0, 536870912);
	iVar1 = func_221(iParam0);
	if (iVar1 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(2216, 139, "[SHOP_UNLOCK_DOORS] Shop: ", func_110(iParam0, 0), " door count is greater then the. Current door count: ", iVar1, " Max door count: ", 15);
		Global_1915867.f_3[iParam0 /*447*/].f_409 = 0;
	}
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_180(Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
	...
	DEBUG::_0xF0783374333FD8CE(168, 139, "[CLEAR_SHOP] Shop: ", func_110(iParam0, 0), " has been cleared!");
}
...
int func_158(int iParam0, bool bParam1)
{
	if (!func_95(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_125(iParam0), " is invalid");
		return 0;
	}
	if (!func_157(iParam0, 2))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_125(iParam0), " has not been initialized");
		return 0;
	}
	if (func_163(iParam0) == 0)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_125(iParam0), " doesn't exist");
		return 1;
	}
	if (!PERSCHAR::_0x800DF3FC913355F3(func_124(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_125(iParam0), " already destroyed");
		return 1;
	}
	if (func_157(iParam0, 1) && !bParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_125(iParam0), " is stolen, so it will be destoyed on release.");
		func_223(iParam0, 128);
		return 1;
	}
	func_165(iParam0, 129);
	func_224(iParam0);
	DEBUG::_0xA308F935BDECCEC0(40, 138, "DESTROY_REGIONAL_CHARACTER: Destroying ", func_125(iParam0));
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_124(iParam0));
	func_164(iParam0, 0);
	DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: ", func_125(iParam0), " destroyed.");
	return 1;
}
...
void func_161()
{
	...
	while (iVar0 <= 3)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ NET_CLEAR_BARTENDERS - Removed ", func_226(Global_1051777.f_3642[iVar0 /*19*/]));
...
void func_165(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_227(iParam1), " on ", func_125(iParam0));
}
...
bool func_166(int iParam0)
{
	...
	if (!func_157(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_125(iParam0), " has not been initialized");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(40, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_125(iParam0));
	return true;
}

bool func_167(struct<2> Param0)
{
	return func_228(Param0, 5, 8);
}

bool func_168(int iParam0)
{
	return func_229(1, iParam0);
}
...
{
	if (func_230(&(Global_1102630.f_4), iParam0, 5))
	{
		DEBUG::_0xF0783374333FD8CE(680, 36, "CLEAR_NET_PLAYER_STATUS_FLAG - ", func_231(iParam0), " cleared by thread ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
		return 1;
	}
	return 0;
}
...
{
	func_232(iParam0);
	DEBUG::_0xF0783374333FD8CE(40, 37, "NET_SPECIAL_CAM__KILL - Setting new display to ", func_233(iParam0, 0));
	if (!func_234(1))
	{
	...
	else if (!func_235(128) && !func_236(19))
	{
		CAM::DO_SCREEN_FADE_OUT(iParam2);
	}
	if (bParam3 && func_237() == 4)
	{
...
int func_172(int iParam0)
{
	...
	{
		DEBUG::_0xF0783374333FD8CE(680, 36, "SET_NET_PLAYER_STATUS_FLAG - ", func_231(iParam0), " set by thread ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
		return 1;
	}
	return 0;
}
...
void func_175(struct<30> Param0, int iParam30)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, iParam30, "             outer.eType                     - ", func_240(Param0.f_17.f_9, 0));
	if (Param0.f_16)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, iParam30, "             inner.eType                     - ", func_240(Param0.f_6.f_9, 0));
	}
...
void func_176(struct<7> Param0, var uParam7, var uParam8, int iParam9)
{
...
void func_179(int iParam0, int iParam1)
{
	if (func_178(iParam0, iParam1))
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_103(iParam0), " flag ", func_188(iParam1));
	}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_FLAGS] ", func_103(iParam0));
	Global_1051777.f_80[iParam0 /*75*/].f_49 = 0;
}

bool func_183(int iParam0, int iParam1)
{
	return func_242(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}

void func_184(int iParam0)
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_SUPPORT_FLAGS] ", func_103(iParam0));
...
int func_187(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1139844.f_7) && !func_244(12, func_243(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
void func_191(bool bParam0, char* sParam1, bool bParam2, bool bParam3)
{
	if (func_112(bParam0))
	{
...
int func_197(int iParam0, char* sParam1, bool bParam2, char* sParam3, bool bParam4, char* sParam5, char* sParam6)
{
	struct<4> Var0;
	...
	{
		DEBUG::_0x4DC69742196F818A(40, 139, "[NET_GET_SHOP_AUTHOR_DATA_WITH_STRING] Could not fill out region node for: ", func_226(iParam0));
		return 0;
	}
	Var0.f_2 = -1407851228;
	...
	DEBUG::_0x4DC69742196F818A(1747624, 139, "[NET_GET_SHOP_AUTHOR_DATA_WITH_STRING] eShop = ", func_226(iParam0), ", ", sParam5, " = ", MISC::_0x6C4DBF553885F9EB(*sParam6), ", ", sParam3, " = ", *bParam4);
	return 1;
}

int func_198(bool bParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
bool func_204(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_249(func_56(0)))
	{
		return true;
	}
...
char* func_205(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
void func_216(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 195, "CLEAR_SALOON_CONFIG_FLAG: Clearing flag for ", func_254(iParam1, 0));
	func_255(&(Global_1940170.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_218(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that isnt stolen ", func_125(iParam0));
		return;
	}
	if (!func_157(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release an uninitialized regional character ", func_125(iParam0));
		return;
	}
	if ((!bParam4 && !func_217(iParam0)) && func_256(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that is stolen by a differnt script ", func_125(iParam0));
		return;
	}
	DEBUG::_0xF0783374333FD8CE(680, 138, "RELEASE_REGIONAL_CHARACTER: Regional character ", func_125(iParam0), " released by ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
	func_165(iParam0, 1);
	func_224(iParam0);
	if (func_257(func_163(iParam0)))
	{
		iVar0 = func_124(iParam0);
		if (!PERSCHAR::_0x800DF3FC913355F3(iVar0))
		{
			DEBUG::_0x9A6C65DDDBEC9C52(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character with no perschar index", func_125(iParam0));
			return;
		}
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being retasked ", func_125(iParam0));
	...
	if (func_157(iParam0, 128) && !bParam3)
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being destroyed on release ", func_125(iParam0));
		func_158(iParam0, 0);
	}
}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 139, "CLEAR_ALL_SHOP_TYPE_FLAGS: ", func_103(iParam0));
...
void func_223(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_227(iParam1), " on ", func_125(iParam0));
}
...
void func_224(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar0, false))
		{
			...
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_125(iParam0), " set as no longer needed.");
		}
		else
		{
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_125(iParam0), " was asked to be set as no longer needed, but this script does not own the ped.");
		}
	}
...
bool func_228(struct<2> Param0, int iParam2, int iParam3)
{
	int iVar0;
...
bool func_229(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_264(&(Global_1102630.f_4), iVar0, 5);
	}
	if (iParam1 == func_265())
	{
		return func_264(&(Global_1102630.f_4), iVar0, 5);
	...
	{
		return func_264(&(Global_1100880[iParam1 /*53*/].f_4), iVar0, 5);
	}
...
bool func_244(int iParam0, char* sParam1, var uParam2)
{
	var uVar0;

	if (func_267(iParam0, sParam1, &uVar0))
	{
...
bool func_247()
{
	...
	if (!func_249(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_267(int iParam0, char* sParam1, bool bParam2)
{
	*bParam2 = Global_1139844.f_7;
	bParam2->f_2 = 1351168281;
	bParam2->f_3 = func_276(iParam0);
	bParam2->f_4 = sParam1;
...
void func_268(bool bParam0, int iParam1, var uParam2)
{
	...
	*uParam2 = iParam1;
	...
	{
		DEBUG::_0x83407B92D46F25C3(648, 84, "RETRIEVE_UNLOCK_DATA - Couldn't retrieve id at index ", uParam2->f_1, " of type ", func_277(iParam1, 0));
	}
	bParam0->f_2 = -2140901307;
...
bool func_278(struct<2> Param0, bool bParam2)
{
	if (!func_249(Param0))
	{
		return false;
