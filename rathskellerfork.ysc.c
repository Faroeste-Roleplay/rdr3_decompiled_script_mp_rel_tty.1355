	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_26)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_76(iLocal_26));
...
bool func_94(int iParam0, bool bParam1)
{
	...
	DEBUG::_0x4DC69742196F818A(2216, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_95(iParam0), " being processed - ALIVE = ", !PERSCHAR::_0xEB98B38CA60742D7(func_59(iParam0)), "!");
...
void func_123(int iParam0)
{
	...
	if (func_91(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_152(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
