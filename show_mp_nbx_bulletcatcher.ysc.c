...
bool func_103(var uParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1393[0]))
	{
		if (func_166(&(uParam0->f_1393[0]), uParam0->f_1385[0], func_165(0)))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] BUCKET INDEX: ", uParam0->f_1393[0]);
		}
		else
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "BUCKET was not created");
			return false;
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1393[1]))
	{
		if (func_166(&(uParam0->f_1393[1]), uParam0->f_1385[1], func_165(1)))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] Stool INDEX: ", uParam0->f_1393[1]);
		}
		else
		{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1393[2]))
	{
		if (func_166(&(uParam0->f_1393[2]), uParam0->f_1385[2], func_165(2)))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(8, 201, "[CUSTOM_PREPARE_NEW_SHOW_ANIM_SCENE] BOTTLE INDEX: ", uParam0->f_1393[2]);
		}
		else
		{
	...
	if (!func_168(&(uParam0->f_1423[0]), uParam0->f_1415[0], func_167(0)))
	{
		return false;
	}
	if (!func_168(&(uParam0->f_1423[1]), uParam0->f_1415[1], func_167(1)))
	{
		return false;
	}
	if (!func_169(uParam0, iVar0, 0, "Benjamin"))
	{
		return false;
	}
	if (!func_169(uParam0, iVar0, 1, "Assistant"))
	{
		return false;
	}
	if (!func_169(uParam0, iVar0, 2, "Crowd_Member"))
	{
		return false;
	}
	ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "Gun", uParam0->f_1423[0], 0);
	func_170(&(uParam0->f_1408[0]));
...
void func_108(bool bParam0, int iParam1, bool bParam2)
{
	...
	if (func_174(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != iParam1 || bParam2)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(680, 183, "SET_DOORSTATE_OF_DOOR_ID - Setting Door ID ", func_175(bParam0, 0), " to ", func_176(iParam1, 0));
...
int func_116(bool bParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12)
{
	...
	func_177(iVar0, bParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
char* func_119(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 201, "Projectionist playlist: ", func_178(iParam1, 0), " show: ", func_179(iParam0, 0));
...
{
	DEBUG::_0x1B08D1EB9D8C4931(40, 201, "[fireDance_02][CUSTOM_UPDATE_HOST] -- STATE: ", func_180(uParam0->f_1, 0));
	switch (uParam0->f_1)
	{
		case 0:
			func_181(&(uParam0->f_1), 32);
			break;
		case 32:
			if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false))
			{
				uParam0->f_3 = 1;
				func_91(uParam0, 1);
				func_181(&(uParam0->f_1), 33);
			}
			break;
		case 33:
			func_181(&(uParam0->f_1), 34);
			break;
		case 34:
			if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)) > func_182())
			{
				func_181(&(uParam0->f_1), 37);
			}
			break;
		case 37:
			uParam0->f_5 = 1;
			...
			func_91(uParam0, 2);
			func_183(&(uParam0->f_27), 0);
			func_181(&(uParam0->f_1), 40);
			break;
		case 40:
			break;
	}
...
{
	DEBUG::_0x1B08D1EB9D8C4931(40, 201, "[fireDance_02][CUSTOM_UPDATE_CLIENT] -- STATE: ", func_180((uParam1[uParam2->f_1 /*18*/])->f_17, 0));
	switch ((uParam1[uParam2->f_1 /*18*/])->f_17)
	{
		case 0:
			func_184(&((uParam1[uParam2->f_1 /*18*/])->f_17), 32);
			break;
		case 32:
			if (uParam0->f_1 > 32)
			{
				func_184(&((uParam1[uParam2->f_1 /*18*/])->f_17), 33);
			}
			break;
		case 33:
			if (uParam0->f_1 > 33)
			{
				func_184(&((uParam1[uParam2->f_1 /*18*/])->f_17), 34);
			}
			break;
		case 34:
			if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)) > func_182())
			{
				func_184(&((uParam1[uParam2->f_1 /*18*/])->f_17), 37);
			}
			break;
		case 37:
			if (!func_13(uParam0->f_1358, 8388608))
			...
			func_18(&(uParam2->f_247), 32);
			func_184(&((uParam1[uParam2->f_1 /*18*/])->f_17), 40);
			break;
		case 40:
			break;
	}
...
void func_132(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 218, "CLEAR_WORLD_STATE_FLAG: clearing world state - ", func_186(iParam0, 0));
	Global_1939807 = 0;
}
...
void func_135(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	...
	if (func_174(bParam0))
	{
		...
		if (bParam3)
		{
			func_188(bParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
			{
				func_189(bParam0, 1);
				UNK_0x355E72323AEE83CC(183, 9);
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking Door ID ", func_175(bParam0, 0));
			}
			else
			{
				func_190(bParam0, 1);
				UNK_0x355E72323AEE83CC(183, 9);
				DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Locking and making unbreakable Door ID ", func_175(bParam0, 0));
			}
		}
		else
		{
			func_191(bParam0, 1);
			UNK_0x355E72323AEE83CC(183, 9);
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "SET_STATE_OF_DOOR_ID - Unlocking Door ID ", func_175(bParam0, 0));
		}
		if (bParam7)
		{
			DEBUG::_0x1B08D1EB9D8C4931(168, 183, "SET_STATE_OF_DOOR_ID - Treating Door ID ", func_175(bParam0, 0), " as shut.");
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 183, "SET_STATE_OF_DOOR_ID: Door with ID not registered by host yet ", func_175(bParam0, 0));
	}
}
...
int func_141(var uParam0, var uParam1, int iParam2)
{
	...
	if (!func_13(*uParam1, 1))
	{
		...
		{
			iVar3 = iVar0;
			if (func_197(uParam0[iVar0 /*5*/], func_195(iParam2), func_196(iParam2, iVar3), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 8))
	{
		...
		{
			iVar4 = iVar0;
			if (func_197(&(uParam0->f_31[iVar0 /*5*/]), func_199(iParam2), func_200(iParam2, iVar4), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 2048))
	{
		...
		{
			iVar5 = iVar0;
			if (func_197(&(uParam0->f_107[iVar0 /*5*/]), func_202(iParam2), func_203(iParam2, iVar5), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
	...
	{
		case 0:
			if (!func_13(*uParam1, 64) && func_197(&(uParam0->f_118[0 /*5*/]), func_204(iParam2, 0), func_205(iParam2, 0), 1065353216 /* Float: 1f */))
			{
				func_18(uParam1, 64);
			}
			if ((!func_13(*uParam1, 16384) && func_197(&(uParam0->f_118[1 /*5*/]), func_204(iParam2, 1), func_205(iParam2, 1), 1065353216 /* Float: 1f */)) && func_197(&(uParam0->f_118[2 /*5*/]), func_204(iParam2, 2), func_205(iParam2, 2), 1065353216 /* Float: 1f */))
			{
		...
		case 1:
			...
			if (!func_13(*uParam1, 2097152))
			{
				...
				{
					iVar6 = iVar0;
					if (func_197(&(uParam0->f_118[iVar0 /*5*/]), func_204(iParam2, 0), func_205(iParam2, iVar6), 1065353216 /* Float: 1f */))
					{
						iVar2++;
					}
					iVar0++;
...
void func_142(var uParam0, var uParam1, int iParam2)
{
	...
	{
		if (func_13(*uParam0, 2) && func_210(uParam1, func_207(uParam1), &(uParam1->f_229), func_208(uParam1), func_209(uParam1)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "WALL LIGHTS should be faded out");
			func_14(uParam0, 2);
		}
		if (func_13(*uParam0, 4) && func_212(uParam1, func_211(uParam1), &(uParam1->f_229), func_208(uParam1), func_209(uParam1)))
		{
	...
	{
		if (func_13(*uParam0, 16) && func_210(&(uParam1->f_31), func_213(uParam1), &(uParam1->f_232), func_214(uParam1), func_209(uParam1)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "STAGE LIGHTS should be faded out");
			func_14(uParam0, 16);
		}
		if (func_13(*uParam0, 32) && func_212(&(uParam1->f_31), func_215(uParam1), &(uParam1->f_232), func_214(uParam1), func_209(uParam1)))
		{
	...
	{
		if (func_13(*uParam0, 4096) && func_210(&(uParam1->f_107), func_216(uParam1), &(uParam1->f_235), func_217(uParam1), func_209(uParam1)))
		{
			DEBUG::_0xA308F935BDECCEC0(8, 201, "BALCONY LIGHTS should be faded out");
			func_14(uParam0, 4096);
		}
		if (func_13(*uParam0, 8192) && func_212(&(uParam1->f_107), func_218(uParam1), &(uParam1->f_235), func_217(uParam1), func_209(uParam1)))
		{
	...
	if (iParam2 == 0)
	{
		...
		{
			if (func_13(*uParam0, 128) && func_221(&(uParam1->f_118[0 /*5*/]), func_219(uParam1), &(uParam1->f_238), func_220(uParam1), func_209(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE CENTER STAGE LIGHT should be faded out");
				func_14(uParam0, 128);
			}
			if (func_13(*uParam0, 256) && func_223(&(uParam1->f_118[0 /*5*/]), func_222(uParam1), &(uParam1->f_238), func_220(uParam1), func_209(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE CENTER STAGE LIGHT s should be faded in");
				func_14(uParam0, 256);
			}
			if (func_13(*uParam0, 512) && func_221(&(uParam1->f_118[0 /*5*/]), func_219(uParam1), &(uParam1->f_238), 0.5f, func_209(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE CENTER STAGE LIGHT s should be off");
				func_14(uParam0, 512);
			}
			if (func_13(*uParam0, 1024) && func_223(&(uParam1->f_118[0 /*5*/]), func_222(uParam1), &(uParam1->f_238), 0.5f, func_209(uParam1)))
			{
		...
		{
			if (func_13(*uParam0, 32768) && func_226(1, 2, &(uParam1->f_118), func_224(uParam1), &(uParam1->f_241), func_225(uParam1), func_209(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE RED LIGHTS should be faded out");
				func_14(uParam0, 32768);
			}
			if (func_13(*uParam0, 65536) && func_228(1, 2, &(uParam1->f_118), func_227(uParam1), &(uParam1->f_241), func_225(uParam1), func_209(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE RED LIGHTS should be faded in");
				func_14(uParam0, 65536);
			}
			if (func_13(*uParam0, 131072) && func_226(1, 2, &(uParam1->f_118), func_224(uParam1), &(uParam1->f_241), 0.5f, func_209(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "VAUDEVILLE RED LIGHTS should be off");
				func_14(uParam0, 131072);
			}
			if (func_13(*uParam0, 262144) && func_228(1, 2, &(uParam1->f_118), func_227(uParam1), &(uParam1->f_241), 0.5f, func_209(uParam1)))
			{
		...
		{
			bVar0 = true;
			if (!func_210(&(uParam1->f_31), func_213(uParam1), &(uParam1->f_232), 0.1f, func_209(uParam1)))
			{
				bVar0 = false;
			}
			if (bVar0)
		...
		{
			bVar1 = true;
			if (!func_212(&(uParam1->f_31), func_215(uParam1), &(uParam1->f_232), 0.1f, func_209(uParam1)))
			{
				bVar1 = false;
			}
			if (bVar1)
	...
	if (iParam2 == 1)
	{
		...
		{
			if (func_13(*uParam0, 4194304) && func_210(&(uParam1->f_118), func_229(uParam1), &(uParam1->f_238), func_230(uParam1), func_209(uParam1)))
			{
				DEBUG::_0xA308F935BDECCEC0(8, 201, "SD MAGIC LANTERN / MOVIE Arch lights should be faded out");
				func_14(uParam0, 4194304);
			}
			if (func_13(*uParam0, 8388608) && func_212(&(uParam1->f_118), func_231(uParam1), &(uParam1->f_238), func_230(uParam1), func_209(uParam1)))
			{
...
{
	func_233(uParam0);
	func_233(&(uParam0->f_31));
	func_233(&(uParam0->f_107));
	func_233(&(uParam0->f_118));
	*uParam1 = 0;
}
...
{
	return func_234(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("VOLCYLINDER"), iParam0, iParam1);
}
...
bool func_168(var uParam0, int iParam1, vector3 vParam2)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
bool func_169(var uParam0, int iParam1, int iParam2, char* sParam3)
{
...
bool func_173(bool bParam0, bool bParam1, bool bParam2)
{
	if (!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(bParam0))
	{
		if ((NETWORK::NETWORK_IS_IN_SESSION() && SCRIPTS::_DOES_THREAD_EXIST(Global_1051590.f_16[0])) && bParam1)
		{
			...
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add networked Door ", func_175(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
		else
		{
			OBJECT::_ADD_DOOR_TO_SYSTEM_NEW(bParam0, true, false, false, 0, 0, false);
			DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Add Door ", func_175(bParam0, 0), " to system");
			UNK_0x355E72323AEE83CC(183, 7);
		}
	}
	...
	if (bParam2)
	{
		...
		DEBUG::_0xA308F935BDECCEC0(168, 183, "REGISTER_DOOR_ID: Set door ", func_175(bParam0, 0), " able to change open ratio while locked");
		UNK_0x355E72323AEE83CC(183, 7);
	}
	return bParam0;
}
...
var func_175(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
void func_177(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
{
	DEBUG::_0xA308F935BDECCEC0(680, 201, "[GSMP_SET_INDIVIDUAL_SHOW_STATE_HOST] Changing from STATE: ,", func_180(*uParam0, 0), " TO STATE: ", func_180(iParam1, 0));
	*uParam0 = iParam1;
}
...
{
	DEBUG::_0xA308F935BDECCEC0(680, 201, "[GSMP_SET_INDIVIDUAL_SHOW_STATE_CLIENT] Changing from STATE: ,", func_180(*uParam0, 0), " TO STATE: ", func_180(iParam1, 0));
	*uParam0 = iParam1;
}
...
void func_188(bool bParam0, char* sParam1, bool bParam2, bool bParam3)
{
	if (func_174(bParam0))
	{
...
void func_189(bool bParam0, bool bParam1)
{
	if (func_174(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 2 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "LOCK_DOOR_ID - Locking Door ID ", func_175(bParam0, 0));
		}
	}
	else
	{
...
void func_190(bool bParam0, bool bParam1)
{
	if (func_174(bParam0))
	{
		...
		{
			DEBUG::_0x1B08D1EB9D8C4931(2216, 183, "SET_DOOR_ID_LOCKED_AND_UNBREAKABLE - Door ID ", func_175(bParam0, 0), " state = ", OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0), " pending state ", UNK_0x4BC2854478F3A749(bParam0));
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(bParam0, 1);
		}
	}
	else
...
void func_191(bool bParam0, bool bParam1)
{
	if (func_174(bParam0))
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(bParam0) != 0 || bParam1)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(40, 183, "UNLOCK_DOOR_ID - Unlocking Door ID ", func_175(bParam0, 0));
		}
	}
	else
	{
...
bool func_197(var uParam0, bool bParam1, vector3 vParam2, int iParam5)
{
	if (uParam0->f_1 == 0)
	{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		DEBUG::_0x1B08D1EB9D8C4931(936, 201, "[SHOW_GET_LIGHT] Light not ready: ", func_244(bParam1, 0), " at position: ", &vParam2);
		return false;
	}
	uParam0->f_2 = 1f;
	return true;
...
bool func_210(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	...
	{
		func_245(uParam0[iVar0 /*5*/], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_212(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
bool func_221(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	float fVar0;
	...
	func_245(uParam0, fParam1, fVar0, fParam3, iParam4);
	if (fVar0 >= fParam3)
	{
		func_161(uParam2);
		return true;
...
bool func_223(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	float fVar0;
...
bool func_226(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	while (iVar3 <= iVar1)
	{
		func_245(uParam2[iVar3 /*5*/], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
bool func_228(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	float fVar2;
...
var func_234(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar2 < 32)
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(Global_1275959.f_154[iVar2]))
		{
			...
			if (!bVar3)
			{
				if (iVar9 & 8192 != 0 && func_252(iVar2) != 1)
				{
					bVar3 = true;
				}
			}
...
{
	DEBUG::_0xA308F935BDECCEC0(648, 28, "HORSE_SET_GENDER - pedHorse: ", sParam0, " eGender = ", func_254(iParam1, 0));
	if (iParam1 == 1)
	{
...
void func_245(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (uParam0->f_2 > fParam1 && uParam0->f_2 > uParam0->f_3)
		{
			...
			fVar0 = (fVar1 / fParam3);
			uParam0->f_2 = func_256(fParam1, uParam0->f_4, fVar0);
...
void func_246(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (uParam0->f_2 < fParam1 && uParam0->f_2 < uParam0->f_4)
		{
			...
			uParam0->f_2 = func_256(uParam0->f_3, fParam1, fVar0);
			if (uParam0->f_2 > fParam1)
			{
				uParam0->f_2 = fParam1;
			}
...
bool func_257(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_260(&(Global_1102630.f_4), iVar0, 5);
	}
	if (iParam1 == func_261())
	{
		return func_260(&(Global_1102630.f_4), iVar0, 5);
	...
	{
		return func_260(&(Global_1100880[iParam1 /*53*/].f_4), iVar0, 5);
	}
