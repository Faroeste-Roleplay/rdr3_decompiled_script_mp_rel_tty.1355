...
void __EntryFunction__()
{
	...
	fLocal_13 = 1f;
	fLocal_14 = 1f;
	DEBUG::_0xF0783374333FD8CE(8, 157, "generic_STEW_item - starting ...");
	...
	Var0.f_1 = bVar183;
	DEBUG::_0xF0783374333FD8CE(40, 157, "Interacting with ", func_3(Var0.f_1, 0));
	if (!ScriptParam_0.f_3)
	{
		func_1(1);
	}
	iVar184 = func_4(Var0.f_1);
	if (iVar184 != 0)
	{
		Var0.f_182 = iVar184;
	}
	Var0.f_1.f_2 = 5f;
	while (!SCRIPTS::_0x9E4EF615E307FBBE() && !ENTITY::IS_ENTITY_DEAD(Global_33))
	{
		if (!ScriptParam_0.f_3)
		{
			...
			func_5(&Var0);
			if (func_6(&uLocal_15) && func_7(&uLocal_15, 0.25f))
			{
				func_8(Var0.f_182);
			}
		}
		if (IntToFloat(Var0.f_1.f_1) < Var0.f_1.f_2)
		{
			...
			{
				Var0.f_1.f_1++;
				func_9(&(Var0.f_1), IntToFloat(Var0.f_1.f_1) >= Var0.f_1.f_2);
			}
		}
		switch (Var0)
		{
			case 0:
				...
				break;
			case 1:
				iVar185 = TASK::_GET_ITEM_INTERACTION_FROM_PED(Global_33);
				...
				{
					iVar186 = TASK::_GET_SCENARIO_POINT_TYPE_PED_IS_USING(Global_33);
					...
					else if (iVar186 != joaat("PROP_PLAYER_SEAT_CHAIR_DYNAMIC"))
					{
					}
					else
					{
				...
				if (IntToFloat(Var0.f_1.f_1) >= (Var0.f_1.f_2 - 1f) || ((MISC::GET_FRAME_COUNT() % 10) == 0 && ENTITY::GET_ENTITY_SUBMERGED_LEVEL(Global_33) > 0.2f))
				{
					func_11(&Var0, 2);
				}
				break;
			case 2:
				...
				if (iVar185 == joaat("EAT_STEW_BOWL_BASE") || iVar185 == joaat("EAT_STEW_BOWL_CHAIR_BASE"))
				{
					...
					{
						TASK::_0xB35370D5353995CB(Global_33, joaat("EAT_STEW_BOWL_EAT_FINISH_DISCARD_AUTO"), 1048576000 /* Float: 0.25f */);
					}
					else
					{
						TASK::_0xB35370D5353995CB(Global_33, joaat("EAT_STEW_BOWL_CHAIR_EAT_FINISH_DISCARD_AUTO"), 1048576000 /* Float: 0.25f */);
					}
					func_11(&Var0, 3);
				}
				else if (iVar185 == joaat("EAT_STEW_BOWL_TABLE_BASE") || (iVar185 == joaat("EAT_STEW_BOWL_TABLE_EAT_FINISH_HOLD") && ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, 1160706425)))
				{
					PED::_SET_PED_BLACKBOARD_BOOL(Global_33, "HIDE_STEW_EAT_PROMPT", true, 1);
					PED::_0x6D07B371E9439019(Global_33);
					PED::_0xD65FDC686A031C83(Global_33, joaat("A_STEW_TRANS_GENERIC_A"), 1.5f);
				}
				break;
			case 3:
				PED::_SET_PED_BLACKBOARD_BOOL(Global_33, "HIDE_STEW_EAT_PROMPT", true, 1);
	...
	DEBUG::_0xF0783374333FD8CE(8, 157, "generic_STEW_item - terminating ...");
}
...
void func_5(var uParam0)
{
	...
	func_12(uParam0->f_1, &(uParam0->f_180), joaat("P_BOWL04X_STEW_PH_L_HAND"), uParam0->f_182, 1);
	func_12(uParam0->f_1, &(uParam0->f_181), joaat("P_SPOON01X_PH_R_HAND"), joaat("P_SPOON01X"), 0);
}
...
void func_8(var uParam0)
{
	...
	iVar14 = 16;
	Var0.f_12 = uParam0;
	func_17(iVar14, Var0, func_16(0, 8));
}
...
void func_9(var uParam0, bool bParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(2216, 157, "GENERIC_ITEM_INTERACTION_APPLY_EFFECTS: ", func_3(*uParam0, 0), " Used: ", uParam0->f_1, " Final Use: ", bParam1);
	iVar0 = 0;
	while (iVar0 < uParam0->f_11)
	{
		DEBUG::_0xF0783374333FD8CE(25725576, 157, "GENERIC_ITEM_INTERACTION_APPLY_EFFECTS - Effect ", iVar0, ":", func_20(uParam0->f_33[iVar0 /*7*/].f_1, 0), " Value ", uParam0->f_33[iVar0 /*7*/].f_2, " Time ", uParam0->f_33[iVar0 /*7*/].f_3, " unit ", uParam0->f_33[iVar0 /*7*/].f_4, " percent ", uParam0->f_33[iVar0 /*7*/].f_5);
		switch (uParam0->f_33[iVar0 /*7*/].f_1)
		{
			...
			case -1104847406:
				...
				func_23((IntToFloat(uParam0->f_33[iVar0 /*7*/].f_2) / uParam0->f_2), 0);
				bVar8 = true;
				break;
			case 381158954:
				...
				break;
			case -416929031:
				fVar4 = func_25((IntToFloat(uParam0->f_33[iVar0 /*7*/].f_2) / uParam0->f_2), (uParam0->f_33[iVar0 /*7*/].f_5 / uParam0->f_2));
				func_26(0, fVar4, 1, 1, bVar10);
				bVar9 = true;
				break;
			case 1857353317:
				fVar5 = func_25((IntToFloat(uParam0->f_33[iVar0 /*7*/].f_2) / uParam0->f_2), (uParam0->f_33[iVar0 /*7*/].f_5 / uParam0->f_2));
				func_26(2, fVar5, 1, 1, bVar10);
				bVar8 = true;
				break;
			case 1681823811:
				fVar6 = func_25((IntToFloat(uParam0->f_33[iVar0 /*7*/].f_2) / uParam0->f_2), (uParam0->f_33[iVar0 /*7*/].f_5 / uParam0->f_2));
				func_26(1, fVar6, 1, 1, bVar10);
				break;
			case -816334026:
				func_27((BUILTIN::TO_FLOAT(uParam0->f_33[iVar0 /*7*/].f_2) / uParam0->f_2), 1 == uParam0->f_1);
				break;
			default:
				if (bParam1)
				{
					...
					{
						case 2062242710:
							fVar7 = func_28(BUILTIN::TO_FLOAT(uParam0->f_33[iVar0 /*7*/].f_3), uParam0->f_33[iVar0 /*7*/].f_4);
							func_29(19, fVar7, bVar11, 1);
							bVar9 = true;
							break;
						case -826379728:
							fVar7 = func_28(BUILTIN::TO_FLOAT(uParam0->f_33[iVar0 /*7*/].f_3), uParam0->f_33[iVar0 /*7*/].f_4);
							func_29(20, fVar7, bVar11, 1);
							bVar8 = true;
							break;
						case -1191740624:
							fVar7 = func_28(BUILTIN::TO_FLOAT(uParam0->f_33[iVar0 /*7*/].f_3), uParam0->f_33[iVar0 /*7*/].f_4);
							func_29(18, fVar7, bVar11, 1);
							break;
						case 1869697234:
							fVar7 = func_28(BUILTIN::TO_FLOAT(uParam0->f_33[iVar0 /*7*/].f_3), uParam0->f_33[iVar0 /*7*/].f_4);
							func_29(0, fVar7, bVar11, 1);
							bVar9 = true;
							break;
						case 1342237631:
							fVar7 = func_28(BUILTIN::TO_FLOAT(uParam0->f_33[iVar0 /*7*/].f_3), uParam0->f_33[iVar0 /*7*/].f_4);
							func_29(2, fVar7, bVar11, 1);
							bVar8 = true;
							break;
						case -1240225157:
							fVar7 = func_28(BUILTIN::TO_FLOAT(uParam0->f_33[iVar0 /*7*/].f_3), uParam0->f_33[iVar0 /*7*/].f_4);
							func_29(1, fVar7, bVar11, 1);
							break;
					}
				}
				break;
	...
	{
		func_30(uParam0);
		func_31(*uParam0, bVar8, bVar9, 562618531);
	}
	func_32(uParam0);
...
void func_10(var uParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(168, 157, "GENERIC_ITEM_INTERACTION_FILLOUT_EFFECTS: ", func_3(*uParam0, 0), " Num Effects ", uParam0->f_11);
	iVar0 = 0;
	while (iVar0 < uParam0->f_11)
	{
		DEBUG::_0x4DC69742196F818A(648, 157, "GENERIC_ITEM_INTERACTION_FILLOUT_EFFECTS - Effect ", iVar0, ":", func_33(uParam0->f_11.f_1[iVar0], 0));
		ITEMDATABASE::_ITEM_DATABASE_FILLOUT_ITEM_EFFECTS_ID_INFO(uParam0->f_11.f_1[iVar0], &(uParam0->f_33[iVar0 /*7*/]));
		DEBUG::_0x4DC69742196F818A(35496, 157, "GENERIC_ITEM_INTERACTION_FILLOUT_EFFECTS - Key ", func_33(uParam0->f_33[iVar0 /*7*/], 0), " Enum ID ", func_20(uParam0->f_33[iVar0 /*7*/].f_1, 0), " Value ", uParam0->f_33[iVar0 /*7*/].f_2, " Time ", uParam0->f_33[iVar0 /*7*/].f_3);
		iVar0++;
	}
}
...
{
	DEBUG::_0xA308F935BDECCEC0(680, 157, "SET_STEW_ITEM_STATE: from ", func_34(*uParam0, 0), " to ", func_34(iParam1, 0));
	*uParam0 = iParam1;
}

void func_12(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam1))
	{
		*uParam1 = TASK::_0x05A0100EA714DB68(Global_33, iParam2);
		if (!ENTITY::DOES_ENTITY_EXIST(*uParam1))
		{
			DEBUG::_0x1B08D1EB9D8C4931(136, 157, "Failed to get object with id: ", iParam2, " attempting to create now.");
			STREAMING::REQUEST_MODEL(iParam3, false);
			if (STREAMING::HAS_MODEL_LOADED(iParam3) && NETWORK::CAN_REGISTER_MISSION_OBJECTS(1))
			{
				DEBUG::_0x1B08D1EB9D8C4931(136, 157, "Successfully created object with id: ", iParam2, " passing to interaction.");
				*uParam1 = OBJECT::CREATE_OBJECT(iParam3, Global_34, true, false, false, false, true);
				...
				TASK::_TASK_ITEM_INTERACTION_2(Global_33, iParam0, *uParam1, iParam2, TASK::_GET_ITEM_INTERACTION_FROM_PED(Global_33), 1, 0, -1f);
			}
		}
	}
}
...
{
	return func_37(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("VOLCYLINDER"), iParam0, iParam1);
}

void func_17(int iParam0, struct<9> Param1, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15)
{
	UNK_0x355E72323AEE83CC(61, 9);
	if (!SCRIPTS::_0x179A6F0EE2E79026(&uParam15))
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 32, "BROADCAST_CAMP_EVENT - playerflags = 0 so not broadcasting");
		return;
	}
	if (!func_38(0))
	{
	...
	DEBUG::_0xA308F935BDECCEC0(2216, 62, "BROADCAST_CAMP_EVENT - event sent, ", func_39(iParam0, 0), " for camp ", Param1.f_8, " size: ", 14);
}
...
bool func_18(bool bParam0, bool bParam1)
{
	if (!func_2(bParam0, 0))
	{
		return func_41(func_40(bParam0), bParam1);
	}
	if (bParam1 == 0)
	{
		return false;
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[ITEM_HAS_PROPERTY_TAG] Found tag ", func_42(bParam1, 0), " for item ", func_3(bParam0, 0), ", returning TRUE");
		return true;
	}
	return false;
}
...
void func_23(float fParam0, bool bParam1)
{
	...
	func_46((fParam0 * IntToFloat(iVar0)), 0, bParam1);
}
...
float func_25(float fParam0, float fParam1)
{
	if (fParam1 != 0f)
	{
...
void func_26(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (fParam1 == 0f)
	{
		return;
	...
	if (bParam4)
	{
		fParam1 = func_49(iParam0, fParam1, 1);
	}
...
float func_28(float fParam0, int iParam1)
{
	switch (iParam1)
	{
		case 0:
...
int func_29(int iParam0, char* sParam1, bool bParam2, bool bParam3)
{
	...
	DEBUG::_0xF0783374333FD8CE(2472, 84, "RPG_GLOBAL_SET_OVERPOWER_FOR_PLAYER_ATTRIBUTE - Attribute: ", func_55(iParam0, 0), " will be Overpowered this frame for  ", sParam1, " seconds");
	return func_56(iParam0, sParam1, bParam2, bParam3);
}

void func_30(var uParam0)
{
	DEBUG::_0xF0783374333FD8CE(168, 157, "GENERIC_ITEM_INTERACTION_APPLY_FINAL_USE_EFFECTS - Item: ", func_3(*uParam0, 0), " is being processed...");
	switch (*uParam0)
	{
		case -2109344034:
		case -2053642092:
		...
		case 1879593571:
		case 1934214136:
			DEBUG::_0xF0783374333FD8CE(168, 157, "GENERIC_ITEM_INTERACTION_APPLY_FINAL_USE_EFFECTS - Item: ", func_3(*uParam0, 0), " is a Daily Stew Meal! Push RPG Effects... ");
			func_57(-1196069774, joaat("CONSUMABLE__DAILY_STEW"), 8100);
			break;
	}
}

void func_31(bool bParam0, bool bParam1, bool bParam2, int iParam3)
{
	DEBUG::_0xF0783374333FD8CE(10920, 157, "GENERIC_ITEM_INTERACTION_INCREMENT_STATS - ", func_3(bParam0, 0), ", bDeadeyeEffect - ", MISC::_0xF216F74101968DB0(bParam1), ", bHealthEffect - ", MISC::_0xF216F74101968DB0(bParam2));
	...
	{
		func_61(func_60(bParam0), 1);
	}
	if (func_18(bParam0, 1939071949))
	{
		func_59(func_62(joaat("USED"), joaat("TONIC")), 1);
	}
	if (func_18(bParam0, 1992556171))
	{
		func_59(func_58(joaat("CAMP_STEWS_CONSUMED")), 1);
	}
	if (func_18(bParam0, 1239889275))
	{
		func_59(func_58(joaat("ANTIQUE_BOTTLES_DRUNK")), 1);
	}
	switch (bParam0)
	{
		...
		case joaat("CONSUMABLE_HAYCUBE"):
			func_59(func_62(joaat("USED"), joaat("FEED_BAG")), 1);
			break;
	}
	switch (bParam0)
	{
		case -611782825:
			func_59(func_62(joaat("USED"), -1875859641), 1);
			break;
		case joaat("CONSUMABLE_MOONSHINE"):
			func_59(func_62(joaat("USED"), joaat("MOONSHINE")), 1);
			break;
		case joaat("CONSUMABLE_WHISKEY_USED"):
		case joaat("CONSUMABLE_WHISKEY"):
			func_59(func_62(joaat("USED"), joaat("WHISKEY")), 1);
			break;
		case joaat("CONSUMABLE_COCAINE_CHEWING_GUM_USED"):
		case joaat("CONSUMABLE_COCAINE_CHEWING_GUM"):
			func_59(func_62(joaat("USED"), joaat("COCAINE_GUM")), 1);
			break;
		case joaat("CONSUMABLE_SNAKE_OIL"):
		case joaat("CONSUMABLE_POTENT_SNAKE_OIL"):
		case joaat("CONSUMABLE_SNAKE_OIL_USED"):
			func_59(func_62(joaat("USED"), joaat("SNAKE_OIL")), 1);
			break;
		case joaat("CONSUMABLE_CHEWING_TOBACCO"):
		case joaat("CONSUMABLE_CHEWING_TOBACCO_USED"):
			func_59(func_62(joaat("USED"), joaat("CHEWING_TOBACCO")), 1);
			break;
		...
		case joaat("CONSUMABLE_POTENT_HORSE_MEDICINE"):
			func_59(func_62(joaat("USED"), joaat("HORSE_PILLS")), 1);
			break;
		case joaat("CONSUMABLE_HERBIVORE_BAIT"):
		case joaat("CONSUMABLE_POTENT_HERBIVORE_BAIT"):
			func_59(func_62(joaat("USED"), joaat("POTENT_HERBIVORE_BAIT")), 1);
			break;
		case joaat("CONSUMABLE_PREDATOR_BAIT"):
		case joaat("CONSUMABLE_POTENT_PREDATOR_BAIT"):
			func_59(func_62(joaat("USED"), joaat("POTENT_PREDATOR_BAIT")), 1);
			break;
	}
	if (func_63() == -1)
	{
		...
		{
			func_59(func_62(joaat("USED"), joaat("SPECIAL_TONIC")), 1);
		}
	}
	if (bParam1)
	{
...
var func_37(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool func_38(bool bParam0)
{
	if (bParam0)
	{
		if (Global_1132718.f_2050 == 0 || (MISC::_GET_SYSTEM_TIME() - Global_1132718.f_2050) >= 1000)
		{
			return true;
		}
		else
	...
	if (Global_1132718.f_2050 == 0)
	{
		Global_1132718.f_2050 = MISC::_GET_SYSTEM_TIME();
	}
	else if ((MISC::_GET_SYSTEM_TIME() - Global_1132718.f_2050) >= 1000)
	{
		Global_1132718.f_2050 = MISC::_GET_SYSTEM_TIME();
	}
	else
	{
		UNK_0x355E72323AEE83CC(62, 6);
		DEBUG::_0x83407B92D46F25C3(8, 62, "NET_CAMP_MANAGER_IS_SAFE_TO_SEND_SCRIPT_EVENT - Aborting script event, is this indicative of crash? Please bug & CC Campbell Crapsey");
		return false;
	}
	return true;
}
...
char* func_39(int iParam0, int iParam1)
{
	...
	{
		case 0:
			return "CAMP_EVENT_TYPE_CAMP_ACTIVE";
		case 1:
			return "CAMP_EVENT_TYPE_CAMP_STEAL_FOLLOWER";
		case 2:
			return "CAMP_EVENT_TYPE_CAMP_RELEASE_FOLLOWER";
		case 3:
			return "CAMP_EVENT_TYPE_CAMP_RAISE_WHITE_FLAG";
		case 4:
			return "CAMP_EVENT_TYPE_CAMP_LOWER_WHITE_FLAG";
		case 5:
			return "CAMP_EVENT_TYPE_CAMP_LOWER_AND_LOCK_WHITE_FLAG";
		case 6:
			return "CAMP_EVENT_TYPE_CAMP_CLEAR_LOCK_WHITE_FLAG";
		case 7:
			return "CAMP_EVENT_TYPE_ON_SHOP_ITEM_SELECTED";
		case 8:
			return "CAMP_EVENT_TYPE_SET_ENTITY_SHOP_ITEM_SELECTED";
		case 9:
			return "CAMP_EVENT_TYPE_FOLLOWER_DEATH";
		case 10:
			return "CAMP_EVENT_TYPE_FOLLOWER_RESPAWN";
		case 11:
			return "CAMP_EVENT_TYPE_LOCAL_CAMP_MOVED";
		case 12:
			return "CAMP_EVENT_TYPE_STEW_RECIPE_CHANGED";
		case 13:
			return "CAMP_EVENT_TYPE_SERVED_STEW_CHANGED";
		case 14:
			return "CAMP_EVENT_TYPE_STEW_DONATOR_CHANGE";
		case 15:
			return "CAMP_EVENT_TYPE_STEW_DONATOR_REMOVED";
		case 16:
			return "CAMP_EVENT_TYPE_STEW_SERVED";
		case 17:
			return "CAMP_EVENT_TYPE_STEW_SERVED_DIALOGUE";
		case 18:
			return "CAMP_EVENT_TYPE_AMBIENT_DIALOGUE";
		case 19:
			return "CAMP_EVENT_TYPE_LEADER_CLAIMED_MEMBER_DONATION";
		case 20:
			return "CAMP_EVENT_TYPE_CAMP_PLAYED_MISSION_OUTRO_DIALOGUE";
		default:
			break;
	}
	if (iParam1 >= 1)
...
int func_41(bool bParam0, bool bParam1)
{
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[BUNDLE_HAS_PROPERTY_TAG] Found tag ", func_42(bParam1, 0), " for bundle ", func_75(bParam0, 0), ", returning TRUE");
		return 1;
	}
	return 0;
}
...
float func_49(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
	int iVar1;

	iVar0 = func_78();
	func_79(&iVar0, 0, 0, 0, 1, 0, 0);
	iVar1 = func_80(iParam0, 2);
	DEBUG::_0x1B08D1EB9D8C4931(8, 84, "_RPG_GLOBAL_APPLY_CORE_FIX_DEGRADE - Degrade Count: ", iVar1);
	if (func_82(iVar0, func_81(iParam0, 2), 1))
	{
		func_83(iParam0, 0, 2);
		iVar1 = 0;
		DEBUG::_0x1B08D1EB9D8C4931(8, 84, "_RPG_GLOBAL_APPLY_CORE_FIX_DEGRADE - Reseting Degrade Count to 0, it's a whole new day!");
		DEBUG::_0x1B08D1EB9D8C4931(40, 84, "_RPG_GLOBAL_APPLY_CORE_FIX_DEGRADE - Degrade Time of Day: ", func_84(iVar0));
		DEBUG::_0x1B08D1EB9D8C4931(40, 84, "_RPG_GLOBAL_APPLY_CORE_FIX_DEGRADE - Current Time of Day: ", func_84(func_81(iParam0, 2)));
	}
	if (iVar1 >= 2)
	{
		func_54(103, bParam2);
	...
	func_85(iParam0, func_78(), 2);
	func_83(iParam0, iVar1 + 1, 2);
	return fParam1;
}
...
float func_50(int iParam0, int iParam1)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_ATTRIBUTE_CORE_DISPLAY_STATE - Failed to retrieve Core Value for ", func_86(iParam0, 0), " Returning -1.0. This is really bad. ");
	return -1f;
}
...
int func_51(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)
{
	...
	iVar0 = PLAYER::PLAYER_PED_ID();
	if (func_87(iVar0, iParam0, fParam1))
	{
		if (bParam2)
		{
			if (fParam1 >= 100f)
		...
		if (bParam3)
		{
			func_88(iParam0, 7000, iParam5);
		}
		func_89(iVar0, iParam0, fParam1);
		DEBUG::_0xA308F935BDECCEC0(10664, 84, "__RPG_GLOBAL_SET_PLAYER_ATTRIBUTE_CORE - Caching Player Attribute Core ", func_86(iParam0, 0), " Value Data. Setting to: ", fParam1, " Override Enabled: ", MISC::_0xF216F74101968DB0(func_90()));
		func_91(iParam0, fParam1, bParam4, iParam5);
	}
	return 1;
}
...
bool func_52()
{
	...
	return func_92(Global_1957252.f_1431.f_107, 0);
}
...
void func_53(float fParam0, bool bParam1)
{
	...
	if (iVar1 != iVar2)
	{
		Global_1957252.f_1431.f_107 = func_78();
		func_96(&(Global_1957252.f_1431.f_107), 0, 0, 1, 0, 0, 0, 0);
	}
	func_97(13, fVar0, 2);
...
void func_54(int iParam0, bool bParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(10376, 105, "TUTORIAL_MARK_RUN() - Tutorial with Set: ", iVar0, " & Flag", iVar1, " marked to run. ", func_101(iParam0));
...
int func_56(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	...
	iVar1 = PLAYER::PLAYER_PED_ID();
	DEBUG::_0xF0783374333FD8CE(2472, 84, "__RPG_GLOBAL_SET_OVERPOWER_FOR_PLAYER_ATTRIBUTE_INTERNAL - Attribute: ", func_55(iParam0, 0), " will be Overpowered this frame for  ", fParam1, " seconds on local player...");
	if (fParam1 == -1f)
	{
		if (func_102(iParam0))
		{
	...
	{
		DEBUG::_0x6D2A5155B260E879(2472, 84, "__RPG_GLOBAL_SET_OVERPOWER_FOR_PLAYER_ATTRIBUTE_INTERNAL - Attribute: ", func_55(iParam0, 0), " was set to a Duration of: ", fParam1, " this is really bad. Correct this. ");
		return 0;
	}
	switch (iParam0)
	{
		...
		case 20:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(168, 84, "__RPG_GLOBAL_SET_OVERPOWER_FOR_PLAYER_ATTRIBUTE_INTERNAL - Attribute: ", func_55(iParam0, 0), " cannot be overpowered... Why are you doing this?");
			return 0;
	}
	return 1;
}
...
int func_57(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_109(iParam1))
	{
		DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_CONSUMABLE_PUSH_TO_SOURCE - Perk Group: ", func_110(iParam1, 0), " is not for Consumables. Bailing... ");
		return 0;
	}
	if (!func_111(iParam1))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(168, 84, "RPG_GLOBAL_CONSUMABLE_PUSH_TO_SOURCE - Provided Perk Group: ", func_110(iParam1, 0), " is not valid. Bailing... ");
		return 0;
	}
	if (!func_112(iParam0))
	{
		DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_CONSUMABLE_PUSH_TO_SOURCE - Perk Source: ", func_113(iParam0, 0), " is not for Consumables. Bailing... ");
		return 0;
	}
	if (!func_114(iParam0))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(168, 84, "RPG_GLOBAL_CONSUMABLE_PUSH_TO_SOURCE - Provided Perk Source: ", func_113(iParam0, 0), " is not valid. Bailing... ");
		return 0;
	}
	if (!func_115(iParam0))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(2728, 84, "RPG_GLOBAL_CONSUMABLE_PUSH_TO_SOURCE - There was already a Perk Group of Type: ", func_110(Global_1146683.f_35859.f_919[func_116(iParam0, 1) /*12*/], 0), " in Source: ", func_113(iParam0, 0), " disabling previous perk group before attempting to add new Perk Group... ");
		func_117(iParam0);
	}
	DEBUG::_0xA308F935BDECCEC0(2728, 84, "RPG_GLOBAL_CONTENT_EFFECT_PUSH_TO_SOURCE - attempting to active Perk Group: ", func_110(iParam1, 0), " at Perk Source: ", func_113(iParam0, 0), " with Duration: ", iParam2);
	if (func_118(iParam0, iParam1))
	{
		...
		DEBUG::_0xA308F935BDECCEC0(680, 84, "RPG_GLOBAL_CONTENT_EFFECT_PUSH_TO_SOURCE - Enabled Source: ", func_113(iParam0, 0), " with Perk Group: ", func_110(iParam1, 0));
		DEBUG::_0xA308F935BDECCEC0(2216, 84, "RPG_GLOBAL_CONTENT_EFFECT_PUSH_TO_SOURCE - Source: ", func_113(iParam0, 0), " will be disabled automatically at timestamp: ", Global_1146683.f_47689.f_1[iVar0 /*2*/].f_1, " Current Time: ", Global_1275959.f_21);
		return 1;
	}
	return 0;
}
...
void func_61(int iParam0, int iParam1)
{
	...
	Var0 = { func_62(joaat("EATEN"), func_120(iParam0)) };
	STATS::_STAT_ID_INCREMENT_INT(&Var0, iParam1);
	func_59(func_121(joaat("HERBS_EATEN")), iParam1);
}
...
void func_64(bool bParam0, int iParam1)
{
	...
	if (func_63() == 0)
	{
		bVar0 = func_122(bParam0, -949239683);
		DEBUG::_0xF0783374333FD8CE(10920, 183, "GENERIC_ITEM_DAILY_CHALLENGES ", func_3(bParam0, 0), " with Tag ", func_42(bVar0, 0), " removed with reason ", func_123(iParam1, 0));
...
bool func_77(int iParam0)
{
	...
	fVar0 = (func_131(iParam0) - PLAYER::_0xDF66A37936D5F3D9(iParam0));
	return fVar0 <= 1f;
}
...
int func_80(int iParam0, int iParam1)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_ATTRIBUTE_CORE_DEGRADE_COUNT - Failed to retrieve Core Degrade Count for ", func_86(iParam0, 0), " Returning -1. This is really bad. ");
	return -1;
}
...
int func_81(int iParam0, int iParam1)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_ATTRIBUTE_CORE_DEGRADE_TIME_OF_DAY - Failed to retrieve Core Degrade Time of Day for ", func_86(iParam0, 0), " Returning -1. This is really bad. ");
	return -15;
}
...
bool func_82(int iParam0, int iParam1, bool bParam2)
{
	if (bParam2)
	{
		if (!func_140(iParam1) || !func_140(iParam0))
		{
			return true;
		}
	}
...
void func_83(int iParam0, char* sParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DEGRADE_COUNT - Setting Core Degrade Count for ", func_86(iParam0, 0), " Pool: ", func_141(iParam2), " to ", sParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DEGRADE_COUNT - Failed to set Core Degrade Count for ", func_86(iParam0, 0), " Pool: ", func_141(iParam2), ". This is really bad. ");
			break;
	}
}
...
void func_85(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(10920, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DEGRADE_TIME_OF_DAY - Setting Core Degrade Time of Day for ", func_86(iParam0, 0), " Pool: ", func_141(iParam2), " to ", func_84(iParam1));
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DEGRADE_TIME_OF_DAY - Failed to set Core Degrade Time of Day for ", func_86(iParam0, 0), " Pool: ", func_141(iParam2), ". This is really bad. ");
			break;
	}
}
...
bool func_87(int iParam0, int iParam1, float fParam2)
{
	...
	ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(iParam0, func_143(iParam1), BUILTIN::CEIL(fParam2));
	return true;
}
...
void func_88(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DISPLAY_TIME - Setting Core Display Time for ", func_86(iParam0, 0), " Pool: ", func_141(iParam2), " to ", iParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DISPLAY_TIME - Failed to set Core Display Time for ", func_86(iParam0, 0), " Pool: ", func_141(iParam2), ". This is really bad. ");
			break;
	}
}
...
void func_89(int iParam0, int iParam1, float fParam2)
{
	...
	{
		PED::_SET_PED_BLACKBOARD_FLOAT(iParam0, func_145(iParam1), fParam2, -1);
	}
	else
	{
		DEBUG::_0x6D2A5155B260E879(40, 84, "__RPG_GLOBAL_HANDLE_BLACKBOARD_FOR_ATTRIBUTE - INVALID BLACK BOARD NAME for Attribute Core: ", func_86(iParam1, 0));
	}
}
...
void func_91(int iParam0, char* sParam1, bool bParam2, int iParam3)
{
	char* sVar0;
	...
	DEBUG::_0xA308F935BDECCEC0(43432, 84, "__RPG_GLOBAL_CACHE_ATTRIBUTE_CORE_DATA - Caching Attribute Core ", func_86(iParam0, 0), " Value Data. Setting to: ", sParam1, " Override Enabled: ", MISC::_0xF216F74101968DB0(func_90()), " Time Stamp: ", sVar0);
	func_146(iParam0, sParam1, iParam3);
	if (bParam2)
	{
		func_147(iParam0, sVar0, iParam3);
	}
}

bool func_92(int iParam0, bool bParam1)
{
	return func_82(func_78(), iParam0, bParam1);
}
...
float func_93(int iParam0, int iParam1)
{
	...
	{
		case 0:
			DEBUG::_0x1B08D1EB9D8C4931(424, 84, "[RPG_GLOBAL_GET_CACHED_PLAYER_ATTRIBUTE_XP] Pool for Attributes: ", func_148(0, 0), " Value: ", Global_1957252.f_1431.f_26[iParam0]);
			return Global_1957252.f_1431.f_26[iParam0];
		case 1:
			DEBUG::_0x1B08D1EB9D8C4931(424, 84, "[RPG_GLOBAL_GET_CACHED_PLAYER_ATTRIBUTE_XP] Pool for Attributes: ", func_148(1, 0), " Value: ", Global_1957252.f_1565.f_2.f_26[iParam0]);
			return Global_1957252.f_1565.f_2.f_26[iParam0];
		default:
			break;
	}
	DEBUG::_0x6D2A5155B260E879(40, 84, "[RPG_GLOBAL_GET_CACHED_PLAYER_ATTRIBUTE_XP] Couldn't retrieve Cached Attribute XP data for Attribute: ", func_55(iParam0, 0));
	return -1f;
}

int func_94(float fParam0)
{
	float fVar0;
...
void func_96(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_97(int iParam0, char* sParam1, int iParam2)
{
	if (!func_149(iParam0))
	{
		return 0;
	...
	DEBUG::_0xA308F935BDECCEC0(10664, 84, "__RPG_GLOBAL_SET_PLAYER_ATTRIBUTE - Caching Attribute ", func_55(iParam0, 0), " XP Data. Setting to: ", sParam1, " Override Enabled: ", MISC::_0xF216F74101968DB0(func_90()));
	func_150(iParam0, sParam1, iParam2);
...
bool func_99(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_151(iParam1, iParam2))
	{
		if (!bParam3)
		{
			DEBUG::_0xA308F935BDECCEC0(168, 105, "TUTORIAL_CAN_GO_PENDING_CHECKS - Tutorial: ", func_101(iParam0), " has already run, and is not being forced.");
			return false;
		}
	}
	if (!func_152(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 105, "TUTORIAL_CAN_GO_PENDING_CHECKS - NOT CAN_TUTORIAL_PLAY_IN_MODE ", func_153(iParam0, 0));
		return false;
	}
	if (func_154(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 105, "TUTORIAL_CAN_GO_PENDING_CHECKS - Timed tutorial is delayed or finished ", func_153(iParam0, 0));
		return false;
	}
	if ((Global_1900777.f_67 && !func_155(iParam0, 1)) || func_156(32768))
	{
		if (!func_155(iParam0, 262144) || !Global_1904703.f_8785)
		{
...
char* func_103(int iParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(168, 84, "RPG_GLOBAL_GET_OVERPOWER_POSTFX_STRING_FOR_ATTRIBUTE - Attribute: ", func_55(iParam0, 0), " does not have an overpower post fx... Returning NULL ");
	return "";
}
...
void func_105(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 84, "RPG_GLOBAL__DISABLE_ALL_STATUS_EFFECT_SOURCES_OF_TYPE - Now disabling all Status Effects with Perk Group: ", func_110(iParam0, 0));
	iVar1 = Global_1146683.f_47689.f_1.f_42;
	iVar2 = 0;
	while (iVar2 < iVar1)
	{
		iVar0 = Global_1146683.f_47689.f_1[iVar2 /*2*/];
		iVar3 = func_116(iVar0, 1);
		if (Global_1146683.f_35859.f_919[iVar3 /*12*/] == iParam0)
		{
			DEBUG::_0xA308F935BDECCEC0(168, 84, "RPG_GLOBAL__DISABLE_ALL_STATUS_EFFECT_SOURCES_OF_TYPE - Disabling Source: ", func_113(Global_1146683.f_47689.f_1[iVar2 /*2*/], 0), " at index: ", iVar2);
			func_117(iVar0);
...
void func_107(int iParam0, bool bParam1)
{
	...
	func_46(BUILTIN::TO_FLOAT((iParam0 * iVar0)), 0, bParam1);
}
...
bool func_115(int iParam0)
{
	...
	return Global_1146683.f_35859.f_919[func_116(iParam0, 1) /*12*/] == -1;
}
...
int func_117(int iParam0)
{
	...
	iVar0 = func_116(iParam0, 1);
	if (!func_111(Global_1146683.f_35859.f_919[iVar0 /*12*/]))
	{
		return 1;
	}
	iVar3 = func_158(Global_1146683.f_35859.f_919[iVar0 /*12*/], 1);
	DEBUG::_0xA308F935BDECCEC0(2216, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Attempting to disable all Perks in Perk Group: ", func_110(Global_1146683.f_35859.f_919[iVar0 /*12*/], 0), " it has: ", Global_1146683.f_35859[iVar3 /*6*/].f_5, " perks...");
	iVar4 = 0;
	while (iVar4 < Global_1146683.f_35859[iVar3 /*6*/].f_5)
	{
		iVar1 = Global_1146683.f_35859[iVar3 /*6*/][iVar4];
		DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Disabling Perk: ", func_159(iVar1, 0), " from Source: ", func_113(iParam0, 0));
...
bool func_118(int iParam0, int iParam1)
{
	...
	if (!func_114(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(648, 84, "__RPG_GLOBAL__ENABLE_PERK_SOURCE_INTERNAL - invalid Source ID ", iParam0, " Name: ", func_113(iParam0, 0));
		return false;
	}
	iVar0 = func_116(iParam0, 1);
	if (!func_111(iParam1))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(648, 84, "__RPG_GLOBAL__ENABLE_PERK_SOURCE_INTERNAL - invalid Perk ID ", iParam1, " Name: ", func_110(iParam1, 0));
		return false;
	}
	iVar1 = func_158(iParam1, 1);
	if (Global_1146683.f_35859.f_919[iVar0 /*12*/] == iParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(40, 84, "__RPG_GLOBAL__ENABLE_PERK_SOURCE_INTERNAL - Perk Group is already active: ", func_110(iParam1, 0));
		return true;
	}
	if (func_111(Global_1146683.f_35859.f_919[iVar0 /*12*/]))
	{
	...
	DEBUG::_0xA308F935BDECCEC0(2216, 84, "__RPG_GLOBAL__ENABLE_PERK_SOURCE_INTERNAL - Attempting to enable all Perks in Perk Group: ", func_110(Global_1146683.f_35859.f_919[iVar0 /*12*/], 0), " it has: ", Global_1146683.f_35859[iVar1 /*6*/].f_5, " perks...");
	iVar4 = 0;
	while (iVar4 < Global_1146683.f_35859[iVar1 /*6*/].f_5)
	{
		...
		switch (func_167(iParam0, iVar2))
		{
			case 0:
				...
				break;
			case 1:
				DEBUG::_0xA308F935BDECCEC0(2728, 84, "__RPG_GLOBAL__ENABLE_PERK_SOURCE_INTERNAL - adding perk ", func_159(iVar2, 0), " + source ", func_113(iParam0, 0), " to activation queue");
			...
			case 2:
				...
				func_164(iVar3, 1);
				DEBUG::_0xA308F935BDECCEC0(2728, 84, "__RPG_GLOBAL__ENABLE_PERK_SOURCE_INTERNAL - Registering perk ", func_159(iVar2, 0), " from source ", func_113(iParam0, 0), ". total sources: ", Global_1146683.f_35859.f_3116[iVar3 /*31*/].f_29);
				iVar4++;
			}
			return true;
		}
...
int func_122(bool bParam0, int iParam1)
{
	...
	{
		DEBUG::_0xD9911C7B5F8CD69C(40, 158, "Failed to fillout item data for item ", func_3(bParam0, 0));
	}
	return 0;
}
...
{
	return func_175(&(Global_1957252.f_1565), iParam0, 1);
}
...
{
	return (PLAYER::_0x592F58BC4D2A2CF3(iParam0, 0) - IntToFloat(func_179(2)));
}
...
int func_143(int iParam0)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_PED_ATTRIBUTE_FROM_RPG_GLOBAL_CORE - Attribute Core: ", func_86(iParam0, 0), " does not have an associated PED Attribute. This is REALLY bad, correct immediately... ");
	return 0;
}
...
void func_146(int iParam0, char* sParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(6824, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_VALUE - Setting Core Value for ", func_86(iParam0, 0), " Pool: ", func_141(iParam2), " to ", sParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_VALUE - Failed to set Core Value for ", func_86(iParam0, 0), " Pool: ", func_141(iParam2), ". This is really bad. ");
			break;
	}
}
...
void func_147(int iParam0, char* sParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_LAST_UPDATED_TIMESTAMP - Setting Last Updated Timestamp for ", func_86(iParam0, 0), " Pool: ", func_141(iParam2), " to ", sParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_LAST_UPDATED_TIMESTAMP - Failed to set Last Updated Timestamp for ", func_86(iParam0, 0), " Pool: ", func_141(iParam2), ". This is really bad. ");
			break;
	}
}

char* func_148(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case 0:
...
void func_150(int iParam0, float fParam1, int iParam2)
{
	if (fParam1 < 0f)
	{
		return;
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(6824, 84, "__RPG_GLOBAL_SET_CACHED_ATTRIBUTE_XP - Setting Attribute XP for ", func_55(iParam0, 0), " Pool: ", func_141(iParam2), " to ", fParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_CACHED_ATTRIBUTE_XP - Failed to set Attribute XP for ", func_55(iParam0, 0), " Pool: ", func_141(iParam2), ". This is really bad. ");
			break;
	}
}
...
bool func_154(int iParam0)
{
	...
	while (iVar0 < Global_38.f_3538)
	{
		if (Global_38.f_3538[iVar0 /*3*/].f_2 == iParam0)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(168, 105, "IS_TIMED_TUTORIAL_DELAYED_OR_FINISHED time since last played tutorial ", func_153(iParam0, 0), " Seconds ", iVar2);
...
int func_160(int iParam0, int iParam1)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(10920, 84, "RPG_GLOBAL_STAT_GET_DEACTIVATION_TYPE - Source: ", func_113(iParam0, 0), " Perk: ", func_159(iParam1, 0), " Deactivation Trigger: ", func_190(Global_1146683.f_35859.f_3116[iVar2 /*31*/].f_1, 0));
...
int func_161(int iParam0, int iParam1, int iParam2)
{
	...
	func_192(iParam0, iParam1, iParam2);
	if (func_193(Global_1146683.f_35859.f_3116[iVar0 /*31*/]) && func_194(iParam0, Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK - Now checking Stack Group: ", func_195(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, 0), " for any perks that could be enabled now that this perk is diabled... ");
		vVar1 = { func_196(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4) };
		if (func_197(vVar1))
		{
			if (func_198(vVar1.x, vVar1.y, vVar1.z))
			{
				func_199(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, vVar1.x, vVar1.y, vVar1.z);
			}
			else
			{
				func_200(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4);
				DEBUG::_0x6D2A5155B260E879(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK - Failed to activate next availible perk in Stack Group: ", func_195(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, 0), " there was a critical failure... ");
			}
		}
		else
		{
			func_200(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4);
			DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK - No suitable replacement for active perk in Stack Group: ", func_195(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, 0), "...");
		}
	}
	return 1;
}
...
void func_164(int iParam0, int iParam1)
{
	...
	DEBUG::_0xF0783374333FD8CE(2216, 84, "__RPG_GLOBAL__ALTER_SOURCES_FOR_PERK_ID - Perk: ", func_159(func_201(iParam0, 1), 0), " is being altered by: ", iParam1, " to a total of: ", Global_1146683.f_35859.f_3116[iParam0 /*31*/].f_29);
}

void func_165(int iParam0, int iParam1)
{
	Global_1146683.f_35859.f_3116[iParam0 /*31*/].f_29 = iParam1;
	DEBUG::_0xF0783374333FD8CE(168, 84, "__RPG_GLOBAL__SET_SOURCES_FOR_PERK_ID - Perk: ", func_159(func_201(iParam0, 1), 0), " is being set to: ", Global_1146683.f_35859.f_3116[iParam0 /*31*/].f_29);
}
...
int func_167(int iParam0, int iParam1)
{
	...
	iVar1 = Global_1275959;
	iVar2 = func_163(iParam1, 1);
	DEBUG::_0x1B08D1EB9D8C4931(10920, 84, "RPG_GLOBAL_STAT_GET_ACTIVATION_TYPE -	Source: ", func_113(iParam0, 0), " Perk: ", func_159(iParam1, 0), " Activation Trigger: ", func_202(Global_1146683.f_35859.f_3116[iVar2 /*31*/], 0));
...
int func_168(int iParam0, int iParam1, int iParam2)
{
	...
	bVar1 = func_193(Global_1146683.f_35859.f_3116[iVar0 /*31*/]);
	if (bVar1 && func_204(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK - There is an active perk already in stack group: ", func_195(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, 0), " will need to disable perk first... ");
		vVar2 = { func_205(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4) };
		if (!func_192(vVar2.x, vVar2.y, vVar2.z))
		{
			DEBUG::_0x6D2A5155B260E879(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK - critical failure to deactivate active perk in stacking group: ", func_195(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, 0), " bailing out... ");
			return 0;
		}
	}
	if (func_198(iParam0, iParam1, iParam2))
	{
		if (bVar1)
		{
			func_199(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, iParam0, iParam1, iParam2);
		}
		return 1;
	}
	return 0;
...
int func_179(int iParam0)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_ATTRIBUTE_CORE_MAX_SIZE - Attribute Core: ", func_86(iParam0, 0), " is INVALID. Correct this immediately... ");
	return -1;
}
...
void func_183(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0x83407B92D46F25C3(559240, 0, "SET_TIMEOFDAY_DAY: Passed an invalid day [", iParam1, "] for the TIMEOFDAY's current month [", iVar0, "] for year ", iVar1, ". GET_NUMBER_OF_DAYS_IN_MONTH(eMonth, iYear) = ", func_138(iVar0, iVar1), ". Failed to set TIMEOFDAY.");
		return;
	}
...
bool func_192(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = func_116(iParam1, 1);
	bVar1 = func_163(iParam0, 1);
	iVar2 = func_158(Global_1146683.f_35859.f_919[iVar0 /*12*/], 1);
	if (Global_1146683.f_35859[iVar2 /*6*/][iParam2] != iParam0)
	{
		DEBUG::_0x9A6C65DDDBEC9C52(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK_INTERNAL - attempting to disable perk ", func_159(iParam0, 0), " from a source that hasn't previously enabled it ", func_113(iParam1, 0));
		return false;
	}
	...
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK_INTERNAL - deactivating perk ", func_159(iParam0, 0), " and source ", func_113(iParam1, 0));
	...
	while (iVar4 < Global_1146683.f_35859.f_3116[bVar1 /*31*/].f_16)
	{
		...
		else
		{
			...
			Global_1146683.f_2169[iVar5 /*205*/].f_201 = (Global_1146683.f_2169[iVar5 /*205*/].f_201 - func_208(&(Global_1146683.f_35859.f_3116[bVar1 /*31*/].f_6[iVar4 /*3*/])));
			DEBUG::_0xA308F935BDECCEC0(6824, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK_INTERNAL - removing perk ", func_159(iParam0, 0), " to stat mod ", func_209(iVar3, 0), " with strength ", Global_1146683.f_35859.f_3116[bVar1 /*31*/].f_6[iVar4 /*3*/].f_1);
			func_210(iVar3);
		}
		iVar4++;
	}
...
bool func_193(struct<5> Param0, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30)
{
	return Param0.f_4 != 0;
}
...
bool func_198(int iParam0, int iParam1, int iParam2)
{
	...
	if (Global_1146683.f_35859[iVar2 /*6*/][iParam2] != iParam0)
	{
		DEBUG::_0x9A6C65DDDBEC9C52(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - attempting to disable perk ", func_159(iParam0, 0), " from a source that hasn't previously enabled it ", func_113(iParam1, 0));
		return false;
	}
	...
	DEBUG::_0xA308F935BDECCEC0(2728, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK - activating perk ", func_159(iParam0, 0), " and source ", func_113(iParam1, 0), " at POSIX time: ", Global_1275959.f_21);
	...
	while (iVar4 < Global_1146683.f_35859.f_3116[bVar1 /*31*/].f_16)
	{
		...
		else
		{
			...
			Global_1146683.f_2169[iVar5 /*205*/].f_201 = (Global_1146683.f_2169[iVar5 /*205*/].f_201 + func_208(&(Global_1146683.f_35859.f_3116[bVar1 /*31*/].f_6[iVar4 /*3*/])));
			DEBUG::_0xA308F935BDECCEC0(6824, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - adding perk ", func_159(iParam0, 0), " to stat mod ", func_209(iVar3, 0), " with strength ", func_208(&(Global_1146683.f_35859.f_3116[bVar1 /*31*/].f_6[iVar4 /*3*/])));
			DEBUG::_0xA308F935BDECCEC0(6824, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - adding perk ", func_159(iParam0, 0), " to stat mod ", func_209(iVar3, 0), " with total ", Global_1146683.f_2169[iVar5 /*205*/].f_201);
			func_217(iVar3);
		}
		iVar4++;
	}
	DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - perk: ", func_159(iParam0, 0), " Flag Count: ", Global_1146683.f_35859.f_3116[bVar1 /*31*/].f_28);
	iVar7 = 0;
	while (iVar7 < Global_1146683.f_35859.f_3116[bVar1 /*31*/].f_28)
	{
		iVar6 = Global_1146683.f_35859.f_3116[bVar1 /*31*/].f_17[iVar7 /*2*/];
		if (!func_211(iVar6))
		{
			DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - Flag: ", func_218(iVar6, 0), " is not valid... skipping... ");
		}
		else if (!func_219(&(Global_1146683.f_35859.f_3116[bVar1 /*31*/].f_17[iVar7 /*2*/])))
		{
			DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - Flag: ", func_218(iVar6, 0), " is not currently disabled by tunables... skipping... ");
		}
		else
		{
			iVar8 = func_212(iVar6, 1);
			...
			{
				DEBUG::_0xA308F935BDECCEC0(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - Turning on flag ", func_218(iVar6, 0));
	...
	func_221(Global_1146683.f_35859.f_3116[bVar1 /*31*/].f_2);
	return true;
}
...
void func_199(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (!func_214(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA - Perk Group: ", func_195(iParam0, 0), " is not valid... Bailing out... ");
		return;
	}
	...
	if (!func_114(iParam2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA - Source: ", func_113(iParam2, 0), " is not valid... Bailing out... ");
		return;
	}
	if (!func_203(iParam3))
	{
	...
	DEBUG::_0xF0783374333FD8CE(680, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA - Setting Perk: ", func_159(iParam1, 0), " active for Perk Group: ", func_195(iParam0, 0));
...
void func_200(int iParam0)
{
	...
	iVar0 = func_215(iParam0, 1);
	DEBUG::_0xF0783374333FD8CE(680, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA_AS_INVALID - Setting Perk: ", func_159(-1, 0), " active for Perk Group: ", func_195(iParam0, 0));
...
bool func_208(var uParam0)
{
	...
	if (uParam0->f_2 != 0)
	{
		DEBUG::_0xF0783374333FD8CE(168, 84, "RPG_GLOBAL_STATS_GET_STAT_MOD_IMPACT - Stat Mod: ", func_209(*uParam0, 0), " has a Tunable associated with impact, looking up... ");
		bVar0 = func_223(794259616, uParam0->f_2, uParam0->f_1, "");
		DEBUG::_0xF0783374333FD8CE(424, 84, "RPG_GLOBAL_STATS_GET_STAT_MOD_IMPACT - Stat Mod: ", func_209(*uParam0, 0), " has an associated Tunable with impact: ", bVar0);
		return bVar0;
	}
	DEBUG::_0xF0783374333FD8CE(424, 84, "RPG_GLOBAL_STATS_GET_STAT_MOD_IMPACT - Stat Mod: ", func_209(*uParam0, 0), " using default Impact: ", uParam0->f_1);
	return uParam0->f_1;
}
...
void func_210(int iParam0)
{
	...
	if (!func_207(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__UNSUBSCRIBE_STAT_MOD - Stat Mod: ", func_209(iParam0, 0), " is Invalid... ");
		return;
	}
	iVar0 = func_206(iParam0, 1);
	if (!func_224(Global_1146683.f_2169[iVar0 /*205*/]))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__UNSUBSCRIBE_STAT_MOD - no RPG stat associated with stat mod ", func_209(iParam0, 0));
		return;
	}
	...
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__UNSUBSCRIBE_STAT_MOD - stat mod ", func_209(iParam0, 0), " is no longer impacting stat ", func_225(Global_1146683.f_2169[iVar0 /*205*/], 0));
	Global_1146683.f_2169[iVar0 /*205*/].f_204 = 0;
	if (!func_226(Global_1146683.f_2169[iVar0 /*205*/].f_203))
	{
		return;
	}
	iVar1 = func_227(Global_1146683.f_2169[iVar0 /*205*/].f_203, 1);
	...
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__UNSUBSCRIBE_STAT_MOD - removing stat ", func_225(Global_1146683.f_2169[iVar0 /*205*/], 0), " from subscribed action ", func_228(Global_1146683.f_2169[iVar0 /*205*/].f_203, 0));
	iVar2 = 0;
...
void func_213(int iParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_STAT_FLAG - Now Disabling Stat Flag: ", func_218(iParam0, 0));
	iVar0 = PLAYER::PLAYER_PED_ID();
	iVar1 = PLAYER::PLAYER_ID();
	switch (iParam0)
	{
		...
		case joaat("TRAIL_EFFECT"):
			...
			GRAPHICS::_0xC5CB91D65852ED7E(func_231(iParam0));
			break;
		case joaat("DRAIN_EFFECT"):
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
		case joaat("SLOW_AND_STEADY_VFX"):
			DEBUG::_0xF0783374333FD8CE(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_STAT_FLAG - Remove VFX ", func_218(iParam0, 0));
...
int func_216(int iParam0)
{
	...
	while (iVar65 < Global_1146683.f_35859.f_11700)
	{
		...
		else if (!func_235(Global_1146683.f_35859.f_9503[iVar65 /*3*/], Global_1146683.f_35859.f_9503[iVar65 /*3*/].f_1))
		{
		}
		else
		{
			Var1 = { func_236(Global_1146683.f_35859.f_9503[iVar65 /*3*/]) };
...
void func_217(int iParam0)
{
	...
	if (!func_207(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__SUBSCRIBE_STAT_MOD - Stat Mod: ", func_209(iParam0, 0), " is Invalid... ");
		return;
	}
	iVar0 = func_206(iParam0, 1);
	if (!func_224(Global_1146683.f_2169[iVar0 /*205*/]))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__SUBSCRIBE_STAT_MOD - no RPG stat associated with stat mod ", func_209(iParam0, 0));
		return;
	}
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__SUBSCRIBE_STAT_MOD - subcribing stat mod ", func_209(iParam0, 0), " to stat ", func_225(Global_1146683.f_2169[iVar0 /*205*/], 0));
	...
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__SUBSCRIBE_STAT_MOD - adding stat ", func_225(Global_1146683.f_2169[iVar0 /*205*/], 0), " to action ", func_228(Global_1146683.f_2169[iVar0 /*205*/].f_203, 0));
...
bool func_219(var uParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(680, 84, "RPG_GLOBAL_STATS_IS_STAT_FLAG_TUNABLE_ENABLED - Stat Flag: ", func_218(*uParam0, 0), " Associated Tunable: ", UNK_0x4379B6FA65D55295(uParam0->f_1));
	if (uParam0->f_1 != 0)
	{
		bVar0 = func_237(794259616, uParam0->f_1, 1, "");
		DEBUG::_0xF0783374333FD8CE(680, 84, "RPG_GLOBAL_STATS_IS_STAT_FLAG_TUNABLE_ENABLED - Stat Flag: ", func_218(*uParam0, 0), " is has Tunable Enabled State: ", MISC::_0xF216F74101968DB0(bVar0));
		return bVar0;
	}
	return true;
}
...
void func_220(int iParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_STAT_FLAG - Now Enabling Stat Flag: ", func_218(iParam0, 0));
	iVar0 = PLAYER::PLAYER_PED_ID();
	iVar1 = PLAYER::PLAYER_ID();
	switch (iParam0)
	{
		...
		case joaat("TRAIL_EFFECT"):
			...
			GRAPHICS::ANIMPOSTFX_PLAY(func_231(iParam0));
			break;
		case joaat("DRAIN_EFFECT"):
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			...
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_238(iParam0, 0));
			func_239(iVar2, 0, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_238(iParam0, 1));
			func_239(iVar2, 1, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_238(iParam0, 2));
			func_239(iVar2, 2, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_238(iParam0, 3));
			func_239(iVar2, 2, 1, iVar3, 0);
			break;
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
			DEBUG::_0xF0783374333FD8CE(8, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_STAT_FLAG - Moment to Recuperate VFX start. ");
			iVar2 = func_232(iParam0);
			func_239(iVar2, 3, 1, -1, 1);
			break;
		case joaat("SLOW_AND_STEADY_VFX"):
			DEBUG::_0xF0783374333FD8CE(8, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_STAT_FLAG - Slow and Steady VFX start. ");
			iVar2 = func_232(iParam0);
			func_239(iVar2, 4, 1, -1, 0);
			break;
		case joaat("MOMENT_TO_RECUPERATE_AURA"):
...
void func_221(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - Attempting to play Activation Sound: ", func_241(iParam0, 0));
	sVar0 = func_242(iParam0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - There is no sound name associated with Activation Sound: ", func_241(iParam0, 0), " not playing anything...");
		return;
	}
	DEBUG::_0x1B08D1EB9D8C4931(680, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - Found sound name: ", sVar0, " associated with Activation Sound: ", func_241(iParam0, 0));
	sVar1 = func_243(iParam0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - There is no sound set associated with Activation Sound: ", func_241(iParam0, 0), " not playing anything...");
		return;
	}
	DEBUG::_0x1B08D1EB9D8C4931(680, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - Found sound set: ", sVar1, " associated with Activation Sound: ", func_241(iParam0, 0));
	DEBUG::_0xF0783374333FD8CE(10920, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - Playing sound name: ", sVar0, " in sound set: ", sVar1, " for Activation Sound: ", func_241(iParam0, 0));
...
bool func_223(bool bParam0, bool bParam1, float fParam2, char* sParam3)
{
	struct<11> Var0;
	bool bVar22;

	if (func_244(bParam0, bParam1, &Var0))
	{
...
bool func_224(bool bParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(168, 84, "RPG_GLOBAL_STATS__ADD_STAT_ID_TO_UPDATE_QUEUE - adding stat ", func_225(bParam0, 0), " to update queue. Total stats in queue: ", Global_1146683.f_2165);
	return true;
}

char* func_225(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case -1:
...
void func_229()
{
	...
	{
		if (!func_245(Global_1277758[Global_1275959 /*87*/].f_86, 1))
		{
...
char* func_231(int iParam0)
{
	...
	DEBUG::_0x9A6C65DDDBEC9C52(168, 84, "RPG_GLOBAL_GET_STAT_FLAG_POSTFX_NAME - Stat Flag: ", func_218(iParam0, 0), " does not have a Post FX name. Should you set one up? ");
	return "";
}
...
int func_232(int iParam0)
{
	...
	DEBUG::_0x9A6C65DDDBEC9C52(168, 84, "RPG_GLOBAL_GET_STAT_FLAG_PTFX_SCRIPT_ID - Stat Flag: ", func_218(iParam0, 0), " does not have a Particle FX. Should you set one up? ");
	return 0;
}
...
bool func_235(int iParam0, int iParam1)
{
	...
	if (func_193(Global_1146683.f_35859.f_3116[iVar0 /*31*/]))
	{
		iVar3 = Global_1146683.f_35859.f_9286[func_215(iVar2, 1) /*3*/];
		Var4 = { func_236(iVar3) };
		if (iVar3 != iParam0 && Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_5 <= Var4.f_5)
		{
			DEBUG::_0x1B08D1EB9D8C4931(680, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - A stronger perk in the perk stack group: ", func_195(iVar2, 0), " is already active. Active Perk: ", func_159(iVar3, 0));
			return false;
		}
	}
	DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Evaluating Activation Trigger: ", func_202(Global_1146683.f_35859.f_3116[iVar0 /*31*/], 0), " for activation... ");
	switch (Global_1146683.f_35859.f_3116[iVar0 /*31*/])
	{
		...
		case joaat("ALLY_ENTER_DEADEYE"):
			...
			if (iVar1 != Global_1275959 && !func_73(Global_1275959.f_154[iVar1]))
			{
...
struct<31> func_236(int iParam0)
{
	int iVar0;
...
bool func_237(bool bParam0, bool bParam1, bool bParam2, char* sParam3)
{
	struct<11> Var0;
	bool bVar22;
...
char* func_238(int iParam0, int iParam1)
{
	...
	DEBUG::_0x9A6C65DDDBEC9C52(168, 84, "RPG_GLOBAL_GET_STAT_FLAG_PTFX_BONE - Stat Flag: ", func_218(iParam0, 0), " does not have a Particle FX bone. Should you set one up? ");
	return "";
}
...
bool func_244(bool bParam0, bool bParam1, var uParam2)
{
	struct<5> Var0;
	int iVar7;
	...
	if (DATAFILE::_0x44B3A36933AC009C(&iVar7, &Var0, joaat("NAME")))
	{
		*uParam2 = bParam0;
		...
		uParam2->f_10.f_3 = func_249(iVar7);
...
bool func_247()
{
	...
	if (func_252(Global_524288.f_40400))
	{
