...
bool func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_27)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_77(iLocal_27));
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_78(iLocal_27, 0), 1);
					break;
			}
		}
		if (func_10(func_70()))
	...
	else
	{
		...
		if (func_45() == -1)
		{
			func_82(iLocal_27);
			func_83(iLocal_27);
			if (!func_84(iLocal_27, 0))
			{
				return false;
			}
		}
		else if (!func_85(iLocal_27))
		{
			return false;
		}
	}
...
int func_58(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == 0)
	{
		DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_96(iParam0), " IS INVALID.");
		return 0;
	}
	DEBUG::_0x4DC69742196F818A(168, 0, "REGION_INIT_PROPERTY - REGIONAL CHARACTER WITH INDEX: ", func_96(iParam0), " IS VALID.");
...
bool func_68(int iParam0)
{
	...
	return ((Global_1887351[iParam0 /*36*/].f_21 == 1 || Global_1887351[iParam0 /*36*/].f_21 == 2) && !func_99(iParam0));
}
...
void func_71(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_101(iParam0, 0), " ", func_102(iParam1, 0), " ", func_103(bParam2, 0), " state ", func_104(iParam4, 0));
	UNK_0x355E72323AEE83CC(11, 6);
	sVar1 = func_105(iParam0, iParam1, bParam2, iParam4, bParam5, bParam3, &bVar0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_101(iParam0, 0), " or ", func_102(iParam1, 0), " or ", func_103(bParam2, 0));
	...
	if (!func_106(iParam4))
	{
		if (func_62(iParam0))
		{
			iParam4 = func_107(func_9(iParam0));
		}
		else
		{
	...
	if (bVar0 && bParam3)
	{
		sVar2 = func_110(func_109(bParam2));
	}
	else if ((func_111(iParam1, 2) || func_112(iParam4, 2)) && !Global_1893599.f_9)
	{
	...
	else if ((func_62(iParam0) && func_87(iParam0, 16777216)) && !Global_1893599.f_9)
	{
	...
	Global_1939313.f_145 = func_118(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
bool func_84(int iParam0, bool bParam1)
{
	...
	if (func_91(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_126(Global_1896632.f_1, 16))
			{
				func_127(Global_1896632.f_1, 0);
			}
			Global_1896632.f_1++;
			iVar2++;
...
int func_94(int iParam0, bool bParam1)
{
	if (!func_92(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_96(iParam0), " is invalid");
		return 0;
	}
	if (!func_126(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_96(iParam0), " has not been initialized");
		return 0;
	}
	if (func_126(iParam0, 32) && !bParam1)
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_96(iParam0), " has been locked dead");
		...
		if (func_45() == -1)
		{
			if (func_126(iParam0, 2048))
			{
				...
				DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_96(iParam0), " has been revived!");
			}
	...
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_96(iParam0), " dead or not spawning, turn scenario groups off");
		return 0;
	}
	if (PERSCHAR::_0x800DF3FC913355F3(func_59(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Persistent character ", func_96(iParam0), " already exists");
		func_135(iParam0, 128);
		return 1;
	}
	func_134(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_133(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_59(iParam0));
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_96(iParam0), " perschar index created!");
	if (func_126(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_59(iParam0));
		func_135(iParam0, 2048);
	...
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_96(iParam0), " created.");
...
bool func_95(int iParam0, bool bParam1)
{
	...
	if (!PERSCHAR::_0x800DF3FC913355F3(func_59(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - Checking if ", func_96(iParam0), " is alive when the perschar index is not created.");
		return false;
	}
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_60(iParam0)))
	{
		DEBUG::_0x4DC69742196F818A(168, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_96(iParam0), " does not have a ped spawned.");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(2216, 138, "IS_REGIONAL_CHARACTER_ALIVE - ", func_96(iParam0), " being processed - ALIVE = ", !PERSCHAR::_0xEB98B38CA60742D7(func_59(iParam0)), "!");
...
{
	if ((iParam0 == 22 || iParam0 == 39) && !func_138())
	{
		return true;
	}
	if (iParam0 == 66)
...
char* func_105(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893599.f_162)))
	{
		sVar0 = func_141(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_143(func_142(Global_34));
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		if (!func_144(iParam0) || func_145(44))
		{
			switch (iParam0)
			{
				case 2:
...
int func_108(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_146(PLAYER::PLAYER_ID()) };
...
void func_120(var uParam0, int iParam1)
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_148(iParam1, 0));
}
...
{
	DEBUG::_0x4DC69742196F818A(40, 195, "CLEAR_SALOON: Clearing ", func_149(iParam0));
	func_150(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_151(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
	...
	func_152(iParam0, 8192);
	func_152(iParam0, 32768);
	func_152(iParam0, 524288);
	func_152(iParam0, 1048576);
...
void func_125(int iParam0)
{
	...
	if (func_92(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_153(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_154(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_155(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_156(iParam0, 536870912);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_159(Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
int func_127(int iParam0, bool bParam1)
{
	if (!func_92(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_96(iParam0), " is invalid");
		return 0;
	}
	if (!func_126(iParam0, 2))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_96(iParam0), " has not been initialized");
		return 0;
	}
	if (func_133(iParam0) == 0)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_96(iParam0), " doesn't exist");
		return 1;
	}
	if (!PERSCHAR::_0x800DF3FC913355F3(func_59(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_96(iParam0), " already destroyed");
		return 1;
	}
	if (func_126(iParam0, 1) && !bParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_96(iParam0), " is stolen, so it will be destoyed on release.");
		func_161(iParam0, 128);
		return 1;
	}
	func_135(iParam0, 129);
	func_162(iParam0);
	DEBUG::_0xA308F935BDECCEC0(40, 138, "DESTROY_REGIONAL_CHARACTER: Destroying ", func_96(iParam0));
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_59(iParam0));
	func_134(iParam0, 0);
	DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: ", func_96(iParam0), " destroyed.");
	return 1;
}
...
void func_130()
{
	...
	while (iVar0 <= 3)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ NET_CLEAR_BARTENDERS - Removed ", func_167(Global_1051777.f_3642[iVar0 /*19*/]));
...
void func_132(int iParam0, bool bParam1)
{
	...
	bVar0 = (func_168(iParam0) && !bParam1);
	if (!bVar0 && !func_169(iParam0, 65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] - Shop keeper deleted for shop: ", func_170(iParam0));
		}
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] Remove the script created scenario for: ", func_170(iParam0));
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_159(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar2]);
	...
	func_174(iParam0);
	if (func_169(iParam0, 262144))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 139, "NET_CLEAR_SHOP: SPF_ALLOW_BLIP_OUT_OF_REGION for ", func_170(iParam0), " is kept; all other flags cleared.");
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_24) && func_175(iParam0, 2))
	{
...
void func_135(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_176(iParam1), " on ", func_96(iParam0));
}
...
bool func_136(int iParam0)
{
	...
	if (!func_126(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_96(iParam0), " has not been initialized");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(40, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_96(iParam0));
	return true;
}
...
bool func_140(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_179(func_56(0)))
	{
		return true;
	}
...
char* func_141(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
void func_152(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 195, "CLEAR_SALOON_CONFIG_FLAG: Clearing flag for ", func_184(iParam1, 0));
	func_185(&(Global_1940170.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_154(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that isnt stolen ", func_96(iParam0));
		return;
	}
	if (!func_126(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release an uninitialized regional character ", func_96(iParam0));
		return;
	}
	if ((!bParam4 && !func_153(iParam0)) && func_186(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that is stolen by a differnt script ", func_96(iParam0));
		return;
	}
	DEBUG::_0xF0783374333FD8CE(680, 138, "RELEASE_REGIONAL_CHARACTER: Regional character ", func_96(iParam0), " released by ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
	func_135(iParam0, 1);
	func_162(iParam0);
	if (func_187(func_133(iParam0)))
	{
		...
		if (!PERSCHAR::_0x800DF3FC913355F3(iVar0))
		{
			DEBUG::_0x9A6C65DDDBEC9C52(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character with no perschar index", func_96(iParam0));
			return;
		}
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being retasked ", func_96(iParam0));
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being destroyed on release ", func_96(iParam0));
		func_127(iParam0, 0);
	}
}
...
{
	if (func_194(bParam0) && func_195())
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 183, "RELEASE_DOOR_ID - Releasing Door ID ", func_196(bParam0, 0));
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 139, "CLEAR_ALL_SHOP_TYPE_FLAGS: ", func_170(iParam0));
...
void func_161(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_176(iParam1), " on ", func_96(iParam0));
}
...
void func_162(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar0, false))
		{
			...
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_96(iParam0), " set as no longer needed.");
		}
		else
		{
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_96(iParam0), " was asked to be set as no longer needed, but this script does not own the ped.");
		}
	}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_FLAGS] ", func_170(iParam0));
	Global_1051777.f_80[iParam0 /*75*/].f_49 = 0;
}

void func_164(int iParam0)
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_SUPPORT_FLAGS] ", func_170(iParam0));
...
void func_172(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_170(iParam0), " flag ", func_198(iParam1));
	}
	Global_1051777.f_80[iParam0 /*75*/].f_1 = (Global_1051777.f_80[iParam0 /*75*/].f_1 - (Global_1051777.f_80[iParam0 /*75*/].f_1 && iParam1));
}
...
{
	return func_199(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}
...
bool func_177()
{
	...
	if (!func_179(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
int func_204(int iParam0)
{
	...
	DEBUG::_0xD9911C7B5F8CD69C(168, 139, "GET_SHOP_TYPE_FROM_SHOP - ", func_197(iParam0, 0), " undefined");
	return -1;
}
