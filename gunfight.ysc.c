...
void func_16(int iParam0)
{
	...
	if (!func_53(1))
	{
		DEBUG::_0xF0783374333FD8CE(8, 11, "REGION_INIT_SPECIAL - Gunfight - Lockbox check found 0 objects! Setting m_bSkipLockboxDelete to TRUE!");
		bLocal_14 = true;
	}
}
...
{
	DEBUG::_0xF0783374333FD8CE(8, 11, "REGION_LOAD_SPECIAL - Gunfight - Trying to find money box");
	if (bLocal_14)
	{
		DEBUG::_0xF0783374333FD8CE(8, 11, "REGION_LOAD_SPECIAL - Gunfight - m_bSkipLockboxDelete was TRUE! Skipping object deletion step!");
		return true;
	}
	func_53(0);
	if (iLocal_13 >= 4)
	{
		DEBUG::_0xF0783374333FD8CE(8, 11, "REGION_LOAD_SPECIAL - Gunfight - m_iDeletedCount >= 4! Finished object deletion step!");
		return true;
	}
	return false;
}
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_24)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_74(iLocal_24));
...
bool func_53(bool bParam0)
{
	...
	if (func_85(&uVar1, &iVar6, 4, 1583.83f, 2193.08f, 324.18f, 5f) > 0)
	{
		DEBUG::_0xF0783374333FD8CE(8, 11, "GF_HANDLE_LOCKBOX_OBJECTS - Gunfight - Found money box!");
		iVar11 = 0;
		while (iVar11 < 4)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uVar1[iVar11]))
			{
				if (bParam0)
				{
					DEBUG::_0xF0783374333FD8CE(8, 11, "GF_HANDLE_LOCKBOX_OBJECTS - Gunfight - Money box or content object exists! Counting it");
					iVar0++;
				}
				else
				{
					DEBUG::_0xF0783374333FD8CE(8, 11, "GF_HANDLE_LOCKBOX_OBJECTS - Gunfight - Money box or content object exists! Deleting it");
	...
	if (bParam0)
	{
		if (iVar0 > 0)
		{
			DEBUG::_0xF0783374333FD8CE(8, 11, "GF_HANDLE_LOCKBOX_OBJECTS - Gunfight - Set to check only, and iFoundCount > 0. Returning TRUE!");
			return true;
		}
		else
		{
			DEBUG::_0xF0783374333FD8CE(8, 11, "GF_HANDLE_LOCKBOX_OBJECTS - Gunfight - Set to check only, and iFoundCount <= 0. Returning FALSE!");
			return false;
		}
	}
	return true;
...
bool func_65(int iParam0)
{
	...
	return ((Global_1887351[iParam0 /*36*/].f_21 == 1 || Global_1887351[iParam0 /*36*/].f_21 == 2) && !func_94(iParam0));
}
...
void func_68(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_96(iParam0, 0), " ", func_97(iParam1, 0), " ", func_98(bParam2, 0), " state ", func_99(iParam4, 0));
	UNK_0x355E72323AEE83CC(11, 6);
	sVar1 = func_100(iParam0, iParam1, bParam2, iParam4, bParam5, bParam3, &bVar0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_96(iParam0, 0), " or ", func_97(iParam1, 0), " or ", func_98(bParam2, 0));
	...
	if (bVar0 && bParam3)
	{
		sVar2 = func_105(func_104(bParam2));
	}
	else if ((func_106(iParam1, 2) || func_107(iParam4, 2)) && !Global_1893599.f_9)
	{
	...
	else if ((func_59(iParam0) && func_84(iParam0, 16777216)) && !Global_1893599.f_9)
	{
	...
	Global_1939313.f_145 = func_113(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
bool func_81(int iParam0, bool bParam1)
{
	...
	if (func_89(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_120(Global_1896632.f_1, 16))
			{
				func_121(Global_1896632.f_1, 0);
			}
			Global_1896632.f_1++;
			iVar2++;
...
int func_85(var uParam0, int iParam1, int iParam2, vector3 vParam3, float fParam6)
{
	int iVar0;
	int iVar1;

	iVar0 = VOLUME::_CREATE_VOLUME_SPHERE(vParam3, 0f, 0f, 0f, fParam6, fParam6, fParam6);
	iVar1 = func_127(uParam0, iParam1, iVar0, iParam2);
	func_128(iVar0);
	return iVar1;
}
...
char* func_100(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;
...
void func_119(int iParam0)
{
	...
	if (func_90(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_150(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
...
bool func_137(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_177(func_57(0)))
	{
		return true;
	}
