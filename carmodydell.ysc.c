...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_34, 0f, 0f, 0f) <= 5f || func_61(Global_1940410, 32768)) || func_61(Global_1940410, 16777216))
	{
		return;
	}
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_23)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_74(iLocal_23));
...
bool func_49(bool bParam0, bool bParam1)
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		{
			DEBUG::_0xF0783374333FD8CE(168, 8, "KILL_EVENT_CAUGHT - NETWORK_IS_GAME_IN_PROGRESS() = FALSE - but bIgnoreTransition = TRUE and g_mpTransition.eMPState = ", func_83(Global_1572887, 0), ", so skipping");
		}
		else
		{
...
int func_53(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (!func_58(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Region index not valid ", func_85(iParam0));
		return 1;
	}
	if (func_84(iParam0, 16))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: RF_PERS_DISABLED is on for ", func_85(iParam0));
		return 1;
	}
	if (func_86(iParam0) && !func_87(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: IS_REGION_IN_LOCKDOWN is on for ", func_85(iParam0));
	}
	DEBUG::_0xF0783374333FD8CE(40, 138, "CREATE_ALL_REGIONAL_CHARACTERS: Starting for ", func_85(iParam0));
	if (func_88(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if ((!func_86(iParam0) || func_87(iParam0)) || func_90(Global_1896632))
			{
				func_91(Global_1896632, 0);
			}
			Global_1896632++;
			iVar2++;
...
void func_60()
{
	...
	{
		DEBUG::_0x4DC69742196F818A(8, 149, "[CARMODY_DELL_UPDATE_INTERIOR_STATE] Interior not valid. Exiting.");
		return;
	}
	DEBUG::_0xA308F935BDECCEC0(8, 149, "[CARMODY_DELL_UPDATE_INTERIOR_STATE] The RC is running, prep for day.");
	func_93(&iVar0, "_car_house_int_after_ransack");
	func_94(&iVar0, "_car_house_int_before_ransack");
	func_93(&iVar0, "_car_house_int_lowvauleitems");
	func_93(&iVar0, "_car_house_int_night");
	func_93(&iVar0, "_car_house_int_night_pickup_whiskey");
	func_93(&iVar0, "_car_house_int_day");
	func_93(&iVar0, "_car_house_int_day_pickup_cheese");
	func_93(&iVar0, "_car_house_int_day_pickup_bread");
	func_93(&iVar0, "_car_house_int_day_pickup_whiskey");
	func_93(&iVar0, "_car_house_int_pickup_medicine");
	func_95("hmrb_crd_interior_ransacked");
	func_95("hmrb_crd_interior_night");
	func_95("hmrb_crd_interior_day");
	bLocal_13 = true;
}
...
bool func_63()
{
	return func_61(Global_1940410, 8192);
}
...
void func_68(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	char* sVar1;
	char* sVar2;
	...
	else if ((func_58(iParam0) && func_84(iParam0, 16777216)) && !Global_1893599.f_9)
	{
...
bool func_81(int iParam0, bool bParam1)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 138, "DELETE_ALL_REGIONAL_CHARACTERS starting for Region ", func_85(iParam0));
	if (func_88(iParam0, &iVar0, &iVar1, 0, 0))
	{
	...
	switch (iParam0)
	{
		...
		case 139:
			...
			*iParam2 = 851;
			...
			break;
		default:
			DEBUG::_0xA308F935BDECCEC0(40, 138, "Attempting to get regional character bounds for a region that doesn't have them yet ", func_74(iParam0));
			*iParam1 = -1;
			*iParam2 = -1;
			break;
	}
...
void func_93(int iParam0, char* sParam1)
{
	if (!INTERIOR::IS_INTERIOR_ENTITY_SET_ACTIVE(*iParam0, sParam1))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 149, "[CARMODY_DELL_DEACTIVATE_INTERIOR_ENTITY_SET] Interior set ", sParam1, " is already deactivated. Exiting.");
		return;
	}
	DEBUG::_0xA308F935BDECCEC0(40, 149, "[CARMODY_DELL_DEACTIVATE_INTERIOR_ENTITY_SET] Deactivating interior set ", sParam1);
	INTERIOR::DEACTIVATE_INTERIOR_ENTITY_SET(*iParam0, sParam1, true);
}

void func_94(int iParam0, char* sParam1)
{
	if (INTERIOR::IS_INTERIOR_ENTITY_SET_ACTIVE(*iParam0, sParam1))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 149, "[CARMODY_DELL_ACTIVATE_INTERIOR_ENTITY_SET] Interior set ", sParam1, " is already active. Exiting.");
		return;
	}
	DEBUG::_0xA308F935BDECCEC0(40, 149, "[CARMODY_DELL_ACTIVATE_INTERIOR_ENTITY_SET] Activating interior set ", sParam1);
...
char* func_102(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_138(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_140(func_139(Global_34));
	}
...
void func_117(var uParam0, int iParam1)
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_145(iParam1, 0));
}
...
{
	DEBUG::_0x4DC69742196F818A(40, 195, "CLEAR_SALOON: Clearing ", func_146(iParam0));
	func_147(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_148(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
...
void func_121(int iParam0)
{
	...
	if (func_89(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_150(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_151(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_152(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_153(iParam0, 536870912);
	iVar1 = func_154(iParam0);
	if (iVar1 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(2216, 139, "[SHOP_UNLOCK_DOORS] Shop: ", func_155(iParam0, 0), " door count is greater then the. Current door count: ", iVar1, " Max door count: ", 15);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_156(Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
	...
	DEBUG::_0xF0783374333FD8CE(168, 139, "[CLEAR_SHOP] Shop: ", func_155(iParam0, 0), " has been cleared!");
}
...
void func_126()
{
	...
	while (iVar0 <= 3)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ NET_CLEAR_BARTENDERS - Removed ", func_164(Global_1051777.f_3642[iVar0 /*19*/]));
...
void func_128(int iParam0, bool bParam1)
{
	...
	DEBUG::_0x4DC69742196F818A(40, 139, "NET_CLEAR_SHOP ", func_155(iParam0, 0));
	bVar0 = (func_165(iParam0) && !bParam1);
	if (!bVar0 && !func_166(iParam0, 65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] - Shop keeper deleted for shop: ", func_167(iParam0));
		}
	...
	else if (func_168(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
	{
	...
	if (func_168(iParam0, 16384) && !bVar0)
	{
		DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] Remove the script created scenario for: ", func_167(iParam0));
	...
	if (iVar3 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "[NET_CLEAR_SHOP] - Shop: ", func_155(iParam0, 0), " current door count exceeds max door count.");
		Global_1915867.f_3[iParam0 /*447*/].f_409 = 0;
	}
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_156(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar2]);
	...
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 139, "NET_CLEAR_SHOP: SPF_ALLOW_BLIP_OUT_OF_REGION for ", func_167(iParam0), " is kept; all other flags cleared.");
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_24) && func_172(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_CLEAR_SHOP] Removing relationship volume from shop ", func_155(iParam0, 0));
...
void func_133(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_174(iParam1), " on ", func_129(iParam0));
}
...
bool func_137(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_177(func_56(0)))
	{
		return true;
	}
...
void func_149(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 195, "CLEAR_SALOON_CONFIG_FLAG: Clearing flag for ", func_182(iParam1, 0));
	func_183(&(Global_1940170.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_151(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if ((!bParam4 && !func_150(iParam0)) && func_184(iParam0))
	{
...
{
	if (func_192(bParam0) && func_193())
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 183, "RELEASE_DOOR_ID - Releasing Door ID ", func_194(bParam0, 0));
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 139, "CLEAR_ALL_SHOP_TYPE_FLAGS: ", func_167(iParam0));
...
void func_158(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_174(iParam1), " on ", func_129(iParam0));
}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_FLAGS] ", func_167(iParam0));
	Global_1051777.f_80[iParam0 /*75*/].f_49 = 0;
}

void func_161(int iParam0)
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_SUPPORT_FLAGS] ", func_167(iParam0));
...
void func_169(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_167(iParam0), " flag ", func_197(iParam1));
	}
	Global_1051777.f_80[iParam0 /*75*/].f_1 = (Global_1051777.f_80[iParam0 /*75*/].f_1 - (Global_1051777.f_80[iParam0 /*75*/].f_1 && iParam1));
}
...
{
	return func_198(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}
...
bool func_175()
{
	...
	if (!func_177(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
int func_203(int iParam0)
{
	...
	DEBUG::_0xD9911C7B5F8CD69C(168, 139, "GET_SHOP_TYPE_FROM_SHOP - ", func_196(iParam0, 0), " undefined");
	return -1;
}
