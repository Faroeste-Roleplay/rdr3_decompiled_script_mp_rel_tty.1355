...
{
	if (((func_60(Global_33, iLocal_13, 0, 1, 0) && iLocal_15 < MISC::GET_GAME_TIMER()) && func_62(func_61())) && func_63(6, 18))
	{
...
bool func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_26)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_77(iLocal_26));
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_78(iLocal_26, 0), 1);
					break;
			}
		}
		if (func_10(func_70()))
	...
	else
	{
		...
		if (func_45() == -1)
		{
			func_82(iLocal_26);
			func_83(iLocal_26);
			if (!func_84(iLocal_26, 0))
			{
				return false;
			}
		}
		else if (!func_85(iLocal_26))
		{
			return false;
		}
	}
...
bool func_60(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
...
{
	return func_96(CLOCK::GET_CLOCK_HOURS(), iParam0, iParam1);
}
...
int func_96(int iParam0, int iParam1, int iParam2)
{
	...
	{
		DEBUG::_0x83407B92D46F25C3(648, 0, "IS_HOUR_BETWEEN_THESE_HOURS: Illegal Start Hour: ", iParam1, " called by script: ", UNK_0x8F77B33B6A34D8BA());
		return 0;
	}
	if (iParam2 == 24)
	{
	...
	{
		DEBUG::_0x83407B92D46F25C3(648, 0, "IS_HOUR_BETWEEN_THESE_HOURS: Illegal End Hour: ", iParam2, " called by script: ", UNK_0x8F77B33B6A34D8BA());
		return 0;
	}
	if (iParam1 == iParam2)
	{
...
void func_121(int iParam0)
{
	...
	func_148(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_149(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
...
void func_122(int iParam0)
{
	...
	if (func_92(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_151(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_152(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_153(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_154(iParam0, 536870912);
	iVar1 = func_155(iParam0);
	if (iVar1 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(2216, 139, "[SHOP_UNLOCK_DOORS] Shop: ", func_156(iParam0, 0), " door count is greater then the. Current door count: ", iVar1, " Max door count: ", 15);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_157(Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
	...
	DEBUG::_0xF0783374333FD8CE(168, 139, "[CLEAR_SHOP] Shop: ", func_156(iParam0, 0), " has been cleared!");
}
...
void func_127()
{
	...
	while (iVar0 <= 3)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ NET_CLEAR_BARTENDERS - Removed ", func_165(Global_1051777.f_3642[iVar0 /*19*/]));
...
void func_129(int iParam0, bool bParam1)
{
	...
	DEBUG::_0x4DC69742196F818A(40, 139, "NET_CLEAR_SHOP ", func_156(iParam0, 0));
	bVar0 = (func_166(iParam0) && !bParam1);
	if (!bVar0 && !func_167(iParam0, 65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] - Shop keeper deleted for shop: ", func_168(iParam0));
		}
	...
	else if (func_169(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
	{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] Remove the script created scenario for: ", func_168(iParam0));
	...
	if (iVar3 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "[NET_CLEAR_SHOP] - Shop: ", func_156(iParam0, 0), " current door count exceeds max door count.");
		Global_1915867.f_3[iParam0 /*447*/].f_409 = 0;
	}
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_157(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar2]);
	...
	func_172(iParam0);
	if (func_167(iParam0, 262144))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 139, "NET_CLEAR_SHOP: SPF_ALLOW_BLIP_OUT_OF_REGION for ", func_168(iParam0), " is kept; all other flags cleared.");
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_24) && func_173(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_CLEAR_SHOP] Removing relationship volume from shop ", func_156(iParam0, 0));
...
void func_134(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_175(iParam1), " on ", func_130(iParam0));
}
...
void func_152(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if ((!bParam4 && !func_151(iParam0)) && func_185(iParam0))
	{
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 139, "CLEAR_ALL_SHOP_TYPE_FLAGS: ", func_168(iParam0));
...
void func_159(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_175(iParam1), " on ", func_130(iParam0));
}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_FLAGS] ", func_168(iParam0));
	Global_1051777.f_80[iParam0 /*75*/].f_49 = 0;
}

void func_162(int iParam0)
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_SUPPORT_FLAGS] ", func_168(iParam0));
...
void func_170(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_168(iParam0), " flag ", func_198(iParam1));
	}
	Global_1051777.f_80[iParam0 /*75*/].f_1 = (Global_1051777.f_80[iParam0 /*75*/].f_1 - (Global_1051777.f_80[iParam0 /*75*/].f_1 && iParam1));
}
