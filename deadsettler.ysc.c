...
void __EntryFunction__()
{
	...
	DEBUG::_0xF0783374333FD8CE(43688, 17, "**** INITIALIZING REGION: ", &(Global_1887351[vScriptParam_0.x /*36*/].f_23), ", ", &(Global_1887351[iLocal_31 /*36*/].f_24), ", ", &(Global_1887351[iLocal_31 /*36*/].f_27), " ****");
	func_2();
	func_3();
	...
	while (func_4())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_30)
		{
			...
			{
				case 0:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_31 /*36*/].f_23), " global init...");
					if (Global_1901988.f_1.f_26 > 0)
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_31 /*36*/].f_23), "-> RBS_WAIT_FOR_UGC_EARLY_QUIT");
						iLocal_32 = (MISC::GET_GAME_TIMER() + Global_1901988.f_1.f_26);
						iLocal_29 = 1;
					}
					else
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_31 /*36*/].f_23), "-> RBS_INIT_REGION");
						iLocal_29 = 2;
					}
					break;
				case 1:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_31 /*36*/].f_23), " ugc early quit...");
					...
					break;
				case 2:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_31 /*36*/].f_23), " region init...");
					func_6(iLocal_31);
					func_7();
					func_8();
					...
					Global_1896632 = -1;
					DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_31 /*36*/].f_23), "-> RBS_INIT_VOLUME");
					iLocal_32 = (iLocal_28 + MISC::GET_GAME_TIMER());
					iLocal_29 = 3;
					break;
				case 3:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_31 /*36*/].f_23), " volume init...");
					if (func_13() || iLocal_32 < MISC::GET_GAME_TIMER())
					{
						func_14(iLocal_31);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_31 /*36*/].f_23), "-> RBS_LOAD_APPEARANCE");
						iLocal_32 = (MISC::GET_GAME_TIMER() + iLocal_28);
						iLocal_29 = 4;
					}
					break;
				case 4:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_31 /*36*/].f_23), " load appearance...");
					if (func_15(iLocal_31) || iLocal_32 < MISC::GET_GAME_TIMER())
					{
						func_16(iLocal_31);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_31 /*36*/].f_23), "-> RBS_LOAD_SPECIAL");
						iLocal_32 = (MISC::GET_GAME_TIMER() + iLocal_28);
						iLocal_29 = 5;
					}
					break;
				case 5:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_31 /*36*/].f_23), " load special...");
					if (func_17(iLocal_31) || iLocal_32 < MISC::GET_GAME_TIMER())
					{
						func_18(iLocal_31);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_31 /*36*/].f_23), "-> RBS_LOAD_PERS_CHARS");
						iLocal_32 = (iLocal_28 + MISC::GET_GAME_TIMER());
						iLocal_29 = 7;
					}
					break;
				case 7:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_31 /*36*/].f_23), " init regional chars...");
					if (func_10(func_9(iLocal_31)))
					{
						...
						else
						{
							if (func_20(iLocal_31) || iLocal_32 < MISC::GET_GAME_TIMER())
							{
								func_21(iLocal_31, 4);
								iLocal_32 = (MISC::GET_GAME_TIMER() + iLocal_28);
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_31 /*36*/].f_23), "-> RBS_INIT_AMBIENT");
								iLocal_29 = 8;
							}
							...
							{
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_31 /*36*/].f_23), " AMBIENT MINIGAMES ARE NOT BEING ENABLED AS A STORY OR RCM OR MISSION RETRY IS HAPPENING");
							}
							func_26();
							func_27();
							func_28();
							...
							func_31();
							func_32();
							DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": INIT_CURRENT_REGION_TOWN_DATA FOR ", &(Global_1887351[iLocal_31 /*36*/].f_23));
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_31 /*36*/].f_23), " RBS_INIT_AMBIENT -> RBS_INIT_LAW");
							iLocal_29 = 9;
							Jump @1356; //curOff = 1032
							func_33(iLocal_31);
							func_34();
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_31 /*36*/].f_23), "-> RBS_INIT_NAMED_LOCATIONS");
							iLocal_29 = 10;
							Jump @1356; //curOff = 1070
							func_35(&Global_1896686);
							func_36(iLocal_31, &Global_1896686);
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_31 /*36*/].f_23), "-> RBS_DONE_INIT");
							iLocal_29 = 11;
							Jump @1356; //curOff = 1116
							DEBUG::_0xF0783374333FD8CE(168, 17, "**** FINISHED INITIALIZING: ", &(Global_1887351[iLocal_31 /*36*/].f_23), " ****");
							func_37(iLocal_31);
							func_21(iLocal_31, 8);
							if (func_38(32))
							{
							...
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_31 /*36*/].f_23), "-> RBS_RUNNING");
							iLocal_29 = 12;
							...
							func_41(&Global_1896686, iLocal_31);
							func_42(iLocal_31);
							func_21(iLocal_31, 8);
							if (func_43())
							{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887351[iLocal_31 /*36*/].f_11);
							if (Global_1887351[iLocal_31 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887351[iLocal_31 /*36*/].f_12);
							}
							Jump @1356; //curOff = 1312
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_31 /*36*/].f_23), " RBS_CLEANUP");
							func_8();
							func_44(iVar0);
							iVar0++;
						}
						if (Global_1887351[iLocal_31 /*36*/].f_13 == 0)
						{
						}
						else
						{
							PED::_0x95423627A9CA598E(Global_1887351[iLocal_31 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
...
bool func_1()
{
	if (!bLocal_33)
	{
		if (Global_1051140)
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_31 /*36*/].f_23), ", g_mpUGC_QuitSessionRequest.bRequestRunning is still true");
			bLocal_33 = true;
			return true;
		}
		if (func_47() && func_48())
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_31 /*36*/].f_23), ", a session request is running and a UGC script is running");
			bLocal_33 = true;
			return true;
		}
	...
	if (func_48())
	{
		DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_31 /*36*/].f_23), ", content script still running for some player");
		return true;
	}
...
bool func_40(int iParam0)
{
	...
	switch (iLocal_21)
	{
		case 0:
			...
			{
				DEBUG::_0xF0783374333FD8CE(8, 11, "Dead Settlers: Going to state: DEAD_SETTLER_STATE_CREATE_PEDS");
				iLocal_21 = 1;
			}
			break;
		case 1:
			if (func_63() && func_64())
			{
				DEBUG::_0xF0783374333FD8CE(8, 11, "Dead Settlers: Going to state: DEAD_SETTLER_STATE_SETUP_PEDS");
				iLocal_21 = 2;
			}
			break;
		case 2:
			func_65();
			func_66();
			DEBUG::_0xF0783374333FD8CE(8, 11, "Dead Settlers: Going to state: DEAD_SETTLER_STATE_CHECK_PEDS_READY");
			iLocal_21 = 3;
			break;
		case 3:
			if (func_64() && func_67())
			{
				func_68(5);
				DEBUG::_0xF0783374333FD8CE(8, 11, "Dead Settlers: Going to state: DEAD_SETTLER_STATE_SETUP_ANIM_SCENE");
				iLocal_21 = 4;
			}
			break;
		case 4:
			...
			DEBUG::_0xF0783374333FD8CE(8, 11, "Dead Settlers: Going to state: DEAD_SETTLER_STATE_START_ANIM_SCENE");
			iLocal_21 = 5;
			break;
		case 5:
			if ((ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iLocal_20) && ANIMSCENE::_IS_ANIM_SCENE_LOADED(iLocal_20, true, false)) && ANIMSCENE::_0x23E33CB9F4A3F547(iLocal_20, func_54()))
			{
				...
				DEBUG::_0xF0783374333FD8CE(8, 11, "Dead Settlers: Going to state: DEAD_SETTLER_STATE_SET_RAGDOLL");
				iLocal_21 = 6;
			}
			break;
		case 6:
			if (ANIMSCENE::_IS_ANIM_SCENE_FINISHED(iLocal_20, false))
			{
				func_70();
				func_71();
				DEBUG::_0xF0783374333FD8CE(8, 11, "Dead Settlers: Going to state: DEAD_SETTLER_STATE_FINISHED");
				iLocal_21 = 7;
			}
			break;
		case 7:
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_34, 0f, 0f, 0f) <= 5f || func_72(Global_1940410, 32768)) || func_72(Global_1940410, 16777216))
	{
		return;
	}
...
bool func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": REGION_TOWN_MANANGER_EXIT_TOWN FOR ", &(Global_1887351[iLocal_31 /*36*/].f_23));
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_31)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_84(iLocal_31));
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_85(iLocal_31, 0), 1);
					break;
			}
		}
		if (func_10(func_77()))
	...
	else
	{
		...
		if (func_45() == -1)
		{
			func_89(iLocal_31);
			func_90(iLocal_31);
			if (!func_91(iLocal_31, 0))
			{
				return false;
			}
		}
		else if (!func_92(iLocal_31))
		{
			return false;
		}
	}
	DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": Terminating. -- ", &(Global_1887351[iLocal_31 /*36*/].f_23));
	SCRIPTS::TERMINATE_THIS_THREAD();
	return true;
}
...
bool func_62()
{
	return func_72(Global_1940410, 8192);
}
...
int func_63()
{
	...
	if (((((func_105(&(uLocal_13[0]), joaat("A_M_M_UNICORPSE_01"), &uVar0, func_103(0), func_104(0)) && func_105(&(uLocal_13[1]), joaat("A_M_M_UNICORPSE_01"), &uVar0, func_103(1), func_104(1))) && func_105(&(uLocal_13[2]), joaat("A_M_M_UNICORPSE_01"), &uVar0, func_103(2), func_104(2))) && func_105(&(uLocal_13[3]), joaat("A_M_M_UNICORPSE_01"), &uVar0, func_103(3), func_104(3))) && func_105(&(uLocal_13[4]), joaat("A_M_M_UNICORPSE_01"), &uVar0, func_103(4), func_104(4))) && func_105(&(uLocal_13[5]), joaat("A_M_M_UNICORPSE_01"), &uVar0, func_103(5), func_104(5)))
	{
		return 1;
	}
	return 0;
...
int func_64()
{
	...
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 11, "Peds are ready to render!");
		return 1;
	}
	else
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 11, "Waiting for peds to be ready to render!");
	}
	return 0;
}
...
void func_65()
{
	func_107(&(uLocal_13[0]));
	func_107(&(uLocal_13[1]));
	func_107(&(uLocal_13[2]));
	func_107(&(uLocal_13[3]));
	func_107(&(uLocal_13[4]));
	func_107(&(uLocal_13[5]));
}

void func_66()
{
	func_108(uLocal_13[0], -2089787434);
	func_108(uLocal_13[1], 1908325491);
	func_108(uLocal_13[2], 254342877);
	func_108(uLocal_13[3], -52800960);
	func_108(uLocal_13[4], -1197356488);
	func_108(uLocal_13[5], -1427362099);
}

int func_67()
{
	if (((((func_109(&(uLocal_13[0])) && func_109(&(uLocal_13[1]))) && func_109(&(uLocal_13[2]))) && func_109(&(uLocal_13[3]))) && func_109(&(uLocal_13[4]))) && func_109(&(uLocal_13[5])))
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 11, "Collision has loaded around all peds!");
		return 1;
	}
	else
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 11, "Waiting for collision to load around all peds!");
	}
	return 0;
}
...
{
	func_110(&(uLocal_13[0]), iParam0);
	func_110(&(uLocal_13[1]), iParam0);
	func_110(&(uLocal_13[2]), iParam0);
	func_110(&(uLocal_13[3]), iParam0);
	func_110(&(uLocal_13[4]), iParam0);
	func_110(&(uLocal_13[5]), iParam0);
}
...
void func_70()
{
	func_112(&(uLocal_13[0]));
	func_112(&(uLocal_13[1]));
	func_112(&(uLocal_13[2]));
	func_112(&(uLocal_13[3]));
	func_112(&(uLocal_13[4]));
	func_112(&(uLocal_13[5]));
}
...
void func_78(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_60(iParam0) && func_94(iParam0, 16777216)) && !Global_1893599.f_9)
	{
...
{
	iParam0 = iParam0;
	DEBUG::_0xF0783374333FD8CE(8, 11, "Dead Settlers: Cleaning up region!");
...
int func_105(var uParam0, int iParam1, var uParam2, vector3 vParam3, float fParam6)
{
	if (*uParam2)
	{
		return 0;
	...
	*uParam0 = func_152(iParam1, vParam3, fParam6, 0, 0, 0, 1, 1, 0, 0, 1);
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		*uParam2 = 1;
...
{
	DEBUG::_0x1B08D1EB9D8C4931(8, 11, "DS_SETUP_CORPSE_PED");
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_DEAD(*uParam0))
		{
			DEBUG::_0x1B08D1EB9D8C4931(8, 11, "The corpse ped is dead!!!");
		}
		DEBUG::_0x1B08D1EB9D8C4931(8, 11, "Setting up the corpse ped...");
		func_153(uParam0, 0);
		func_154(uParam0, 0);
...
void func_108(int iParam0, bool bParam1)
{
	...
	{
		DEBUG::_0x4DC69742196F818A(680, 131, "SWITCH_PED_TO_OUTFIT: Swapping to metaped outfit ", func_155(bParam1, 0), " for ped: ", UNK_0x1B7C373FB4E76B85(ENTITY::GET_ENTITY_MODEL(iParam0)));
		if (func_156(iParam0, bParam1))
		{
			if (func_157(iParam0, bParam1))
			{
				if (func_158(iParam0, bParam1))
				{
					...
					func_159(iParam0);
					DEBUG::_0xF0783374333FD8CE(680, 131, "SWITCH_PED_TO_OUTFIT: Successfullly applied requested metaped outfit ", func_155(bParam1, 0), " for: ", UNK_0x1B7C373FB4E76B85(ENTITY::GET_ENTITY_MODEL(iParam0)));
				}
			}
			else
			{
				...
				DEBUG::_0xF0783374333FD8CE(680, 131, "SWITCH_PED_TO_OUTFIT: Successfullly applied NON-requested outfit ", func_155(bParam1, 0), " for: ", UNK_0x1B7C373FB4E76B85(ENTITY::GET_ENTITY_MODEL(iParam0)));
			}
		...
		{
			DEBUG::_0x4DC69742196F818A(680, 131, "SWITCH_PED_TO_OUTFIT: Ped DOES NOT have outfit ", func_155(bParam1, 0), " : ", UNK_0x1B7C373FB4E76B85(ENTITY::GET_ENTITY_MODEL(iParam0)));
		}
	}
	else
	{
...
int func_109(var uParam0)
{
	...
	{
		return 0;
		DEBUG::_0x1B08D1EB9D8C4931(8, 11, "Waiting for collision to load around the ped...");
	}
	return 1;
}
...
void func_110(var uParam0, int iParam1)
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0) && !ENTITY::IS_ENTITY_DEAD(*uParam0))
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 11, "Disabling the IK on the ped...");
...
void func_112(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_DEAD(*uParam0))
		{
			DEBUG::_0x1B08D1EB9D8C4931(8, 11, "Setting the ragdoll blocking flags on the ped...");
			iVar0 = 1048575;
			PED::SET_RAGDOLL_BLOCKING_FLAGS(*uParam0, iVar0);
		}
		else
		{
			DEBUG::_0x1B08D1EB9D8C4931(8, 11, "The corpse ped is alive!!!");
		}
	}
	else
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 11, "The ped entity is NOT valid!!!");
	}
}
...
char* func_119(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_163(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_165(func_164(Global_34));
	}
...
char* func_131(char* sParam0, int iParam1)
{
	...
	return func_169(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
void func_134(var uParam0, int iParam1)
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_170(iParam1, 0));
}
...
{
	DEBUG::_0x4DC69742196F818A(40, 195, "CLEAR_SALOON: Clearing ", func_171(iParam0));
	func_172(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_173(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
...
void func_138(int iParam0)
{
	...
	if (func_99(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_175(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_176(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_177(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_178(iParam0, 536870912);
	iVar1 = func_179(iParam0);
	if (iVar1 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(2216, 139, "[SHOP_UNLOCK_DOORS] Shop: ", func_180(iParam0, 0), " door count is greater then the. Current door count: ", iVar1, " Max door count: ", 15);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_181(Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
	...
	DEBUG::_0xF0783374333FD8CE(168, 139, "[CLEAR_SHOP] Shop: ", func_180(iParam0, 0), " has been cleared!");
}
...
void func_143()
{
	...
	while (iVar0 <= 3)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ NET_CLEAR_BARTENDERS - Removed ", func_189(Global_1051777.f_3642[iVar0 /*19*/]));
...
void func_145(int iParam0, bool bParam1)
{
	...
	DEBUG::_0x4DC69742196F818A(40, 139, "NET_CLEAR_SHOP ", func_180(iParam0, 0));
	bVar0 = (func_190(iParam0) && !bParam1);
	if (!bVar0 && !func_191(iParam0, 65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] - Shop keeper deleted for shop: ", func_192(iParam0));
		}
	...
	else if (func_193(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
	{
	...
	if (func_193(iParam0, 16384) && !bVar0)
	{
		DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] Remove the script created scenario for: ", func_192(iParam0));
	...
	if (iVar3 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "[NET_CLEAR_SHOP] - Shop: ", func_180(iParam0, 0), " current door count exceeds max door count.");
		Global_1915867.f_3[iParam0 /*447*/].f_409 = 0;
	}
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_181(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar2]);
	...
	func_196(iParam0);
	if (func_191(iParam0, 262144))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 139, "NET_CLEAR_SHOP: SPF_ALLOW_BLIP_OUT_OF_REGION for ", func_192(iParam0), " is kept; all other flags cleared.");
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_24) && func_197(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_CLEAR_SHOP] Removing relationship volume from shop ", func_180(iParam0, 0));
...
void func_150(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_199(iParam1), " on ", func_146(iParam0));
}
...
int func_152(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12)
{
	int iVar0;
...
void func_153(var uParam0, int iParam1)
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		...
		DEBUG::_0x1B08D1EB9D8C4931(8, 11, "Setting loot flags on the ped...");
...
void func_154(var uParam0, int iParam1)
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		...
		DEBUG::_0x1B08D1EB9D8C4931(8, 11, "Setting carriable flags on the ped...");
...
bool func_156(int iParam0, bool bParam1)
{
	...
	if (bVar0)
	{
		DEBUG::_0x1B08D1EB9D8C4931(2696, 131, "DOES_PED_HAVE_META_PED_OUTFIT: Ped[", iParam0, "] does have metaped outfit[", func_155(bParam1, 0), "]");
	}
	else
	{
		DEBUG::_0x1B08D1EB9D8C4931(2696, 131, "DOES_PED_HAVE_META_PED_OUTFIT: Ped[", iParam0, "] does NOT have metaped outfit[", func_155(bParam1, 0), "]");
	}
	return bVar0;
}
...
bool func_162(int iParam0, bool bParam1, bool bParam2)
{
	if (Global_1572887.f_13 != -1)
	{
	...
	if (iParam0 == 0 && func_203(func_58(0)))
	{
		return true;
	}
...
char* func_163(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
char* func_169(char* sParam0, int iParam1)
{
...
void func_174(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 195, "CLEAR_SALOON_CONFIG_FLAG: Clearing flag for ", func_208(iParam1, 0));
	func_209(&(Global_1940170.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_176(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if ((!bParam4 && !func_175(iParam0)) && func_210(iParam0))
	{
...
{
	if (func_218(bParam0) && func_219())
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 183, "RELEASE_DOOR_ID - Releasing Door ID ", func_220(bParam0, 0));
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 139, "CLEAR_ALL_SHOP_TYPE_FLAGS: ", func_192(iParam0));
...
void func_183(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_199(iParam1), " on ", func_146(iParam0));
}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_FLAGS] ", func_192(iParam0));
	Global_1051777.f_80[iParam0 /*75*/].f_49 = 0;
}

void func_186(int iParam0)
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_SUPPORT_FLAGS] ", func_192(iParam0));
...
void func_194(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_192(iParam0), " flag ", func_223(iParam1));
	}
	Global_1051777.f_80[iParam0 /*75*/].f_1 = (Global_1051777.f_80[iParam0 /*75*/].f_1 - (Global_1051777.f_80[iParam0 /*75*/].f_1 && iParam1));
}
...
{
	return func_224(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}
...
bool func_201()
{
	...
	if (!func_203(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
{
	DEBUG::_0xA308F935BDECCEC0(648, 28, "HORSE_SET_GENDER - pedHorse: ", sParam0, " eGender = ", func_236(iParam1, 0));
	if (iParam1 == 1)
	{
...
int func_232(int iParam0)
{
	...
	DEBUG::_0xD9911C7B5F8CD69C(168, 139, "GET_SHOP_TYPE_FROM_SHOP - ", func_222(iParam0, 0), " undefined");
	return -1;
}
