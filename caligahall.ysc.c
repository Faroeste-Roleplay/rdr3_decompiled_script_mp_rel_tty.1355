...
bool func_13()
{
	iLocal_16 = Global_1887351[101 /*36*/].f_5;
	return true;
}
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_28)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_75(iLocal_28));
...
bool func_66(int iParam0)
{
	...
	return ((Global_1887351[iParam0 /*36*/].f_21 == 1 || Global_1887351[iParam0 /*36*/].f_21 == 2) && !func_95(iParam0));
}
...
void func_69(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_97(iParam0, 0), " ", func_98(iParam1, 0), " ", func_99(bParam2, 0), " state ", func_100(iParam4, 0));
	UNK_0x355E72323AEE83CC(11, 6);
	sVar1 = func_101(iParam0, iParam1, bParam2, iParam4, bParam5, bParam3, &bVar0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_97(iParam0, 0), " or ", func_98(iParam1, 0), " or ", func_99(bParam2, 0));
	...
	if (bVar0 && bParam3)
	{
		sVar2 = func_106(func_105(bParam2));
	}
	else if ((func_107(iParam1, 2) || func_108(iParam4, 2)) && !Global_1893599.f_9)
	{
	...
	Global_1939313.f_145 = func_114(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
{
	if ((iParam0 == 22 || iParam0 == 39) && !func_136())
	{
		return true;
	}
	if (iParam0 == 66)
...
var func_99(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case joaat("RIOBRAVO"):
...
char* func_101(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893599.f_162)))
	{
		sVar0 = func_139(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_141(func_140(Global_34));
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		if (!func_142(iParam0) || func_143(44))
		{
			switch (iParam0)
			{
				case 2:
...
char* func_113(char* sParam0, int iParam1)
{
	...
	return func_145(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
void func_116(var uParam0, int iParam1)
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_146(iParam1, 0));
}
...
void func_119(bool bParam0)
{
	if (bParam0)
	{
		...
		func_147(&Global_1940410, 8388608);
	}
	else
	{
		...
		func_116(&Global_1940410, 8388608);
	}
...
char* func_139(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
char* func_145(char* sParam0, int iParam1)
{
...
void func_147(var uParam0, int iParam1)
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	DEBUG::_0xF0783374333FD8CE(40, 0, "CLEAR_PLAYER_FLAG: ", func_146(iParam1, 0));
}
...
void func_153(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if ((!bParam4 && !func_152(iParam0)) && func_186(iParam0))
	{
...
void func_171(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_169(iParam0), " flag ", func_199(iParam1));
	}
	Global_1051777.f_80[iParam0 /*75*/].f_1 = (Global_1051777.f_80[iParam0 /*75*/].f_1 - (Global_1051777.f_80[iParam0 /*75*/].f_1 && iParam1));
}
...
{
	return func_200(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}
...
bool func_181(vector3 vParam0, int iParam3)
{
	...
	func_203(iParam3, &vVar0, &Var3, &uVar6);
	if (func_204(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
...
void func_203(int iParam0, var uParam1, var uParam2, var uParam3)
{
	switch (iParam0)
	{
		case 0:
...
bool func_204(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
...
int func_205(int iParam0)
{
	...
	DEBUG::_0xD9911C7B5F8CD69C(168, 139, "GET_SHOP_TYPE_FROM_SHOP - ", func_198(iParam0, 0), " undefined");
	return -1;
}
