...
{
	DEBUG::_0x4DC69742196F818A(8744, 215, "INIT_BURIED_JEWELRY - player NOT found xx", " activated Location = ", Global_1213072[PLAYER::PLAYER_ID() /*9*/], " scrpt = ", Global_1213072[PLAYER::PLAYER_ID() /*9*/].f_1, " item = ", Global_1213072[PLAYER::PLAYER_ID() /*9*/].f_2);
...
{
	DEBUG::_0x4DC69742196F818A(8, 215, "SCRIPT CLEANUP_ARROWHEAD_CHEST: CLEANUP_ARROWHEAD_CHEST!");
...
bool func_6(var uParam0)
{
	...
	{
		DEBUG::_0x4DC69742196F818A(8, 215, "SHOULD_ARROWHEAD_SCRIPT_RUN: iScenarioScriptID = ", uParam0->f_11);
		func_5(uParam0);
		return false;
	}
	return true;
...
bool func_8(var uParam0)
{
	...
	if (func_20(uParam0, 32))
	{
		if ((MISC::GET_FRAME_COUNT() % 5) == 0 && func_29(Global_33, uParam0->f_7, 3f, 1, 1))
		{
			if (!func_30(uParam0))
			{
				DEBUG::_0x1B08D1EB9D8C4931(8, 56, "alexdebug - UPDATE_ARROWHEAD - updating player data - this is now collectible type - item: ", uParam0->f_1);
				func_16(*uParam0, uParam0->f_1);
	...
	switch (func_31(uParam0))
	{
		...
		case 5:
			if (func_45(uParam0, 1097859072 /* Float: 15f */))
			{
				if (!func_34(uParam0->f_15))
				{
					DEBUG::_0x4DC69742196F818A(8, 215, "UPDATE_ARROWHEAD: Metal Detector unequipped - Create use context.");
		...
		case 11:
			...
			if (func_49(*uParam0, uParam0->f_1, 1))
			{
				if (!func_32(*uParam0))
				{
					...
					if (!func_63(bVar0, 0))
					{
						DEBUG::_0x4DC69742196F818A(8, 215, "UPDATE_ARROWHEAD: RANDOM DIG SITE - wait for Remote digging Player to send item to be awarded.");
						return false;
					}
					DEBUG::_0x4DC69742196F818A(8, 215, "UPDATE_ARROWHEAD: RANDOM DIG SITE - item received from Remote digging Player! eItem = ", bVar0);
					uParam0->f_5 = bVar0;
...
int func_9(struct<2> Param0, var uParam2, var uParam3)
{
	...
	if (TASK::_DOES_SCENARIO_POINT_EXIST(iVar2))
	{
		...
		DEBUG::_0x4DC69742196F818A(8, 215, "GET_ARROWHEAD_FROM_SCENARIO: scen point iRadius = ", iVar1);
		DEBUG::_0x4DC69742196F818A(8, 215, "GET_ARROWHEAD_FROM_SCENARIO: scen point direction = ", iVar0);
		bVar3 = iVar0 == 99;
		if (func_20(uParam3, 4))
		{
			iVar1 = Global_1213072[PLAYER::PLAYER_ID() /*9*/].f_2;
			DEBUG::_0x4DC69742196F818A(8, 215, "GET_ARROWHEAD_FROM_SCENARIO: From Player data iRadius = ", iVar1);
		}
		else if (bVar3)
		{
			DEBUG::_0x4DC69742196F818A(8, 215, "GET_ARROWHEAD_FROM_SCENARIO: direction shows we are from Wreckage");
			func_65(uParam3, 32);
		}
...
int func_10(struct<2> Param0, var uParam2, var uParam3)
{
	...
	DEBUG::_0x9A6C65DDDBEC9C52(136, 215, "GET_BURIED_ARROWHEAD_DIG_SITE_ID: no item found for radius: ", iVar0, ", returning BURIED_JEWELRY_G2_SLVR_PEARL_NECKLACE");
	return iVar0;
}
...
void func_19(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_22))
	{
		DEBUG::_0x4DC69742196F818A(40, 215, "CLEAR_ARROWHEAD_MOUND_EAGLE_EYE: obj = ", func_68(ENTITY::GET_ENTITY_MODEL(uParam0->f_22), 0));
		func_69(uParam0->f_22, uParam0->f_22, 0);
	}
}

bool func_20(var uParam0, int iParam1)
{
	return func_70(uParam0->f_16, iParam1);
}
...
void func_22(var uParam0, var uParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		Var8.f_4 = 103;
		func_74(Var8, func_73(Global_34, 0f, 0f, 0f, 300f, 300f, 300f, joaat("VOLSPHERE"), 0, 8), 0, 0);
	}
	func_75(&Var1, &uVar0);
}
...
bool func_32(int iParam0)
{
	...
	if (fVar2 > 0f)
	{
		if (Global_1275959.f_154[Global_1275959] != Global_1275959.f_154[iVar3])
		{
			...
			{
				func_82(&(Global_1213365[Global_1213072[iVar4 /*9*/].f_1 /*251*/][Global_1213072[iVar4 /*9*/].f_2]), 1);
			}
			return true;
		}
		if (!func_70(Global_1213365[Global_1213072[iVar4 /*9*/].f_1 /*251*/][Global_1213072[iVar4 /*9*/].f_2], 32))
		{
			func_82(&(Global_1213365[Global_1213072[iVar4 /*9*/].f_1 /*251*/][Global_1213072[iVar4 /*9*/].f_2]), 32);
		}
	}
	return false;
}
...
{
	DEBUG::_0x4DC69742196F818A(680, 215, "SET_ARROWHEAD_STATE: ", func_83(uParam0->f_2, 0), " -> ", func_83(iParam1, 0));
	uParam0->f_2 = iParam1;
}
...
{
	if (func_84(joaat("KIT_COLLECTOR_SPADE"), 1))
	{
		if (bParam0)
		{
			if (func_84(joaat("WEAPON_KIT_METAL_DETECTOR"), 1))
			{
				return true;
			}
		}
...
void func_38(var uParam0, vector3 vParam1, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	bVar1 = func_86(uParam0, bParam4, bVar0);
	if (!bVar1)
	{
		if (uParam0->f_8)
		{
			DEBUG::_0xF0783374333FD8CE(40, 215, "NET_COLLECTIBLE_HANDLE_RUMBLE: rumble disabled in state - ", func_87(uParam0->f_11, 0));
			uParam0->f_8 = 0;
		}
	}
	if (uParam0->f_11 < 8)
	...
	switch (*uParam0)
	{
		...
		case 2:
			...
			else if (func_92(&(uParam0->f_1)) >= 2f)
			{
				func_89(uParam0, 1);
			}
...
void func_40(vector3 vParam0, int iParam3, int iParam4, float fParam5)
{
	if (func_53(Global_33, vParam0, 1) < fParam5)
	{
		...
		{
			DEBUG::_0x4DC69742196F818A(680, 215, "UPDATE_NET_COLLECTIBLE_LOCATION_PLAYER_DATA: Set iCollectibleType in Player Data from ", func_97(Global_1213072[PLAYER::PLAYER_ID() /*9*/].f_1, 0), " to ", func_97(iParam3, 0));
...
void func_41(var uParam0, vector3 vParam1, bool bParam4, int iParam5, bool bParam6, int iParam7)
{
	if (!func_98(uParam0))
	{
...
bool func_45(var uParam0, float fParam1)
{
	if (func_84(joaat("KIT_COLLECTOR_SPADE"), 1))
	{
		...
		if (func_20(uParam0, 2))
		{
			...
			{
				DEBUG::_0x4DC69742196F818A(8, 215, "SHOULD_ARROWHEAD_DIG_SITE_BE_ACTIVE: ARROWHEAD_FLAG_ACTIVATE_METAL_DETECTOR -> T");
				return true;
			}
		}
		else
		{
			DEBUG::_0x4DC69742196F818A(8, 215, "SHOULD_ARROWHEAD_DIG_SITE_BE_ACTIVEx: -> T");
			return true;
		}
	}
	return false;
...
int func_46(char* sParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, int iParam14, bool bParam15, int iParam16)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar0 < 60)
	{
		if (func_104(iVar0, 2))
		{
			if (func_105(vParam2, Global_1952230[iVar0 /*23*/].f_6, 0.01f, 1) && iParam1 == Global_1952230[iVar0 /*23*/].f_4)
			{
				iVar2 = iVar0;
				DEBUG::_0xA308F935BDECCEC0(40, 145, "REGISTER_USE_CONTEXT_AREA - Registered context that already exist for script ", func_106(iVar2));
				return iVar2;
			}
		}
		else if (iVar1 == 0)
	...
	if (iVar1 != 0)
	{
		func_107(iVar1, iParam1, sParam0, 4, iParam6, iParam7, vParam2, fParam5, 0, 0, 2, iParam8, iParam9, iParam10, iParam11, iParam12, bParam13, iParam14, 1065353216 /* Float: 1f */, 0, 0, 0, bParam15, iParam16);
...
void func_47(int iParam0, var uParam1)
{
	if (AUDIO::_0xD9130842D7226045("RDRO_Collectible_Sounds_Travelling_Saleswoman", 0))
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 215, "NET_COLLECTIBLE_HANDLE_USE_CONTEXT_SOUND: IS_USE_CONTEXT_BEING_DISPLAYED(ucCollectible) - ", MISC::_0xF216F74101968DB0(func_35(iParam0, 1)));
...
bool func_58(var uParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 215, "ADD_ARROWHEAD_ITEM_TO_SATCHEL: thisArrowheadData.eLootTable = ", func_108(uParam0->f_23, 0));
	Global_1213072[PLAYER::PLAYER_ID() /*9*/].f_7 = 1;
	while (!func_109(uParam0->f_23, &iVar0))
	{
		DEBUG::_0xA308F935BDECCEC0(8, 215, "ADD_ARROWHEAD_ITEM_TO_SATCHEL: F");
		return false;
	}
	iVar5 = uParam0->f_5;
	DEBUG::_0xA308F935BDECCEC0(40, 215, "ADD_ARROWHEAD_ITEM_TO_SATCHEL: thisArrowheadData.eItem = ", func_110(uParam0->f_5, 0));
	iVar4 = 0;
	while (iVar4 < Global_17414.f_2989.f_1)
	{
		DEBUG::_0xA308F935BDECCEC0(648, 215, "ADD_ARROWHEAD_ITEM_TO_SATCHEL: g_mpSavedGlobals.mpCollectiblesMapBlip.eCollectibleItems[", iVar4, "].eItem = ", func_110(Global_17414.f_2989.f_1[iVar4 /*5*/].f_4, 0));
		DEBUG::_0xA308F935BDECCEC0(904, 215, "ADD_ARROWHEAD_ITEM_TO_SATCHEL: g_mpSavedGlobals.mpCollectiblesMapBlip.eCollectibleItems[", iVar4, "].vBlipLocation = ", &(Global_17414.f_2989.f_1[iVar4 /*5*/].f_1));
		DEBUG::_0xA308F935BDECCEC0(56, 215, "ADD_ARROWHEAD_ITEM_TO_SATCHEL: thisArrowheadData.vLaunchLocation = ", &(uParam0->f_7));
		if (iVar5 == Global_17414.f_2989.f_1[iVar4 /*5*/].f_4)
		{
			DEBUG::_0xA308F935BDECCEC0(136, 215, "ADD_ARROWHEAD_ITEM_TO_SATCHEL: g_mpSavedGlobals.mpCollectiblesMapBlip.eCollectibleItems[", iVar4, "].bItemPickedUp = TRUE");
			Global_17414.f_2989.f_1[iVar4 /*5*/] = 1;
		}
		iVar4++;
	}
	func_112(func_111(joaat("COLLECTIBLES_COLLECTED"), joaat("W_SHOVEL")), 1);
	if (func_20(uParam0, 2))
	{
		func_112(func_111(joaat("COLLECTIBLES_COLLECTED"), joaat("W_METAL_DETECTOR")), 1);
	}
	return true;
}
...
void func_60(bool bParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		func_113(-753305330, 0, 255, 0, 0);
	}
	else if (bParam0)
	{
		func_113(11389876, 0, 255, 0, 0);
	}
}
...
{
	if (!func_70(uParam0->f_16, iParam1))
	{
...
{
	return func_73(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("VOLCYLINDER"), iParam0, iParam1);
}
...
void func_74(struct<19> Param0, var uParam19, bool bParam20, bool bParam21)
{
	...
	if (!bParam20)
	{
		if (Param0.f_18)
		{
			if (bParam21)
			{
				...
				func_121(&(Global_1072032.f_23083), Var0);
				DEBUG::_0x1B08D1EB9D8C4931(40, 32, "BROADCAST_TICKER_EVENT - storing message - ", func_122(Param0.f_4));
				return;
			}
		}
	}
	DEBUG::_0x1B08D1EB9D8C4931(40, 32, "BROADCAST_TICKER_EVENT - broadcasting - ", func_122(Param0.f_4));
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 32, "structTickerEventData.playerID Name           = ", func_123(Param0.f_14));
...
void func_79(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(2728, 162, "NET_HUD__SET_LOCAL_PLAYER_GHOSTED: Setting ghost type ", func_126(iParam0, 0), " from source ", func_127(iParam1, 0), " for local player.");
...
{
	if (func_125(iParam0, iParam1) && (!bParam2 || Global_1072032.f_22542.f_417[iParam0 /*12*/].f_1[iParam1] == SCRIPTS::GET_ID_OF_THIS_THREAD()))
	{
		DEBUG::_0xA308F935BDECCEC0(2728, 162, "NET_HUD__CLEAR_LOCAL_PLAYER_GHOSTED: Clearing ghost type ", func_126(iParam0, 0), " from source ", func_127(iParam1, 0), " for local player.");
		UNK_0x355E72323AEE83CC(162, 7);
...
char* func_83(int iParam0, int iParam1)
{
	...
	{
		case -1:
			return "ARROWHEAD_STATE_INVALID";
		case 0:
			return "ARROWHEAD_INIT";
		case 1:
			return "ARROWHEAD_CREATE_ENTITIES";
		case 2:
			return "ARROWHEAD_REQUEST_ANIM_SCENE";
		case 3:
			return "ARROWHEAD_LOAD_ANIM_SCENE";
		case 4:
			return "ARROWHEAD_CREATE_CLUES";
		case 5:
			return "ARROWHEAD_CREATE_USE_CONTEXT";
		case 6:
			return "ARROWHEAD_STATE_05";
		case 7:
			return "ARROWHEAD_STATE_06";
		case 8:
			return "ARROWHEAD_STATE_07";
		case 9:
			return "ARROWHEAD_STATE_08";
		case 10:
			return "ARROWHEAD_STATE_09";
		case 11:
			return "ARROWHEAD_STATE_WAIT_FOR_REMOTE_PLAYER_TO_BE_DONE";
		case 12:
			return "ARROWHEAD_STATE_DONE";
		default:
			break;
	}
	if (iParam1 >= 1)
...
int func_86(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		case 0:
			if (func_133(joaat("KIT_COLLECTORS_BAG"), 0, 0, 0) <= 0)
			{
				return 0;
			}
			break;
...
bool func_93()
{
	if (((((!ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_33, -1) && !PED::IS_PED_USING_ANY_SCENARIO(Global_33)) && !func_141(Global_33, 1369124074)) && !func_141(Global_33, 713668775)) && !TASK::_0xEC7E480FF8BD0BED(Global_33)) && !PED::IS_PED_IN_ANY_VEHICLE(Global_33, false))
	{
		return true;
	}
	return false;
...
bool func_103(int iParam0)
{
	...
	if (!DATAFILE::_0x603AC35FD4602C76(func_151()))
	{
...
bool func_105(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_107(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, vector3 vParam6, float fParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, bool bParam16, int iParam17, bool bParam18, int iParam19, int iParam20, int iParam21, bool bParam22, int iParam23, bool bParam24, bool bParam25)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 145, "USE_CONTEXT_CREATE_PROMPT ", sParam2, " mode ", func_152(iParam14, 0));
}
...
bool func_109(bool bParam0, int* iParam1)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 215, "NET_COLLECTIBLE_PERSONA_REQUEST_AWARD_LOOT: ", func_108(bParam0, 0));
	Var0.f_1 = 10;
	func_153(&Var0, joaat("LOOT_TYPE_NORMAL"));
	return func_154(bParam0, &Var0, iParam1, 0, 0);
}
...
int func_113(bool bParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	struct<2> Var0;
	struct<2> Var12;
	int iVar25;
	...
	Var0.f_1 = 10;
	Var12.f_1 = 11;
	return func_155(bParam0, &iVar25, &Var12, &Var0, iParam1, iParam2, iParam3, bParam4);
}

bool func_114(int iParam0)
{
	return func_104(iParam0, 2);
}
...
bool func_132(bool bParam0)
{
	...
	if (!iVar1 == 0)
	{
		iVar2 = func_168(&(Global_17414.f_55.f_664.f_1354.f_5), iVar1);
		if (iVar2 == -1)
		{
...
int func_133(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (func_171(bParam0, joaat("DEFAULT")) != 0)
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_172(bParam2), bParam0, bParam3);
	}
	else
	{
		...
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_172(bParam2), &Var3, bParam3);
	}
...
{
	return func_178(iParam0, 3);
}

bool func_144(int iParam0)
{
	return (func_178(iParam0, 4) || func_178(iParam0, 5));
}

bool func_145(int iParam0)
{
	return func_178(iParam0, 6);
}

bool func_146(int iParam0)
{
	return func_178(iParam0, 7);
}
...
void func_148(int iParam0, bool bParam1)
{
	if (HUD::_UIPROMPT_IS_VALID(Global_1952230[iParam0 /*23*/].f_3))
	{
		if (Global_1952230[iParam0 /*23*/].f_5 == 5 && !func_104(iParam0, 8))
		{
...
int func_154(bool bParam0, var uParam1, int* iParam2, int iParam3, int iParam4)
{
	var uVar0;
	struct<15> Var1;
	...
	{
		DEBUG::_0xD9911C7B5F8CD69C(40, 84, "PERSONA_REQUEST_AWARD_LOOT - Failed to request loot award ", func_108(bParam0, 0));
		return 0;
	}
	Var1.f_3.f_1 = 10;
	Var1 = iParam3;
	Var1.f_3 = { *uParam1 };
	Var1.f_2 = iParam4;
	func_180(iParam2, bParam0, Var1);
	return 1;
}

int func_155(bool bParam0, int* iParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	bool bVar0;
	int iVar1;
	var uVar2;
	...
	{
		DEBUG::_0x9A6C65DDDBEC9C52(2216, 84, "PERSONA_REQUEST_AWARD_MODIFIED_WITH_CONDS_WITH_RPC_GUID - Award ", func_181(bParam0, 0), "(", bParam0, ") has already reached maxclaims. Ignoring and returning TRUE.");
		return 1;
	}
	if (bParam7)
	{
	...
	if (!bParam7)
	{
		...
		{
			DEBUG::_0xD9911C7B5F8CD69C(2216, 84, "PERSONA_REQUEST_AWARD_MODIFIED_WITH_CONDS_WITH_RPC_GUID - Failed to request award ", func_181(bParam0, 0), "(", bParam0, ")");
			return 0;
		}
	}
	else if (!NETWORK::_0x7A8E8DF782B47EB0(&uVar2, &(iParam2->f_1), iParam1))
	{
		DEBUG::_0xD9911C7B5F8CD69C(2216, 84, "PERSONA_REQUEST_AWARD_MODIFIED_WITH_CONDS_WITH_RPC_GUID - Posse Split - Failed to request award ", func_181(bParam0, 0), "(", bParam0, ")");
		return 0;
	}
	Var3.f_1 = 11;
	Var3.f_16 = 255;
...
bool func_156(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_184(&(Global_1102630.f_4), iVar0, 5);
	}
	if (iParam1 == func_185())
	{
		return func_184(&(Global_1102630.f_4), iVar0, 5);
	...
	{
		return func_184(&(Global_1100880[iParam1 /*53*/].f_4), iVar0, 5);
	}
...
bool func_161(bool bParam0, int iParam1)
{
	...
	if (func_188(bParam0, 1399091007))
	{
		func_189(bParam0, &uVar1, &uVar2);
		return uVar2;
	}
...
bool func_162(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_172(bParam4), sParam0, bParam3, iParam2);
	if (*iParam1 >= 0)
	{
		DEBUG::_0xA308F935BDECCEC0(174216, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION - Created collection '", *iParam1, "' with size ", *iParam2, " from predicate '", sParam0, "' with ", func_190(bParam3, 0));
...
bool func_163(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	if (iParam2 < 0)
	{
...
int func_168(var uParam0, int iParam1)
{
	...
	DEBUG::_0x9A6C65DDDBEC9C52(40, 208, "[METAPED_SAVE__OVERLAY_FIND_LAYER_BY_TYPE] Failed to find: ", func_191(iParam1, 0));
	return -1;
}
...
char* func_170(bool bParam0, bool bParam1)
{
	struct<14> Var0;
	int iVar14;
	char* sVar15;
	...
	Var0 = { func_192(bParam0, -1591664384, -1591664384, -1591664384, 0, 0, 0) };
	if (bParam1)
	{
		func_194(&Var0, func_193(0));
	}
	if (!func_195(&Var0, &iVar14, &sVar15, 0))
	{
...
int func_171(bool bParam0, int iParam1)
{
	...
	if (func_197(func_196(bParam0), 2))
	{
...
struct<4> func_173(bool bParam0, bool bParam1)
{
	...
	Var0 = { func_198(bParam0, bParam1, 0) };
	return func_199(bParam0, Var0, Var0.f_4, bParam1);
}
...
{
	func_153(uParam0, joaat("MULTIPLAYER_GAME"));
	if (func_200() == joaat("MPC_PLAYER_TYPE_MP_MALE"))
	{
		func_153(uParam0, joaat("LOOTER_PED_IS_MALE"));
	}
	else
	{
		func_153(uParam0, joaat("LOOTER_PED_IS_FEMALE"));
	}
}

void func_180(int* iParam0, bool bParam1, struct<15> Param2)
{
	int iVar0;
	struct<22> Var1;
	...
	DEBUG::_0x4DC69742196F818A(2696, 205, "ADD_AWARD_LOOT_TRANSACTION_DATA -   eLootTable:                     ", Var1.f_4, " (", func_108(Var1.f_4, 0), ")");
	DEBUG::_0x4DC69742196F818A(40, 205, "ADD_AWARD_LOOT_TRANSACTION_DATA -   eStatus:                        ", func_202(Var1.f_6, 0));
...
var func_181(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
void func_182(int iParam0, bool bParam1)
{
	...
	{
		DEBUG::_0xD9911C7B5F8CD69C(168, 157, "PUSH_AWARD_MODIFIER: Failed to push modifier ", func_203(bParam1, 0), ", array is full");
		return;
	}
	DEBUG::_0x4DC69742196F818A(40, 157, "PUSH_AWARD_MODIFIER: Adding modifier ", func_203(bParam1, 0));
}

void func_183(int* iParam0, bool bParam1, struct<17> Param2)
{
	int iVar0;
	struct<24> Var1;
	...
	DEBUG::_0x4DC69742196F818A(40, 205, "ADD_AWARD_TRANSACTION_DATA -   eAward:                         ", func_181(Var1.f_4, 0));
...
int func_188(bool bParam0, bool bParam1)
{
	if (!func_63(bParam0, 0))
	{
		return func_205(func_196(bParam0), bParam1);
	}
	if (bParam1 == 0)
	{
		return 0;
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[ITEM_HAS_PROPERTY_TAG] Found tag ", func_206(bParam1, 0), " for item ", func_110(bParam0, 0), ", returning TRUE");
		return 1;
	}
	return 0;
}

void func_189(bool bParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
struct<14> func_192(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6)
{
	struct<14> Var0;
	...
	{
		Var0.f_1 = bParam1;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eSlot:     ", func_190(bParam1, 0));
	}
	if (bParam2 != 0 && bParam2 != -1591664384)
	{
		Var0.f_2 = bParam2;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eFitsSlot: ", func_190(bParam2, 0));
	}
	if (bParam3 != 0 && bParam3 != -1591664384)
	{
		Var0.f_3 = bParam3;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eHasSlot:  ", func_190(bParam3, 0));
	}
	if (bParam4 != 0)
	{
		Var0.f_4 = bParam4;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eCategory: ", func_207(bParam4, 0));
	}
	if (bParam5 != 0)
	{
		Var0.f_5 = bParam5;
	...
	{
		Var0.f_8 = iParam6;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eItemGroup:  ", func_208(iParam6, 0));
	}
	return Var0;
}
...
struct<4> func_193(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		if (!INVENTORY::_0xB881CA836CC4B6D4(&(Global_1272425.f_4)))
		{
			...
			Global_1272425.f_4 = { func_199(923904168, func_209(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		if (!INVENTORY::_0xB881CA836CC4B6D4(&(Global_1272425.f_16)))
		{
			...
			Global_1272425.f_16 = { func_199(923904168, func_209(bParam0), -740156546, 0) };
		}
		return Global_1272425.f_16;
	}
	return func_199(923904168, func_209(bParam0), -740156546, 0);
}

void func_194(var uParam0, struct<4> Param1)
{
...
bool func_195(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_172(bParam3), uParam0, bParam2);
	if (*iParam1 >= 0)
	{
...
struct<5> func_198(bool bParam0, bool bParam1, bool bParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 157, "PLAYER_INVENTORY_GET_DEFAULT_ITEM_SLOT_INFO - eInvItemGroup = ", func_208(iVar5, 0));
	switch (iVar5)
	{
		case joaat("CLOTHING"):
			Var0 = { func_199(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			{
				Var6.f_9 = -1591664384;
				if (!func_211(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_211(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_212(bParam0, &Var6, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
		case joaat("DOG"):
			if (func_214(bParam0, -1823706425))
			{
				Var0 = { func_199(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, joaat("KIT_CAMP"));
			}
			else if (func_214(bParam0, -1483207246))
			{
				Var0 = { func_199(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, joaat("WARDROBE"));
			}
			...
			else if (func_214(bParam0, -1653629781))
			{
				Var0 = { func_199(1384535894, Var0, 1784584921, bParam1) };
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(bParam0, -833319691))
			{
				...
				if (!func_215(Var0, &Var28, bParam1, 0, -1))
				{
	...
	DEBUG::_0xA308F935BDECCEC0(10920, 157, "PLAYER_INVENTORY_GET_DEFAULT_ITEM_SLOT_INFO - ", func_110(bParam0, 0), ": ", func_190(Var0.f_4, 0), " - ", UNK_0xD2E4270E5D98EEE4(&Var0));
	return Var0;
}

struct<4> func_199(bool bParam0, var uParam1, bool bParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_172(bParam6), &uParam1, bParam0, bParam5, &Var0);
	return Var0;
}
...
int func_205(bool bParam0, bool bParam1)
{
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[BUNDLE_HAS_PROPERTY_TAG] Found tag ", func_206(bParam1, 0), " for bundle ", func_216(bParam0, 0), ", returning TRUE");
		return 1;
	}
	return 0;
}
...
struct<4> func_209(bool bParam0)
{
	...
	if (Global_1572887.f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				Global_1272425 = { func_199(joaat("CHARACTER"), func_217(), -1591664384, bParam0) };
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1272425.f_12 = { func_199(joaat("CHARACTER"), func_217(), -1591664384, 0) };
	...
	return func_199(joaat("CHARACTER"), func_217(), -1591664384, bParam0);
}

bool func_210(bool bParam0, bool bParam1)
{
	if (func_166(bParam0) == 1779021115)
	{
		return false;
	}
...
bool func_211(bool bParam0, var uParam1, int iParam2, int iParam3, bool bParam4)
{
	return func_219(bParam0, *uParam1, iParam2, iParam3, 1, bParam4) > 0;
}

bool func_212(bool bParam0, int iParam1, bool bParam2)
{
	var uVar0;

	if (func_220(bParam0, &uVar0, iParam1, bParam2))
	{
...
struct<4> func_213(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		if (!INVENTORY::_0xB881CA836CC4B6D4(&(Global_1272425.f_8)))
		{
			...
			Global_1272425.f_8 = { func_199(271701509, func_209(bParam0), 12999093, 0) };
		}
		return Global_1272425.f_8;
	}
	return func_199(271701509, func_209(bParam0), 12999093, 0);
}
...
bool func_214(bool bParam0, bool bParam1)
{
	...
	while (iVar2 < iVar3)
	{
		...
		{
			if (func_221(bParam0, bParam1, bVar0))
			{
				return true;
			}
		}
...
bool func_215(var uParam0, var uParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, int iParam7)
{
	return func_222(&uParam0, iParam4, bParam5, bParam6, iParam7);
}
...
bool func_218()
{
	return (func_223(joaat("UPGRADE_OFFHAND_HOLSTER"), 0, 0, 0) > 0 && func_224(func_199(joaat("WARDROBE"), func_209(1), 1034665895, 1), -234132662, 1, -1) != 0);
}

int func_219(bool bParam0, struct<4> Param1, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	struct<4> Var1;
	...
	if (!bParam7 && func_171(bParam0, joaat("DEFAULT")) == 0)
	{
	...
	if (bParam7)
	{
		DEBUG::_0x1B08D1EB9D8C4931(43688, 157, "PLAYER_INVENTORY_GET_ITEM_COUNT - eInventoryItem: ", func_110(bParam0, 0), " sParentGUID: ", UNK_0xD2E4270E5D98EEE4(&Param1), " eSlot: ", func_190(bParam5, 0), " bPlayerOnly: ", bParam6);
		Var1 = { func_199(bParam0, Param1, bParam5, bParam6) };
		if (!INVENTORY::_0xB881CA836CC4B6D4(&Var1))
		{
			DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_GET_ITEM_COUNT - Unable to find GUID for item ", func_110(bParam0, 0));
			return 0;
		}
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_172(bParam6), &Var1, bParam8);
		DEBUG::_0xA308F935BDECCEC0(648, 157, "PLAYER_INVENTORY_GET_ITEM_COUNT - Found ", iVar0, " of item ", func_110(bParam0, 0));
	}
	else
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_172(bParam6), bParam0, bParam8);
		DEBUG::_0xA308F935BDECCEC0(648, 157, "PLAYER_INVENTORY_GET_ITEM_COUNT - Found total ", iVar0, " of item ", func_110(bParam0, 0));
	}
	return iVar0;
}

bool func_220(bool bParam0, int iParam1, int iParam2, bool bParam3)
{
	int iVar0;

	iVar0 = func_172(0);
	*iParam1 = { func_199(bParam0, func_193(0), bParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(iParam1))
	{
		DEBUG::_0xF0783374333FD8CE(2728, 139, "[SHOP_GET_INVENTORY_WEAPON_DATA] Invalid INVENTORY_ITEM_GUID for ", func_110(bParam0, 0), " eSlot: ", func_190(bParam3, 0), " iPlayerInventoryID: ", iVar0);
		return false;
	}
...
bool func_222(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 157, "PLAYER_INVENTORY_GET_ITEM_DATA -  SlotId:      ", func_190(iParam1->f_9, 0));
...
{
	if (func_225(bParam0) && !bParam2)
	{
		return WEAPON::GET_PED_AMMO_BY_TYPE(Global_33, bParam0);
	}
	return INVENTORY::_0xE787F05DFC977BDE(func_172(bParam1), bParam0, bParam3);
}

int func_224(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, int iParam6)
{
	return func_226(&uParam0, bParam4, bParam5, iParam6);
}
...
int func_226(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	Var0.f_9 = -1591664384;
	if (func_227(iParam0, bParam1, &Var0, bParam2, iParam3))
	{
...
bool func_227(int iParam0, bool bParam1, int iParam2, bool bParam3, int iParam4)
{
	var uVar0;
	...
	{
		DEBUG::_0x9A6C65DDDBEC9C52(40, 157, "PLAYER_INVENTORY_GET_ITEM_DATA_EQUIPPED_IN_SLOT_BY_REF - nothing is equipped for slot ", func_190(bParam1, 0));
		return false;
	}
	if (!func_222(&uVar0, iParam2, bParam3, 0, iParam4))
	{
		DEBUG::_0xD9911C7B5F8CD69C(40, 157, "PLAYER_INVENTORY_GET_ITEM_DATA_EQUIPPED_IN_SLOT_BY_REF - failed to get equipment data for slot ", func_190(bParam1, 0));
		return false;
	}
	DEBUG::_0x1B08D1EB9D8C4931(10920, 157, "PLAYER_INVENTORY_GET_ITEM_DATA_EQUIPPED_IN_SLOT_BY_REF - ", func_110(iParam2->f_4, 0), " (", UNK_0xD2E4270E5D98EEE4(iParam2), ") is equipped in slot ", func_190(bParam1, 0));
	return true;
}
