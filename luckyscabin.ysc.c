...
void __EntryFunction__()
{
	...
	DEBUG::_0xF0783374333FD8CE(43688, 17, "**** INITIALIZING REGION: ", &(Global_1887351[vScriptParam_0.x /*36*/].f_23), ", ", &(Global_1887351[iLocal_34 /*36*/].f_24), ", ", &(Global_1887351[iLocal_34 /*36*/].f_27), " ****");
	func_2();
	func_3();
	...
	while (func_4())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_33)
		{
			...
			{
				case 0:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_34 /*36*/].f_23), " global init...");
					if (Global_1901988.f_1.f_26 > 0)
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_34 /*36*/].f_23), "-> RBS_WAIT_FOR_UGC_EARLY_QUIT");
						iLocal_35 = (MISC::GET_GAME_TIMER() + Global_1901988.f_1.f_26);
						iLocal_32 = 1;
					}
					else
					{
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_34 /*36*/].f_23), "-> RBS_INIT_REGION");
						iLocal_32 = 2;
					}
					break;
				case 1:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_34 /*36*/].f_23), " ugc early quit...");
					...
					break;
				case 2:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_34 /*36*/].f_23), " region init...");
					func_6(iLocal_34);
					func_7();
					func_8();
					...
					Global_1896632 = -1;
					DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_34 /*36*/].f_23), "-> RBS_INIT_VOLUME");
					iLocal_35 = (iLocal_31 + MISC::GET_GAME_TIMER());
					iLocal_32 = 3;
					break;
				case 3:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_34 /*36*/].f_23), " volume init...");
					if (func_13() || iLocal_35 < MISC::GET_GAME_TIMER())
					{
						func_14(iLocal_34);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_34 /*36*/].f_23), "-> RBS_LOAD_APPEARANCE");
						iLocal_35 = (MISC::GET_GAME_TIMER() + iLocal_31);
						iLocal_32 = 4;
					}
					break;
				case 4:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_34 /*36*/].f_23), " load appearance...");
					if (func_15(iLocal_34) || iLocal_35 < MISC::GET_GAME_TIMER())
					{
						func_16(iLocal_34);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_34 /*36*/].f_23), "-> RBS_LOAD_SPECIAL");
						iLocal_35 = (MISC::GET_GAME_TIMER() + iLocal_31);
						iLocal_32 = 5;
					}
					break;
				case 5:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_34 /*36*/].f_23), " load special...");
					if (func_17(iLocal_34) || iLocal_35 < MISC::GET_GAME_TIMER())
					{
						func_18(iLocal_34);
						DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_34 /*36*/].f_23), "-> RBS_LOAD_PERS_CHARS");
						iLocal_35 = (iLocal_31 + MISC::GET_GAME_TIMER());
						iLocal_32 = 7;
					}
					break;
				case 7:
					DEBUG::_0x1B08D1EB9D8C4931(168, 17, "Waiting for region ", &(Global_1887351[iLocal_34 /*36*/].f_23), " init regional chars...");
					if (func_10(func_9(iLocal_34)))
					{
						...
						else
						{
							if (func_20(iLocal_34) || iLocal_35 < MISC::GET_GAME_TIMER())
							{
								func_21(iLocal_34, 4);
								iLocal_35 = (MISC::GET_GAME_TIMER() + iLocal_31);
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_34 /*36*/].f_23), "-> RBS_INIT_AMBIENT");
								iLocal_32 = 8;
							}
							Jump @1393; //curOff = 934
							func_22(iLocal_34);
							func_23();
							if (!func_24(4105, 0))
							{
							...
							{
								DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_34 /*36*/].f_23), " AMBIENT MINIGAMES ARE NOT BEING ENABLED AS A STORY OR RCM OR MISSION RETRY IS HAPPENING");
							}
							func_26();
							func_27();
							func_28();
							...
							func_31();
							func_32();
							DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": INIT_CURRENT_REGION_TOWN_DATA FOR ", &(Global_1887351[iLocal_34 /*36*/].f_23));
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_34 /*36*/].f_23), " RBS_INIT_AMBIENT -> RBS_INIT_LAW");
							iLocal_32 = 9;
							Jump @1393; //curOff = 1069
							func_33(iLocal_34);
							func_34();
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_34 /*36*/].f_23), "-> RBS_INIT_NAMED_LOCATIONS");
							iLocal_32 = 10;
							Jump @1393; //curOff = 1107
							func_35(&Global_1896686);
							func_36(iLocal_34, &Global_1896686);
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_34 /*36*/].f_23), "-> RBS_DONE_INIT");
							iLocal_32 = 11;
							Jump @1393; //curOff = 1153
							DEBUG::_0xF0783374333FD8CE(168, 17, "**** FINISHED INITIALIZING: ", &(Global_1887351[iLocal_34 /*36*/].f_23), " ****");
							func_37(iLocal_34);
							func_21(iLocal_34, 8);
							if (func_38(32))
							{
							...
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_34 /*36*/].f_23), "-> RBS_RUNNING");
							iLocal_32 = 12;
							Jump @1393; //curOff = 1248
							if (func_40(iLocal_34))
							{
								iLocal_33 = MISC::GET_GAME_TIMER() + 1000;
							}
							func_41(&Global_1896686, iLocal_34);
							func_42(iLocal_34);
							func_21(iLocal_34, 8);
							if (func_43())
							{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887351[iLocal_34 /*36*/].f_11);
							if (Global_1887351[iLocal_34 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887351[iLocal_34 /*36*/].f_12);
							}
							Jump @1393; //curOff = 1349
							DEBUG::_0xA308F935BDECCEC0(40, 17, &(Global_1887351[iLocal_34 /*36*/].f_23), " RBS_CLEANUP");
							func_8();
							func_44(iVar0);
							iVar0++;
						}
						if (Global_1887351[iLocal_34 /*36*/].f_13 == 0)
						{
						}
						else
						{
							PED::_0x95423627A9CA598E(Global_1887351[iLocal_34 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
...
bool func_1()
{
	if (!bLocal_36)
	{
		if (Global_1051140)
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_34 /*36*/].f_23), ", g_mpUGC_QuitSessionRequest.bRequestRunning is still true");
			bLocal_36 = true;
			return true;
		}
		if (func_47() && func_48())
		{
			DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_34 /*36*/].f_23), ", a session request is running and a UGC script is running");
			bLocal_36 = true;
			return true;
		}
	...
	if (func_48())
	{
		DEBUG::_0xF0783374333FD8CE(168, 17, "IS_UGC_CONTENT_EARLY_QUIT_PENDING - Returning TRUE for region ", &(Global_1887351[iLocal_34 /*36*/].f_23), ", content script still running for some player");
		return true;
	}
...
bool func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": REGION_TOWN_MANANGER_EXIT_TOWN FOR ", &(Global_1887351[iLocal_34 /*36*/].f_23));
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_34)
			{
				...
				case 127:
				case 136:
					DEBUG::_0xF0783374333FD8CE(40, 17, "REGION_CLEANUP - Setting the script stat...", func_75(iLocal_34));
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_76(iLocal_34, 0), 1);
					break;
			}
		}
		if (func_10(func_68()))
	...
	else
	{
		...
		if (func_45() == -1)
		{
			func_80(iLocal_34);
			func_81(iLocal_34);
			if (!func_82(iLocal_34, 0))
			{
				return false;
			}
		}
		else if (!func_83(iLocal_34))
		{
			return false;
		}
	}
	DEBUG::_0xF0783374333FD8CE(168, 17, UNK_0x8F77B33B6A34D8BA(), ": Terminating. -- ", &(Global_1887351[iLocal_34 /*36*/].f_23));
	SCRIPTS::TERMINATE_THIS_THREAD();
	return true;
}
	...
	switch (iLocal_26)
	{
		case 0:
			...
			if (STREAMING::HAS_MODEL_LOADED(iLocal_17) && STREAMING::HAS_ANIM_DICT_LOADED("MECH_RANSACK@LOCKBOX@MED@0CM@OPENUNLOCKED@A"))
			{
				...
				{
					DEBUG::_0xF0783374333FD8CE(8, 11, "REGION_UPDATE: AWARD_MP_GAME_CONTENT_CROSS_PROMOTION_NAVY_REVOLVER_LOCKBOX is at max claims");
				...
				{
					DEBUG::_0xF0783374333FD8CE(8, 11, "REGION_UPDATE: UNLOCK_PROMO_GTAO_GATING_NAVY_REVOLVER is not unlocked");
					iLocal_18 = OBJECT::CREATE_OBJECT(joaat("P_STRONGBOX01X"), vLocal_19, false, false, false, true, true);
				}
				else
				{
					DEBUG::_0xF0783374333FD8CE(8, 11, "REGION_UPDATE: UNLOCK_PROMO_GTAO_GATING_NAVY_REVOLVER is unlocked");
				...
				if (NETWORK::_0xFBE782B3165AC8EC(-448258490))
				{
					...
					iLocal_26 = 2;
					DEBUG::_0xF0783374333FD8CE(8, 11, "REGION_UPDATE: player already has revolver, movin to LUCKY_REGION_UPDATE_COMPLETE");
				}
				else if (!UNLOCK::_UNLOCK_IS_UNLOCKED(joaat("PROMO_GTAO_GATING_NAVY_REVOLVER")))
				{
					iLocal_26 = 2;
					DEBUG::_0xF0783374333FD8CE(8, 11, "REGION_UPDATE: revolver not available, movin to LUCKY_REGION_UPDATE_COMPLETE");
				}
				else
				{
					iLocal_26 = 1;
					DEBUG::_0xF0783374333FD8CE(8, 11, "REGION_UPDATE: player movin to LUCKY_REGION_UPDATE_WAIT_FOR_LOOT");
				}
			}
			else
			{
				DEBUG::_0xF0783374333FD8CE(8, 11, "REGION_UPDATE: waiting for model and anims to load");
			}
			break;
		case 1:
			if (func_95(iLocal_18))
			{
				if (!func_96(-448258490, 0, 255, 1, 0))
				{
					DEBUG::_0x83407B92D46F25C3(8, 11, "REGION_UPDATE: unable to award AWARD_MP_GAME_CONTENT_CROSS_PROMOTION_NAVY_REVOLVER_LOCKBOX");
				}
				iLocal_26 = 2;
				DEBUG::_0xF0783374333FD8CE(8, 11, "REGION_UPDATE: movin to LUCKY_REGION_UPDATE_COMPLETE");
			}
			break;
		case 2:
			break;
...
void func_61()
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(8, 11, "REGION_UPDATE: found interior");
	}
	switch (iLocal_27)
	{
		case 0:
			DEBUG::_0xA308F935BDECCEC0(8, 11, "REGION_UPDATE: player is outside");
			if (INTERIOR::IS_VALID_INTERIOR(iLocal_25) && iLocal_25 == INTERIOR::GET_INTERIOR_FROM_ENTITY(Global_33))
			{
				...
				iLocal_27 = 1;
				DEBUG::_0xF0783374333FD8CE(8, 11, "REGION_UPDATE: movin to LUCKY_REGION_UPDATE_INTERIOR_PLAYER_INSIDE");
			}
			break;
		case 1:
			DEBUG::_0xA308F935BDECCEC0(8, 11, "REGION_UPDATE: player is inside");
			if (!INTERIOR::IS_VALID_INTERIOR(INTERIOR::GET_INTERIOR_FROM_ENTITY(Global_33)) || iLocal_25 != INTERIOR::GET_INTERIOR_FROM_ENTITY(Global_33))
			{
				if (NETWORK::NETWORK_IS_IN_MP_CUTSCENE())
				{
				...
				iLocal_27 = 0;
				DEBUG::_0xF0783374333FD8CE(8, 11, "REGION_UPDATE: movin to LUCKY_REGION_UPDATE_INTERIOR_PLAYER_OUTSIDE");
			}
			break;
		default:
			iLocal_27 = 0;
...
bool func_66(int iParam0)
{
	...
	return ((Global_1887351[iParam0 /*36*/].f_21 == 1 || Global_1887351[iParam0 /*36*/].f_21 == 2) && !func_97(iParam0));
}
...
void func_69(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_99(iParam0, 0), " ", func_100(iParam1, 0), " ", func_101(bParam2, 0), " state ", func_102(iParam4, 0));
	UNK_0x355E72323AEE83CC(11, 6);
	sVar1 = func_103(iParam0, iParam1, bParam2, iParam4, bParam5, bParam3, &bVar0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_99(iParam0, 0), " or ", func_100(iParam1, 0), " or ", func_101(bParam2, 0));
	...
	if (bVar0 && bParam3)
	{
		sVar2 = func_108(func_107(bParam2));
	}
	else if ((func_109(iParam1, 2) || func_110(iParam4, 2)) && !Global_1893599.f_9)
	{
	...
	else if ((func_58(iParam0) && func_85(iParam0, 16777216)) && !Global_1893599.f_9)
	{
	...
	Global_1939313.f_145 = func_116(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
bool func_82(int iParam0, bool bParam1)
{
	...
	if (func_89(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_123(Global_1896632.f_1, 16))
			{
				func_124(Global_1896632.f_1, 0);
			}
			Global_1896632.f_1++;
			iVar2++;
...
bool func_83(int iParam0)
{
	...
	while (iVar0 < 40)
	{
		if (func_125(iVar0) || func_126(iVar0))
		{
		}
		else
		{
...
int func_92(int iParam0, bool bParam1)
{
	if (!func_90(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_130(iParam0), " is invalid");
		return 0;
	}
	if (!func_123(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_130(iParam0), " has not been initialized");
		return 0;
	}
	if (func_123(iParam0, 32) && !bParam1)
	{
		DEBUG::_0xF0783374333FD8CE(168, 138, "CREATE_REGIONAL_CHARACTER - rcType ", func_130(iParam0), " has been locked dead");
		...
		if (func_45() == -1)
		{
			if (func_123(iParam0, 2048))
			{
				...
				DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_130(iParam0), " has been revived!");
			}
	...
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_130(iParam0), " dead or not spawning, turn scenario groups off");
		return 0;
	}
	if (PERSCHAR::_0x800DF3FC913355F3(func_133(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Persistent character ", func_130(iParam0), " already exists");
		func_134(iParam0, 128);
		return 1;
	}
	func_132(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_131(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_133(iParam0));
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: Character ", func_130(iParam0), " perschar index created!");
	if (func_123(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_133(iParam0));
		func_134(iParam0, 2048);
	...
	DEBUG::_0xA308F935BDECCEC0(168, 138, "CREATE_REGIONAL_CHARACTER: ", func_130(iParam0), " created.");
		...
		if (SCRIPTS::GET_EVENT_AT_INDEX(0, iVar4) == 1352063587)
		{
			if (SCRIPTS::GET_EVENT_DATA(0, iVar4, &Var0, 4))
			{
				if (Var0.f_1 == iParam0)
				{
					if (Var0 == Global_33)
					{
						DEBUG::_0xF0783374333FD8CE(8, 11, "LUCKY_REGION_UPDATE_HAS_PLAYER_LOOTED_STRONGBOX: local player looted it");
						return true;
					}
				}
			}
...
int func_96(bool bParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	struct<2> Var0;
	struct<2> Var12;
	int iVar25;
	...
	Var0.f_1 = 10;
	Var12.f_1 = 11;
	return func_136(bParam0, &iVar25, &Var12, &Var0, iParam1, iParam2, iParam3, bParam4);
}
...
char* func_103(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893599.f_162)))
	{
		sVar0 = func_140(Global_1893599.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_142(func_141(Global_34));
	}
...
void func_118(var uParam0, int iParam1)
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_147(iParam1, 0));
}
...
{
	DEBUG::_0x4DC69742196F818A(40, 195, "CLEAR_SALOON: Clearing ", func_148(iParam0));
	func_149(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_150(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
	...
	func_151(iParam0, 8192);
	func_151(iParam0, 32768);
	func_151(iParam0, 524288);
	func_151(iParam0, 1048576);
...
void func_122(int iParam0)
{
	...
	if (func_90(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_152(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_153(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_154(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_155(iParam0, 536870912);
	iVar1 = func_156(iParam0);
	if (iVar1 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(2216, 139, "[SHOP_UNLOCK_DOORS] Shop: ", func_157(iParam0, 0), " door count is greater then the. Current door count: ", iVar1, " Max door count: ", 15);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_158(Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
	...
	DEBUG::_0xF0783374333FD8CE(168, 139, "[CLEAR_SHOP] Shop: ", func_157(iParam0, 0), " has been cleared!");
}
...
int func_124(int iParam0, bool bParam1)
{
	if (!func_90(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_130(iParam0), " is invalid");
		return 0;
	}
	if (!func_123(iParam0, 2))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER - rcType ", func_130(iParam0), " has not been initialized");
		return 0;
	}
	if (func_131(iParam0) == 0)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_130(iParam0), " doesn't exist");
		return 1;
	}
	if (!PERSCHAR::_0x800DF3FC913355F3(func_133(iParam0)))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_130(iParam0), " already destroyed");
		return 1;
	}
	if (func_123(iParam0, 1) && !bParam1)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: Persistent character ", func_130(iParam0), " is stolen, so it will be destoyed on release.");
		func_160(iParam0, 128);
		return 1;
	}
	func_134(iParam0, 129);
	func_161(iParam0);
	DEBUG::_0xA308F935BDECCEC0(40, 138, "DESTROY_REGIONAL_CHARACTER: Destroying ", func_130(iParam0));
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_133(iParam0));
	func_132(iParam0, 0);
	DEBUG::_0xA308F935BDECCEC0(168, 138, "DESTROY_REGIONAL_CHARACTER: ", func_130(iParam0), " destroyed.");
	return 1;
}
...
void func_127()
{
	...
	while (iVar0 <= 3)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ NET_CLEAR_BARTENDERS - Removed ", func_166(Global_1051777.f_3642[iVar0 /*19*/]));
...
void func_129(int iParam0, bool bParam1)
{
	...
	DEBUG::_0x4DC69742196F818A(40, 139, "NET_CLEAR_SHOP ", func_157(iParam0, 0));
	bVar0 = (func_167(iParam0) && !bParam1);
	if (!bVar0 && !func_168(iParam0, 65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] - Shop keeper deleted for shop: ", func_169(iParam0));
		}
	...
	else if (func_170(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
	{
	...
	if (func_170(iParam0, 16384) && !bVar0)
	{
		DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] Remove the script created scenario for: ", func_169(iParam0));
	...
	if (iVar3 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "[NET_CLEAR_SHOP] - Shop: ", func_157(iParam0, 0), " current door count exceeds max door count.");
		Global_1915867.f_3[iParam0 /*447*/].f_409 = 0;
	}
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_158(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar2]);
	...
	func_173(iParam0);
	if (func_168(iParam0, 262144))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 139, "NET_CLEAR_SHOP: SPF_ALLOW_BLIP_OUT_OF_REGION for ", func_169(iParam0), " is kept; all other flags cleared.");
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_24) && func_174(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_CLEAR_SHOP] Removing relationship volume from shop ", func_157(iParam0, 0));
...
void func_134(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_176(iParam1), " on ", func_130(iParam0));
}
...
bool func_135(int iParam0)
{
	...
	if (!func_123(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_130(iParam0), " has not been initialized");
		return false;
	}
	DEBUG::_0x4DC69742196F818A(40, 138, "SHOULD_REGIONAL_CHARACTER_BE_CREATED: ", func_130(iParam0));
	return true;
}

int func_136(bool bParam0, int* iParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	bool bVar0;
	int iVar1;
	var uVar2;
	...
	{
		DEBUG::_0x9A6C65DDDBEC9C52(2216, 84, "PERSONA_REQUEST_AWARD_MODIFIED_WITH_CONDS_WITH_RPC_GUID - Award ", func_177(bParam0, 0), "(", bParam0, ") has already reached maxclaims. Ignoring and returning TRUE.");
		return 1;
	}
	if (bParam7)
	{
	...
	if (iVar1 != 0)
	{
		func_178(iParam2, -372840566);
	}
	if (!bParam7)
	{
		if (!NETWORK::_0x64A36BA85CE01A81(&uVar2, &(uParam3->f_1), &(iParam2->f_1), iParam1))
		{
			DEBUG::_0xD9911C7B5F8CD69C(2216, 84, "PERSONA_REQUEST_AWARD_MODIFIED_WITH_CONDS_WITH_RPC_GUID - Failed to request award ", func_177(bParam0, 0), "(", bParam0, ")");
			return 0;
		}
	}
	else if (!NETWORK::_0x7A8E8DF782B47EB0(&uVar2, &(iParam2->f_1), iParam1))
	{
		DEBUG::_0xD9911C7B5F8CD69C(2216, 84, "PERSONA_REQUEST_AWARD_MODIFIED_WITH_CONDS_WITH_RPC_GUID - Posse Split - Failed to request award ", func_177(bParam0, 0), "(", bParam0, ")");
		return 0;
	}
	Var3.f_1 = 11;
	Var3.f_16 = 255;
...
bool func_139(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_182(func_56(0)))
	{
		return true;
	}
...
void func_151(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 195, "CLEAR_SALOON_CONFIG_FLAG: Clearing flag for ", func_187(iParam1, 0));
	func_188(&(Global_1940170.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_153(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that isnt stolen ", func_130(iParam0));
		return;
	}
	if (!func_123(iParam0, 2))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release an uninitialized regional character ", func_130(iParam0));
		return;
	}
	if ((!bParam4 && !func_152(iParam0)) && func_189(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character that is stolen by a differnt script ", func_130(iParam0));
		return;
	}
	DEBUG::_0xF0783374333FD8CE(680, 138, "RELEASE_REGIONAL_CHARACTER: Regional character ", func_130(iParam0), " released by ", UNK_0xD2ADB90D13FA15A8(SCRIPTS::GET_ID_OF_THIS_THREAD()));
	func_134(iParam0, 1);
	func_161(iParam0);
	if (func_190(func_131(iParam0)))
	{
		iVar0 = func_133(iParam0);
		if (!PERSCHAR::_0x800DF3FC913355F3(iVar0))
		{
			DEBUG::_0x9A6C65DDDBEC9C52(40, 138, "RELEASE_REGIONAL_CHARACTER: Attempting to release a regional character with no perschar index", func_130(iParam0));
			return;
		}
		...
		{
			DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being retasked ", func_130(iParam0));
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 138, "RELEASE_REGIONAL_CHARACTER: Regional character is being destroyed on release ", func_130(iParam0));
		func_124(iParam0, 0);
	}
}
...
{
	if (func_197(bParam0) && func_198())
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 183, "RELEASE_DOOR_ID - Releasing Door ID ", func_199(bParam0, 0));
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 139, "CLEAR_ALL_SHOP_TYPE_FLAGS: ", func_169(iParam0));
...
void func_160(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_176(iParam1), " on ", func_130(iParam0));
}
...
void func_161(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar0, false))
		{
			...
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_130(iParam0), " set as no longer needed.");
		}
		else
		{
			DEBUG::_0xF0783374333FD8CE(168, 138, "Regional character ", func_130(iParam0), " was asked to be set as no longer needed, but this script does not own the ped.");
		}
	}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_FLAGS] ", func_169(iParam0));
	Global_1051777.f_80[iParam0 /*75*/].f_49 = 0;
}

void func_163(int iParam0)
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_SUPPORT_FLAGS] ", func_169(iParam0));
...
void func_171(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_169(iParam0), " flag ", func_202(iParam1));
	}
	Global_1051777.f_80[iParam0 /*75*/].f_1 = (Global_1051777.f_80[iParam0 /*75*/].f_1 - (Global_1051777.f_80[iParam0 /*75*/].f_1 && iParam1));
}
...
{
	return func_203(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}
...
void func_178(int iParam0, bool bParam1)
{
	...
	{
		DEBUG::_0xD9911C7B5F8CD69C(168, 157, "PUSH_AWARD_MODIFIER: Failed to push modifier ", func_204(bParam1, 0), ", array is full");
		return;
	}
	DEBUG::_0x4DC69742196F818A(40, 157, "PUSH_AWARD_MODIFIER: Adding modifier ", func_204(bParam1, 0));
}

void func_179(int* iParam0, bool bParam1, struct<17> Param2)
{
	int iVar0;
	struct<24> Var1;
	...
	DEBUG::_0x4DC69742196F818A(40, 205, "ADD_AWARD_TRANSACTION_DATA -   eAward:                         ", func_177(Var1.f_4, 0));
	DEBUG::_0x4DC69742196F818A(40, 205, "ADD_AWARD_TRANSACTION_DATA -   eStatus:                        ", func_206(Var1.f_6, 0));
...
bool func_180()
{
	...
	if (!func_182(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
int func_211(int iParam0)
{
	...
	DEBUG::_0xD9911C7B5F8CD69C(168, 139, "GET_SHOP_TYPE_FROM_SHOP - ", func_201(iParam0, 0), " undefined");
	return -1;
}
