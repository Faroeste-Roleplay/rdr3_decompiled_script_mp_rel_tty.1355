...
{
	DEBUG::_0xF0783374333FD8CE(168, 218, "ALTER_WORLD_STATE -- Setting ", func_93(iParam0, 0), " to ", bParam1);
	if (!bParam2)
	{
	...
	switch (iParam0)
	{
		...
		case 1649996811:
		case 2008888900:
			DEBUG::_0xA308F935BDECCEC0(40, 218, "ALTER_WORLD_STATE -- Setting Beechers ", func_93(iParam0, 0));
			func_97();
			func_94(iParam0);
			break;
		case 2019386373:
			...
			func_95(2109952320);
			func_94(2019386373);
			DEBUG::_0xA308F935BDECCEC0(40, 218, "ALTER_WORLD_STATE --", func_93(iParam0, 0));
			break;
		case -664252410:
			func_95(2019386373);
			func_95(2109952320);
		...
		case joaat("WS_MP_FORT_WALLACE_DOORS_UNLOCK_HOLD_OPEN"):
			if (bParam1)
			{
				func_94(joaat("WS_MP_FORT_WALLACE_DOORS_UNLOCK_HOLD_OPEN"));
			}
			else
			{
				func_95(joaat("WS_MP_FORT_WALLACE_DOORS_UNLOCK_HOLD_OPEN"));
				func_99(385812466);
				func_99(-1201452352);
			}
			break;
		default:
			if (bParam1)
			{
				DEBUG::_0xA308F935BDECCEC0(168, 218, "ALTER_WORLD_STATE -- ", func_100(iParam0), " ACTIVE!");
				func_94(iParam0);
			}
			else
			{
				DEBUG::_0xA308F935BDECCEC0(168, 218, "ALTER_WORLD_STATE -- ", func_100(iParam0), " CLEARED!");
				func_95(iParam0);
			}
			break;
	}
...
bool func_66(int iParam0)
{
	...
	return ((Global_1887351[iParam0 /*36*/].f_21 == 1 || Global_1887351[iParam0 /*36*/].f_21 == 2) && !func_103(iParam0));
}
...
void func_69(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	DEBUG::_0xF0783374333FD8CE(174760, 11, "DISPLAY_NAMED_LOCATION - ", func_105(iParam0, 0), " ", func_106(iParam1, 0), " ", func_107(bParam2, 0), " state ", func_108(iParam4, 0));
	UNK_0x355E72323AEE83CC(11, 6);
	sVar1 = func_109(iParam0, iParam1, bParam2, iParam4, bParam5, bParam3, &bVar0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		...
		DEBUG::_0x83407B92D46F25C3(10920, 11, "No texture for either ", func_105(iParam0, 0), " or ", func_106(iParam1, 0), " or ", func_107(bParam2, 0));
	...
	if (bVar0 && bParam3)
	{
		sVar2 = func_114(func_113(bParam2));
	}
	else if ((func_115(iParam1, 2) || func_116(iParam4, 2)) && !Global_1893599.f_9)
	{
	...
	Global_1939313.f_145 = func_122(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
bool func_82(int iParam0, bool bParam1)
{
	...
	if (func_89(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_129(Global_1896632.f_1, 16))
			{
				func_130(Global_1896632.f_1, 0);
			}
			Global_1896632.f_1++;
			iVar2++;
...
void func_94(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 218, "SET_WORLD_STATE_FLAG: setting world state - ", func_93(iParam0, 0));
	Global_1939807 = 0;
}
...
void func_95(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 218, "CLEAR_WORLD_STATE_FLAG: clearing world state - ", func_93(iParam0, 0));
	Global_1939807 = 0;
}
...
bool func_98(int iParam0)
{
	...
	if (func_143(iVar1))
	{
		if (Global_1072032.f_19652.f_24 && !func_144(iParam0))
		{
			return false;
		}
...
{
	if (func_145(bParam0) && func_146())
	{
		DEBUG::_0x1B08D1EB9D8C4931(40, 183, "RELEASE_DOOR_ID - Releasing Door ID ", func_147(bParam0, 0));
...
char* func_109(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893599.f_162)))
	{
		sVar0 = func_151(Global_1893599.f_162);
	}
...
void func_124(var uParam0, int iParam1)
{
	*uParam0 = (*uParam0 || iParam1);
	DEBUG::_0xF0783374333FD8CE(40, 0, "SET_PLAYER_FLAG: ", func_158(iParam1, 0));
}
...
{
	DEBUG::_0x4DC69742196F818A(40, 195, "CLEAR_SALOON: Clearing ", func_159(iParam0));
	func_160(Global_1940170.f_5[iParam0 /*11*/].f_6, 1);
	func_161(Global_1940170.f_5[iParam0 /*11*/].f_6, 0);
...
void func_128(int iParam0)
{
	...
	if (func_90(Global_1915867.f_3[iParam0 /*447*/].f_21) && func_163(Global_1915867.f_3[iParam0 /*447*/].f_21))
	{
		func_164(Global_1915867.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_165(Global_1915867.f_3[iParam0 /*447*/].f_9, 0);
	func_166(iParam0, 536870912);
	iVar1 = func_167(iParam0);
	if (iVar1 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(2216, 139, "[SHOP_UNLOCK_DOORS] Shop: ", func_168(iParam0, 0), " door count is greater then the. Current door count: ", iVar1, " Max door count: ", 15);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_99(Global_1915867.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
	...
	DEBUG::_0xF0783374333FD8CE(168, 139, "[CLEAR_SHOP] Shop: ", func_168(iParam0, 0), " has been cleared!");
}
...
void func_133()
{
	...
	while (iVar0 <= 3)
	{
		...
		DEBUG::_0xF0783374333FD8CE(40, 139, "@@ NET_CLEAR_BARTENDERS - Removed ", func_176(Global_1051777.f_3642[iVar0 /*19*/]));
...
void func_135(int iParam0, bool bParam1)
{
	...
	DEBUG::_0x4DC69742196F818A(40, 139, "NET_CLEAR_SHOP ", func_168(iParam0, 0));
	...
	if (!bVar0 && !func_178(iParam0, 65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
		{
			...
			DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] - Shop keeper deleted for shop: ", func_179(iParam0));
		}
	...
	else if (func_180(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_21))
	{
	...
	if (func_180(iParam0, 16384) && !bVar0)
	{
		DEBUG::_0xA308F935BDECCEC0(40, 139, "[NET_CLEAR_SHOP] Remove the script created scenario for: ", func_179(iParam0));
	...
	if (iVar3 >= 15)
	{
		DEBUG::_0x83407B92D46F25C3(168, 139, "[NET_CLEAR_SHOP] - Shop: ", func_168(iParam0, 0), " current door count exceeds max door count.");
		Global_1915867.f_3[iParam0 /*447*/].f_409 = 0;
	}
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_99(Global_1051777.f_80[iParam0 /*75*/].f_31[iVar2]);
	...
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 139, "NET_CLEAR_SHOP: SPF_ALLOW_BLIP_OUT_OF_REGION for ", func_179(iParam0), " is kept; all other flags cleared.");
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051777.f_80[iParam0 /*75*/].f_24) && func_184(iParam0, 2))
	{
		DEBUG::_0xF0783374333FD8CE(40, 139, "[NET_CLEAR_SHOP] Removing relationship volume from shop ", func_168(iParam0, 0));
...
void func_140(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "CLEAR_REGIONAL_CHARACTER_FLAG - Clearing flag ", func_186(iParam1), " on ", func_136(iParam0));
}
...
var func_147(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
bool func_150(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_191(func_56(0)))
	{
		return true;
	}
...
void func_162(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 195, "CLEAR_SALOON_CONFIG_FLAG: Clearing flag for ", func_196(iParam1, 0));
	func_197(&(Global_1940170.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_164(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if ((!bParam4 && !func_163(iParam0)) && func_198(iParam0))
	{
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 139, "CLEAR_ALL_SHOP_TYPE_FLAGS: ", func_179(iParam0));
...
void func_170(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 138, "SET_REGIONAL_CHARACTER_FLAG - Setting flag ", func_186(iParam1), " on ", func_136(iParam0));
}
...
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_FLAGS] ", func_179(iParam0));
	Global_1051777.f_80[iParam0 /*75*/].f_49 = 0;
}

void func_173(int iParam0)
{
	DEBUG::_0xA308F935BDECCEC0(40, 55, "[NET_CLEAR_ALL_SHOP_PROPERTIES_SUPPORT_FLAGS] ", func_179(iParam0));
...
void func_181(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(680, 55, "[NET_CLEAR_SHOP_TYPE_FLAG] ", func_179(iParam0), " flag ", func_208(iParam1));
	}
	Global_1051777.f_80[iParam0 /*75*/].f_1 = (Global_1051777.f_80[iParam0 /*75*/].f_1 - (Global_1051777.f_80[iParam0 /*75*/].f_1 && iParam1));
}
...
{
	return func_209(Global_1051777.f_80[iParam0 /*75*/].f_50, iParam1);
}
...
bool func_189()
{
	...
	if (!func_191(Global_1051214) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_193(vector3 vParam0, int iParam3)
{
	...
	func_213(iParam3, &vVar0, &Var3, &uVar6);
	if (func_214(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
...
bool func_214(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
...
int func_215(int iParam0)
{
	...
	DEBUG::_0xD9911C7B5F8CD69C(168, 139, "GET_SHOP_TYPE_FROM_SHOP - ", func_207(iParam0, 0), " undefined");
	return -1;
}
